...
$NUNIT Src/GoogleApis.Tests/$OUTDIR/Google.Apis.Tests.dll
$NUNIT Src/GoogleApis.Auth.Tests/$OUTDIR/Google.Apis.Auth.Tests.dll
$NUNIT Src/GoogleApis.Apis.DotNet4.Tests/$OUTDIR/Google.Apis.Auth.DotNet4.Tests.dll
