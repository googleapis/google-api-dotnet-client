  ...
  'photoAlbums': {
   'methods': {
    ...
    'get': {
     ...
     'response': {
      '$ref': 'ChiliPhotoalbumsResourceJson'
     }
    },
    'insert': {
