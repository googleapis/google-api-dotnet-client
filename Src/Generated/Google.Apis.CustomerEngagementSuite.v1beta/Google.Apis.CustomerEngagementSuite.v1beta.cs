...
namespace Google.Apis.CustomerEngagementSuite.v1beta.Data
{
    ...
    public class EvaluationResultUserGoalSatisfactionResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. The label associated with each score. Score 1: User Task Satisfied Score 0: User Task Not
        /// Satisfied Score -1: User Task Unspecified
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("label")]
        public virtual string Label { get; set; }

        /// <summary>Output only. The user task satisfaction score. Can be -1, 0, 1.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("score")]
        public virtual System.Nullable<int> Score { get; set; }
