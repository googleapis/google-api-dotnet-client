...
namespace Google.Apis.AndroidManagement.v1.Data
{
    ...
    public class DeviceConnectivityManagement : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// and above. See 5G network slicing (https://developers.google.com/android/management/5g-network-slicing)
    ...
    public class EnrollmentToken : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Options related to Google authentication during the enrollment.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("googleAuthenticationOptions")]
        public virtual GoogleAuthenticationOptions GoogleAuthenticationOptions { get; set; }
    ...
    /// <summary>
    /// Options for Google authentication during the enrollment.When triggering the enrollment with a SigninDetail,
    /// these options are enforced after the user completes third-party sign-in and an EnrollmentToken is created. If
    /// this token's authentication_requirement is set to REQUIRED, these options interact with the
    /// SigninDetail.googleAuthenticationOptions that initiated the flow in the following ways: - If the user skipped
    /// Google sign-in earlier (permitted by SigninDetail.googleAuthenticationOptions), an error will occur and the user
    /// will be prompted to sign in again. - If required_account_email is set on this token and the user signed in with
    /// a different email earlier, an error will occur and the user will be asked to sign in again with the correct
    /// account.
    /// </summary>
    public class GoogleAuthenticationOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. Specifies whether user should authenticate with Google during enrollment. If this is set to any
        /// value other than AUTHENTICATION_REQUIREMENT_UNSPECIFIED, the enterprise-level setting
        /// googleAuthenticationSettings is ignored for devices enrolled with this token.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("authenticationRequirement")]
        public virtual string AuthenticationRequirement { get; set; }

        /// <summary>
        /// Optional. Specifies the managed Google account that the user must use during enrollment. This field can only
        /// be set if AuthenticationRequirement is set to REQUIRED.
        /// </summary>
    ...
    public class SigninDetail : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Options related to Google authentication during the enrollment.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("googleAuthenticationOptions")]
        public virtual SigninDetailGoogleAuthenticationOptions GoogleAuthenticationOptions { get; set; }
    ...
    /// <summary>
    /// Options for Google authentication during the enrollment.These options control whether the Google authentication
    /// screen is shown, and whether it can be skipped, at the start of the sign-in flow. More requirements can be
    /// enforced by EnrollmentToken.googleAuthenticationOptions on the EnrollmentToken that is created later.
    /// </summary>
    public class SigninDetailGoogleAuthenticationOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. Specifies whether user should authenticate with Google during enrollment. If this is set to any
        /// value other than AUTHENTICATION_REQUIREMENT_UNSPECIFIED, the enterprise-level setting
        /// googleAuthenticationSettings is ignored for devices enrolled with this sign-in detail.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("authenticationRequirement")]
        public virtual string AuthenticationRequirement { get; set; }
