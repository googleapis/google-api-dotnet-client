...
namespace Google.Apis.Merchant.promotions_v1
{
    ...
    public class AccountsResource
    {
        ...
        public class PromotionsResource
        {
            ...
            /// input, it may take several minutes before the updated promotion can be retrieved.
            /// </summary>
            public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.promotions_v1.Data.Promotion>
            {
                ...
                public override string RestPath => "promotions/v1/{+name}";
            ...
            /// </param>
            public virtual InsertRequest Insert(Google.Apis.Merchant.promotions_v1.Data.InsertPromotionRequest body, string parent)
            {
            ...
            /// the promotion instead.
            /// </summary>
            public class InsertRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.promotions_v1.Data.Promotion>
            {
                /// <summary>Constructs a new Insert request.</summary>
                public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.promotions_v1.Data.InsertPromotionRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.Merchant.promotions_v1.Data.InsertPromotionRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "promotions/v1/{+parent}/promotions:insert";
            ...
            /// can be retrieved.
            /// </summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.promotions_v1.Data.ListPromotionsResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "promotions/v1/{+parent}/promotions";
...
namespace Google.Apis.Merchant.promotions_v1.Data
{
