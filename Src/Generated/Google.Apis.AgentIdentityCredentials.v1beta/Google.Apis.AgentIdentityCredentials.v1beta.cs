        ...
        public class LocationsResource
        {
            ...
            public class AuthProvidersResource
            {
                ...
                public class CredentialsResource
                {
                    ...
                    /// </param>
                    public virtual FinalizeRequest Finalize(Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest body, string authProvider)
                    {
                        return new FinalizeRequest(this.service, body, authProvider);
                    }

                    /// <summary>Finalizes the credentials after a successful consent flow.</summary>
                    public class FinalizeRequest : AgentIdentityCredentialsBaseServiceRequest<Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsResponse>
                    {
                        /// <summary>Constructs a new Finalize request.</summary>
                        public FinalizeRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest body, string authProvider) : base(service)
                        {
                        ...
                        Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest Body { get; set; }
                        ...
                        public override string RestPath => "v1beta/{+authProvider}/credentials:finalize";
                    ...
                    /// `projects/{project}/locations/{location}/authProviders/{auth_provider}`
                    /// </param>
                    public virtual RetrieveRequest Retrieve(Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest body, string authProvider)
                    {
                    ...
                    /// comments on `RetrieveCredentialsResponse` for more information.
                    /// </summary>
                    public class RetrieveRequest : AgentIdentityCredentialsBaseServiceRequest<Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsResponse>
                    {
                        /// <summary>Constructs a new Retrieve request.</summary>
                        public RetrieveRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest body, string authProvider) : base(service)
                        {
                            AuthProvider = authProvider;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.AgentIdentityCredentials.v1beta.Data.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+authProvider}/credentials:retrieve";
...
namespace Google.Apis.AgentIdentityCredentials.v1beta.Data
{
    ...
    public class GoogleCloudAgentidentitycredentialsV1betaConsentRejected : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }
    ...
    /// after some time.
    /// </summary>
    public class GoogleCloudAgentidentitycredentialsV1betaPending : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }
    ...
    public class GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudAgentidentitycredentialsV1betaSuccess : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// callback.
    /// </summary>
    public class GoogleCloudAgentidentitycredentialsV1betaUriConsentRequired : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
