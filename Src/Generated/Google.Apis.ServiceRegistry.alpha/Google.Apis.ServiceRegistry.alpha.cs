...
{    
    ...
    /// <summary>Next available tag: 13</summary>
    ...
    {
        /// <summary>[Output Only] Fully qualified domain name for the endpoint; used when addressing the endpoint from
        /// within Compute Networks specified in the networks field.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("internalDnsName")]
        public virtual string InternalDnsName { get; set; } 
