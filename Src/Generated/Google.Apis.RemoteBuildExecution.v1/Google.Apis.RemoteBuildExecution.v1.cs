...
namespace Google.Apis.RemoteBuildExecution.v1
{
    ...
    public class V1Resource
    {
        ...
        /// <summary>Start a streaming RPC to get watch information from the server.</summary>
        public virtual WatchRequest Watch()
        {
            return new WatchRequest(service);
        }

        /// <summary>Start a streaming RPC to get watch information from the server.</summary>
        public class WatchRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1.Data.GoogleWatcherV1ChangeBatch>
        {
            /// <summary>Constructs a new Watch request.</summary>
            public WatchRequest(Google.Apis.Services.IClientService service)
                : base(service)
            {
                InitParameters();
            }
            ...
            ///
            /// *   Parameter is not specified or has the value "". Semantics: Fetch initial state. The client wants the
            /// entity's initial state to be delivered. See the description in "Initial State".
            ///
            /// *   Parameter is set to the string "now" (UTF-8 encoding). Semantics: Fetch new changes only. The client
            /// just wants to get the changes received by the system after the watch point. The system may deliver
            /// changes from before the watch point as well.
            ///
            /// *   Parameter is set to a value received in an earlier `Change.resume_marker` field while watching the
            /// same entity. Semantics: Resume from a specific point. The client wants to receive the changes from a
            /// specific point; this value must correspond to a value received in the `Change.resume_marker` field. The
            /// system may deliver changes from before the `resume_marker` as well. If the system cannot resume the
            /// stream from this point (e.g., if it is too far behind in the stream), it can raise the
            /// `FAILED_PRECONDITION` error.
            ///
            /// An implementation MUST support an unspecified parameter and the empty string "" marker (initial state
...
{    
    ...
    /// <summary>An ActionResult represents the result of an Action being run.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testActionResult : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The exit code of the command.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("exitCode")]
        public virtual System.Nullable<int> ExitCode { get; set; } 
        ...
        /// a single entry will be present in the output list, which will contain the digest of a Tree message
        /// containing the directory tree, and the path equal exactly to the corresponding Action output_directories
        /// member. As an example, suppose the Action had an output directory `a/b/dir` and the execution produced the
        /// following contents in `a/b/dir`: a file named `bar` and a directory named `foo` with an executable file
        /// named `baz`. Then, output_directory will contain (hashes shortened for readability):
        ///
        /// ```json // OutputDirectory proto: { path: "a/b/dir" tree_digest: { hash: "4a73bc9d03...", size: 55 } } //
        /// Tree proto with hash "4a73bc9d03..." and size 55: { root: { files: [ { name: "bar", digest: { hash:
        /// "4a73bc9d03...", size: 65534 } } ], directories: [ { name: "foo", digest: { hash: "4cf2eda940...", size: 43
        ...
        /// digest: { hash: "b2c941073e...", size: 1294, }, is_executable: true } ] } } ```</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("outputDirectories")]
        public virtual System.Collections.Generic.IList<GoogleDevtoolsRemoteexecutionV1testOutputDirectory> OutputDirectories { get; set; } 

        /// <summary>The output files of the action. For each output file requested in the `output_files` field of the
        /// Action, if the corresponding file existed after the action completed, a single entry will be present in the
        /// output list.
        ///
        /// If the action does not produce the requested output, or produces a directory where a regular file is
        /// expected or vice versa, then that output will be omitted from the list. The server is free to arrange the
        /// output list as desired; clients MUST NOT assume that the output list is sorted.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("outputFiles")]
        public virtual System.Collections.Generic.IList<GoogleDevtoolsRemoteexecutionV1testOutputFile> OutputFiles { get; set; } 

        /// <summary>The digest for a blob containing the standard error of the action, which can be retrieved from the
        /// ContentAddressableStorage. See `stderr_raw` for when this will be set.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("stderrDigest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest StderrDigest { get; set; } 
        ...
        /// ContentAddressableStorage. See `stdout_raw` for when this will be set.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("stdoutDigest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest StdoutDigest { get; set; } 
    ...
    /// <summary>A `Command` is the actual command executed by a worker running an Action.
    ///
    /// Except as otherwise required, the environment (such as which system libraries or binaries are available, and
    /// what filesystems are mounted where) is defined by and specific to the implementation of the remote execution
    /// API.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testCommand : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The arguments to the command. The first argument must be the path to the executable, which must be
        /// either a relative path, in which case it is evaluated with respect to the input root, or an absolute path.
        ///
        /// The working directory will always be the input root.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("arguments")]
        public virtual System.Collections.Generic.IList<string> Arguments { get; set; } 
        ...
        /// bytes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("environmentVariables")]
        public virtual System.Collections.Generic.IList<GoogleDevtoolsRemoteexecutionV1testCommandEnvironmentVariable> EnvironmentVariables { get; set; } 
    ...
    /// <summary>An `EnvironmentVariable` is one variable to set in the running program's environment.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testCommandEnvironmentVariable : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The variable name.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    /// to avoid shortcuts. For instance, concatenating two messages to merge them may produce duplicate
    /// fields.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testDigest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The hash. In the case of SHA-256, it will always be a lowercase hex string exactly 64 characters
        /// long.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("hash")]
    ...
    /// <summary>A `Directory` represents a directory node in a file tree, containing zero or more children FileNodes
    /// and DirectoryNodes. Each `Node` contains its name in the directory, the digest of its content (either a file
    /// blob or a `Directory` proto), as well as possibly some metadata about the file or directory.
    ///
    /// In order to ensure that two equivalent directory trees hash to the same value, the following restrictions MUST
    ...
    /// unique path segment (file name). - The files and directories in the directory must each be sorted in
    ...
    /// // (Directory proto with hash "4cf2eda940..." and size 43) { files: [ { name: "baz", digest: { hash:
    /// "b2c941073e...", size: 1294, }, is_executable: true } ] } ```</summary>
    public class GoogleDevtoolsRemoteexecutionV1testDirectory : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The subdirectories in the directory.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("directories")]
        public virtual System.Collections.Generic.IList<GoogleDevtoolsRemoteexecutionV1testDirectoryNode> Directories { get; set; } 

        /// <summary>The files in the directory.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("files")]
        public virtual System.Collections.Generic.IList<GoogleDevtoolsRemoteexecutionV1testFileNode> Files { get; set; } 
    ...
    /// <summary>A `DirectoryNode` represents a child of a Directory which is itself a `Directory` and its associated
    /// metadata.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testDirectoryNode : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The digest of the Directory object represented. See Digest for information about how to take the
        /// digest of a proto message.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("digest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest Digest { get; set; } 
    ...
    /// <summary>Metadata about an ongoing execution, which will be contained in the metadata field of the
    /// Operation.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testExecuteOperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The digest of the Action being executed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("actionDigest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest ActionDigest { get; set; } 
    ...
    /// <summary>The response message for Execution.Execute, which will be contained in the response field of the
    /// Operation.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testExecuteResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>True if the result was served from cache, false if it was executed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("cachedResult")]
        public virtual System.Nullable<bool> CachedResult { get; set; } 
        ...
        /// <summary>The result of the action.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("result")]
        public virtual GoogleDevtoolsRemoteexecutionV1testActionResult Result { get; set; } 
        ...
        /// client can display them to a user.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("serverLogs")]
        public virtual System.Collections.Generic.IDictionary<string,GoogleDevtoolsRemoteexecutionV1testLogFile> ServerLogs { get; set; } 
    ...
    /// <summary>A `FileNode` represents a single file and associated metadata.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testFileNode : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The digest of the file's content.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("digest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest Digest { get; set; } 
    ...
    /// <summary>A `LogFile` is a log stored in the CAS.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testLogFile : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The digest of the log contents.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("digest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest Digest { get; set; } 
    ...
    /// <summary>An `OutputDirectory` is the output in an `ActionResult` corresponding to a directory's full contents
    /// rather than a single file.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testOutputDirectory : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>DEPRECATED: This field is deprecated and should no longer be used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("digest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest Digest { get; set; } 
        ...
        /// <summary>The digest of the encoded Tree proto containing the directory's contents.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("treeDigest")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDigest TreeDigest { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    /// <summary>An `OutputFile` is similar to a FileNode, but it is tailored for output as part of an `ActionResult`.
    /// It allows a full file path rather than only a name, and allows the server to include content inline.
    ///
    /// `OutputFile` is binary-compatible with `FileNode`.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testOutputFile : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The raw content of the file.
        ///
        /// This field may be used by the server to provide the content of a file inline in an ActionResult and avoid
        /// requiring that the client make a separate call to [ContentAddressableStorage.GetBlob] to retrieve it.
        ///
        /// The client SHOULD NOT assume that it will get raw content with any request, and always be prepared to
        /// retrieve it via `digest`.</summary>
        ...
        /// <summary>The full path of the file relative to the input root, including the filename. The path separator is
        /// a forward slash `/`. Since this is a relative path, it MUST NOT begin with a leading forward
        /// slash.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("path")]
        public virtual string Path { get; set; } 
    ...
    /// <summary>An optional Metadata to attach to any RPC request to tell the server about an external context of the
    /// request. The server may use this for logging or other purposes. To use it, the client attaches the header to the
    /// call using the canonical proto serialization: name: google.devtools.remoteexecution.v1test.requestmetadata-bin
    /// contents: the base64 encoded binary RequestMetadata message.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testRequestMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>An identifier that ties multiple requests to the same action. For example, multiple requests to the
        /// CAS, Action Cache, and Execution API are used in order to compile foo.cc.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("actionId")]
        ...
        /// <summary>The details for the tool invoking the requests.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("toolDetails")]
        public virtual GoogleDevtoolsRemoteexecutionV1testToolDetails ToolDetails { get; set; } 
    ...
    /// <summary>Details for the tool used to call the API.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testToolDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Name of the tool, e.g. bazel.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("toolName")]
        public virtual string ToolName { get; set; } 
    ...
    /// <summary>A `Tree` contains all the Directory protos in a single directory Merkle tree, compressed into one
    /// message.</summary>
    public class GoogleDevtoolsRemoteexecutionV1testTree : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>All the child directories: the directories referred to by the root and, recursively, all its
        /// children. In order to reconstruct the directory tree, the client must take the digests of each of the child
        /// directories and then build up a tree starting from the `root`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("children")]
        public virtual System.Collections.Generic.IList<GoogleDevtoolsRemoteexecutionV1testDirectory> Children { get; set; } 

        /// <summary>The root directory in the tree.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("root")]
        public virtual GoogleDevtoolsRemoteexecutionV1testDirectory Root { get; set; } 
    ...
    /// <summary>A Change indicates the most recent state of an element.</summary>
    public class GoogleWatcherV1Change : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>If true, this Change is followed by more Changes that are in the same group as this
        /// Change.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("continued")]
        public virtual System.Nullable<bool> Continued { get; set; } 

        /// <summary>The actual change data. This field is present only when `state() == EXISTS` or `state() == ERROR`.
        /// Please see google.protobuf.Any about how to use the Any type.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("data")]
        public virtual System.Collections.Generic.IDictionary<string,object> Data { get; set; } 

        /// <summary>Name of the element, interpreted relative to the entity's actual name. "" refers to the entity
        /// itself. The element name is a valid UTF-8 string.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("element")]
        public virtual string Element { get; set; } 

        /// <summary>If present, provides a compact representation of all the messages that have been received by the
        /// caller for the given entity, e.g., it could be a sequence number or a multi-part timestamp/version vector.
        /// This marker can be provided in the Request message, allowing the caller to resume the stream watching at a
        /// specific point without fetching the initial state.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("resumeMarker")]
        public virtual string ResumeMarker { get; set; } 

        /// <summary>The state of the `element`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; } 
    ...
    /// <summary>A batch of Change messages.</summary>
    public class GoogleWatcherV1ChangeBatch : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A list of Change messages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("changes")]
        public virtual System.Collections.Generic.IList<GoogleWatcherV1Change> Changes { get; set; } 
