...
namespace Google.Apis.Cloudbilling.v1beta.Data
{
    ...
    /// example: `source_continent` = "SOURCE_CONTINENT_ASIA_PACIFIC", `destination_continent` =
    /// "SOURCE_CONTINENT_SOUTH_AMERICA". * If transferring data within one region, the source and destination fields
    /// are set to the same value. For example: `source_continent` = "SOURCE_CONTINENT_ASIA_PACIFIC",
    /// `destination_continent` = "SOURCE_CONTINENT_ASIA_PACIFIC". Some examples for the Network data transfer traffic
    /// type on the pricing page. * Data moves between different locations on the same continent. `source_continent` =
    /// "SOURCE_CONTINENT_ASIA_PACIFIC", `destination_continent` = "SOURCE_CONTINENT_ASIA_PACIFIC". * Data moves between
    /// different continents and neither is Australia. `source_continent` = "SOURCE_CONTINENT_NORTH_AMERICA",
    /// `destination_continent` = "SOURCE_CONTINENT_ASIA_PACIFIC". * Data moves between different continents and one is
    /// Australia. `source_continent` = "SOURCE_CONTINENT_NORTH_AMERICA", `destination_continent` =
