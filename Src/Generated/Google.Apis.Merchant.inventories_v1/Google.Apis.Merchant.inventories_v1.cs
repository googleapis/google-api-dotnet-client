    ...
    public class AccountsResource
    {
        ...
        public class ProductsResource
        {
            ...
            public class LocalInventoriesResource
            {
                ...
                /// server, supporting two options: 1. **Encoded Format**: The `{product}` segment is an unpadded
                ...
                public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.Empty>
                {
                    ...
                    /// Example: `local~en~US~sku123` The format of the {product} segment in the URL is automatically
                    /// detected by the server, supporting two options: 1. **Encoded Format**: The `{product}` segment
                    /// is an unpadded base64url encoded string (RFC 4648 Section 5). The decoded string must result in
                    ...
                    /// base64url encoding of this string, which is `ZW5-VVMtc2t1LzEyMw`. The full resource name for the
                    /// product would be `accounts/123/products/ZW5-VVMtc2t1LzEyMw`. 2. **Plain Format**: The
                ...
                public class InsertRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.LocalInventory>
                {
                    ...
                    /// the server, supporting two options: 1. **Encoded Format**: The `{product}` segment is an
