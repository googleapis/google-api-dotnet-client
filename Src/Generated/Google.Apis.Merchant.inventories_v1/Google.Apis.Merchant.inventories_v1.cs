...
namespace Google.Apis.Merchant.inventories_v1
{
    ...
    public class MerchantService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "inventories_v1";
    ...
    public class AccountsResource
    {
        ...
        public class ProductsResource
        {
            ...
            public class LocalInventoriesResource
            {
                ...
                /// received a successful delete response, wait for that period before attempting a delete again.
                /// </summary>
                public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.Empty>
                {
                    ...
                    /// 1. **Encoded Format**: The `{product}` segment is an unpadded base64url encoded string (RFC 4648
                    /// Section 5). The decoded string must result in the `content_language~feed_label~offer_id`
                    ...
                    /// `en~US~sku/123` for `store_code` "store123", the `{product}` segment must be the unpadded
                    /// base64url encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource name for the
                    /// local inventory would be `accounts/123/products/ZW5-VVN-c2t1LzEyMw/localInventories/store123`.
                    ...
                    public override string RestPath => "inventories/v1/{+name}";
                ...
                /// encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource name for the product would
                /// be `accounts/123/products/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{product}` segment is the
                ...
                /// might take up to 30 minutes for the new or updated `LocalInventory` resource to appear in products.
                /// </summary>
                public class InsertRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.LocalInventory>
                {
                    /// <summary>Constructs a new Insert request.</summary>
                    public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.inventories_v1.Data.LocalInventory body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// would be `accounts/123/products/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{product}`
                    /// segment is the tilde-separated string `content_language~feed_label~offer_id`. This format is
                    /// suitable only when `content_language`, `feed_label`, and `offer_id` do not contain
                    /// URL-problematic characters like `/`, `%`, or `~`. We recommend using the **Encoded Format** for
                    /// all product IDs to ensure correct parsing, especially those containing special characters. The
                    /// presence of tilde (`~`) characters in the `{product}` segment is used to differentiate between
                    /// the two formats.
                    /// </summary>
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "inventories/v1/{+parent}/localInventories:insert";
                ...
                /// product for a given account.
                /// </summary>
                public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.ListLocalInventoriesResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "inventories/v1/{+parent}/localInventories";
            ...
            public class RegionalInventoriesResource
            {
                ...
                public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.Empty>
                {
                    ...
                    /// structure. This encoding MUST be used if any part of the product identifier (like `offer_id`)
                    /// contains characters such as `/`, `%`, or `~`. * Example: To represent the product ID
                    /// `en~US~sku/123` for `region` "region123", the `{product}` segment must be the unpadded base64url
                ...
                /// products.
                /// </summary>
                public class InsertRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.RegionalInventory>
                {
                    /// <summary>Constructs a new Insert request.</summary>
                    public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.inventories_v1.Data.RegionalInventory body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// `local~en~US~sku123` The format of the `{product}` segment in the URL is automatically detected
                    /// by the server, supporting two options: 1. **Encoded Format**: The `{product}` segment is an
                    /// **unpadded base64url** encoded string (RFC 4648 Section 5). The decoded string must result in
                    /// the `content_language~feed_label~offer_id` structure. This encoding MUST be used if any part of
                    /// the product identifier (like `offer_id`) contains characters such as `/`, `%`, or `~`. *
                    /// Example: To represent the product ID `en~US~sku/123`, the `{product}` segment must be the
                    /// unpadded base64url encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource
                    /// name for the product would be `accounts/123/products/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**:
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "inventories/v1/{+parent}/regionalInventories:insert";
                ...
                /// product for a given account.
                /// </summary>
                public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.inventories_v1.Data.ListRegionalInventoriesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "inventories/v1/{+parent}/regionalInventories";
...
namespace Google.Apis.Merchant.inventories_v1.Data
{
    ...
    public class InventoryLoyaltyProgram : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// slash.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("memberPriceEffectiveInterval")]
        public virtual Interval MemberPriceEffectiveInterval { get; set; }
        ...
        /// between a business entity and a loyalty program entity. The label must be provided if there are multiple
        /// loyalty programs available for the merchant, so that the system can associate the assets below (for example,
        /// price and points) with the correct business. The corresponding program must be linked to the Merchant Center
        /// account.
        /// </summary>
    ...
    /// <summary>Local inventory attributes.</summary>
    public class LocalInventoryAttributes : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        /// merchant's website and be clear to members. This is only applicable for merchants in supported countries.
        /// See [Loyalty program](https://support.google.com/merchants/answer/12922446) for details on supported
        /// countries and loyalty program configuration. For local inventory specific details, see the [Local inventory
        ...
        public virtual System.Collections.Generic.IList<InventoryLoyaltyProgram> LoyaltyPrograms { get; set; }

        /// <summary>
        /// Optional. Supported [pickup method](https://support.google.com/merchants/answer/3061342) for this product.
    ...
    public class RegionalInventory : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. A list of regional inventory attributes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("regionalInventoryAttributes")]
    ...
    /// <summary>Regional inventory attributes.</summary>
    public class RegionalInventoryAttributes : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. [Availability](https://support.google.com/merchants/answer/14644124) of the product in this
        /// region.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("availability")]
        public virtual string Availability { get; set; }
        ...
        /// <summary>
        /// Optional. An optional list of loyalty programs containing applicable loyalty member prices for this product
        /// in this region. This field is used to show region-specific member prices on Product Listing Ads (PLA). To
        /// use this, the loyalty program must be configured in Google Merchant Center, and the merchant must be using
        /// the Regional Availability and Pricing (RAAP) feature. The benefits provided must match the merchant's
        /// website and be clear to members. This is only applicable for merchants in supported countries. See [Loyalty
        /// program](https://support.google.com/merchants/answer/12922446) for details on supported countries and
        /// loyalty program configuration. Also see [Regional availability and
        /// pricing](https://support.google.com/merchants/answer/14644124) and [How to set up regional member
        /// pricing](https://support.google.com/merchants/answer/16388178) for more information.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("loyaltyPrograms")]
        public virtual System.Collections.Generic.IList<InventoryLoyaltyProgram> LoyaltyPrograms { get; set; }
