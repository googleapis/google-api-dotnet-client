    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public LocationsResource(Google.Apis.Services.IClientService service)
            {
                ...
                PrivateRanges = new PrivateRangesResource(service);
            ...
            /// <summary>Gets the PrivateRanges resource.</summary>
            public virtual PrivateRangesResource PrivateRanges { get; }

            /// <summary>The "privateRanges" collection of methods.</summary>
            public class PrivateRangesResource
            {
                private const string Resource = "privateRanges";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public PrivateRangesResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
