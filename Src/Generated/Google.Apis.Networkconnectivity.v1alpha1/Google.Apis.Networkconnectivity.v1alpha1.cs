    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public LocationsResource(Google.Apis.Services.IClientService service)
            {
                ...
                ServiceConnectPolicies = new ServiceConnectPoliciesResource(service);
            ...
            /// <summary>Gets the ServiceConnectPolicies resource.</summary>
            public virtual ServiceConnectPoliciesResource ServiceConnectPolicies { get; }

            /// <summary>The "serviceConnectPolicies" collection of methods.</summary>
            public class ServiceConnectPoliciesResource
            {
                private const string Resource = "serviceConnectPolicies";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public ServiceConnectPoliciesResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
