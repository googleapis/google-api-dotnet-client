...
namespace Google.Apis.Networkconnectivity.v1alpha1.Data
{
    ...
    public class InternalRange : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. IP range that this internal range defines. NOTE: IPv6 ranges are limited to usage=EXTERNAL_TO_VPC
        /// and peering=FOR_SELF. NOTE: For IPv6 Ranges this field is compulsory, i.e. the address range must be
        ...
        /// <summary>
        /// Optional. The URL or resource ID of the network in which to reserve the internal range. The network cannot
        ...
        /// <summary>
        /// Optional. An alternative to ip_cidr_range. Can be set when trying to create an IPv4 reservation that
        ...
        /// <summary>Optional. The type of usage set for this internal range.</summary>
