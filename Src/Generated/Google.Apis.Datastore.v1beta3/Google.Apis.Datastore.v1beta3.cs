...
{    
    ...
    public class Query : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>An ending point for the query results. Query cursors are returned in query result
        /// batches.</summary>
        ...
        /// <summary>A starting point for the query results. Query cursors are returned in query result
        /// batches.</summary>
    ...
    public class ReadOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The transaction in which to read.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("transaction")]
        public virtual string Transaction { get; set; } 
