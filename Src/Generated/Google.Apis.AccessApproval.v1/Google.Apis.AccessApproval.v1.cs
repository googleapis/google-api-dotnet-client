...
namespace Google.Apis.AccessApproval.v1.Data
{
    ...
    public class EnrolledService : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Storage * Google Kubernetes Engine * Persistent Disk Note: These values are supported as input for legacy
        /// purposes, but will not be returned from the API. * all * appengine.googleapis.com * bigquery.googleapis.com
        /// * bigtable.googleapis.com * container.googleapis.com * cloudkms.googleapis.com * compute.googleapis.com *
