...
namespace Google.Apis.AccessApproval.v1.Data
{
    ...
    public class EnrolledService : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// all * GA * App Engine * Artifact Registry * BigQuery * Cloud Bigtable * Cloud Key Management Service *
        /// Compute Engine * Cloud Composer * Cloud Dataflow * Cloud Dataproc * Cloud DLP * Cloud EKM * Cloud HSM *
        /// Cloud Identity and Access Management * Cloud Logging * Cloud NAT * Cloud Pub/Sub * Cloud Spanner * Cloud SQL
        /// * Cloud Storage * Google Kubernetes Engine * Organization Policy Serivice * Persistent Disk * Resource
        /// Manager * Secret Manager * Speaker ID Note: These values are supported as input for legacy purposes, but
        ...
        /// cloudsql.googleapis.com * compute.googleapis.com * dataflow.googleapis.com * dataproc.googleapis.com *
        /// dlp.googleapis.com * iam.googleapis.com * logging.googleapis.com * orgpolicy.googleapis.com *
        /// pubsub.googleapis.com * spanner.googleapis.com * secretmanager.googleapis.com * speakerid.googleapis.com *
