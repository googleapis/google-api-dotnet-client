...
namespace Google.Apis.AccessApproval.v1.Data
{
    ...
    public class EnrolledService : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Access Management * Cloud Logging * Cloud NAT * Cloud Pub/Sub * Cloud Spanner * Cloud SQL * Cloud Storage *
        /// Google Kubernetes Engine * Organization Policy Serivice * Persistent Disk * Resource Manager * Secret
        /// Manager * Speaker ID Note: These values are supported as input for legacy purposes, but will not be returned
        /// from the API. * all * ga-only * appengine.googleapis.com * artifactregistry.googleapis.com *
