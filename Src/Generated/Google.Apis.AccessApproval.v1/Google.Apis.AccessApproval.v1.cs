...
namespace Google.Apis.AccessApproval.v1.Data
{
    ...
    public class EnrolledService : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Dataflow * Cloud Dataproc * Cloud DLP * Cloud EKM * Cloud HSM * Cloud Identity and Access Management * Cloud
        /// Logging * Cloud Pub/Sub * Cloud Spanner * Cloud SQL * Cloud Storage * Google Kubernetes Engine *
        ...
        /// cloudkms.googleapis.com * cloudresourcemanager.googleapis.com * cloudsql.googleapis.com *
        /// compute.googleapis.com * dataflow.googleapis.com * dataproc.googleapis.com * dlp.googleapis.com *
        /// iam.googleapis.com * logging.googleapis.com * orgpolicy.googleapis.com * pubsub.googleapis.com *
        /// spanner.googleapis.com * secretmanager.googleapis.com * speakerid.googleapis.com * storage.googleapis.com
        /// Calls to UpdateAccessApprovalSettings using 'all' or any of the XXX.googleapis.com will be translated to the
