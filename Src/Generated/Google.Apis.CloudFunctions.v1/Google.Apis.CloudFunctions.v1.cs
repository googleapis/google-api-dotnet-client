...
namespace Google.Apis.CloudFunctions.v1
{
    ...
    public class OperationsResource
    {
        ...
        public class ListRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v1.Data.ListOperationsResponse>
        {
            ...
            /// <summary>Required. A filter for matching the requested operations. The supported formats of *filter*
            /// are: To query for a specific function: project:*,location:*,function:* To query for all of the latest
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class FunctionsResource
            {
                ...
                /// Limits](https://cloud.google.com/functions/quotas#rate_limits).</summary>
                ...
                /// header SHOULD NOT be specified: * `Authorization: Bearer YOUR_TOKEN`</summary>
                /// <param name="body">The body of the request.</param>
                ...
                /// <summary>Gets the IAM access control policy for a function. Returns an empty policy if the function
                ...
                /// `projects/locations` If you want to list functions in all locations, use "-" in place of a location. When listing
                /// functions in all locations, if one or more location(s) are unreachable, the response will contain functions from all
                /// reachable locations along with the names of any unreachable locations.</param>
                ...
                public class ListRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v1.Data.ListFunctionsResponse>
                {
                    ...
                    /// a location. When listing functions in all locations, if one or more location(s) are unreachable,
                    /// the response will contain functions from all reachable locations along with the names of any
                    /// unreachable locations.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <summary>Sets the IAM access control policy on the specified function. Replaces any existing
                /// policy.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public class SetIamPolicyRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v1.Data.Policy>
                {
                    ...
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v1.Data.SetIamPolicyRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                ...
                /// <summary>Tests the specified permissions against the IAM access control policy for a function. If
                /// the function does not exist, this will return an empty set of permissions, not a NOT_FOUND
                /// error.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public class TestIamPermissionsRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v1.Data.TestIamPermissionsResponse>
                {
                    ...
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v1.Data.TestIamPermissionsRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
...
{    
    ...
    public class EventTrigger : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// must support it. Google Cloud Functions only allows EventTriggers to be deployed that observe resources in
        /// the same project as the `CloudFunction`. 2. The resource type must match the pattern expected for an
    ...
    public class SourceRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `https://source.developers.google.com/projects/repos/moveable-aliases/paths` In particular, to refer to HEAD
