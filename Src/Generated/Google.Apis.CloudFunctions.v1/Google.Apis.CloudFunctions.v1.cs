...
/**
 * \brief
 *   Cloud Functions API Version v1
 *
...
{    
    ...
    /// encapsulate function and triggers configurations. LINT.IfChange</summary>
    public class CloudFunction : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The limit on the maximum number of function instances that may coexist at a given time. This
        /// feature is currently in alpha, available only for whitelisted users.</summary>
        ...
        /// Cloud projects.
        ///
        /// This feature is currently in alpha, available only for whitelisted users.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("network")]
        public virtual string Network { get; set; } 

        /// <summary>The runtime in which the function is going to run. Example values include: `go111`: for Go 1.11
        /// `nodejs6`: for Node.js 6 `nodejs8`: for Node.js 8 `nodejs10`: for Node.js 10 `python37`: for Python 3.7
        /// `ruby25`: for Ruby 2.5
        ///
        /// If empty, defaults to `nodejs6`.</summary>
    ...
    public class EventTrigger : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// 1. namespace: For example, `cloud.storage` and `google.firebase.analytics`. 2. resource type: The type of
        /// resource on which event occurs. For example, the Google Cloud Storage API includes the type `object`. 3.
        /// action: The action that generates the event. For example, action for a Google Cloud Storage Object is
        /// 'change'. These parts are lower case.</summary>
