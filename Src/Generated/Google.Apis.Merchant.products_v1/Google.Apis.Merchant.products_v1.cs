...
namespace Google.Apis.Merchant.products_v1
{
    ...
    public class MerchantService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "products_v1";
    ...
    public class AccountsResource
    {
        ...
        public class ProductInputsResource
        {
            ...
            /// `{productInput}` segment must be the unpadded base64url encoding of this string, which is
            /// `ZW5-VVN-c2t1LzEyMw`. The full resource name for the product would be
            /// `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{productInput}` segment is
            /// the tilde-separated string `content_language~feed_label~offer_id`. This format is suitable only when
            ...
            /// `{productInput}` segment is used to differentiate between the two formats.
            /// </param>
            ...
            /// product input, it may take several minutes before the processed product can be retrieved.
            /// </summary>
            public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.products_v1.Data.Empty>
            {
                ...
                public override string RestPath => "products/v1/{+name}";
            ...
            /// account](/merchant/api/guides/products/add-manage#add_a_product). You must have a products [data
            /// source](/merchant/api/guides/data-sources/api-sources#create-primary-data-source) to be able to insert a
            ...
            /// </param>
            public virtual InsertRequest Insert(Google.Apis.Merchant.products_v1.Data.ProductInput body, string parent)
            {
            ...
            /// input, it may take several minutes before the processed product can be retrieved.
            /// </summary>
            public class InsertRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.products_v1.Data.ProductInput>
            {
                /// <summary>Constructs a new Insert request.</summary>
                public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.products_v1.Data.ProductInput body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// information, see [Create a primary data
                /// source](/merchant/api/guides/data-sources/api-sources#create-primary-data-source). Only API data
                /// sources are supported. Format: `accounts/{account}/dataSources/{datasource}`. For example,
                /// `accounts/123456/dataSources/104628`.
                /// </summary>
                [Google.Apis.Util.RequestParameterAttribute("dataSource", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string DataSource { get; set; }
                ...
                Google.Apis.Merchant.products_v1.Data.ProductInput Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "products/v1/{+parent}/productInputs:insert";
            ...
            /// resource name for the product would be `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.Merchant.products_v1.Data.ProductInput body, string name)
            {
            ...
            /// deleting a product input, it may take several minutes before the processed product can be retrieved.
            /// </summary>
            public class PatchRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.products_v1.Data.ProductInput>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.products_v1.Data.ProductInput body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// 1. **Encoded Format**: The `{productinput}` segment is an unpadded base64url encoded string (RFC
                ...
                /// `en~US~sku/123`, the `{productinput}` segment must be the unpadded base64url encoding of this
                /// string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource name for the product would be
                /// `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{productinput}` segment
                /// is the tilde-separated string `content_language~feed_label~offer_id`. This format is suitable only
                /// when `content_language`, `feed_label`, and `offer_id` do not contain URL-problematic characters like
                ...
                /// the `{productinput}` segment is used to differentiate between the two formats.
                /// </summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
        ...
        public class ProductsResource
        {
            ...
            /// product ID `en~US~sku/123`, the `{product}` segment must be the unpadded base64url encoding of this
            /// string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource name for the product would be
            ...
            /// deleting a product input, it may take several minutes before the updated final product can be retrieved.
            /// </summary>
            public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.products_v1.Data.Product>
            {
            ...
            /// processed product can be retrieved.
            /// </summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.products_v1.Data.ListProductsResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "products/v1/{+parent}/products";
...
namespace Google.Apis.Merchant.products_v1.Data
{
    ...
    public class Product : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. A list of strongly-typed product attributes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("productAttributes")]
    ...
    public class ProductAttributes : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Availability](https://support.google.com/merchants/answer/6324448) status of the item.</summary>
        ...
        /// <summary>[Condition](https://support.google.com/merchants/answer/6324469) or state of the item.</summary>
        ...
        /// <summary>
        /// System in which the size is specified. Recommended for apparel items. For more information, see [Size
    ...
    {
        /// <summary>The certification authority.</summary>
    ...
    public class ProductInput : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `content_language~feed_label~offer_id` structure. This encoding MUST be used if any part of the product
        /// identifier (like `offer_id`) contains characters such as `/`, `%`, or `~`. * Example: To represent the
        /// product ID `en~US~sku/123`, the `{productinput}` segment must be the unpadded base64url encoding of this
        /// string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource name for the product would be
        /// `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{productinput}` segment is the
        /// tilde-separated string `content_language~feed_label~offer_id`. This format is suitable only when
        ...
        /// <summary>Optional. A list of strongly-typed product attributes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("productAttributes")]
        public virtual ProductAttributes ProductAttributes { get; set; }
    ...
    public class ProductInstallment : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Structured description, for algorithmically (AI)-generated descriptions.</summary>
    public class StructuredDescription : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Structured title, for algorithmically (AI)-generated titles.</summary>
    public class StructuredTitle : Google.Apis.Requests.IDirectResponseSchema
    {
