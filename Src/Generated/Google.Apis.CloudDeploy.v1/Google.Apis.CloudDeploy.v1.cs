...
namespace Google.Apis.CloudDeploy.v1.Data
{
    ...
    public class AutomationRun : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. Unique identifier of the `AutomationRun`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uid")]
        public virtual string Uid { get; set; }
    ...
    public class Config : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. Default tool versions. These tool versions are assigned when a Release is created without
        /// specifying tool versions.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("defaultToolVersions")]
        public virtual ToolVersions DefaultToolVersions { get; set; }
    ...
    public class ContainerTask : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Shell script to execute. If provided then command and args cannot be specified.</summary>
