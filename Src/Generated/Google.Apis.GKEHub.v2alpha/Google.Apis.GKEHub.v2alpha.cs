...
namespace Google.Apis.GKEHub.v2alpha
{
        ...
        public class LocationsResource
        {
            ...
            public class MembershipsResource
            {
                ...
                public class FeaturesResource
                {
                    ...
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.GKEHub.v2alpha.Data.MembershipFeature body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates membershipFeature under a given parent.</summary>
                    public class CreateRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Operation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v2alpha.Data.MembershipFeature body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        Google.Apis.GKEHub.v2alpha.Data.MembershipFeature Body { get; set; }
                        ...
                        public override string RestPath => "v2alpha/{+parent}/features";
                    ...
                    /// <summary>Removes a membershipFeature.</summary>
                    public class DeleteRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Operation>
                    {
                    ...
                    /// ========= MembershipFeature Services ========= Gets details of a membershipFeature.
                    /// </summary>
                    public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.MembershipFeature>
                    {
                    ...
                    /// <summary>Lists MembershipFeatures in a given project and location.</summary>
                    public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.ListMembershipFeaturesResponse>
                    {
                    ...
                    /// </param>
                    public virtual PatchRequest Patch(Google.Apis.GKEHub.v2alpha.Data.MembershipFeature body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }

                    /// <summary>Updates an existing MembershipFeature.</summary>
                    public class PatchRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Operation>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v2alpha.Data.MembershipFeature body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.GKEHub.v2alpha.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v2alpha.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GKEHub.v2alpha.Data.CancelOperationRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v2alpha/{+name}:cancel";
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
