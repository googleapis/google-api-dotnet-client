...
namespace Google.Apis.GKEHub.v2alpha
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            {
                this.service = service;
                FeatureConfigs = new FeatureConfigsResource(service);
                Memberships = new MembershipsResource(service);
                Operations = new OperationsResource(service);
            }

            /// <summary>Gets the FeatureConfigs resource.</summary>
            public virtual FeatureConfigsResource FeatureConfigs { get; }

            /// <summary>The "featureConfigs" collection of methods.</summary>
            public class FeatureConfigsResource
            {
                private const string Resource = "featureConfigs";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public FeatureConfigsResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }

                /// <summary>Creates FeatureConfig under a given parent.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">
                /// Required. The name of parent where the FeatureConfig will be created. Specified in the format
                /// `projects/{project}/locations/global/featureConfigs/{feature_type}/{feature_config}/`.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.GKEHub.v2alpha.Data.FeatureConfig body, string parent)
                {
                ...
                public class CreateRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v2alpha.Data.FeatureConfig body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>The ID of the feature config to create.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("featureConfigId", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string FeatureConfigId { get; set; }
                    ...
                    Google.Apis.GKEHub.v2alpha.Data.FeatureConfig Body { get; set; }
                    ...
                    public override string RestPath => "v2alpha/{+parent}/featureConfigs";
                    ...
                    protected override void InitParameters()
                    {
                        ...
                        RequestParameters.Add("featureConfigId", new Google.Apis.Discovery.Parameter
                        {
                            Name = "featureConfigId",
                            IsRequired = false,
                            ParameterType = "query",
                            DefaultValue = null,
                            Pattern = null,
                ...
                /// <summary>Removes a FeatureConfig.</summary>
                /// <param name="name">
                ...
                /// <summary>========= FeatureConfig Services ========= Gets details of a featureConfig.</summary>
                /// <param name="name">
                /// Required. The FeatureConfig resource name in the format `projects/*/locations/*/featureConfigs/**`.
                /// </param>
                ...
                /// <summary>========= FeatureConfig Services ========= Gets details of a featureConfig.</summary>
                public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.FeatureConfig>
                {
                    ...
                    /// <summary>
                    /// Required. The FeatureConfig resource name in the format
                    /// `projects/*/locations/*/featureConfigs/**`.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <summary>Lists all FeatureConfigs in a given project and location.</summary>
                /// <param name="parent">
                ...
                /// <summary>Lists all FeatureConfigs in a given project and location.</summary>
                public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v2alpha.Data.ListFeatureConfigsResponse>
                {
                    ...
                    /// <summary>
                    /// Lists FeatureConfigs that match the filter expression, following the syntax outlined in
...
namespace Google.Apis.GKEHub.v2alpha.Data
{
    ...
    /// <summary>
    /// FeatureConfig contains configurations for a Fleet feature. FeatureConfig can be applied to MembershipFeature(s)
    /// to setup per-membership FeatureSpec.
    /// </summary>
    public class FeatureConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. When the FeatureConfig resource was created.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("createTime")]
        public virtual object CreateTime { get; set; }

        /// <summary>Output only. When the FeatureConfig resource was deleted.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("deleteTime")]
        public virtual object DeleteTime { get; set; }

        /// <summary>GCP labels for this FeatureConfig.</summary>
        ...
        /// <summary>
        /// Input only. Immutable. User input of feature spec. Note that this field is immutable. Must create a new
        /// FeatureConfig if a new feature spec is needed.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("spec")]
        public virtual FeatureSpec Spec { get; set; }

        /// <summary>Lifecycle information of the FeatureConfig.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual FeatureConfigState State { get; set; }

        /// <summary>
        /// Output only. Google-generated UUID for this resource. This is unique across all FeatureConfig resources. If
        /// a Membership resource is deleted and another resource with the same name is created, it gets a different
        /// unique_id.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uniqueId")]
        public virtual string UniqueId { get; set; }

        /// <summary>Output only. When the FeatureConfig resource was last updated.</summary>
    ...
    /// <summary>FeatureConfigState describes the state of a FeatureConfig resource.</summary>
    public class FeatureConfigState : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. The current state of the FeatureConfig resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
    ...
    /// <summary>Response message for the `GkeHubFeature.ListFeatureConfigs` method.</summary>
    public class ListFeatureConfigsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The list of FeatureConfig(s).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("featureConfigs")]
        public virtual System.Collections.Generic.IList<FeatureConfig> FeatureConfigs { get; set; }

        /// <summary>
        /// A token to request the next page of resources from the `ListFeatureConfigs` method. The value of an empty
    ...
    public class MembershipFeature : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Lifecycle information of the resource itself.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("resourceState")]
        public virtual ResourceState ResourceState { get; set; }

        /// <summary>Output only. Spec of this membershipFeature.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("spec")]
        public virtual FeatureSpec Spec { get; set; }
    ...
    /// <summary>
    /// ResourceState describes the state of a MembershipFeature *resource* in the GkeHub API. See `FeatureState` for
    /// the "running state" of the MembershipFeature.
    /// </summary>
    public class ResourceState : Google.Apis.Requests.IDirectResponseSchema
    {
