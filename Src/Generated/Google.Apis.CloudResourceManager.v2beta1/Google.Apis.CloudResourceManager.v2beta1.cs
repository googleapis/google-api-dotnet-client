...
namespace Google.Apis.CloudResourceManager.v2beta1
{
    ...
    public class FoldersResource
    {
        ...
        /// of 4. Note, the full active + deleted Folder hierarchy is allowed to reach a height of 8; this provides
        /// additional headroom when moving folders that contain deleted folders. + The addition of the Folder must not
        /// cause the total number of Folders under its parent to exceed 100. If the operation fails due to a folder
        ...
        public class CreateRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Operation>
        {
            ...
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.Folder body) : base(service)
            {
                Body = body;
                InitParameters();
            }
        ...
        public class GetIamPolicyRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Policy>
        {
            ...
            public GetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.GetIamPolicyRequest body, string resource) : base(service)
            {
                Resource = resource;
                Body = body;
                InitParameters();
        ...
        public class MoveRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Operation>
        {
            ...
            public MoveRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.MoveFolderRequest body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
        ...
        public class PatchRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Folder>
        {
            ...
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.Folder body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
        ...
        /// view of the folders a user has access to which meet the specified filter criteria. This will only return
        /// folders on which the caller has the permission `resourcemanager.folders.get`.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        public class SearchRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.SearchFoldersResponse>
        {
            ...
            public SearchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.SearchFoldersRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
        ...
        public class SetIamPolicyRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Policy>
        {
            ...
            public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.SetIamPolicyRequest body, string resource) : base(service)
            {
                Resource = resource;
                Body = body;
                InitParameters();
        ...
        /// Folder's resource name, e.g. "folders/1234". There are no permissions required for making this API
        /// call.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        public class TestIamPermissionsRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.TestIamPermissionsResponse>
        {
            ...
            public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.TestIamPermissionsRequest body, string resource) : base(service)
            {
                Resource = resource;
                Body = body;
                InitParameters();
        ...
        public class UndeleteRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Folder>
        {
            ...
            public UndeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2beta1.Data.UndeleteFolderRequest body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
    ...
    public class OperationsResource
    {
        ...
        /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
        /// operation result at intervals as recommended by the API service.</summary>
        public class GetRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2beta1.Data.Operation>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
            {
...
{    
    ...
    public class SearchFoldersRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// accessible folders will be returned. Query expressions can be used to restrict results based upon
        /// displayName, lifecycleState and parent, where the operators `=`, `NOT`, `AND` and `OR` can be used along
        /// with the suffix wildcard symbol `*`. The displayName field in a query expression should use escaped quotes
        /// for values that include whitespace to prevent unexpected behavior. Some example queries are: * Query
