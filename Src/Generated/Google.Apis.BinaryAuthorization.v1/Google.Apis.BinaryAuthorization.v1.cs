...
namespace Google.Apis.BinaryAuthorization.v1.Data
{
    ...
    public class PkixPublicKey : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// public key that can be used to verify them, and that ID must match the contents of this field exactly. This
        /// may be explicitly provided by the caller, but it MUST be a valid RFC3986 URI. If `key_id` is left blank and
        /// this `PkixPublicKey` is not used in the context of a wrapper (see next paragraph), a default key ID will be
        /// computed based on the digest of the DER encoding of the public key. If this `PkixPublicKey` is used in the
        /// context of a wrapper that has its own notion of key ID (e.g. `AttestorPublicKey`), then this field can
        /// either: * Match that value exactly. * Or be left blank, in which case it behaves exactly as though it is
        /// equal to that wrapper value.
        /// </summary>
    ...
    public class UserOwnedGrafeasNote : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `projects/*/notes/*`. This field may not be updated. An attestation by this attestor is stored as a Grafeas
        /// Attestation.Authority Occurrence that names a container image and that links to this Note. Grafeas is an
        /// external dependency.
        /// </summary>
