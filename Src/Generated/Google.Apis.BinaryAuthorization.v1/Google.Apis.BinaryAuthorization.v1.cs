    ...
    public class ProjectsResource
    {
        ...
        public class AttestorsResource
        {
            ...
            public class CreateRequest : BinaryAuthorizationBaseServiceRequest<Google.Apis.BinaryAuthorization.v1.Data.Attestor>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.BinaryAuthorization.v1.Data.Attestor body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            public class UpdateRequest : BinaryAuthorizationBaseServiceRequest<Google.Apis.BinaryAuthorization.v1.Data.Attestor>
            {
                ...
                public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.BinaryAuthorization.v1.Data.Attestor body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
        ...
        public class UpdatePolicyRequest : BinaryAuthorizationBaseServiceRequest<Google.Apis.BinaryAuthorization.v1.Data.Policy>
        {
            ...
            public UpdatePolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.BinaryAuthorization.v1.Data.Policy body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
...
{    
    ...
    /// <summary>An user owned Grafeas note references a Grafeas Attestation.Authority Note created by the
    /// user.</summary>
