...
namespace Google.Apis.CloudUserAccounts.vm_beta
{
    ...
    public class CloudUserAccountsService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "vm_beta";
        ...
        {
            get { return "https://www.googleapis.com/clouduseraccounts/vm_beta/projects/"; }
        }

        /// <summary>Gets the service base path.</summary>
        public override string BasePath
        {
            get { return "clouduseraccounts/vm_beta/projects/"; }
        }
        ...
        {
            get { return "https://www.googleapis.com/batch/clouduseraccounts/vm_beta"; }
        }

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath
        {
            get { return "batch/clouduseraccounts/vm_beta"; }
        }
        #endif
    ...
    public class GlobalAccountsOperationsResource
    {
        ...
        /// <summary>Retrieves the specified operation resource.</summary>
        public class GetRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
        ...
        /// <summary>Retrieves the list of operation resources contained within the specified project.</summary>
        public class ListRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.OperationList>
        {
    ...
    public class GroupsResource
    {
        ...
        /// this request.</param>
        public virtual AddMemberRequest AddMember(Google.Apis.CloudUserAccounts.vm_beta.Data.GroupsAddMemberRequest body, string project, string groupName)
        {
            return new AddMemberRequest(service, body, project, groupName);
        }

        /// <summary>Adds users to the specified group.</summary>
        public class AddMemberRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
            /// <summary>Constructs a new AddMember request.</summary>
            public AddMemberRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudUserAccounts.vm_beta.Data.GroupsAddMemberRequest body, string project, string groupName)
                : base(service)
            {
                Project = project;
                GroupName = groupName;
            ...
            Google.Apis.CloudUserAccounts.vm_beta.Data.GroupsAddMemberRequest Body { get; set; }
        ...
        /// <summary>Deletes the specified Group resource.</summary>
        public class DeleteRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
            /// <summary>Constructs a new Delete request.</summary>
        ...
        /// <summary>Returns the specified Group resource.</summary>
        public class GetRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Group>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Project ID for this request.</param>
        public virtual InsertRequest Insert(Google.Apis.CloudUserAccounts.vm_beta.Data.Group body, string project)
        {
            return new InsertRequest(service, body, project);
        }

        /// <summary>Creates a Group resource in the specified project using the data included in the request.</summary>
        public class InsertRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudUserAccounts.vm_beta.Data.Group body, string project)
                : base(service)
            {
                Project = project;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudUserAccounts.vm_beta.Data.Group Body { get; set; }
        ...
        /// <summary>Retrieves the list of groups contained within the specified project.</summary>
        public class ListRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.GroupList>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project)
                : base(service)
        ...
        /// <param name="groupName">Name of the group for
        /// this request.</param>
        public virtual RemoveMemberRequest RemoveMember(Google.Apis.CloudUserAccounts.vm_beta.Data.GroupsRemoveMemberRequest body, string project, string groupName)
        {
            return new RemoveMemberRequest(service, body, project, groupName);
        }

        /// <summary>Removes users from the specified group.</summary>
        public class RemoveMemberRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
            /// <summary>Constructs a new RemoveMember request.</summary>
            public RemoveMemberRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudUserAccounts.vm_beta.Data.GroupsRemoveMemberRequest body, string project, string groupName)
                : base(service)
            {
                Project = project;
                GroupName = groupName;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudUserAccounts.vm_beta.Data.GroupsRemoveMemberRequest Body { get; set; }
    ...
    public class LinuxResource
    {
        ...
        /// <summary>Returns a list of authorized public keys for a specific user account.</summary>
        public class GetAuthorizedKeysViewRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.LinuxGetAuthorizedKeysViewResponse>
        {
        ...
        /// <summary>Retrieves a list of user accounts for an instance within a specific project.</summary>
        public class GetLinuxAccountViewsRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.LinuxGetLinuxAccountViewsResponse>
        {
    ...
    public class UsersResource
    {
        ...
        /// request.</param>
        public virtual AddPublicKeyRequest AddPublicKey(Google.Apis.CloudUserAccounts.vm_beta.Data.PublicKey body, string project, string user)
        {
            return new AddPublicKeyRequest(service, body, project, user);
        }

        /// <summary>Adds a public key to the specified User resource with the data included in the request.</summary>
        public class AddPublicKeyRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
            /// <summary>Constructs a new AddPublicKey request.</summary>
            public AddPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudUserAccounts.vm_beta.Data.PublicKey body, string project, string user)
                : base(service)
            {
                Project = project;
                User = user;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudUserAccounts.vm_beta.Data.PublicKey Body { get; set; }
        ...
        /// <summary>Returns the specified User resource.</summary>
        public class GetRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.User>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Project ID for this request.</param>
        public virtual InsertRequest Insert(Google.Apis.CloudUserAccounts.vm_beta.Data.User body, string project)
        {
            return new InsertRequest(service, body, project);
        }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudUserAccounts.vm_beta.Data.User body, string project)
                : base(service)
            {
                Project = project;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudUserAccounts.vm_beta.Data.User Body { get; set; }
        ...
        /// <summary>Retrieves a list of users contained within the specified project.</summary>
        public class ListRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.UserList>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project)
                : base(service)
        ...
        /// <summary>Removes the specified public key from the user.</summary>
        public class RemovePublicKeyRequest : CloudUserAccountsBaseServiceRequest<Google.Apis.CloudUserAccounts.vm_beta.Data.Operation>
        {
...
namespace Google.Apis.CloudUserAccounts.vm_beta.Data
{    
