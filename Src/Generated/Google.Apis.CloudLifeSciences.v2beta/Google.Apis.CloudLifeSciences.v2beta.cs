...
namespace Google.Apis.CloudLifeSciences.v2beta
{
    ...
    public class CloudLifeSciencesService : Google.Apis.Services.BaseClientService
    {
        ...
        public CloudLifeSciencesService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public CloudLifeSciencesService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class CloudLifeSciencesBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected CloudLifeSciencesBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                /// effort to cancel the operation, but success is not guaranteed. Clients may use
                /// Operations.GetOperation or Operations.ListOperations to check whether the cancellation succeeded or
                /// the operation completed despite cancellation. Authorization requires the following [Google
                /// IAM](https://cloud.google.com/iam) permission: * `lifesciences.operations.cancel`</summary>
                ...
                public class CancelRequest : CloudLifeSciencesBaseServiceRequest<Google.Apis.CloudLifeSciences.v2beta.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudLifeSciences.v2beta.Data.CancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// `lifesciences.operations.get`</summary>
                ...
                /// following [Google IAM](https://cloud.google.com/iam) permission: *
                /// `lifesciences.operations.list`</summary>
                ...
                public class ListRequest : CloudLifeSciencesBaseServiceRequest<Google.Apis.CloudLifeSciences.v2beta.Data.ListOperationsResponse>
                {
                    ...
                    /// occurred. * error: If the pipeline is running, this value is NULL. Once the pipeline finishes,
                    /// the value is the standard Google error code. * labels.key or labels."key with space" where key
                    /// is a label key. * done: If the pipeline is running, this value is false. Once the pipeline
                    /// finishes, the value is true.</summary>
            ...
            public class PipelinesResource
            {
                ...
                /// following [Google IAM](https://cloud.google.com/iam/) permission: *
                /// `lifesciences.workflows.run`</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public class RunRequest : CloudLifeSciencesBaseServiceRequest<Google.Apis.CloudLifeSciences.v2beta.Data.Operation>
                {
                    ...
                    public RunRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudLifeSciences.v2beta.Data.RunPipelineRequest body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
...
{    
    ...
    public class Action : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>All container images are typically downloaded before any actions are executed. This helps prevent
        /// typos in URIs or issues like lack of disk space from wasting large amounts of compute resources. If set,
        /// this flag prevents the worker from downloading the image until just before the action is executed.</summary>
        ...
        /// <summary>A small portion of the container's standard error stream is typically captured and returned inside
        /// the `ContainerStoppedEvent`. Setting this flag disables this functionality.</summary>
        ...
        /// <summary>Enable access to the FUSE device for this action. Filesystems can then be mounted into disks shared
        /// with other actions. The other actions do not need the `enable_fuse` flag to access the mounted filesystem.
        /// This has the effect of causing the container to be executed with `CAP_SYS_ADMIN` and exposes `/dev/fuse` to
        /// the container, so use it only for containers you trust.</summary>
        ...
        /// to determine whether an individual action has succeeded or failed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("environment")]
        public virtual System.Collections.Generic.IDictionary<string,string> Environment { get; set; } 

        /// <summary>Normally, a non-zero exit status causes the pipeline to fail. This flag allows execution of other
        /// actions to continue instead.</summary>
        ...
        /// must be specified in the google.cloud.lifesciences.v2beta.Action.credentials field.</summary>
        ...
        /// <summary>Exposes all ports specified by `EXPOSE` statements in the container. To discover the host side port
        /// numbers, consult the `ACTION_STARTED` event in the operation metadata.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("publishExposedPorts")]
        public virtual System.Nullable<bool> PublishExposedPorts { get; set; } 

        /// <summary>This flag allows an action to continue running in the background while executing subsequent
        /// actions. This is useful to provide services to other actions (or to provide debugging support tools like SSH
        /// servers).</summary>
    ...
    public class Operation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The server-assigned name for the operation. This may be passed to the other operation methods to
        /// retrieve information about the operation's status.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    /// `iam.serviceAccounts.actAs` permission for the Cloud Life Sciences service account or the request will
    /// fail.</summary>
