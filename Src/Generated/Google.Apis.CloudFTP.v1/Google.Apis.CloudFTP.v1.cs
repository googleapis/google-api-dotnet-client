    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.CloudFTP.v1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.CloudFTP.v1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Empty>
                {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Operation>
                {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.ListOperationsResponse>
                {
            ...
            public class ServersResource
            {
                ...
                public class UsersResource
                {
                    ...
                    public virtual CreateRequest Create(Google.Apis.CloudFTP.v1.Data.User body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new User in a given project and location and Server.</summary>
                    public class CreateRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.User body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudFTP.v1.Data.User Body { get; set; }
                    ...
                    /// <summary>Deletes a single User.</summary>
                    public class DeleteRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Delete request.</summary>
                        public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Gets details of a single User.</summary>
                    public class GetRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.User>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists Users in a given project and location.</summary>
                    public class ListRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.ListUsersResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                    ...
                    /// </param>
                    public virtual PatchRequest Patch(Google.Apis.CloudFTP.v1.Data.User body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }

                    /// <summary>Updates the parameters of a single User.</summary>
                    public class PatchRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.User body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Required. Value for parent.</param>
                public virtual CreateRequest Create(Google.Apis.CloudFTP.v1.Data.Server body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.Server body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFTP.v1.Data.Server Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/servers";
                ...
                /// <summary>Gets details of a single Server.</summary>
                public class GetRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Server>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists Servers in a given project and location.</summary>
                public class ListRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.ListServersResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                public virtual PatchRequest Patch(Google.Apis.CloudFTP.v1.Data.Server body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.Server body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// </param>
                public virtual StartRequest Start(Google.Apis.CloudFTP.v1.Data.StartServerRequest body, string name)
                {
                    return new StartRequest(this.service, body, name);
                }

                /// <summary>Starts a stopping/stopped Server.</summary>
                public class StartRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Start request.</summary>
                    public StartRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.StartServerRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFTP.v1.Data.StartServerRequest Body { get; set; }
                ...
                /// Required. Name of the resource. Format: `projects/{project}/locations/{location}/servers/{server}`
                /// </param>
                public virtual StopRequest Stop(Google.Apis.CloudFTP.v1.Data.StopServerRequest body, string name)
                {
                    return new StopRequest(this.service, body, name);
                }

                /// <summary>Stops an active Server.</summary>
                public class StopRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Stop request.</summary>
                    public StopRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFTP.v1.Data.StopServerRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFTP.v1.Data.StopServerRequest Body { get; set; }
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// specific service implementation and version.
            /// </summary>
            public class ListRequest : CloudFTPBaseServiceRequest<Google.Apis.CloudFTP.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
