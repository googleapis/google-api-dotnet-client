        ...
        public class LocationsResource
        {
            ...
            public class JobsResource
            {
                ...
                public class CreateRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1.Data.Job>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1.Data.Job body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                ...
                public class PatchRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1.Data.Job>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1.Data.Job body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                public class PauseRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1.Data.Job>
                {
                    ...
                    public PauseRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1.Data.PauseJobRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                public class ResumeRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1.Data.Job>
                {
                    ...
                    public ResumeRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1.Data.ResumeJobRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                public class RunRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1.Data.Job>
                {
                    ...
                    public RunRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1.Data.RunJobRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
