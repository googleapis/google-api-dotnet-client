...
{    
    ...
    public class CheckError : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Contains public information about the check error. If available, `status.code` will be non zero and
        /// client can propagate it out as public error.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("status")]
        public virtual Status Status { get; set; }
    ...
    public class MetricValue : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The end of the time period over which this metric value's measurement applies. If not specified,
        /// google.api.servicecontrol.v1.Operation.end_time will be used.</summary>
        ...
        /// google.api.servicecontrol.v1.Operation.start_time will be used.</summary>
    ...
    public class QuotaError : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Contains additional information about the quota error. If available, `status.code` will be non
        /// zero.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("status")]
        public virtual Status Status { get; set; }
    ...
    public class Resource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The unique identifier of the resource. UID is unique in the time and space for this resource within
        /// the scope of the service. It is typically generated by the server on successful creation of a resource and
        /// must not be changed. UID is used to uniquely identify resources with resource name reuses. This should be a
        /// UUID4.</summary>
    ...
    public class ServiceAccountDelegationInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A string representing the principal_subject associated with the identity. See go/3pical for more
        /// info on how principal_subject is formatted.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("principalSubject")]
        public virtual string PrincipalSubject { get; set; }
