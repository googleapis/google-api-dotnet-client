...
namespace Google.Apis.CloudOSLogin.v1
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            /// </param>
            public virtual SignSshPublicKeyRequest SignSshPublicKey(Google.Apis.CloudOSLogin.v1.Data.SignSshPublicKeyRequest body, string parent)
            {
            ...
            /// Signs an SSH public key for a user to authenticate to a virtual machine on Google Compute Engine.
            /// </summary>
            public class SignSshPublicKeyRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1.Data.SignSshPublicKeyResponse>
            {
                /// <summary>Constructs a new SignSshPublicKey request.</summary>
                public SignSshPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1.Data.SignSshPublicKeyRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.CloudOSLogin.v1.Data.SignSshPublicKeyRequest Body { get; set; }
                ...
                public override string RestPath => "v1/{+parent}:signSshPublicKey";
    ...
    public class UsersResource
    {
        ...
        public class SshPublicKeysResource
        {
            ...
            /// <summary>Create an SSH public key</summary>
            public class CreateRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1.Data.SshPublicKey>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1.Data.SshPublicKey body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
            ...
            public class PatchRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1.Data.SshPublicKey>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1.Data.SshPublicKey body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
        ...
        public class ImportSshPublicKeyRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1.Data.ImportSshPublicKeyResponse>
        {
            ...
            public ImportSshPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1.Data.SshPublicKey body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
