...
{    
    ...
    /// <summary>Per resource and severity counts of fixable and total vulnerabilites.</summary>
    ...
    public class PackageIssue : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The severity (e.g., distro assigned severity) for this vulnerability.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("severityName")]
        public virtual string SeverityName { get; set; } 
    ...
    {
        /// <summary>The hash of the resource content. For example, the Docker digest.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("contentHash")]
        public virtual Hash ContentHash { get; set; } 

        /// <summary>The name of the resource. For example, the name of a Docker image - "Debian".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
