...
namespace Google.Apis.Vision.v1p2beta1
{
    ...
    public class FilesResource
    {
        ...
        public class AnnotateRequest : VisionBaseServiceRequest<Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse>
        {
            ...
            public AnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest body)
                : base(service)
            {
                Body = body;
                InitParameters();
        ...
        public class AsyncBatchAnnotateRequest : VisionBaseServiceRequest<Google.Apis.Vision.v1p2beta1.Data.Operation>
        {
            ...
            public AsyncBatchAnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest body)
                : base(service)
            {
                Body = body;
                InitParameters();
    ...
    public class ImagesResource
    {
        ...
        {
            /// <summary>Constructs a new Annotate request.</summary>
            public AnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest body)
                : base(service)
            {
                Body = body;
                InitParameters();
        ...
        {
            /// <summary>Constructs a new AsyncBatchAnnotate request.</summary>
            public AsyncBatchAnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest body)
                : base(service)
            {
                Body = body;
                InitParameters();
    ...
    public class ProjectsResource
    {
        ...
        public class FilesResource
        {
            ...
            {
                /// <summary>Constructs a new Annotate request.</summary>
                public AnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            {
                /// <summary>Constructs a new AsyncBatchAnnotate request.</summary>
                public AsyncBatchAnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
        ...
        public class ImagesResource
        {
            ...
            {
                /// <summary>Constructs a new Annotate request.</summary>
                public AnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            {
                /// <summary>Constructs a new AsyncBatchAnnotate request.</summary>
                public AsyncBatchAnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.Vision.v1p2beta1.Data.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
