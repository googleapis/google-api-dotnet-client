...
namespace Google.Apis.Vision.v1p2beta1
{
    ...
    public class FilesResource
    {
        ...
        /// <summary>Run async image detection and annotation for a list of generic files (e.g. PDF) which may contain
        /// multiple pages and multiple images per page. Progress and results can be retrieved through the
...
{    
    ...
    {
        /// <summary>Google Cloud Storage URI for the input file. This must only be a GCS object. Wildcards are not
        /// currently supported.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uri")]
        public virtual string Uri { get; set; } 
