...
namespace Google.Apis.PubsubLite.v1
{
    ...
    public class PubsubLiteService : Google.Apis.Services.BaseClientService
    {
        ...
        public PubsubLiteService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public PubsubLiteService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class PubsubLiteBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected PubsubLiteBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
            ...
            public class LocationsResource
            {
                ...
                public class SubscriptionsResource
                {
                    ...
                    public class CreateRequest : PubsubLiteBaseServiceRequest<Google.Apis.PubsubLite.v1.Data.Subscription>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.PubsubLite.v1.Data.Subscription body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    public class PatchRequest : PubsubLiteBaseServiceRequest<Google.Apis.PubsubLite.v1.Data.Subscription>
                    {
                        ...
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.PubsubLite.v1.Data.Subscription body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                ...
                public class TopicsResource
                {
                    ...
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.PubsubLite.v1.Data.Topic body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    public class GetPartitionsRequest : PubsubLiteBaseServiceRequest<Google.Apis.PubsubLite.v1.Data.TopicPartitions>
                    {
                        ...
                        public GetPartitionsRequest(Google.Apis.Services.IClientService service, string name)
                            : base(service)
                        {
                            Name = name;
                            InitParameters();
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.PubsubLite.v1.Data.Topic body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
...
{    
    ...
    public class PartitionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Every partition in the topic is allocated throughput equivalent to `scale` times the standard
        /// partition throughput (4 MiB/s). This is also reflected in the cost of this topic; a topic with `scale` of 2
        /// and count of 10 is charged for 20 partitions. This value must be in the range [1,4].</summary>
