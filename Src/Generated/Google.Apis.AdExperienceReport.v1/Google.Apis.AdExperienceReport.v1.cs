...
namespace Google.Apis.AdExperienceReport.v1
{
    ...
    public class ViolatingSitesResource
    {
        ...
        /// <summary>Lists sites with Ad Experience Report statuses of "Reviewed - out of compliance," "Reviewed -
        /// significantly out of compliance," or "Failed review - egregious issues found."</summary>
...
{    
    ...
    public class PlatformSummary : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The status of the site reviewed for egregious ads.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("egregiousStatus")]
        public virtual string EgregiousStatus { get; set; } 
