...
namespace Google.Apis.GameServices.v1
{
        ...
        public class LocationsResource
        {
            ...
            public class GameServerDeploymentsResource
            {
                ...
                public class ConfigsResource
                {
                    ...
                    /// <param name="parent">Required. The parent resource name, in the following form:
                    /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/`.</param>
                    public virtual CreateRequest Create(Google.Apis.GameServices.v1.Data.GameServerConfig body, string parent)
                    {
                    ...
                    /// deployment. Game server configs are immutable, and are not applied until referenced in the game
                    /// server deployment rollout resource.</summary>
                    public class CreateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerConfig body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Required. The parent resource name, in the following form:
                        ...
                        Google.Apis.GameServices.v1.Data.GameServerConfig Body { get; set; }
                    ...
                    /// <param name="name">Required. The name of the game server config to delete, in the following form:
                    ...
                    /// <summary>Deletes a single game server config. The deletion will fail if the game server config
                    /// is referenced in a game server deployment rollout.</summary>
                    public class DeleteRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                    {
                        ...
                        /// <summary>Required. The name of the game server config to delete, in the following form: `pro
                        /// jects/{project}/locations/{location}/gameServerDeployments/{deployment}/configs/{config}`.</
                        /// summary>
                    ...
                    /// <param name="name">Required. The name of the game server config to retrieve, in the following form:
                    /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/configs/{config}`.</param>
                    ...
                    /// <summary>Gets details of a single game server config.</summary>
                    public class GetRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.GameServerConfig>
                    {
                        ...
                        /// <summary>Required. The name of the game server config to retrieve, in the following form: `p
                        /// rojects/{project}/locations/{location}/gameServerDeployments/{deployment}/configs/{config}`.
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    /// <summary>Lists game server configs in a given project, location, and game server
                    /// deployment.</summary>
                    public class ListRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.ListGameServerConfigsResponse>
                    {
                        ...
                        /// <summary>Required. The parent resource name, in the following form: `projects/{project}/loca
                        /// tions/{location}/gameServerDeployments/{deployment}/configs`.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }
                        ...
                        /// <summary>Optional. Specifies the ordering of results following syntax at
                        /// https://cloud.google.com/apis/design/design_patterns#sorting_order.</summary>
                        ...
                        /// rely on response's next_page_token to determine if there are more GameServerConfigs left to
                        /// be queried.</summary>
                ...
                public virtual CreateRequest Create(Google.Apis.GameServices.v1.Data.GameServerDeployment body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerDeployment body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.GameServerDeployment Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/gameServerDeployments";
                ...
                /// <param name="name">Required. The name of the game server delpoyment to delete, in the following form:
                /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.</param>
                public virtual DeleteRequest Delete(string name)
                {
                    return new DeleteRequest(service, name);
                ...
                public class DeleteRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                {
                    ...
                    /// <summary>Required. The name of the game server delpoyment to delete, in the following form:
                    /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The name of the game server delpoyment, in the following form:
                /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.</param>
                public virtual FetchDeploymentStateRequest FetchDeploymentState(Google.Apis.GameServices.v1.Data.FetchDeploymentStateRequest body, string name)
                {
                ...
                /// the Agones fleets and Agones autoscalers, including fleets running an older version of the game
                /// server deployment.</summary>
                public class FetchDeploymentStateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.FetchDeploymentStateResponse>
                {
                    /// <summary>Constructs a new FetchDeploymentState request.</summary>
                    public FetchDeploymentStateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.FetchDeploymentStateRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Required. The name of the game server delpoyment, in the following form:
                    /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.FetchDeploymentStateRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:fetchDeploymentState";
                ...
                /// <param name="name">Required. The name of the game server delpoyment to retrieve, in the following form:
                /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                /// <summary>Gets details of a single game server deployment.</summary>
                public class GetRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.GameServerDeployment>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                    ...
                    /// <summary>Required. The name of the game server delpoyment to retrieve, in the following form:
                    /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <summary>Gets the access control policy for a resource. Returns an empty policy if the resource
                /// exists and does not have a policy set.</summary>
                public class GetIamPolicyRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Policy>
                {
                ...
                /// <summary>Gets details a single game server deployment rollout.</summary>
                public class GetRolloutRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.GameServerDeploymentRollout>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}/rollout";
                ...
                /// <summary>Lists game server deployments in a given project and location.</summary>
                public class ListRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.ListGameServerDeploymentsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The resource name of the game server deployment, in the following form:
                /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`. For example, `projects/my-
                /// project/locations/global/gameServerDeployments/my-deployment`.</param>
                public virtual PatchRequest Patch(Google.Apis.GameServices.v1.Data.GameServerDeployment body, string name)
                {
                    return new PatchRequest(service, body, name);
                }

                /// <summary>Patches a game server deployment.</summary>
                public class PatchRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerDeployment body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>The resource name of the game server deployment, in the following form:
                    /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`. For example,
                    /// `projects/my-project/locations/global/gameServerDeployments/my-deployment`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// resource.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The resource name of the game server deployment rollout, in the following form:
                /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/rollout`. For example, `projects/my-
                /// project/locations/global/gameServerDeployments/my-deployment/rollout`.</param>
                public virtual PreviewRolloutRequest PreviewRollout(Google.Apis.GameServices.v1.Data.GameServerDeploymentRollout body, string name)
                {
                ...
                /// <summary>Previews the game server deployment rollout. This API does not mutate the rollout
                /// resource.</summary>
                public class PreviewRolloutRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.PreviewGameServerDeploymentRolloutResponse>
                {
                    /// <summary>Constructs a new PreviewRollout request.</summary>
                    public PreviewRolloutRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerDeploymentRollout body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>The resource name of the game server deployment rollout, in the following form:
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.GameServerDeploymentRollout Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}/rollout:preview";
                ...
                /// documentation for the appropriate value for this field.</param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.GameServices.v1.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// <summary>Sets the access control policy on the specified resource. Replaces any existing policy. Can
                /// return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.</summary>
                public class SetIamPolicyRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// documentation for the appropriate value for this field.</param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.GameServices.v1.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// is designed to be used for building permission-aware UIs and command-line tools, not for
                /// authorization checking. This operation may "fail open" without warning.</summary>
                public class TestIamPermissionsRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.TestIamPermissionsRequest Body { get; set; }
                ...
                /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/rollout`. For example, `projects/my-
                /// project/locations/global/gameServerDeployments/my-deployment/rollout`.</param>
                public virtual UpdateRolloutRequest UpdateRollout(Google.Apis.GameServices.v1.Data.GameServerDeploymentRollout body, string name)
                {
                ...
                /// is explicitly called out in game_server_config_overrides field, that will also not result in an
                /// error.</summary>
                public class UpdateRolloutRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                {
                    /// <summary>Constructs a new UpdateRollout request.</summary>
                    public UpdateRolloutRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerDeploymentRollout body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.GameServices.v1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to
                /// `Code.CANCELLED`.</summary>
                public class CancelRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// interested in the operation result. It does not cancel the operation. If the server doesn't support
                /// this method, it returns `google.rpc.Code.UNIMPLEMENTED`.</summary>
                public class DeleteRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
                /// operation result at intervals as recommended by the API service.</summary>
                public class GetRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// however overriding users must ensure the name binding is the parent resource, without the operations
                /// collection id.</summary>
                public class ListRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            public class RealmsResource
            {
                ...
                public class GameServerClustersResource
                {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">Required. The parent resource name, in the following form:
                    /// `projects/{project}/locations/{location}/realms/{realm-id}`.</param>
                    public virtual CreateRequest Create(Google.Apis.GameServices.v1.Data.GameServerCluster body, string parent)
                    {
                        return new CreateRequest(service, body, parent);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerCluster body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Required. The parent resource name, in the following form:
                        /// `projects/{project}/locations/{location}/realms/{realm-id}`.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.GameServices.v1.Data.GameServerCluster Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/gameServerClusters";
                    ...
                    /// <param name="name">Required. The name of the game server cluster to delete, in the following form:
                    ...
                    public class DeleteRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                    {
                        ...
                        /// <summary>Required. The name of the game server cluster to delete, in the following form:
                    ...
                    /// <param name="name">Required. The name of the game server cluster to retrieve, in the following form:
                    ...
                    /// <summary>Gets details of a single game server cluster.</summary>
                    public class GetRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.GameServerCluster>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                        ...
                        /// <summary>Required. The name of the game server cluster to retrieve, in the following form:
                    ...
                    /// <summary>Lists game server clusters in a given project and location.</summary>
                    public class ListRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.ListGameServerClustersResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The resource name of the game server cluster, in the following form:
                    /// `projects/{project}/locations/{location}/realms/{realm}/gameServerClusters/{cluster}`. For example, `projects/my-
                    /// project/locations/{location}/realms/zanzibar/gameServerClusters/my-onprem-cluster`.</param>
                    public virtual PatchRequest Patch(Google.Apis.GameServices.v1.Data.GameServerCluster body, string name)
                    {
                        return new PatchRequest(service, body, name);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerCluster body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Required. The resource name of the game server cluster, in the following form:
                    ...
                    /// <summary>Previews creation of a new game server cluster in a given project and
                    /// location.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">Required. The parent resource name, in the following form:
                    /// `projects/{project}/locations/{location}/realms/{realm}`.</param>
                    public virtual PreviewCreateRequest PreviewCreate(Google.Apis.GameServices.v1.Data.GameServerCluster body, string parent)
                    {
                    ...
                    /// <summary>Previews creation of a new game server cluster in a given project and
                    /// location.</summary>
                    public class PreviewCreateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.PreviewCreateGameServerClusterResponse>
                    {
                        /// <summary>Constructs a new PreviewCreate request.</summary>
                        public PreviewCreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerCluster body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/gameServerClusters:previewCreate";
                    ...
                    /// <summary>Previews deletion of a single game server cluster.</summary>
                    public class PreviewDeleteRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.PreviewDeleteGameServerClusterResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:previewDelete";
                    ...
                    /// `projects/{project}/locations/{location}/realms/{realm}/gameServerClusters/{cluster}`. For example, `projects/my-
                    /// project/locations/{location}/realms/zanzibar/gameServerClusters/my-onprem-cluster`.</param>
                    public virtual PreviewUpdateRequest PreviewUpdate(Google.Apis.GameServices.v1.Data.GameServerCluster body, string name)
                    {
                        return new PreviewUpdateRequest(service, body, name);
                    }

                    /// <summary>Previews updating a GameServerCluster.</summary>
                    public class PreviewUpdateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.PreviewUpdateGameServerClusterResponse>
                    {
                        /// <summary>Constructs a new PreviewUpdate request.</summary>
                        public PreviewUpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.GameServerCluster body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:previewUpdate";
                ...
                /// <param name="parent">Required. The parent resource name, in the following form:
                /// `projects/{project}/locations/{location}`.</param>
                public virtual CreateRequest Create(Google.Apis.GameServices.v1.Data.Realm body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.Realm body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GameServices.v1.Data.Realm Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/realms";
                ...
                /// <param name="name">Required. The name of the realm to delete, in the following form:
                /// `projects/{project}/locations/{location}/realms/{realm}`.</param>
                public virtual DeleteRequest Delete(string name)
                {
                    return new DeleteRequest(service, name);
                ...
                public class DeleteRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Operation>
                {
                    ...
                    /// <summary>Required. The name of the realm to delete, in the following form:
                    /// `projects/{project}/locations/{location}/realms/{realm}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="name">Required. The name of the realm to retrieve, in the following form:
                /// `projects/{project}/locations/{location}/realms/{realm}`.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                /// <summary>Gets details of a single realm.</summary>
                public class GetRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Realm>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                    ...
                    /// <summary>Required. The name of the realm to retrieve, in the following form:
                    /// `projects/{project}/locations/{location}/realms/{realm}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <summary>Lists realms in a given project and location.</summary>
                public class ListRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.ListRealmsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The resource name of the realm, in the following form:
                /// `projects/{project}/locations/{location}/realms/{realm}`. For example, `projects/my-
                /// project/locations/{location}/realms/my-realm`.</param>
                public virtual PatchRequest Patch(Google.Apis.GameServices.v1.Data.Realm body, string name)
                {
                    return new PatchRequest(service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.Realm body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>The resource name of the realm, in the following form:
                    /// `projects/{project}/locations/{location}/realms/{realm}`. For example, `projects/my-
                ...
                /// `projects/{project}/locations/{location}/realms/{realm}`. For example, `projects/my-
                /// project/locations/{location}/realms/my-realm`.</param>
                public virtual PreviewUpdateRequest PreviewUpdate(Google.Apis.GameServices.v1.Data.Realm body, string name)
                {
                    return new PreviewUpdateRequest(service, body, name);
                }

                /// <summary>Previews patches to a single realm.</summary>
                public class PreviewUpdateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.PreviewRealmUpdateResponse>
                {
                    /// <summary>Constructs a new PreviewUpdate request.</summary>
                    public PreviewUpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1.Data.Realm body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
{    
    ...
    /// <summary>Increment a streamz counter with the specified metric and field names. Metric names should start with a
    /// '/', generally be lowercase-only, and end in "_count". Field names should not contain an initial slash. The
    /// actual exported metric names will have "/iam/policy" prepended. Field names correspond to IAM request parameters
    /// and field values are their respective values. Supported field names: - "authority", which is "[token]" if
    ...
    public class DeployedFleet : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The source spec that is used to create the Agones fleet. The GameServerConfig resource may no
        /// longer exist in the system.</summary>
    ...
    public class DeployedFleetAutoscaler : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The source spec that is used to create the autoscaler. The GameServerConfig resource may no longer
        /// exist in the system.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("specSource")]
        public virtual SpecSource SpecSource { get; set; }
    ...
    /// <summary>DeployedFleetStatus has details about the Agones fleets such as how many are running, how many
    /// allocated, and so on.</summary>
    public class DeployedFleetStatus : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The number of GameServer replicas in the RESERVED state in this fleet. Reserved instances won't be
        /// deleted on scale down, but won't cause an autoscaler to scale up.</summary>
    ...
    public class GameServerCluster : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `projects/my-project/locations/{location}/realms/zanzibar/gameServerClusters/my-onprem-cluster`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    public class GameServerConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the game server config, in the following form:
    ...
    public class GameServerDeployment : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the game server deployment, in the following form:
        /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`. For example, `projects/my-
        /// project/locations/global/gameServerDeployments/my-deployment`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    public class GameServerDeploymentRollout : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// example, `projects/my-project/locations/global/gameServerDeployments/my-game/configs/my-config`.</summary>
        ...
        /// <summary>The resource name of the game server deployment rollout, in the following form:
        /// `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/rollout`. For example, `projects
        /// /my-project/locations/global/gameServerDeployments/my-deployment/rollout`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    public class GkeClusterReference : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// resource are used to generate the full name of the GKE cluster.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("cluster")]
        public virtual string Cluster { get; set; }
    ...
    /// <summary>Response message for PreviewGameServerDeploymentRollout. This has details about the Agones fleet and
    ...
    {
        /// <summary>Required. Agones fleet autoscaler spec. Example spec:
        /// https://agones.dev/site/docs/reference/fleetautoscaler/</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("fleetAutoscalerSpec")]
        public virtual string FleetAutoscalerSpec { get; set; }
    ...
    /// <summary>The schedule of a recurring or one time event. The event's time span is specified by start_time and
    /// end_time. If the scheduled event's timespan is larger than the cron_spec + cron_job_duration, the event will be
    /// recurring. If only cron_spec + cron_job_duration are specified, the event is effective starting at the local
    /// time specified by cron_spec, and is recurring. start_time|-------[cron job]-------[cron job]-------[cron
    /// job]---|end_time cron job: cron spec start time + duration</summary>
    public class Schedule : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The duration for the cron job event. The duration of the event is effective after the cron job's
        /// start time.</summary>
    ...
    {
        /// <summary>The game server config resource. Uses the form: `projects/{project}/locations/{location}/gameServer
        /// Deployments/{deployment_id}/configs/{config_id}`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("gameServerConfigName")]
        public virtual string GameServerConfigName { get; set; }

        /// <summary>The name of the Agones leet config or Agones scaling config used to derive the Agones fleet or
        /// Agones autoscaler spec.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    public class TargetFleetAutoscaler : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Encapsulates the source of the Agones fleet spec. Details about the Agones autoscaler
        /// spec.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("specSource")]
        public virtual SpecSource SpecSource { get; set; }
