...
namespace Google.Apis.CloudBuild.v1alpha2
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha2.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1alpha2.Data.CancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
        ...
        public class WorkerPoolsResource
        {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Required. The parent resource where this book will be created. Format:
            ...
            public class CreateRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha2.Data.WorkerPool>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1alpha2.Data.WorkerPool body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Required. The parent resource where this book will be created. Format:
                /// projects/{project}</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }

                /// <summary>Required. Immutable. The ID to use for the `WorkerPool`, which will become the final
                /// component of the resource name. This value should be 1-63 characters, and valid characters are
                /// /a-z-/.</summary>
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add(
                        "workerPoolId", new Google.Apis.Discovery.Parameter
                        {
                            Name = "workerPoolId",
                            IsRequired = false,
                            ParameterType = "query",
            ...
            /// <param name="name">Required. The name of the `WorkerPool` to delete. Format:
            /// projects/{project}/workerPools/{workerPool}</param>
            ...
            public class DeleteRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha2.Data.Empty>
            {
                ...
                /// <summary>Required. The name of the `WorkerPool` to delete. Format:
                /// projects/{project}/workerPools/{workerPool}</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="name">Required. The name of the `WorkerPool` to retrieve. Format:
            /// projects/{project}/workerPools/{workerPool}</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            ...
            public class GetRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha2.Data.WorkerPool>
            {
                ...
                /// <summary>Required. The name of the `WorkerPool` to retrieve. Format:
                /// projects/{project}/workerPools/{workerPool}</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="parent">Required. The parent, which owns this collection of `WorkerPools`. Format:
            /// projects/{project}</param>
            ...
            public class ListRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha2.Data.ListWorkerPoolsResponse>
            {
                ...
                /// <summary>Required. The parent, which owns this collection of `WorkerPools`. Format:
                /// projects/{project}</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Output only. The resource name of the `WorkerPool`. Format of the name is
            /// `projects/{project_id}/workerPools/{worker_pool_id}`, where the value of {worker_pool_id} is provided in the
            /// CreateWorkerPool request.</param>
            ...
            public class PatchRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha2.Data.WorkerPool>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1alpha2.Data.WorkerPool body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// provided in the CreateWorkerPool request.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
...
{    
    ...
    {
        /// <summary>Required. Immutable. The network definition that the workers are peered to. If this section is left
        /// empty, the workers will be peered to WorkerPool.project_id on the default network. Must be in the format
    ...
    /// <summary>Notification is the container which holds the data that is relevant to this particular
    ...
    /// <summary>NotifierSecret is the container that maps a secret name (reference) to its Google Cloud Secret Manager
    ...
    /// <summary>NotifierSecretRef contains the reference to a secret stored in the corresponding
    /// NotifierSpec.</summary>
    ...
    /// <summary>SlackDelivery is the delivery configuration for delivering Slack messages via webhooks. See Slack
    /// webhook documentation at: https://api.slack.com/messaging/webhooks.</summary>
