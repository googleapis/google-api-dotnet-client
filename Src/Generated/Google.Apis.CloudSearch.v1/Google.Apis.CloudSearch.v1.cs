 ...
 * <a href='https://gsuite.google.com/products/cloud-search/'>https://gsuite.google.com/products/cloud-search/</a>.
 *
...
namespace Google.Apis.CloudSearch.v1
{
        ...
        public class DatasourcesResource
        {
            ...
            public class ItemsResource
            {
                ...
                public class CheckAccessRequest : CloudSearchBaseServiceRequest<Google.Apis.CloudSearch.v1.Data.CheckAccessResponse>
                {
                    ...
                    /// <summary>If set, the request will enable debugging features of Cloud Search. Only turn on this
    ...
    public class IndexingResource
    {
        ...
        public class DatasourcesResource
        {
            ...
            public class ItemsResource
            {
                ...
                /// <summary>Deletes Item resource for the specified resource name.</summary>
                ...
                /// <summary>Deletes all items in a queue. This method is useful for deleting stale items.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                /// <summary>Gets Item resource by item name.</summary>
                ...
                /// <summary>Lists all or a subset of Item resources.</summary>
                ...
                /// <summary>Pushes an item onto a queue for later polling and updating.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                /// useful for resetting the indexing queue after a connector has been restarted.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                /// <summary>Creates an upload session for uploading item content. For items smaller than 100 KiB, it's
                /// easier to embed the content inline within update.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Name of the Data Source to start a resumable upload. Format: datasources/{source_id}</param>
                ...
                public class UploadRequest : CloudSearchBaseServiceRequest<Google.Apis.CloudSearch.v1.Data.UploadItemRef>
                {
                    ...
                    /// <summary>Name of the Data Source to start a resumable upload. Format:
                    /// datasources/{source_id}</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
    ...
    public class MediaResource
    {
        ...
        /// not be inlined during index requests. To index large content:
        ///
        /// 1. Call upload to begin a session and get the item reference. 1. Upload the content using the item
        /// reference's resource name. 1. Call index with the item reference as the content.
        ///
    ...
    public class QueryResource
    {
        ...
        public class SourcesResource
        {
            ...
            public class ListRequest : CloudSearchBaseServiceRequest<Google.Apis.CloudSearch.v1.Data.ListQuerySourcesResponse>
            {
                ...
                /// [timezone.xml](http://unicode.org/repos/cldr/trunk/common/bcp47/timezone.xml)</summary>
    ...
    public class StatsResource
    {
        ...
        /// <summary>Gets indexed item statistics aggreggated across all data sources.</summary>
...
{    
    ...
    public class DataSource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// gmail, docs, drive, groups, sites, calendar, hangouts, gplus, keep. Its maximum length is 32
        /// characters.</summary>
    ...
    public class DataSourceRestriction : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// The maximum number of elements is 20.</summary>
    ...
    {
        /// <summary>The maximum number of elements is 100.</summary>
    ...
    {
        /// <summary>If set, the request will enable debugging features of Cloud Search. Only turn on this field, if
        /// asked by Google to help with debugging.</summary>
    ...
    {
        /// <summary>The maximum allowable length for string values is 32 characters. The maximum number of elements is
        /// 100.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("values")]
    ...
    {
        /// <summary>Number of results that match the bucket value.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("count")]
        public virtual System.Nullable<int> Count { get; set; } 

        /// <summary>Percent of results that match the bucket value. This value is between (0-100]. This may not be
        /// accurate and is a best effort estimate.</summary>
    ...
    {
        /// <summary>FacetBuckets for values in response containing atleast a single result.</summary>
    ...
    public class FreshnessOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// be a top-level property within the PropertyDefinitions and it must be a timestamp type or date type.
    ...
    {
        /// <summary>The maximum allowable length for html values is 2048 characters. The maximum number of string
        /// elements is 100.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("values")]
        public virtual System.Collections.Generic.IList<string> Values { get; set; } 
    ...
    {
        /// <summary>The list of displayed properties for the metaline.</summary>
    ...
    public class ObjectDisplayOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// The maximum number of elements is 3.</summary>
    ...
    /// <summary>A people suggestion.</summary>
    ...
    public class QueryInterpretation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The interpretation of the query used in search. For example, query "email from john" will be
        /// interpreted as "from:john source:mail"</summary>
    ...
    /// <summary>A completed query suggestion.</summary>
    ...
    public class Schema : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// schema, wait for opeations to complete before indexing additional content.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("operationIds")]
        public virtual System.Collections.Generic.IList<string> OperationIds { get; set; } 
    ...
    {
        /// <summary>Whether to use freshness as a ranking signal. By default, freshness is used as a ranking
        /// signal.</summary>
    ...
    public class SearchResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The URL of the result.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("url")]
        public virtual string Url { get; set; } 
    ...
    {
        /// <summary>Use a field to control results crowding. For example, if you want to control overly similar results
        /// from Gmail topics, use `thread_id`. For similar pages from Google Sites, you can use `webspace_id`. When
        /// matching query results contain the same field value in `GenericMetadata`, crowding limits are set on those
        /// records.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("field")]
        public virtual string Field { get; set; } 
        ...
        /// <summary>Control results by content source. This option limits the total number of results from a given
        /// source and ignores field-based crowding control.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual System.Nullable<bool> Source { get; set; } 
    ...
    public class SuggestRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Partial query for the completion suggestion.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("query")]
        public virtual string Query { get; set; } 
    ...
    {
        /// <summary>List of suggestion results.</summary>
    ...
    {
        /// <summary>The maximum allowable length for text values is 2048 characters. The maximum number of string
        /// elements is 100.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("values")]
        public virtual System.Collections.Generic.IList<string> Values { get; set; } 
