...
{    
    ...
    public class DataSource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// access on the entire datasource, and that the individual items are not shared outside this visibility. This
        /// should not be set if anonymous search is enabled for the data source.</summary>
