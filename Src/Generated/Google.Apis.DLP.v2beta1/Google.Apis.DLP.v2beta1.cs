...
{    
    ...
    public class GooglePrivacyDlpV2beta1CreateInspectOperationRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// regardless of storage type scanned: - id - info_type - likelihood - byte size of finding - quote - timestamp
        ///
        /// For Cloud Storage the next columns are: - file_path - start_offset
        ///
        /// For Cloud Datastore the next columns are: - project_id - namespace_id - path - column_name - offset
        ///
        /// For BigQuery the next columns are: - row_number - project_id - dataset_id - table_id</summary>
