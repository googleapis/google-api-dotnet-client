...
/**
 * \brief
 *   Cloud Data Loss Prevention (DLP) API Version v2beta1
 *
...
{    
    ...
    /// <summary>LINT.IfChange Row key for identifying a record in BigQuery table.</summary>
    public class GooglePrivacyDlpV2beta1BigQueryKey : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GooglePrivacyDlpV2beta1Finding : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// representation here. Provided if requested by the `InspectConfig` and the finding is less than or equal to
        /// 4096 bytes long. If the finding exceeds 4096 bytes in length, the quote may be omitted.</summary>
    ...
    public class GooglePrivacyDlpV2beta1RecordKey : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual GooglePrivacyDlpV2beta1BigQueryKey BigQueryKey { get; set; } 
