    ...
    public class FoldersResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class ResourceBackupConfigsResource
            {
                ...
                /// <summary>Fetches ResourceBackupConfigs.</summary>
                public class FetchRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1.Data.FetchResourceBackupConfigsResponse>
                {
                    ...
                    public override string RestPath => "v1/{+parent}/resourceBackupConfigs:fetch";
        ...
        public class LocationsResource
        {
            ...
            public class BackupPlansResource
            {
                ...
                public class RevisionsResource
                {
                    ...
                    /// <summary>Gets details of a single BackupPlanRevision.</summary>
                    public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1.Data.BackupPlanRevision>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists BackupPlanRevisions in a given project and location.</summary>
                    public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1.Data.ListBackupPlanRevisionsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                ...
                /// `projects/{project}/locations/{location}/backupPlans/{backup_plan}`
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Backupdr.v1.Data.BackupPlan body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1.Data.BackupPlan body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class TrialResource
            {
                ...
                /// <summary>Subscribes to a trial for a project</summary>
                public class SubscribeRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1.Data.Trial>
                {
                    /// <summary>Constructs a new Subscribe request.</summary>
                    public SubscribeRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1.Data.SubscribeTrialRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1.Data.SubscribeTrialRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/trial:subscribe";
            ...
            /// <summary>Gets the Trial state for a given project</summary>
            public class GetTrialRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1.Data.Trial>
            {
...
namespace Google.Apis.Backupdr.v1.Data
{
    ...
    public class GoogleCloudBackupdrV1OperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
