    ...
    public class ProjectsResource
    {
        ...
        public class ModelsResource
        {
            ...
            public class VersionsResource
            {
                ...
                /// engine/reference/rest/v1beta1/projects.models.versions/setDefault).</summary>
                /// <param name="body">The body of the request.</param>
                ...
                /// calling [projects.models.versions.list](/ml-
                /// engine/reference/rest/v1beta1/projects.models.versions/list).</param>
                ...
                public class DeleteRequest : CloudMachineLearningEngineBaseServiceRequest<Google.Apis.CloudMachineLearningEngine.v1beta1.Data.GoogleLongrunningOperation>
                {
                    ...
                    /// engine/reference/rest/v1beta1/projects.models.versions/list).</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// engine/reference/rest/v1beta1/projects.models.versions/list) to get the same information that this
                /// method returns for all of the versions of a model.</summary>
            ...
            /// engine/reference/rest/v1beta1/projects.models.versions/create).</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Required. The project name.</param>
            ...
            /// engine/reference/rest/v1beta1/projects.models.versions/delete).</summary>
...
{    
    ...
    public class GoogleCloudMlV1beta1Version : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// as the source of the model. Once deployed, the model version is hosted by the prediction service, so this
        /// location is useful only as a historical record. The total number of model files can't exceed 1000.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("deploymentUri")]
        public virtual string DeploymentUri { get; set; } 
