...
namespace Google.Apis.CloudNaturalLanguage.v1beta2
{
    ...
    public class DocumentsResource
    {
        ...
        public virtual AnalyzeEntitiesRequest AnalyzeEntities(Google.Apis.CloudNaturalLanguage.v1beta2.Data.AnalyzeEntitiesRequest body)
        {
        ...
        /// </summary>
        /// <param name="body">The body of the request.</param>
        public virtual AnalyzeEntitySentimentRequest AnalyzeEntitySentiment(Google.Apis.CloudNaturalLanguage.v1beta2.Data.AnalyzeEntitySentimentRequest body)
        {
        ...
        /// <param name="body">The body of the request.</param>
        public virtual AnalyzeSentimentRequest AnalyzeSentiment(Google.Apis.CloudNaturalLanguage.v1beta2.Data.AnalyzeSentimentRequest body)
        {
        ...
        /// </summary>
        /// <param name="body">The body of the request.</param>
        public virtual AnalyzeSyntaxRequest AnalyzeSyntax(Google.Apis.CloudNaturalLanguage.v1beta2.Data.AnalyzeSyntaxRequest body)
        {
        ...
        /// </summary>
        /// <param name="body">The body of the request.</param>
        public virtual AnnotateTextRequest AnnotateText(Google.Apis.CloudNaturalLanguage.v1beta2.Data.AnnotateTextRequest body)
        {
        ...
        /// <param name="body">The body of the request.</param>
        public virtual ClassifyTextRequest ClassifyText(Google.Apis.CloudNaturalLanguage.v1beta2.Data.ClassifyTextRequest body)
        {
        ...
        /// <param name="body">The body of the request.</param>
        public virtual ModerateTextRequest ModerateText(Google.Apis.CloudNaturalLanguage.v1beta2.Data.ModerateTextRequest body)
        {
            return new ModerateTextRequest(this.service, body);
        }

        /// <summary>Moderates a document for harmful and sensitive categories.</summary>
        public class ModerateTextRequest : CloudNaturalLanguageBaseServiceRequest<Google.Apis.CloudNaturalLanguage.v1beta2.Data.ModerateTextResponse>
        {
            /// <summary>Constructs a new ModerateText request.</summary>
            public ModerateTextRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudNaturalLanguage.v1beta2.Data.ModerateTextRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudNaturalLanguage.v1beta2.Data.ModerateTextRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1beta2/documents:moderateText";
...
namespace Google.Apis.CloudNaturalLanguage.v1beta2.Data
{
    ...
    {
        /// <summary>
        /// Indicates how detected boilerplate(e.g. advertisements, copyright declarations, banners) should be handled
        /// for this document. If not specified, boilerplate will be treated the same as content.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("boilerplateHandling")]
        public virtual string BoilerplateHandling { get; set; }
        ...
        /// <summary>
        /// The web URI where the document comes from. This URI is not used for fetching the content, but as a hint for
        /// analyzing the document.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("referenceWebUri")]
        public virtual string ReferenceWebUri { get; set; }
    ...
    /// specific analysis for the input. Next ID: 12
    /// </summary>
    public class Features : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Classify the full document into categories. If this is true, the API will use the default model which
        /// classifies into a [predefined taxonomy](https://cloud.google.com/natural-language/docs/categories).
        /// </summary>
    ...
    /// <summary>Represents the feeling associated with the entire text or entities in the text. Next ID: 6</summary>
