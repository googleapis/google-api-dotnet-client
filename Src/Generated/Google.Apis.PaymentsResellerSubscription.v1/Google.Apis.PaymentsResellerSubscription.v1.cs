...
namespace Google.Apis.PaymentsResellerSubscription.v1.Data
{
    ...
    public class ResumeSubscriptionRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The mode to resume the subscription.</summary>
    ...
    /// <summary>
    /// Acts as a central billing entity between an external partner and Google. Google services use the subscription
    /// state to grant or revoke the user's service entitlement. Note: The subscription state might not perfectly align
    /// with the user's service entitlement. Some services might continue providing access until the current cycle ends,
    /// even if the subscription is immediately canceled. Consult the relevant contract or product policy for specific
    /// details.
    /// </summary>
