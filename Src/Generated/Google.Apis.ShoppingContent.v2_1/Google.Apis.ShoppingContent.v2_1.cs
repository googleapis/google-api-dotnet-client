...
{    
    ...
    public class CustomerReturnReason : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Code of the return reason.</summary>
    ...
    public class ReturnAddress : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The country of sale where the return address is applicable.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("country")]
        public virtual string Country { get; set; } 
        ...
        /// <summary>The user-defined label of the return address. For the default address, use the label
        /// "default".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("label")]
        public virtual string Label { get; set; } 

        /// <summary>The merchant's contact phone number regarding the return.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("phoneNumber")]
        public virtual string PhoneNumber { get; set; } 
    ...
    {
        /// <summary>The country of sale where the return policy is applicable.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("country")]
        public virtual string Country { get; set; } 
        ...
        /// <summary>The user-defined label of the return policy. For the default policy, use the label
        /// "default".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("label")]
        public virtual string Label { get; set; } 
    ...
    {
        /// <summary>Last day for returning the items. In ISO 8601 format. When specifying the return window like this,
        /// set the policy type to "lastReturnDate". Use this for seasonal overrides only.</summary>
        ...
        /// food, perishables, and living things. A policy of less than 30 days can only be applied to those
        /// items.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("type")]
        public virtual string Type { get; set; } 
    ...
    {
        /// <summary>Last day on which the override applies. In ISO 8601 format.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endDate")]
        public virtual string EndDate { get; set; } 

        /// <summary>The name of the seasonal override as shown in Merchant Center.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 

        /// <summary>The policy which is in effect during that time.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policy")]
        public virtual ReturnPolicyPolicy Policy { get; set; } 

        /// <summary>First day on which the override applies. In ISO 8601 format.</summary>
    ...
    public class ReturnShipment : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Type of the return method.</summary>
        ...
        /// <summary>State of the shipment.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; } 
    ...
    {
        /// <summary>The shipping carrier that handles the package.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("carrier")]
        public virtual string Carrier { get; set; } 
