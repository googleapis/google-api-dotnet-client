...
namespace Google.Apis.ContainerAnalysis.v1.Data
{
    ...
    public class AISkillAnalysisOccurrence : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Maximum severity found among findings. Per scanner verdict details.</summary>
    ...
    public class ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsOci> Oci { get; set; }
    ...
    public class ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsOci : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    {
        /// <summary>Optional. Empty placeholder to denote that this is a Google Cloud Storage export request.</summary>
    ...
    public class SecretLocation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("fileLocation")]
        public virtual GrafeasV1FileLocation FileLocation { get; set; }
    ...
    public class VulnerabilityNote : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The full description of the v2 CVSS for this vulnerability.</summary>
