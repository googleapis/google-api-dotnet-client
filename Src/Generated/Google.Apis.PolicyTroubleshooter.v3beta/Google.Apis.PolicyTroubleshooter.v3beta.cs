...
namespace Google.Apis.PolicyTroubleshooter.v3beta
{
    ...
    public class PolicyTroubleshooterService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "v3beta";
    ...
    public class IamResource
    {
        ...
        public virtual TroubleshootRequest Troubleshoot(Google.Apis.PolicyTroubleshooter.v3beta.Data.GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyRequest body)
        {
        ...
        /// does or doesn't have that permission.
        /// </summary>
        public class TroubleshootRequest : PolicyTroubleshooterBaseServiceRequest<Google.Apis.PolicyTroubleshooter.v3beta.Data.GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse>
        {
            /// <summary>Constructs a new Troubleshoot request.</summary>
            public TroubleshootRequest(Google.Apis.Services.IClientService service, Google.Apis.PolicyTroubleshooter.v3beta.Data.GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            Google.Apis.PolicyTroubleshooter.v3beta.Data.GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyRequest Body { get; set; }
            ...
            public override string RestPath => "v3beta/iam:troubleshoot";
...
namespace Google.Apis.PolicyTroubleshooter.v3beta.Data
{
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaAccessTuple : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaConditionContext ConditionContext { get; set; }
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership CombinedMembership { get; set; }
        ...
        public virtual System.Collections.Generic.IDictionary<string, GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership> Memberships { get; set; }
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaAllowPolicyExplanation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaExplainedAllowPolicy> ExplainedPolicies { get; set; }
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionContext : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaConditionContextPeer Destination { get; set; }
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaConditionContextEffectiveTag> EffectiveTags { get; set; }

        /// <summary>Represents a network request, such as an HTTP request.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("request")]
        public virtual GoogleCloudPolicytroubleshooterIamV3betaConditionContextRequest Request { get; set; }
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaConditionContextResource Resource { get; set; }
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionContextEffectiveTag : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionContextPeer : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionContextRequest : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionContextResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionExplanation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaConditionExplanationEvaluationState> EvaluationStates { get; set; }
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaConditionExplanationEvaluationState : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaDenyPolicyExplanation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaExplainedDenyResource> ExplainedResources { get; set; }
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedPermissionMatching CombinedDeniedPermission { get; set; }
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedDenyPrincipalMatching CombinedDeniedPrincipal { get; set; }
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedPermissionMatching CombinedExceptionPermission { get; set; }
        ...
        public virtual GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedDenyPrincipalMatching CombinedExceptionPrincipal { get; set; }
        ...
        public virtual System.Collections.Generic.IDictionary<string, GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedPermissionMatching> DeniedPermissions { get; set; }
        ...
        public virtual System.Collections.Generic.IDictionary<string, GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedDenyPrincipalMatching> DeniedPrincipals { get; set; }
        ...
        public virtual System.Collections.Generic.IDictionary<string, GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedPermissionMatching> ExceptionPermissions { get; set; }
        ...
        public virtual System.Collections.Generic.IDictionary<string, GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedDenyPrincipalMatching> ExceptionPrincipals { get; set; }
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedDenyPrincipalMatching : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Indicates whether the principal is listed as a denied principal in the deny rule, either directly or through
        /// membership in a principal set.
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedPermissionMatching : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedAllowPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanation> BindingExplanations { get; set; }
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedDenyPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanation> RuleExplanations { get; set; }
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedDenyResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("explainedPolicies")]
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaExplainedDenyPolicy> ExplainedPolicies { get; set; }
    ...
    /// <summary>
    /// Details about how a principal access boundary binding and policy contributes to the principal access boundary
    /// explanation, with annotations to indicate how the binding and policy contribute to the overall access state.
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedPABBindingAndPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. Indicates whether the principal is allowed to access the specified resource based on evaluating
        /// the binding and policy.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bindingAndPolicyAccessState")]
        public virtual string BindingAndPolicyAccessState { get; set; }

        /// <summary>
        /// Optional. Details about how this policy contributes to the principal access boundary explanation, with
        /// annotations to indicate how the policy contributes to the overall access state. If the caller doesn't have
        /// permission to view the policy in the binding, this field is omitted.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("explainedPolicy")]
        public virtual GoogleCloudPolicytroubleshooterIamV3betaExplainedPABPolicy ExplainedPolicy { get; set; }

        /// <summary>
        /// Details about how this binding contributes to the principal access boundary explanation, with annotations to
        /// indicate how the binding contributes to the overall access state.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("explainedPolicyBinding")]
    ...
    /// <summary>
    /// Details about how a principal access boundary policy contributes to the explanation, with annotations to
    /// indicate how the policy contributes to the overall access state.
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedPABPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// List of principal access boundary rules that were explained to check the principal's access to specified
        /// resource, with annotations to indicate how each rule contributes to the overall access state.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("explainedRules")]
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaExplainedPABRule> ExplainedRules { get; set; }

        /// <summary>The policy that is explained.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policy")]
        public virtual GoogleIamV3PrincipalAccessBoundaryPolicy Policy { get; set; }

        /// <summary>Output only. Indicates whether the policy allows access to the specified resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyAccessState")]
        public virtual string PolicyAccessState { get; set; }

        /// <summary>Output only. Explanation of the principal access boundary policy's version.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyVersion")]
        public virtual GoogleCloudPolicytroubleshooterIamV3betaExplainedPABPolicyVersion PolicyVersion { get; set; }

        /// <summary>The relevance of this policy to the overall access state.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("relevance")]
        public virtual string Relevance { get; set; }
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedPABPolicyVersion : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. Indicates whether the policy is enforced based on its version.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enforcementState")]
        public virtual string EnforcementState { get; set; }

        /// <summary>
        /// Output only. The actual version of the policy. - If the policy uses static version, this field is the chosen
        /// static version. - If the policy uses dynamic version, this field is the effective latest version.
        /// </summary>
    ...
    /// <summary>
    /// Details about how a principal access boundary rule contributes to the explanation, with annotations to indicate
    /// how the rule contributes to the overall access state.
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedPABRule : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. Indicates whether any resource of the rule is the specified resource or includes the specified
        /// resource.
        /// </summary>
        ...
        /// <summary>
        /// List of resources that were explained to check the principal's access to specified resource, with
        /// annotations to indicate how each resource contributes to the overall access state.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("explainedResources")]
        ...
        /// <summary>Output only. Indicates whether the rule allows access to the specified resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ruleAccessState")]
    ...
    /// <summary>
    /// Details about how a resource contributes to the explanation, with annotations to indicate how the resource
    /// contributes to the overall access state.
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedPABRuleExplainedResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The relevance of this resource to the overall access state.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("relevance")]
        public virtual string Relevance { get; set; }

        /// <summary>
        /// The [full resource name](https://cloud.google.com/iam/docs/full-resource-names) that identifies the resource
        /// that is explained. This can only be a project, a folder, or an organization which is what a PAB rule
        /// accepts.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("resource")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("resourceInclusionState")]
    ...
    /// <summary>
    /// Details about how a policy binding contributes to the policy explanation, with annotations to indicate how the
    /// policy binding contributes to the overall access state.
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaExplainedPolicyBinding : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. Explanation of the condition in the policy binding. If the policy binding doesn't have a
        /// condition, this field is omitted.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("conditionExplanation")]
        public virtual GoogleCloudPolicytroubleshooterIamV3betaConditionExplanation ConditionExplanation { get; set; }

        /// <summary>The policy binding that is explained.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyBinding")]
        public virtual GoogleIamV3PolicyBinding PolicyBinding { get; set; }

        /// <summary>Output only. Indicates whether the policy binding takes effect.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyBindingState")]
        public virtual string PolicyBindingState { get; set; }

        /// <summary>The relevance of this policy binding to the overall access state.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("relevance")]
        public virtual string Relevance { get; set; }
    ...
    /// </summary>
    public class GoogleCloudPolicytroubleshooterIamV3betaPABPolicyExplanation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// List of principal access boundary policies and bindings that are applicable to the principal's access state,
        /// with annotations to indicate how each binding and policy contributes to the overall access state.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("explainedBindingsAndPolicies")]
        public virtual System.Collections.Generic.IList<GoogleCloudPolicytroubleshooterIamV3betaExplainedPABBindingAndPolicy> ExplainedBindingsAndPolicies { get; set; }

        /// <summary>
        /// Output only. Indicates whether the principal is allowed to access specified resource, based on evaluating
        /// all applicable principal access boundary bindings and policies.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("principalAccessBoundaryAccessState")]
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyRequest : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    /// <summary>IAM policy binding resource.</summary>
    public class GoogleIamV3PolicyBinding : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. User-defined annotations. See https://google.aip.dev/148#annotations for more details such as
        ...
        /// <summary>Output only. The time when the policy binding was created.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("createTime")]
        public virtual string CreateTimeRaw
        {
            get => _createTimeRaw;
        ...
        /// <summary>
        /// Required. Immutable. The resource name of the policy to be bound. The binding parent and policy must belong
        ...
        /// <summary>
        /// Immutable. The kind of the policy to attach in this binding. This field must be one of the following: - Left
        /// empty (will be automatically set to the policy kind) - The input policy kind
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyKind")]
        public virtual string PolicyKind { get; set; }

        /// <summary>Output only. The globally unique ID of the policy to be bound.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyUid")]
        public virtual string PolicyUid { get; set; }

        /// <summary>
        /// Required. Immutable. The full resource name of the resource to which the policy will be bound. Immutable
        /// once set.
        /// </summary>
        ...
        /// <summary>Output only. The time when the policy binding was most recently updated.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("updateTime")]
        public virtual string UpdateTimeRaw
        {
            get => _updateTimeRaw;
    ...
    /// <summary>The full resource name of the resource to which the policy will be bound. Immutable once set.</summary>
    public class GoogleIamV3PolicyBindingTarget : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Immutable. The full resource name that's used for principal access boundary policy bindings. The principal
        /// set must be directly parented by the policy binding's parent or same as the parent if the target is a
        /// project, folder, or organization. Examples: * For bindings parented by an organization: * Organization:
        ...
        /// `//iam.googleapis.com/locations/global/workspace/WORKSPACE_ID` * For bindings parented by a folder: *
        /// Folder: `//cloudresourcemanager.googleapis.com/folders/FOLDER_ID` * For bindings parented by a project: *
        /// Project: * `//cloudresourcemanager.googleapis.com/projects/PROJECT_NUMBER` *
        /// `//cloudresourcemanager.googleapis.com/projects/PROJECT_ID` * Workload Identity Pool:
        /// `//iam.googleapis.com/projects/PROJECT_NUMBER/locations/LOCATION/workloadIdentityPools/WORKLOAD_POOL_ID`
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("principalSet")]
        public virtual string PrincipalSet { get; set; }

        /// <summary>
        /// Immutable. The full resource name that's used for access policy bindings. Examples: * Organization:
    ...
    /// <summary>An IAM principal access boundary policy resource.</summary>
    public class GoogleIamV3PrincipalAccessBoundaryPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. User defined annotations. See https://google.aip.dev/148#annotations for more details such as
        /// format and size limitations
        ...
        /// <summary>Output only. The time when the principal access boundary policy was created.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("createTime")]
        public virtual string CreateTimeRaw
        {
            get => _createTimeRaw;
        ...
        /// <summary>Optional. The details for the principal access boundary policy.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("details")]
        public virtual GoogleIamV3PrincipalAccessBoundaryPolicyDetails Details { get; set; }

        /// <summary>
        /// Optional. The description of the principal access boundary policy. Must be less than or equal to 63
        /// characters.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayName")]
        public virtual string DisplayName { get; set; }
        ...
        /// <summary>
        /// Optional. The etag for the principal access boundary. If this is provided on update, it must match the
        /// server's etag.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("etag")]
        public virtual string ETag { get; set; }
        ...
        /// <summary>Output only. The globally unique ID of the principal access boundary policy.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uid")]
        public virtual string Uid { get; set; }
    ...
    /// <summary>Principal access boundary policy details</summary>
    public class GoogleIamV3PrincipalAccessBoundaryPolicyDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. The version number (for example, `1` or `latest`) that indicates which permissions are able to be
        /// blocked by the policy. If empty, the PAB policy version will be set to the most recent version number at the
        /// time of the policy's creation.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enforcementVersion")]
        public virtual string EnforcementVersion { get; set; }

        /// <summary>
        /// Required. A list of principal access boundary policy rules. The number of rules in a policy is limited to
        /// 500.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("rules")]
        public virtual System.Collections.Generic.IList<GoogleIamV3PrincipalAccessBoundaryPolicyRule> Rules { get; set; }

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }

    /// <summary>Principal access boundary policy rule that defines the resource boundary.</summary>
    public class GoogleIamV3PrincipalAccessBoundaryPolicyRule : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. The description of the principal access boundary policy rule. Must be less than or equal to 256
        /// characters.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }
