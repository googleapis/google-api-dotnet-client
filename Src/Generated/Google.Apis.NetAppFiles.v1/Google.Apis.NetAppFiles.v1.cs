    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class HostGroupsResource
            {
                ...
                public virtual CreateRequest Create(Google.Apis.NetAppFiles.v1.Data.HostGroup body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.HostGroup body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.NetAppFiles.v1.Data.HostGroup Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/hostGroups";
                ...
                /// <summary>Returns details of the specified host group.</summary>
                public class GetRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.HostGroup>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// locations.
                /// </summary>
                public class ListRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.ListHostGroupsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// `projects/{project_number}/locations/{location_id}/hostGroups/{host_group_id}`.
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.NetAppFiles.v1.Data.HostGroup body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.HostGroup body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class StoragePoolsResource
            {
                ...
                public class BackupConfigsResource
                {
                    ...
                    /// <summary>Lists backup configurations for all volumes in an ONTAP-mode Storage Pool.</summary>
                    public class ListRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.ListBackupConfigsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/backupConfigs";
                ...
                public class OntapResource
                {
                    ...
                    public class ExecuteOntapDeleteRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.ExecuteOntapDeleteResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+ontapPath}";
                    ...
                    /// `projects/123456789/locations/us-central1/storagePools/my-storage-pool/ontap/api/storage/volumes`.
                    /// </param>
                    public virtual ExecuteOntapPatchRequest ExecuteOntapPatch(Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPatchRequest body, string ontapPath)
                    {
                    ...
                    public class ExecuteOntapPatchRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPatchResponse>
                    {
                        ...
                        public ExecuteOntapPatchRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPatchRequest body, string ontapPath) : base(service)
                        {
                            OntapPath = ontapPath;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPatchRequest Body { get; set; }
                    ...
                    /// `projects/123456789/locations/us-central1/storagePools/my-storage-pool/ontap/api/storage/volumes`.
                    /// </param>
                    public virtual ExecuteOntapPostRequest ExecuteOntapPost(Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPostRequest body, string ontapPath)
                    {
                    ...
                    public class ExecuteOntapPostRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPostResponse>
                    {
                        ...
                        public ExecuteOntapPostRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPostRequest body, string ontapPath) : base(service)
                        {
                            OntapPath = ontapPath;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.NetAppFiles.v1.Data.ExecuteOntapPostRequest Body { get; set; }
                ...
                /// </param>
                public virtual RestoreVolumeRequest RestoreVolume(Google.Apis.NetAppFiles.v1.Data.RestoreVolumeRequest body, string name)
                {
                    return new RestoreVolumeRequest(this.service, body, name);
                }

                /// <summary>Restores a backup to an ONTAP-mode volume.</summary>
                public class RestoreVolumeRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.Operation>
                {
                    /// <summary>Constructs a new RestoreVolume request.</summary>
                    public RestoreVolumeRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.RestoreVolumeRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.NetAppFiles.v1.Data.RestoreVolumeRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:restoreVolume";
                ...
                /// </param>
                public virtual UpdateBackupConfigRequest UpdateBackupConfig(Google.Apis.NetAppFiles.v1.Data.UpdateBackupConfigRequest body, string name)
                {
                    return new UpdateBackupConfigRequest(this.service, body, name);
                }

                /// <summary>Updates the backup configuration for an ONTAP-mode volume.</summary>
                public class UpdateBackupConfigRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.Operation>
                {
                    /// <summary>Constructs a new UpdateBackupConfig request.</summary>
                    public UpdateBackupConfigRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.UpdateBackupConfigRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.NetAppFiles.v1.Data.UpdateBackupConfigRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:updateBackupConfig";
            ...
            public class VolumesResource
            {
                ...
                /// error.
                /// </summary>
                public class GetSplitStatusRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.SplitStatus>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:getSplitStatus";
                ...
                /// projects/{project_number}/locations/{location}/volumes/{volume_id}
                /// </param>
                public virtual StartSplitRequest StartSplit(Google.Apis.NetAppFiles.v1.Data.StartSplitRequest body, string name)
                {
                ...
                /// clone_details set(clones). For volumes that are not clones, this operation will return an error.
                /// </summary>
                public class StartSplitRequest : NetAppFilesBaseServiceRequest<Google.Apis.NetAppFiles.v1.Data.Operation>
                {
                    /// <summary>Constructs a new StartSplit request.</summary>
                    public StartSplitRequest(Google.Apis.Services.IClientService service, Google.Apis.NetAppFiles.v1.Data.StartSplitRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.NetAppFiles.v1.Data.StartSplitRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:startSplit";
