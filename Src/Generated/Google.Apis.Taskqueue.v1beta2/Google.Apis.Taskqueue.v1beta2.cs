...
namespace Google.Apis.Taskqueue.v1beta2
{
    ...
    public class TaskqueueService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            get { return "https://www.googleapis.com/taskqueue/v1beta2/projects/"; }
        }

        /// <summary>Gets the service base path.</summary>
        public override string BasePath
        {
            get { return "taskqueue/v1beta2/projects/"; }
        }
        ...
        {
            get { return "https://www.googleapis.com/batch/taskqueue/v1beta2"; }
        }

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath
        {
            get { return "batch/taskqueue/v1beta2"; }
        }
        #endif
    ...
    public class TaskqueuesResource
    {
        ...
        /// <summary>Get detailed information about a TaskQueue.</summary>
        public class GetRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.TaskQueue>
        {
    ...
    public class TasksResource
    {
        ...
        /// <summary>Get a particular task from a TaskQueue.</summary>
        public class GetRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.Task>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Insert a new task in a TaskQueue</summary>
        public class InsertRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.Task>
        {
            ...
            Google.Apis.Taskqueue.v1beta2.Data.Task Body { get; set; }
        ...
        /// <summary>Lease 1 or more tasks from a TaskQueue.</summary>
        public class LeaseRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.Tasks>
        {
            ...
            public virtual System.Nullable<bool> GroupByTag { get; set; }

            /// <summary>The tag allowed for tasks in the response. Must only be specified if group_by_tag is true. If
            /// group_by_tag is true and tag is not specified the tag will be that of the oldest task by eta, i.e. the
            /// first available tag</summary>
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add(
                    "groupByTag", new Google.Apis.Discovery.Parameter
                    {
                        Name = "groupByTag",
                        IsRequired = false,
                        ParameterType = "query",
                ...
                RequestParameters.Add(
                    "tag", new Google.Apis.Discovery.Parameter
                    {
                        Name = "tag",
                        IsRequired = false,
                        ParameterType = "query",
        ...
        /// <summary>List Tasks in a TaskQueue</summary>
        public class ListRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.Tasks2>
        {
        ...
        /// <param name="project">The project under which the queue lies.</param>
        /// <param
        /// name="taskqueue"></param>
        /// <param name="task"></param>
        /// <param name="newLeaseSeconds">The new lease in
        /// seconds.</param>
        public virtual PatchRequest Patch(Google.Apis.Taskqueue.v1beta2.Data.Task body, string project, string taskqueue, string task, int newLeaseSeconds)
        {
            return new PatchRequest(service, body, project, taskqueue, task, newLeaseSeconds);
        }

        /// <summary>Update tasks that are leased out of a TaskQueue. This method supports patch semantics.</summary>
        public class PatchRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.Task>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Taskqueue.v1beta2.Data.Task body, string project, string taskqueue, string task, int newLeaseSeconds)
                : base(service)
            {
                Project = project;
                Taskqueue = taskqueue;
            ...
            public virtual int NewLeaseSeconds { get; private set; }
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add(
                    "newLeaseSeconds", new Google.Apis.Discovery.Parameter
                    {
        ...
        /// <param name="newLeaseSeconds">The new lease in
        /// seconds.</param>
        public virtual UpdateRequest Update(Google.Apis.Taskqueue.v1beta2.Data.Task body, string project, string taskqueue, string task, int newLeaseSeconds)
        {
            return new UpdateRequest(service, body, project, taskqueue, task, newLeaseSeconds);
        }

        /// <summary>Update tasks that are leased out of a TaskQueue.</summary>
        public class UpdateRequest : TaskqueueBaseServiceRequest<Google.Apis.Taskqueue.v1beta2.Data.Task>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Taskqueue.v1beta2.Data.Task body, string project, string taskqueue, string task, int newLeaseSeconds)
                : base(service)
            {
                Project = project;
                Taskqueue = taskqueue;
...
{    
    ...
    public class Task : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The number of leases applied to this task.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("retry_count")]
