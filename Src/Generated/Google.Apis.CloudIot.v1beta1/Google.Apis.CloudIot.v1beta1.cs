...
/**
 * \brief
 *   Google Cloud IoT API Version v1beta1
 *
...
namespace Google.Apis.CloudIot.v1beta1
{
            ...
            public class RegistriesResource
            {
                ...
                public class DevicesResource
                {
                    ...
                    public class ConfigVersionsResource
                    {
                        ...
                        /// <summary>Lists the last few versions of the device configuration in descending order (i.e.:
                        /// newest first).</summary>
                        public class ListRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.ListDeviceConfigVersionsResponse>
                        {
                            ...
                            {
                                get { return "v1beta1/{+name}/configVersions"; }
                            }
                    ...
                    public virtual CreateRequest Create(Google.Apis.CloudIot.v1beta1.Data.Device body, string parent)
                    {
                        return new CreateRequest(service, body, parent);
                    }

                    /// <summary>Creates a device in a device registry.</summary>
                    public class CreateRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.Device>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.Device body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                        ...
                        Google.Apis.CloudIot.v1beta1.Data.Device Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+parent}/devices"; }
                        }
                    ...
                    /// <summary>Deletes a device.</summary>
                    public class DeleteRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.Empty>
                    {
                    ...
                    /// <summary>Gets details about a device.</summary>
                    public class GetRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.Device>
                    {
                    ...
                    /// <summary>List devices in a device registry.</summary>
                    public class ListRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.ListDevicesResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                    ...
                    /// servers. Returns the modified configuration version and its meta-data.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">The name of the device. For example, `projects/p0/locations/us-
                    /// central1/registries/registry0/devices/device0` or `projects/p0/locations/us-
                    /// central1/registries/registry0/devices/{num_id}`.</param>
                    public virtual ModifyCloudToDeviceConfigRequest ModifyCloudToDeviceConfig(Google.Apis.CloudIot.v1beta1.Data.ModifyCloudToDeviceConfigRequest body, string name)
                    {
                    ...
                    /// <summary>Modifies the configuration for the device, which is eventually sent from the Cloud IoT
                    /// servers. Returns the modified configuration version and its meta-data.</summary>
                    public class ModifyCloudToDeviceConfigRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.DeviceConfig>
                    {
                        /// <summary>Constructs a new ModifyCloudToDeviceConfig request.</summary>
                        public ModifyCloudToDeviceConfigRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.ModifyCloudToDeviceConfigRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudIot.v1beta1.Data.ModifyCloudToDeviceConfigRequest Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+name}:modifyCloudToDeviceConfig"; }
                        }
                    ...
                    public virtual PatchRequest Patch(Google.Apis.CloudIot.v1beta1.Data.Device body, string name)
                    {
                        return new PatchRequest(service, body, name);
                    }

                    /// <summary>Updates a device.</summary>
                    public class PatchRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.Device>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.Device body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// top-level fields: `credentials` and `enabled_state`</summary>
                ...
                public virtual CreateRequest Create(Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }

                /// <summary>Creates a device registry that contains devices.</summary>
                public class CreateRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry Body { get; set; }
                    ...
                    public override string RestPath
                    {
                        get { return "v1beta1/{+parent}/registries"; }
                    }
                ...
                /// <summary>Gets a device registry configuration.</summary>
                public class GetRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name)
                        : base(service)
                ...
                public virtual GetIamPolicyRequest GetIamPolicy(Google.Apis.CloudIot.v1beta1.Data.GetIamPolicyRequest body, string resource)
                {
                ...
                /// <summary>Gets the access control policy for a resource. Returns an empty policy if the resource
                /// exists and does not have a policy set.</summary>
                public class GetIamPolicyRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.Policy>
                {
                    /// <summary>Constructs a new GetIamPolicy request.</summary>
                    public GetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.GetIamPolicyRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudIot.v1beta1.Data.GetIamPolicyRequest Body { get; set; }
                ...
                /// <summary>Lists device registries.</summary>
                public class ListRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.ListDeviceRegistriesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent)
                        : base(service)
                ...
                /// /my-registry`.</param>
                public virtual PatchRequest Patch(Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry body, string name)
                {
                    return new PatchRequest(service, body, name);
                }

                /// <summary>Updates a device registry configuration.</summary>
                public class PatchRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.DeviceRegistry body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// Mutable top-level fields: `event_notification_config` and `mqtt_config`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual object UpdateMask { get; set; }
                ...
                /// documentation for the appropriate value for this field.</param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.CloudIot.v1beta1.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// <summary>Sets the access control policy on the specified resource. Replaces any existing
                /// policy.</summary>
                public class SetIamPolicyRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.SetIamPolicyRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudIot.v1beta1.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// documentation for the appropriate value for this field.</param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.CloudIot.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// <summary>Returns permissions that a caller has on the specified resource. If the resource does not
                /// exist, this will return an empty set of permissions, not a NOT_FOUND error.</summary>
                public class TestIamPermissionsRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1beta1.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIot.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudIot.v1beta1.Data.TestIamPermissionsRequest Body { get; set; }
...
namespace Google.Apis.CloudIot.v1beta1.Data
{    
    ...
    {
        /// <summary>The most recent device configuration, which is eventually sent from the Cloud IoT Core service to
        /// the device. If not present on creation, the configuration will be initialized with an empty payload and
        /// version value of `1`. To update this field after creation, use the `DeviceManager.ModifyCloudToDeviceConfig`
        /// method.</summary>
        ...
        /// bound to a single device at a time.</summary>
        ...
        /// <summary>If a device is disabled, communication from it will be blocked. Can be used to temporarily prevent
        /// the device from connecting if, for example, the sensor is generating bad data and needs
        /// maintenance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enabledState")]
        public virtual string EnabledState { get; set; } 
        ...
        /// <summary>[Output only] The error message of the last error, e.g., failed to publish to Cloud Pub/Sub.
        /// 'last_error_time' is the timestamp of this field. If no errors are present, this will have an empty message
        /// (whose status code is 0 == OK), otherwise this field is expected to have a not-OK status code.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lastErrorStatus")]
        public virtual Status LastErrorStatus { get; set; } 

        /// <summary>[Output only] The last time an error happened, e.g., failed to publish to Cloud Pub/Sub. This field
        /// is the timestamp of 'last_error_status'.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lastErrorTime")]
        public virtual object LastErrorTime { get; set; } 

        /// <summary>[Output only] The last time an event was received. Timestamps are periodically collected and
    ...
    /// <summary>The device configuration and its metadata. Eventually delivered to devices.</summary>
    public class DeviceConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>[Output only] The time when this version state was updated in the Cloud IoT Core service. This
        ...
        public virtual DeviceConfigData Data { get; set; } 

        /// <summary>[Output only] The time when the Cloud IoT Core server received the acknowledgment from the device,
        /// indicating that the device has received this configuration version. If this field is not present, the device
        /// has not yet acknowledged that it received this version. Note that when sending the config to the device,
        /// there may have been many config versions on the Cloud IoT Core service while the device was disconnected;
        /// and on connection, only the latest version is sent to the device. Some of the versions may never be sent to
        /// the device, and therefore are never acknowledged. This timestamp is set by the Cloud IoT Core
        /// service.</summary>
        ...
        /// always greater than zero after device creation. The version must be zero on the `CreateDevice` request if a
        /// `config` is specified; the response of `CreateDevice` will always have a value of one.</summary>
    ...
    /// <summary>The data for a device configuration. Only binary data is currently supported.</summary>
    public class DeviceConfigData : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The configuration sent to the device, as bytes.</summary>
    ...
    {
        /// <summary>Configuration to notify events received from the device.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("eventNotificationConfig")]
        public virtual NotificationConfig EventNotificationConfig { get; set; } 

        /// <summary>The identifier of this device registry. For example, `myRegistry`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 

        /// <summary>The configuration of the MQTT broker associated with this device registry, including enablement,
        /// payload data format type, etc.</summary>
    ...
    {
        /// <summary>If enabled, allows connections using the MQTT protocol. Otherwise any MQTT connection to this
        /// registry will fail.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("mqttConfigState")]
        public virtual string MqttConfigState { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    /// <summary>Configuration to forward messages such as telemetry events.</summary>
