...
namespace Google.Apis.Genomics.v2alpha1
{
    ...
    public class GenomicsService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://genomics.googleapis.com/";
...
namespace Google.Apis.Genomics.v2alpha1.Data
{
    ...
    {
        /// <summary>
        /// The deadline by which the worker must request an extension. The backend will allow for network transmission
        /// time and other delays, but the worker must attempt to transmit the extension request no later than the
        /// deadline.
        /// </summary>
