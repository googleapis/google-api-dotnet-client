...
{    
    ...
    public class Action : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// ENTRYPOINT the values are used as entrypoint arguments.  Otherwise, they are used as a command and arguments
        ...
        /// identifying actions (for example, to indicate what sort of action they perform: eg. localization, debugging,
        /// etc).  They are returned in the operation metadata but are otherwise ignored.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IDictionary<string,string> Labels { get; set; } 

        /// <summary>A list of mounts to make available to the action.
        ///
        /// In addition to the values specified here, every action has a special virtual disk mounted under /google that
        /// contains log files and other operational components.
        ///
        /// /google/logs: all logs written during the pipeline execution are stored here. /google/logs/output: the
        ...
        /// <summary>A map of container to host port mappings for this container.  Note that if the container already
        /// specifies exposed ports, the PUBLISH_EXPOSED_PORTS flag should be used instead.
        ///
        /// The host port number must be less than 65536.  If it is zero, an unused random port is assigned.  To
        /// determine the resulting port number, consult the ContainerStartedEvent in the operation metadata.</summary>
    ...
    /// <summary>Carries information about a disk that can be attached to a VM.</summary>
    public class Disk : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A user supplied name for the disk, used when mounting it into actions. The name must contain only
        /// upper and lowercase alphanumeric characters and hypens and cannot start with a hypen.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 

        /// <summary>The size, in gigabytes, of the disk to attach.  Note that this value is not configurable for some
        /// disk types such as local-ssd.  If the size is not specified, a size of at least 500gb is used to ensure
        /// reasonable I/O performance.</summary>
        ...
        /// <summary>The Compute Engine disk type.  If unspecified, 'standard-pd' is used.</summary>
    ...
    /// <summary>Metadata carries information about the pipeline execution that is returned in the long running
    /// operation's metadata field.</summary>
    public class Metadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The time that the operation was created by the API.</summary>
    ...
    /// <summary>Mount carries information about a particular disk mount inside a container.</summary>
    public class Mount : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The path to mount the disk at inside the container.</summary>
    ...
    {
        /// <summary>The network name to attach the VM's network interface to.  If unspecified, the global default
        /// network is used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 

        /// <summary>If set to true, do not attach a public IP address to the VM.  Note that without an public IP
    ...
    /// <summary>The Pipeline object describes a series of actions to execute, expressed as docker containers.</summary>
    public class Pipeline : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The environment to pass into every action.  Each action may also specify additional environment
        /// variables but cannot delete an entry from this map (though they may overwrite it with a different
        /// value).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("environment")]
        public virtual System.Collections.Generic.IDictionary<string,string> Environment { get; set; } 
    ...
    {
        /// <summary>The customer project ID to allocate resources in.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("projectId")]
        public virtual string ProjectId { get; set; } 
    ...
    /// <summary>The arguments to the RunPipeline method.  The requesting user must have the iam.serviceAccounts.actAs
    ...
    public class RunPipelineRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// message (i.e., VirtualMachine).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IDictionary<string,string> Labels { get; set; } 
    ...
    public class ServiceAccount : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>List of scopes to be enabled for this service account on the VM, in addition to the Google Genomics
        /// API scope.</summary>
    ...
    public class VirtualMachine : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// To test a pipeline against the beta release of COS, use the value "projects/cos-cloud/global/images/family
        /// /cos-beta".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bootImage")]
        public virtual string BootImage { get; set; } 

        /// <summary>The CPU platform to request.  An instance based on a newer platform may be allocated but never one
        /// with less capabilities.  The value of this parameter must be a valid Compute Engine CPU platform name (such
        /// as "Intel Skylake").  This parameter is only useful for carefully optimized work loads where the CPU
        /// platform has a significant impact.
        ///
        ...
        ///
        /// These labels are applied at creation time to the VM and are applied on a best-effort basis to attached disk
        /// resources shortly after VM creation.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IDictionary<string,string> Labels { get; set; } 

        /// <summary>The machine type of the virtual machine to create.  Must be the short name of a standard machine
        /// type (such as "n1-standard-1") or a custom machine type (such as "custom-1-4096").</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("machineType")]
        public virtual string MachineType { get; set; } 
