    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class EndpointsResource
            {
                ...
                /// Endpoint.name field.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.CloudAlloyDBAdmin.v1beta.Data.Endpoint body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudAlloyDBAdmin.v1beta.Data.Endpoint body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudAlloyDBAdmin.v1beta.Data.Endpoint Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/endpoints";
                ...
                /// <summary>Gets details of a single Endpoint.</summary>
                public class GetRequest : CloudAlloyDBAdminBaseServiceRequest<Google.Apis.CloudAlloyDBAdmin.v1beta.Data.Endpoint>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists Endpoints in a given project and location.</summary>
                public class ListRequest : CloudAlloyDBAdminBaseServiceRequest<Google.Apis.CloudAlloyDBAdmin.v1beta.Data.ListEndpointsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// projects/{project}/locations/{region}
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.CloudAlloyDBAdmin.v1beta.Data.Endpoint body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudAlloyDBAdmin.v1beta.Data.Endpoint body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
