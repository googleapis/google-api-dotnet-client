...
namespace Google.Apis.SecurityCommandCenter.v1p1beta1
{
    ...
    public class OrganizationsResource
    {
        ...
        public class AssetsResource
        {
            ...
            public virtual GroupRequest Group(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupAssetsRequest body, string parent)
            {
                return new GroupRequest(service, body, parent);
            }

            /// <summary>Filters an organization's assets and groups them by their specified properties.</summary>
            public class GroupRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupAssetsResponse>
            {
                /// <summary>Constructs a new Group request.</summary>
                public GroupRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupAssetsRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupAssetsRequest Body { get; set; }
                ...
                public override string RestPath => "v1p1beta1/{+parent}/assets:group";
            ...
            /// <summary>Lists an organization's assets.</summary>
            public class ListRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.ListAssetsResponse>
            {
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+parent}/assets";
            ...
            /// "organizations/[organization_id]".</param>
            public virtual RunDiscoveryRequest RunDiscovery(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.RunAssetDiscoveryRequest body, string parent)
            {
            ...
            public class RunDiscoveryRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Operation>
            {
                ...
                public RunDiscoveryRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.RunAssetDiscoveryRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.RunAssetDiscoveryRequest Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+parent}/assets:runDiscovery";
            ...
            public virtual UpdateSecurityMarksRequest UpdateSecurityMarks(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1SecurityMarks body, string name)
            {
            ...
            public class UpdateSecurityMarksRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1SecurityMarks>
            {
                ...
                public UpdateSecurityMarksRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1SecurityMarks body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1SecurityMarks Body { get; set; }
        ...
        public class NotificationConfigsResource
        {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Required. Resource name of the new notification config's parent. Its format is
            /// "organizations/[organization_id]".</param>
            public virtual CreateRequest Create(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }

            /// <summary>Creates a notification config.</summary>
            public class CreateRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Required. Resource name of the new notification config's parent. Its format is
                /// "organizations/[organization_id]".</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }

                /// <summary>Required. Unique identifier provided by the client within the parent scope. It must be
                /// between 1 and 128 characters, and contains alphanumeric characters, underscores or hyphens
                /// only.</summary>
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+parent}/notificationConfigs";
            ...
            /// <param name="name">Required. Name of the notification config to delete. Its format is
            /// "organizations/[organization_id]/notificationConfigs/[config_id]".</param>
            ...
            public class DeleteRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Empty>
            {
                ...
                /// <summary>Required. Name of the notification config to delete. Its format is
                /// "organizations/[organization_id]/notificationConfigs/[config_id]".</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="name">Required. Name of the notification config to get. Its format is
            /// "organizations/[organization_id]/notificationConfigs/[config_id]".</param>
            ...
            /// <summary>Gets a notification config.</summary>
            public class GetRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig>
            {
                ...
                /// <summary>Required. Name of the notification config to get. Its format is
                /// "organizations/[organization_id]/notificationConfigs/[config_id]".</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="parent">Required. Name of the organization to list notification configs. Its format is
            /// "organizations/[organization_id]".</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            ...
            /// <summary>Lists notification configs.</summary>
            public class ListRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.ListNotificationConfigsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
                ...
                /// <summary>Required. Name of the organization to list notification configs. Its format is
                /// "organizations/[organization_id]".</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
                ...
                /// <summary>The value returned by the last `ListNotificationConfigsResponse`; indicates that this is a
            ...
            /// "organizations/{organization_id}/notificationConfigs/notify_public_bucket".</param>
            public virtual PatchRequest Patch(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig body, string name)
            {
            ...
            public class PatchRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.NotificationConfig body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>The relative resource name of this notification config. See:
                /// https://cloud.google.com/apis/design/resource_names#relative_resource_name Example:
                /// "organizations/{organization_id}/notificationConfigs/notify_public_bucket".</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }

                /// <summary>The FieldMask to use when updating the notification config. If empty all mutable fields
        ...
        public class OperationsResource
        {
            ...
            public class CancelRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Empty>
            {
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+name}:cancel";
        ...
        public class SourcesResource
        {
            ...
            public class FindingsResource
            {
                ...
                public virtual CreateRequest Create(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1Finding body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1Finding body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1Finding Body { get; set; }
                    ...
                    ///<summary>Gets the REST path.</summary>
                    public override string RestPath => "v1p1beta1/{+parent}/findings";
                ...
                /// /v1p1beta1/organizations/{organization_id}/sources/-/findings</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public virtual GroupRequest Group(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupFindingsRequest body, string parent)
                {
                    return new GroupRequest(service, body, parent);
                }
                ...
                /// To group across all sources provide a `-` as the source id. Example:
                /// /v1p1beta1/organizations/{organization_id}/sources/-/findings</summary>
                public class GroupRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupFindingsResponse>
                {
                    /// <summary>Constructs a new Group request.</summary>
                    public GroupRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupFindingsRequest body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GroupFindingsRequest Body { get; set; }
                    ...
                    ///<summary>Gets the REST path.</summary>
                    public override string RestPath => "v1p1beta1/{+parent}/findings:group";
                ...
                /// source id. Example: /v1p1beta1/organizations/{organization_id}/sources/-/findings</summary>
                ...
                /// <summary>Lists an organization or source's findings. To list across all sources provide a `-` as the
                /// source id. Example: /v1p1beta1/organizations/{organization_id}/sources/-/findings</summary>
                public class ListRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.ListFindingsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent)
                        : base(service)
                ...
                public virtual PatchRequest Patch(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1Finding body, string name)
                {
                    return new PatchRequest(service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1Finding body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public virtual SetStateRequest SetState(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.SetFindingStateRequest body, string name)
                {
                ...
                public class SetStateRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GoogleCloudSecuritycenterV1p1beta1Finding>
                {
                    ...
                    public SetStateRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.SetFindingStateRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecurityCommandCenter.v1p1beta1.Data.SetFindingStateRequest Body { get; set; }
                    ...
                    ///<summary>Gets the REST path.</summary>
                    public override string RestPath => "v1p1beta1/{+name}:setState";
            ...
            /// "organizations/[organization_id]".</param>
            public virtual CreateRequest Create(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }

            /// <summary>Creates a source.</summary>
            public class CreateRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+parent}/sources";
            ...
            /// <summary>Gets a source.</summary>
            public class GetRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
            ...
            public virtual GetIamPolicyRequest GetIamPolicy(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GetIamPolicyRequest body, string resource)
            {
                return new GetIamPolicyRequest(service, body, resource);
            }

            /// <summary>Gets the access control policy on the specified Source.</summary>
            public class GetIamPolicyRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Policy>
            {
                /// <summary>Constructs a new GetIamPolicy request.</summary>
                public GetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GetIamPolicyRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.GetIamPolicyRequest Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+resource}:getIamPolicy";
            ...
            /// <summary>Lists all sources belonging to an organization.</summary>
            public class ListRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.ListSourcesResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
            ...
            /// https://cloud.google.com/apis/design/resource_names#relative_resource_name Example:
            /// "organizations/{organization_id}/sources/{source_id}"</param>
            public virtual PatchRequest Patch(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source body, string name)
            {
                return new PatchRequest(service, body, name);
            }
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Source body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>The FieldMask to use when updating the source resource. If empty all mutable fields will be
                /// updated.</summary>
                [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
                public virtual object UpdateMask { get; set; }
            ...
            /// documentation for the appropriate value for this field.</param>
            public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.SetIamPolicyRequest body, string resource)
            {
                return new SetIamPolicyRequest(service, body, resource);
            }

            /// <summary>Sets the access control policy on the specified Source.</summary>
            public class SetIamPolicyRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.Policy>
            {
                /// <summary>Constructs a new SetIamPolicy request.</summary>
                public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.SetIamPolicyRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.SetIamPolicyRequest Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+resource}:setIamPolicy";
            ...
            /// documentation for the appropriate value for this field.</param>
            public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.TestIamPermissionsRequest body, string resource)
            {
                return new TestIamPermissionsRequest(service, body, resource);
            }

            /// <summary>Returns the permissions that a caller has on the specified source.</summary>
            public class TestIamPermissionsRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.TestIamPermissionsResponse>
            {
                /// <summary>Constructs a new TestIamPermissions request.</summary>
                public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.TestIamPermissionsRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecurityCommandCenter.v1p1beta1.Data.TestIamPermissionsRequest Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1p1beta1/{+resource}:testIamPermissions";
        ...
        /// <summary>Gets the settings for an organization.</summary>
        public class GetOrganizationSettingsRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.OrganizationSettings>
        {
        ...
        /// https://cloud.google.com/apis/design/resource_names#relative_resource_name Example:
        /// "organizations/{organization_id}/organizationSettings".</param>
        public virtual UpdateOrganizationSettingsRequest UpdateOrganizationSettings(Google.Apis.SecurityCommandCenter.v1p1beta1.Data.OrganizationSettings body, string name)
        {
        ...
        public class UpdateOrganizationSettingsRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1p1beta1.Data.OrganizationSettings>
        {
            ...
            public UpdateOrganizationSettingsRequest(Google.Apis.Services.IClientService service, Google.Apis.SecurityCommandCenter.v1p1beta1.Data.OrganizationSettings body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
            ...
            /// <summary>The FieldMask to use when updating the settings resource. If empty all mutable fields will be
            /// updated.</summary>
            [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
            public virtual object UpdateMask { get; set; }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SecurityCommandCenter.v1p1beta1.Data.OrganizationSettings Body { get; set; }
...
{    
    ...
    {
        /// <summary>When compare_duration is set, the GroupResult's "state_change" property is updated to indicate
        ...
        /// read_time. If this field is set then `state_change` must be a specified field in `group_by`.</summary>
        ...
        /// and operator combinations are supported: * name: `=` * update_time: `=`, `>`, `<`, `>=`, `<=` Usage: This
        /// should be milliseconds since epoch or an RFC3339 string. Examples: `update_time =
        /// "2019-06-10T16:07:18-07:00"` `update_time = 1560208038000` * create_time: `=`, `>`, `<`, `>=`, `<=` Usage:
        /// This should be milliseconds since epoch or an RFC3339 string. Examples: `create_time =
        /// "2019-06-10T16:07:18-07:00"` `create_time = 1560208038000` * iam_policy.policy_blob: `=`, `:` *
        /// resource_properties: `=`, `:`, `>`, `<`, `>=`, `<=` * security_marks.marks: `=`, `:` *
        /// security_center_properties.resource_name: `=`, `:` * security_center_properties.resource_name_display_name:
        /// `=`, `:` * security_center_properties.resource_type: `=`, `:` * security_center_properties.resource_parent:
        /// `=`, `:` * security_center_properties.resource_parent_display_name: `=`, `:` *
        /// security_center_properties.resource_project: `=`, `:` *
        /// security_center_properties.resource_project_display_name: `=`, `:` *
        ...
        /// property not existing: `-resource_properties.my_property : ""`</summary>
        ...
        /// security_center_properties.resource_project_display_name *
        /// security_center_properties.resource_parent_display_name</summary>
    ...
    {
        /// <summary>When compare_duration is set, the GroupResult's "state_change" attribute is updated to indicate
        /// whether the finding had its state changed, the finding's state remained unchanged, or if the finding was
        /// added during the compare_duration period of time that precedes the read_time. This is the time between
        /// (read_time - compare_duration) and read_time. The state_change value is derived based on the presence and
        /// state of the finding at the two points in time. Intermediate state changes between the two times don't
        /// affect the result. For example, the results aren't affected if the finding is made inactive and then active
        /// again. Possible "state_change" values when compare_duration is specified: * "CHANGED": indicates that the
        /// finding was present and matched the given filter at the start of compare_duration, but changed its state at
        /// read_time. * "UNCHANGED": indicates that the finding was present and matched the given filter at the start
        /// of compare_duration and did not change state at read_time. * "ADDED": indicates that the finding did not
        /// match the given filter or was not present at the start of compare_duration, but was present at read_time. *
        ...
        /// field is set then `state_change` must be a specified field in `group_by`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("compareDuration")]
        public virtual object CompareDuration { get; set; } 

        /// <summary>Expression that defines the filter to apply across findings. The expression is a list of one or
        /// more restrictions combined via logical operators `AND` and `OR`. Parentheses are supported, and `OR` has
        ...
        /// property not existing: `-source_properties.my_property : ""`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("filter")]
        public virtual string Filter { get; set; } 
    ...
    /// <summary>Security Command Center notification configs. A notification config is a Security Command Center
    /// resource that contains the configuration to send notifications for create/update events of findings, assets and
    /// etc.</summary>
    public class NotificationConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The type of events the config is for, e.g. FINDING.</summary>
        ...
        /// <summary>The Pub/Sub topic to send notifications to. Its format is
        /// "projects/[project_id]/topics/[topic]".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pubsubTopic")]
        public virtual string PubsubTopic { get; set; } 

        /// <summary>Output only. The service account that needs "pubsub.topics.publish" permission to publish to the
    ...
    /// <summary>The config for streaming-based notifications, which send each event as soon as it is
    /// detected.</summary>
    public class StreamingConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Expression that defines the filter to apply across create/update events of assets or findings as
        /// specified by the event type. The expression is a list of zero or more restrictions combined via logical
        /// operators `AND` and `OR`. Parentheses are supported, and `OR` has higher precedence than `AND`. Restrictions
        /// have the form ` ` and may have a `-` character in front of them to indicate negation. The fields map to
        /// those defined in the corresponding resource. The supported operators are: * `=` for all value types. * `>`,
        /// `<`, `>=`, `<=` for integer values. * `:`, meaning substring matching, for strings. The supported value
        /// types are: * string literals in quotes. * integer literals without quotes. * boolean literals `true` and
        /// `false` without quotes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("filter")]
        public virtual string Filter { get; set; } 
