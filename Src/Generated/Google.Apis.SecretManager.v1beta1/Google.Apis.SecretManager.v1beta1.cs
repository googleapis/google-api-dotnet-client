...
namespace Google.Apis.SecretManager.v1beta1
{
    ...
    public class SecretManagerService : Google.Apis.Services.BaseClientService
    {
        ...
        public SecretManagerService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class SecretManagerBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected SecretManagerBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Location>
            {
        ...
        public class SecretsResource
        {
            ...
            public class VersionsResource
            {
                ...
                /// <summary>Accesses a SecretVersion. This call returns the secret data.
                /// `projects/secrets/versions/latest` is an alias to the `latest` SecretVersion.</summary>
                public class AccessRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.AccessSecretVersionResponse>
                {
                    /// <summary>Constructs a new Access request.</summary>
                    public AccessRequest(Google.Apis.Services.IClientService service, string name)
                        : base(service)
                    {
                        Name = name;
                        InitParameters();
                    ...
                    /// <summary>Required. The resource name of the SecretVersion in the format
                    /// `projects/secrets/versions`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    ///<summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+name}:access";
                ...
                /// `projects/secrets/versions`.</param>
                public virtual DestroyRequest Destroy(Google.Apis.SecretManager.v1beta1.Data.DestroySecretVersionRequest body, string name)
                {
                ...
                /// <summary>Destroys a SecretVersion. Sets the state of the SecretVersion to DESTROYED and irrevocably
                /// destroys the secret data.</summary>
                public class DestroyRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.SecretVersion>
                {
                    /// <summary>Constructs a new Destroy request.</summary>
                    public DestroyRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.DestroySecretVersionRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Required. The resource name of the SecretVersion to destroy in the format
                    /// `projects/secrets/versions`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    Google.Apis.SecretManager.v1beta1.Data.DestroySecretVersionRequest Body { get; set; }
                    ...
                    ///<summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+name}:destroy";
                ...
                /// `projects/secrets/versions`.</param>
                public virtual DisableRequest Disable(Google.Apis.SecretManager.v1beta1.Data.DisableSecretVersionRequest body, string name)
                {
                    return new DisableRequest(service, body, name);
                }

                /// <summary>Disables a SecretVersion. Sets the state of the SecretVersion to DISABLED.</summary>
                public class DisableRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.SecretVersion>
                {
                    /// <summary>Constructs a new Disable request.</summary>
                    public DisableRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.DisableSecretVersionRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Required. The resource name of the SecretVersion to disable in the format
                    /// `projects/secrets/versions`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecretManager.v1beta1.Data.DisableSecretVersionRequest Body { get; set; }
                ...
                /// `projects/secrets/versions`.</param>
                public virtual EnableRequest Enable(Google.Apis.SecretManager.v1beta1.Data.EnableSecretVersionRequest body, string name)
                {
                    return new EnableRequest(service, body, name);
                }

                /// <summary>Enables a SecretVersion. Sets the state of the SecretVersion to ENABLED.</summary>
                public class EnableRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.SecretVersion>
                {
                    /// <summary>Constructs a new Enable request.</summary>
                    public EnableRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.EnableSecretVersionRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Required. The resource name of the SecretVersion to enable in the format
                    /// `projects/secrets/versions`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecretManager.v1beta1.Data.EnableSecretVersionRequest Body { get; set; }
                ...
                /// <summary>Gets metadata for a SecretVersion. `projects/secrets/versions/latest` is an alias to the
                /// `latest` SecretVersion.</summary>
                public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.SecretVersion>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name)
                        : base(service)
                    ...
                    /// <summary>Required. The resource name of the SecretVersion in the format
                    /// `projects/secrets/versions`. `projects/secrets/versions/latest` is an alias to the `latest`
                    /// SecretVersion.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="parent">Required. The resource name of the Secret associated with the SecretVersions to list, in the
                /// format `projects/secrets`.</param>
                ...
                /// <summary>Lists SecretVersions. This call does not return secret data.</summary>
                public class ListRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.ListSecretVersionsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    ...
                    /// <summary>Required. The resource name of the Secret associated with the SecretVersions to list,
                    /// in the format `projects/secrets`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Optional. The maximum number of results to be returned in a single page. If set to 0,
                    /// the server decides the number of results to return. If the number is greater than 25000, it is
                    /// capped at 25000.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }

                    /// <summary>Optional. Pagination token, returned earlier via
                    /// ListSecretVersionsResponse.next_page_token][].</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string PageToken { get; set; }
            ...
            /// <summary>Creates a new SecretVersion containing secret data and attaches it to an existing
            /// Secret.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Required. The resource name of the Secret to associate with the SecretVersion in the format
            /// `projects/secrets`.</param>
            public virtual AddVersionRequest AddVersion(Google.Apis.SecretManager.v1beta1.Data.AddSecretVersionRequest body, string parent)
            {
            ...
            /// <summary>Creates a new SecretVersion containing secret data and attaches it to an existing
            /// Secret.</summary>
            public class AddVersionRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.SecretVersion>
            {
                /// <summary>Constructs a new AddVersion request.</summary>
                public AddVersionRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.AddSecretVersionRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Required. The resource name of the Secret to associate with the SecretVersion in the format
                /// `projects/secrets`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }


                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecretManager.v1beta1.Data.AddSecretVersionRequest Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1beta1/{+parent}:addVersion";
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Required. The resource name of the project to associate with the Secret, in the format
            /// `projects`.</param>
            public virtual CreateRequest Create(Google.Apis.SecretManager.v1beta1.Data.Secret body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }

            /// <summary>Creates a new Secret containing no SecretVersions.</summary>
            public class CreateRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Secret>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.Secret body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Required. The resource name of the project to associate with the Secret, in the format
                /// `projects`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecretManager.v1beta1.Data.Secret Body { get; set; }
                ...
                ///<summary>Gets the REST path.</summary>
                public override string RestPath => "v1beta1/{+parent}/secrets";
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add(
                        "secretId", new Google.Apis.Discovery.Parameter
                        {
                            Name = "secretId",
                            IsRequired = false,
                            ParameterType = "query",
            ...
            /// <param name="name">Required. The resource name of the Secret to delete in the format
            /// `projects/secrets`.</param>
            ...
            /// <summary>Deletes a Secret.</summary>
            public class DeleteRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Empty>
            {
                ...
                /// <summary>Required. The resource name of the Secret to delete in the format
                /// `projects/secrets`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="name">Required. The resource name of the Secret, in the format `projects/secrets`.</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            }
            ...
            /// <summary>Gets metadata for a given Secret.</summary>
            public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Secret>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
            ...
            /// <summary>Gets the access control policy for a secret. Returns empty policy if the secret exists and does
            /// not have a policy set.</summary>
            ...
            /// <summary>Gets the access control policy for a secret. Returns empty policy if the secret exists and does
            /// not have a policy set.</summary>
            public class GetIamPolicyRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Policy>
            {
            ...
            /// <param name="parent">Required. The resource name of the project associated with the Secrets, in the format
            /// `projects`.</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            ...
            /// <summary>Lists Secrets.</summary>
            public class ListRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.ListSecretsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
                ...
                /// <summary>Required. The resource name of the project associated with the Secrets, in the format
                /// `projects`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }

                /// <summary>Optional. The maximum number of results to be returned in a single page. If set to 0, the
                /// server decides the number of results to return. If the number is greater than 25000, it is capped at
                /// 25000.</summary>
                [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                public virtual System.Nullable<int> PageSize { get; set; }

                /// <summary>Optional. Pagination token, returned earlier via
                /// ListSecretsResponse.next_page_token.</summary>
                [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string PageToken { get; set; }
            ...
            public virtual PatchRequest Patch(Google.Apis.SecretManager.v1beta1.Data.Secret body, string name)
            {
                return new PatchRequest(service, body, name);
            }

            /// <summary>Updates metadata of an existing Secret.</summary>
            public class PatchRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Secret>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.Secret body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
            ...
            /// documentation for the appropriate value for this field.</param>
            public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.SecretManager.v1beta1.Data.SetIamPolicyRequest body, string resource)
            {
            ...
            /// Permissions on SecretVersions are enforced according to the policy set on the associated
            /// Secret.</summary>
            public class SetIamPolicyRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.Policy>
            {
                /// <summary>Constructs a new SetIamPolicy request.</summary>
                public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.SetIamPolicyRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecretManager.v1beta1.Data.SetIamPolicyRequest Body { get; set; }
            ...
            /// documentation for the appropriate value for this field.</param>
            public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.SecretManager.v1beta1.Data.TestIamPermissionsRequest body, string resource)
            {
            ...
            /// to be used for building permission-aware UIs and command-line tools, not for authorization checking.
            /// This operation may "fail open" without warning.</summary>
            public class TestIamPermissionsRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta1.Data.TestIamPermissionsResponse>
            {
                /// <summary>Constructs a new TestIamPermissions request.</summary>
                public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SecretManager.v1beta1.Data.TestIamPermissionsRequest Body { get; set; }
...
{    
    ...
    /// <summary>A secret payload resource in the Secret Manager API. This contains the sensitive secret data that is
    /// associated with a SecretVersion.</summary>
    ...
    /// <summary>A replication policy that replicates the Secret payload into the locations specified in
