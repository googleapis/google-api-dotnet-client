...
namespace Google.Apis.Merchant.datasources_v1
{
    ...
    public class MerchantService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "datasources_v1";
    ...
    public class AccountsResource
    {
        ...
        public class DataSourcesResource
        {
            ...
            public class FileUploadsResource
            {
                ...
                /// Gets the latest data source file upload. Only the `latest` alias is accepted for a file upload.
                /// </summary>
                public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.FileUpload>
                {
                    ...
                    public override string RestPath => "datasources/v1/{+name}";
            ...
            /// </param>
            public virtual CreateRequest Create(Google.Apis.Merchant.datasources_v1.Data.DataSource body, string parent)
            {
            ...
            /// source.
            /// </summary>
            public class CreateRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.DataSource>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.datasources_v1.Data.DataSource body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.Merchant.datasources_v1.Data.DataSource Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "datasources/v1/{+parent}/dataSources";
            ...
            /// <summary>Deletes a data source from your Merchant Center account.</summary>
            public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.Empty>
            {
            ...
            /// `accounts/{account}/dataSources/{datasource}`
            /// </param>
            public virtual FetchRequest Fetch(Google.Apis.Merchant.datasources_v1.Data.FetchDataSourceRequest body, string name)
            {
            ...
            /// set.
            /// </summary>
            public class FetchRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.Empty>
            {
                /// <summary>Constructs a new Fetch request.</summary>
                public FetchRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.datasources_v1.Data.FetchDataSourceRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Merchant.datasources_v1.Data.FetchDataSourceRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "datasources/v1/{+name}:fetch";
            ...
            /// <summary>Retrieves the data source configuration for the given account.</summary>
            public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.DataSource>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists the configurations for data sources for the given account.</summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.ListDataSourcesResponse>
            {
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.Merchant.datasources_v1.Data.DataSource body, string name)
            {
            ...
            /// provided in the resource will be deleted.
            /// </summary>
            public class PatchRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.datasources_v1.Data.DataSource>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.datasources_v1.Data.DataSource body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
...
namespace Google.Apis.Merchant.datasources_v1.Data
{
    /// <summary>
    ...
    public class PrimaryProductDataSource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. Immutable. Determines whether the products of this data source are **only** targeting local
        /// destinations. Legacy local products are prefixed with `local~` in the product resource ID. For example,
        /// `accounts/123/products/local~en~US~sku123`.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("legacyLocal")]
        public virtual System.Nullable<bool> LegacyLocal { get; set; }
    ...
    /// source](https://developers.google.com/merchant/api/guides/data-sources/api-sources#link-supplemental-data-source)
    /// for local and online products. After creation,you should make sure to link the supplemental product data source
    /// into one or more primary product data sources.
    /// </summary>
