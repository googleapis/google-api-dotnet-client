...
namespace Google.Apis.WebSecurityScanner.v1beta
{
    ...
    public class WebSecurityScannerService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://websecurityscanner.googleapis.com/";

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "";

        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://websecurityscanner.googleapis.com/batch";
        ...
        public class ScanConfigsResource
        {
            ...
            public class ScanRunsResource
            {
                ...
                public class CrawledUrlsResource
                {
                    ...
                    /// <summary>List CrawledUrls under a given ScanRun.</summary>
                    public class ListRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ListCrawledUrlsResponse>
                    {
                        ...
                        public override string RestPath => "v1beta/{+parent}/crawledUrls";
                ...
                public class FindingTypeStatsResource
                {
                    ...
                    /// <summary>List all FindingTypeStats under a given ScanRun.</summary>
                    public class ListRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ListFindingTypeStatsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+parent}/findingTypeStats";
                ...
                public class FindingsResource
                {
                    ...
                    /// <summary>Gets a Finding.</summary>
                    public class GetRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.Finding>
                    {
                    ...
                    /// <summary>List Findings under a given ScanRun.</summary>
                    public class ListRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ListFindingsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                ...
                /// <summary>Gets a ScanRun.</summary>
                public class GetRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ScanRun>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// Lists ScanRuns under a given ScanConfig, in descending order of ScanRun stop time.
                /// </summary>
                public class ListRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ListScanRunsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/scanRuns";
                ...
                /// 'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
                /// </param>
                public virtual StopRequest Stop(Google.Apis.WebSecurityScanner.v1beta.Data.StopScanRunRequest body, string name)
                {
                    return new StopRequest(service, body, name);
                }

                /// <summary>Stops a ScanRun. The stopped ScanRun is returned.</summary>
                public class StopRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ScanRun>
                {
                    /// <summary>Constructs a new Stop request.</summary>
                    public StopRequest(Google.Apis.Services.IClientService service, Google.Apis.WebSecurityScanner.v1beta.Data.StopScanRunRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.WebSecurityScanner.v1beta.Data.StopScanRunRequest Body { get; set; }
            ...
            /// </param>
            public virtual CreateRequest Create(Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }

            /// <summary>Creates a new ScanConfig.</summary>
            public class CreateRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1beta/{+parent}/scanConfigs";
            ...
            /// <summary>Deletes an existing ScanConfig and its child resources.</summary>
            public class DeleteRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.Empty>
            {
            ...
            /// <summary>Gets a ScanConfig.</summary>
            public class GetRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists ScanConfigs under a given project.</summary>
            public class ListRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ListScanConfigsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig body, string name)
            {
                return new PatchRequest(service, body, name);
            }

            /// <summary>Updates a ScanConfig. This method support partial update of a ScanConfig.</summary>
            public class PatchRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.WebSecurityScanner.v1beta.Data.ScanConfig body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
            ...
            /// 'projects/{projectId}/scanConfigs/{scanConfigId}'.
            /// </param>
            public virtual StartRequest Start(Google.Apis.WebSecurityScanner.v1beta.Data.StartScanRunRequest body, string name)
            {
                return new StartRequest(service, body, name);
            }

            /// <summary>Start a ScanRun according to the given ScanConfig.</summary>
            public class StartRequest : WebSecurityScannerBaseServiceRequest<Google.Apis.WebSecurityScanner.v1beta.Data.ScanRun>
            {
                /// <summary>Constructs a new Start request.</summary>
                public StartRequest(Google.Apis.Services.IClientService service, Google.Apis.WebSecurityScanner.v1beta.Data.StartScanRunRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.WebSecurityScanner.v1beta.Data.StartScanRunRequest Body { get; set; }
...
namespace Google.Apis.WebSecurityScanner.v1beta.Data
{
    ...
    public class Finding : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The severity level of the reported vulnerability.</summary>
    ...
    {
        /// <summary>
        /// Authentication configuration when Web-Security-Scanner service account is added in Identity-Aware-Proxy
        /// (IAP) access policies.
        /// </summary>
    ...
    public class ScanConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Whether the scan configuration has enabled static IP address scan feature. If enabled, the scanner will
        /// access applications from static IP addresses.
        /// </summary>
    ...
    /// <summary>
    /// Defines a custom error message used by CreateScanConfig and UpdateScanConfig APIs when scan configuration
    /// validation fails. It is also reported as part of a ScanRunErrorTrace message if scan validation fails due to a
    ...
    public class ScanConfigError : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// This field is provided for troubleshooting purposes only and its actual value can change in the future.
        /// </summary>
    ...
    public class ScanRun : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// If result_state is an ERROR, this field provides the primary reason for scan's termination and more details,
    ...
    public class ScanRunErrorTrace : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// If the scan encounters TOO_MANY_HTTP_ERRORS, this field indicates the most common HTTP error code, if such
        /// is available. For example, if this code is 404, the scan has encountered too many NOT_FOUND responses.
        /// </summary>
        ...
        /// <summary>
        /// If the scan encounters SCAN_CONFIG_ISSUE error, this field has the error message encountered during scan
    ...
    /// <summary>
    /// Output only. Defines a warning trace message for ScanRun. Warning traces provide customers with useful
    /// information that helps make the scanning process more effective.
    /// </summary>
