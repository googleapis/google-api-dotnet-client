    ...
    public class PlatformsResource
    {
        ...
        public class AccountsResource
        {
            ...
            public class EventsResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.AdSensePlatform.v1.Data.Event body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates an account event.</summary>
                public class CreateRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.Event>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.AdSensePlatform.v1.Data.Event body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.AdSensePlatform.v1.Data.Event Body { get; set; }
                    ...
                    public override string RestPath => "v1/{+parent}/events";
            ...
            public class SitesResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.AdSensePlatform.v1.Data.Site body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a site for a specified account.</summary>
                public class CreateRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.Site>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.AdSensePlatform.v1.Data.Site body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AdSensePlatform.v1.Data.Site Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/sites";
                ...
                /// <summary>Deletes a site from a specified account.</summary>
                public class DeleteRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.Empty>
                {
                ...
                /// <summary>Gets a site from a specified sub-account.</summary>
                public class GetRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.Site>
                {
                ...
                /// <summary>Lists sites for a specific account.</summary>
                public class ListRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.ListSitesResponse>
                {
                ...
                /// your site before requesting a review.
                /// </summary>
                public class RequestReviewRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.RequestSiteReviewResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:requestReview";
            ...
            /// </param>
            public virtual CloseRequest Close(Google.Apis.AdSensePlatform.v1.Data.CloseAccountRequest body, string name)
            {
                return new CloseRequest(this.service, body, name);
            }

            /// <summary>Closes a sub-account.</summary>
            public class CloseRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.CloseAccountResponse>
            {
                /// <summary>Constructs a new Close request.</summary>
                public CloseRequest(Google.Apis.Services.IClientService service, Google.Apis.AdSensePlatform.v1.Data.CloseAccountRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.AdSensePlatform.v1.Data.CloseAccountRequest Body { get; set; }
            ...
            public virtual CreateRequest Create(Google.Apis.AdSensePlatform.v1.Data.Account body, string parent)
            {
                return new CreateRequest(this.service, body, parent);
            }

            /// <summary>Creates a sub-account.</summary>
            public class CreateRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.Account>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.AdSensePlatform.v1.Data.Account body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.AdSensePlatform.v1.Data.Account Body { get; set; }
            ...
            /// <summary>Gets information about the selected sub-account.</summary>
            public class GetRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.Account>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists a partial view of sub-accounts for a specific parent account.</summary>
            public class ListRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.ListAccountsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
            ...
            /// the given creation_request_id, returns 404.
            /// </summary>
            public class LookupRequest : AdSensePlatformBaseServiceRequest<Google.Apis.AdSensePlatform.v1.Data.LookupAccountResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/{+parent}/accounts:lookup";
