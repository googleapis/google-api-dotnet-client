...
namespace Google.Apis.DeploymentManager.alpha
{
    ...
    public class DeploymentManagerService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://deploymentmanager.googleapis.com/";
    ...
    public class CompositeTypesResource
    {
        ...
        /// <summary>Deletes a composite type.</summary>
        public class DeleteRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            ...
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}";
        ...
        /// <summary>Gets information about a specific composite type.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.CompositeType>
        {
        ...
        /// <param name="project">The project ID for this request.</param>
        public virtual InsertRequest Insert(Google.Apis.DeploymentManager.alpha.Data.CompositeType body, string project)
        {
            return new InsertRequest(this.service, body, project);
        }

        /// <summary>Creates a composite type.</summary>
        public class InsertRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.CompositeType body, string project) : base(service)
            {
                Project = project;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/compositeTypes";
        ...
        /// <summary>Lists all composite types for Deployment Manager.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.CompositeTypesListResponse>
        {
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="compositeType">The name of the composite type for this request.</param>
        public virtual PatchRequest Patch(Google.Apis.DeploymentManager.alpha.Data.CompositeType body, string project, string compositeType)
        {
            return new PatchRequest(this.service, body, project, compositeType);
        }

        /// <summary>Patches a composite type.</summary>
        public class PatchRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.CompositeType body, string project, string compositeType) : base(service)
            {
                Project = project;
                CompositeType = compositeType;
                Body = body;
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="compositeType">The name of the composite type for this request.</param>
        public virtual UpdateRequest Update(Google.Apis.DeploymentManager.alpha.Data.CompositeType body, string project, string compositeType)
        {
            return new UpdateRequest(this.service, body, project, compositeType);
        }

        /// <summary>Updates a composite type.</summary>
        public class UpdateRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.CompositeType body, string project, string compositeType) : base(service)
            {
                Project = project;
                CompositeType = compositeType;
                Body = body;
    ...
    public class DeploymentsResource
    {
        ...
        public virtual CancelPreviewRequest CancelPreview(Google.Apis.DeploymentManager.alpha.Data.DeploymentsCancelPreviewRequest body, string project, string deployment)
        {
            return new CancelPreviewRequest(this.service, body, project, deployment);
        }

        /// <summary>Cancels and removes the preview currently associated with the deployment.</summary>
        public class CancelPreviewRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            /// <summary>Constructs a new CancelPreview request.</summary>
            public CancelPreviewRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.DeploymentsCancelPreviewRequest body, string project, string deployment) : base(service)
            {
                Project = project;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.DeploymentManager.alpha.Data.DeploymentsCancelPreviewRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/cancelPreview";
        ...
        public class DeleteRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}";
        ...
        /// <summary>Gets information about a specific deployment.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Deployment>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// Gets the access control policy for a resource. May be empty if no such policy or resource exists.
        /// </summary>
        public class GetIamPolicyRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Policy>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/getIamPolicy";
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="project">The project ID for this request.</param>
        public virtual InsertRequest Insert(Google.Apis.DeploymentManager.alpha.Data.Deployment body, string project)
        {
            return new InsertRequest(this.service, body, project);
        }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.Deployment body, string project) : base(service)
            {
                Project = project;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.DeploymentManager.alpha.Data.Deployment Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments";
        ...
        /// <summary>Lists all deployments for a given project.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.DeploymentsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project) : base(service)
            {
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="deployment">The name of the deployment for this request.</param>
        public virtual PatchRequest Patch(Google.Apis.DeploymentManager.alpha.Data.Deployment body, string project, string deployment)
        {
        ...
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.Deployment body, string project, string deployment) : base(service)
            {
                Project = project;
                Deployment = deployment;
                Body = body;
        ...
        /// <param name="project">Project ID for this request.</param>
        /// <param name="resource">Name or id of the resource for this request.</param>
        public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.DeploymentManager.alpha.Data.GlobalSetPolicyRequest body, string project, string resource)
        {
            return new SetIamPolicyRequest(this.service, body, project, resource);
        }

        /// <summary>Sets the access control policy on the specified resource. Replaces any existing policy.</summary>
        public class SetIamPolicyRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Policy>
        {
            /// <summary>Constructs a new SetIamPolicy request.</summary>
            public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.GlobalSetPolicyRequest body, string project, string resource) : base(service)
            {
                Project = project;
                Resource = resource;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.DeploymentManager.alpha.Data.GlobalSetPolicyRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/setIamPolicy";
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="deployment">The name of the deployment for this request.</param>
        public virtual StopRequest Stop(Google.Apis.DeploymentManager.alpha.Data.DeploymentsStopRequest body, string project, string deployment)
        {
        ...
        /// any new work from being started.
        /// </summary>
        public class StopRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            /// <summary>Constructs a new Stop request.</summary>
            public StopRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.DeploymentsStopRequest body, string project, string deployment) : base(service)
            {
                Project = project;
                Deployment = deployment;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.DeploymentManager.alpha.Data.DeploymentsStopRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/stop";
        ...
        /// <param name="project">Project ID for this request.</param>
        /// <param name="resource">Name or id of the resource for this request.</param>
        public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.DeploymentManager.alpha.Data.TestPermissionsRequest body, string project, string resource)
        {
            return new TestIamPermissionsRequest(this.service, body, project, resource);
        }

        /// <summary>Returns permissions that a caller has on the specified resource.</summary>
        public class TestIamPermissionsRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.TestPermissionsResponse>
        {
            /// <summary>Constructs a new TestIamPermissions request.</summary>
            public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.TestPermissionsRequest body, string project, string resource) : base(service)
            {
                Project = project;
                Resource = resource;
                Body = body;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/testIamPermissions";
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="deployment">The name of the deployment for this request.</param>
        public virtual UpdateRequest Update(Google.Apis.DeploymentManager.alpha.Data.Deployment body, string project, string deployment)
        {
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.Deployment body, string project, string deployment) : base(service)
            {
                Project = project;
                Deployment = deployment;
                Body = body;
    ...
    public class ManifestsResource
    {
        ...
        /// <summary>Gets information about a specific manifest.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Manifest>
        {
            /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests/{manifest}";
        ...
        /// <summary>Lists all manifests for a given deployment.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.ManifestsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests";
    ...
    public class OperationsResource
    {
        ...
        /// <summary>Gets information about a specific operation.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/operations/{operation}";
        ...
        /// <summary>Lists all operations for a project.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.OperationsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/operations";
    ...
    public class ResourcesResource
    {
        ...
        /// <summary>Gets information about a single resource.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Resource>
        {
            /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources/{resource}";
        ...
        /// <summary>Lists all resources in a given deployment.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.ResourcesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string deployment) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources";
    ...
    public class TypeProvidersResource
    {
        ...
        public class DeleteRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}";
        ...
        /// <summary>Gets information about a specific type provider.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.TypeProvider>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Gets a type info for a type provided by a TypeProvider.</summary>
        public class GetTypeRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.TypeInfo>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}/types/{type}";
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="project">The project ID for this request.</param>
        public virtual InsertRequest Insert(Google.Apis.DeploymentManager.alpha.Data.TypeProvider body, string project)
        {
            return new InsertRequest(this.service, body, project);
        }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.TypeProvider body, string project) : base(service)
            {
                Project = project;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/typeProviders";
        ...
        /// <summary>Lists all resource type providers for Deployment Manager.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.TypeProvidersListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project) : base(service)
            {
        ...
        /// <summary>Lists all the type info for a TypeProvider.</summary>
        public class ListTypesRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.TypeProvidersListTypesResponse>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}/types";
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="typeProvider">The name of the type provider for this request.</param>
        public virtual PatchRequest Patch(Google.Apis.DeploymentManager.alpha.Data.TypeProvider body, string project, string typeProvider)
        {
        ...
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.TypeProvider body, string project, string typeProvider) : base(service)
            {
                Project = project;
                TypeProvider = typeProvider;
                Body = body;
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="typeProvider">The name of the type provider for this request.</param>
        public virtual UpdateRequest Update(Google.Apis.DeploymentManager.alpha.Data.TypeProvider body, string project, string typeProvider)
        {
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.alpha.Data.TypeProvider body, string project, string typeProvider) : base(service)
            {
                Project = project;
                TypeProvider = typeProvider;
                Body = body;
    ...
    public class TypesResource
    {
        ...
        /// <param name="project">The project ID for this request.</param>
        /// <param name="type">The name of the type for this request.</param>
        public virtual GetRequest Get(string project, string type)
        {
            return new GetRequest(this.service, project, type);
        }

        /// <summary>Gets information about a specific type.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.Type>
        {
            /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/types/{type}";
        ...
        /// <summary>Lists all resource types for Deployment Manager.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.alpha.Data.TypesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "deploymentmanager/alpha/projects/{project}/global/types";
...
namespace Google.Apis.DeploymentManager.alpha.Data
{
    ...
    public class AsyncOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Deployment manager will poll instances for this API resource setting a RUNNING state, and blocking until
        /// polling conditions tell whether the resource is completed or failed.
        /// </summary>
    ...
    /// <summary>Label object for CompositeTypes</summary>
    ...
    {
        /// <summary>
        /// JsonPath expression on the resource that if non empty, indicates that this field needs to be extracted as a
        /// diagnostic.
        /// </summary>
    ...
    /// <summary>
    /// InputMapping creates a 'virtual' property that will be injected into the properties before sending the request
    ...
    public class Options : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The json path to the field in the resource JSON body into which the resource name should be mapped. Leaving
        /// this empty indicates that there should be no mapping performed.
        /// </summary>
    ...
    {
        /// <summary>
        /// An array of diagnostics to be collected by Deployment Manager, these diagnostics will be displayed to the
        /// user.
        /// </summary>
    ...
    public class Resource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. In case this is an action, it will show the runtimePolicies on which this action will run in
        /// the deployment
        /// </summary>
    ...
    public class ResourceUpdate : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. In case this is an action, it will show the runtimePolicies that this action will have after
    ...
    /// <summary>
    /// Type Information. Contains detailed information about a composite type, base type, or base type with specific
    /// collection.
    /// </summary>
    public class TypeInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// For base types with a collection, we return a schema and documentation link For template types, we return
        /// only a schema
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("schema")]
    ...
    public class TypeInfoSchemaInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The properties that this composite type or base type collection exposes as output, these properties can be
        /// used for references, represented as json blob, format is: JSON Schema Draft V4
        /// </summary>
    ...
    /// <summary>Label object for Types</summary>
    ...
    public class TypeProvider : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// List of up to 2 custom certificate authority roots to use for TLS authentication when making calls on behalf
        /// of this type provider. If set, TLS authentication will exclusively use these roots instead of relying on
        /// publicly trusted certificate authorities when validating TLS certificate authenticity. The certificates must
        /// be in base64-encoded PEM format. The maximum size of each certificate must not exceed 10KB.
        /// </summary>
    ...
    /// <summary>Label object for TypeProviders</summary>
