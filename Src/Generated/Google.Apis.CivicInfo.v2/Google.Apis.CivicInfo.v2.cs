...
namespace Google.Apis.CivicInfo.v2
{
    ...
    public class CivicInfoService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://www.googleapis.com/civicinfo/v2/"; }
        #else
    ...
    public class ElectionsResource
    {
        ...
        public class VoterInfoQueryRequest : CivicInfoBaseServiceRequest<Google.Apis.CivicInfo.v2.Data.VoterInfoResponse>
        {
            ...
            /// https://www.googleapis.com/civicinfo/{version}/electionsIf no election ID is specified in the query and
            /// there is more than one election with data for the given voter, the additional elections are provided in
            /// the otherElections response field.</summary>
            /// [default: 0]
...
{    
    ...
    public class FieldMetadataProto : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("internal")]
        public virtual InternalFieldMetadataProto Internal__ { get; set; } 
    ...
    public class InternalFieldMetadataProto : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("isAuto")]
        public virtual System.Nullable<bool> IsAuto { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("sourceSummary")]
        public virtual InternalSourceSummaryProto SourceSummary { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class InternalSourceSummaryProto : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class PointProto : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("latE7")]
        public virtual System.Nullable<long> LatE7 { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("lngE7")]
        public virtual System.Nullable<long> LngE7 { get; set; } 
    ...
    {
        [Newtonsoft.Json.JsonPropertyAttribute("collidedSegmentSource")]
        public virtual StreetSegmentList CollidedSegmentSource { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("ctclContestUuid")]
        public virtual string CtclContestUuid { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("ctclOfficeUuid")]
        public virtual string CtclOfficeUuid { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("datasetId")]
        public virtual System.Nullable<long> DatasetId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("precinctId")]
        public virtual System.Nullable<long> PrecinctId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("precinctSplitId")]
        public virtual System.Nullable<long> PrecinctSplitId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("tsStreetSegmentId")]
        public virtual string TsStreetSegmentId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("vip5PrecinctId")]
        public virtual string Vip5PrecinctId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("vip5StreetSegmentId")]
        public virtual string Vip5StreetSegmentId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("vipStreetSegmentId")]
        public virtual System.Nullable<long> VipStreetSegmentId { get; set; } 
    ...
    public class StreetSegment : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("administrationRegionIds")]
        public virtual System.Collections.Generic.IList<string> AdministrationRegionIds { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("beforeGeocodeId")]
        public virtual string BeforeGeocodeId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("catalistUniquePrecinctCode")]
        public virtual string CatalistUniquePrecinctCode { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("city")]
        public virtual string City { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("cityCouncilDistrict")]
        public virtual string CityCouncilDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("congressionalDistrict")]
        public virtual string CongressionalDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("contestIds")]
        public virtual System.Collections.Generic.IList<string> ContestIds { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("countyCouncilDistrict")]
        public virtual string CountyCouncilDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("countyFips")]
        public virtual string CountyFips { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("datasetId")]
        public virtual System.Nullable<long> DatasetId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("earlyVoteSiteByIds")]
        public virtual System.Collections.Generic.IList<string> EarlyVoteSiteByIds { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("endHouseNumber")]
        public virtual System.Nullable<long> EndHouseNumber { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("geocodedPoint")]
        public virtual PointProto GeocodedPoint { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("geographicDivisionOcdIds")]
        public virtual System.Collections.Generic.IList<string> GeographicDivisionOcdIds { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("judicialDistrict")]
        public virtual string JudicialDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("mailOnly")]
        public virtual System.Nullable<bool> MailOnly { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("municipalDistrict")]
        public virtual string MunicipalDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("ncoaAddress")]
        public virtual string NcoaAddress { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("oddOrEvens")]
        public virtual System.Collections.Generic.IList<string> OddOrEvens { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("originalId")]
        public virtual string OriginalId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("pollinglocationByIds")]
        public virtual System.Collections.Generic.IList<string> PollinglocationByIds { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("precinctName")]
        public virtual string PrecinctName { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("precinctOcdId")]
        public virtual string PrecinctOcdId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("provenances")]
        public virtual System.Collections.Generic.IList<Provenance> Provenances { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("published")]
        public virtual System.Nullable<bool> Published { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("schoolDistrict")]
        public virtual string SchoolDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("startHouseNumber")]
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("stateHouseDistrict")]
        public virtual string StateHouseDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("stateSenateDistrict")]
        public virtual string StateSenateDistrict { get; set; } 
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("surrogateId")]
        public virtual System.Nullable<long> SurrogateId { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("targetsmartUniquePrecinctCode")]
        public virtual string TargetsmartUniquePrecinctCode { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("townshipDistrict")]
        public virtual string TownshipDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("unitNumber")]
        public virtual string UnitNumber { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("unitType")]
        public virtual string UnitType { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("vanPrecinctCode")]
        public virtual string VanPrecinctCode { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("voterGeographicDivisionOcdIds")]
        public virtual System.Collections.Generic.IList<string> VoterGeographicDivisionOcdIds { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("wardDistrict")]
        public virtual string WardDistrict { get; set; } 

        [Newtonsoft.Json.JsonPropertyAttribute("wildcard")]
        public virtual System.Nullable<bool> Wildcard { get; set; } 
    ...
    public class StreetSegmentList : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("segments")]
        public virtual System.Collections.Generic.IList<StreetSegment> Segments { get; set; } 
