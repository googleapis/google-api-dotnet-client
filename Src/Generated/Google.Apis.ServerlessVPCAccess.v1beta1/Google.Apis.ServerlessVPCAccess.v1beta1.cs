...
namespace Google.Apis.ServerlessVPCAccess.v1beta1
{
    /// <summary>The ServerlessVPCAccess Service.</summary>
    public class ServerlessVPCAccessService : Google.Apis.Services.BaseClientService
    {
        ...
        public ServerlessVPCAccessService() : this(new Google.Apis.Services.BaseClientService.Initializer())
        {
        }

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public ServerlessVPCAccessService(Google.Apis.Services.BaseClientService.Initializer initializer) : base(initializer)
        {
        ...
        public override string Name => "vpcaccess";

        /// <summary>Gets the service base URI.</summary>
        public override string BaseUri => BaseUriOverride ?? "https://vpcaccess.googleapis.com/";

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "";

        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://vpcaccess.googleapis.com/batch";

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath => "batch";

        /// <summary>Available OAuth 2.0 scopes for use with the Serverless VPC Access API.</summary>
        public class Scope
        {
            /// <summary>
        ...
        /// <summary>Available OAuth 2.0 scope constants for use with the Serverless VPC Access API.</summary>
    ...
    /// <summary>A base abstract class for ServerlessVPCAccess requests.</summary>
    public abstract class ServerlessVPCAccessBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        /// <summary>Constructs a new ServerlessVPCAccessBaseServiceRequest instance.</summary>
        protected ServerlessVPCAccessBaseServiceRequest(Google.Apis.Services.IClientService service) : base(service)
        {
        }
        ...
        /// <summary>Initializes ServerlessVPCAccess parameter list.</summary>
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class ConnectorsResource
            {
                ...
                /// <summary>Creates a Serverless VPC Access connector, returns an operation.</summary>
                public class CreateRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServerlessVPCAccess.v1beta1.Data.Connector body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Required. The ID to use for this connector.</summary>
                    ...
                    Google.Apis.ServerlessVPCAccess.v1beta1.Data.Connector Body { get; set; }
                    ...
                    public override string RestPath => "v1beta1/{+parent}/connectors";
                ...
                /// Deletes a Serverless VPC Access connector. Returns NOT_FOUND if the resource does not exist.
                /// </summary>
                public class DeleteRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>Required. Name of a Serverless VPC Access connector to delete.</summary>
                ...
                /// </summary>
                /// <param name="name">Required. Name of a Serverless VPC Access connector to get.</param>
                ...
                /// Gets a Serverless VPC Access connector. Returns NOT_FOUND if the resource does not exist.
                /// </summary>
                public class GetRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.Connector>
                {
                    ...
                    /// <summary>Required. Name of a Serverless VPC Access connector to get.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <summary>Lists Serverless VPC Access connectors.</summary>
                /// <param name="parent">
                ...
                /// <summary>Lists Serverless VPC Access connectors.</summary>
                public class ListRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.ListConnectorsResponse>
                {
                    ...
                    /// <summary>Required. The project and location from which the routes should be listed.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <summary>Updates a Serverless VPC Access connector, returns an operation.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The resource name in the format `projects/*/locations/*/connectors/*`.</param>
                public virtual PatchRequest Patch(Google.Apis.ServerlessVPCAccess.v1beta1.Data.Connector body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates a Serverless VPC Access connector, returns an operation.</summary>
                public class PatchRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.ServerlessVPCAccess.v1beta1.Data.Connector body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>The resource name in the format `projects/*/locations/*/connectors/*`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            public class OperationsResource
            {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1beta1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
{
    /// <summary>Definition of a Serverless VPC Access connector.</summary>
    public class Connector : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. List of projects using the connector.</summary>
        ...
        /// over max-throughput. The use of `max-throughput` is discouraged in favor of `max-instances`.
        /// </summary>
        ...
        /// over min-throughput. The use of `min-throughput` is discouraged in favor of `min-instances`.
        /// </summary>
        ...
        /// <summary>Output only. State of the VPC access connector.</summary>
    ...
    /// <summary>Response for listing Serverless VPC Access connectors.</summary>
    public class ListConnectorsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>List of Serverless VPC Access connectors.</summary>
    ...
    /// <summary>Metadata for google.longrunning.Operation.</summary>
    public class OperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. Time when the operation completed.</summary>
    ...
    /// <summary>Metadata for google.longrunning.Operation.</summary>
    public class OperationMetadataV1Alpha1 : Google.Apis.Requests.IDirectResponseSchema
    {
        private string _endTimeRaw;
    ...
    /// <summary>Metadata for google.longrunning.Operation.</summary>
    public class OperationMetadataV1Beta1 : Google.Apis.Requests.IDirectResponseSchema
    {
        private string _createTimeRaw;
    ...
    /// <summary>The subnet in which to house the connector</summary>
