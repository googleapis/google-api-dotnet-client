...
{    
    ...
    {
        /// <summary>Identifies whether members external to your organization can join the group. Possible values are: -
        ...
        /// searchable. - If true, the whoCanPostMessage property is set to NONE_CAN_POST. - If reverted from true to
        ...
        /// address using the Directory API or the control panel, you are changing the address your subscribers use to
        ...
        /// from the group itself. Note: When true, any message moderation settings on individual users or new members
        ...
        /// the customReplyTo property holds the custom email address used when replying to a message. If the group's
        /// ReplyTo property is set to REPLY_TO_CUSTOM, the customReplyTo property must have a value. Otherwise an error
        /// is returned.
        ///
        /// - REPLY_TO_SENDER: The reply sent to author of message. - REPLY_TO_LIST: This reply message is sent to the
        /// group. - REPLY_TO_OWNER: The reply is sent to the owner(s) of the group. This does not include the group's
        /// managers. - REPLY_TO_IGNORE: Group users individually decide where the message reply is sent. -
        ...
        /// author. The defaultMessageDenyNotificationText property is dependent on the sendMessageDenyNotification
        /// property being true.
        ///
        ...
        /// candidate. - ALL_MANAGERS_CAN_INVITE: Only managers can invite a new member. This includes the group's
        ...
        /// outside your domain can access your Google Groups service and view the list of groups in your Groups
        /// directory. Warning: Group owners can add external addresses, outside of the domain to their groups. They can
        /// also allow people outside your domain to join their groups. If you later disable this option, any external
        /// addresses already added to users' groups remain in those groups. - INVITED_CAN_JOIN: Candidates for
        ...
        /// to NONE_CAN_POST, results in an error. - If archiveOnly is reverted from true to false, whoCanPostMessages
        /// is set to ALL_MANAGERS_CAN_POST. - ALL_MANAGERS_CAN_POST: Managers, including group owners, can post
