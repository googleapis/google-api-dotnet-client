...
{    
    ...
    public class Groups : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Specifies who should the default reply go to. Possible values are: - REPLY_TO_CUSTOM: For replies
        /// to messages, use the group's custom email address. When the group's ReplyTo property is set to
        /// REPLY_TO_CUSTOM, the customReplyTo property holds the custom email address used when replying to a message.
