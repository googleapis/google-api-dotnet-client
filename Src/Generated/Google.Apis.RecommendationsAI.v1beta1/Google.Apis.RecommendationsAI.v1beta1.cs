...
namespace Google.Apis.RecommendationsAI.v1beta1
{
    ...
    public class RecommendationsAIService : Google.Apis.Services.BaseClientService
    {
        ...
        public RecommendationsAIService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public RecommendationsAIService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class RecommendationsAIBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected RecommendationsAIBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
        ...
        public class LocationsResource
        {
            ...
            public class CatalogsResource
            {
                ...
                public class CatalogItemsResource
                {
                    ...
                    /// <param name="parent">Required. The parent catalog resource name, such as
                    ...
                    public class CreateRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1CatalogItem>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1CatalogItem body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                        ...
                        /// <summary>Required. The parent catalog resource name, such as
                    ...
                    /// <param name="name">Required. Full resource name of catalog item, such as
                    /// "projects/locations/global/catalogs/default_catalog/catalogItems/some_catalog_item_id".</param>
                    ...
                    public class DeleteRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleProtobufEmpty>
                    {
                        ...
                        /// <summary>Required. Full resource name of catalog item, such as "projects/locations/global/ca
                        /// talogs/default_catalog/catalogItems/some_catalog_item_id".</summary>
                    ...
                    public class ImportRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleLongrunningOperation>
                    {
                        ...
                        public ImportRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1ImportCatalogItemsRequest body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    public class ListRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1ListCatalogItemsResponse>
                    {
                        ...
                        /// <summary>Optional. Maximum number of results to return per page. If zero, the service will
                    ...
                    /// <summary>Updates a catalog item. Partial updating is supported. Non-existing items will be
                    /// created.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. Full resource name of catalog item, such as
                    /// "projects/locations/global/catalogs/default_catalog/catalogItems/some_catalog_item_id".</param>
                    ...
                    public class PatchRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1CatalogItem>
                    {
                        ...
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1CatalogItem body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// <summary>Optional. Indicates which fields in the provided 'item' to update. If not set, will
                        /// by default update all fields.</summary>
                ...
                public class EventStoresResource
                {
                    ...
                    public class PlacementsResource
                    {
                        ...
                        public class PredictRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1PredictResponse>
                        {
                            ...
                            public PredictRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1PredictRequest body, string name)
                                : base(service)
                            {
                                Name = name;
                                Body = body;
                    ...
                    public class PredictionApiKeyRegistrationsResource
                    {
                        ...
                        /// <param name="body">The body of the request.</param>
                        /// <param name="parent">Required. The parent resource path.
                        /// "projects/locations/global/catalogs/default_catalog/eventStores/default_event_store".</param>
                        ...
                        {
                            /// <summary>Constructs a new Create request.</summary>
                            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                            ...
                            /// <summary>Required. The parent resource path. "projects/locations/global/catalogs/default
                            /// _catalog/eventStores/default_event_store".</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }
                        ...
                        /// <param name="name">Required. The API key to unregister including full resource path. "projects/locations/global/cata
                        /// logs/default_catalog/eventStores/default_event_store/predictionApiKeyRegistrations/"</param>
                        public virtual DeleteRequest Delete(string name)
                        {
                            return new DeleteRequest(service, name);
                        }
                        ...
                        public class DeleteRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleProtobufEmpty>
                        {
                            ...
                            /// <summary>Required. The API key to unregister including full resource path. "projects/loc
                            /// ations/global/catalogs/default_catalog/eventStores/default_event_store/predictionApiKeyR
                            /// egistrations/"</summary>
                            [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Name { get; private set; }
                        ...
                        /// <param name="parent">Required. The parent placement resource name such as
                        ...
                        public class ListRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1ListPredictionApiKeyRegistrationsResponse>
                        {
                            ...
                            /// <summary>Required. The parent placement resource name such as "projects/1234/locations/g
                            /// lobal/catalogs/default_catalog/eventStores/default_event_store"</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }

                            /// <summary>Optional. Maximum number of results to return per page. If unset, the service
                            /// will choose a reasonable default.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                            public virtual System.Nullable<int> PageSize { get; set; }

                            /// <summary>Optional. The previous
                            /// `ListPredictionApiKeyRegistration.nextPageToken`.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                            public virtual string PageToken { get; set; }
                    ...
                    public class UserEventsResource
                    {
                        ...
                        public class CollectRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleApiHttpBody>
                        {
                            ...
                            public CollectRequest(Google.Apis.Services.IClientService service, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                InitParameters();
                            ...
                            /// <summary>Required. The parent eventStore name, such as "projects/1234/locations/global/c
                            /// atalogs/default_catalog/eventStores/default_event_store".</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }

                            /// <summary>Optional. The event timestamp in milliseconds. This prevents browser caching of
                            ...
                            /// <summary>Optional. The url including cgi-parameters but excluding the hash fragment. The
                            /// URL must be truncated to 1.5K bytes to conservatively be under the 2K bytes. This is
                            /// often more useful than the referer url, because many browsers only send the domain for
                            /// 3rd party requests.</summary>
                            ...
                            protected override void InitParameters()
                            {
                                ...
                                RequestParameters.Add(
                                    "ets", new Google.Apis.Discovery.Parameter
                                    {
                                        Name = "ets",
                                        IsRequired = false,
                                        ParameterType = "query",
                                ...
                                RequestParameters.Add(
                                    "uri", new Google.Apis.Discovery.Parameter
                                    {
                                        Name = "uri",
                                        IsRequired = false,
                                        ParameterType = "query",
                                ...
                                RequestParameters.Add(
                                    "userEvent", new Google.Apis.Discovery.Parameter
                                    {
                                        Name = "userEvent",
                                        IsRequired = false,
                                        ParameterType = "query",
                        ...
                        {
                            /// <summary>Constructs a new Import request.</summary>
                            public ImportRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1ImportUserEventsRequest body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                            ...
                            /// <summary>Required. "projects/1234/locations/global/catalogs/default_catalog/eventStores/
                            /// default_event_store"</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }
                        ...
                        public class ListRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1ListUserEventsResponse>
                        {
                            ...
                            /// <summary>Required. The parent eventStore resource name, such as
                            /// "projects/locations/catalogs/default_catalog/eventStores/default_event_store".</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }

                            /// <summary>Optional. Filtering expression to specify restrictions over returned events.
                            ...
                            /// <summary>Optional. Maximum number of results to return per page. If zero, the service
                            /// will choose a reasonable default.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                            public virtual System.Nullable<int> PageSize { get; set; }
                        ...
                        /// <summary>Deletes permanently all user events specified by the filter provided. Depending on
                        /// the number of events specified by the filter, this operation could take hours or days to
                        /// complete. To test a filter, use the list command first.</summary>
                        /// <param name="body">The body of the request.</param>
                        /// <param name="parent">Required. The resource name of the event_store under which the events are created. The format
                        /// is "projects/${projectId}/locations/global/catalogs/${catalogId}/eventStores/${eventStoreId}"</param>
                        ...
                        public class PurgeRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleLongrunningOperation>
                        {
                            ...
                            public PurgeRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1PurgeUserEventsRequest body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                            ...
                            /// <summary>Required. The resource name of the event_store under which the events are
                            /// created. The format is "projects/${projectId}/locations/global/catalogs/${catalogId}/eve
                            /// ntStores/${eventStoreId}"</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }
                        ...
                        /// <summary>Triggers a user event rejoin operation with latest catalog data. Events will not be
                        ...
                        /// wrong catalog items.</summary>
                        /// <param name="body">The body of the request.</param>
                        /// <param name="parent">Required. Full resource name of user event, such as
                        /// "projects/locations/catalogs/default_catalog/eventStores/default_event_store".</param>
                        ...
                        public class RejoinRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleLongrunningOperation>
                        {
                            ...
                            public RejoinRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1RejoinUserEventsRequest body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                            ...
                            /// <summary>Required. Full resource name of user event, such as
                            /// "projects/locations/catalogs/default_catalog/eventStores/default_event_store".</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }
                        ...
                        public class WriteRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1UserEvent>
                        {
                            ...
                            public WriteRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1UserEvent body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                            ...
                            /// <summary>Required. The parent eventStore resource name, such as "projects/1234/locations
                            /// /global/catalogs/default_catalog/eventStores/default_event_store".</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }
                ...
                public class ListRequest : RecommendationsAIBaseServiceRequest<Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1ListCatalogsResponse>
                {
                    ...
                    /// <summary>Optional. Maximum number of results to return. If unspecified, defaults to 50. Max
                    /// allowed value is 1000.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }

                    /// <summary>Optional. A page token, received from a previous `ListCatalogs` call. Provide this to
                    /// retrieve the subsequent page.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string PageToken { get; set; }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.RecommendationsAI.v1beta1.Data.GoogleCloudRecommendationengineV1beta1Catalog body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
...
{    
    ...
    {
        /// <summary>The resource name of the recommendation model that this tune applies to. Format: projects/{project_
    ...
    public class GoogleCloudRecommendationengineV1beta1EventDetail : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// user is browsing the page. The `pageViewId` property should be kept the same for all these events so that
    ...
    /// <summary>FeatureMap represents extra features that customers want to include in the recommendation model for
    /// catalogs/user events as categorical/numerical features.</summary>
    ...
    {
        /// <summary>Required. Google Cloud Storage URIs to input files. URI can be up to 2000 characters long. URIs can
        /// match the full object path (for example, gs://bucket/directory/object.json) or a pattern matching one or
        /// more files, such as gs://bucket/directory.json. A request can contain at most 100 files, and each file can
    ...
    /// <summary>Response of the ImportCatalogItemsRequest. If the long running operation is done, then this message is
    /// returned by the google.longrunning.Operations.response field if the operation was successful.</summary>
    ...
    {
        /// <summary>Google Cloud Storage path for import errors. This must be an empty, existing Cloud Storage bucket.
    ...
    /// <summary>Metadata related to the progress of the Import operation. This will be returned by the
    /// google.longrunning.Operation.metadata field.</summary>
    ...
    /// <summary>Response of the ImportUserEventsRequest. If the long running operation was successful, then this
    ...
    {
        /// <summary>Optional. Use dryRun mode for this prediction query. If set to true, a dummy model will be used
    ...
    /// <summary>Product price range when there are a range of prices for different variations of the same
    /// product.</summary>
    ...
    /// <summary>Metadata related to the progress of the PurgeUserEvents operation. This will be returned by the
    /// google.longrunning.Operation.metadata field.</summary>
    ...
    /// <summary>Response of the PurgeUserEventsRequest. If the long running operation is successfully done, then this
    /// message is returned by the google.longrunning.Operations.response field.</summary>
    ...
    /// <summary>UserEvent captures all metadata information recommendation engine needs to know about how end users
    /// interact with customers' website.</summary>
    ...
    /// <summary>A summary of import result. The UserEventImportSummary summarizes the import status for user
    /// events.</summary>
    ...
    {
        /// <summary>Optional. Indicates if the request is made directly from the end user in which case the user_agent
        /// and ip_address fields can be populated from the HTTP request. This should *not* be set when using the
