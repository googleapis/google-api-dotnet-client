...
/**
 * \brief
 *   Google Cloud Dataproc API Version v1beta1
 *
...
namespace Google.Apis.Dataproc.v1beta1
{
    ...
    public class OperationsResource
    {
        ...
        /// [operations.get](/dataproc/reference/rest/v1beta1/operations/get) or other methods to check whether the
        /// cancellation succeeded or whether the operation completed despite cancellation.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="name">The name of the operation resource to be cancelled.</param>
        public virtual CancelRequest Cancel(Google.Apis.Dataproc.v1beta1.Data.CancelOperationRequest body, string name)
        {
        ...
        /// [operations.get](/dataproc/reference/rest/v1beta1/operations/get) or other methods to check whether the
        /// cancellation succeeded or whether the operation completed despite cancellation.</summary>
        public class CancelRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Empty>
        {
            /// <summary>Constructs a new Cancel request.</summary>
            public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.CancelOperationRequest body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
            ...
            Google.Apis.Dataproc.v1beta1.Data.CancelOperationRequest Body { get; set; }
        ...
        /// the operation result. It does not cancel the operation. If the server doesn't support this method, it
        /// returns `google.rpc.Code.UNIMPLEMENTED`.</summary>
        public class DeleteRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Empty>
        {
        ...
        /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
        /// operation result at intervals as recommended by the API service.</summary>
        public class GetRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
        {
        ...
        /// method, it returns `UNIMPLEMENTED`. NOTE: the `name` binding below allows API services to override the
        /// binding to use different resource name schemes, such as `users/operations`.</summary>
        public class ListRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.ListOperationsResponse>
        {
    ...
    public class ProjectsResource
    {
        ...
        public class ClustersResource
        {
            ...
            /// to.</param>
            public virtual CreateRequest Create(Google.Apis.Dataproc.v1beta1.Data.Cluster body, string projectId)
            {
                return new CreateRequest(service, body, projectId);
            }

            /// <summary>Creates a cluster in a project.</summary>
            public class CreateRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.Cluster body, string projectId)
                    : base(service)
                {
                    ProjectId = projectId;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.Cluster Body { get; set; }
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/clusters"; }
                }
            ...
            /// <summary>Deletes a cluster in a project.</summary>
            public class DeleteRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
            {
                /// <summary>Constructs a new Delete request.</summary>
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/clusters/{clusterName}"; }
                }
            ...
            /// to.</param>
            /// <param name="clusterName">[Required] The cluster name.</param>
            public virtual DiagnoseRequest Diagnose(Google.Apis.Dataproc.v1beta1.Data.DiagnoseClusterRequest body, string projectId, string clusterName)
            {
                return new DiagnoseRequest(service, body, projectId, clusterName);
            }

            /// <summary>Gets cluster diagnostic information. After the operation completes, the Operation.response
            /// field contains `DiagnoseClusterOutputLocation`.</summary>
            public class DiagnoseRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
            {
                /// <summary>Constructs a new Diagnose request.</summary>
                public DiagnoseRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.DiagnoseClusterRequest body, string projectId, string clusterName)
                    : base(service)
                {
                    ProjectId = projectId;
                    ClusterName = clusterName;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.DiagnoseClusterRequest Body { get; set; }
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/clusters/{clusterName}:diagnose"; }
                }
            ...
            /// <summary>Gets the resource representation for a cluster in a project.</summary>
            public class GetRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Cluster>
            {
                /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Gets the access control policy for a `resource`. Returns an empty policy if the resource exists
            /// and does not have a policy set.</summary>
            public class GetIamPolicyRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Policy>
            {
            ...
            /// <summary>Lists all clusters in a project.</summary>
            /// <param name="projectId">[Required] The ID of the Google Cloud Platform project that the cluster belongs
            /// to.</param>
            ...
            /// <summary>Lists all clusters in a project.</summary>
            public class ListRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.ListClustersResponse>
            {
                /// <summary>Constructs a new List request.</summary>
            ...
            /// to.</param>
            /// <param name="clusterName">[Required] The cluster name.</param>
            public virtual PatchRequest Patch(Google.Apis.Dataproc.v1beta1.Data.Cluster body, string projectId, string clusterName)
            {
                return new PatchRequest(service, body, projectId, clusterName);
            }

            /// <summary>Updates a cluster in a project.</summary>
            public class PatchRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.Cluster body, string projectId, string clusterName)
                    : base(service)
                {
                    ProjectId = projectId;
                    ClusterName = clusterName;
            ...
            public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.Dataproc.v1beta1.Data.SetIamPolicyRequest body, string resource)
            {
            ...
            /// <summary>Sets the access control policy on the specified resource. Replaces any existing
            /// policy.</summary>
            public class SetIamPolicyRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Policy>
            {
                /// <summary>Constructs a new SetIamPolicy request.</summary>
                public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.SetIamPolicyRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.SetIamPolicyRequest Body { get; set; }
            ...
            public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.Dataproc.v1beta1.Data.TestIamPermissionsRequest body, string resource)
            {
                return new TestIamPermissionsRequest(service, body, resource);
            }

            /// <summary>Returns permissions that a caller has on the specified resource.</summary>
            public class TestIamPermissionsRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.TestIamPermissionsResponse>
            {
                /// <summary>Constructs a new TestIamPermissions request.</summary>
                public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                    : base(service)
                {
                    Resource = resource;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.TestIamPermissionsRequest Body { get; set; }
        ...
        public class JobsResource
        {
            ...
            /// [jobs.get](/dataproc/reference/rest/v1beta1/projects.jobs/get).</summary>
            /// <param name="body">The body of the request.</param>
            ...
            public virtual CancelRequest Cancel(Google.Apis.Dataproc.v1beta1.Data.CancelJobRequest body, string projectId, string jobId)
            {
            ...
            /// [jobs.list](/dataproc/reference/rest/v1beta1/projects.jobs/list) or
            /// [jobs.get](/dataproc/reference/rest/v1beta1/projects.jobs/get).</summary>
            public class CancelRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Job>
            {
                /// <summary>Constructs a new Cancel request.</summary>
                public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.CancelJobRequest body, string projectId, string jobId)
                    : base(service)
                {
                    ProjectId = projectId;
                    JobId = jobId;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.CancelJobRequest Body { get; set; }
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/jobs/{jobId}:cancel"; }
                }
            ...
            public class DeleteRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Empty>
            {
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/jobs/{jobId}"; }
                }
            ...
            /// <summary>Gets the resource representation for a job in a project.</summary>
            public class GetRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Job>
            {
                /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Lists jobs in a project.</summary>
            ...
            /// <summary>Lists jobs in a project.</summary>
            public class ListRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.ListJobsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string projectId)
                    : base(service)
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/jobs"; }
                }
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="projectId">[Required] The ID of the Google Cloud Platform project that the job belongs to.</param>
            public virtual SubmitRequest Submit(Google.Apis.Dataproc.v1beta1.Data.SubmitJobRequest body, string projectId)
            {
                return new SubmitRequest(service, body, projectId);
            }

            /// <summary>Submits a job to a cluster.</summary>
            public class SubmitRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Job>
            {
                /// <summary>Constructs a new Submit request.</summary>
                public SubmitRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.SubmitJobRequest body, string projectId)
                    : base(service)
                {
                    ProjectId = projectId;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.SubmitJobRequest Body { get; set; }
                ...
                public override string RestPath
                {
                    get { return "v1beta1/projects/{projectId}/jobs:submit"; }
                }
...
namespace Google.Apis.Dataproc.v1beta1.Data
{    
    ...
    public class Cluster : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Required] The cluster configuration. Note that Cloud Dataproc may set default values, and values
        /// may change when clusters are updated.</summary>
    ...
    public class ClusterConfiguration : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// zone where your cluster is deployed, and then it will create and manage this project-level, per-location
        /// bucket for you.</summary>
    ...
    public class InstanceGroupConfiguration : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `SoftwareConfiguration.image_version`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("imageUri")]
        public virtual string ImageUri { get; set; } 

        /// <summary>The list of instance names. Dataproc derives the names from `cluster_name`, `num_instances`, and
        /// the instance group if not set by user (recommended practice is to let Dataproc derive the name).</summary>
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Optional] If set to `true`, the driver's stdin will be kept open and `driver_input_uri` will be
