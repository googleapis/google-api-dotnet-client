...
namespace Google.Apis.Dataproc.v1beta1
{
    ...
    public class OperationsResource
    {
        ...
        /// google.rpc.Code.UNIMPLEMENTED. Clients can use operations.get or other methods to check whether the
        ...
        /// method, it returns UNIMPLEMENTED.NOTE: the name binding below allows API services to override the binding to
        /// use different resource name schemes, such as users/operations.</summary>
    ...
    public class ProjectsResource
    {
        ...
        public class ClustersResource
        {
            ...
            public class CreateRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
            {
                ...
                /// <summary>Required The ID of the Google Cloud Platform project that the cluster belongs to.</summary>
            ...
            public class PatchRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Operation>
            {
                ...
                /// value, as follows: { "configuration":{ "workerConfiguration":{ "numInstances":"5" } } } Similarly,
                /// to change the number of preemptible workers in a cluster to 5, the update_mask parameter would be
                /// config.secondary_worker_config.num_instances, and the PATCH request body would be set as follows: {
                /// "config":{ "secondaryWorkerConfig":{ "numInstances":"5" } } } Note: Currently,
        ...
        public class JobsResource
        {
            ...
            /// to.</param>
            /// <param name="jobId">Required The job ID.</param>
            public virtual PatchRequest Patch(Google.Apis.Dataproc.v1beta1.Data.Job body, string projectId, string jobId)
            {
                return new PatchRequest(service, body, projectId, jobId);
            }

            /// <summary>Updates a job in a project.</summary>
            public class PatchRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta1.Data.Job>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1beta1.Data.Job body, string projectId, string jobId)
                    : base(service)
                {
                    ProjectId = projectId;
                    JobId = jobId;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataproc.v1beta1.Data.Job Body { get; set; }
...
{    
    ...
    public class Cluster : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required The cluster configuration. Note that Cloud Dataproc may set default values, and values may
    ...
    public class ClusterConfiguration : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required The shared Google Compute Engine configuration settings for all instances in a
        /// cluster.</summary>
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional If set to true, the driver's stdin will be kept open and driver_input_uri will be set to
        /// provide a path at which additional input can be sent to the driver.</summary>
