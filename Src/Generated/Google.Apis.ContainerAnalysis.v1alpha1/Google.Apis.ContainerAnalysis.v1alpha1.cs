...
namespace Google.Apis.ContainerAnalysis.v1alpha1.Data
{
    ...
    public class AISkillAnalysisOccurrence : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Maximum severity found among findings.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("maxSeverity")]
        public virtual string MaxSeverity { get; set; }

        /// <summary>Optional. Per scanner verdict.</summary>
    ...
    public class BaseImage : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The registry of the base image.</summary>
    ...
    public class CVSS : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Integrity Impact (I). Defined in CVSS v2, v3.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("integrityImpact")]
        public virtual string IntegrityImpact { get; set; }

        /// <summary>Optional. Privileges Required (PR). Defined in CVSS v3, v4.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("privilegesRequired")]
        public virtual string PrivilegesRequired { get; set; }

        /// <summary>Optional. Scope (S). Defined in CVSS v3.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("scope")]
        public virtual string Scope { get; set; }

        /// <summary>Optional. Subsequent System Availability Impact (SA). Defined in CVSS v4.</summary>
        ...
        /// <summary>Optional. Subsequent System Confidentiality Impact (SC). Defined in CVSS v4.</summary>
        ...
        /// <summary>Optional. Subsequent System Integrity Impact (SI). Defined in CVSS v4.</summary>
        ...
        /// <summary>Optional. User Interaction (UI). Defined in CVSS v3, v4.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("userInteraction")]
        public virtual string UserInteraction { get; set; }

        /// <summary>Optional. Vulnerable System Availability Impact (VA). Defined in CVSS v4.</summary>
        ...
        /// <summary>Optional. Vulnerable System Confidentiality Impact (VC). Defined in CVSS v4.</summary>
        ...
        /// <summary>Optional. Vulnerable System Integrity Impact (VI). Defined in CVSS v4.</summary>
    ...
    public class Discovered : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. The last time vulnerability scan results changed.</summary>
        ...
        /// <summary>Output only. The status of a vulnerability attestation generation.</summary>
    ...
    public class FileLocation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Line number in the file where the package is found. Optional field that only applies to source repository
        /// scanning.
        /// </summary>
    ...
    public class Finding : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Description of the finding category.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("details")]
        public virtual string Details { get; set; }

        /// <summary>Optional. Location (path and line) where the finding was detected.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("location")]
        public virtual FindingLocation Location { get; set; }

        /// <summary>Optional. Scanner determines which engine (e.g. static, llm) emitted the finding.</summary>
    ...
    {
        /// <summary>Optional. Relative path of the file containing the finding.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("filePath")]
        public virtual string FilePath { get; set; }

        /// <summary>Optional. Line number (1-based), or 0 if whole File / unknown.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lineNumber")]
    ...
    public class MalwareScanResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Verdict of the scan.</summary>
    ...
    public class Occurrence : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>This represents a secret occurrence</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("secret")]
    ...
    {
        /// <summary>Optional. Malicious Content LLM scan result.</summary>
        ...
        /// <summary>Optional. Malicious Content Static scan result.</summary>
    ...
    /// <summary>The status of a vulnerability attestation generation.</summary>
    public class VulnerabilityAttestation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. If failure, the error reason for why the attestation generation failed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("error")]
        public virtual string Error { get; set; }
        ...
        /// <summary>Output only. The last time we attempted to generate an attestation.</summary>
        ...
        /// <summary>Output only. The success/failure state of the latest attestation attempt.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }
    ...
    public class VulnerabilityDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. The CVSS v4 score of this vulnerability.</summary>
    ...
    public class VulnerabilityType : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Time this advisory was published by the source.</summary>
        ...
        /// <summary>Optional. The full description of the CVSS for version 4.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("cvssV4")]
        public virtual CVSS CvssV4 { get; set; }
