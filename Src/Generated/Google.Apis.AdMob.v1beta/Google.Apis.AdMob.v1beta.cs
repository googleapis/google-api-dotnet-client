...
namespace Google.Apis.AdMob.v1beta
{
    ...
    public class AccountsResource
    {
        ...
        public class AdUnitsResource
        {
            ...
            /// <param name="parent">Required. Resource name of the account to list ad units for. Example:
            ...
            public class ListRequest : AdMobBaseServiceRequest<Google.Apis.AdMob.v1beta.Data.ListAdUnitsResponse>
            {
                ...
                /// <summary>Required. Resource name of the account to list ad units for. Example:
                ...
                /// <summary>The value returned by the last `ListAdUnitsResponse`; indicates that this is a continuation
                /// of a prior `ListAdUnits` call, and that the system should return the next page of data.</summary>
        ...
        public class AppsResource
        {
            ...
            /// <param name="parent">Required. Resource name of the account to list apps for. Example:
            /// accounts/pub-9876543210987654</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            ...
            public class ListRequest : AdMobBaseServiceRequest<Google.Apis.AdMob.v1beta.Data.ListAppsResponse>
            {
                ...
                /// <summary>Required. Resource name of the account to list apps for. Example:
                /// accounts/pub-9876543210987654</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }

                /// <summary>The maximum number of apps to return. If unspecified or 0, at most 1000 apps will be
                /// returned. The maximum value is 10,000; values above 10,000 will be coerced to 10,000.</summary>
                [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                public virtual System.Nullable<int> PageSize { get; set; }

                /// <summary>The value returned by the last `ListAppsResponse`; indicates that this is a continuation of
                /// a prior `ListApps` call, and that the system should return the next page of data.</summary>
                [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string PageToken { get; set; }
...
{    
    ...
    {
        /// <summary>AdFormat of the ad unit. Possible values are as follows: "BANNER" - Banner ad format.
        /// "BANNER_INTERSTITIAL" - Legacy format that can be used as either banner or interstitial. This format can no
        /// longer be created but can be targeted by mediation groups. "INTERSTITIAL" - A full screen ad. Supported ad
        /// types are "RICH_MEDIA" and "VIDEO". "NATIVE" - Native ad format. "REWARDED" - An ad that, once viewed, gets
        /// a callback verifying the view so that a reward can be given to the user. Supported ad types are "RICH_MEDIA"
        /// (interactive) and video where video can not be excluded.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("adFormat")]
        public virtual string AdFormat { get; set; }

        /// <summary>Ad media type supported by this ad unit. Possible values as follows: "RICH_MEDIA" - Text, image,
        /// and other non-video media. "VIDEO" - Video media.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("adTypes")]
        public virtual System.Collections.Generic.IList<string> AdTypes { get; set; }

        /// <summary>The externally visible ID of the ad unit which can be used to integrate with the AdMob SDK. This is
        /// a read only property. Example: ca-app-pub-9876543210987654/0123456789</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("adUnitId")]
        public virtual string AdUnitId { get; set; }

        /// <summary>The externally visible ID of the app this ad unit is associated with. Example: ca-app-
        /// pub-9876543210987654~0123456789</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("appId")]
        public virtual string AppId { get; set; }

        /// <summary>The display name of the ad unit as shown in the AdMob UI, which is provided by the user. The
        /// maximum length allowed is 80 characters.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayName")]
        public virtual string DisplayName { get; set; }

        /// <summary>Resource name for this ad unit. Format is accounts/{publisher_id}/adUnits/{ad_unit_id_fragment}
        /// Example: accounts/pub-9876543210987654/adUnits/0123456789</summary>
    ...
    {
        /// <summary>The externally visible ID of the app which can be used to integrate with the AdMob SDK. This is a
        /// read only property. Example: ca-app-pub-9876543210987654~0123456789</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("appId")]
        public virtual string AppId { get; set; }

        /// <summary>Immutable. The information for an app that is linked to an app store. This field is present if and
        /// only if the app is linked to an app store.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("linkedAppInfo")]
        public virtual AppLinkedAppInfo LinkedAppInfo { get; set; }

        /// <summary>The information for an app that is not linked to any app store. After an app is linked, this
        /// information is still retrivable. If no name is provided for the app upon creation, a placeholder name will
        /// be used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("manualAppInfo")]
        public virtual AppManualAppInfo ManualAppInfo { get; set; }

        /// <summary>Resource name for this app. Format is accounts/{publisher_id}/apps/{app_id_fragment} Example:
        /// accounts/pub-9876543210987654/apps/0123456789</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    {
        /// <summary>The app store ID of the app; present if and only if the app is linked to an app store. If the app
        /// is added to the Google Play store, it will be the application ID of the app. For example:
        /// "com.example.myapp". See https://developer.android.com/studio/build/application-id. If the app is added to
        /// the Apple App Store, it will be app store ID. For example "105169111". Note that setting the app store id is
        /// considered an irreversible action. Once an app is linked, it cannot be unlinked.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("appStoreId")]
        public virtual string AppStoreId { get; set; }

        /// <summary>Output only. Display name of the app as it appears in the app store. This is an output-only field,
        /// and may be empty if the app cannot be found in the store.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayName")]
        public virtual string DisplayName { get; set; }
    ...
    /// <summary>Information provided for manual apps which are not linked to an application store (Example: Google
    /// Play, App Store).</summary>
    public class AppManualAppInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The display name of the app as shown in the AdMob UI, which is provided by the user. The maximum
        /// length allowed is 80 characters.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayName")]
        public virtual string DisplayName { get; set; }
    ...
    public class ListAdUnitsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>If not empty, indicates that there may be more ad units for the request; this value should be
        /// passed in a new `ListAdUnitsRequest`.</summary>
    ...
    public class ListAppsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>If not empty, indicates that there may be more apps for the request; this value should be passed in
        /// a new `ListAppsRequest`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
