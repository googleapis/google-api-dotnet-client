...
namespace Google.Apis.CloudOSLogin.v1alpha
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            /// </param>
            public virtual SignSshPublicKeyRequest SignSshPublicKey(Google.Apis.CloudOSLogin.v1alpha.Data.GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest body, string parent)
            {
            ...
            /// Signs an SSH public key for a user to authenticate to a virtual machine on Google Compute Engine.
            /// </summary>
            public class SignSshPublicKeyRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse>
            {
                /// <summary>Constructs a new SignSshPublicKey request.</summary>
                public SignSshPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1alpha.Data.GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.CloudOSLogin.v1alpha.Data.GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest Body { get; set; }
                ...
                public override string RestPath => "v1alpha/{+parent}:signSshPublicKey";
    ...
    public class UsersResource
    {
        ...
        public class ProjectsResource
        {
            ...
            public class LocationsResource
            {
                ...
                /// Signs an SSH public key for a user to authenticate to a virtual machine on Google Compute Engine.
                /// </summary>
                public class SignSshPublicKeyRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.SignSshPublicKeyResponse>
                {
                    /// <summary>Constructs a new SignSshPublicKey request.</summary>
                    public SignSshPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1alpha.Data.SignSshPublicKeyRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudOSLogin.v1alpha.Data.SignSshPublicKeyRequest Body { get; set; }
            ...
            public class DeleteRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.Empty>
            {
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add("operatingSystemType", new Google.Apis.Discovery.Parameter
                    {
            ...
            /// </param>
            public virtual ProvisionPosixAccountRequest ProvisionPosixAccount(Google.Apis.CloudOSLogin.v1alpha.Data.ProvisionPosixAccountRequest body, string name)
            {
                return new ProvisionPosixAccountRequest(this.service, body, name);
            }

            /// <summary>Create a POSIX account if it doesn't exist.</summary>
            public class ProvisionPosixAccountRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.PosixAccount>
            {
                /// <summary>Constructs a new ProvisionPosixAccount request.</summary>
                public ProvisionPosixAccountRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1alpha.Data.ProvisionPosixAccountRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudOSLogin.v1alpha.Data.ProvisionPosixAccountRequest Body { get; set; }
        ...
        public class SshPublicKeysResource
        {
            ...
            public class PatchRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.SshPublicKey>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1alpha.Data.SshPublicKey body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
        ...
        public class GetLoginProfileRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.LoginProfile>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1alpha/{+name}/loginProfile";
        ...
        public class ImportSshPublicKeyRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1alpha.Data.ImportSshPublicKeyResponse>
        {
            ...
            public ImportSshPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1alpha.Data.SshPublicKey body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1alpha/{+parent}:importSshPublicKey";
...
namespace Google.Apis.CloudOSLogin.v1alpha.Data
{
    ...
    public class GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse : Google.Apis.Requests.IDirectResponseSchema
    {
