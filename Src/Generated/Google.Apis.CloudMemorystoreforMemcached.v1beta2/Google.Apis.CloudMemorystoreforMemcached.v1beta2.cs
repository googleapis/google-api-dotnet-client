        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                public class ApplyParametersRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Operation>
                {
                    ...
                    public ApplyParametersRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.ApplyParametersRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class CreateRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Instance body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                ...
                public class PatchRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Instance body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class UpdateParametersRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Operation>
                {
                    ...
                    public UpdateParametersRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.UpdateParametersRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1beta2.Data.CancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
