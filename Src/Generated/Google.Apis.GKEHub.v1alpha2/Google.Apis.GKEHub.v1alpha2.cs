...
namespace Google.Apis.GKEHub.v1alpha2
{
    ...
    public class GKEHubService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://gkehub.googleapis.com/";
        ...
        public class LocationsResource
        {
            ...
            public class GlobalResource
            {
                ...
                public class MembershipsResource
                {
                    ...
                    /// <summary>
                    /// Initializes the Hub in this project, which includes creating the default Hub Service Account and
                    /// the Hub Workload Identity Pool. Initialization is optional, and happens automatically when the
                    /// first Membership is created. InitializeHub should be called when the first Membership cannot be
                    /// registered without these resources. A common example is granting the Hub Service Account access
                    /// to another project, which requires the account to exist first.
                    /// </summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="project">
                    /// Required. The Hub to initialize, in the format `projects/*/locations/*/memberships/*`.
                    /// </param>
                    public virtual InitializeHubRequest InitializeHub(Google.Apis.GKEHub.v1alpha2.Data.InitializeHubRequest body, string project)
                    {
                        return new InitializeHubRequest(this.service, body, project);
                    }
                    ...
                    /// to another project, which requires the account to exist first.
                    /// </summary>
                    public class InitializeHubRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.InitializeHubResponse>
                    {
                        /// <summary>Constructs a new InitializeHub request.</summary>
                        public InitializeHubRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v1alpha2.Data.InitializeHubRequest body, string project) : base(service)
                        {
                            Project = project;
                            Body = body;
                            InitParameters();
                        ...
                        Google.Apis.GKEHub.v1alpha2.Data.InitializeHubRequest Body { get; set; }

                        /// <summary>Returns the body of the request.</summary>
                        protected override object GetBody() => Body;

                        /// <summary>Gets the method name.</summary>
                        public override string MethodName => "initializeHub";

                        /// <summary>Gets the HTTP method.</summary>
                        public override string HttpMethod => "POST";

                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1alpha2/{+project}:initializeHub";

                        /// <summary>Initializes InitializeHub parameter list.</summary>
                        protected override void InitParameters()
                        {
                            base.InitParameters();
            ...
            public class MembershipsResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.GKEHub.v1alpha2.Data.Membership body, string parent)
                {
                ...
                /// https://cloud.google.com/anthos/multicluster-management/connect/registering-a-cluster.
                /// </summary>
                public class CreateRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v1alpha2.Data.Membership body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GKEHub.v1alpha2.Data.Membership Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha2/{+parent}/memberships";
                ...
                /// https://cloud.google.com/anthos/multicluster-management/connect/unregistering-a-cluster.
                /// </summary>
                public class DeleteRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Operation>
                {
                ...
                /// Google-provided libraries.** Most clients should not need to call this method directly.
                /// </summary>
                public class GenerateConnectManifestRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.GenerateConnectManifestResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha2/{+name}:generateConnectManifest";
                ...
                /// <summary>Gets the details of a Membership.</summary>
                public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Membership>
                {
                ...
                /// does not have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Policy>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha2/{+resource}:getIamPolicy";
                ...
                /// <summary>Lists Memberships in a given project and location.</summary>
                public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.ListMembershipsResponse>
                {
                ...
                /// Required. The Membership resource name in the format `projects/*/locations/*/memberships/*`.
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.GKEHub.v1alpha2.Data.Membership body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates an existing Membership.</summary>
                public class PatchRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v1alpha2.Data.Membership body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.GKEHub.v1alpha2.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
                /// </summary>
                public class SetIamPolicyRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v1alpha2.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GKEHub.v1alpha2.Data.SetIamPolicyRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha2/{+resource}:setIamPolicy";
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.GKEHub.v1alpha2.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// checking. This operation may "fail open" without warning.
                /// </summary>
                public class TestIamPermissionsRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v1alpha2.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GKEHub.v1alpha2.Data.TestIamPermissionsRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha2/{+resource}:testIamPermissions";
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.GKEHub.v1alpha2.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.GKEHub.v1alpha2.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GKEHub.v1alpha2.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha2/{+name}/operations";
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : GKEHubBaseServiceRequest<Google.Apis.GKEHub.v1alpha2.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1alpha2/{+name}/locations";
...
namespace Google.Apis.GKEHub.v1alpha2.Data
{
    ...
    public class Authority : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// tokens from the issuer, unless `oidc_jwks` is set. Clearing `issuer` disables Workload Identity. `issuer`
        /// cannot be directly modified; it must be cleared (and Workload Identity disabled) before using a new issuer
        /// (and re-enabling Workload Identity).
        /// </summary>
    ...
    /// <summary>Request message for the InitializeHub method.</summary>
    public class InitializeHubRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }

    /// <summary>Response message for the InitializeHub method.</summary>
    public class InitializeHubResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Name of the Hub default service identity, in the format: service-@gcp-sa-gkehub.iam.gserviceaccount.com The
        /// service account has `roles/gkehub.serviceAgent` in the Hub project.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("serviceIdentity")]
        public virtual string ServiceIdentity { get; set; }
    ...
    /// <summary>
    /// KubernetesMetadata provides informational metadata for Memberships that are created from Kubernetes Endpoints
    ...
    public class KubernetesResource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Create or Update, or leave this field empty if none exists. The CR manifest is used to validate the cluster
        /// has not been registered with another Membership.
        /// </summary>
