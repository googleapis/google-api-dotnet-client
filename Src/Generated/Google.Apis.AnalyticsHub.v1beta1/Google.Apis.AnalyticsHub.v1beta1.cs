...
namespace Google.Apis.AnalyticsHub.v1beta1
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : AnalyticsHubBaseServiceRequest<Google.Apis.AnalyticsHub.v1beta1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : AnalyticsHubBaseServiceRequest<Google.Apis.AnalyticsHub.v1beta1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
...
namespace Google.Apis.AnalyticsHub.v1beta1.Data
{
    ...
    /// <summary>Message for response when you subscribe to a listing. Empty for now.</summary>
