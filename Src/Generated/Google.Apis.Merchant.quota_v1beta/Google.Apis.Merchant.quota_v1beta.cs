...
namespace Google.Apis.Merchant.quota_v1beta
{
    ...
    public class MerchantService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "quota_v1beta";
    ...
    public class AccountsResource
    {
        ...
        public class QuotasResource
        {
            ...
            /// <summary>Lists the daily call quota and usage per group for your Merchant Center account.</summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.quota_v1beta.Data.ListQuotaGroupsResponse>
            {
                ...
                public override string RestPath => "quota/v1beta/{+parent}/quotas";
...
namespace Google.Apis.Merchant.quota_v1beta.Data
{
