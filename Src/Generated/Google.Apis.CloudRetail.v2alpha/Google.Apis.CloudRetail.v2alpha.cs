...
namespace Google.Apis.CloudRetail.v2alpha.Data
{
    ...
    public class GoogleCloudRetailV2alphaBigQuerySource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Center](/retail/recommendations-ai/docs/upload-catalog#mc). Supported values for user events imports: *
    ...
    public class GoogleCloudRetailV2alphaGcsSource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// up to 2 GB. See [Importing product information](/recommendations-ai/docs/upload-catalog) for the expected
    ...
    public class GoogleCloudRetailV2alphaPredictRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The labels for the predict request. * Label keys can contain lowercase letters, digits and hyphens, must
        /// start with a letter, and must end with a letter or digit. * Non-zero label values can contain lowercase
        /// letters, digits and hyphens, must start with a letter, and must end with a letter or digit. * No more than
        /// 64 labels can be associated with a given request. See https://goo.gl/xmQnxf for more information on and
        /// examples of labels.
        /// </summary>
    ...
    public class GoogleCloudRetailV2alphaProduct : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Canonical URL directly linking to the product detail page. This field must be a UTF-8 encoded string with a
        /// length limit of 5,000 characters. Otherwise, an INVALID_ARGUMENT error is returned. Google Merchant Center
        /// property [link](https://support.google.com/merchants/answer/6324416). Schema.org property
    ...
    public class GoogleCloudRetailV2alphaUserEvent : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// detail page viewed. * `home-page-view`: Homepage viewed. * `purchase-complete`: User finishing a purchase. *
