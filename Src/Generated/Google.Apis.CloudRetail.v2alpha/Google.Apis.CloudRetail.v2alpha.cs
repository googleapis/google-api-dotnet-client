...
namespace Google.Apis.CloudRetail.v2alpha.Data
{
    ...
    public class GoogleCloudRetailV2alphaMerchantCenterLink : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// here. [https://support.google.com/merchants/answer/7501026?hl=en] List of allowed string values:
        /// "shopping-ads", "buy-on-google-listings", "display-ads", "local-inventory -ads", "free-listings",
