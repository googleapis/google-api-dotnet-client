        ...
        public class LocationsResource
        {
            ...
            public class CatalogsResource
            {
                ...
                public class CompleteQueryRequest : CloudRetailBaseServiceRequest<Google.Apis.CloudRetail.v2alpha.Data.GoogleCloudRetailV2alphaCompleteQueryResponse>
                {
                    ...
                    /// an exact match with UserEvent.entity to get per-entity autocomplete results. Also, this entity
                    /// should be limited to 256 characters, if too long, it will be truncated to 256 characters in both
                    /// generation and serving time, and may lead to mis-match. To ensure it works, please set the
