...
namespace Google.Apis.CloudRetail.v2alpha.Data
{
    ...
    public class GoogleCloudRetailV2alphaProduct : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned. Google Merchant Center property
        ...
        /// <summary>
        /// The pattern or graphic print of the product. For example, "striped", "polka dot", "paisley". A maximum of 5
    ...
    public class GoogleCloudRetailV2alphaSearchRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// [user guide](/retail/private/docs/result-size#relevance_thresholding).
        /// </summary>
