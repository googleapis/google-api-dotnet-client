...
namespace Google.Apis.DataCatalog.v1
{
    ...
    public class EntriesResource
    {
        ...
        public class LookupRequest : DataCatalogBaseServiceRequest<Google.Apis.DataCatalog.v1.Data.GoogleCloudDatacatalogV1Entry>
        {
            ...
            /// comply with the [Lexical structure in GoogleSQL]
...
namespace Google.Apis.DataCatalog.v1.Data
{
    ...
    /// (https://cloud.google.com/iam/docs/roles-permissions/datacatalog) provide permissions to create, edit, and use
    /// the template. For example, see the [TagTemplate User]
