    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class WorkloadIdentityPoolsResource
            {
                ...
                /// <summary>
                /// Add an AttestationRule on a WorkloadIdentityPoolManagedIdentity. The total attestation rules after
                /// addition must not exceed 50.
                /// </summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="resource">
                /// Required. The resource name of the managed identity or namespace resource to add an attestation rule
                /// to.
                /// </param>
                public virtual AddAttestationRuleRequest AddAttestationRule(Google.Apis.Iam.v1.Data.AddAttestationRuleRequest body, string resource)
                {
                ...
                public class ListAttestationRulesRequest : IamBaseServiceRequest<Google.Apis.Iam.v1.Data.ListAttestationRulesResponse>
                {
                    ...
                    /// <summary>
                    /// Required. The resource name of the managed identity or namespace resource to list attestation
                    /// rules of.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("resource", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Resource { get; private set; }
                    ...
                    /// AttestationRules under the specific container ids. The function expects a comma-delimited list
                    /// with only project numbers and must use the format `projects/`. For example:
                ...
                /// <summary>
                /// Set all AttestationRule on a WorkloadIdentityPoolManagedIdentity. A maximum of 50 AttestationRules
                /// can be set.
                /// </summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="resource">
...
namespace Google.Apis.Iam.v1.Data
{
    ...
    public class InlineCertificateIssuanceConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. Determines whether the trust domain utilizes the Google Cloud-provisioned default CA. A default CA
        /// in the same region as the workload will be selected to issue the certificate. Enabling this will clear any
        /// existing `ca_pools` configuration to provision the certificates. NOTE: This field is mutually exclusive with
    ...
    /// System-managed keys are also called _Google-owned and managed keys_. User-managed key-pairs can be created and
    /// deleted by users. Users are responsible for rotating these keys periodically to ensure security of their service
    /// accounts. Users retain the private key of these key-pairs, and Google retains ONLY the public key.
    /// System-managed keys that are actively used for signing are rotated regularly according to [security best
    /// practices](https://docs.cloud.google.com/iam/docs/key-rotation#timing). The rotation process is probabilistic,
    /// and usage of the new key will gradually ramp up and down over the key's lifetime. If you cache the public key
    /// set for a service account, we recommend that you update the cache every 15 minutes. User-managed keys can be
    /// added and removed at any time, so it is important to update the cache frequently. For Google-managed keys,
    /// Google will publish a key at least 6 hours before it is first used for signing and will keep publishing it for
    /// at least 6 hours after it was last used for signing. Public keys for all service accounts are also published at
    ...
    public class TrustStore : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. Determines whether the trust bundle includes the private CA managed identity regional root public
    ...
    public class WorkforcePoolProvider : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// When evaluated, the total size of all mapped attributes must not exceed 16 KB. For OIDC providers, you must
    ...
    public class WorkforcePoolProviderScimTenant : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. Service Agent created by SCIM Tenant API. SCIM tokens created under this tenant will be
        /// attached to this service agent.
        /// </summary>
    ...
    public class WorkloadIdentityPoolProvider : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// of the `attribute_condition` expression is 4,096 characters. Providing a condition longer than this will
        /// result in an error. If unspecified, all valid authentication credentials are accepted. However, multi-tenant
        /// identity providers (such as GitHub or Terraform Cloud) require an `attribute_condition` to prevent token
        /// spoofing. The following example shows how to only allow credentials with a mapped `google.groups` value of
        /// `admins`:
        /// ```
        /// "'admins' in google.groups"
        /// ```
