...
namespace Google.Apis.Iam.v1
{
    ...
    public class IamPoliciesResource
    {
        ...
        /// <summary>Lints a Cloud IAM policy object or its sub fields. Currently supports google.iam.v1.Policy,
        /// google.iam.v1.Binding and google.iam.v1.Binding.condition.
        ///
        /// Each lint operation consists of multiple lint validation units. Validation units have the following
        /// properties:
        ///
        /// - Each unit inspects the input object in regard to a particular linting aspect and issues a
        /// google.iam.admin.v1.LintResult disclosing the result. - Domain of discourse of each unit can be either
        /// google.iam.v1.Policy, google.iam.v1.Binding, or google.iam.v1.Binding.condition depending on the purpose of
        /// the validation. - A unit may require additional data (like the list of all possible enumerable values of a
        /// particular attribute used in the policy instance) which shall be provided by the caller. Refer to the
        ...
        ///
        /// Regardless of any lint issues or their severities, successful calls to `lintPolicy` return an HTTP 200 OK
        /// status code.</summary>
    ...
    public class ProjectsResource
    {
        ...
        public class ServiceAccountsResource
        {
            ...
            public class KeysResource
            {
                ...
                /// <summary>Upload public key for a given service account. This rpc will create a ServiceAccountKey
                /// that has the provided public key and returns it.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The resource name of the service account in the following format:
                /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`. Using `-` as a wildcard for the `PROJECT_ID` will infer the
                /// project from the account. The `ACCOUNT` value can be the `email` address or the `unique_id` of the service
            ...
            /// <summary>Patches a ServiceAccount.
            ///
            /// Currently, only the following fields are updatable: `display_name` and `description`.
            ///
            /// Only fields specified in the request are guaranteed to be returned in the response. Other fields in the
            /// response may be empty.
            ///
            /// Note: The field mask is required.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The resource name of the service account in the following format:
            /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`.
            ///
            ...
            /// <summary>**Note**: This method is in the process of being deprecated. Call the
            /// [`signBlob()`](/iam/credentials/reference/rest/v1/projects.serviceAccounts/signBlob) method of the Cloud
            /// IAM Service Account Credentials API instead.
            ///
            /// Signs a blob using a service account's system-managed private key.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The resource name of the service account in the following format:
            /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`. Using `-` as a wildcard for the `PROJECT_ID` will infer the
            /// project from the account. The `ACCOUNT` value can be the `email` address or the `unique_id` of the service
            ...
            /// <summary>**Note**: This method is in the process of being deprecated. Call the
            /// [`signJwt()`](/iam/credentials/reference/rest/v1/projects.serviceAccounts/signJwt) method of the Cloud
            /// IAM Service Account Credentials API instead.
            ///
...
{    
    ...
    /// <summary>The request to lint a Cloud IAM policy object. LintPolicy is currently functional only for
    /// `lint_object` of type `condition`.</summary>
    public class LintPolicyRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Binding object to be linted. The functionality of linting a binding is not yet implemented and if
        /// this field is set, it returns NOT_IMPLEMENTED error.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("binding")]
        ...
        /// <summary>`context` contains additional *permission-controlled* data that any lint unit may depend on, in
        /// form of `{key: value}` pairs. Currently, this field is non-operational and it will not be used during the
        /// lint operation.</summary>
        ...
        /// <summary>Policy object to be linted. The functionality of linting a policy is not yet implemented and if
        /// this field is set, it returns NOT_IMPLEMENTED error.</summary>
    ...
    {
        /// <summary>List of lint results sorted by a composite  key, descending order of severity and ascending order
        /// of binding_ordinal. There is no certain order among the same keys.
        ///
        /// For cross-binding results (only if the input object to lint is instance of google.iam.v1.Policy), there will
        /// be a google.iam.admin.v1.LintResult for each of the involved bindings, and the associated debug_message may
        /// enumerate the other involved binding ordinal number(s).</summary>
    ...
    {
        /// <summary>0-based index ordinality of the binding in the input object associated with this result. This field
        /// is populated only if the input object to lint is of type google.iam.v1.Policy, which can comprise more than
        /// one binding. It is set to -1 if the result is not associated with any particular binding and only targets
        /// the policy as a whole, such as results about policy size violations.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bindingOrdinal")]
        public virtual System.Nullable<int> BindingOrdinal { get; set; } 
        ...
        ///
        /// For nested messages, `field_name` consists of names of the embedded fields separated by period character.
        /// The top-level qualifier is the input object to lint in the request. For instance, if the lint request is on
        /// a google.iam.v1.Policy and this lint result is about a condition expression of one of the input policy
        /// bindings, the field would be populated as `policy.bindings.condition.expression`.
        ///
        /// This field does not identify the ordinality of the repetitive fields (for instance bindings in a
        /// policy).</summary>
    ...
    /// <summary>The patch service account request.</summary>
    ...
    public class ServiceAccount : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Note: `etag` is an inoperable legacy field that is only returned for backwards
