...
/**
 * \brief
 *   Identity and Access Management (IAM) API Version v1
 *
 ...
 *
 * The complete API documentation for using Identity and Access Management (IAM) API can be found at
...
namespace Google.Apis.Iam.v1
{
    ...
    public class IamService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://iam.googleapis.com/"; }
        #else
    ...
    public class IamPoliciesResource
    {
        ...
        ///
        /// Successful calls to this method always return an HTTP `200 OK` status code, even if the linter detects an
        /// issue in the IAM policy.</summary>
        ...
        public class LintPolicyRequest : IamBaseServiceRequest<Google.Apis.Iam.v1.Data.LintPolicyResponse>
        {
            ...
            {
                get { return "v1/iamPolicies:lintPolicy"; }
            }
    ...
    public class OrganizationsResource
    {
        ...
        public class RolesResource
        {
            ...
            /// described below:
            ///
            /// * [`projects.roles.create()`](/iam/reference/rest/v1/projects.roles/create):   `projects/{PROJECT_ID}`. This method
            /// creates project-level   [custom roles](/iam/docs/understanding-custom-roles).   Example request URL:
            ...
            /// custom-roles). Example request   URL:   `https://iam.googleapis.com/v1/organizations/{ORGANIZATION_ID}/roles`
            ///
            /// Note: Wildcard (*) values are invalid; you must specify a complete project ID or organization ID.</param>
            ...
            ///
            /// * The custom role is permanently deleted and cannot be recovered. * If an IAM policy contains a binding
            /// to the custom role, the binding is permanently removed.</summary>
            ...
            /// below:
            ///
            /// * [`roles.get()`](/iam/reference/rest/v1/roles/get): `roles/{ROLE_NAME}`.   This method returns results from all
            /// [predefined roles](/iam/docs/understanding-roles#predefined_roles) in   Cloud IAM. Example request URL:
            /// `https://iam.googleapis.com/v1/roles/{ROLE_NAME}`
            ///
            /// * [`projects.roles.get()`](/iam/reference/rest/v1/projects.roles/get):
            /// `projects/{PROJECT_ID}/roles/{CUSTOM_ROLE_ID}`. This method returns only   [custom roles](/iam/docs/understanding-
            /// custom-roles) that have been   created at the project level. Example request URL:
            /// `https://iam.googleapis.com/v1/projects/{PROJECT_ID}/roles/{CUSTOM_ROLE_ID}`
            ///
            ...
            /// described below:
            ///
            /// * [`roles.list()`](/iam/reference/rest/v1/roles/list): An empty string.   This method doesn't require a resource; it
            /// simply returns all   [predefined roles](/iam/docs/understanding-roles#predefined_roles) in   Cloud IAM. Example
            /// request URL:   `https://iam.googleapis.com/v1/roles`
            ///
            /// * [`projects.roles.list()`](/iam/reference/rest/v1/projects.roles/list):   `projects/{PROJECT_ID}`. This method
            ...
            public class ListRequest : IamBaseServiceRequest<Google.Apis.Iam.v1.Data.ListRolesResponse>
            {
                ...
                /// a resource; it simply returns all [predefined roles](/iam/docs/understanding-roles#predefined_roles)
        ...
        public class ServiceAccountsResource
        {
            ...
            public class KeysResource
            {
                ...
                public class UploadRequest : IamBaseServiceRequest<Google.Apis.Iam.v1.Data.ServiceAccountKey>
                {
                    ...
                    public override string RestPath
                    {
                        get { return "v1/{+name}/keys:upload"; }
                    }
            ...
            /// <summary>Deletes a ServiceAccount.
            ///
            /// **Warning:** After you delete a service account, you might not be able to undelete it. If you know that
            /// you need to re-enable the service account in the future, use DisableServiceAccount instead.
            ///
            /// If you delete a service account, IAM permanently removes the service account 30 days later. Google Cloud
            /// cannot recover the service account after it is permanently removed, even if you file a support request.
            ///
            /// To help avoid unplanned outages, we recommend that you disable the service account before you delete it.
            /// Use DisableServiceAccount to disable the service account, then wait at least 24 hours and watch for
            /// unintended consequences. If there are no unintended consequences, you can delete the service
            /// account.</summary>
            /// <param name="name">Required. The resource name of the service account in the following format:
            /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`. Using `-` as a wildcard for the `PROJECT_ID` will infer the
            /// project from the account. The `ACCOUNT` value can be the `email` address or the `unique_id` of the service
            ...
            /// <summary>Disables a ServiceAccount immediately.
            ///
            /// If an application uses the service account to authenticate, that application can no longer call Google
            /// APIs or access Google Cloud resources. Existing access tokens for the service account are rejected, and
            /// requests for new access tokens will fail.
            ///
            /// To re-enable the service account, use EnableServiceAccount. After you re-enable the service account, its
            /// existing access tokens will be accepted, and you can request new access tokens.
            ///
            /// To help avoid unplanned outages, we recommend that you disable the service account before you delete it.
            /// Use this method to disable the service account, then wait at least 24 hours and watch for unintended
            /// consequences. If there are no unintended consequences, you can delete the service account with
            /// DeleteServiceAccount.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The resource name of the service account in the following format:
            /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`. Using `-` as a wildcard for the `PROJECT_ID` will infer the
            /// project from the account. The `ACCOUNT` value can be the `email` address or the `unique_id` of the service
            ...
            /// <summary>Enables a ServiceAccount that was disabled by DisableServiceAccount.
            ///
            /// If the service account is already enabled, then this method has no effect.
            ///
            /// If the service account was disabled by other means—for example, if Google disabled the service account
            /// because it was compromised—you cannot use this method to enable the service account.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The resource name of the service account in the following format:
            /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`. Using `-` as a wildcard for the `PROJECT_ID` will infer the
            /// project from the account. The `ACCOUNT` value can be the `email` address or the `unique_id` of the service
            ...
            ///
            /// This method does not tell you whether the service account has been granted any roles on other resources.
            /// To check whether a service account has role grants on a resource, use the `getIamPolicy` method for that
            /// resource. For example, to view the role grants for a project, call the Resource Manager API's
            ...
            ///
            /// When possible, avoid using the `-` wildcard character, because it can cause response messages to contain misleading
            /// error codes. For example, if you try to get the service account `projects/-/serviceAccounts/fake@example.com`, which
            /// does not exist, the response contains an HTTP `403 Forbidden` error instead of a `404 Not Found` error.</param>
            ...
            /// <summary>Sets the IAM policy that is attached to a ServiceAccount.
            ///
            /// Use this method to grant or revoke access to the service account. For example, you could grant a member
            /// the ability to impersonate the service account.
            ///
            /// This method does not enable the service account to access other resources. To grant roles to a service
            /// account on a resource, follow these steps:
            ///
            /// 1. Call the resource's `getIamPolicy` method to get its current IAM policy. 2. Edit the policy so that
            /// it binds the service account to an IAM role for the resource. 3. Call the resource's `setIamPolicy`
            ...
            /// <summary>Restores a deleted ServiceAccount.
            ///
            /// **Important:** It is not always possible to restore a deleted service account. Use this method only as a
            /// last resort.
            ///
            /// After you delete a service account, IAM permanently removes the service account 30 days later. There is
            /// no way to restore a deleted service account that has been permanently removed.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The resource name of the service account in the following format:
            ...
            ///
            /// You can update only the `display_name` and `description` fields.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The resource name of the service account.
            ///
            /// Use one of the following formats:
    ...
    public class RolesResource
    {
        ...
        public class GetRequest : IamBaseServiceRequest<Google.Apis.Iam.v1.Data.Role>
        {
            ...
            /// is described below:
            ///
            /// * [`roles.get()`](/iam/reference/rest/v1/roles/get): `roles/{ROLE_NAME}`. This method returns results
            /// from all [predefined roles](/iam/docs/understanding-roles#predefined_roles) in Cloud IAM. Example
...
{    
    ...
    public class LintPolicyRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The full resource name of the policy this lint request is about.
        ///
        /// The name follows the Google Cloud Platform (GCP) resource format. For example, a GCP project with ID `my-
        /// project` will be named `//cloudresourcemanager.googleapis.com/projects/my-project`.
        ///
        /// The resource name is not used to read the policy instance from the Cloud IAM database. The candidate policy
        /// for lint has to be provided in the same request object.</summary>
    ...
    public class LintResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The name of the field for which this lint result is about.
        ///
        /// For nested messages `field_name` consists of names of the embedded fields separated by period character. The
        /// top-level qualifier is the input object to lint in the request. For example, the `field_name` value
    ...
    /// <summary>The request for PatchServiceAccount.
    ///
    /// You can patch only the `display_name` and `description` fields. You must use the `update_mask` field to specify
    /// which of these fields you want to patch.
    ///
    /// Only the fields specified in the request are guaranteed to be returned in the response. Other fields may be
    /// empty in the response.</summary>
    ...
    /// <summary>An IAM service account.
    ///
    /// A service account is an account for an application or a virtual machine (VM) instance, not a person. You can use
    /// a service account to call Google APIs. To learn more, read the [overview of service
    /// accounts](https://cloud.google.com/iam/help/service-accounts/overview).
    ///
    /// When you create a service account, you specify the project ID that owns the service account, as well as a name
    /// that must be unique within the project. IAM uses these values to create an email address that identifies the
    ...
    public class ServiceAccount : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `projects/-/serviceAccounts/fake@example.com`, which does not exist, the response contains an HTTP `403
        /// Forbidden` error instead of a `404 Not Found` error.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
        ...
        /// <summary>Output only. The unique, stable numeric ID for the service account.
        ///
        /// Each service account retains its unique ID even if you delete the service account. For example, if you
        /// delete a service account, then create a new service account with the same name, the new service account has
        /// a different unique ID than the deleted service account.</summary>
    ...
    ///
    /// System-managed keys are automatically rotated by Google, and are used for signing for a maximum of two weeks.
    /// The rotation process is probabilistic, and usage of the new key will gradually ramp up and down over the key's
    /// lifetime. We recommend caching the public key set for a service account for no more than 24 hours to ensure you
    /// have access to the latest keys.
    ///
    ...
    public class SignJwtRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// If the JWT Claims Set does not contain an expiration time (`exp`) claim, this claim is added automatically,
        /// with a timestamp that is 1 hour in the future.</summary>
