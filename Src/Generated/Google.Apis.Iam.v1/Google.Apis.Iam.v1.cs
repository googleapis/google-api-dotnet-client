...
namespace Google.Apis.Iam.v1
{
    ...
    public class IamPoliciesResource
    {
        ...
        /// <summary>Lints a Cloud IAM policy object or its sub fields. Currently supports
        /// google.iam.v1.Binding.condition.
        ///
        /// Each lint operation consists of multiple lint validation units. Each unit inspects the input object in
        /// regard to a particular linting aspect and issues a google.iam.admin.v1.LintResult disclosing the result.
        ///
    ...
    public class ProjectsResource
    {
        ...
        public class ServiceAccountsResource
        {
            ...
            ///
            /// Previously issued Access tokens for a service account will be rejected while the service account is
            /// disabled but will start working again if the account is re-enabled. Issuance of new tokens will fail
...
{    
    ...
    {
        /// <summary>Required. The JWT payload to sign, a JSON JWT Claim set.</summary>
