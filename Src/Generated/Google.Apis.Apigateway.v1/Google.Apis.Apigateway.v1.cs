        ...
        public class LocationsResource
        {
            ...
            public class ApisResource
            {
                ...
                public class ConfigsResource
                {
                    ...
                    public class PatchRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                    {
                        ...
                        /// <summary>
                        /// Field mask is used to specify the fields to be overwritten in the ApiConfig resource by the
            ...
            public class GatewaysResource
            {
                ...
                public class CreateRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>
                    /// Required. Identifier to assign to the Gateway. Must be unique within scope of the parent
                    /// resource.
                    /// </summary>
                ...
                public class PatchRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>
                    /// Field mask is used to specify the fields to be overwritten in the Gateway resource by the
                    /// update. The fields specified in the update_mask are relative to the resource, not the full
...
namespace Google.Apis.Apigateway.v1.Data
{
    ...
    /// <summary>
    /// An API Configuration is a combination of settings for both the Managed Service and Gateways serving this API
    /// Config.
    /// </summary>
    public class ApigatewayApiConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// See https://cloud.google.com/endpoints/docs/grpc/grpc-service-config#service_configuration_overview for the
        /// expected file contents. If multiple files are specified, the files are merged with the following rules: *
        /// All singular scalar fields are merged using "last one wins" semantics in the order of the files uploaded. *
        /// Repeated fields are concatenated. * Singular embedded messages are merged using these rules for nested
        /// fields.
        /// </summary>
        ...
        /// <summary>
        /// Optional. OpenAPI specification documents. If specified, grpc_services and managed_service_configs must not
        /// be included.
        /// </summary>
    ...
    {
        /// <summary>
        /// Input only. File descriptor set, generated by protoc. To generate, use protoc with imports and source info
        /// included. For an example test.proto file, the following command would put the value in a new file named
        /// out.pb. $ protoc --include_imports --include_source_info test.proto -o out.pb
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("fileDescriptorSet")]
        public virtual ApigatewayApiConfigFile FileDescriptorSet { get; set; }

        /// <summary>
        /// Optional. Uncompiled proto files associated with the descriptor set, used for display purposes (server-side
        /// compilation is not supported). These should match the inputs to 'protoc' command used to generate
        /// file_descriptor_set.
        /// </summary>
    ...
    /// <summary>
    /// A Gateway is an API-aware HTTP proxy. It performs API-Method and/or API-Consumer specific actions based on an
    /// API Config such as authentication, policy enforcement, and backend selection.
    /// </summary>
    public class ApigatewayGateway : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The default hostname that serves traffic for this Gateway.</summary>
