...
namespace Google.Apis.Apigateway.v1
{
    ...
    public class ApigatewayService : Google.Apis.Services.BaseClientService
    {
        ...
        public ApigatewayService() : this(new Google.Apis.Services.BaseClientService.Initializer())
        {
        }
        ...
        public override string BaseUri =>
            ...
            BaseUriOverride ?? "https://apigateway.googleapis.com/";
        #else
        ...
        /// <summary>Available OAuth 2.0 scopes for use with the API Gateway API.</summary>
        public class Scope
        {
        ...
        /// <summary>Available OAuth 2.0 scope constants for use with the API Gateway API.</summary>
    ...
    /// <summary>A base abstract class for Apigateway requests.</summary>
    public abstract class ApigatewayBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        /// <summary>Constructs a new ApigatewayBaseServiceRequest instance.</summary>
        protected ApigatewayBaseServiceRequest(Google.Apis.Services.IClientService service) : base(service)
        {
        }
        ...
        /// <summary>Initializes Apigateway parameter list.</summary>
        ...
        public class LocationsResource
        {
            ...
            public class ApisResource
            {
                ...
                public class ConfigsResource
                {
                    ...
                    public class CreateRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                    {
                        ...
                        /// <summary>Required. Parent resource of the API Config, of the form:
                        /// `projects/locations/global/apis`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }

                        /// <summary>Required. Identifier to assign to the API Config. Must be unique within scope of
                        /// the parent resource.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("apiConfigId", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual string ApiConfigId { get; set; }
                        ...
                        protected override void InitParameters()
                        {
                            ...
                            RequestParameters.Add("apiConfigId", new Google.Apis.Discovery.Parameter
                            {
                                Name = "apiConfigId",
                                IsRequired = false,
                                ParameterType = "query",
                    ...
                    /// <param name="name">Required. Resource name of the form: `projects/locations/global/apis/configs`</param>
                    ...
                    public class DeleteRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                    {
                        ...
                        /// <summary>Required. Resource name of the form:
                        /// `projects/locations/global/apis/configs`</summary>
                    ...
                    public class GetRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayApiConfig>
                    {
                        ...
                        /// <summary>Specifies which fields of the API Config are returned in the response. Defaults to
                        /// `BASIC` view.</summary>
                        ...
                        {
                            [Google.Apis.Util.StringValueAttribute("CONFIG_VIEW_UNSPECIFIED")]
                            CONFIGVIEWUNSPECIFIED,
                            /// <summary>Do not include configuration source files.</summary>
                            [Google.Apis.Util.StringValueAttribute("BASIC")]
                            BASIC,
                            /// <summary>Include configuration source files.</summary>
                    ...
                    public class PatchRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                    {
                        ...
                        /// <summary>Field mask is used to specify the fields to be overwritten in the ApiConfig
                        /// resource by the update. The fields specified in the update_mask are relative to the
                        /// resource, not the full request. A field will be overwritten if it is in the mask. If the
                        /// user does not provide a mask then all fields will be overwritten.</summary>
                ...
                public class CreateRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>Required. Parent resource of the API, of the form:
                    /// `projects/locations/global`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Required. Identifier to assign to the API. Must be unique within scope of the parent
                    /// resource.</summary>
                ...
                public class DeleteRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>Required. Resource name of the form: `projects/locations/global/apis`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                public class PatchRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>Field mask is used to specify the fields to be overwritten in the Api resource by the
                    ...
                    /// then all fields will be overwritten.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual object UpdateMask { get; set; }
            ...
            public class GatewaysResource
            {
                ...
                public class CreateRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>Required. Parent resource of the Gateway, of the form: `projects/locations`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Required. Identifier to assign to the Gateway. Must be unique within scope of the
                ...
                public class DeleteRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>Required. Resource name of the form: `projects/locations/gateways`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                public class PatchRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1.Data.ApigatewayOperation>
                {
                    ...
                    /// <summary>Field mask is used to specify the fields to be overwritten in the Gateway resource by
...
{    
    ...
    public class ApigatewayApi : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayApiConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// (`projects/{PROJECT}/accounts/{UNIQUE_ID}`). This is most often used when the service is a GCP resource such
        /// as a Cloud Run Service or an IAP-secured service.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("gatewayServiceAccount")]
        ...
        /// config#service_configuration_overview for the expected file contents. If multiple files are specified, the
        /// files are merged with the following rules: * All singular scalar fields are merged using "last one wins"
    ...
    /// <summary>A lightweight description of a file.</summary>
    public class ApigatewayApiConfigFile : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>A gRPC service definition.</summary>
    public class ApigatewayApiConfigGrpcServiceDefinition : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Input only. File descriptor set, generated by protoc. To generate, use protoc with imports and
    ...
    /// <summary>An OpenAPI Specification Document describing an API.</summary>
    public class ApigatewayApiConfigOpenApiDocument : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayAuditConfig : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// logging.</summary>
    public class ApigatewayAuditLogConfig : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayCancelOperationRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    
    ...
    public class ApigatewayExpr : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>A Gateway is an API-aware HTTP proxy. It performs API-Method and/or API-Consumer specific actions based
    /// on an API Config such as authentication, policy enforcement, and backend selection.</summary>
    public class ApigatewayGateway : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Response message for ApiGatewayService.ListApiConfigs</summary>
    public class ApigatewayListApiConfigsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Response message for ApiGatewayService.ListApis</summary>
    public class ApigatewayListApisResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Response message for ApiGatewayService.ListGateways</summary>
    public class ApigatewayListGatewaysResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayListLocationsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayListOperationsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The standard List next-page token.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    public class ApigatewayLocation : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayOperation : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayOperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Diagnostic information from configuration processing.</summary>
    public class ApigatewayOperationMetadataDiagnostic : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewaySetIamPolicyRequest : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayStatus : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayTestIamPermissionsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class ApigatewayTestIamPermissionsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
