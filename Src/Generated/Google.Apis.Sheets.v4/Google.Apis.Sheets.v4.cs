    ...
    public class SpreadsheetsResource
    {
        ...
        public class ValuesResource
        {
            ...
            public class AppendRequest : SheetsBaseServiceRequest<Google.Apis.Sheets.v4.Data.AppendValuesResponse>
            {
                ...
                {
                    /// <summary>
                    /// Values will be calculated &amp;amp; formatted in the response according to the cell's
...
namespace Google.Apis.Sheets.v4.Data
{
    ...
    public class CellData : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Non-chipped runs will have an empty Chip. When writing, only runs with chips are included. Runs containing
        /// chips are of length 1 and are represented in the user-entered text by an “@” placeholder symbol. New runs
        /// will overwrite any prior runs. Writing a new user_entered_value will erase previous runs.
        /// </summary>
    ...
    public class Request : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Refreshes one or multiple data sources and associated dbobjects.</summary>
