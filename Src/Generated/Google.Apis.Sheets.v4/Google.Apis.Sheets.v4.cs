 ...
 *      <tr><th>API Rev<td>20180204 (1130)
 *      <tr><th>API Docs
...
{    
    ...
    {
        /// <summary>Optional. The maximum value at which items will be placed into buckets of constant size. Values
        /// above end will be lumped into a single bucket.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("end")]
        public virtual System.Nullable<double> End { get; set; } 

        /// <summary>Required. The size of the buckets that will be created. Must be positive.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("interval")]
        public virtual System.Nullable<double> Interval { get; set; } 

        /// <summary>Optional. The minimum value at which items will be placed into buckets of constant size. Values
        /// below start will be lumped into a single bucket.</summary>
    ...
    public class WaterfallChartCustomSubtotal : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// points. For example, if a series has 3 data points, their indices will always be 0, 1, and 2, regardless of
        /// how many subtotals exist on the series or what data points they are associated with.</summary>
