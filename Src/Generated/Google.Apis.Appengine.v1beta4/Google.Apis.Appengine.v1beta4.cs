...
namespace Google.Apis.Appengine.v1beta4
{
    ...
    public class AppsResource
    {
        ...
        public class ModulesResource
        {
            ...
            /// <summary>Deletes a module and all enclosed versions.</summary>
            /// <param name="appsId">Part of `name`. Name of the resource requested. For example:
            /// "apps/myapp/modules/default".</param>
            /// <param name="modulesId">Part of `name`. See documentation of
            /// `appsId`.</param>
            ...
            /// <summary>Gets the current configuration of the module.</summary>
            /// <param name="appsId">Part of `name`. Name of the resource requested. For example:
            /// "apps/myapp/modules/default".</param>
            /// <param name="modulesId">Part of `name`. See documentation of
            /// `appsId`.</param>
...
{    
    ...
    public class AutomaticScaling : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// to the default version of a module, since other versions are not expected to receive significant
        /// traffic.</summary>
    ...
    {
        /// <summary>The number of instances to assign to the module at the start. This number can later be altered by
    ...
    /// <summary>A module is a component of an application that provides a single service or configuration. A module has
    /// a collection of versions that define a specific set of code used to implement the functionality of that
    /// module.</summary>
    public class Module : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The relative name/path of the module within the application. Example: "default"
        /// @OutputOnly</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 

        /// <summary>The full path to the Module resource in the API. Example: "apps/myapp/modules/default"
        /// @OutputOnly</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    public class StaticDirectoryHandler : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The path to the directory containing the static files, from the application root directory.
        /// Everything after the end of the matched url pattern is appended to static_dir to form the full path to the
    ...
    /// <summary>Configuration for traffic splitting for versions within a single module. Traffic splitting allows
    /// traffic directed to the module to be assigned to one of several versions in a fractional way, enabling
    ...
    {
        /// <summary>Mapping from module version IDs within the module to fractional (0.000, 1] allocations of traffic
        /// for that version. Each version may only be specified once, but some versions in the module may not have any
        /// traffic allocation. Modules that have traffic allocated in this field may not be deleted until the module is
        /// deleted, or their traffic allocation is removed. Allocations must sum to 1. Supports precision up to two
    ...
    public class UrlDispatchRule : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource id of a Module in this application that should service the matched request. The Module
    ...
    /// <summary>A Version is a specific set of source code and configuration files deployed to a module.</summary>
    public class Version : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The relative name/path of the Version within the module. Example: "v1". Version specifiers can
        ...
        /// <summary>The frontend instance class to use to run this app. Valid values are `[F1, F2, F4, F4_1G]`.
        /// Default: "F1"</summary>
