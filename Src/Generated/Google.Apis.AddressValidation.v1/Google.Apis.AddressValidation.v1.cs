...
namespace Google.Apis.AddressValidation.v1.Data
{
    ...
    public class GoogleMapsAddressvalidationV1Address : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// address in the `postal_address` field. For example, the `postal_address` will always represent the country
        /// as a 2 letter `region_code` (ex. "US" or "CA"), whereas this field will use a longer form of the country
        /// name (ex. "USA or "Canada").
        /// </summary>
        ...
        /// valid part of an address (for example in an input like "Parcel 0000123123 &amp;amp; 0000456456 Str # Guthrie
        /// Center IA 50115 US", the unresolved tokens may look like `["Parcel", "0000123123", "&amp;amp;",
        /// "0000456456"]`.
        /// </summary>
