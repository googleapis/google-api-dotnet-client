...
namespace Google.Apis.Pubsub.v1beta2
{
    ...
    public class ProjectsResource
    {
        ...
        public class SubscriptionsResource
        {
            ...
            /// <summary>Creates a subscription to a given topic for a given subscriber. If the subscription already
            /// exists, returns `ALREADY_EXISTS`. If the corresponding topic doesn't exist, returns `NOT_FOUND`. If the
            /// name is not provided in the request, the server will assign a random name for this subscription on the
            /// same project as the topic.</summary>
            /// <param name="body">The body of the request.</param>
            ...
            /// <summary>Gets the access control policy for a `resource`. Is empty if the policy or the resource does
            /// not exist.</summary>
            /// <param name="resource">REQUIRED: The resource for which policy is being requested. `resource` is usually specified
            /// as a path, such as, `projects/{project}/zones/{zone}/disks/{disk}`. The format for the path specified in this value
            /// is resource specific and is specified in the documentation for the respective GetIamPolicy rpc.</param>
            ...
            public class GetIamPolicyRequest : PubsubBaseServiceRequest<Google.Apis.Pubsub.v1beta2.Data.Policy>
            {
                ...
                /// <summary>REQUIRED: The resource for which policy is being requested. `resource` is usually specified
                ...
                /// respective GetIamPolicy rpc.</summary>
            ...
            /// policy.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="resource">REQUIRED: The resource for which policy is being specified. `resource` is usually specified
            /// as a path, such as, `projects/{project}/zones/{zone}/disks/{disk}`. The format for the path specified in this value
            /// is resource specific and is specified in the documentation for the respective SetIamPolicy rpc.</param>
            ...
            public class SetIamPolicyRequest : PubsubBaseServiceRequest<Google.Apis.Pubsub.v1beta2.Data.Policy>
            {
                ...
                /// <summary>REQUIRED: The resource for which policy is being specified. `resource` is usually specified
                /// as a path, such as, `projects/{project}/zones/{zone}/disks/{disk}`. The format for the path
                /// specified in this value is resource specific and is specified in the documentation for the
                /// respective SetIamPolicy rpc.</summary>
                [Google.Apis.Util.RequestParameterAttribute("resource", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Resource { get; private set; }
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="resource">REQUIRED: The resource for which policy detail is being requested. `resource` is usually
            /// specified as a path, such as, `projects/{project}/zones/{zone}/disks/{disk}`. The format for the path specified in
            /// this value is resource specific and is specified in the documentation for the respective TestIamPermissions
            /// rpc.</param>
            ...
            public class TestIamPermissionsRequest : PubsubBaseServiceRequest<Google.Apis.Pubsub.v1beta2.Data.TestIamPermissionsResponse>
            {
                ...
                /// <summary>REQUIRED: The resource for which policy detail is being requested. `resource` is usually
                /// specified as a path, such as, `projects/{project}/zones/{zone}/disks/{disk}`. The format for the
                /// path specified in this value is resource specific and is specified in the documentation for the
                /// respective TestIamPermissions rpc.</summary>
                [Google.Apis.Util.RequestParameterAttribute("resource", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Resource { get; private set; }
...
{    
    ...
    public class Binding : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// following formats: * `allUsers`: A special identifier that represents anyone who is on the internet; with or
    ...
    public class Policy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Can be used to perform a read-modify-write.</summary>
    ...
    public class Subscription : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// effort basis). For pull delivery this value is used as the initial value for the ack deadline. To override
        /// this value for a given message, call `ModifyAckDeadline` with the corresponding `ack_id`. For push delivery,
        /// this value is also used to set the request timeout for the call to the push endpoint. If the subscriber
        /// never acknowledges the message, the Pub/Sub system will eventually redeliver the message. If this parameter
        /// is not set, the default value of 10 seconds is used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ackDeadlineSeconds")]
        public virtual System.Nullable<int> AckDeadlineSeconds { get; set; } 
