    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class TransferConfigsResource
            {
                ...
                /// `projects/{project_id}/location/{region}/transferConfigs/{config_id}`. The name is automatically generated based on
                ...
                public class PatchRequest : BigQueryDataTransferBaseServiceRequest<Google.Apis.BigQueryDataTransfer.v1.Data.TransferConfig>
                {
                    ...
                    /// generated based on the config_id specified in CreateTransferConfigRequest along with project_id
                    /// and region. If config_id is not provided, usually a uuid, even though it is not guaranteed or
                    /// required, will be generated for config_id.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
...
{    
    ...
    public class TransferConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the transfer config. Transfer config names have the form of
        /// `projects/{project_id}/location/{region}/transferConfigs/{config_id}`. The name is automatically generated
