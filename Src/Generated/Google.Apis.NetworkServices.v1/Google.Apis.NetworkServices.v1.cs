    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public LocationsResource(Google.Apis.Services.IClientService service)
            {
                ...
                MulticastDomainActivations = new MulticastDomainActivationsResource(service);
                MulticastDomains = new MulticastDomainsResource(service);
                MulticastGroupDefinitions = new MulticastGroupDefinitionsResource(service);
                MulticastGroups = new MulticastGroupsResource(service);
            ...
            /// <summary>Gets the MulticastDomainActivations resource.</summary>
            public virtual MulticastDomainActivationsResource MulticastDomainActivations { get; }

            /// <summary>The "multicastDomainActivations" collection of methods.</summary>
            public class MulticastDomainActivationsResource
            {
                private const string Resource = "multicastDomainActivations";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public MulticastDomainActivationsResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
            ...
            /// <summary>Gets the MulticastDomains resource.</summary>
            public virtual MulticastDomainsResource MulticastDomains { get; }

            /// <summary>The "multicastDomains" collection of methods.</summary>
            public class MulticastDomainsResource
            {
                private const string Resource = "multicastDomains";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public MulticastDomainsResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
            ...
            /// <summary>Gets the MulticastGroupDefinitions resource.</summary>
            public virtual MulticastGroupDefinitionsResource MulticastGroupDefinitions { get; }

            /// <summary>The "multicastGroupDefinitions" collection of methods.</summary>
            public class MulticastGroupDefinitionsResource
            {
                private const string Resource = "multicastGroupDefinitions";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public MulticastGroupDefinitionsResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
            ...
            /// <summary>Gets the MulticastGroups resource.</summary>
            public virtual MulticastGroupsResource MulticastGroups { get; }

            /// <summary>The "multicastGroups" collection of methods.</summary>
            public class MulticastGroupsResource
            {
                private const string Resource = "multicastGroups";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public MulticastGroupsResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
