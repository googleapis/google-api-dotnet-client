...
namespace Google.Apis.DataCatalog.v1beta1.Data
{
    ...
    /// roles](https://cloud.google.com/iam/docs/roles-permissions/datacatalog) provide permissions to create, edit, and
    /// use the template. See, for example, the [TagTemplate
