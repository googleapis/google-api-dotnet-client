...
{    
    ...
    public class PolicyName : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// is-iam-currently-deployed.
        ///
        /// For Local IAM: This field should be set to "local".</summary>
    ...
    public class Resource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// evaluate to false.
        ///
        /// This field is in limited use. If your intended use case is not expected to express resource.labels attribute
        /// in IAM Conditions, leave this field empty. Before planning on using this attribute please: * Read go/iam-
        /// conditions-labels-comm and ensure your service can meet the data availability and management requirements. *
        /// Talk to iam-conditions-eng@ about your use case.</summary>
        ...
        /// ID]" for a firewall.
        ///
        /// This field is required for evaluating conditions with rules on resource names. For a `list` permission
        /// check, the resource.name value must be set to the parent resource. If the parent resource is a project, this
        /// field should be left unset.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
