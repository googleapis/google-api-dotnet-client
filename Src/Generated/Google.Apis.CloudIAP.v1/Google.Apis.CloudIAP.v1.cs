    ...
    public class ProjectsResource
    {
        ...
        public class BrandsResource
        {
            ...
            public class IdentityAwareProxyClientsResource
            {
                ...
                /// projects/{project_number/id}/brands/{brand}. The project must belong to a G Suite account.</param>
                ...
                public class ListRequest : CloudIAPBaseServiceRequest<Google.Apis.CloudIAP.v1.Data.ListIdentityAwareProxyClientsResponse>
                {
                    ...
                    /// `ListIdentityAwareProxyClients` must match the call that provided the page token.</summary>
...
{    
    ...
    public class AccessSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Settings to configure Policy delegation for apps hosted in tenant projects.
        /// INTERNAL_ONLY.</summary>
    ...
    public class ApplicationSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The Domain value to set for cookies generated by IAP. This value is not validated by the API, but
        /// will be ignored at runtime if invalid.</summary>
    ...
    public class Brand : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. Whether the brand is only intended for usage inside the G Suite organization
        /// only.</summary>
    ...
    /// <summary>PolicyDelegationConfig allows google-internal teams to use IAP for apps hosted in a tenant project.
    /// Using these settings, the app can delegate permission check to happen against the linked customer project. This
    /// is only ever supposed to be used by google internal teams, hence the restriction on the proto.</summary>
    public class PolicyDelegationSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The DNS name of the service (e.g. "resourcemanager.googleapis.com"). This should be the domain name
        /// part of the full resource names (see https://aip.dev/122#full-resource-names), which is usually the same as
        /// IamServiceSpec.service of the service where the resource type is defined.</summary>
    ...
    public class PolicyName : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>For Cloud IAM: The location of the Policy. Must be empty or "global" for Policies owned by global
        /// IAM. Must name a region from prodspec/cloud-iam-cloudspec for Regional IAM Policies, see go/iam-faq#where-
        /// is-iam-currently-deployed. For Local IAM: This field should be set to "local".</summary>
    ...
    {
        /// <summary>The service defined labels of the resource on which the conditions will be evaluated. The semantics
        ...
        /// management requirements. * Talk to iam-conditions-eng@ about your use case.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IDictionary<string, string> Labels { get; set; }

        /// <summary>Name of the resource on which conditions will be evaluated. Must use the Relative Resource Name of
        /// the resource, which is the URI path of the resource without the leading "/". Examples are
        /// "projects/_/buckets/[BUCKET-ID]" for storage buckets or "projects/[PROJECT-ID]/global/firewalls/[FIREWALL-
        /// ID]" for a firewall. This field is required for evaluating conditions with rules on resource names. For a
        /// `list` permission check, the resource.name value must be set to the parent resource. If the parent resource
        /// is a project, this field should be left unset.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }

        /// <summary>The name of the service this resource belongs to. It is configured using the official_service_name
        /// of the Service as defined in service configurations under //configs/cloud/resourcetypes. For example, the
        /// official_service_name of cloud resource manager service is set as 'cloudresourcemanager.googleapis.com'
        /// according to //configs/cloud/resourcetypes/google/cloud/resourcemanager/prod.yaml</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("service")]
        public virtual string Service { get; set; }

        /// <summary>The public resource type name of the resource on which conditions will be evaluated. It is
        /// configured using the official_name of the ResourceType as defined in service configurations under
        ...
        /// //configs/cloud/resourcetypes/google/cloud/resourcemanager/prod.yaml For details see go/iam-conditions-
