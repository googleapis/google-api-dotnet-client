...
namespace Google.Apis.CloudIAP.v1.Data
{
    ...
    public class Resource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Boundaries. Usage: - Must not be empty for services in-scope for Trust Boundaries. Once Trust Boundaries is
        /// GA, empty values will cause the request to be rejected if customers enforce Trust Boundaries on the parent
