    ...
    public class ProjectsResource
    {
        ...
        public class DatabasesResource
        {
            ...
            public class DocumentsResource
            {
                ...
                /// </param>
                public virtual ExecutePipelineRequest ExecutePipeline(Google.Apis.Firestore.v1.Data.ExecutePipelineRequest body, string database)
                {
                    return new ExecutePipelineRequest(this.service, body, database);
                }

                /// <summary>Executes a pipeline query.</summary>
                public class ExecutePipelineRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1.Data.ExecutePipelineResponse>
                {
                    /// <summary>Constructs a new ExecutePipeline request.</summary>
                    public ExecutePipelineRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1.Data.ExecutePipelineRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Firestore.v1.Data.ExecutePipelineRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+database}/documents:executePipeline";
