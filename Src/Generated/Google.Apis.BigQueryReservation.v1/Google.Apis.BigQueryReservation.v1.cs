...
namespace Google.Apis.BigQueryReservation.v1.Data
{
    ...
    public class Reservation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// ignore_idle_slots is set to false. If edition is EDITION_UNSPECIFIED and total slot_capacity of the
        /// reservation and its siblings exceeds the total slot_count of all capacity commitments, the request will fail
        /// with `google.rpc.Code.RESOURCE_EXHAUSTED`. If edition is any value but EDITION_UNSPECIFIED, then the above
        /// requirement is not needed. The total slot_capacity of the reservation and its siblings may exceed the total
        /// slot_count of capacity commitments. In that case, the exceeding slots will be charged with the autoscale
        /// SKU. You can increase the number of baseline slots in a reservation every few minutes. If you want to
        /// decrease your baseline slots, you are limited to once an hour if you have recently changed your baseline
        /// slot capacity and your baseline slots exceed your committed slots. Otherwise, you can decrease your baseline
        /// slots every few minutes. NOTE: for reservations in US or EU multi-regions, slot capacity constraints are
        /// checked separately for default and auxiliary regions. See multi_region_auxiliary flag for more details.
        /// </summary>
