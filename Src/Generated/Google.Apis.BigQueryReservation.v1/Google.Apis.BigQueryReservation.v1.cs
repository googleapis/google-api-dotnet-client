...
namespace Google.Apis.BigQueryReservation.v1.Data
{
    ...
    public class Reservation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// ignore_idle_slots is set to false, or autoscaling is enabled. If edition is EDITION_UNSPECIFIED and total
        /// slot_capacity of the reservation and its siblings exceeds the total slot_count of all capacity commitments,
        /// the request will fail with `google.rpc.Code.RESOURCE_EXHAUSTED`. If edition is any value but
        /// EDITION_UNSPECIFIED, then the above requirement is not needed. The total slot_capacity of the reservation
        /// and its siblings may exceed the total slot_count of capacity commitments. In that case, the exceeding slots
