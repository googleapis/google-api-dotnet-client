...
namespace Google.Apis.Appsactivity.v1
{
    ...
    public class AppsactivityService : Google.Apis.Services.BaseClientService
    {
        ...
        public AppsactivityService() : this(new Google.Apis.Services.BaseClientService.Initializer())
        {
        }

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public AppsactivityService(Google.Apis.Services.BaseClientService.Initializer initializer) : base(initializer)
        {
        ...
        public override string Name => "appsactivity";

        /// <summary>Gets the service base URI.</summary>
        public override string BaseUri =>
        #if NETSTANDARD1_3 || NETSTANDARD2_0 || NET45
            BaseUriOverride ?? "https://www.googleapis.com/appsactivity/v1/";
        #else
            "https://www.googleapis.com/appsactivity/v1/";
        #endif

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "appsactivity/v1/";

        #if !NET40
        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://www.googleapis.com/batch/appsactivity/v1";

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath => "batch/appsactivity/v1";
        #endif
        ...
        {
            /// <summary>View the activity history of your Google apps</summary>
            public const string Activity = "https://www.googleapis.com/auth/activity";
    ...
    public abstract class AppsactivityBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected AppsactivityBaseServiceRequest(Google.Apis.Services.IClientService service) : base(service)
        {
        }
    ...
    public class ActivitiesResource
    {
        ...
        /// determined by the visibility settings of the object that was acted on, e.g. Drive files a user can see. An
        ...
        public class ListRequest : AppsactivityBaseServiceRequest<Google.Apis.Appsactivity.v1.Data.ListActivitiesResponse>
        {
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add("drive.ancestorId", new Google.Apis.Discovery.Parameter
                {
                ...
                RequestParameters.Add("drive.fileId", new Google.Apis.Discovery.Parameter
                {
                    Name = "drive.fileId",
                    IsRequired = false,
                    ParameterType = "query",
                ...
                RequestParameters.Add("groupingStrategy", new Google.Apis.Discovery.Parameter
                {
