    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class ConnectorsResource
            {
                ...
                /// <summary>Creates a Serverless VPC Access connector, returns an operation.</summary>
                public class CreateRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServerlessVPCAccess.v1.Data.Connector body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.ServerlessVPCAccess.v1.Data.Connector Body { get; set; }
                ...
                /// Deletes a Serverless VPC Access connector. Returns NOT_FOUND if the resource does not exist.
                /// </summary>
                public class DeleteRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.Operation>
                {
                ...
                /// Gets a Serverless VPC Access connector. Returns NOT_FOUND if the resource does not exist.
                /// </summary>
                public class GetRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.Connector>
                {
                ...
                /// <summary>Lists Serverless VPC Access connectors.</summary>
                public class ListRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.ListConnectorsResponse>
                {
                ...
                public virtual PatchRequest Patch(Google.Apis.ServerlessVPCAccess.v1.Data.Connector body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates a Serverless VPC Access connector, returns an operation.</summary>
                public class PatchRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.ServerlessVPCAccess.v1.Data.Connector body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class OperationsResource
            {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : ServerlessVPCAccessBaseServiceRequest<Google.Apis.ServerlessVPCAccess.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
