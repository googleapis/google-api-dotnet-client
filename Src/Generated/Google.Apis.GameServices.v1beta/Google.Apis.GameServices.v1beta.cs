        ...
        public class LocationsResource
        {
            ...
            public class GameServerDeploymentsResource
            {
                ...
                public class ConfigsResource
                {
                    ...
                    public class CreateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.Operation>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerConfig body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerDeployment body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                ...
                public class FetchDeploymentStateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.FetchDeploymentStateResponse>
                {
                    ...
                    public FetchDeploymentStateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.FetchDeploymentStateRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class PatchRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerDeployment body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class PreviewRolloutRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.PreviewGameServerDeploymentRolloutResponse>
                {
                    ...
                    public PreviewRolloutRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerDeploymentRollout body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class SetIamPolicyRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.Policy>
                {
                    ...
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.SetIamPolicyRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                ...
                public class TestIamPermissionsRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.TestIamPermissionsResponse>
                {
                    ...
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.TestIamPermissionsRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                ...
                public class UpdateRolloutRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.Operation>
                {
                    ...
                    public UpdateRolloutRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerDeploymentRollout body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.CancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
            ...
            public class RealmsResource
            {
                ...
                public class GameServerClustersResource
                {
                    ...
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerCluster body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerCluster body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    public class PreviewCreateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.PreviewCreateGameServerClusterResponse>
                    {
                        ...
                        public PreviewCreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerCluster body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    public class PreviewUpdateRequest : GameServicesBaseServiceRequest<Google.Apis.GameServices.v1beta.Data.PreviewUpdateGameServerClusterResponse>
                    {
                        ...
                        public PreviewUpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.GameServerCluster body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.Realm body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.Realm body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                {
                    /// <summary>Constructs a new PreviewUpdate request.</summary>
                    public PreviewUpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.GameServices.v1beta.Data.Realm body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
