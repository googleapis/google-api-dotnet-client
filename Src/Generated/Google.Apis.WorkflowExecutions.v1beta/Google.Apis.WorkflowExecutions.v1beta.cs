...
namespace Google.Apis.WorkflowExecutions.v1beta
{
    ...
    public class WorkflowExecutionsService : Google.Apis.Services.BaseClientService
    {
        ...
        public WorkflowExecutionsService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public WorkflowExecutionsService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class WorkflowExecutionsBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected WorkflowExecutionsBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
            ...
            public class WorkflowsResource
            {
                ...
                public class ExecutionsResource
                {
                    ...
                    public class CancelRequest : WorkflowExecutionsBaseServiceRequest<Google.Apis.WorkflowExecutions.v1beta.Data.Execution>
                    {
                        ...
                        public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.WorkflowExecutions.v1beta.Data.CancelExecutionRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    public class CreateRequest : WorkflowExecutionsBaseServiceRequest<Google.Apis.WorkflowExecutions.v1beta.Data.Execution>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.WorkflowExecutions.v1beta.Data.Execution body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
