...
namespace Google.Apis.CloudAsset.v1
{
    ...
    public class V1Resource
    {
        ...
        public class SearchAllIamPoliciesRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1.Data.SearchAllIamPoliciesResponse>
        {
            ...
            /// specified `scope`. Examples: * `policy:amy@gmail.com` to find IAM policy bindings that specify user
            /// "amy@gmail.com". * `policy:roles/compute.admin` to find IAM policy bindings that specify the Compute
            /// Admin role. * `policy.role.permissions:storage.buckets.update` to find IAM policy bindings that specify
            /// a role containing "storage.buckets.update" permission. Note that if callers don't have `iam.roles.get`
        ...
        public class SearchAllResourcesRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1.Data.SearchAllResourcesResponse>
        {
            ...
            /// `scope`. Note that the query string is compared against each Cloud IAM policy binding, including its
            /// members, roles, and Cloud IAM conditions. The returned Cloud IAM policies will only contain the bindings
            /// that match your query. To learn more about the IAM policy structure, see [IAM policy
...
namespace Google.Apis.CloudAsset.v1.Data
{
    ...
    {
        /// <summary>
        /// Required. The uri of the Cloud Storage object. It's the same uri that is used by gsutil. For example:
        /// "gs://bucket_name/object_name". See [Quickstart: Using the gsutil tool]
    ...
    public class IamPolicySearchResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// project that contains the resource. If an IAM policy is set on a folder or orgnization, the project field
        /// will be empty. To search against the `project`: * specify the `scope` field as this project in your search
        /// request.
        /// </summary>
    ...
    public class ResourceSearchResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// One or more paragraphs of text description of this resource. Maximum length could be up to 1M bytes. To
        /// search against the `description`: * use a field query. Example: `description:"*important instance*"` * use a
        ...
        /// <summary>
        /// The display name of this resource. To search against the `display_name`: * use a field query. Example:
        ...
        /// for more information. To search against the `labels`: * use a field query: - query on any label's key or
        /// value. Example: `labels:prod` - query by a given label. Example: `labels.env:prod` - query by a given
        ...
        /// <summary>
        /// Location can be `global`, regional like `us-east1`, or zonal like `us-west1-b`. To search against the
        /// `location`: * use a field query. Example: `location:us-west*` * use a free text query. Example: `us-west*`
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("location")]
        public virtual string Location { get; set; }
        ...
        /// resources](https://cloud.google.com/blog/products/gcp/labelling-and-grouping-your-google-cloud-platform-resources)
        /// for more information. To search against the `network_tags`: * use a field query. Example:
