 ...
 *      <tr><th>API Rev<td>20200111 (1836)
 *      <tr><th>API Docs
...
namespace Google.Apis.Fitness.v1
{
    ...
    public class UsersResource
    {
        ...
        public class DataSourcesResource
        {
            ...
            /// <summary>A data source is a unique source of sensor data. Data sources can expose raw data coming from
            ...
            /// Every data point in every dataset inserted into or read from the Fitness API has an associated data
            /// source.
            ///
            ...
            ///
            /// Data sources are addressed using a string generated by the server, based on the contents of the source
            /// being created.
            ///
            /// Creates a new data source that is unique across all data sources belonging to this user. The
            /// dataStreamId field should be excluded. This will be automatically generated by the server with the
            /// correct format. If a dataStreamId is included, it must match the format that the server would generate.
