...
namespace Google.Apis.CloudControlsPartnerService.v1beta
{
    ...
    public class OrganizationsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class CustomersResource
            {
                ...
                public class WorkloadsResource
                {
                    ...
                    public class AccessApprovalRequestsResource
                    {
                        ...
                        /// workload folder.
                        /// </summary>
                        public class ListRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.ListAccessApprovalRequestsResponse>
                        {
                            ...
                            public override string RestPath => "v1beta/{+parent}/accessApprovalRequests";
                    ...
                    public class ViolationsResource
                    {
                        ...
                        /// <summary>Gets details of a single Violation.</summary>
                        public class GetRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Violation>
                        {
                        ...
                        /// `organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}`
                        /// </summary>
                        public class ListRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.ListViolationsResponse>
                        {
                            /// <summary>Constructs a new List request.</summary>
                            public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                            {
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta/{+parent}/violations";
                    ...
                    /// <summary>Gets details of a single workload</summary>
                    public class GetRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Workload>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Gets the EKM connections associated with a workload</summary>
                    public class GetEkmConnectionsRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.EkmConnections>
                    {
                    ...
                    /// <summary>Gets the partner permissions granted for a workload</summary>
                    public class GetPartnerPermissionsRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.PartnerPermissions>
                    {
                    ...
                    /// <summary>Lists customer workloads for a given customer org id</summary>
                    public class ListRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.ListWorkloadsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+parent}/workloads";
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a new customer.</summary>
                public class CreateRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/customers";
                ...
                /// <summary>Delete details of a single customer</summary>
                /// <param name="name">
                ...
                /// <summary>Delete details of a single customer</summary>
                public class DeleteRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Empty>
                {
                ...
                /// <summary>Gets details of a single customer</summary>
                public class GetRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists customers of a partner identified by its Google Cloud organization ID</summary>
                public class ListRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.ListCustomersResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// <summary>Update details of a single customer</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// Identifier. Format: `organizations/{organization}/locations/{location}/customers/{customer}`
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Update details of a single customer</summary>
                public class PatchRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudControlsPartnerService.v1beta.Data.Customer body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            /// <summary>Get details of a Partner.</summary>
            public class GetPartnerRequest : CloudControlsPartnerServiceBaseServiceRequest<Google.Apis.CloudControlsPartnerService.v1beta.Data.Partner>
            {
...
namespace Google.Apis.CloudControlsPartnerService.v1beta.Data
{
    ...
    public class Customer : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. Display name for the customer</summary>
        ...
        /// <summary>
        /// Output only. The customer organization domain, extracted from CRM Organization’s display_name field. e.g.
        /// "google.com"
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("organizationDomain")]
