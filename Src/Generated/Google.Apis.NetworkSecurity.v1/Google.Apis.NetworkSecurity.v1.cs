...
namespace Google.Apis.NetworkSecurity.v1
{
    ...
    public class NetworkSecurityService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://networksecurity.googleapis.com/";

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "";

        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://networksecurity.googleapis.com/batch";
