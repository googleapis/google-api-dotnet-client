        ...
        public class LocationsResource
        {
            ...
            public class ApisResource
            {
                ...
                public class ConfigsResource
                {
                    ...
                    public class SetIamPolicyRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayPolicy>
                    {
                        ...
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Apigateway.v1alpha1.Data.ApigatewaySetIamPolicyRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                    ...
                    public class TestIamPermissionsRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayTestIamPermissionsResponse>
                    {
                        ...
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.Apigateway.v1alpha1.Data.ApigatewayTestIamPermissionsRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Apigateway.v1alpha1.Data.ApigatewayCancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
