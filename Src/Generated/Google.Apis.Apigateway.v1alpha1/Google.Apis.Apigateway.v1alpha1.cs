...
namespace Google.Apis.Apigateway.v1alpha1
{
        ...
        public class LocationsResource
        {
            ...
            public class ApisResource
            {
                ...
                public class ConfigsResource
                {
                    ...
                    /// <summary>Gets the access control policy for a resource. Returns an empty policy if the resource
                    /// exists and does not have a policy set.</summary>
                    public class GetIamPolicyRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayPolicy>
                    {
                    ...
                    /// documentation for the appropriate value for this field.</param>
                    public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.Apigateway.v1alpha1.Data.ApigatewaySetIamPolicyRequest body, string resource)
                    {
                    ...
                    /// <summary>Sets the access control policy on the specified resource. Replaces any existing policy.
                    /// Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.</summary>
                    public class SetIamPolicyRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayPolicy>
                    {
                        /// <summary>Constructs a new SetIamPolicy request.</summary>
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Apigateway.v1alpha1.Data.ApigatewaySetIamPolicyRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                        ...
                        Google.Apis.Apigateway.v1alpha1.Data.ApigatewaySetIamPolicyRequest Body { get; set; }
                    ...
                    /// documentation for the appropriate value for this field.</param>
                    public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.Apigateway.v1alpha1.Data.ApigatewayTestIamPermissionsRequest body, string resource)
                    {
                    ...
                    /// operation is designed to be used for building permission-aware UIs and command-line tools, not
                    /// for authorization checking. This operation may "fail open" without warning.</summary>
                    public class TestIamPermissionsRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayTestIamPermissionsResponse>
                    {
                        /// <summary>Constructs a new TestIamPermissions request.</summary>
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.Apigateway.v1alpha1.Data.ApigatewayTestIamPermissionsRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Apigateway.v1alpha1.Data.ApigatewayTestIamPermissionsRequest Body { get; set; }
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.Apigateway.v1alpha1.Data.ApigatewayCancelOperationRequest body, string name)
                {
                ...
                /// operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to
                /// `Code.CANCELLED`.</summary>
                public class CancelRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Apigateway.v1alpha1.Data.ApigatewayCancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Apigateway.v1alpha1.Data.ApigatewayCancelOperationRequest Body { get; set; }
                ...
                /// interested in the operation result. It does not cancel the operation. If the server doesn't support
                /// this method, it returns `google.rpc.Code.UNIMPLEMENTED`.</summary>
                public class DeleteRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.Empty>
                {
                ...
                /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
                /// operation result at intervals as recommended by the API service.</summary>
                public class GetRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayOperation>
                {
                ...
                /// however overriding users must ensure the name binding is the parent resource, without the operations
                /// collection id.</summary>
                public class ListRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayListOperationsResponse>
                {
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayLocation>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : ApigatewayBaseServiceRequest<Google.Apis.Apigateway.v1alpha1.Data.ApigatewayListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
namespace Google.Apis.Apigateway.v1alpha1.Data
{    
