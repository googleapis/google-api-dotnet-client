...
/**
 * \brief
 *   Artifact Registry API Version v1beta1
 *
 ...
 *      <tr><th>Discovery Name<td>artifactregistry
 *    </table>
 *
 * \section ForMoreInfo For More Information
 *
 * The complete API documentation for using Artifact Registry API can be found at
 * <a href='https://cloud.google.com/artifacts/docs/'>https://cloud.google.com/artifacts/docs/</a>.
 *
...
namespace Google.Apis.ArtifactRegistry.v1beta1
{
    ...
    public class ArtifactRegistryService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://artifactregistry.googleapis.com/"; }
        #else
            get { return "https://artifactregistry.googleapis.com/"; }
        #endif
        }
        ...
        {
            get { return "https://artifactregistry.googleapis.com/batch"; }
        }
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            private readonly RepositoriesResource repositories;

            /// <summary>Gets the Repositories resource.</summary>
            public virtual RepositoriesResource Repositories
            {
            ...
            public class RepositoriesResource
            {
                ...
                private readonly PackagesResource packages;

                /// <summary>Gets the Packages resource.</summary>
                public virtual PackagesResource Packages
                {
                    get { return packages; }
                }
                ...
                public class PackagesResource
                {
                    ...
                    public class TagsResource
                    {
                        ...
                        public class CreateRequest : ArtifactRegistryBaseServiceRequest<Google.Apis.ArtifactRegistry.v1beta1.Data.Tag>
                        {
                            ...
                            public override string RestPath
                            {
                                get { return "v1beta1/{+parent}/tags"; }
                            }
                    ...
                    public class ListRequest : ArtifactRegistryBaseServiceRequest<Google.Apis.ArtifactRegistry.v1beta1.Data.ListPackagesResponse>
                    {
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+parent}/packages"; }
                        }
                ...
                public class CreateRequest : ArtifactRegistryBaseServiceRequest<Google.Apis.ArtifactRegistry.v1beta1.Data.Operation>
                {
                    ...
                    public override string RestPath
                    {
                        get { return "v1beta1/{+parent}/repositories"; }
                    }
