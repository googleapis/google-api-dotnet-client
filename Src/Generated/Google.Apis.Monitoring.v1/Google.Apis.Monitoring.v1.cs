...
namespace Google.Apis.Monitoring.v1
{
    ...
    public class OperationsResource
    {
        ...
        /// google.rpc.Code.UNIMPLEMENTED. Clients can use Operations.GetOperation or other methods to check whether the
        /// cancellation succeeded or whether the operation completed despite cancellation. On successful cancellation,
        /// the operation is not deleted; instead, it becomes an operation with an Operation.error value with a
        /// google.rpc.Status.code of 1, corresponding to Code.CANCELLED.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="name">The name of the operation resource to be cancelled.</param>
        public virtual CancelRequest Cancel(Google.Apis.Monitoring.v1.Data.CancelOperationRequest body, string name)
        {
        ...
        /// the operation is not deleted; instead, it becomes an operation with an Operation.error value with a
        /// google.rpc.Status.code of 1, corresponding to Code.CANCELLED.</summary>
        public class CancelRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v1.Data.Empty>
        {
            /// <summary>Constructs a new Cancel request.</summary>
            public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Monitoring.v1.Data.CancelOperationRequest body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
            ...
            Google.Apis.Monitoring.v1.Data.CancelOperationRequest Body { get; set; }
        ...
        /// method, it returns UNIMPLEMENTED.NOTE: the name binding allows API services to override the binding to use
        /// different resource name schemes, such as users/operations. To override the binding, API services can add a
        /// binding such as "/v1/{name=users}/operations" to their service configuration. For backwards compatibility,
        /// the default name includes the operations collection id, however overriding users must ensure the name
        ...
        /// the default name includes the operations collection id, however overriding users must ensure the name
        /// binding is the parent resource, without the operations collection id.</summary>
        public class ListRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v1.Data.ListOperationsResponse>
        {
