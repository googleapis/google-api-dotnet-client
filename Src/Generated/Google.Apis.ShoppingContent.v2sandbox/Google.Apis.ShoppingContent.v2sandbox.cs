...
namespace Google.Apis.ShoppingContent.v2sandbox
{
    ...
    public class OrderinvoicesResource
    {
        ...
        public virtual CreatechargeinvoiceRequest Createchargeinvoice(Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateChargeInvoiceRequest body, ulong merchantId, string orderId)
        {
        ...
        /// <summary>Creates a charge invoice for a shipment group, and triggers a charge capture for non-facilitated
        /// payment orders.</summary>
        public class CreatechargeinvoiceRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateChargeInvoiceResponse>
        {
            /// <summary>Constructs a new Createchargeinvoice request.</summary>
            public CreatechargeinvoiceRequest(Google.Apis.Services.IClientService service, Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateChargeInvoiceRequest body, ulong merchantId, string orderId)
                : base(service)
            {
            ...
            Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateChargeInvoiceRequest Body { get; set; }
        ...
        /// account.</param>
        /// <param name="orderId">The ID of the order.</param>
        public virtual CreaterefundinvoiceRequest Createrefundinvoice(Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateRefundInvoiceRequest body, ulong merchantId, string orderId)
        {
        ...
        public class CreaterefundinvoiceRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateRefundInvoiceResponse>
        {
            ...
            public CreaterefundinvoiceRequest(Google.Apis.Services.IClientService service, Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateRefundInvoiceRequest body, ulong merchantId, string orderId)
                : base(service)
            {
                MerchantId = merchantId;
                OrderId = orderId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.ShoppingContent.v2sandbox.Data.OrderinvoicesCreateRefundInvoiceRequest Body { get; set; }
    ...
    public class OrderpaymentsResource
    {
        ...
        /// happening.</param>
        public virtual NotifyauthapprovedRequest Notifyauthapproved(Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthApprovedRequest body, ulong merchantId, string orderId)
        {
            return new NotifyauthapprovedRequest(service, body, merchantId, orderId);
        }

        /// <summary>Notify about successfully authorizing user's payment method for a given amount.</summary>
        public class NotifyauthapprovedRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthApprovedResponse>
        {
            /// <summary>Constructs a new Notifyauthapproved request.</summary>
            public NotifyauthapprovedRequest(Google.Apis.Services.IClientService service, Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthApprovedRequest body, ulong merchantId, string orderId)
                : base(service)
            {
                MerchantId = merchantId;
                OrderId = orderId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthApprovedRequest Body { get; set; }
        ...
        /// declined.</param>
        public virtual NotifyauthdeclinedRequest Notifyauthdeclined(Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthDeclinedRequest body, ulong merchantId, string orderId)
        {
            return new NotifyauthdeclinedRequest(service, body, merchantId, orderId);
        }

        /// <summary>Notify about failure to authorize user's payment method.</summary>
        public class NotifyauthdeclinedRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthDeclinedResponse>
        {
            /// <summary>Constructs a new Notifyauthdeclined request.</summary>
            public NotifyauthdeclinedRequest(Google.Apis.Services.IClientService service, Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthDeclinedRequest body, ulong merchantId, string orderId)
                : base(service)
            {
                MerchantId = merchantId;
                OrderId = orderId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyAuthDeclinedRequest Body { get; set; }
        ...
        public virtual NotifychargeRequest Notifycharge(Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyChargeRequest body, ulong merchantId, string orderId)
        {
            return new NotifychargeRequest(service, body, merchantId, orderId);
        }

        /// <summary>Notify about charge on user's selected payments method.</summary>
        public class NotifychargeRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyChargeResponse>
        {
            /// <summary>Constructs a new Notifycharge request.</summary>
            public NotifychargeRequest(Google.Apis.Services.IClientService service, Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyChargeRequest body, ulong merchantId, string orderId)
                : base(service)
            {
                MerchantId = merchantId;
                OrderId = orderId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyChargeRequest Body { get; set; }
        ...
        /// account.</param>
        /// <param name="orderId">The ID of the order for which charge is happening.</param>
        public virtual NotifyrefundRequest Notifyrefund(Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyRefundRequest body, ulong merchantId, string orderId)
        {
            return new NotifyrefundRequest(service, body, merchantId, orderId);
        }

        /// <summary>Notify about refund on user's selected payments method.</summary>
        public class NotifyrefundRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyRefundResponse>
        {
            /// <summary>Constructs a new Notifyrefund request.</summary>
            public NotifyrefundRequest(Google.Apis.Services.IClientService service, Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyRefundRequest body, ulong merchantId, string orderId)
                : base(service)
            {
                MerchantId = merchantId;
                OrderId = orderId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.ShoppingContent.v2sandbox.Data.OrderpaymentsNotifyRefundRequest Body { get; set; }
    ...
    public class OrderreturnsResource
    {
        ...
        /// <summary>Retrieves an order return from your Merchant Center account.</summary>
        public class GetRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.MerchantOrderReturn>
        {
        ...
        /// <summary>Lists order returns in your Merchant Center account.</summary>
        public class ListRequest : ShoppingContentBaseServiceRequest<Google.Apis.ShoppingContent.v2sandbox.Data.OrderreturnsListResponse>
        {
