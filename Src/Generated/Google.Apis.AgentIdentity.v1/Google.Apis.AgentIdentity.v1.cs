        ...
        public class LocationsResource
        {
            ...
            public class AccessSummariesResource
            {
                ...
                public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.ListAccessSummariesResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/accessSummaries";
            ...
            public class AuthProvidersResource
            {
                ...
                public class AuthorizationsResource
                {
                    ...
                    public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.ListAuthorizationsResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/authorizations";
                ...
                public class CreateRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.AuthProvider>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.AuthProvider body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.AgentIdentity.v1.Data.AuthProvider Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/authProviders";
                ...
                public class DisableRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.AuthProvider>
                {
                    ...
                    public DisableRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.DisableAuthProviderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1.Data.DisableAuthProviderRequest Body { get; set; }
                ...
                public class EnableRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.AuthProvider>
                {
                    ...
                    public EnableRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.EnableAuthProviderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1.Data.EnableAuthProviderRequest Body { get; set; }
                ...
                /// does not have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.Policy>
                {
                ...
                public class PatchRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.AuthProvider>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.AuthProvider body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                public class QueryRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.QueryAuthProvidersResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/authProviders:query";
                ...
                public class QueryWorkloadsRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.QueryWorkloadsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:queryWorkloads";
                ...
                public class RevokeAuthorizationRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.RevokeAuthorizationResponse>
                {
                    ...
                    public RevokeAuthorizationRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.RevokeAuthorizationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1.Data.RevokeAuthorizationRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:revokeAuthorization";
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.AgentIdentity.v1.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
                /// </summary>
                public class SetIamPolicyRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.AgentIdentity.v1.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// checking. This operation may "fail open" without warning.
                /// </summary>
                public class TestIamPermissionsRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1.Data.TestIamPermissionsRequest Body { get; set; }
                ...
                public class UndeleteRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.AuthProvider>
                {
                    ...
                    public UndeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1.Data.UndeleteAuthProviderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1.Data.UndeleteAuthProviderRequest Body { get; set; }
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// specific service implementation and version.
            /// </summary>
            public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
