    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class JobTemplatesResource
            {
                ...
                /// <param name="parent">Required. The parent location to create this job template. Format:
                ...
                public class CreateRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.JobTemplate>
                {
                    ...
                    /// <summary>Required. The parent location to create this job template. Format:
                    /// `projects/{project}/locations/{location}`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Required. The ID to use for the job template, which will become the final component of
                    /// the job template's resource name. This value should be 4-63 characters, and valid characters
                    /// must match the regular expression `a-zA-Z*`.</summary>
                ...
                /// <param name="name">Required. The name of the job template to delete.
                /// `projects/{project}/locations/{location}/jobTemplates/{job_template}`</param>
                ...
                public class DeleteRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.Empty>
                {
                    ...
                    /// <summary>Required. The name of the job template to delete.
                    /// `projects/{project}/locations/{location}/jobTemplates/{job_template}`</summary>
                ...
                /// <param name="name">Required. The name of the job template to retrieve. Format:
                /// `projects/{project}/locations/{location}/jobTemplates/{job_template}`</param>
                ...
                public class GetRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.JobTemplate>
                {
                    ...
                    /// <summary>Required. The name of the job template to retrieve. Format:
                    /// `projects/{project}/locations/{location}/jobTemplates/{job_template}`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="parent">Required. The parent location from which to retrieve the collection of job templates. Format:
                /// `projects/{project}/locations/{location}`</param>
                ...
                public class ListRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.ListJobTemplatesResponse>
                {
                    ...
                    /// <summary>Required. The parent location from which to retrieve the collection of job templates.
            ...
            public class JobsResource
            {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Required. The parent location to create and process this job. Format:
                /// `projects/{project}/locations/{location}`</param>
                ...
                public class CreateRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.Job>
                {
                    ...
                    /// <summary>Required. The parent location to create and process this job. Format:
                    /// `projects/{project}/locations/{location}`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <param name="name">Required. The name of the job to delete. Format:
                /// `projects/{project}/locations/{location}/jobs/{job}`</param>
                public virtual DeleteRequest Delete(string name)
                {
                    return new DeleteRequest(service, name);
                }
                ...
                public class DeleteRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.Empty>
                {
                    ...
                    /// <summary>Required. The name of the job to delete. Format:
                    /// `projects/{project}/locations/{location}/jobs/{job}`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="name">Required. The name of the job to retrieve. Format:
                /// `projects/{project}/locations/{location}/jobs/{job}`</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                public class GetRequest : TranscoderBaseServiceRequest<Google.Apis.Transcoder.v1beta1.Data.Job>
                {
                    ...
                    /// <summary>Required. The name of the job to retrieve. Format:
                    /// `projects/{project}/locations/{location}/jobs/{job}`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
...
{    
    ...
    {
        /// <summary>Start time in seconds for the ad break, relative to the output file timeline. The default is
        /// `0s`.</summary>
    ...
    /// <summary>End previous overlay animation from the video. Without AnimationEnd, the overlay object will keep the
    /// state of previous animation until the end of the video.</summary>
    ...
    public class AnimationFade : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Normalized coordinates based on output video resolution. Valid values: `0.0`–`1.0`. `xy` is the
        /// upper-left coordinate of the overlay object.</summary>
    ...
    public class Audio : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Specify audio loudness normalization in loudness units relative to full scale (LUFS). Enter a value
        /// between -24 and 0, where -24 is the Advanced Television Systems Committee (ATSC A/85), -23 is the EU R128
        /// broadcast standard, -19 is the prior standard for online mono audio, -18 is the ReplayGain standard, -16 is
        /// the prior standard for stereo audio, -14 is the new online audio standard recommended by Spotify, as well as
        /// Amazon Echo, and 0 disables normalization. The default is 0.</summary>
    ...
    public class AudioAtom : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The `EditAtom.key` that references the atom with audio inputs in the
        /// `Job.edit_list`.</summary>
    ...
    public class AudioChannelInput : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Audio volume control in dB. Negative values decrease volume, positive values increase. The default
        /// is 0.</summary>
    ...
    public class AudioStream : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A list of channel names specifying layout of the audio channels. This only affects the metadata
        /// embedded in the container headers, if supported by the specified format. The default is `["fl", "fr"]`.
        /// Supported channel names: - 'fl' - Front left channel - 'fr' - Front right channel - 'sl' - Side left channel
        /// - 'sr' - Side right channel - 'fc' - Front center channel - 'lfe' - Low frequency</summary>
        ...
        /// <summary>The codec for this audio stream. The default is `"aac"`. Supported audio codecs: - 'aac' - 'aac-he'
        /// - 'aac-he-v2' - 'mp3' - 'ac3' - 'eac3'</summary>
    ...
    {
        /// <summary>Control brightness of the video. Enter a value between -1 and 1, where -1 is minimum brightness and
        /// 1 is maximum brightness. 0 is no change. The default is 0.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("brightness")]
        public virtual System.Nullable<double> Brightness { get; set; }

        /// <summary>Control black and white contrast of the video. Enter a value between -1 and 1, where -1 is minimum
        /// contrast and 1 is maximum contrast. 0 is no change. The default is 0.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("contrast")]
        public virtual System.Nullable<double> Contrast { get; set; }

        /// <summary>Control color saturation of the video. Enter a value between -1 and 1, where -1 is fully
        /// desaturated and 1 is maximum saturation. 0 is no change. The default is 0.</summary>
    ...
    public class Deblock : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Set strength of the deblocker. Enter a value between 0 and 1. The higher the value, the stronger
        /// the block removal. 0 is no deblocking. The default is 0.</summary>
    ...
    {
        /// <summary>Set strength of the denoise. Enter a value between 0 and 1. The higher the value, the smoother the
        /// image. 0 is no denoising. The default is 0.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("strength")]
        public virtual System.Nullable<double> Strength { get; set; }

        /// <summary>Set the denoiser mode. The default is `"standard"`. Supported denoiser modes: - 'standard' -
        /// 'grain'</summary>
    ...
    {
        /// <summary>End time in seconds for the atom, relative to the input file timeline. When `end_time_offset` is
        /// not specified, the `inputs` are used until the end of the atom.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endTimeOffset")]
        public virtual object EndTimeOffset { get; set; }

        /// <summary>List of `Input.key`s identifying files that should be used in this atom. The listed `inputs` must
        /// have the same timeline.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("inputs")]
        ...
        /// <summary>Start time in seconds for the atom, relative to the input file timeline. The default is
        /// `0s`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("startTimeOffset")]
        public virtual object StartTimeOffset { get; set; }
    ...
    /// <summary>Encoding of an input file such as an audio, video, or text track. Elementary streams must be packaged
    /// before mapping and sharing between different output formats.</summary>
    ...
    public class Image : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Normalized image resolution, based on output video resolution. Valid values: `0.0`–`1.0`. To
        /// respect the original image aspect ratio, set either `x` or `y` to `0.0`. To use the original image
        /// resolution, set both `x` and `y` to `0.0`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("resolution")]
        public virtual NormalizedCoordinate Resolution { get; set; }

        /// <summary>Required. URI of the image in Cloud Storage. For example,
        /// `gs://bucket/inputs/image.jpeg`.</summary>
    ...
    {
        /// <summary>A unique key for this input. Must be specified when using advanced mapping and edit
        /// lists.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("key")]
        public virtual string Key { get; set; }
        ...
        /// <summary>URI of the media. It must be stored in Cloud Storage. Example `gs://bucket/inputs/file.mp4`. If
        /// empty the value will be populated from `Job.input_uri`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uri")]
        public virtual string Uri { get; set; }
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. List of failure details. This property may contain additional information about the
        /// failure when `failure_reason` is present. *Note*: This feature is not yet available.</summary>
        ...
        /// <summary>Output only. A description of the reason for the failure. This property is always present when
        /// `state` is `FAILED`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failureReason")]
        public virtual string FailureReason { get; set; }

        /// <summary>Input only. Specify the `input_uri` to populate empty `uri` fields in each element of
        /// `Job.config.inputs` or `JobTemplate.config.inputs` when using template. URI of the media. It must be stored
        /// in Cloud Storage. For example, `gs://bucket/inputs/file.mp4`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("inputUri")]
        public virtual string InputUri { get; set; }

        /// <summary>The resource name of the job. Format:
        /// `projects/{project}/locations/{location}/jobs/{job}`</summary>
        ...
        /// <summary>Input only. Specify the `output_uri` to populate an empty `Job.config.output.uri` or
        /// `JobTemplate.config.output.uri` when using template. URI for the output file(s). For example, `gs://my-
        /// bucket/outputs/`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("outputUri")]
        public virtual string OutputUri { get; set; }

        /// <summary>Specify the priority of the job. Enter a value between 0 and 100, where 0 is the lowest priority
        /// and 100 is the highest priority. The default is 0.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("priority")]
        public virtual System.Nullable<int> Priority { get; set; }

        /// <summary>Output only. Estimated fractional progress, from `0` to `1` for each step. *Note*: This feature is
        ...
        /// <summary>Input only. Specify the `template_id` to use for populating `Job.config`. The default is `preset
        /// /web-hd`. Preset Transcoder templates: - `preset/{preset_id}` - User defined JobTemplate:
    ...
    public class JobTemplate : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the job template. Format:
        /// `projects/{project}/locations/{location}/jobTemplates/{job_template}`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    {
        /// <summary>The name of the generated file. The default is `"manifest"` with the extension suffix corresponding
        /// to the `Manifest.type`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("fileName")]
        public virtual string FileName { get; set; }

        /// <summary>Required. List of user given `MuxStream.key`s that should appear in this manifest. When
        /// `Manifest.type` is `HLS`, a media manifest with name `MuxStream.key` and `.m3u8` extension is generated for
        /// each element of the `Manifest.mux_streams`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("muxStreams")]
    ...
    {
        /// <summary>Required. 128 bit Key ID represented as lowercase hexadecimal digits for use with common
        /// encryption.</summary>
    ...
    {
        /// <summary>The container format. The default is `"mp4"` Supported container formats: - 'ts' - 'fmp4'- the
        /// corresponding file extension is `".m4s"` - 'mp4' - 'vtt'</summary>
        ...
        /// <summary>The name of the generated file. The default is `MuxStream.key` with the extension suffix
        /// corresponding to the `MuxStream.container`. Individual segments also have an incremental 10-digit zero-
        /// padded suffix starting from 0 before the extension, such as `"mux_stream0000000123.ts"`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("fileName")]
        public virtual string FileName { get; set; }

        /// <summary>A unique key for this multiplexed stream. HLS media manifests will be named `MuxStream.key` with
        /// the `".m3u8"` extension suffix.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("key")]
        public virtual string Key { get; set; }
    ...
    public class OriginUri : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>HLS manifest URI per https://tools.ietf.org/html/rfc8216#section-4.3.4. If multiple HLS manifests
        /// are created, only the first one is listed.</summary>
    ...
    {
        /// <summary>URI for the output file(s). For example, `gs://my-bucket/outputs/`. If empty the value is populated
        /// from `Job.output_uri`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uri")]
        public virtual string Uri { get; set; }
    ...
    {
        /// <summary>The name of the Pub/Sub topic to publish job completion notification to. For example:
    ...
    {
        /// <summary>The maximum number of sprites per row in a sprite sheet. The default is 0, which indicates no
        /// maximum limit.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("columnCount")]
        public virtual System.Nullable<int> ColumnCount { get; set; }

        /// <summary>End time in seconds, relative to the output file timeline. When `end_time_offset` is not specified,
        /// the sprites are generated until the end of the output file.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endTimeOffset")]
        public virtual object EndTimeOffset { get; set; }

        /// <summary>Required. File name prefix for the generated sprite sheets. Each sprite sheet has an incremental
        /// 10-digit zero-padded suffix starting from 0 before the extension, such as
        /// `"sprite_sheet0000000123.jpeg"`.</summary>
        ...
        /// <summary>Starting from `0s`, create sprites at regular intervals. Specify the interval value in
        /// seconds.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("interval")]
        public virtual object Interval { get; set; }

        /// <summary>The maximum number of rows per sprite sheet. When the sprite sheet is full, a new sprite sheet is
        /// created. The default is 0, which indicates no maximum limit.</summary>
        ...
        /// <summary>Start time in seconds, relative to the output file timeline. Determines the first sprite to pick.
        /// The default is `0s`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("startTimeOffset")]
        public virtual object StartTimeOffset { get; set; }

        /// <summary>Total number of sprites. Create the specified number of sprites distributed evenly across the
        /// timeline of the output media. The default is 100.</summary>
    ...
    public class TextAtom : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The `EditAtom.key` that references atom with text inputs in the
        /// `Job.edit_list`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("key")]
        public virtual string Key { get; set; }
    ...
    {
        /// <summary>The codec for this text stream. The default is `"webvtt"`. Supported text codecs: - 'srt' - 'ttml'
        /// - 'cea608' - 'cea708' - 'webvtt'</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("codec")]
        public virtual string Codec { get; set; }

        /// <summary>Required. The BCP-47 language code, such as `"en-US"` or `"sr-Latn"`. For more information, see
        /// https://www.unicode.org/reports/tr35/#Unicode_locale_identifier.</summary>
    ...
    {
        /// <summary>Specifies whether an open Group of Pictures (GOP) structure should be allowed or not. The default
        /// is `false`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("allowOpenGop")]
        public virtual System.Nullable<bool> AllowOpenGop { get; set; }

        /// <summary>Specify the intensity of the adaptive quantizer (AQ). Must be between 0 and 1, where 0 disables the
        ...
        /// <summary>The number of consecutive B-frames. Must be greater than or equal to zero. Must be less than
        /// `VideoStream.gop_frame_count` if set. The default is 0.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bFrameCount")]
        public virtual System.Nullable<int> BFrameCount { get; set; }

        /// <summary>Allow B-pyramid for reference frame selection. This may not be supported on all decoders. The
        ...
        /// <summary>Target CRF level. Must be between 10 and 36, where 10 is the highest quality and 36 is the most
        /// efficient compression. The default is 21.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("crfLevel")]
        public virtual System.Nullable<int> CrfLevel { get; set; }

        /// <summary>Use two-pass encoding strategy to achieve better video quality. `VideoStream.rate_control_mode`
        /// must be `"vbr"`. The default is `false`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enableTwoPass")]
        public virtual System.Nullable<bool> EnableTwoPass { get; set; }

        /// <summary>The entropy coder to use. The default is `"cabac"`. Supported entropy coders: - 'cavlc' -
        /// 'cabac'</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("entropyCoder")]
        public virtual string EntropyCoder { get; set; }

        /// <summary>Required. The target video frame rate in frames per second (FPS). Must be less than or equal to
        /// 120. Will default to the input frame rate if larger than the input frame rate. The API will generate an
        /// output FPS that is divisible by the input FPS, and smaller or equal to the target FPS. The following table
        /// shows the computed video FPS given the target FPS (in parenthesis) and input FPS (in the first column): | |
        /// (30) | (60) | (25) | (50) | |--------|--------|--------|------|------| | 240 | Fail | Fail | Fail | Fail | |
        /// 120 | 30 | 60 | 20 | 30 | | 100 | 25 | 50 | 20 | 30 | | 50 | 25 | 50 | 20 | 30 | | 60 | 30 | 60 | 20 | 30 |
        /// | 59.94 | 29.97 | 59.94 | 20 | 30 | | 48 | 24 | 48 | 20 | 30 | | 30 | 30 | 30 | 20 | 30 | | 25 | 25 | 25 |
        /// 20 | 30 | | 24 | 24 | 24 | 20 | 30 | | 23.976 | 23.976 | 23.976 | 20 | 30 | | 15 | 15 | 15 | 20 | 30 | | 12
        /// | 12 | 12 | 20 | 30 | | 10 | 10 | 10 | 20 | 30 |</summary>
        ...
        /// <summary>The height of the video in pixels. Must be an even integer. When not specified, the height is
        /// adjusted to match the specified width and input aspect ratio. If both are omitted, the input height is
        /// used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("heightPixels")]
        public virtual System.Nullable<int> HeightPixels { get; set; }

        /// <summary>Pixel format to use. The default is `"yuv420p"`. Supported pixel formats: - 'yuv420p' pixel format.
        ...
        /// 'yuv422p12' 12-bit HDR pixel format. - 'yuv444p12' 12-bit HDR pixel format.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pixelFormat")]
        public virtual string PixelFormat { get; set; }

        /// <summary>Enforces the specified codec preset. The default is `veryfast`. The available options are FFmpeg-
        /// compatible. Note that certain values for this field may cause the transcoder to override other fields you
        /// set in the `VideoStream` message.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("preset")]
        public virtual string Preset { get; set; }

        /// <summary>Enforces the specified codec profile. The following profiles are supported: * `baseline` * `main` *
        /// `high` (default) The available options are FFmpeg-compatible. Note that certain values for this field may
        /// cause the transcoder to override other fields you set in the `VideoStream` message.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("profile")]
        public virtual string Profile { get; set; }

        /// <summary>Specify the `rate_control_mode`. The default is `"vbr"`. Supported rate control modes: - 'vbr' -
        /// variable bitrate - 'crf' - constant rate factor</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("rateControlMode")]
        public virtual string RateControlMode { get; set; }

        /// <summary>Enforces the specified codec tune. The available options are FFmpeg-compatible. Note that certain
        /// values for this field may cause the transcoder to override other fields you set in the `VideoStream`
        /// message.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("tune")]
        public virtual string Tune { get; set; }

        /// <summary>Initial fullness of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero.
        /// The default is equal to 90% of `VideoStream.vbv_size_bits`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("vbvFullnessBits")]
        public virtual System.Nullable<int> VbvFullnessBits { get; set; }

        /// <summary>Size of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero. The default
        /// is equal to `VideoStream.bitrate_bps`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("vbvSizeBits")]
        public virtual System.Nullable<int> VbvSizeBits { get; set; }

        /// <summary>The width of the video in pixels. Must be an even integer. When not specified, the width is
        /// adjusted to match the specified height and input aspect ratio. If both are omitted, the input width is
        /// used.</summary>
