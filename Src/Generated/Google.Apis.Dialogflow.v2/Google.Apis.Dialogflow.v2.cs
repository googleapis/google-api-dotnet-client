    ...
    public class ProjectsResource
    {
        ...
        public class AgentResource
        {
            ...
            public class EnvironmentsResource
            {
                ...
                public class UsersResource
                {
                    ...
                    public class SessionsResource
                    {
                        ...
                        /// types to be updated, which in turn might affect results of future queries. Note: Always use
                        /// agent versions for production traffic. See [Versions and
                        /// environments](https://cloud.google.com/dialogflow/es/docs/agents-versions).</summary>
                        /// <param name="body">The body of the request.</param>
                        ...
                        /// [API interactions guide](https://cloud.google.com/dialogflow/docs/api-overview). Note: Always use agent versions for
                        /// production traffic. See [Versions and environments](https://cloud.google.com/dialogflow/es/docs/agents-
                        /// versions).</param>
            ...
            public class SessionsResource
            {
                ...
                /// which in turn might affect results of future queries. Note: Always use agent versions for production
                /// traffic. See [Versions and environments](https://cloud.google.com/dialogflow/es/docs/agents-
                /// versions).</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="session">Required. The name of the session this query is sent to. Format: `projects//agent/sessions/`,
                /// or `projects//agent/environments//users//sessions/`. If `Environment ID` is not specified, we assume default 'draft'
                ...
                public class DetectIntentRequest : DialogflowBaseServiceRequest<Google.Apis.Dialogflow.v2.Data.GoogleCloudDialogflowV2DetectIntentResponse>
                {
                    ...
                    /// overview). Note: Always use agent versions for production traffic. See [Versions and
                    /// environments](https://cloud.google.com/dialogflow/es/docs/agents-versions).</summary>
                    [Google.Apis.Util.RequestParameterAttribute("session", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Session { get; private set; }
...
{    
    ...
    public class GoogleCloudDialogflowV2QueryParameters : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// webhook along with the headers that have been configured through the Dialogflow web console. The headers
        /// defined within this field will overwrite the headers configured through the Dialogflow console if there is a
        /// conflict. Header names are case-insensitive. Google's specified headers are not allowed. Including: "Host",
        /// "Content-Length", "Connection", "From", "User-Agent", "Accept-Encoding", "If-Modified-Since", "If-None-
        /// Match", "X-Forwarded-For", etc.</summary>
