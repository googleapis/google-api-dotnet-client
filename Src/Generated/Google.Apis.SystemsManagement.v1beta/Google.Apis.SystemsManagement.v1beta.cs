...
namespace Google.Apis.SystemsManagement.v1beta
{
    ...
    public class ProjectsResource
    {
        ...
        public class GuestPoliciesResource
        {
            ...
            /// <param name="parent">Required. The resource name of the parent using one of the following forms:
            /// `projects/{project_number}`.</param>
            public virtual CreateRequest Create(Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }

            /// <summary>Create an OS Config guest policy.</summary>
            public class CreateRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Required. The resource name of the parent using one of the following forms:
                ...
                Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy Body { get; set; }
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add(
                        "guestPolicyId", new Google.Apis.Discovery.Parameter
                        {
                            Name = "guestPolicyId",
                            IsRequired = false,
                            ParameterType = "query",
            ...
            /// <summary>Delete an OS Config guest policy.</summary>
            public class DeleteRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.Empty>
            {
            ...
            /// <summary>Get an OS Config guest policy.</summary>
            public class GetRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy>
            {
            ...
            /// <summary>Get a page of OS Config guest policies.</summary>
            public class ListRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.ListGuestPoliciesResponse>
            {
                ...
                /// <summary>A pagination token returned from a previous call to `ListGuestPolicies` that indicates
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Required. Unique name of the resource in this project using one of the following forms:
            /// `projects/{project_number}/guestPolicies/{guest_policy_id}`.</param>
            public virtual PatchRequest Patch(Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy body, string name)
            {
                return new PatchRequest(service, body, name);
            }

            /// <summary>Update an OS Config guest policy.</summary>
            public class PatchRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SystemsManagement.v1beta.Data.GuestPolicy body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>Required. Unique name of the resource in this project using one of the following forms:
                /// `projects/{project_number}/guestPolicies/{guest_policy_id}`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
        ...
        public class PatchDeploymentsResource
        {
            ...
            public virtual CreateRequest Create(Google.Apis.SystemsManagement.v1beta.Data.PatchDeployment body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }

            /// <summary>Create an OS Config patch deployment.</summary>
            public class CreateRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.PatchDeployment>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SystemsManagement.v1beta.Data.PatchDeployment body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SystemsManagement.v1beta.Data.PatchDeployment Body { get; set; }
            ...
            /// <summary>Get an OS Config patch deployment.</summary>
            public class GetRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.PatchDeployment>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
            ...
            /// <summary>Get a page of OS Config patch deployments.</summary>
            public class ListRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.ListPatchDeploymentsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
        ...
        public class PatchJobsResource
        {
            ...
            public class InstanceDetailsResource
            {
                ...
                /// <summary>Get a list of instance details for a given patch job.</summary>
                public class ListRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.ListPatchJobInstanceDetailsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent)
                        : base(service)
            ...
            public virtual CancelRequest Cancel(Google.Apis.SystemsManagement.v1beta.Data.CancelPatchJobRequest body, string name)
            {
            ...
            /// <summary>Cancel a patch job. The patch job must be active. Canceled patch jobs cannot be
            /// restarted.</summary>
            public class CancelRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.PatchJob>
            {
                /// <summary>Constructs a new Cancel request.</summary>
                public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.SystemsManagement.v1beta.Data.CancelPatchJobRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SystemsManagement.v1beta.Data.CancelPatchJobRequest Body { get; set; }
            ...
            public virtual ExecuteRequest Execute(Google.Apis.SystemsManagement.v1beta.Data.ExecutePatchJobRequest body, string parent)
            {
                return new ExecuteRequest(service, body, parent);
            }

            /// <summary>Patch VM instances by creating and running a patch job.</summary>
            public class ExecuteRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.PatchJob>
            {
                /// <summary>Constructs a new Execute request.</summary>
                public ExecuteRequest(Google.Apis.Services.IClientService service, Google.Apis.SystemsManagement.v1beta.Data.ExecutePatchJobRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SystemsManagement.v1beta.Data.ExecutePatchJobRequest Body { get; set; }
            ...
            /// <summary>Get the patch job. This can be used to track the progress of an ongoing patch job or review the
            /// details of completed jobs.</summary>
            public class GetRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.PatchJob>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
            ...
            /// <summary>Get a list of patch jobs.</summary>
            public class ListRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.ListPatchJobsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
        ...
        public class ZonesResource
        {
            ...
            public class InstancesResource
            {
                ...
                /// <summary>Lookup the effective guest policy that applies to a VM instance. This lookup merges all
                /// policies that are assigned to the instance ancestry.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="instance">Required. The VM instance whose policies are being looked up.</param>
                public virtual LookupEffectiveGuestPolicyRequest LookupEffectiveGuestPolicy(Google.Apis.SystemsManagement.v1beta.Data.LookupEffectiveGuestPolicyRequest body, string instance)
                {
                ...
                /// <summary>Lookup the effective guest policy that applies to a VM instance. This lookup merges all
                /// policies that are assigned to the instance ancestry.</summary>
                public class LookupEffectiveGuestPolicyRequest : SystemsManagementBaseServiceRequest<Google.Apis.SystemsManagement.v1beta.Data.EffectiveGuestPolicy>
                {
                    /// <summary>Constructs a new LookupEffectiveGuestPolicy request.</summary>
                    public LookupEffectiveGuestPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.SystemsManagement.v1beta.Data.LookupEffectiveGuestPolicyRequest body, string instance)
                        : base(service)
                    {
                        Instance = instance;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SystemsManagement.v1beta.Data.LookupEffectiveGuestPolicyRequest Body { get; set; }
...
namespace Google.Apis.SystemsManagement.v1beta.Data
{    

    /// <summary>Represents a single Apt package repository. This repository is added to a repo file that is stored at
    /// `/etc/apt/sources.list.d/google_osconfig.list`.</summary>
    public class AptRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>URI of the key file for this repository. The agent maintains a keyring at
        /// `/etc/apt/trusted.gpg.d/osconfig_agent_managed.gpg` containing all the keys in any applied guest
        /// policy.</summary>
    ...
    {
        /// <summary>Targets instances matching at least one of these label sets. This allows an assignment to target
        /// disparate groups, for example "env=prod or env=staging".</summary>
    ...
    /// <summary>Represents a group of VM intances that can be identified as having all these labels, for example
    /// "env=prod and app=web".</summary>
    public class AssignmentGroupLabel : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Google Compute Engine instance labels that must be present for an instance to be included in this
    ...
    public class AssignmentOsType : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Targets VM instances with OS Inventory enabled and having the following OS short name, for example
        /// "debian" or "windows".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("osShortName")]
        public virtual string OsShortName { get; set; } 

        /// <summary>Targets VM instances with OS Inventory enabled and having the following following OS
        /// version.</summary>
    ...
    /// <summary>A resource that contains custom validation and enforcement steps.</summary>
    public class ExecResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>What to run to bring this resource into the desired state. Optional if policy is in validate only
        /// mode.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enforce")]
        public virtual ExecResourceExec Enforce { get; set; } 

        /// <summary>What to run to validate this resource is in the desired state. A successful exit code indicates
        /// resource is in the desired state.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("validate")]
        public virtual ExecResourceExec Validate { get; set; } 
    ...
    public class ExecResourceExec : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Exit codes that indicate success.</summary>
    ...
    /// <summary>A resource that extracts an archive</summary>
    public class ExtractArchiveResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Local file path that signals this resource is in the desired state. The absence of this file will
        /// indicate whether the archive needs to be extracted.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("creates")]
        public virtual string Creates { get; set; } 

        /// <summary>Directory to extract archive to.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("destination")]
        public virtual string Destination { get; set; } 

        /// <summary>Whether to overwrite existing files during extraction. If this is set to true, any existing files
        /// in the destination location will be overwritten by the extraction.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("overwrite")]
        public virtual System.Nullable<bool> Overwrite { get; set; } 

        /// <summary>The source archive to extract.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual File Source { get; set; } 

        /// <summary>The type of the archive to extract.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("type")]
        public virtual string Type { get; set; } 
    ...
    public class File : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A GCS object.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("gcs")]
        public virtual FileGcs Gcs { get; set; } 

        /// <summary>A local path to use.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("localPath")]
        public virtual string LocalPath { get; set; } 

        /// <summary>A generic remote file.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("remote")]
        public virtual FileRemote Remote { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    /// <summary>Specifies a file available as a GCS Object.</summary>
    public class FileGcs : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Bucket of the GCS object.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bucket")]
        public virtual string Bucket { get; set; } 

        /// <summary>Generation number of the GCS object.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("generation")]
        public virtual System.Nullable<long> Generation { get; set; } 

        /// <summary>Name of the GCS object.</summary>
    ...
    public class FileRemote : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>URI from which to fetch the object. It should contain both the protocol and path following the
        /// format {protocol}://{location}.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uri")]
        public virtual string Uri { get; set; } 
    ...
    public class FileResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A a file with this content.</summary>
        ...
        /// <summary>The absolute path of the file.</summary>
        ...
        /// <summary>Desired state of the file.</summary>
    ...
    /// <summary>Represents a Goo package repository. These is added to a repo file that is stored at
    /// C:/ProgramData/GooGet/repos/google_osconfig.repo.</summary>
    ...
    /// <summary>An OS Config resource representing a guest configuration policy. These policies represent the desired
    /// state for VM instance guest environments including packages to install or remove, package repository
    /// configurations, and software to install.</summary>
    public class GuestPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The etag for this guest policy. If this is provided on update, it must match the server's
        /// etag.</summary>
        ...
        /// <summary>A list of package repositories to configure on the VM instance. This is done before any other
        /// configs are applied so they can use these repos. Package repositories are only configured if the
        /// corresponding package manager(s) are available.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("packageRepositories")]
    ...
    {
        /// <summary>Architecture of OS running on the instance. The OS Config agent only provides this field for
        /// targeting if OS Inventory is enabled for that instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("osArchitecture")]
        public virtual string OsArchitecture { get; set; } 

        /// <summary>Short name of the OS running on the instance. The OS Config agent only provides this field for
        /// targeting if OS Inventory is enabled for that instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("osShortName")]
        public virtual string OsShortName { get; set; } 

        /// <summary>Version of the OS running on the instance. The OS Config agent only provides this field for
        /// targeting if OS Inventory is enabled for that VM instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("osVersion")]
        public virtual string OsVersion { get; set; } 
    ...
    public class Package : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The name of the package. A package is uniquely identified for conflict validation by
        /// checking the package name and the manager(s) that the package targets.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    public class PackageResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A package managed by Apt.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("apt")]
        public virtual PackageResourceAPT Apt { get; set; } 

        /// <summary>A deb package file.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("deb")]
        public virtual PackageResourceDeb Deb { get; set; } 
        ...
        public virtual PackageResourceGooGet Googet { get; set; } 

        /// <summary>An MSI package.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("msi")]
        public virtual PackageResourceMSI Msi { get; set; } 

        /// <summary>An rpm package file.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("rpm")]
        public virtual PackageResourceRPM Rpm { get; set; } 

        /// <summary>A package managed by YUM.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("yum")]
        public virtual PackageResourceYUM Yum { get; set; } 

        /// <summary>A package managed by Zypper.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("zypper")]
        public virtual PackageResourceZypper Zypper { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    /// <summary>A package managed by APT. install: `apt-get update && apt-get -y install [name]` remove: `apt-get -y
    /// remove [name]`</summary>
    public class PackageResourceAPT : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class PackageResourceDeb : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Whether dependencies should also be installed. install when false: `dpkg -i package` install when
        /// true: `apt-get update && apt-get -y install package.deb`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pullDeps")]
        public virtual System.Nullable<bool> PullDeps { get; set; } 

        /// <summary>A deb package.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual File Source { get; set; } 
    ...
    /// <summary>A package managed by GooGet. install: `googet -noconfirm install package` remove: `googet -noconfirm
    /// remove package`</summary>
    public class PackageResourceGooGet : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Package name.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    /// <summary>An MSI package. MSI packages only support INSTALLED state. Install msiexec /i /qn /norestart</summary>
    public class PackageResourceMSI : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Return codes that indicate that the software installed or updated successfully. Behaviour defaults
        /// to [0]</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("allowedSuccessCodes")]
        public virtual System.Collections.Generic.IList<System.Nullable<int>> AllowedSuccessCodes { get; set; } 

        /// <summary>Flags to use during package install. Appended to the defalts of "/i /qn /norestart"</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("flags")]
        public virtual System.Collections.Generic.IList<string> Flags { get; set; } 

        /// <summary>The MSI package.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual File Source { get; set; } 
    ...
    public class PackageResourceRPM : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Whether dependencies should also be installed. install when false: `rpm --upgrade --replacepkgs
        /// package.rpm` install when true: `yum -y install package.rpm` or `zypper -y install package.rpm`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pullDeps")]
        public virtual System.Nullable<bool> PullDeps { get; set; } 

        /// <summary>An rpm package.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual File Source { get; set; } 
    ...
    public class PackageResourceYUM : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Package name.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    /// <summary>A package managed by Zypper. install: `zypper -y install package` remove: `zypper -y rm
    /// package`</summary>
    public class PackageResourceZypper : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Package name.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    public class RepositoryResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>An Apt Repository.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("apt")]
        public virtual RepositoryResourceAptRepository Apt { get; set; } 

        /// <summary>A Goo Repository.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("goo")]
        public virtual RepositoryResourceGooRepository Goo { get; set; } 

        /// <summary>A Yum Repository.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("yum")]
        public virtual RepositoryResourceYumRepository Yum { get; set; } 

        /// <summary>A Zypper Repository.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("zypper")]
        public virtual RepositoryResourceZypperRepository Zypper { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    /// <summary>Represents a single apt package repository. These will be added to a repo file that will be managed at
    /// /etc/apt/sources.list.d/google_osconfig.list.</summary>
    public class RepositoryResourceAptRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Type of archive files in this repository. The default behavior is DEB.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("archiveType")]
        public virtual string ArchiveType { get; set; } 
        ...
        /// <summary>URI of the key file for this repository. The agent will maintain a keyring at
        /// /etc/apt/trusted.gpg.d/osconfig_agent_managed.gpg.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("gpgKey")]
        public virtual string GpgKey { get; set; } 

        /// <summary>URI for this repository.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uri")]
        public virtual string Uri { get; set; } 
    ...
    /// <summary>Represents a Goo package repository. These will be added to a repo file that will be managed at
    /// C:/ProgramData/GooGet/repos/google_osconfig.repo.</summary>
    public class RepositoryResourceGooRepository : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// <summary>Represents a single yum package repository. These will be added to a repo file that will be managed at
    /// /etc/yum.repos.d/google_osconfig.repo.</summary>
    public class RepositoryResourceYumRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A one word, unique name for this repository. This will be the `repo id` in the yum config file and
        /// also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when
        /// checking for resource conflicts.</summary>
    ...
    /// <summary>Represents a single zypper package repository. These will be added to a repo file that will be managed
    /// at /etc/zypp/repos.d/google_osconfig.repo.</summary>
    public class RepositoryResourceZypperRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The location of the repository directory.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("baseUrl")]
        public virtual string BaseUrl { get; set; } 
        ...
        /// <summary>A one word, unique name for this repository. This will be the `repo id` in the zypper config file
        /// and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when
        /// checking for GuestPolicy conflicts.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
    ...
    /// <summary>A resource that manages a system service.</summary>
    public class ServiceResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    
    ...
    public class SoftwareRecipe : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Actions to be taken for installing this recipe. On failure it stops executing steps and does not
        /// attempt another installation. Any steps taken (including partially completed steps) are not rolled
        /// back.</summary>
        ...
        /// <summary>The version of this software recipe. Version can be up to 4 period separated numbers (e.g.
        /// 12.34.56.78).</summary>
    ...
    public class SoftwareRecipeArtifact : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. Id of the artifact, which the installation and update steps of this recipe can reference.
        /// Artifacts in a recipe cannot have the same id.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
    ...
    {
        /// <summary>Bucket of the Google Cloud Storage object. Given an example URL: `https://storage.googleapis.com
        /// /my-bucket/foo/bar#1234567` this value would be `my-bucket`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bucket")]
        public virtual string Bucket { get; set; } 

        /// <summary>Must be provided if allow_insecure is false. Generation number of the Google Cloud Storage object.
        /// `https://storage.googleapis.com/my-bucket/foo/bar#1234567` this value would be `1234567`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("generation")]
        public virtual System.Nullable<long> Generation { get; set; } 

        /// <summary>Name of the Google Cloud Storage object. As specified [here]
        /// (https://cloud.google.com/storage/docs/naming#objectnames) Given an example URL:
        /// `https://storage.googleapis.com/my-bucket/foo/bar#1234567` this value would be `foo/bar`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("object")]
        public virtual string Object__ { get; set; } 
    ...
    {
        /// <summary>Must be provided if `allow_insecure` is `false`. SHA256 checksum in hex format, to compare to the
        /// checksum of the artifact. If the checksum is not empty and it doesn't match the artifact then the recipe
        /// installation fails before running any of the steps.</summary>
    ...
    public class SoftwareRecipeStepCopyFile : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Whether to allow this step to overwrite existing files. If this is false and the file already
        /// exists the file is not overwritten and the step is considered a success. Defaults to false.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("overwrite")]
        public virtual System.Nullable<bool> Overwrite { get; set; } 
    ...
    {
        /// <summary>Defaults to [0]. A list of possible return values that the program can return to indicate a
        /// success.</summary>
    ...
    public class SoftwareRecipeStepRunScript : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The script interpreter to use to run the script. If no interpreter is specified the script is
        /// executed directly, which likely only succeed for scripts with [shebang
        /// lines](https://en.wikipedia.org/wiki/Shebang_\(Unix\)).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("interpreter")]
        public virtual string Interpreter { get; set; } 
    ...
    /// <summary>Represents a single Yum package repository. This repository is added to a repo file that is stored at
    /// `/etc/yum.repos.d/google_osconfig.repo`.</summary>
    public class YumRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. A one word, unique name for this repository. This is the `repo id` in the Yum config file
        /// and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when
        /// checking for guest policy conflicts.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
    ...
    /// <summary>Represents a single Zypper package repository. This repository is added to a repo file that is stored
    /// at `/etc/zypp/repos.d/google_osconfig.repo`.</summary>
    public class ZypperRepository : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. A one word, unique name for this repository. This is the `repo id` in the zypper config
        /// file and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier
        /// when checking for guest policy conflicts.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
