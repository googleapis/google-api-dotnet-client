...
/**
 * \brief
 *   Accelerated Mobile Page (AMP) URL API Version v1
 *
 * \section ApiInfo API Version Information
 *    <table>
 *      <tr><th>API
 *          <td><a href='https://developers.google.com/amp/cache/'>Accelerated Mobile Page (AMP) URL API</a>
 ...
 *
 * The complete API documentation for using Accelerated Mobile Page (AMP) URL API can be found at
