    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.FirebaseDataConnect.v1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.FirebaseDataConnect.v1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Empty>
                {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Operation>
                {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.ListOperationsResponse>
                {
            ...
            public class ServicesResource
            {
                ...
                public class ConnectorsResource
                {
                    ...
                    public virtual CreateRequest Create(Google.Apis.FirebaseDataConnect.v1.Data.Connector body, string parent)
                    {
                    ...
                    /// or if the schema is not present, this will result in an error.
                    /// </summary>
                    public class CreateRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.Connector body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.FirebaseDataConnect.v1.Data.Connector Body { get; set; }
                    ...
                    /// <summary>Deletes a single Connector.</summary>
                    public class DeleteRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Delete request.</summary>
                        public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// ```
                    /// </param>
                    public virtual ExecuteMutationRequest ExecuteMutation(Google.Apis.FirebaseDataConnect.v1.Data.ExecuteMutationRequest body, string name)
                    {
                        return new ExecuteMutationRequest(this.service, body, name);
                    }

                    /// <summary>Execute a predefined mutation in a Connector.</summary>
                    public class ExecuteMutationRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.ExecuteMutationResponse>
                    {
                        /// <summary>Constructs a new ExecuteMutation request.</summary>
                        public ExecuteMutationRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.ExecuteMutationRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.FirebaseDataConnect.v1.Data.ExecuteMutationRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:executeMutation";
                    ...
                    /// ```
                    /// </param>
                    public virtual ExecuteQueryRequest ExecuteQuery(Google.Apis.FirebaseDataConnect.v1.Data.ExecuteQueryRequest body, string name)
                    {
                        return new ExecuteQueryRequest(this.service, body, name);
                    }

                    /// <summary>Execute a predefined query in a Connector.</summary>
                    public class ExecuteQueryRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.ExecuteQueryResponse>
                    {
                        /// <summary>Constructs a new ExecuteQuery request.</summary>
                        public ExecuteQueryRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.ExecuteQueryRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.FirebaseDataConnect.v1.Data.ExecuteQueryRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:executeQuery";
                    ...
                    /// <summary>Gets details of a single Connector.</summary>
                    public class GetRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Connector>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists Connectors in a given project and location.</summary>
                    public class ListRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.ListConnectorsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                    ...
                    /// ```
                    /// </param>
                    public virtual PatchRequest Patch(Google.Apis.FirebaseDataConnect.v1.Data.Connector body, string name)
                    {
                    ...
                    /// will result in an error.
                    /// </summary>
                    public class PatchRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Operation>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.Connector body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                ...
                public class SchemasResource
                {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">Required. Value for parent.</param>
                    public virtual CreateRequest Create(Google.Apis.FirebaseDataConnect.v1.Data.Schema body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.Schema body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.FirebaseDataConnect.v1.Data.Schema Body { get; set; }
                    ...
                    /// <summary>Gets details of a single Schema.</summary>
                    public class GetRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Schema>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// this will always return at most one Schema.
                    /// </summary>
                    public class ListRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.ListSchemasResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                    ...
                    /// </param>
                    public virtual PatchRequest Patch(Google.Apis.FirebaseDataConnect.v1.Data.Schema body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.Schema body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Required. Value of parent.</param>
                public virtual CreateRequest Create(Google.Apis.FirebaseDataConnect.v1.Data.Service body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.Service body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.FirebaseDataConnect.v1.Data.Service Body { get; set; }
                ...
                /// ```
                /// </param>
                public virtual ExecuteGraphqlRequest ExecuteGraphql(Google.Apis.FirebaseDataConnect.v1.Data.GraphqlRequest body, string name)
                {
                ...
                /// explore the generated GraphQL schema.
                /// </summary>
                public class ExecuteGraphqlRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.GraphqlResponse>
                {
                    /// <summary>Constructs a new ExecuteGraphql request.</summary>
                    public ExecuteGraphqlRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.GraphqlRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:executeGraphql";
                ...
                /// ```
                /// </param>
                public virtual ExecuteGraphqlReadRequest ExecuteGraphqlRead(Google.Apis.FirebaseDataConnect.v1.Data.GraphqlRequest body, string name)
                {
                ...
                /// only accepts read-only query.
                /// </summary>
                public class ExecuteGraphqlReadRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.GraphqlResponse>
                {
                    /// <summary>Constructs a new ExecuteGraphqlRead request.</summary>
                    public ExecuteGraphqlReadRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.GraphqlRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:executeGraphqlRead";
                ...
                /// <summary>Gets details of a single Service.</summary>
                public class GetRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Service>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists Services in a given project and location.</summary>
                public class ListRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.ListServicesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1.Data.Service body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
namespace Google.Apis.FirebaseDataConnect.v1.Data
{
    ...
    public class PostgreSql : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. Ephemeral is true if this data connect service is served from in-memory emulation of Postgres.
        /// Data Connect service will transfer the data on a best-effort basis to the Cloud SQL instance once it's
        /// provisioned and linked. WARNING: When `ephemeral=true`, mutations to the database are not guaranteed to be
        /// durably persisted, even if an OK status code is returned. All or parts of the data may be lost or reverted
        /// to earlier versions.
        /// </summary>
