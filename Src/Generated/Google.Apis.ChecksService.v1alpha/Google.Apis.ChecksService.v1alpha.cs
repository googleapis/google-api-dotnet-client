...
namespace Google.Apis.ChecksService.v1alpha
{
    ...
    public class PrivacypolicyResource
    {
        ...
        /// <summary>
        /// Performs a synchronous analysis of a privacy policy, where the policy content is mapped to privacy
        /// categories, data types, and purposes.
        /// </summary>
        /// <param name="body">The body of the request.</param>
        ...
        public class PrivacypolicyResource
        {
            ...
            public class OperationsResource
            {
                ...
                public class ListRequest : ChecksServiceBaseServiceRequest<Google.Apis.ChecksService.v1alpha.Data.ListOperationsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+name}/privacypolicy/operations";
...
{
    /// <summary>Request for the AnalyzePrivacyPolicy method.</summary>
    public class AnalyzePrivacyPolicyRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// The HTML content of the privacy policy. This is useful if you'd like to manage the crawling and rendering of
        /// the privacy policy.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("privacyPolicyPageContent")]
        public virtual string PrivacyPolicyPageContent { get; set; }

        /// <summary>The URI that points to the web page for the privacy policy.</summary>
    ...
    /// <summary>Response containing the analyzed privacy policy for the AnalyzePrivacyPolicy method.</summary>
    public class AnalyzePrivacyPolicyResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A list of detected purposes in the privacy policy.</summary>
        ...
        /// <summary>A list of detected data types in the privacy policy.</summary>
        ...
        /// <summary>
        /// HTML content for the privacy policy page. The byte offsets in each annotated section will match this
        /// content.
        /// </summary>
        ...
        /// <summary>A list of detected topics in the privacy policy.</summary>
    ...
    /// <summary>Response containing the analyzed privacy policy for the FindPrivacyPolicy method.</summary>
    ...
    public class PolicySectionAnnotation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Detected type of the high-level topic in the policy.</summary>
        ...
        /// <summary>Actual text content in the section.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("textContent")]
        public virtual string TextContent { get; set; }
