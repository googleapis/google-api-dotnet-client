...
namespace Google.Apis.Slides.v1
{
    ...
    public class SlidesService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://slides.googleapis.com/";
...
namespace Google.Apis.Slides.v1.Data
{
    ...
    public class LineConnection : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// be found in the description of the "cnx" attribute in section 20.1.9.9 and Annex H. "Predefined DrawingML
        /// Shape and Text Geometries" of "Office Open XML File Formats-Fundamentals and Markup Language Reference",
