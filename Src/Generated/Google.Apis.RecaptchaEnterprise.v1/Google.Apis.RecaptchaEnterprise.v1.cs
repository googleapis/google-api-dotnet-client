...
namespace Google.Apis.RecaptchaEnterprise.v1.Data
{
    ...
    public class GoogleCloudRecaptchaenterpriseV1ChallengeRule : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. A CEL condition that must be met for this rule to apply. If unspecified, the rule applies
        /// unconditionally. The following fields can be referenced in the condition: * `score` * `user_ip_address` *
        /// `user_asn` * `user_agent` * `verified_bots.name` * `verified_bots.bot_type` Examples: * `score &amp;lt; 0.5`
        /// * `user_ip_address == "123.45.67.89"` * `user_agent.contains("Chrome")` * `score &amp;lt; 0.5
    ...
    /// <summary>Details on a phone authentication event</summary>
    public class GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Required. Phone number in E.164 format for which a multi-factor authentication challenge was initiated,
        /// succeeded, or failed.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("phoneNumber")]
        public virtual string PhoneNumber { get; set; }
    ...
    {
        /// <summary>
        /// Required. Action name to be used for token generation for this endpoint. The action name can only contain
    ...
    public class GoogleCloudRecaptchaenterpriseV1TokenProperties : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. Indicates whether the provided user response token is valid. If `false`, the token is invalid,
        /// either because the user failed the challenge or for a reason provided in the `invalid_reason` field.
        /// </summary>
