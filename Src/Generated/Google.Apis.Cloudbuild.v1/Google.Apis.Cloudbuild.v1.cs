...
{    
    ...
    /// run on the source), and what tag to apply to the built image when it is pushed to Google Container
    /// Registry.</summary>
    public class Build : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Time at whihc execution of the build was finished. @OutputOnly</summary>
