...
namespace Google.Apis.Kmsinventory.v1
{
    ...
    public class KmsinventoryService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://kmsinventory.googleapis.com/";

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "";

        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://kmsinventory.googleapis.com/batch";
    ...
    public class OrganizationsResource
    {
        ...
        public class ProtectedResourcesResource
        {
            ...
            {
                return new SearchRequest(service, scope);
            }
        ...
        public class LocationsResource
        {
            ...
            public class KeyRingsResource
            {
                ...
                public class CryptoKeysResource
                {
                    ...
                    {
                        return new GetProtectedResourcesSummaryRequest(service, name);
                    }
...
namespace Google.Apis.Kmsinventory.v1.Data
{
    ...
    public class GoogleCloudKmsInventoryV1ProtectedResource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// used to protect this resource via CMEK. This field may be empty if the Cloud product owning the resource
        /// does not provide key version data to Asset Inventory.
        /// </summary>
