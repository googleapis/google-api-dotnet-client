...
{    
    ...
    public class Company : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Whether the company's badge authority is in AWN</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("badgeAuthorityInAwn")]
        public virtual System.Nullable<bool> BadgeAuthorityInAwn { get; set; } 
    ...
    {
        /// <summary>Whether or not the user has opted to share their Academy for Ads info with Google
        /// Partners.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("afaInfoShared")]
        public virtual System.Nullable<bool> AfaInfoShared { get; set; } 
