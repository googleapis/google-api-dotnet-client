    ...
    public class ProjectsResource
    {
        ...
        public class ZonesResource
        {
            ...
            public class ClustersResource
            {
                ...
                /// instances, plus a Kubernetes master endpoint. By default, the cluster is created in the project's
                /// [default network](/compute/docs/networking#networks_1). One firewall is added for the cluster. After
                /// cluster creation, the cluster creates routes for each node to allow the containers on that node to
                /// communicate with all other instances in the cluster. Finally, an entry is added to the project's
                /// global metadata indicating which CIDR range is being used by the cluster.</summary>
                ...
                /// routes that were configured during cluster creation are also deleted.</summary>
                /// <param name="projectId">The Google Developers Console [project ID or project
                /// number](https://developers.google.com/console/help/new/#projectnumber).</param>
                /// <param name="zone">The name
                /// of the Google Compute Engine [zone](/compute/docs/zones#available) in which the cluster resides.</param>
                ///
                /// <param name="clusterId">The name of the cluster to delete.</param>
                ...
                /// <summary>Gets a specific cluster.</summary>
                /// <param name="projectId">The Google Developers Console [project ID or project
                /// number](https://developers.google.com/console/help/new/#projectnumber).</param>
                /// <param name="zone">The name
                /// of the Google Compute Engine [zone](/compute/docs/zones#available) in which the cluster resides.</param>
                ///
                /// <param name="clusterId">The name of the cluster to retrieve.</param>
                ...
                /// number](https://developers.google.com/console/help/new/#projectnumber).</param>
                /// <param name="zone">The name
                /// of the Google Compute Engine [zone](/compute/docs/zones#available) in which the cluster resides, or "-" for all
                /// zones.</param>
                ...
                /// <summary>Update settings of a specific cluster.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="projectId">The Google Developers Console [project ID or project
                /// number](https://developers.google.com/console/help/new/#projectnumber).</param>
                /// <param name="zone">The name
                /// of the Google Compute Engine [zone](/compute/docs/zones#available) in which the cluster resides.</param>
                ///
                /// <param name="clusterId">The name of the cluster to upgrade.</param>
            ...
            public class OperationsResource
            {
                ...
                /// number](https://developers.google.com/console/help/new/#projectnumber).</param>
                /// <param name="zone">The name
                /// of the Google Compute Engine [zone](/compute/docs/zones#available) to return operations for, or "-" for all
                /// zones.</param>
                public virtual ListRequest List(string projectId, string zone)
                {
                    return new ListRequest(service, projectId, zone);
...
{    
    ...
    public class Cluster : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// different versions because they're in the process of being upgraded, this reflects the minimum version of
        /// any of them.</summary>
        ...
        /// <summary>[Output only] The IP address of this cluster's Kubernetes master endpoint. The endpoint can be
        /// accessed from the internet at `https://username:password@endpoint/`. See the `masterAuth` property of this
        /// resource for username and password information.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endpoint")]
        public virtual string Endpoint { get; set; } 

        /// <summary>[Output only] The software version of Kubernetes master and kubelets used in the cluster when it
        ...
        /// quota](/compute/docs/resource-quotas) is sufficient for this number of instances. You must also have
        /// available firewall and routes quota.</summary>
        ...
        /// <summary>The logging service that the cluster should write logs to. Currently available options: *
        /// "logging.googleapis.com" - the Google Cloud Logging service * "none" - no logs will be exported from the
        /// cluster * "" - default value; the default is "logging.googleapis.com"</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("loggingService")]
        public virtual string LoggingService { get; set; } 

        /// <summary>The authentication information for accessing the master.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("masterAuth")]
        public virtual MasterAuth MasterAuth { get; set; } 

        /// <summary>The monitoring service that the cluster should write metrics to. Currently available options: *
        /// "monitoring.googleapis.com" - the Google Cloud Monitoring service * "none" - no metrics will be exported
        /// from the cluster * "" - default value; the default is "monitoring.googleapis.com"</summary>
        ...
        /// <summary>The name of the Google Compute Engine [network](/compute/docs/networking#networks_1) to which the
        /// cluster is connected. If left unspecified, the "default" network will be used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("network")]
        public virtual string Network { get; set; } 

        /// <summary>Parameters used in creating the cluster's nodes. See the descriptions of the child properties of
        /// `nodeConfig`. If unspecified, the defaults for all child properties are used.</summary>
    ...
    /// <summary>ClusterUpdate describes an update to the cluster.</summary>
    ...
    public class MasterAuth : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Because the master endpoint is open to the internet, you should create a strong password.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("password")]
        public virtual string Password { get; set; } 

        /// <summary>The username to use for HTTP basic authentication when accessing the Kubernetes master
        /// endpoint.</summary>
    ...
    /// <summary>Per-node parameters.</summary>
    public class NodeConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `https://www.googleapis.com/auth/devstorage.read_only` is required for communicating with *gcr.io*. If
        /// unspecified, no scopes are added.</summary>
    ...
    /// <summary>Defines the operation resource. All fields are output only.</summary>
    ...
    /// <summary>Container Engine Server configuration.</summary>
    public class ServerConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>What version this server deploys by default.</summary>
    ...
    /// <summary>UpdateClusterRequest updates a cluster.</summary>
