...
namespace Google.Apis.Container.v1.Data
{
    ...
    public class ClusterUpdate : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// custom image. NOTE: Set the "desired_node_pool" field as well.
        /// </summary>
    ...
    /// <summary>Represents an arbitrary window of time that recurs. Will replace RecurringTimeWindow.</summary>
    public class RecurringMaintenanceWindow : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. Specifies the date before which will not be scheduled. Depending on the recurrence, this may be
        /// the date the first window appears. Days are measured in the UTC timezone. This setting must be used when
        ...
        /// <summary>
        /// Required. An RRULE (https://tools.ietf.org/html/rfc5545#section-3.8.5.3) for how this window recurs. For
    ...
    {
        /// <summary>
        /// An RRULE (https://tools.ietf.org/html/rfc5545#section-3.8.5.3) for how this window recurs. They go on for
