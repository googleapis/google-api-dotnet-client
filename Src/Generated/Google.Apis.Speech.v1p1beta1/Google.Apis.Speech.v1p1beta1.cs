...
namespace Google.Apis.Speech.v1p1beta1
{
    ...
    public class OperationsResource
    {
        ...
        public class GetRequest : SpeechBaseServiceRequest<Google.Apis.Speech.v1p1beta1.Data.Operation>
        {
            ...
            public override string RestPath => "v1p1beta1/operations/{+name}";
        ...
        public class ListRequest : SpeechBaseServiceRequest<Google.Apis.Speech.v1p1beta1.Data.ListOperationsResponse>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1p1beta1/operations";
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public class ListRequest : SpeechBaseServiceRequest<Google.Apis.Speech.v1p1beta1.Data.ListOperationsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1p1beta1/{+name}/operations";
    ...
    public class SpeechResource
    {
        ...
        public class LongrunningrecognizeRequest : SpeechBaseServiceRequest<Google.Apis.Speech.v1p1beta1.Data.Operation>
        {
            ...
            public LongrunningrecognizeRequest(Google.Apis.Services.IClientService service, Google.Apis.Speech.v1p1beta1.Data.LongRunningRecognizeRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1p1beta1/speech:longrunningrecognize";
        ...
        public class RecognizeRequest : SpeechBaseServiceRequest<Google.Apis.Speech.v1p1beta1.Data.RecognizeResponse>
        {
            ...
            public RecognizeRequest(Google.Apis.Services.IClientService service, Google.Apis.Speech.v1p1beta1.Data.RecognizeRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1p1beta1/speech:recognize";
...
{    
    ...
    public class RecognitionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Search use cases and performance may vary for other use cases (e.g., phone call transcription).</summary>
        ...
        /// <summary>If set, specifies the estimated number of speakers in the conversation. Defaults to '2'. Ignored
        /// unless enable_speaker_diarization is set to true. Note: Use diarization_config instead.</summary>
        ...
        /// <summary>The spoken emoji behavior for the call If not set, uses default behavior based on model of choice
        /// If 'true', adds spoken emoji formatting for the request. This will replace spoken emojis with the
        /// corresponding Unicode symbols in the final transcript. If 'false', spoken emojis are not replaced.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enableSpokenEmojis")]
        public virtual System.Nullable<bool> EnableSpokenEmojis { get; set; }

        /// <summary>The spoken punctuation behavior for the call If not set, uses default behavior based on model of
        /// choice e.g. command_and_search will enable spoken punctuation by default If 'true', replaces spoken
        /// punctuation with the corresponding symbols in the request. For example, "how are you question mark" becomes
        /// "how are you?". See https://cloud.google.com/speech-to-text/docs/spoken-punctuation for support. If 'false',
        /// spoken punctuation is not replaced.</summary>
        ...
        /// <summary>If `true`, the top result includes a list of words and the confidence for those words. If `false`,
        /// no word-level confidence information is returned. The default is `false`.</summary>
    ...
    public class SpeechContext : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// recognition as well. Negative boost values would correspond to anti-biasing. Anti-biasing is not enabled, so
        /// negative boost will simply be ignored. Though `boost` can accept a wide range of positive values, most use
        /// cases are best served with values between 0 and 20. We recommend using a binary search approach to finding
        /// the optimal value for your use case.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("boost")]
        public virtual System.Nullable<float> Boost { get; set; }
