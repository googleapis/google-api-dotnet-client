...
namespace Google.Apis.Speech.v1p1beta1.Data
{
    ...
    public class RecognitionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// If set, specifies the estimated number of speakers in the conversation. Defaults to '2'. Ignored unless
        /// enable_speaker_diarization is set to true. Note: Use diarization_config instead.
        /// </summary>
