...
namespace Google.Apis.Merchant.ordertracking_v1
{
    ...
    public class AccountsResource
    {
        ...
        public class OrderTrackingSignalsResource
        {
            ...
            /// </param>
            public virtual CreateRequest Create(Google.Apis.Merchant.ordertracking_v1.Data.OrderTrackingSignal body, string parent)
            {
                return new CreateRequest(this.service, body, parent);
            }

            /// <summary>Creates new order tracking signal.</summary>
            public class CreateRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.ordertracking_v1.Data.OrderTrackingSignal>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.ordertracking_v1.Data.OrderTrackingSignal body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.Merchant.ordertracking_v1.Data.OrderTrackingSignal Body { get; set; }
                ...
                public override string RestPath => "ordertracking/v1/{+parent}/orderTrackingSignals";
...
namespace Google.Apis.Merchant.ordertracking_v1.Data
{
    /// <summary>
