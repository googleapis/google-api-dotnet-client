...
namespace Google.Apis.Games.v1
{
    ...
    public class GamesService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://www.googleapis.com/games/v1/"; }
        #else
    ...
    public class PlayersResource
    {
        ...
        public class ListRequest : GamesBaseServiceRequest<Google.Apis.Games.v1.Data.PlayerListResponse>
        {
            ...
            public enum CollectionEnum
            {
                /// <summary>(DEPRECATED) Retrieve a list of players that are also playing this game in reverse
                ...
                FriendsAll,
                /// <summary>(DEPRECATED) Retrieve a list of players you have played a multiplayer game (realtime or
                /// turn-based) with recently.</summary>
                [Google.Apis.Util.StringValueAttribute("played_with")]
                PlayedWith,
                /// <summary>(DEPRECATED: please use FRIENDS_ALL) Retrieve a list of players in the user's social graph
                /// that are visible to this game.</summary>
