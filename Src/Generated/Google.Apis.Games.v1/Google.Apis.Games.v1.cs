...
namespace Google.Apis.Games.v1
{
    ...
    public class GamesService : Google.Apis.Services.BaseClientService
    {
        ...
        public GamesService(Google.Apis.Services.BaseClientService.Initializer initializer) : base(initializer)
        {
            ...
            BaseUri = GetEffectiveUri(BaseUriOverride, "https://games.googleapis.com/");
            BatchUri = GetEffectiveUri(null, "https://games.googleapis.com/batch");
        }
...
namespace Google.Apis.Games.v1.Data
{
    ...
    /// <summary>Request message for PlayerGameEvents.BatchRecordEvents Next ID: 7</summary>
    public class BatchRecordEventsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. The DroidGuard blob generated by the client. This is used to detect abuse signals from the devices
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("droidGuardBlob")]
        ...
        public virtual System.Collections.Generic.IList<PlayerGameEvent> Events { get; set; }

        /// <summary>Required. Application package name (e.g., "com.example.game").</summary>
        ...
        /// <summary>Required. The time from the client when this specific batch of events was submitted.</summary>
        ...
        /// <summary>
        /// Optional. The salt used to generate content binding for the DroidGuard blob. This is used to prevent replay
        /// attacks.
        /// </summary>
    ...
    /// <summary>A successful response indicates that the batch of events has been processed.</summary>
    public class BatchRecordEventsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failedRequests")]
        public virtual System.Collections.Generic.IDictionary<string, Status> FailedRequests { get; set; }
    ...
    /// <summary>
    /// A representation of a single player game event triggered by a player's event in a game. This might be completing
    /// a level, unlocking an item, or finishing a match.
    /// </summary>
    public class PlayerGameEvent : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. A unique client-generated UUID for this specific event instance. Used for server-side idempotency
        /// and deduplication. Submitting an event with a previously recorded event_id for the same player will be
        /// ignored.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("eventId")]
        public virtual string EventId { get; set; }
        ...
        /// <summary>
        /// Required. Client-defined name of the event (e.g., "run_completed", "level_up"). Maximum length: 100
        /// characters.
        /// </summary>
        ...
        /// <summary>
        /// Optional. Key-value properties providing details about the event. - Maximum number of properties: 25. -
        /// Property key maximum length: 100 characters. - String values within PropertyValue maximum length: 1024
        /// characters.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("eventProperties")]
        public virtual System.Collections.Generic.IDictionary<string, PropertyValue> EventProperties { get; set; }

        private string _eventTimeRaw;

        private object _eventTime;

        /// <summary>Required. The time from the client when this specific event was performed.</summary>
    ...
    /// <summary>Wrapper for the value.</summary>
