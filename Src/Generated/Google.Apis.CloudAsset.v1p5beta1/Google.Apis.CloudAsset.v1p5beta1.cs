...
namespace Google.Apis.CloudAsset.v1p5beta1
{
    ...
    public class CloudAssetService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "v1p5beta1";
    ...
    public class AssetsResource
    {
        ...
        /// <param name="parent">Required. Name of the organization or project the assets belong to. Format: "organizations
        /// /[organization-number]" (such as "organizations/123"), "projects/[project-number]" (such as "projects/my-project-
        /// id"), or "projects/[project-id]" (such as "projects/12345").</param>
        ...
        /// <summary>Lists assets with time and resource types and returns paged results in response.</summary>
        public class ListRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p5beta1.Data.ListAssetsResponse>
        {
            ...
            /// <summary>Required. Name of the organization or project the assets belong to. Format: "organizations
            /// /[organization-number]" (such as "organizations/123"), "projects/[project-number]" (such as "projects
            /// /my-project-id"), or "projects/[project-id]" (such as "projects/12345").</summary>
            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Parent { get; private set; }

            /// <summary>A list of asset types to take a snapshot for. For example: "compute.googleapis.com/Disk".
            /// Regular expression is also supported. For example: * "compute.googleapis.com.*" snapshots resources
            ...
            /// <summary>The maximum number of assets to be returned in a single response. Default is 100, minimum is 1,
            /// and maximum is 1000.</summary>
            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<int> PageSize { get; set; }

            /// <summary>The `next_page_token` returned from the previous `ListAssetsResponse`, or unspecified for the
            /// first `ListAssetsRequest`. It is a continuation of a prior `ListAssets` call, and the API should return
            /// the next page of assets.</summary>
            [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string PageToken { get; set; }

            /// <summary>Timestamp to take an asset snapshot. This can only be set to a timestamp between the current
            /// time and the current time minus 35 days (inclusive). If not specified, the current time will be used.
            /// Due to delays in resource data collection and indexing, there is a volatile window during which running
            /// the same query may get different results.</summary>
            ...
            public override string RestPath => "v1p5beta1/{+parent}/assets";
