...
namespace Google.Apis.Merchant.notifications_v1
{
    ...
    public class AccountsResource
    {
        ...
        public class NotificationsubscriptionsResource
        {
            ...
            /// </param>
            public virtual CreateRequest Create(Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription body, string parent)
            {
            ...
            /// account.
            /// </summary>
            public class CreateRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription Body { get; set; }
                ...
                public override string RestPath => "notifications/v1/{+parent}/notificationsubscriptions";
            ...
            /// <summary>Deletes a notification subscription for a merchant.</summary>
            public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.notifications_v1.Data.Empty>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "notifications/v1/{+name}";
            ...
            /// <summary>Gets notification subscriptions for an account.</summary>
            public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription>
            {
            ...
            /// <summary>Gets all the notification subscriptions for a merchant.</summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.notifications_v1.Data.ListNotificationSubscriptionsResponse>
            {
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription body, string name)
            {
                return new PatchRequest(this.service, body, name);
            }

            /// <summary>Updates an existing notification subscription for a merchant.</summary>
            public class PatchRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.notifications_v1.Data.NotificationSubscription body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
...
namespace Google.Apis.Merchant.notifications_v1.Data
{
    /// <summary>
