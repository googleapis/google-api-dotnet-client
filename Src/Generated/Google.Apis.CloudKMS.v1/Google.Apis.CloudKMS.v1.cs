...
namespace Google.Apis.CloudKMS.v1.Data
{
    ...
    public class KeyAccessJustificationsPolicyConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. Indicates whether this parent resource is available to default policy feature. Please consult
        /// [the prerequisite of default policy
        /// feature](https://cloud.google.com/assured-workloads/key-access-justifications/docs/set-default-policy#before)
        /// for more details.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("defaultPolicyAvailable")]
        public virtual System.Nullable<bool> DefaultPolicyAvailable { get; set; }
    ...
    public class SingleTenantHsmInstance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// only be set at creation time. Key portability features are disabled by default.
        /// </summary>
