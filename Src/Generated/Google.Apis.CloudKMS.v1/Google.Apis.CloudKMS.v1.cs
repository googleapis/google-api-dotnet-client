...
namespace Google.Apis.CloudKMS.v1
{
    ...
    public class CloudKMSService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scope constants for use with the Cloud Key Management Service (KMS) API.</summary>
            ...
            public class KeyRingsResource
            {
                ...
                public class CryptoKeysResource
                {
                    ...
                    public class CryptoKeyVersionsResource
                    {
                        ...
                        /// <summary>Decrypts data that was encrypted with a public key retrieved from GetPublicKey
                        /// corresponding to a CryptoKeyVersion with CryptoKey.purpose ASYMMETRIC_DECRYPT.</summary>
                        ...
                        public class AsymmetricDecryptRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1.Data.AsymmetricDecryptResponse>
                        {
                            ...
                            public AsymmetricDecryptRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1.Data.AsymmetricDecryptRequest body, string name)
                                : base(service)
                            {
                                Name = name;
                                Body = body;
                            ...
                            /// <summary>Required. The resource name of the CryptoKeyVersion to use for
                            /// decryption.</summary>
                        ...
                        /// <summary>Signs data using a CryptoKeyVersion with CryptoKey.purpose ASYMMETRIC_SIGN,
                        /// producing a signature that can be verified with the public key retrieved from
                        /// GetPublicKey.</summary>
                        /// <param name="body">The body of the request.</param>
                        ...
                        public class AsymmetricSignRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1.Data.AsymmetricSignResponse>
                        {
                            ...
                            public AsymmetricSignRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1.Data.AsymmetricSignRequest body, string name)
                                : base(service)
                            {
                                Name = name;
                                Body = body;
                        ...
                        /// <summary>Returns the public key for the given CryptoKeyVersion. The CryptoKey.purpose must
                        /// be ASYMMETRIC_SIGN or ASYMMETRIC_DECRYPT.</summary>
                        ...
                        public class GetPublicKeyRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1.Data.PublicKey>
                        {
                            ...
                            public GetPublicKeyRequest(Google.Apis.Services.IClientService service, string name)
                                : base(service)
                            {
                                Name = name;
                                InitParameters();
                        ...
                        public class ImportRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1.Data.CryptoKeyVersion>
                        {
                            ...
                            public ImportRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1.Data.ImportCryptoKeyVersionRequest body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                        ...
                        public class ListRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1.Data.ListCryptoKeyVersionsResponse>
                        {
                            ...
                            /// <summary>Optional. Optional limit on the number of CryptoKeyVersions to include in the
                            ...
                            /// <summary>Optional. Optional pagination token, returned earlier via
                    ...
                    /// <summary>Decrypts data that was protected by Encrypt. The CryptoKey.purpose must be
                ...
                public class ImportJobsResource
                {
                    ...
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1.Data.ImportJob body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                        ...
                        protected override void InitParameters()
                        {
                            ...
                            RequestParameters.Add(
                                "importJobId", new Google.Apis.Discovery.Parameter
                                {
                                    Name = "importJobId",
                                    IsRequired = false,
                                    ParameterType = "query",
                    ...
                    public class ListRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1.Data.ListImportJobsResponse>
                    {
                        ...
                        /// <summary>Optional. Optional limit on the number of ImportJobs to include in the response.
...
{    
    ...
    /// <summary>A CryptoKeyVersionTemplate specifies the properties to use when creating a new CryptoKeyVersion, either
    ...
    /// <summary>ExternalProtectionLevelOptions stores a group of additional fields for configuring a CryptoKeyVersion
    /// that are specific to the EXTERNAL protection level.</summary>
    ...
    /// <summary>Contains an HSM-generated attestation about a key operation. For more information, see [Verifying
    ...
    /// <summary>The public key component of the wrapping key. For details of the type of key this public key
    /// corresponds to, see the ImportMethod.</summary>
