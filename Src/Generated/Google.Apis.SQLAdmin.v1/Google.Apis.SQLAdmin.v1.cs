...
namespace Google.Apis.SQLAdmin.v1
{
    ...
    public class BackupsResource
    {
        ...
        /// </param>
        public virtual CreateBackupRequest CreateBackup(Google.Apis.SQLAdmin.v1.Data.Backup body, string parent)
        {
        ...
        /// Creates a backup for a Cloud SQL instance. This API can be used only to create on-demand backups.
        /// </summary>
        public class CreateBackupRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new CreateBackup request.</summary>
            public CreateBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.Backup body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
            ...
            Google.Apis.SQLAdmin.v1.Data.Backup Body { get; set; }
        ...
        /// <summary>Deletes the backup.</summary>
        public class DeleteBackupRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
        ...
        /// <summary>Retrieves a resource containing information about a backup.</summary>
        public class GetBackupRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Backup>
        {
        ...
        /// <summary>Lists all backups associated with the project.</summary>
        public class ListBackupsRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.ListBackupsResponse>
        {
        ...
        /// </param>
        public virtual UpdateBackupRequest UpdateBackup(Google.Apis.SQLAdmin.v1.Data.Backup body, string name)
        {
        ...
        public class UpdateBackupRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            public UpdateBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.Backup body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
    ...
    public class BackupRunsResource
    {
        ...
        /// <summary>Deletes the backup taken by a backup run.</summary>
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/backupRuns/{id}";
        ...
        /// <summary>Retrieves a resource containing information about a backup run.</summary>
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.BackupRun>
        {
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual InsertRequest Insert(Google.Apis.SQLAdmin.v1.Data.BackupRun body, string project, string instance)
        {
            return new InsertRequest(this.service, body, project, instance);
        }

        /// <summary>Creates a new backup run on demand.</summary>
        public class InsertRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.BackupRun body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.BackupRun Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/backupRuns";
        ...
        /// chronological order of the backup initiation time.
        /// </summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.BackupRunsListResponse>
        {
    ...
    public class BlueGreenDeploymentsResource
    {
        ...
        /// <summary>Creates a blue-green deployment under a given project and location.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="parent">
        /// Required. The parent resource where this blue-green deployment will be created. Format:
        /// projects/{project}/locations/{location}
        /// </param>
        public virtual CreateRequest Create(Google.Apis.SQLAdmin.v1.Data.BlueGreenDeployment body, string parent)
        {
            return new CreateRequest(this.service, body, parent);
        }

        /// <summary>Creates a blue-green deployment under a given project and location.</summary>
        public class CreateRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.BlueGreenDeployment body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
            ...
            /// deployment's resource name. The ID must be unique within the given project and location and between 2-63
            /// characters.
            /// </summary>
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.BlueGreenDeployment Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/{+parent}/blueGreenDeployments";
        ...
        /// <summary>Deletes a blue-green deployment.</summary>
        /// <param name="name">
        ...
        /// <summary>Retrieves a blue-green deployment resource under a given project and location.</summary>
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.BlueGreenDeployment>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists blue-green deployments under a given project.</summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.ListBlueGreenDeploymentsResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>
            /// Optional. The maximum number of deployments to return. The service may return fewer deployments than
            /// this value. If unspecified, at most 500 deployments are returned. The maximum value is 1000; values
            /// above 1000 are treated as 1000.
            /// </summary>
            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<int> PageSize { get; set; }
        ...
        /// projects/{project}/locations/{location}/blueGreenDeployments/{blue_green_deployment}
        /// </param>
        public virtual SwitchoverRequest Switchover(Google.Apis.SQLAdmin.v1.Data.SwitchoverBlueGreenDeploymentRequest body, string name)
        {
        ...
        public class SwitchoverRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            public SwitchoverRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SwitchoverBlueGreenDeploymentRequest body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.SwitchoverBlueGreenDeploymentRequest Body { get; set; }
    ...
    public class ConnectResource
    {
        ...
        /// <summary>Retrieves connect settings about a Cloud SQL instance.</summary>
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.ConnectSettings>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Retrieves connect settings about a Cloud SQL instance using the instance DNS name.</summary>
        public class ResolveRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.ConnectSettings>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/locations/{location}/dns/{dnsName}:resolveConnectSettings";
    ...
    public class DatabasesResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/databases/{database}";
        ...
        /// <summary>Retrieves a resource containing information about a database inside a Cloud SQL instance.</summary>
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Database>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Database instance ID. This does not include the project ID.</param>
        public virtual InsertRequest Insert(Google.Apis.SQLAdmin.v1.Data.Database body, string project, string instance)
        {
            return new InsertRequest(this.service, body, project, instance);
        }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.Database body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.Database Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/databases";
        ...
        /// <summary>Lists databases in the specified Cloud SQL instance.</summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.DatabasesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string instance) : base(service)
            {
        ...
        public virtual PatchRequest Patch(Google.Apis.SQLAdmin.v1.Data.Database body, string project, string instance, string database)
        {
        ...
        public class PatchRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.Database body, string project, string instance, string database) : base(service)
            {
                Project = project;
                Instance = instance;
                Database = database;
        ...
        /// <param name="instance">Database instance ID. This does not include the project ID.</param>
        /// <param name="database">Name of the database to be updated in the instance.</param>
        public virtual UpdateRequest Update(Google.Apis.SQLAdmin.v1.Data.Database body, string project, string instance, string database)
        {
            return new UpdateRequest(this.service, body, project, instance, database);
        }

        /// <summary>Updates a resource containing information about a database inside a Cloud SQL instance.</summary>
        public class UpdateRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.Database body, string project, string instance, string database) : base(service)
            {
                Project = project;
                Instance = instance;
                Database = database;
    ...
    public class FlagsResource
    {
        ...
        /// <summary>Lists all available database flags for Cloud SQL instances.</summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.FlagsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/flags";
    ...
    public class InstancesResource
    {
        ...
        /// to sign a certificate, and a certificate that has been rotated out.
        /// </summary>
        public class ListEntraIdCertificatesRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.InstancesListEntraIdCertificatesResponse>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/listEntraIdCertificates";
        ...
        /// <param name="project">Required. Project ID of the project that contains the instance.</param>
        /// <param name="instance">Required. Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual RotateEntraIdCertificateRequest RotateEntraIdCertificate(Google.Apis.SQLAdmin.v1.Data.InstancesRotateEntraIdCertificateRequest body, string project, string instance)
        {
        ...
        /// Rotates the server certificate version to one previously added with the addEntraIdCertificate method.
        /// </summary>
        public class RotateEntraIdCertificateRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new RotateEntraIdCertificate request.</summary>
            public RotateEntraIdCertificateRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesRotateEntraIdCertificateRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesRotateEntraIdCertificateRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/rotateEntraIdCertificate";
        ...
        /// (Example: instance-id).
        /// </param>
        public virtual AcquireSsrsLeaseRequest AcquireSsrsLease(Google.Apis.SQLAdmin.v1.Data.InstancesAcquireSsrsLeaseRequest body, string project, string instance)
        {
            return new AcquireSsrsLeaseRequest(this.service, body, project, instance);
        }

        /// <summary>Acquire a lease for the setup of SQL Server Reporting Services (SSRS).</summary>
        public class AcquireSsrsLeaseRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SqlInstancesAcquireSsrsLeaseResponse>
        {
            /// <summary>Constructs a new AcquireSsrsLease request.</summary>
            public AcquireSsrsLeaseRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesAcquireSsrsLeaseRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Required. Project ID of the project that contains the instance (Example: project-id).</summary>
            [Google.Apis.Util.RequestParameterAttribute("project", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Project { get; private set; }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesAcquireSsrsLeaseRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/acquireSsrsLease";
        ...
        /// add a new server certificate.
        /// </summary>
        public class AddServerCaRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
        ...
        /// </summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Required. Project ID of the source Cloud SQL instance.</param>
        /// <param name="instance">
        ...
        /// instance to restart.
        /// </summary>
        public class CloneRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Clone request.</summary>
            public CloneRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesCloneRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Required. Project ID of the source Cloud SQL instance.</summary>
            [Google.Apis.Util.RequestParameterAttribute("project", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Project { get; private set; }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesCloneRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/clone";
        ...
        /// </summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Required. ID of the project that contains the instance.</param>
        /// <param name="instance">Required. Cloud SQL instance name.</param>
        public virtual DemoteRequest Demote(Google.Apis.SQLAdmin.v1.Data.InstancesDemoteRequest body, string project, string instance)
        {
        ...
        /// Demotes an existing standalone instance to be a Cloud SQL read replica for an external database server.
        /// </summary>
        public class DemoteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Demote request.</summary>
            public DemoteRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesDemoteRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Required. ID of the project that contains the instance.</summary>
            [Google.Apis.Util.RequestParameterAttribute("project", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Project { get; private set; }

            /// <summary>Required. Cloud SQL instance name.</summary>
            [Google.Apis.Util.RequestParameterAttribute("instance", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Instance { get; private set; }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesDemoteRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/demote";
        ...
        public virtual DemoteMasterRequest DemoteMaster(Google.Apis.SQLAdmin.v1.Data.InstancesDemoteMasterRequest body, string project, string instance)
        {
        ...
        /// Demotes the stand-alone instance to be a Cloud SQL read replica for an external database server.
        /// </summary>
        public class DemoteMasterRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new DemoteMaster request.</summary>
            public DemoteMasterRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesDemoteMasterRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesDemoteMasterRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/demoteMaster";
        ...
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual ExportRequest Export(Google.Apis.SQLAdmin.v1.Data.InstancesExportRequest body, string project, string instance)
        {
        ...
        /// Exports data from a Cloud SQL instance to a Cloud Storage bucket as a SQL dump or CSV file.
        /// </summary>
        public class ExportRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Export request.</summary>
            public ExportRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesExportRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesExportRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/export";
        ...
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual FailoverRequest Failover(Google.Apis.SQLAdmin.v1.Data.InstancesFailoverRequest body, string project, string instance)
        {
        ...
        /// replica instance.
        /// </summary>
        public class FailoverRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Failover request.</summary>
            public FailoverRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesFailoverRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesFailoverRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/failover";
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual ImportRequest Import(Google.Apis.SQLAdmin.v1.Data.InstancesImportRequest body, string project, string instance)
        {
            return new ImportRequest(this.service, body, project, instance);
        }

        /// <summary>Imports data into a Cloud SQL instance from a SQL dump or CSV file in Cloud Storage.</summary>
        public class ImportRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Import request.</summary>
            public ImportRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesImportRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesImportRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/import";
        ...
        /// </param>
        public virtual InsertRequest Insert(Google.Apis.SQLAdmin.v1.Data.DatabaseInstance body, string project)
        {
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.DatabaseInstance body, string project) : base(service)
            {
                Project = project;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.DatabaseInstance Body { get; set; }
        ...
        /// but not yet used to sign a certificate, and a CA used to sign a certificate that has previously rotated out.
        /// </summary>
        public class ListServerCasRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.InstancesListServerCasResponse>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/listServerCas";
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual PatchRequest Patch(Google.Apis.SQLAdmin.v1.Data.DatabaseInstance body, string project, string instance)
        {
        ...
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.DatabaseInstance body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
        ...
        /// <param name="project">Required. Project ID of the project that contains the instance.</param>
        /// <param name="instance">Required. Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual PreCheckMajorVersionUpgradeRequest PreCheckMajorVersionUpgrade(Google.Apis.SQLAdmin.v1.Data.InstancesPreCheckMajorVersionUpgradeRequest body, string project, string instance)
        {
            return new PreCheckMajorVersionUpgradeRequest(this.service, body, project, instance);
        }

        /// <summary>Execute MVU Pre-checks</summary>
        public class PreCheckMajorVersionUpgradeRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new PreCheckMajorVersionUpgrade request.</summary>
            public PreCheckMajorVersionUpgradeRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesPreCheckMajorVersionUpgradeRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesPreCheckMajorVersionUpgradeRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/preCheckMajorVersionUpgrade";
        ...
        /// might cause your instance to restart.
        /// </summary>
        public class PromoteReplicaRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/promoteReplica";
        ...
        /// <param name="project">ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual ReencryptRequest Reencrypt(Google.Apis.SQLAdmin.v1.Data.InstancesReencryptRequest body, string project, string instance)
        {
            return new ReencryptRequest(this.service, body, project, instance);
        }

        /// <summary>Reencrypt CMEK instance with latest key version.</summary>
        public class ReencryptRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Reencrypt request.</summary>
            public ReencryptRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesReencryptRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesReencryptRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/reencrypt";
        ...
        /// <param name="project">Required. The project ID that contains the instance.</param>
        /// <param name="instance">
        /// Required. The Cloud SQL instance ID. This doesn't include the project ID. The instance ID contains lowercase
        /// letters, numbers, and hyphens, and it must start with a letter. This ID can have a maximum length of 98
        /// characters.
        /// </param>
        ...
        /// <summary>Release a lease for the setup of SQL Server Reporting Services (SSRS).</summary>
        public class ReleaseSsrsLeaseRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SqlInstancesReleaseSsrsLeaseResponse>
        {
            ...
            /// <summary>Required. The project ID that contains the instance.</summary>
            [Google.Apis.Util.RequestParameterAttribute("project", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Project { get; private set; }

            /// <summary>
            /// Required. The Cloud SQL instance ID. This doesn't include the project ID. The instance ID contains
            /// lowercase letters, numbers, and hyphens, and it must start with a letter. This ID can have a maximum
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/releaseSsrsLease";
        ...
        /// Deletes all client certificates and generates a new server SSL certificate for the instance.
        /// </summary>
        public class ResetSslConfigRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/resetSslConfig";
        ...
        /// <summary>Restarts a Cloud SQL instance.</summary>
        public class RestartRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/restart";
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual RestoreBackupRequest RestoreBackup(Google.Apis.SQLAdmin.v1.Data.InstancesRestoreBackupRequest body, string project, string instance)
        {
        ...
        /// Restores a backup of a Cloud SQL instance. Using this operation might cause your instance to restart.
        /// </summary>
        public class RestoreBackupRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new RestoreBackup request.</summary>
            public RestoreBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesRestoreBackupRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesRestoreBackupRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/restoreBackup";
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual RotateServerCaRequest RotateServerCa(Google.Apis.SQLAdmin.v1.Data.InstancesRotateServerCaRequest body, string project, string instance)
        {
        ...
        /// use RotateServerCertificate to rotate the server certificate.
        /// </summary>
        public class RotateServerCaRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new RotateServerCa request.</summary>
            public RotateServerCaRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesRotateServerCaRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesRotateServerCaRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/rotateServerCa";
        ...
        /// <summary>Starts the replication in the read replica instance.</summary>
        public class StartReplicaRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/startReplica";
        ...
        /// <summary>Stops the replication in the read replica instance.</summary>
        public class StopReplicaRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/stopReplica";
        ...
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual TruncateLogRequest TruncateLog(Google.Apis.SQLAdmin.v1.Data.InstancesTruncateLogRequest body, string project, string instance)
        {
            return new TruncateLogRequest(this.service, body, project, instance);
        }

        /// <summary>Truncate MySQL general and slow query log tables MySQL only.</summary>
        public class TruncateLogRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new TruncateLog request.</summary>
            public TruncateLogRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.InstancesTruncateLogRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.InstancesTruncateLogRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/truncateLog";
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual UpdateRequest Update(Google.Apis.SQLAdmin.v1.Data.DatabaseInstance body, string project, string instance)
        {
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.DatabaseInstance body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
    ...
    public class OperationsResource
    {
        ...
        /// <summary>Retrieves an instance operation that has been performed on an instance.</summary>
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/operations/{operation}";
        ...
        /// chronological order of the start time.
        /// </summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.OperationsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/operations";
    ...
    public class ProjectsResource
    {
        ...
        public class InstancesResource
        {
            ...
            /// <summary>Get Disk Shrink Config for a given instance.</summary>
            public class GetDiskShrinkConfigRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SqlInstancesGetDiskShrinkConfigResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/projects/{project}/instances/{instance}/getDiskShrinkConfig";
            ...
            /// <param name="project">Project ID of the project that contains the instance.</param>
            /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
            public virtual PerformDiskShrinkRequest PerformDiskShrink(Google.Apis.SQLAdmin.v1.Data.PerformDiskShrinkContext body, string project, string instance)
            {
                return new PerformDiskShrinkRequest(this.service, body, project, instance);
            }

            /// <summary>Perform Disk Shrink on primary instance.</summary>
            public class PerformDiskShrinkRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
            {
                /// <summary>Constructs a new PerformDiskShrink request.</summary>
                public PerformDiskShrinkRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.PerformDiskShrinkContext body, string project, string instance) : base(service)
                {
                    Project = project;
                    Instance = instance;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SQLAdmin.v1.Data.PerformDiskShrinkContext Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/projects/{project}/instances/{instance}/performDiskShrink";
            ...
            /// <param name="project">ID of the project that contains the instance.</param>
            /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
            public virtual RescheduleMaintenanceRequest RescheduleMaintenance(Google.Apis.SQLAdmin.v1.Data.SqlInstancesRescheduleMaintenanceRequestBody body, string project, string instance)
            {
                return new RescheduleMaintenanceRequest(this.service, body, project, instance);
            }

            /// <summary>Reschedules the maintenance on the given instance.</summary>
            public class RescheduleMaintenanceRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
            {
                /// <summary>Constructs a new RescheduleMaintenance request.</summary>
                public RescheduleMaintenanceRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlInstancesRescheduleMaintenanceRequestBody body, string project, string instance) : base(service)
                {
                    Project = project;
                    Instance = instance;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SQLAdmin.v1.Data.SqlInstancesRescheduleMaintenanceRequestBody Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/projects/{project}/instances/{instance}/rescheduleMaintenance";
            ...
            /// <param name="project">ID of the project that contains the read replica.</param>
            /// <param name="instance">Cloud SQL read replica instance name.</param>
            public virtual ResetReplicaSizeRequest ResetReplicaSize(Google.Apis.SQLAdmin.v1.Data.SqlInstancesResetReplicaSizeRequest body, string project, string instance)
            {
                return new ResetReplicaSizeRequest(this.service, body, project, instance);
            }

            /// <summary>Reset Replica Size to primary instance disk size.</summary>
            public class ResetReplicaSizeRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
            {
                /// <summary>Constructs a new ResetReplicaSize request.</summary>
                public ResetReplicaSizeRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlInstancesResetReplicaSizeRequest body, string project, string instance) : base(service)
                {
                    Project = project;
                    Instance = instance;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SQLAdmin.v1.Data.SqlInstancesResetReplicaSizeRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/projects/{project}/instances/{instance}/resetReplicaSize";
            ...
            /// <param name="project">ID of the project that contains the instance.</param>
            /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
            public virtual StartExternalSyncRequest StartExternalSync(Google.Apis.SQLAdmin.v1.Data.SqlInstancesStartExternalSyncRequest body, string project, string instance)
            {
                return new StartExternalSyncRequest(this.service, body, project, instance);
            }

            /// <summary>Start External primary instance migration.</summary>
            public class StartExternalSyncRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
            {
                /// <summary>Constructs a new StartExternalSync request.</summary>
                public StartExternalSyncRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlInstancesStartExternalSyncRequest body, string project, string instance) : base(service)
                {
                    Project = project;
                    Instance = instance;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SQLAdmin.v1.Data.SqlInstancesStartExternalSyncRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/projects/{project}/instances/{instance}/startExternalSync";
            ...
            /// <param name="project">Project ID of the project that contains the instance.</param>
            /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
            public virtual VerifyExternalSyncSettingsRequest VerifyExternalSyncSettings(Google.Apis.SQLAdmin.v1.Data.SqlInstancesVerifyExternalSyncSettingsRequest body, string project, string instance)
            {
                return new VerifyExternalSyncSettingsRequest(this.service, body, project, instance);
            }

            /// <summary>Verify External primary instance external sync settings.</summary>
            public class VerifyExternalSyncSettingsRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SqlInstancesVerifyExternalSyncSettingsResponse>
            {
                /// <summary>Constructs a new VerifyExternalSyncSettings request.</summary>
                public VerifyExternalSyncSettingsRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlInstancesVerifyExternalSyncSettingsRequest body, string project, string instance) : base(service)
                {
                    Project = project;
                    Instance = instance;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.SQLAdmin.v1.Data.SqlInstancesVerifyExternalSyncSettingsRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/projects/{project}/instances/{instance}/verifyExternalSyncSettings";
    ...
    public class SslCertsResource
    {
        ...
        /// <param name="project">Project ID of the Cloud SQL project.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual CreateEphemeralRequest CreateEphemeral(Google.Apis.SQLAdmin.v1.Data.SslCertsCreateEphemeralRequest body, string project, string instance)
        {
        ...
        /// to the database.
        /// </summary>
        public class CreateEphemeralRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SslCert>
        {
            /// <summary>Constructs a new CreateEphemeral request.</summary>
            public CreateEphemeralRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SslCertsCreateEphemeralRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/sslCerts/{sha1Fingerprint}";
        ...
        /// key must be saved from the response to initial creation.
        /// </summary>
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SslCert>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual InsertRequest Insert(Google.Apis.SQLAdmin.v1.Data.SslCertsInsertRequest body, string project, string instance)
        {
            return new InsertRequest(this.service, body, project, instance);
        }
        ...
        /// new certificate will not be usable until the instance is restarted.
        /// </summary>
        public class InsertRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SslCertsInsertResponse>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SslCertsInsertRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.SslCertsInsertRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/sslCerts";
        ...
        /// <summary>Lists all of the current SSL certificates for the instance.</summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.SslCertsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string instance) : base(service)
            {
    ...
    public class TiersResource
    {
        ...
        /// information, see https://cloud.google.com/sql/pricing.
        /// </summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.TiersListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/tiers";
    ...
    public class UsersResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/users";
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Database instance ID. This does not include the project ID.</param>
        public virtual InsertRequest Insert(Google.Apis.SQLAdmin.v1.Data.User body, string project, string instance)
        {
            return new InsertRequest(this.service, body, project, instance);
        }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.User body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
        ...
        /// <summary>Lists users in the specified Cloud SQL instance.</summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.UsersListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string instance) : base(service)
            {
        ...
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Database instance ID. This does not include the project ID.</param>
        public virtual UpdateRequest Update(Google.Apis.SQLAdmin.v1.Data.User body, string project, string instance)
        {
            return new UpdateRequest(this.service, body, project, instance);
        }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.User body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
    ...
    public class WorkloadCapturesResource
    {
        ...
        /// <summary>Lists all captured workloads associated with the instance.</summary>
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.WorkloadCapturesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string instance) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/workloadCaptures";
        ...
        /// <param name="project">Required. Project ID of the project that contains the instance.</param>
        /// <param name="instance">Required. Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual StartRequest Start(Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStartRequest body, string project, string instance)
        {
        ...
        /// applying them to production.
        /// </summary>
        public class StartRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Start request.</summary>
            public StartRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStartRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStartRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/workloadCaptures:start";
        ...
        public virtual StartReplayRequest StartReplay(Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStartReplayRequest body, string project, string instance, string workloadId)
        {
        ...
        /// target instance simulates the production environment without affecting the primary instance.
        /// </summary>
        public class StartReplayRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new StartReplay request.</summary>
            public StartReplayRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStartReplayRequest body, string project, string instance, string workloadId) : base(service)
            {
                Project = project;
                Instance = instance;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStartReplayRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:startReplay";
        ...
        /// <param name="project">Required. Project ID of the project that contains the instance.</param>
        /// <param name="instance">Required. Cloud SQL instance ID. This does not include the project ID.</param>
        public virtual StopRequest Stop(Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStopRequest body, string project, string instance)
        {
        ...
        /// Stops capturing the query traffic and related operations executed on the primary instance.
        /// </summary>
        public class StopRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new Stop request.</summary>
            public StopRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStopRequest body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStopRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/workloadCaptures:stop";
        ...
        /// <param name="instance">Required. Cloud SQL instance ID. This does not include the project ID.</param>
        /// <param name="workloadId">Required. The ID of the workload to replay.</param>
        public virtual StopReplayRequest StopReplay(Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStopReplayRequest body, string project, string instance, string workloadId)
        {
            return new StopReplayRequest(this.service, body, project, instance, workloadId);
        }

        /// <summary>Stops executing a captured workload on the separate Cloud SQL instance.</summary>
        public class StopReplayRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1.Data.Operation>
        {
            /// <summary>Constructs a new StopReplay request.</summary>
            public StopReplayRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStopReplayRequest body, string project, string instance, string workloadId) : base(service)
            {
                Project = project;
                Instance = instance;
                WorkloadId = workloadId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.SQLAdmin.v1.Data.SqlWorkloadCapturesStopReplayRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:stopReplay";
...
namespace Google.Apis.SQLAdmin.v1.Data
{
    ...
    {
        /// <summary>Lease duration needed for SSRS setup.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("duration")]
        public virtual object Duration { get; set; }

        /// <summary>The report database to be used for SSRS setup.</summary>
    ...
    public class Backup : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Backup expiration time. A UTC timestamp of when this backup expired.</summary>
        ...
        /// <summary>The name of the source database instance.</summary>
        ...
        /// <summary>Output only. The status of this backup.</summary>
    ...
    public class BackupConfiguration : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. This value contains the storage location of transactional logs used to perform point-in-time
        /// recovery (PITR) for the database.
        /// </summary>
    ...
    /// <summary>A `BlueGreenDeployment` resource represents a Cloud SQL blue-green deployment setup.</summary>
    public class BlueGreenDeployment : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The time when the deployment was created. Example: `2024-01-01T00:00:00Z`</summary>
        ...
        /// <summary>
        /// Output only. Provides details on why switchover is not possible. This field is empty unless a switchover
        /// attempt failed or the state is `SWITCHOVER_NOT_READY`. Example: "The target database version does not match
        ...
        /// <summary>
        /// Required. Immutable. Required on create, and immutable. The full resource name of the source instance (the
        /// "blue" instance). Format: projects/{project}/instances/{instance}
        /// </summary>
        ...
        /// <summary>
        /// Output only. The full resource name of the primary target instance (the "green" instance) that will be
        /// promoted during switchover. This field is always populated once the deployment is created. Format:
    ...
    {
        /// <summary>
        /// Output only. The name of the field that differs in the blue and green instances, fully-qualified. Example:
        /// `settings.tier`
        /// </summary>
    ...
    public class ConnectSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `POSTGRES_10`, `POSTGRES_11`, `POSTGRES_12` (default), `POSTGRES_13`, or `POSTGRES_14`. SQL Server
        ...
        /// <summary>
        /// The cloud region for the instance. For example, `us-central1`, `europe-west1`. The region cannot be changed
    ...
    public class DatabaseInstance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. A primary instance and disaster recovery (DR) replica pair. A DR replica is a cross-region replica
        /// that you designate for failover in the event that the primary instance experiences regional failure.
    ...
    public class ExportContext : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public class TdeExportOptionsData
        {
            ...
            /// have write access to the bucket. Applicable only for SQL Server instances.
            /// </summary>
    ...
    public class Flag : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// flags that do not take a value, such as `skip_grant_tables`.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("type")]
        public virtual string Type { get; set; }
    ...
    public class ImportContext : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Import parameters specific to SQL Server TDE certificates</summary>
    ...
    /// <summary>Request to acquire a lease for SSRS.</summary>
    ...
    {
        /// <summary>Required. Contains details about the demote operation.</summary>
    ...
    public class Operation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// PreCheckMajorVersionUpgradeContext message itself contains the details for that pre-check, such as the
        /// target database version for the upgrade and the results of the check (including any warnings or errors
        /// found).
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("preCheckMajorVersionUpgradeContext")]
        public virtual PreCheckMajorVersionUpgradeContext PreCheckMajorVersionUpgradeContext { get; set; }
    ...
    /// <summary>
    /// The context to perform a point-in-time recovery of an instance managed by Backup and Disaster Recovery (DR)
    /// Service.
    /// </summary>
    ...
    public class PscAutoConnectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. This is the project ID of consumer service project of this consumer endpoint. This is only
    ...
    /// designate for failover in the event that the primary instance experiences regional failure. Applicable to MySQL
    /// and PostgreSQL.
    /// </summary>
    ...
    {
        /// <summary>
        /// Optional. Whether the replica is in accelerated mode. This feature is in private preview and requires
    ...
    {
        /// <summary>Output only. Describes the list of differences for the `SourceTargetPairedNode`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("diffs")]
        public virtual System.Collections.Generic.IList<ConfigDiff> Diffs { get; set; }

        /// <summary>Output only. Specifies the resource name of the source instance in this pair.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual NodeInfo Source { get; set; }

        /// <summary>Output only. Specifies the current state of this specific source-target pair.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }

        /// <summary>Output only. Specifies details of the corresponding target instance in this pair.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("target")]
    ...
    /// <summary>Response for the acquire SSRS lease request.</summary>
    ...
    /// <summary>Response for the release SSRS lease request.</summary>
