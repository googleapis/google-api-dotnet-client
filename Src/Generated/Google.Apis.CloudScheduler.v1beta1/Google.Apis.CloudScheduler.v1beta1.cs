    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class JobsResource
            {
                ...
                /// information, see [Cloud Scheduler locations](/scheduler/docs/locations). * `JOB_ID` can contain only
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.CloudScheduler.v1beta1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1beta1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudScheduler.v1beta1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
...
namespace Google.Apis.CloudScheduler.v1beta1.Data
{
    ...
    public class AppEngineHttpTarget : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// this header will contain the job schedule as an offset of UTC parsed according to RFC3339. Remains constant
        /// across retries and can be used for [job request
        /// deduplication](https://docs.cloud.google.com/scheduler/docs/overview#job-deduplication). If the job has a
    ...
    public class HttpTarget : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `"Google-Cloud-Scheduler"`. * `X-Google-*`: Used internally by Google. If present in an external user
        /// request, it is replaced by the internal header. * `X-AppEngine-*`: Used internally by Google. If present in
        /// an external user request, it is replaced by the internal header. * `X-CloudScheduler`: This header will be
        /// set to true. * `X-CloudScheduler-JobName`: This header will contain the job name. *
        /// `X-CloudScheduler-ScheduleTime`: For Cloud Scheduler jobs specified in the unix-cron format, this header
        /// will contain the job schedule as an offset of UTC parsed according to RFC3339. Remains constant across
        /// retries and can be used for [job request
        /// deduplication](https://docs.cloud.google.com/scheduler/docs/overview#job-deduplication). If the job has a
        /// body and the following headers are not set by the user, Cloud Scheduler sets default values: *
        /// `Content-Type`: This will be set to `"application/octet-stream"`. You can override this default by
        /// explicitly setting `Content-Type` to a particular media type when creating the job. For example, you can set
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// [locations.list](/scheduler/docs/reference/rest/v1beta1/projects.locations/list). For more information, see
