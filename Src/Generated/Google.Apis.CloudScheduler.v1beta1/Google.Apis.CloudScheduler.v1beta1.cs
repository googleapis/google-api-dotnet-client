        ...
        public class LocationsResource
        {
            ...
            public class JobsResource
            {
                ...
                public class CreateRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Job>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1beta1.Data.Job body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                ...
                /// <summary>Updates a job. If successful, the updated Job is returned. If the job does not exist,
                /// `NOT_FOUND` is returned. If UpdateJob does not successfully return, it is possible for the job to be
                /// in an Job.State.UPDATE_FAILED state. A job in this state may not be executed. If this happens, retry
                /// the UpdateJob request until a successful response is received.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Optionally caller-specified in CreateJob, after which it becomes output only. The job name. For
                /// example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`. * `PROJECT_ID` can contain letters ([A-Za-z]),
                /// numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see [Identifying
                /// projects](https://cloud.google.com/resource-manager/docs/creating-managing-projects#identifying_projects) *
                /// `LOCATION_ID` is the canonical ID for the job's location. The list of available locations can be obtained by calling
                /// ListLocations. For more information, see https://cloud.google.com/about/locations/. * `JOB_ID` can contain only
                ...
                public class PatchRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Job>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1beta1.Data.Job body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Optionally caller-specified in CreateJob, after which it becomes output only. The job
                    /// name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`. * `PROJECT_ID` can
                    /// contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more
                    /// information, see [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-
                    /// managing-projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the job's
                    /// location. The list of available locations can be obtained by calling ListLocations. For more
                    /// information, see https://cloud.google.com/about/locations/. * `JOB_ID` can contain only letters
                    /// ([A-Za-z]), numbers ([0-9]), hyphens (-), or underscores (_). The maximum length is 500
                    /// characters.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <summary>Pauses a job. If a job is paused then the system will stop executing the job until it is
                /// re-enabled via ResumeJob. The state of the job is stored in state; if paused it will be set to
                /// Job.State.PAUSED. A job must be in Job.State.ENABLED to be paused.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The job name. For example:
                /// `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
                ...
                public class PauseRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Job>
                {
                    ...
                    public PauseRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1beta1.Data.PauseJobRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// <summary>Resume a job. This method reenables a job after it has been Job.State.PAUSED. The state of
                /// a job is stored in Job.state; after calling this method it will be set to Job.State.ENABLED. A job
                /// must be in Job.State.PAUSED to be resumed.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The job name. For example:
                /// `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
                ...
                public class ResumeRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Job>
                {
                    ...
                    public ResumeRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1beta1.Data.ResumeJobRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// <summary>Forces a job to run now. When this method is called, Cloud Scheduler will dispatch the job,
                /// even if the job is already running.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The job name. For example:
                /// `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
                ...
                public class RunRequest : CloudSchedulerBaseServiceRequest<Google.Apis.CloudScheduler.v1beta1.Data.Job>
                {
                    ...
                    public RunRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudScheduler.v1beta1.Data.RunJobRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
...
{    
    ...
    public class AppEngineHttpTarget : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// header is `"AppEngine-Google; (+http://code.google.com/appengine)"`. This header can be modified, but Cloud
        /// Scheduler will append `"AppEngine-Google; (+http://code.google.com/appengine)"` to the modified `User-
        /// Agent`. * `X-CloudScheduler`: This header will be set to true. If the job has an body, Cloud Scheduler sets
        /// the following headers: * `Content-Type`: By default, the `Content-Type` header is set to `"application
        /// /octet-stream"`. The default can be overridden by explictly setting `Content-Type` to a particular media
        /// type when the job is created. For example, `Content-Type` can be set to `"application/json"`. * `Content-
        /// Length`: This is computed by Cloud Scheduler. This value is output only. It cannot be changed. The headers
        /// below are output only. They cannot be set or overridden: * `X-Google-*`: For Google internal use only. *
    ...
    /// <summary>App Engine Routing. For more information about services, versions, and instances see [An Overview of
    /// App Engine](https://cloud.google.com/appengine/docs/python/an-overview-of-app-engine), [Microservices
    /// Architecture on Google App Engine](https://cloud.google.com/appengine/docs/python/microservices-on-app-engine),
    /// [App Engine Standard request routing](https://cloud.google.com/appengine/docs/standard/python/how-requests-are-
    /// routed), and [App Engine Flex request routing](https://cloud.google.com/appengine/docs/flexible/python/how-
    ...
    public class AppEngineRouting : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// are routed, see [here](https://cloud.google.com/appengine/docs/standard/python/how-requests-are-routed). The
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// viewed in execution logs. Cloud Scheduler will retry the job according to the RetryConfig. The allowed
        /// duration for this deadline is: * For HTTP targets, between 15 seconds and 30 minutes. * For App Engine HTTP
        /// targets, between 15 seconds and 24 hours. * For PubSub targets, this field is ignored.</summary>
        ...
        /// [schedule](https://cloud.google.com/scheduler/docs/configuring/cron-job-schedules) As a general rule,
        /// execution `n + 1` of a job will not begin until execution `n` has finished. Cloud Scheduler will never allow
        /// two simultaneously outstanding executions. For example, this implies that if the `n+1`th execution is
        ...
        /// include a provision for daylight savings time. The rules for daylight saving time are determined by the
    ...
    /// <summary>Settings that determine the retry behavior. By default, if a job does not complete successfully
    /// (meaning that an acknowledgement is not received from the handler, then it will be retried with exponential
    /// backoff according to the settings in RetryConfig.</summary>
    public class RetryConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// job attempt will *not* be retried if it fails. Instead the Cloud Scheduler system will wait for the next
        /// scheduled execution time. If retry_count is set to a non-zero number then Cloud Scheduler will retry failed
