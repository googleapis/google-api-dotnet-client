...
namespace Google.Apis.CloudScheduler.v1beta1
{
    ...
    public class CloudSchedulerService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://cloudscheduler.googleapis.com/";
...
namespace Google.Apis.CloudScheduler.v1beta1.Data
{
    ...
    public class AppEngineHttpTarget : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// this header will contain the job schedule time in RFC3339 UTC "Zulu" format. If the job has a body and the
        /// following headers are not set by the user, Cloud Scheduler sets default values: * `Content-Type`: This will
        /// be set to `"application/octet-stream"`. You can override this default by explicitly setting `Content-Type`
        /// to a particular media type when creating the job. For example, you can set `Content-Type` to
    ...
    public class HttpTarget : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// format, this header will contain the job schedule time in RFC3339 UTC "Zulu" format. If the job has a body
        /// and the following headers are not set by the user, Cloud Scheduler sets default values: * `Content-Type`:
        /// This will be set to `"application/octet-stream"`. You can override this default by explicitly setting
        /// `Content-Type` to a particular media type when creating the job. For example, you can set `Content-Type` to
    ...
    /// <summary>
    /// Settings that determine the retry behavior. By default, if a job does not complete successfully (meaning that an
    /// acknowledgement is not received from the handler, then it will be retried with exponential backoff according to
    ...
    public class RetryConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The time limit for retrying a failed job, measured from time when an execution was first attempted. If
