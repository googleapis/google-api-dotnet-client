...
{    
    ...
    public class AdClient : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>ARC review mode this ad client is in. Empty if the client is not opted in to ARC. Possible values:
        /// POST_REVIEW, AUTOMATIC_PRE_REVIEW.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("arcReviewMode")]
        public virtual string ArcReviewMode { get; set; } 
