...
/**
 * \brief
 *   Google Cloud Error Reporting API Version v1beta1
 *
 ...
 *
 * The complete API documentation for using Google Cloud Error Reporting API can be found at
...
namespace Google.Apis.Clouderrorreporting.v1beta1
{
    ...
    public class ClouderrorreportingService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scopes for use with the Google Cloud Error Reporting API.</summary>
        public class Scope
        {
...
{    
    ...
    public class ErrorContext : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// usually close to the place where it was caught. This value is in contrast to `Exception.cause_location`,
        /// which describes the source line where the exception was thrown.</summary>
    ...
    /// <summary>Data extracted for a specific group based on certain selection criteria, such as a given time period
    /// and/or service filter.</summary>
    public class ErrorGroupStats : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Service contexts with a non-zero error count for the given selection criteria. This list can be
        ...
        /// <summary>Approximate number of affected users in the given group that match the selection criteria. Users
        /// are distinguished by data in the `ErrorContext` of the individual error events, such as their login name or
        ...
        /// <summary>Approximate total number of events in the given group that match the selection criteria.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("count")]
        public virtual System.Nullable<long> Count { get; set; } 

        /// <summary>Approximate first occurrence that was seen for this group and which matches the given selection
        /// criteria.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("firstSeenTime")]
        public virtual object FirstSeenTime { get; set; } 

        /// <summary>Group data that is independent of the selection criteria.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("group")]
        public virtual ErrorGroup Group { get; set; } 

        /// <summary>Approximate last occurrence that was seen for this group and which matches the given selection
        /// criteria.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lastSeenTime")]
        public virtual object LastSeenTime { get; set; } 

        /// <summary>The total number of services with a non-zero error count for the given selection
        /// criteria.</summary>
    ...
    public class ServiceContext : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// Contains the module name for error reports extracted from Google App Engine logs or `default` if the App
        /// Engine default module is used. If empty, the value is set to `default`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("service")]
        public virtual string Service { get; set; } 

        /// <summary>Represents the source code version that the developer provided, which could represent a version
        /// label or a Git SHA-1 hash, for example. If the developer did not provide a version, the value is set to
        /// `default`. For App Engine, the version is set to the version of the app.</summary>
    ...
    /// <summary>Indicates a location in the source code of the service for which errors are reported. This data should
    /// be provided by the application when reporting an error, unless the error report has been generated automatically
    /// from Google App Engine logs. All fields are optional.</summary>
