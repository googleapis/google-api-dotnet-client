        ...
        public class LocationsResource
        {
            ...
            public class ConnectionProfilesResource
            {
                ...
                public class CreateRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>A unique id used to identify the request. If the server receives two requests with the
                    ...
                    /// (-). The maximum length is 40 characters.</summary>
                    ...
                    public override string RestPath => "v1beta1/{+parent}/connectionProfiles";
                ...
                /// <summary>Deletes a single Database Migration Service connection profile. A connection profile can
                /// only be deleted if it is not in use by any active migration jobs.</summary>
                ...
                public class DeleteRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>In case of force delete, the CloudSQL replica database is also deleted (only for
                    /// CloudSQL connection profile).</summary>
                ...
                public class ListRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.ListConnectionProfilesResponse>
                {
                    ...
                    /// <summary>A filter expression that filters connection profiles listed in the response. The
                    ...
                    /// must be either =, !=, >, or <. For example, list connection profiles created this year by
                    /// specifying **createTime %gt; 2020-01-01T00:00:00.000000000Z**. You can also filter nested
                    /// fields. For example, you could specify **mySql.username = %lt;my_username%gt;** to list all
                    /// connection profiles configured to connect with a specific username.</summary>
                    ...
                    /// <summary>The maximum number of connection profiles to return. The service may return fewer than
                    /// this value. If unspecified, at most 50 connection profiles will be returned. The maximum value
                    /// is 1000; values above 1000 will be coerced to 1000.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }

                    /// <summary>A page token, received from a previous `ListConnectionProfiles` call. Provide this to
                    /// retrieve the subsequent page. When paginating, all other parameters provided to
                    /// `ListConnectionProfiles` must match the call that provided the page token.</summary>
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The name of this connection profile resource in the form of
                ...
                public class PatchRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>The name of this connection profile resource in the form of
                    ...
                    /// <summary>Required. Field mask is used to specify the fields to be overwritten in the connection
                    /// profile resource by the update.</summary>
            ...
            public class MigrationJobsResource
            {
                ...
                public class CreateRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+parent}/migrationJobs";
                ...
                public class DeleteRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>The destination CloudSQL connection profile is always deleted with the migration job.
                    /// In case of force delete, the destination CloudSQL replica database is also deleted.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("force", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<bool> Force { get; set; }
                ...
                public class GenerateSshScriptRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.SshScript>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+migrationJob}:generateSshScript";
                ...
                public class ListRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.ListMigrationJobsResponse>
                {
                    ...
                    /// <summary>A filter expression that filters migration jobs listed in the response. The expression
                    ...
                    /// jobs connecting through the specific SSH tunnel bastion.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("filter", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string Filter { get; set; }

                    /// <summary>Sort the results based on the migration job name. Valid values are: "name", "name asc",
                    /// and "name desc".</summary>
                    [Google.Apis.Util.RequestParameterAttribute("orderBy", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string OrderBy { get; set; }

                    /// <summary>The maximum number of migration jobs to return. The service may return fewer than this
                    ...
                    /// <summary>The nextPageToken value received in the previous call to migrationJobs.list, used in
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The name (URI) of this migration job resource, in the form of:
                /// projects/{project}/locations/{location}/instances/{instance}.</param>
                ...
                public class PatchRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>The name (URI) of this migration job resource, in the form of:
                    /// projects/{project}/locations/{location}/instances/{instance}.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    /// <summary>Required. Field mask is used to specify the fields to be overwritten in the migration
                    /// job resource by the update.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual object UpdateMask { get; set; }
                ...
                /// <summary>Promote a migration job, stopping replication to the destination and promoting the
                /// destination to be a standalone database.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public class PromoteRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+name}:promote";
                ...
                /// <summary>Restart a stopped or failed migration job, resetting the destination instance to its
                /// original state and starting the migration process from scratch.</summary>
                /// <param name="body">The body of the request.</param>
                ...
                /// <summary>Resume a migration job that is currently stopped and is resumable (was stopped during CDC
                /// phase).</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public class StartRequest : CloudDatabaseMigrationServiceBaseServiceRequest<Google.Apis.CloudDatabaseMigrationService.v1beta1.Data.Operation>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+name}:start";
                ...
                /// <summary>Verify a migration job, making sure the destination can reach the source and that all
                /// configuration and prerequisites are met.</summary>
                /// <param name="body">The body of the request.</param>
...
{    
    ...
    /// <summary>Specifies required connection parameters, and, optionally, the parameters required to create a Cloud
    /// SQL destination database instance.</summary>
    ...
    public class CloudSqlSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[default: ON] If you enable this setting, Cloud SQL checks your available storage every 30 seconds.
        /// If the available storage falls below a threshold size, Cloud SQL automatically adds additional storage
        /// capacity. If the available storage repeatedly falls below the threshold size, Cloud SQL continues to add
        /// storage until it reaches the maximum of 30 TB.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoStorageIncrease")]
        public virtual System.Nullable<bool> AutoStorageIncrease { get; set; }

        /// <summary>The storage capacity available to the database, in GB. The minimum (and default) size is
        /// 10GB.</summary>
        ...
        /// <summary>The database flags passed to the Cloud SQL instance at startup. An object containing a list of
        /// "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.</summary>
        ...
        /// external networks can connect to the instance. The IPv4 address cannot be disabled.</summary>
        ...
        /// <summary>The Database Migration Service source connection profile ID, in the format:
        /// `projects/my_project_name/locations/us-central1/connectionProfiles/connection_profile_ID`</summary>
        ...
        /// Settings](https://cloud.google.com/sql/docs/mysql/instance-settings).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("tier")]
        public virtual string Tier { get; set; }

        /// <summary>The resource labels for a Cloud SQL instance to use to annotate any related underlying resources
        /// such as Compute Engine VMs. An object containing a list of "key": "value" pairs. Example: `{ "name":
        /// "wrench", "mass": "18kg", "count": "3" }`.</summary>
    ...
    public class ConnectionProfile : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The timestamp when the resource was created. A timestamp in RFC3339 UTC "Zulu" format,
        ...
        /// <summary>The resource labels for connection profile to use to annotate any related underlying resources such
        /// as Compute Engine VMs. An object containing a list of "key": "value" pairs. Example: `{ "name": "wrench",
        /// "mass": "1.3kg", "count": "3" }`.</summary>
        ...
        /// <summary>Output only. The timestamp when the resource was last updated. A timestamp in RFC3339 UTC "Zulu"
        /// format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".</summary>
    ...
    public class GoogleCloudClouddmsV1beta1OperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    {
        /// <summary>Output only. The timestamp when the migration job resource was created. A timestamp in RFC3339 UTC
        /// "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("createTime")]
        public virtual object CreateTime { get; set; }
        ...
        /// <summary>The path to the dump file in Google Cloud Storage, in the format:
        /// (gs://[BUCKET_NAME]/[OBJECT_NAME]).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("dumpPath")]
        public virtual string DumpPath { get; set; }

        /// <summary>Output only. The duration of the migration job (in seconds). A duration in seconds with up to nine
        /// fractional digits, terminated by 's'. Example: "3.5s".</summary>
        ...
        /// <summary>The resource labels for migration job to use to annotate any related underlying resources such as
        ...
        /// <summary>Output only. The timestamp when the migration job resource was last updated. A timestamp in RFC3339
        /// UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("updateTime")]
        public virtual object UpdateTime { get; set; }
    ...
    {
        /// <summary>If the source is a Cloud SQL database, use this field to provide the Cloud SQL instance ID of the
        /// source.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("cloudSqlId")]
        public virtual string CloudSqlId { get; set; }
        ...
        /// <summary>Required. Input only. The password for the user that Database Migration Service will be using to
        /// connect to the database. This field is not returned on request, and the value is encrypted when stored in
        /// Database Migration Service.</summary>
        ...
        /// <summary>Required. The username that Database Migration Service will use to connect to the database. The
        /// value is encrypted when stored in Database Migration Service.</summary>
    ...
    /// <summary>The details needed to configure a reverse SSH tunnel between the source and destination databases.
    /// These details will be used when calling the generateSshScript method (see https://cloud.google.com/database-
    /// migration/docs/reference/rest/v1beta1/projects.locations.migrationJobs/generateSshScript) to produce the script
    /// that will help set up the reverse SSH tunnel, and to set up the VPC peering between the Cloud SQL private
    /// network and the VPC.</summary>
    public class ReverseSshConnectivity : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The name of the virtual machine (Compute Engine) used as the bastion server for the SSH
        /// tunnel.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("vm")]
        public virtual string Vm { get; set; }

        /// <summary>Required. The IP of the virtual machine (Compute Engine) used as the bastion server for the SSH
        /// tunnel.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("vmIp")]
        public virtual string VmIp { get; set; }

        /// <summary>Required. The forwarding port of the virtual machine (Compute Engine) used as the bastion server
        /// for the SSH tunnel.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("vmPort")]
        public virtual System.Nullable<int> VmPort { get; set; }
    ...
    {
        /// <summary>The time when this access control entry expires in [RFC 3339](https://tools.ietf.org/html/rfc3339)
        /// format, for example: `2012-11-15T16:19:00.094Z`.</summary>
    ...
    {
        /// <summary>The list of external networks that are allowed to connect to the instance using the IP. See
        /// https://en.wikipedia.org/wiki/CIDR_notation#CIDR_notation, also known as 'slash' notation (e.g.
        /// `192.168.100.0/24`).</summary>
        ...
        /// IP. For example, `/projects/myProject/global/networks/default`. This setting can be updated, but it cannot
        /// be removed after it is set.</summary>
    ...
    {
        /// <summary>Required. Input only. The x509 PEM-encoded certificate of the CA that signed the source database
        /// server's certificate. The replica will use this certificate to verify it's connecting to the right
        /// host.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("caCertificate")]
        public virtual string CaCertificate { get; set; }

        /// <summary>Input only. The x509 PEM-encoded certificate that will be used by the replica to authenticate
        /// against the source database server.If this field is used then the 'client_key' field is mandatory.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clientCertificate")]
        public virtual string ClientCertificate { get; set; }

        /// <summary>Input only. The unencrypted PKCS#1 or PKCS#8 PEM-encoded private key associated with the Client
        /// Certificate. If this field is used then the 'client_certificate' field is mandatory.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clientKey")]
        public virtual string ClientKey { get; set; }

        /// <summary>Output only. The ssl config type according to 'client_key', 'client_certificate' and
        /// 'ca_certificate'.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("type")]
        public virtual string Type { get; set; }
    ...
    /// <summary>The source database will allow incoming connections from the destination database's public IP. You can
    /// retrieve the Cloud SQL instance's public IP from the Cloud SQL console or using Cloud SQL APIs. No additional
    /// configuration is required.</summary>
    ...
    /// <summary>The details of the VPC where the source database is located in Google Cloud. We will use this
    /// information to set up the VPC peering connection between Cloud SQL and this VPC.</summary>
