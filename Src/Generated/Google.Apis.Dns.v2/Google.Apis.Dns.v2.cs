...
namespace Google.Apis.Dns.v2
{
    ...
    public class ChangesResource
    {
        ...
        /// <param name="location"><c>null</c></param>
        /// <param name="managedZone">
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2.Data.Change body, string project, string location, string managedZone)
        {
            return new CreateRequest(service, body, project, location, managedZone);
        }

        /// <summary>Atomically updates the ResourceRecordSet collection.</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Change>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.Change body, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
            ...
            Google.Apis.Dns.v2.Data.Change Body { get; set; }
            ...
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes";
        ...
        /// </param>
        public virtual GetRequest Get(string project, string location, string managedZone, string changeId)
        {
            return new GetRequest(service, project, location, managedZone, changeId);
        }

        /// <summary>Fetches the representation of an existing Change.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Change>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone, string changeId) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes/{changeId}";
        ...
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual ListRequest List(string project, string location, string managedZone)
        {
            return new ListRequest(service, project, location, managedZone);
        }

        /// <summary>Enumerates Changes to a ResourceRecordSet collection.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ChangesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
    ...
    public class DnsKeysResource
    {
        ...
        /// <param name="project">Identifies the project addressed by this request.</param>
        /// <param name="location">
        /// Specifies the location of the resource. This information will be used for routing and will be part of the
        /// resource name.
        /// </param>
        /// <param name="managedZone">
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        ...
        public virtual GetRequest Get(string project, string location, string managedZone, string dnsKeyId)
        {
            return new GetRequest(service, project, location, managedZone, dnsKeyId);
        }

        /// <summary>Fetches the representation of an existing DnsKey.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.DnsKey>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone, string dnsKeyId) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
            ...
            /// <summary>
            /// Specifies the location of the resource. This information will be used for routing and will be part of
            /// the resource name.
            /// </summary>
            [Google.Apis.Util.RequestParameterAttribute("location", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Location { get; private set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}";
        ...
        /// <summary>Enumerates DnsKeys to a ResourceRecordSet collection.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.DnsKeysListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/dnsKeys";
    ...
    public class ManagedZoneOperationsResource
    {
        ...
        public virtual GetRequest Get(string project, string location, string managedZone, string operation)
        {
            return new GetRequest(service, project, location, managedZone, operation);
        }

        /// <summary>Fetches the representation of an existing Operation.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Operation>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone, string operation) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/operations/{operation}";
        ...
        /// <summary>Enumerates Operations for the given ManagedZone.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ManagedZoneOperationsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone) : base(service)
            {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/operations";
    ...
    public class ManagedZonesResource
    {
        ...
        /// resource name.
        /// </param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2.Data.ManagedZone body, string project, string location)
        {
            return new CreateRequest(service, body, project, location);
        }

        /// <summary>Creates a new ManagedZone.</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ManagedZone>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ManagedZone body, string project, string location) : base(service)
            {
                Project = project;
                Location = location;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Dns.v2.Data.ManagedZone Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones";
        ...
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual DeleteRequest Delete(string project, string location, string managedZone)
        {
            return new DeleteRequest(service, project, location, managedZone);
        }
        ...
        public class DeleteRequest : DnsBaseServiceRequest<string>
        {
            ...
            public DeleteRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}";
        ...
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual GetRequest Get(string project, string location, string managedZone)
        {
            return new GetRequest(service, project, location, managedZone);
        }

        /// <summary>Fetches the representation of an existing ManagedZone.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ManagedZone>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
        ...
        /// resource name.
        /// </param>
        public virtual ListRequest List(string project, string location)
        {
            return new ListRequest(service, project, location);
        }

        /// <summary>Enumerates ManagedZones that have been created but not yet deleted.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ManagedZonesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location) : base(service)
            {
                Project = project;
                Location = location;
                InitParameters();
        ...
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual PatchRequest Patch(Google.Apis.Dns.v2.Data.ManagedZone body, string project, string location, string managedZone)
        {
            return new PatchRequest(service, body, project, location, managedZone);
        }

        /// <summary>Applies a partial update to an existing ManagedZone.</summary>
        public class PatchRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Operation>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ManagedZone body, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
        ...
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual UpdateRequest Update(Google.Apis.Dns.v2.Data.ManagedZone body, string project, string location, string managedZone)
        {
            return new UpdateRequest(service, body, project, location, managedZone);
        }

        /// <summary>Updates an existing ManagedZone.</summary>
        public class UpdateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Operation>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ManagedZone body, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
    ...
    public class PoliciesResource
    {
        ...
        /// resource name.
        /// </param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2.Data.Policy body, string project, string location)
        {
            return new CreateRequest(service, body, project, location);
        }

        /// <summary>Creates a new Policy.</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Policy>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.Policy body, string project, string location) : base(service)
            {
                Project = project;
                Location = location;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Dns.v2.Data.Policy Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/policies";
        ...
        public virtual DeleteRequest Delete(string project, string location, string policy)
        {
            return new DeleteRequest(service, project, location, policy);
        }
        ...
        {
            /// <summary>Constructs a new Delete request.</summary>
            public DeleteRequest(Google.Apis.Services.IClientService service, string project, string location, string policy) : base(service)
            {
                Project = project;
                Location = location;
                Policy = policy;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/policies/{policy}";
        ...
        /// </param>
        /// <param name="policy">User given friendly name of the policy addressed by this request.</param>
        public virtual GetRequest Get(string project, string location, string policy)
        {
            return new GetRequest(service, project, location, policy);
        }

        /// <summary>Fetches the representation of an existing Policy.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Policy>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string policy) : base(service)
            {
                Project = project;
                Location = location;
                Policy = policy;
        ...
        /// <summary>Enumerates all Policies associated with a project.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.PoliciesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location) : base(service)
            {
        ...
        /// </param>
        /// <param name="policy">User given friendly name of the policy addressed by this request.</param>
        public virtual PatchRequest Patch(Google.Apis.Dns.v2.Data.Policy body, string project, string location, string policy)
        {
            return new PatchRequest(service, body, project, location, policy);
        }

        /// <summary>Applies a partial update to an existing Policy.</summary>
        public class PatchRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.PoliciesPatchResponse>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.Policy body, string project, string location, string policy) : base(service)
            {
                Project = project;
                Location = location;
                Policy = policy;
        ...
        /// </param>
        /// <param name="policy">User given friendly name of the policy addressed by this request.</param>
        public virtual UpdateRequest Update(Google.Apis.Dns.v2.Data.Policy body, string project, string location, string policy)
        {
            return new UpdateRequest(service, body, project, location, policy);
        }

        /// <summary>Updates an existing Policy.</summary>
        public class UpdateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.PoliciesUpdateResponse>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.Policy body, string project, string location, string policy) : base(service)
            {
                Project = project;
                Location = location;
                Policy = policy;
    ...
    public class ProjectsResource
    {
        ...
        /// <param name="project">Identifies the project addressed by this request.</param>
        /// <param name="location"><c>null</c></param>
        public virtual GetRequest Get(string project, string location)
        {
            return new GetRequest(service, project, location);
        }

        /// <summary>Fetches the representation of an existing Project.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.Project>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location) : base(service)
            {
                Project = project;
                Location = location;
                InitParameters();
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}";
    ...
    public class ResourceRecordSetsResource
    {
        ...
        /// Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
        /// </param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2.Data.ResourceRecordSet body, string project, string location, string managedZone)
        {
            return new CreateRequest(service, body, project, location, managedZone);
        }

        /// <summary>Creates a new ResourceRecordSet.</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResourceRecordSet>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResourceRecordSet body, string project, string location, string managedZone) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Dns.v2.Data.ResourceRecordSet Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets";
        ...
        public virtual DeleteRequest Delete(string project, string location, string managedZone, string name, string type)
        {
            return new DeleteRequest(service, project, location, managedZone, name, type);
        }
        ...
        {
            /// <summary>Constructs a new Delete request.</summary>
            public DeleteRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone, string name, string type) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets/{name}/{type}";
        ...
        /// <param name="name">Fully qualified domain name.</param>
        /// <param name="type">RRSet type.</param>
        public virtual GetRequest Get(string project, string location, string managedZone, string name, string type)
        {
            return new GetRequest(service, project, location, managedZone, name, type);
        }

        /// <summary>Fetches the representation of an existing ResourceRecordSet.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResourceRecordSet>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone, string name, string type) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
        ...
        /// <summary>Enumerates ResourceRecordSets that you have created but not yet deleted.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResourceRecordSetsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location, string managedZone) : base(service)
            {
        ...
        /// <param name="name">Fully qualified domain name.</param>
        /// <param name="type">RRSet type.</param>
        public virtual PatchRequest Patch(Google.Apis.Dns.v2.Data.ResourceRecordSet body, string project, string location, string managedZone, string name, string type)
        {
            return new PatchRequest(service, body, project, location, managedZone, name, type);
        }

        /// <summary>Applies a partial update to an existing ResourceRecordSet.</summary>
        public class PatchRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResourceRecordSet>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResourceRecordSet body, string project, string location, string managedZone, string name, string type) : base(service)
            {
                Project = project;
                Location = location;
                ManagedZone = managedZone;
    ...
    public class ResponsePoliciesResource
    {
        ...
        /// <param name="project">Identifies the project addressed by this request.</param>
        /// <param name="location">
        /// Specifies the location of the resource, only applicable in the v APIs. This information will be used for
        /// routing and will be part of the resource name.
        /// </param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2.Data.ResponsePolicy body, string project, string location)
        {
            return new CreateRequest(service, body, project, location);
        }

        /// <summary>Creates a new Response Policy</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicy>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResponsePolicy body, string project, string location) : base(service)
            {
                Project = project;
                Location = location;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Dns.v2.Data.ResponsePolicy Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/responsePolicies";
        ...
        public virtual DeleteRequest Delete(string project, string location, string responsePolicy)
        {
            return new DeleteRequest(service, project, location, responsePolicy);
        }
        ...
        {
            /// <summary>Constructs a new Delete request.</summary>
            public DeleteRequest(Google.Apis.Services.IClientService service, string project, string location, string responsePolicy) : base(service)
            {
                Project = project;
                Location = location;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}";
        ...
        /// </param>
        /// <param name="responsePolicy">User assigned name of the Response Policy addressed by this request.</param>
        public virtual GetRequest Get(string project, string location, string responsePolicy)
        {
            return new GetRequest(service, project, location, responsePolicy);
        }

        /// <summary>Fetches the representation of an existing Response Policy.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicy>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string responsePolicy) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
        ...
        /// <summary>Enumerates all Response Policies associated with a project.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePoliciesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location) : base(service)
            {
        ...
        public virtual PatchRequest Patch(Google.Apis.Dns.v2.Data.ResponsePolicy body, string project, string location, string responsePolicy)
        {
            return new PatchRequest(service, body, project, location, responsePolicy);
        }

        /// <summary>Applies a partial update to an existing Response Policy.</summary>
        public class PatchRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePoliciesPatchResponse>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResponsePolicy body, string project, string location, string responsePolicy) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
        ...
        /// </param>
        /// <param name="responsePolicy">User assigned name of the Response Policy addressed by this request.</param>
        public virtual UpdateRequest Update(Google.Apis.Dns.v2.Data.ResponsePolicy body, string project, string location, string responsePolicy)
        {
            return new UpdateRequest(service, body, project, location, responsePolicy);
        }

        /// <summary>Updates an existing Response Policy.</summary>
        public class UpdateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePoliciesUpdateResponse>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResponsePolicy body, string project, string location, string responsePolicy) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
    ...
    public class ResponsePolicyRulesResource
    {
        ...
        /// </param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2.Data.ResponsePolicyRule body, string project, string location, string responsePolicy)
        {
            return new CreateRequest(service, body, project, location, responsePolicy);
        }

        /// <summary>Creates a new Response Policy Rule.</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicyRule>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResponsePolicyRule body, string project, string location, string responsePolicy) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Dns.v2.Data.ResponsePolicyRule Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}/rules";
        ...
        /// </param>
        public virtual DeleteRequest Delete(string project, string location, string responsePolicy, string responsePolicyRule)
        {
            return new DeleteRequest(service, project, location, responsePolicy, responsePolicyRule);
        }
        ...
        {
            /// <summary>Constructs a new Delete request.</summary>
            public DeleteRequest(Google.Apis.Services.IClientService service, string project, string location, string responsePolicy, string responsePolicyRule) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}";
        ...
        /// User assigned name of the Response Policy Rule addressed by this request.
        /// </param>
        public virtual GetRequest Get(string project, string location, string responsePolicy, string responsePolicyRule)
        {
            return new GetRequest(service, project, location, responsePolicy, responsePolicyRule);
        }

        /// <summary>Fetches the representation of an existing Response Policy Rule.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicyRule>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string location, string responsePolicy, string responsePolicyRule) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
        ...
        public virtual ListRequest List(string project, string location, string responsePolicy)
        {
            return new ListRequest(service, project, location, responsePolicy);
        }

        /// <summary>Enumerates all Response Policy Rules associated with a project.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicyRulesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string location, string responsePolicy) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
        ...
        /// User assigned name of the Response Policy Rule addressed by this request.
        /// </param>
        public virtual PatchRequest Patch(Google.Apis.Dns.v2.Data.ResponsePolicyRule body, string project, string location, string responsePolicy, string responsePolicyRule)
        {
            return new PatchRequest(service, body, project, location, responsePolicy, responsePolicyRule);
        }

        /// <summary>Applies a partial update to an existing Response Policy Rule.</summary>
        public class PatchRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicyRulesPatchResponse>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResponsePolicyRule body, string project, string location, string responsePolicy, string responsePolicyRule) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
        ...
        /// User assigned name of the Response Policy Rule addressed by this request.
        /// </param>
        public virtual UpdateRequest Update(Google.Apis.Dns.v2.Data.ResponsePolicyRule body, string project, string location, string responsePolicy, string responsePolicyRule)
        {
            return new UpdateRequest(service, body, project, location, responsePolicy, responsePolicyRule);
        }

        /// <summary>Updates an existing Response Policy Rule.</summary>
        public class UpdateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2.Data.ResponsePolicyRulesUpdateResponse>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2.Data.ResponsePolicyRule body, string project, string location, string responsePolicy, string responsePolicyRule) : base(service)
            {
                Project = project;
                Location = location;
                ResponsePolicy = responsePolicy;
