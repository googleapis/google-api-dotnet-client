    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public LocationsResource(Google.Apis.Services.IClientService service)
            {
                ...
                TeamFolders = new TeamFoldersResource(service);
            }
            ...
            public class FoldersResource
            {
                ...
                /// `projects/*/locations/*`.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.Folder body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a new Folder in a given project and location.</summary>
                public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Folder>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.Folder body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Dataform.v1.Data.Folder Body { get; set; }
                    ...
                    public override string RestPath => "v1/{+parent}/folders";
                ...
                /// <summary>Deletes a single Folder.</summary>
                public class DeleteRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Empty>
                {
                ...
                /// </param>
                public virtual DeleteTreeRequest DeleteTree(Google.Apis.Dataform.v1.Data.DeleteFolderTreeRequest body, string name)
                {
                    return new DeleteTreeRequest(this.service, body, name);
                }
                ...
                /// WorkflowConfigs).
                /// </summary>
                public class DeleteTreeRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Operation>
                {
                    /// <summary>Constructs a new DeleteTree request.</summary>
                    public DeleteTreeRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.DeleteFolderTreeRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.DeleteFolderTreeRequest Body { get; set; }

                    /// <summary>Returns the body of the request.</summary>
                    protected override object GetBody() => Body;

                    /// <summary>Gets the method name.</summary>
                    public override string MethodName => "deleteTree";

                    /// <summary>Gets the HTTP method.</summary>
                    public override string HttpMethod => "POST";

                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:deleteTree";

                    /// <summary>Initializes DeleteTree parameter list.</summary>
                    protected override void InitParameters()
                    {
                        base.InitParameters();
                        RequestParameters.Add("name", new Google.Apis.Discovery.Parameter
                ...
                /// <summary>Fetches a single Folder.</summary>
                public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Folder>
                {
                ...
                /// does not have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Policy>
                {
                ...
                public virtual MoveRequest Move(Google.Apis.Dataform.v1.Data.MoveFolderRequest body, string name)
                {
                    return new MoveRequest(this.service, body, name);
                }

                /// <summary>Moves a Folder to a new Folder, TeamFolder, or the root location.</summary>
                public class MoveRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Move request.</summary>
                    public MoveRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.MoveFolderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.MoveFolderRequest Body { get; set; }
                ...
                public virtual PatchRequest Patch(Google.Apis.Dataform.v1.Data.Folder body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates a single Folder.</summary>
                public class PatchRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Folder>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.Folder body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// <summary>Returns the contents of a given Folder.</summary>
                public class QueryFolderContentsRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryFolderContentsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+folder}:queryFolderContents";
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.Dataform.v1.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
                /// </summary>
                public class SetIamPolicyRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.Dataform.v1.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// checking. This operation may "fail open" without warning.
                /// </summary>
                public class TestIamPermissionsRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.TestIamPermissionsRequest Body { get; set; }
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.Dataform.v1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListOperationsResponse>
                {
            ...
            public class RepositoriesResource
            {
                ...
                public class CompilationResultsResource
                {
                    ...
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.CompilationResult body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new CompilationResult in a given project and location.</summary>
                    public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.CompilationResult>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.CompilationResult body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.CompilationResult Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/compilationResults";
                    ...
                    /// <summary>Fetches a single CompilationResult.</summary>
                    public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.CompilationResult>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists CompilationResults in a given Repository.</summary>
                    public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListCompilationResultsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                    ...
                    /// <summary>Returns CompilationResultActions in a given CompilationResult.</summary>
                    public class QueryRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryCompilationResultActionsResponse>
                    {
                ...
                public class ReleaseConfigsResource
                {
                    ...
                    /// `projects/*/locations/*/repositories/*`.
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.ReleaseConfig body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new ReleaseConfig in a given Repository.</summary>
                    public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ReleaseConfig>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.ReleaseConfig body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.ReleaseConfig Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/releaseConfigs";
                    ...
                    /// <summary>Fetches a single ReleaseConfig.</summary>
                    public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ReleaseConfig>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists ReleaseConfigs in a given Repository.</summary>
                    public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListReleaseConfigsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                    ...
                    public virtual PatchRequest Patch(Google.Apis.Dataform.v1.Data.ReleaseConfig body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }
                    ...
                    /// fields.*
                    /// </summary>
                    public class PatchRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ReleaseConfig>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.ReleaseConfig body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                ...
                public class WorkflowConfigsResource
                {
                    ...
                    /// `projects/*/locations/*/repositories/*`.
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.WorkflowConfig body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new WorkflowConfig in a given Repository.</summary>
                    public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.WorkflowConfig>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.WorkflowConfig body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.WorkflowConfig Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/workflowConfigs";
                    ...
                    /// <summary>Fetches a single WorkflowConfig.</summary>
                    public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.WorkflowConfig>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists WorkflowConfigs in a given Repository.</summary>
                    public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListWorkflowConfigsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                    ...
                    public virtual PatchRequest Patch(Google.Apis.Dataform.v1.Data.WorkflowConfig body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }
                    ...
                    /// fields.*
                    /// </summary>
                    public class PatchRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.WorkflowConfig>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.WorkflowConfig body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                ...
                public class WorkflowInvocationsResource
                {
                    ...
                    public virtual CancelRequest Cancel(Google.Apis.Dataform.v1.Data.CancelWorkflowInvocationRequest body, string name)
                    {
                        return new CancelRequest(this.service, body, name);
                    }

                    /// <summary>Requests cancellation of a running WorkflowInvocation.</summary>
                    public class CancelRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.CancelWorkflowInvocationResponse>
                    {
                        /// <summary>Constructs a new Cancel request.</summary>
                        public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.CancelWorkflowInvocationRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.CancelWorkflowInvocationRequest Body { get; set; }
                    ...
                    /// `projects/*/locations/*/repositories/*`.
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.WorkflowInvocation body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new WorkflowInvocation in a given Repository.</summary>
                    public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.WorkflowInvocation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.WorkflowInvocation body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.WorkflowInvocation Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/workflowInvocations";
                    ...
                    /// <summary>Fetches a single WorkflowInvocation.</summary>
                    public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.WorkflowInvocation>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists WorkflowInvocations in a given Repository.</summary>
                    public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListWorkflowInvocationsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                    ...
                    /// <summary>Returns WorkflowInvocationActions in a given WorkflowInvocation.</summary>
                    public class QueryRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryWorkflowInvocationActionsResponse>
                    {
                        /// <summary>Constructs a new Query request.</summary>
                        public QueryRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                ...
                public class WorkspacesResource
                {
                    ...
                    public virtual CommitRequest Commit(Google.Apis.Dataform.v1.Data.CommitWorkspaceChangesRequest body, string name)
                    {
                        return new CommitRequest(this.service, body, name);
                    }

                    /// <summary>Applies a Git commit for uncommitted files in a Workspace.</summary>
                    public class CommitRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.CommitWorkspaceChangesResponse>
                    {
                        /// <summary>Constructs a new Commit request.</summary>
                        public CommitRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.CommitWorkspaceChangesRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.CommitWorkspaceChangesRequest Body { get; set; }
                    ...
                    /// `projects/*/locations/*/repositories/*`.
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.Workspace body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new Workspace in a given Repository.</summary>
                    public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Workspace>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.Workspace body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.Workspace Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/workspaces";
                    ...
                    /// <summary>Fetches Git diff for an uncommitted file in a Workspace.</summary>
                    public class FetchFileDiffRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.FetchFileDiffResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:fetchFileDiff";
                    ...
                    /// <summary>Fetches Git statuses for the files in a Workspace.</summary>
                    public class FetchFileGitStatusesRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.FetchFileGitStatusesResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:fetchFileGitStatuses";
                    ...
                    /// <summary>Fetches Git ahead/behind against a remote branch.</summary>
                    public class FetchGitAheadBehindRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.FetchGitAheadBehindResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:fetchGitAheadBehind";
                    ...
                    /// <summary>Fetches a single Workspace.</summary>
                    public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Workspace>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual InstallNpmPackagesRequest InstallNpmPackages(Google.Apis.Dataform.v1.Data.InstallNpmPackagesRequest body, string workspace)
                    {
                        return new InstallNpmPackagesRequest(this.service, body, workspace);
                    }

                    /// <summary>Installs dependency NPM packages (inside a Workspace).</summary>
                    public class InstallNpmPackagesRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.InstallNpmPackagesResponse>
                    {
                        /// <summary>Constructs a new InstallNpmPackages request.</summary>
                        public InstallNpmPackagesRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.InstallNpmPackagesRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.InstallNpmPackagesRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:installNpmPackages";
                    ...
                    /// <summary>Lists Workspaces in a given Repository.</summary>
                    public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListWorkspacesResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual MakeDirectoryRequest MakeDirectory(Google.Apis.Dataform.v1.Data.MakeDirectoryRequest body, string workspace)
                    {
                        return new MakeDirectoryRequest(this.service, body, workspace);
                    }

                    /// <summary>Creates a directory inside a Workspace.</summary>
                    public class MakeDirectoryRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.MakeDirectoryResponse>
                    {
                        /// <summary>Constructs a new MakeDirectory request.</summary>
                        public MakeDirectoryRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.MakeDirectoryRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.MakeDirectoryRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:makeDirectory";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual MoveDirectoryRequest MoveDirectory(Google.Apis.Dataform.v1.Data.MoveDirectoryRequest body, string workspace)
                    {
                    ...
                    /// Moves a directory (inside a Workspace), and all of its contents, to a new location.
                    /// </summary>
                    public class MoveDirectoryRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.MoveDirectoryResponse>
                    {
                        /// <summary>Constructs a new MoveDirectory request.</summary>
                        public MoveDirectoryRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.MoveDirectoryRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.MoveDirectoryRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:moveDirectory";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual MoveFileRequest MoveFile(Google.Apis.Dataform.v1.Data.MoveFileRequest body, string workspace)
                    {
                        return new MoveFileRequest(this.service, body, workspace);
                    }

                    /// <summary>Moves a file (inside a Workspace) to a new location.</summary>
                    public class MoveFileRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.MoveFileResponse>
                    {
                        /// <summary>Constructs a new MoveFile request.</summary>
                        public MoveFileRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.MoveFileRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.MoveFileRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:moveFile";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The workspace's name.</param>
                    public virtual PullRequest Pull(Google.Apis.Dataform.v1.Data.PullGitCommitsRequest body, string name)
                    {
                        return new PullRequest(this.service, body, name);
                    }

                    /// <summary>Pulls Git commits from the Repository's remote into a Workspace.</summary>
                    public class PullRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.PullGitCommitsResponse>
                    {
                        /// <summary>Constructs a new Pull request.</summary>
                        public PullRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.PullGitCommitsRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.PullGitCommitsRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:pull";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The workspace's name.</param>
                    public virtual PushRequest Push(Google.Apis.Dataform.v1.Data.PushGitCommitsRequest body, string name)
                    {
                        return new PushRequest(this.service, body, name);
                    }

                    /// <summary>Pushes Git commits from a Workspace to the Repository's remote.</summary>
                    public class PushRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.PushGitCommitsResponse>
                    {
                        /// <summary>Constructs a new Push request.</summary>
                        public PushRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.PushGitCommitsRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.PushGitCommitsRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+name}:push";
                    ...
                    /// <summary>Returns the contents of a given Workspace directory.</summary>
                    public class QueryDirectoryContentsRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryDirectoryContentsResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:queryDirectoryContents";
                    ...
                    /// <summary>Returns the contents of a file (inside a Workspace).</summary>
                    public class ReadFileRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ReadFileResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:readFile";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual RemoveDirectoryRequest RemoveDirectory(Google.Apis.Dataform.v1.Data.RemoveDirectoryRequest body, string workspace)
                    {
                        return new RemoveDirectoryRequest(this.service, body, workspace);
                    }

                    /// <summary>Deletes a directory (inside a Workspace) and all of its contents.</summary>
                    public class RemoveDirectoryRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.RemoveDirectoryResponse>
                    {
                        /// <summary>Constructs a new RemoveDirectory request.</summary>
                        public RemoveDirectoryRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.RemoveDirectoryRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.RemoveDirectoryRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:removeDirectory";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual RemoveFileRequest RemoveFile(Google.Apis.Dataform.v1.Data.RemoveFileRequest body, string workspace)
                    {
                        return new RemoveFileRequest(this.service, body, workspace);
                    }

                    /// <summary>Deletes a file (inside a Workspace).</summary>
                    public class RemoveFileRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.RemoveFileResponse>
                    {
                        /// <summary>Constructs a new RemoveFile request.</summary>
                        public RemoveFileRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.RemoveFileRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.RemoveFileRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:removeFile";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The workspace's name.</param>
                    public virtual ResetRequest Reset(Google.Apis.Dataform.v1.Data.ResetWorkspaceChangesRequest body, string name)
                    {
                        return new ResetRequest(this.service, body, name);
                    }

                    /// <summary>Performs a Git reset for uncommitted files in a Workspace.</summary>
                    public class ResetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ResetWorkspaceChangesResponse>
                    {
                        /// <summary>Constructs a new Reset request.</summary>
                        public ResetRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.ResetWorkspaceChangesRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.ResetWorkspaceChangesRequest Body { get; set; }
                    ...
                    /// <summary>Finds the contents of a given Workspace directory by filter.</summary>
                    public class SearchFilesRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.SearchFilesResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:searchFiles";
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="workspace">Required. The workspace's name.</param>
                    public virtual WriteFileRequest WriteFile(Google.Apis.Dataform.v1.Data.WriteFileRequest body, string workspace)
                    {
                        return new WriteFileRequest(this.service, body, workspace);
                    }

                    /// <summary>Writes to a file (inside a Workspace).</summary>
                    public class WriteFileRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.WriteFileResponse>
                    {
                        /// <summary>Constructs a new WriteFile request.</summary>
                        public WriteFileRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.WriteFileRequest body, string workspace) : base(service)
                        {
                            Workspace = workspace;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Dataform.v1.Data.WriteFileRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+workspace}:writeFile";
                ...
                public virtual CommitRequest Commit(Google.Apis.Dataform.v1.Data.CommitRepositoryChangesRequest body, string name)
                {
                    return new CommitRequest(this.service, body, name);
                }
                ...
                /// `git_remote_settings.url`.
                /// </summary>
                public class CommitRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.CommitRepositoryChangesResponse>
                {
                    /// <summary>Constructs a new Commit request.</summary>
                    public CommitRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.CommitRepositoryChangesRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.CommitRepositoryChangesRequest Body { get; set; }
                ...
                /// <summary>Computes a Repository's Git access token status.</summary>
                public class ComputeAccessTokenStatusRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ComputeRepositoryAccessTokenStatusResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:computeAccessTokenStatus";
                ...
                /// `projects/*/locations/*`.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.Repository body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a new Repository in a given project and location.</summary>
                public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Repository>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.Repository body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.Repository Body { get; set; }
                ...
                /// `git_remote_settings.url`.
                /// </summary>
                public class FetchHistoryRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.FetchRepositoryHistoryResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:fetchHistory";
                ...
                /// <summary>Fetches a Repository's remote branches.</summary>
                public class FetchRemoteBranchesRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.FetchRemoteBranchesResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:fetchRemoteBranches";
                ...
                /// <summary>Fetches a single Repository.</summary>
                public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Repository>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// not shown in the [Dataform UI](https://console.cloud.google.com/bigquery/dataform)*.
                /// </summary>
                public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListRepositoriesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                public virtual MoveRequest Move(Google.Apis.Dataform.v1.Data.MoveRepositoryRequest body, string name)
                {
                    return new MoveRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Move request.</summary>
                    public MoveRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.MoveRepositoryRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.MoveRepositoryRequest Body { get; set; }
                ...
                public virtual PatchRequest Patch(Google.Apis.Dataform.v1.Data.Repository body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                /// the `field_mask` is omitted, the request is treated as a full update on all modifiable fields.*
                /// </summary>
                public class PatchRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Repository>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.Repository body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// `git_remote_settings.url`.
                /// </summary>
                public class QueryDirectoryContentsRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryRepositoryDirectoryContentsResponse>
                {
                    /// <summary>Constructs a new QueryDirectoryContents request.</summary>
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:queryDirectoryContents";
                ...
                /// `git_remote_settings.url`.
                /// </summary>
                public class ReadFileRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ReadRepositoryFileResponse>
                {
                    /// <summary>Constructs a new ReadFile request.</summary>
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+name}:readFile";
            ...
            /// <summary>Gets the TeamFolders resource.</summary>
            public virtual TeamFoldersResource TeamFolders { get; }

            /// <summary>The "teamFolders" collection of methods.</summary>
            public class TeamFoldersResource
            {
                private const string Resource = "teamFolders";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public TeamFoldersResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
                ...
                /// `projects/*/locations/*`.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Dataform.v1.Data.TeamFolder body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a new TeamFolder in a given project and location.</summary>
                public class CreateRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.TeamFolder>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.TeamFolder body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.TeamFolder Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/teamFolders";
                ...
                /// </param>
                public virtual DeleteTreeRequest DeleteTree(Google.Apis.Dataform.v1.Data.DeleteTeamFolderTreeRequest body, string name)
                {
                    return new DeleteTreeRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new DeleteTree request.</summary>
                    public DeleteTreeRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.DeleteTeamFolderTreeRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Dataform.v1.Data.DeleteTeamFolderTreeRequest Body { get; set; }
                ...
                /// <summary>Fetches a single TeamFolder.</summary>
                public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.TeamFolder>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                public virtual PatchRequest Patch(Google.Apis.Dataform.v1.Data.TeamFolder body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates a single TeamFolder.</summary>
                public class PatchRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.TeamFolder>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.TeamFolder body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// <summary>Returns the contents of a given TeamFolder.</summary>
                public class QueryContentsRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryTeamFolderContentsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+teamFolder}:queryContents";
                ...
                /// filter.
                /// </summary>
                public class SearchRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.SearchTeamFoldersResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+location}/teamFolders:search";
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Get default config for a given project and location.</summary>
            public class GetConfigRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Config>
            {
            ...
            /// specific service implementation and version.
            /// </summary>
            public class ListRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// resources that are created by the user and not contained in any other folder.
            /// </summary>
            public class QueryUserRootContentsRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.QueryUserRootContentsResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1/{+location}:queryUserRootContents";
            ...
            public virtual UpdateConfigRequest UpdateConfig(Google.Apis.Dataform.v1.Data.Config body, string name)
            {
            ...
            /// `field_mask` is omitted, the request is treated as a full update on all modifiable fields.*
            /// </summary>
            public class UpdateConfigRequest : DataformBaseServiceRequest<Google.Apis.Dataform.v1.Data.Config>
            {
                /// <summary>Constructs a new UpdateConfig request.</summary>
                public UpdateConfigRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataform.v1.Data.Config body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dataform.v1.Data.Config Body { get; set; }
...
namespace Google.Apis.Dataform.v1.Data
{
    ...
    /// <summary>`DeleteFolderTree` request message.</summary>
    public class DeleteFolderTreeRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. If `false` (default): The operation will fail if any Repository within the folder hierarchy has
        /// associated Release Configs or Workflow Configs. If `true`: The operation will attempt to delete everything,
        /// including any Release Configs and Workflow Configs linked to Repositories within the folder hierarchy. This
    ...
    public class GitRemoteSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. Deprecated: The field does not contain any token status information.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("tokenStatus")]
        public virtual string TokenStatus { get; set; }
    ...
    public class InvocationConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. Specifies the priority for query execution in BigQuery. More information can be found at
        /// https://cloud.google.com/bigquery/docs/running-queries#queries.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("queryPriority")]
        public virtual string QueryPriority { get; set; }
    ...
    /// <summary>Configures workspace compilation overrides for a repository.</summary>
