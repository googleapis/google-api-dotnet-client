...
namespace Google.Apis.BigQueryReservation.v1alpha2
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class ReservationsResource
            {
                ...
                public class SlotPoolsResource
                {
                    ...
                    public class ListRequest : BigQueryReservationBaseServiceRequest<Google.Apis.BigQueryReservation.v1alpha2.Data.ListSlotPoolsResponse>
                    {
                        ...
                        /// <summary>
                        /// Resource name of the parent reservation. Only top-level reservations can have slot pools.
                        /// E.g., projects/myproject/locations/us-central1/reservations/my_reservation
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }
                ...
                /// <summary>
                /// Creates a new reservation resource. Multiple reservations are created if the ancestor reservations
                /// do not exist.
                /// </summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">
                ...
                /// <summary>
                /// Deletes a reservation. Returns `google.rpc.Code.FAILED_PRECONDITION` in the following cases: 1. When
                /// reservation has child reservations. This check can be bypassed by setting
                ...
                public class PatchRequest : BigQueryReservationBaseServiceRequest<Google.Apis.BigQueryReservation.v1alpha2.Data.Reservation>
                {
                    ...
                    /// "dev/team/product") exceeding a depth of six will fail with `google.rpc.Code.INVALID_ARGUMENT`.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            /// <summary>
            /// Look up grants for a specified resource for a particular region. If the request is about a project: 1)
            /// Grants created on the project will be returned if they exist. 2) Otherwise grants created on the closest
            /// ancestor will be returned. 3) Grants for different JobTypes will all be returned. Same logic applies if
            /// the request is about a folder. If the request is about an organization, then grants created on the
            /// organization will be returned (organization doesn't have ancestors). Comparing to ListReservationGrants,
            /// there are two behavior differences: 1) permission on the grantee will be verified in this API. 2)
...
namespace Google.Apis.BigQueryReservation.v1alpha2.Data
{
    ...
    public class Reservation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Maximum slots available to this reservation and its children. A slot is a unit of computational power in
        /// BigQuery, and serves as the unit of parallelism. In a scan of a multi-partitioned table, a single slot
        /// operates on a single partition of the table. If the new reservation's slot capacity exceed the parent's slot
        /// capacity or if total slot capacity of the new reservation and its siblings exceeds the parent's slot
        ...
        /// <summary>
        /// If true, any query using this reservation will also be submitted to the parent reservation. This allows the
        /// query to share the additional slot capacity of the parent with other queries in the parent reservation. If
        /// the parent also has this field set to true, then this process will continue until it encounters a
        /// reservation for which this is false. If false, a query using this reservation will execute with the maximum
        /// slot capacity as specified above. If not specified, default value is true. Ignored for top-level
        /// reservation.
        /// </summary>
    ...
    public class ReservationGrant : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Resource name of the reservation. E.g., projects/myproject/locations/eu/reservations/my_reservation. This
        /// reservation must be in the same location as the grant. This reservation should belong to the same parent
        /// project.
        /// </summary>
    ...
    /// <summary>
    /// Slot pool is a way to purchase slots with some minimum committed period of usage. Slot pool is immutable and
    /// cannot be deleted until the end of the commitment period. After the end of the commitment period, slots are
    /// still available but can be freely removed any time. Annual commitments will automatically be downgraded to
    /// monthly after the commitment ends. A slot pool resource exists as a child resource of a top-level reservation.
    /// Sum of all the ACTIVE pools slot_count is always equal to the reservation slot_capacity.
    /// </summary>
    public class SlotPool : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. The end of the commitment period. Slot pool cannot be removed before commitment_end_time. It is
        /// applicable only for ACTIVE slot pools and is computed as a combination of the plan and the time when the
