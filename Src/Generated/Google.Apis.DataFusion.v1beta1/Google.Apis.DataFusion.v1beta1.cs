        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                public class NamespacesResource
                {
                    ...
                    public class SetIamPolicyRequest : DataFusionBaseServiceRequest<Google.Apis.DataFusion.v1beta1.Data.Policy>
                    {
                        ...
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.SetIamPolicyRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                    ...
                    public class TestIamPermissionsRequest : DataFusionBaseServiceRequest<Google.Apis.DataFusion.v1beta1.Data.TestIamPermissionsResponse>
                    {
                        ...
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.TestIamPermissionsRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.Instance body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                ...
                public class PatchRequest : DataFusionBaseServiceRequest<Google.Apis.DataFusion.v1beta1.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.Instance body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// supported fields (labels and options currently) will be overwritten.
                    /// </summary>
                ...
                public class RestartRequest : DataFusionBaseServiceRequest<Google.Apis.DataFusion.v1beta1.Data.Operation>
                {
                    ...
                    public RestartRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.RestartInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+name}:restart";
                ...
                public class UpgradeRequest : DataFusionBaseServiceRequest<Google.Apis.DataFusion.v1beta1.Data.Operation>
                {
                    ...
                    public UpgradeRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.UpgradeInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : DataFusionBaseServiceRequest<Google.Apis.DataFusion.v1beta1.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.DataFusion.v1beta1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
...
namespace Google.Apis.DataFusion.v1beta1.Data
{
    ...
    {
        /// <summary>
        /// Optional. Option to enable the InstanceV2 logging for this instance. This field is supported only in CDF
        /// patch revision versions 6.11.1.1 and above.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enableInstanceV2Logs")]
        public virtual System.Nullable<bool> EnableInstanceV2Logs { get; set; }
    ...
    /// <summary>
    /// Request message for upgrading a Data Fusion instance. To change the instance properties, instance update should
    /// be used.
    /// </summary>
