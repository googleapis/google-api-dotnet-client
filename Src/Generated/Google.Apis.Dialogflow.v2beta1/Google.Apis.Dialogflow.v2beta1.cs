...
{    
    ...
    public class QueryResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// You should not rely on this field as it isn't guaranteed to be accurate, or even set. In particular this
        /// field isn't set in Webhook calls and for StreamingDetectIntent since the streaming endpoint has separate
        /// confidence estimates per portion of the audio in StreamingRecognitionResult.</summary>
