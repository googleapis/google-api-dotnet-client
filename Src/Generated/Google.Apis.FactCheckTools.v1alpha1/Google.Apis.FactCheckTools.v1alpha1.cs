...
namespace Google.Apis.FactCheckTools.v1alpha1
{
    ...
    public class FactCheckToolsService : Google.Apis.Services.BaseClientService
    {
        ...
        public FactCheckToolsService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public FactCheckToolsService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class FactCheckToolsBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected FactCheckToolsBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
    ...
    public class PagesResource
    {
        ...
        public class CreateRequest : FactCheckToolsBaseServiceRequest<Google.Apis.FactCheckTools.v1alpha1.Data.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage>
        {
            ...
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.FactCheckTools.v1alpha1.Data.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage body)
                : base(service)
            {
                Body = body;
                InitParameters();
        ...
        public class UpdateRequest : FactCheckToolsBaseServiceRequest<Google.Apis.FactCheckTools.v1alpha1.Data.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage>
        {
            ...
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.FactCheckTools.v1alpha1.Data.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
