...
namespace Google.Apis.FactCheckTools.v1alpha1
{
    ...
    public class ClaimsResource
    {
        ...
        public class SearchRequest : FactCheckToolsBaseServiceRequest<Google.Apis.FactCheckTools.v1alpha1.Data.GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse>
        {
            ...
            /// <summary>
            /// The BCP-47 language code, such as "en-US" or "sr-Latn". Can be used to restrict results by language,
            /// though we do not currently consider the region.
            /// </summary>
            ...
            /// field is only considered if `page_token` is unset. For example, 0 means to return results starting from
            ...
            /// <summary>
            /// The pagination token. You may provide the `next_page_token` returned from a previous List request, if
    ...
    public class PagesResource
    {
        ...
        public class ListRequest : FactCheckToolsBaseServiceRequest<Google.Apis.FactCheckTools.v1alpha1.Data.GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse>
        {
            ...
            /// <summary>
            /// An integer that specifies the current offset (that is, starting result location) in search results. This
            /// field is only considered if `page_token` is unset, and if the request is not for a specific URL. For
            /// example, 0 means to return results starting from the first matching result, and 10 means to return from
            /// the 11th result.
            /// </summary>
            [Google.Apis.Util.RequestParameterAttribute("offset", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<int> Offset { get; set; }
            ...
            /// <summary>
            /// The organization for which we want to fetch markups for. For instance, "site.com". Cannot be specified
            /// along with an URL.
            /// </summary>
            ...
            /// <summary>
            /// The pagination size. We will return up to that many results. Defaults to 10 if not set. Has no effect if
            /// a URL is requested.
            /// </summary>
            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<int> PageSize { get; set; }
        ...
        /// <summary>
        /// Update for all `ClaimReview` markup on a page Note that this is a full update. To retain the existing
        /// `ClaimReview` markup on a page, first perform a Get operation, then modify the returned markup, and finally
        /// call Update with the entire `ClaimReview` markup as the body.
        /// </summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="name">
        /// The name of this `ClaimReview` markup page resource, in the form of `pages/{page_id}`. Except for update
...
namespace Google.Apis.FactCheckTools.v1alpha1.Data
{
    ...
    /// <summary>
    /// Fields for an individual `ClaimReview` element. Except for sub-messages that group fields together, each of
    ...
    public class GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `claim_first_appearance`. Corresponds to `ClaimReview.itemReviewed[@type=Claim].appearance.url`.
        /// </summary>
        ...
        /// <summary>
        /// This field is optional, and will default to the page URL. We provide this field to allow you the override
        /// the default value, but the only permitted override is the page URL plus an optional anchor link ("page
    ...
    {
        /// <summary>
        /// Info about the author of this claim review. Similar to the above, semantically these are page-level fields,
        /// and each `ClaimReview` on this page will contain the same values.
        /// </summary>
        ...
        /// <summary>
        /// The URL of the page associated with this `ClaimReview` markup. While every individual `ClaimReview` has its
        /// own URL field, semantically this is a page-level field, and each `ClaimReview` on this page will use this
        /// value unless individually overridden. Corresponds to `ClaimReview.url`
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pageUrl")]
        public virtual string PageUrl { get; set; }

        /// <summary>
        /// The date when the fact check was published. Similar to the URL, semantically this is a page-level field, and
        /// each `ClaimReview` on this page will contain the same value. Corresponds to `ClaimReview.datePublished`
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("publishDate")]
        public virtual string PublishDate { get; set; }

        /// <summary>
        /// The version ID for this markup. Except for update requests, this field is output-only and should not be set
        /// by the user.
        /// </summary>
    ...
    public class GoogleFactcheckingFactchecktoolsV1alpha1Publisher : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Host-level site name, without the protocol or "www" prefix. For instance, "awesomefactchecks.com". This
        /// value of this field is based purely on the claim review URL.
        /// </summary>
