...
namespace Google.Apis.Merchant.notifications_v1beta
{
    ...
    public class AccountsResource
    {
        ...
        public class NotificationsubscriptionsResource
        {
            ...
            /// <summary>
            /// Creates a notification subscription for a business. For standalone or sub-accounts, the business can
            /// create a subscription for self. For advanced accounts, the business can create a subscription for all
            /// managed accounts or for a specific subaccount. See [Decode
            ...
            /// Subscription for all managed accounts + subscription for self. 2. Multiple "partial" subscriptions for
            /// managed accounts + subscription for self. we will not allow (per business as a subscriber per event
            /// type): 1. Multiple self subscriptions. 2. Multiple "all managed accounts" subscriptions. 3. "All managed
            /// accounts" subscription and partial subscriptions at the same time. 4. Multiple partial subscriptions for
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">
            /// Output only. The `name` of the notification configuration. Generated by the Merchant API upon creation
            /// of a new `NotificationSubscription`. The `account` represents the merchant ID of the merchant that owns
            /// the configuration. Format: `accounts/{account}/notificationsubscriptions/{notification_subscription}`
            /// </param>
...
namespace Google.Apis.Merchant.notifications_v1beta.Data
{
    ...
    /// notifications](/merchant/api/guides/accounts/notifications#decode_notifications) for information on how to
    /// decode the notification payload and how to interpret its contents.
    /// </summary>
    public class NotificationSubscription : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. The `name` of the notification configuration. Generated by the Merchant API upon creation of a
