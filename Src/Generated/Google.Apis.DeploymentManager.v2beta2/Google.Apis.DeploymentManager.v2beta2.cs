...
/**
 * \brief
 *   Google Cloud Deployment Manager API Version v2beta2
 *
...
namespace Google.Apis.DeploymentManager.v2beta2
{
    ...
    public class DeploymentManagerService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            get { return "https://www.googleapis.com/deploymentmanager/v2beta2/projects/"; }
        }

        /// <summary>Gets the service base path.</summary>
        public override string BasePath
        {
            get { return "deploymentmanager/v2beta2/projects/"; }
        }
    ...
    public class DeploymentsResource
    {
        ...
        /// <summary>Deletes a deployment and all of the resources in the deployment.</summary>
        public class DeleteRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Operation>
        {
        ...
        /// <summary>Gets information about a specific deployment.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Deployment>
        {
        ...
        /// <param name="project">The project ID for this request.</param>
        public virtual InsertRequest Insert(Google.Apis.DeploymentManager.v2beta2.Data.Deployment body, string project)
        {
            return new InsertRequest(service, body, project);
        }

        /// <summary>Creates a deployment and all of the resources described by the deployment manifest.</summary>
        public class InsertRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Operation>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.v2beta2.Data.Deployment body, string project)
                : base(service)
            {
                Project = project;
                Body = body;
            ...
            Google.Apis.DeploymentManager.v2beta2.Data.Deployment Body { get; set; }
        ...
        /// <summary>Lists all deployments for a given project.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.DeploymentsListResponse>
        {
        ...
        /// <param name="deployment">The name of the
        /// deployment for this request.</param>
        public virtual PatchRequest Patch(Google.Apis.DeploymentManager.v2beta2.Data.Deployment body, string project, string deployment)
        {
        ...
        /// <summary>Updates a deployment and all of the resources described by the deployment manifest. This method
        /// supports patch semantics.</summary>
        public class PatchRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Operation>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.v2beta2.Data.Deployment body, string project, string deployment)
                : base(service)
            {
                Project = project;
                Deployment = deployment;
            ...
            /// <summary>Sets the policy to use for updating resources.</summary>
            /// [default: PATCH]
            [Google.Apis.Util.RequestParameterAttribute("updatePolicy", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<UpdatePolicyEnum> UpdatePolicy { get; set; }
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add(
                    "updatePolicy", new Google.Apis.Discovery.Parameter
                    {
                        Name = "updatePolicy",
                        IsRequired = false,
                        ParameterType = "query",
        ...
        /// <param name="deployment">The name of the
        /// deployment for this request.</param>
        public virtual UpdateRequest Update(Google.Apis.DeploymentManager.v2beta2.Data.Deployment body, string project, string deployment)
        {
            return new UpdateRequest(service, body, project, deployment);
        }

        /// <summary>Updates a deployment and all of the resources described by the deployment manifest.</summary>
        public class UpdateRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Operation>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.DeploymentManager.v2beta2.Data.Deployment body, string project, string deployment)
                : base(service)
            {
                Project = project;
                Deployment = deployment;
    ...
    public class ManifestsResource
    {
        ...
        /// <summary>Gets information about a specific manifest.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Manifest>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists all manifests for a given deployment.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.ManifestsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
    ...
    public class OperationsResource
    {
        ...
        /// <summary>Gets information about a specific operation.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Operation>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists all operations for a project.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.OperationsListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project)
                : base(service)
    ...
    public class ResourcesResource
    {
        ...
        /// <summary>Gets information about a single resource.</summary>
        public class GetRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.Resource>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists all resources in a given deployment.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.ResourcesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string deployment)
                : base(service)
    ...
    public class TypesResource
    {
        ...
        /// <summary>Lists all resource types for Deployment Manager.</summary>
        public class ListRequest : DeploymentManagerBaseServiceRequest<Google.Apis.DeploymentManager.v2beta2.Data.TypesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project)
                : base(service)
...
namespace Google.Apis.DeploymentManager.v2beta2.Data
{    
    ...
    public class Deployment : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Specifies a fingerprint for update() requests. A fingerprint is a randomly generated value that
        /// must be provided in update() requests to perform optimistic locking. This ensures optimistic concurrency so
        /// that only one update can be performed at a time. The fingerprint is initially generated by Deployment
        /// Manager and changes after every request to modify data. To get the latest fingerprint value, perform a get()
        /// request to a deployment.</summary>
        ...
        /// <summary>[Input Only] Specifies how Deployment Manager should apply this template. Possible options are
        /// PREVIEW, UPDATE, and CANCEL.
        ///
        /// PREVIEW creates a deployment and creates "shell" resources but does not actually instantiate these
        /// resources. This allows you to preview what your deployment looks like. You can use this intent to preview
        /// updates to deployments or preview new deployments. You must provide a target.config with a configuration for
        /// this intent. After previewing a deployment, you can deploy your resources by making a request with the
        /// UPDATE intent or you can CANCEL the preview altogether. Note that the deployment will still exist after you
        /// cancel the preview and you must separately delete this deployment if you want to remove it.
        ///
        /// UPDATE performs an update to the underlying resources in a deployment. If you provide a populated
        /// target.config field with this request, Deployment Manager uses that configuration to perform an update. If
        /// you had previewed this update beforehand, and do not supply a target.config or provide an empty
        /// target.config, Deployment Manager uses the last previewed configuration.
        ///
        /// CANCEL cancels an update that is in PREVIEW or UPDATE but does not undo any changes already made.</summary>
        ...
        /// <summary>[Output Only] The current state of the deployment. This can be DEPLOYED, DEPLOYMENT_FAILED,
        /// PREVIEWING, UPDATING, and CANCELING.</summary>
        ...
        /// <summary>[Output Only] Timestamp when the deployment was updated, in RFC3339 text format .</summary>
    ...
    {
        /// <summary>[Output Only] List of all errors encountered while trying to enact the update.</summary>
    ...
    {
        /// <summary>[Output Only] List of all errors encountered while trying to enact update.intent.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("errors")]
        public virtual System.Collections.Generic.IList<string> Errors { get; set; } 
