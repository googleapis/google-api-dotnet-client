...
{    
    ...
    public class File : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// inserted through the API. Note that renames of the title will not change the original filename. This field
        /// is only populated for files with content stored in Drive; it is not populated for Google Docs or shortcut
        /// files.</summary>
