...
namespace Google.Apis.Logging.v2
{
    ...
    public class EntriesResource
    {
        ...
        /// <summary>Writes log entries to Stackdriver Logging. This API method is the only way to send log entries to
        /// Stackdriver Logging. This method is used, directly or indirectly, by the Stackdriver Logging agent (fluentd)
        /// and all logging libraries configured to use Stackdriver Logging. A single request may contain log entries
        /// for a maximum of 1000 different resources (projects, organizations, billing accounts or folders)</summary>
        /// <param name="body">The body of the request.</param>
...
{    
    ...
    public class WriteLogEntriesRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// more than the logs retention period in the past or more than 24 hours in the future will not be available
        /// when calling entries.list. However, those log entries can still be exported with LogSinks.To improve
        /// throughput and to avoid exceeding the quota limit for calls to entries.write, you should try to include
        /// several log entries in this list, rather than calling this method for each individual log entry.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("entries")]
        public virtual System.Collections.Generic.IList<LogEntry> Entries { get; set; } 
