        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
...
namespace Google.Apis.CloudMemorystoreforMemcached.v1.Data
{
    ...
    public class GoogleCloudMemcacheV1LocationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
