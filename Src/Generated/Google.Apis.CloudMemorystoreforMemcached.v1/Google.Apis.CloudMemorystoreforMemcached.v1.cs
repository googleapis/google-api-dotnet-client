...
namespace Google.Apis.CloudMemorystoreforMemcached.v1
{
    ...
    public class CloudMemorystoreforMemcachedService : Google.Apis.Services.BaseClientService
    {
        ...
        public CloudMemorystoreforMemcachedService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public CloudMemorystoreforMemcachedService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class CloudMemorystoreforMemcachedBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected CloudMemorystoreforMemcachedBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                public class ApplyParametersRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Operation>
                {
                    ...
                    public ApplyParametersRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1.Data.ApplyParametersRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Required. Resource name of the Memcached instance for which parameter group updates
                    /// should be applied.</summary>
                ...
                public class CreateRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1.Data.Instance body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                ...
                public class ListRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.ListInstancesResponse>
                {
                    ...
                    /// <summary>List filter. For example, exclude all Memcached instances with name as my-instance by
                    /// specifying "name != my-instance".</summary>
                ...
                public class PatchRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1.Data.Instance body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// <summary>Updates the defined Memcached Parameters for an existing Instance. This method only stages
                /// the parameters, it must be followed by ApplyParameters to apply the parameters to nodes of the
                /// Memcached Instance.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. Resource name of the Memcached instance for which the parameters should be
                /// updated.</param>
                ...
                public class UpdateParametersRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Operation>
                {
                    ...
                    public UpdateParametersRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1.Data.UpdateParametersRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Required. Resource name of the Memcached instance for which the parameters should be
                    /// updated.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            public class OperationsResource
            {
                ...
                /// operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to
                /// `Code.CANCELLED`.</summary>
                public class CancelRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudMemorystoreforMemcached.v1.Data.CancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudMemorystoreforMemcached.v1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// interested in the operation result. It does not cancel the operation. If the server doesn't support
                /// this method, it returns `google.rpc.Code.UNIMPLEMENTED`.</summary>
                public class DeleteRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name)
                        : base(service)
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : CloudMemorystoreforMemcachedBaseServiceRequest<Google.Apis.CloudMemorystoreforMemcached.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
...
{    
    ...
    {
        /// <summary>Whether to apply instance-level parameter group to all nodes. If set to true, will explicitly
        /// restrict users from specifying any nodes, and apply parameter group updates to all nodes within the
        /// instance.</summary>
    ...
    public class Instance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The full version of memcached server running on this instance. System automatically
        /// determines the full memcached version for an instance based on the input MemcacheVersion. The full version
        /// format will be "memcached-1.5.16".</summary>
    ...
    public class LocationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// each zone, as defined by GCE. These keys can be specified in the `zones` field when creating a Memcached
        /// instance.</summary>
    ...
    {
        /// <summary>Output only. The unique ID associated with this set of parameters. Users can use this id to
        /// determine if the parameters associated with the instance differ from the parameters associated with the
        /// nodes and any action needs to be taken to apply parameters on nodes.</summary>
    ...
    {
        /// <summary>Output only. Hostname or IP address of the Memcached node used by the clients to connect to the
        /// Memcached server on this node.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("host")]
        public virtual string Host { get; set; } 

        /// <summary>Output only. Identifier of the Memcached node. The node id does not include project or location
        /// like the Memcached instance name.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nodeId")]
        public virtual string NodeId { get; set; } 
