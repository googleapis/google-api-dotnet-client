...
namespace Google.Apis.ServiceDirectory.v1
{
    ...
    public class ServiceDirectoryService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://servicedirectory.googleapis.com/";
...
namespace Google.Apis.ServiceDirectory.v1.Data
{
    ...
    public class Endpoint : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `metadata` field in the v1beta1 API. They have the same syntax and read/write to the same location in
        /// Service Directory.
        /// </summary>
        ...
        /// <summary>Output only. The globally unique identifier of the endpoint in the UUID4 format.</summary>
    ...
    public class Namespace : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The globally unique identifier of the namespace in the UUID4 format.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uid")]
        public virtual string Uid { get; set; }
    ...
    public class ResolveServiceRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// annotations.foo=bar` returns endpoints that have `owner` in annotation key but value is not `sd` AND have
        /// key/value `foo=bar` * `doesnotexist.foo=bar` returns an empty list. Note that endpoint doesn't have a field
        /// called "doesnotexist". Since the filter does not match any endpoint, it returns no results For more
    ...
    public class Service : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The globally unique identifier of the service in the UUID4 format.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uid")]
        public virtual string Uid { get; set; }
