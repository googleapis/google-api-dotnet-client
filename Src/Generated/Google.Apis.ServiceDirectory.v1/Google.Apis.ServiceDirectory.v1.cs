...
namespace Google.Apis.ServiceDirectory.v1
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class NamespacesResource
            {
                ...
                public class ServicesResource
                {
                    ...
                    public class EndpointsResource
                    {
                        ...
                        /// <summary>Creates a endpoint, and returns the new Endpoint.</summary>
                        public class CreateRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Endpoint>
                        {
                            /// <summary>Constructs a new Create request.</summary>
                            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.Endpoint body, string parent) : base(service)
                            {
                                Parent = parent;
                                Body = body;
                                InitParameters();
                            ...
                            /// <summary>Required. The resource name of the service that this endpoint
                            /// provides.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }

                            /// <summary>Required. The Resource ID must be 1-63 characters long, and comply with
                            /// RFC1035. Specifically, the name must be 1-63 characters long and match the regular
                            /// expression `[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?` which means the first character must be a
                            /// lowercase letter, and all following characters must be a dash, lowercase letter, or
                            /// digit, except the last character, which cannot be a dash.</summary>
                            ...
                            Google.Apis.ServiceDirectory.v1.Data.Endpoint Body { get; set; }
                        ...
                        /// <summary>Deletes a endpoint.</summary>
                        public class DeleteRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Empty>
                        {
                        ...
                        /// <summary>Gets a endpoint.</summary>
                        public class GetRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Endpoint>
                        {
                        ...
                        /// <param name="parent">Required. The resource name of the service whose endpoints we'd like to list.</param>
                        ...
                        /// <summary>Lists all endpoints.</summary>
                        public class ListRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.ListEndpointsResponse>
                        {
                            ...
                            /// <summary>Required. The resource name of the service whose endpoints we'd like to
                            /// list.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }
                        ...
                        /// <param name="body">The body of the request.</param>
                        /// <param name="name">Immutable. The resource name for the endpoint in the format
                        ...
                        /// <summary>Updates a endpoint.</summary>
                        public class PatchRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Endpoint>
                        {
                            /// <summary>Constructs a new Patch request.</summary>
                            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.Endpoint body, string name) : base(service)
                            {
                                Name = name;
                                Body = body;
                                InitParameters();
                            ...
                            /// <summary>Immutable. The resource name for the endpoint in the format
                            /// 'projects/locations/namespaces/services/endpoints'.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Name { get; private set; }
                    ...
                    /// <summary>Creates a service, and returns the new Service.</summary>
                    public class CreateRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Service>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.Service body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Required. The Resource ID must be 1-63 characters long, and comply with RFC1035.
                    ...
                    /// <summary>Deletes a service. This also deletes all endpoints associated with the
                    /// service.</summary>
                    ...
                    /// <summary>Gets a service.</summary>
                    public class GetRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Service>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Gets the IAM Policy for a resource (namespace or service only).</summary>
                    public class GetIamPolicyRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Policy>
                    {
                        /// <summary>Constructs a new GetIamPolicy request.</summary>
                        public GetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.GetIamPolicyRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.ServiceDirectory.v1.Data.GetIamPolicyRequest Body { get; set; }
                    ...
                    /// <param name="parent">Required. The resource name of the namespace whose services we'd like to list.</param>
                    public virtual ListRequest List(string parent)
                    {
                        return new ListRequest(service, parent);
                    }
                    ...
                    /// <summary>Lists all services belonging to a namespace.</summary>
                    public class ListRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.ListServicesResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// <summary>Required. The resource name of the namespace whose services we'd like to
                        /// list.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }
                        ...
                        /// not be. * "metadata.owner!=sd AND metadata.foo=bar" returns Services that have "owner" in
                        /// label key but value is not "sd" AND have key/value foo=bar. * "doesnotexist.foo=bar" returns
                        /// an empty list. Note that Service doesn't have a field called "doesnotexist". Since the
                        /// filter does not match any Services, it returns no results.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("filter", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual string Filter { get; set; }
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Immutable. The resource name for the service in the format
                    /// 'projects/locations/namespaces/services'.</param>
                    ...
                    /// <summary>Updates a service.</summary>
                    public class PatchRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Service>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.Service body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Immutable. The resource name for the service in the format
                        /// 'projects/locations/namespaces/services'.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    /// <summary>Returns a service and its associated endpoints. Resolving a service is not considered
                    /// an active developer method.</summary>
                    /// <param name="body">The body of the request.</param>
                    ...
                    /// <summary>Returns a service and its associated endpoints. Resolving a service is not considered
                    /// an active developer method.</summary>
                    public class ResolveRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.ResolveServiceResponse>
                    {
                        /// <summary>Constructs a new Resolve request.</summary>
                        public ResolveRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.ResolveServiceRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.ServiceDirectory.v1.Data.ResolveServiceRequest Body { get; set; }
                    ...
                    /// <summary>Sets the IAM Policy for a resource (namespace or service only).</summary>
                    public class SetIamPolicyRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Policy>
                    {
                        /// <summary>Constructs a new SetIamPolicy request.</summary>
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.SetIamPolicyRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.ServiceDirectory.v1.Data.SetIamPolicyRequest Body { get; set; }
                    ...
                    /// <summary>Tests IAM permissions for a resource (namespace or service only).</summary>
                    public class TestIamPermissionsRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.TestIamPermissionsResponse>
                    {
                        /// <summary>Constructs a new TestIamPermissions request.</summary>
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.TestIamPermissionsRequest body, string resource) : base(service)
                        {
                            Resource = resource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.ServiceDirectory.v1.Data.TestIamPermissionsRequest Body { get; set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Required. The resource name of the project and location the namespace will be created
                /// in.</param>
                ...
                /// <summary>Creates a namespace, and returns the new Namespace.</summary>
                public class CreateRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Namespace>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.Namespace body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Required. The resource name of the project and location the namespace will be created
                    /// in.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.ServiceDirectory.v1.Data.Namespace Body { get; set; }
                ...
                /// <summary>Deletes a namespace. This also deletes all services and endpoints in the
                /// namespace.</summary>
                ...
                /// <summary>Gets a namespace.</summary>
                public class GetRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Namespace>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <param name="parent">Required. The resource name of the project and location whose namespaces we'd like to
                /// list.</param>
                public virtual ListRequest List(string parent)
                {
                    return new ListRequest(service, parent);
                ...
                /// <summary>Lists all namespaces.</summary>
                public class ListRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.ListNamespacesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Required. The resource name of the project and location whose namespaces we'd like to
                    /// list.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Immutable. The resource name for the namespace in the format
                ...
                /// <summary>Updates a namespace.</summary>
                public class PatchRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Namespace>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceDirectory.v1.Data.Namespace body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Immutable. The resource name for the namespace in the format
                    /// 'projects/locations/namespaces'.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : ServiceDirectoryBaseServiceRequest<Google.Apis.ServiceDirectory.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
...
{    
    ...
    /// <summary>An individual endpoint that provides a service. The service must already exist to create an
    /// endpoint.</summary>
    public class Endpoint : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. An IPv4 or IPv6 address. Service Directory will reject bad addresses like: "8.8.8"
        /// "8.8.8.8:53" "test:bad:address" "[::1]" "[::1]:8080" Limited to 45 characters.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("address")]
        public virtual string Address { get; set; }

        /// <summary>Optional. Annotations for the endpoint. This data can be consumed by service clients. Restrictions:
        /// - The entire annotations dictionary may contain up to 512 characters, spread accoss all key-value pairs.
        /// Annotations that goes beyond any these limits will be rejected. - Valid annotation keys have two segments:
        /// an optional prefix and name, separated by a slash (/). The name segment is required and must be 63
        /// characters or less, beginning and ending with an alphanumeric character ([a-z0-9A-Z]) with dashes (-),
        /// underscores (_), dots (.), and alphanumerics between. The prefix is optional. If specified, the prefix must
        /// be a DNS subdomain: a series of DNS labels separated by dots (.), not longer than 253 characters in total,
        /// followed by a slash (/). Annotations that fails to meet these requirements will be rejected. - The
        /// '(*.)google.com/' and '(*.)googleapis.com/' prefixes are reserved for system annotations managed by Service
        /// Directory. If the user tries to write to these keyspaces, those entries will be silently ignored by the
        /// system. Note: This field is equivalent to the 'metadata' field in the v1beta1 API. They have the same syntax
        /// and read/write to the same location in Service Directory.</summary>
    ...
    /// <summary>A container for services. Namespaces allow administrators to group services together and define
    /// permissions for a collection of services.</summary>
    ...
    /// <summary>The request message for LookupService.ResolveService. Looks up a service by its name, returns the
    ...
    public class ResolveServiceRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. The maximum number of endpoints to return. Defaults to 25. Maximum is 100. If a value
        /// less than one is specified, the Default is used. If a value greater than the Maximum is specified, the
        /// Maximum is used.</summary>
    ...
    /// <summary>An individual service. A service contains a name and optional metadata. A service must exist before
    /// endpoints can be added to it.</summary>
    public class Service : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. Annotations for the service. This data can be consumed by service clients. Restrictions:
        /// - The entire annotations dictionary may contain up to 2000 characters, spread accoss all key-value pairs.
        /// Annotations that goes beyond any these limits will be rejected. - Valid annotation keys have two segments:
        /// an optional prefix and name, separated by a slash (/). The name segment is required and must be 63
        /// characters or less, beginning and ending with an alphanumeric character ([a-z0-9A-Z]) with dashes (-),
        /// underscores (_), dots (.), and alphanumerics between. The prefix is optional. If specified, the prefix must
        ...
        /// <summary>Output only. Endpoints associated with this service. Returned on LookupService.Resolve. Control
        /// plane clients should use RegistrationService.ListEndpoints.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endpoints")]
        public virtual System.Collections.Generic.IList<Endpoint> Endpoints { get; set; }
