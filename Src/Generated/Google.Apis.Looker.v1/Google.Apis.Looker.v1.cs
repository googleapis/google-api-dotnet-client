...
namespace Google.Apis.Looker.v1
{
    /// <summary>The Looker Service.</summary>
    public class LookerService : Google.Apis.Services.BaseClientService
    {
        ...
        public LookerService() : this(new Google.Apis.Services.BaseClientService.Initializer())
        {
        }

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public LookerService(Google.Apis.Services.BaseClientService.Initializer initializer) : base(initializer)
        {
            Projects = new ProjectsResource(this);
            BaseUri = GetEffectiveUri(BaseUriOverride, "https://looker.googleapis.com/");
            BatchUri = GetEffectiveUri(null, "https://looker.googleapis.com/batch");
        }
        ...
        public override string Name => "looker";
        ...
        /// <summary>Available OAuth 2.0 scopes for use with the Looker (Google Cloud core) API.</summary>
        public class Scope
        {
            /// <summary>
        ...
        /// <summary>Available OAuth 2.0 scope constants for use with the Looker (Google Cloud core) API.</summary>
    ...
    /// <summary>A base abstract class for Looker requests.</summary>
    public abstract class LookerBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        /// <summary>Constructs a new LookerBaseServiceRequest instance.</summary>
        protected LookerBaseServiceRequest(Google.Apis.Services.IClientService service) : base(service)
        {
        }
        ...
        /// <summary>Initializes Looker parameter list.</summary>
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                public virtual CreateRequest Create(Google.Apis.Looker.v1.Data.Instance body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Looker.v1.Data.Instance body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. The unique instance identifier. Must contain only lowercase letters, numbers, or
                    /// hyphens, with the first character a letter and the last a letter or a number. 63 characters
                    /// maximum.
                    /// </summary>
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Looker.v1.Data.Instance Body { get; set; }
                ...
                /// <summary>Delete instance.</summary>
                /// <param name="name">
                /// Required. Format: `projects/{project}/locations/{location}/instances/{instance}`.
                /// </param>
                public virtual DeleteRequest Delete(string name)
                ...
                public class DeleteRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Operation>
                {
                    ...
                    /// <summary>Whether to force cascading delete.</summary>
                ...
                /// <summary>Export instance.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// Required. Format: `projects/{project}/locations/{location}/instances/{instance}`.
                /// </param>
                public virtual ExportRequest Export(Google.Apis.Looker.v1.Data.ExportInstanceRequest body, string name)
                {
                    return new ExportRequest(this.service, body, name);
                }

                /// <summary>Export instance.</summary>
                public class ExportRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Export request.</summary>
                    public ExportRequest(Google.Apis.Services.IClientService service, Google.Apis.Looker.v1.Data.ExportInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Looker.v1.Data.ExportInstanceRequest Body { get; set; }
                ...
                /// <summary>Gets details of a single Instance.</summary>
                public class GetRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Instance>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Import instance.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// Required. Format: `projects/{project}/locations/{location}/instances/{instance}`.
                /// </param>
                public virtual ImportRequest Import(Google.Apis.Looker.v1.Data.ImportInstanceRequest body, string name)
                {
                    return new ImportRequest(this.service, body, name);
                }

                /// <summary>Import instance.</summary>
                public class ImportRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Import request.</summary>
                    public ImportRequest(Google.Apis.Services.IClientService service, Google.Apis.Looker.v1.Data.ImportInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Looker.v1.Data.ImportInstanceRequest Body { get; set; }
                ...
                /// <summary>Lists Instances in a given project and location.</summary>
                public class ListRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.ListInstancesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>
                    /// The maximum number of instances to return. If unspecified at most 256 will be returned. The
                    /// maximum possible value is 2048.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }

                    /// <summary>A page token received from a previous ListInstancesRequest.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string PageToken { get; set; }
                ...
                /// <summary>Update Instance.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// Output only. Format: `projects/{project}/locations/{location}/instances/{instance}`.
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Looker.v1.Data.Instance body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Update Instance.</summary>
                public class PatchRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Looker.v1.Data.Instance body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. Field mask used to specify the fields to be overwritten in the Instance resource by
                    /// the update. The fields specified in the mask are relative to the resource, not the full request.
                ...
                /// <summary>Restart instance.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// Required. Format: `projects/{project}/locations/{location}/instances/{instance}`.
                /// </param>
                public virtual RestartRequest Restart(Google.Apis.Looker.v1.Data.RestartInstanceRequest body, string name)
                {
                    return new RestartRequest(this.service, body, name);
                }

                /// <summary>Restart instance.</summary>
                public class RestartRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Restart request.</summary>
                    public RestartRequest(Google.Apis.Services.IClientService service, Google.Apis.Looker.v1.Data.RestartInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Looker.v1.Data.RestartInstanceRequest Body { get; set; }
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.Looker.v1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Looker.v1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Looker.v1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// specific service implementation and version.
            /// </summary>
            public class ListRequest : LookerBaseServiceRequest<Google.Apis.Looker.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
{
    /// <summary>Looker instance Admin settings fields.</summary>
    public class AdminSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Email domain allowlist for the instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("allowedEmailDomains")]
        public virtual System.Collections.Generic.IList<string> AllowedEmailDomains { get; set; }
    ...
    /// <summary>Specifies the maintenance denial period.</summary>
    public class DenyMaintenancePeriod : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Required. End date of the deny maintenance period.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endDate")]
        public virtual Date EndDate { get; set; }

        /// <summary>Required. Start date of the deny maintenance period.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("startDate")]
        public virtual Date StartDate { get; set; }

        /// <summary>Required. Time in UTC when the period starts and ends.</summary>
    ...
    /// <summary>Encryption configuration (i.e. CMEK).</summary>
    public class EncryptionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Name of the CMEK key in KMS (input parameter).</summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kmsKeyNameVersion")]
        public virtual string KmsKeyNameVersion { get; set; }

        /// <summary>Output only. Status of the CMEK key.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kmsKeyState")]
    ...
    /// <summary>Configuration for Encryption - e.g. CMEK.</summary>
    public class ExportEncryptionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Required. Name of the CMEK key in KMS.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kmsKeyName")]
        public virtual string KmsKeyName { get; set; }
    ...
    /// <summary>Request options for exporting data of an Instance.</summary>
    public class ExportInstanceRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual ExportEncryptionConfig EncryptionConfig { get; set; }

        /// <summary>
        /// The path to the folder in Google Cloud Storage where the export will be stored. The URI is in the form
    ...
    /// <summary>
    /// ExportMetadata represents the metadata of the exported artifacts. The metadata.json file in export artifact can
    /// be parsed as this message
    /// </summary>
    public class ExportMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("filePaths")]
        public virtual System.Collections.Generic.IList<string> FilePaths { get; set; }

        /// <summary>
        /// Looker encryption key, encrypted with the provided export encryption key. This value will only be populated
        /// if the looker instance uses Looker managed encryption instead of CMEK.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lookerEncryptionKey")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lookerInstance")]
        public virtual string LookerInstance { get; set; }

        /// <summary>Platform edition of the exported instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lookerPlatformEdition")]
        public virtual string LookerPlatformEdition { get; set; }

        /// <summary>Version of instance when the export was created.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lookerVersion")]
        public virtual string LookerVersion { get; set; }

        /// <summary>The source type of the migration.</summary>
    ...
    /// <summary>Encryption key details for the exported artifact.</summary>
    public class ExportMetadataEncryptionKey : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Name of the CMEK.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("cmek")]
    ...
    /// <summary>Ingress IP allowlist configuration.</summary>
    public class IngressIpAllowlistConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. List of IP range rules to allow ingress traffic.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("allowlistRules")]
        public virtual System.Collections.Generic.IList<IngressIpAllowlistRule> AllowlistRules { get; set; }

        /// <summary>Optional. Whether ingress IP allowlist functionality is enabled on the Looker instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enabled")]
        public virtual System.Nullable<bool> Enabled { get; set; }

        /// <summary>Optional. Whether google service connections are enabled for the instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("googleServicesEnabled")]
        public virtual System.Nullable<bool> GoogleServicesEnabled { get; set; }

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }

    /// <summary>Ingress IP allowlist rule.</summary>
    public class IngressIpAllowlistRule : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. Description for the IP range.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }

        /// <summary>Optional. The IP range to allow ingress traffic from.</summary>
    ...
    public class Instance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Nullable<bool> CatalogIntegrationOptOut { get; set; }
        ...
        /// <summary>Output only. The time when the Looker instance provisioning was first requested.</summary>
        ...
        /// <summary>Maintenance denial period for this instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("denyMaintenancePeriod")]
        public virtual DenyMaintenancePeriod DenyMaintenancePeriod { get; set; }

        /// <summary>Output only. Public Egress IP (IPv4).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("egressPublicIp")]
        public virtual string EgressPublicIp { get; set; }

        /// <summary>Encryption configuration (CMEK). Only set if CMEK has been enabled on the instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("encryptionConfig")]
        ...
        /// <summary>Optional. Ingress IP allowlist configuration for the Looker instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ingressIpAllowlistConfig")]
        public virtual IngressIpAllowlistConfig IngressIpAllowlistConfig { get; set; }
        ...
        /// <summary>Output only. Public Ingress IP (IPv4).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ingressPublicIp")]
        public virtual string IngressPublicIp { get; set; }

        /// <summary>Output only. Last computed maintenance denial period for this instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lastDenyMaintenancePeriod")]
        public virtual DenyMaintenancePeriod LastDenyMaintenancePeriod { get; set; }

        /// <summary>Optional. Linked Google Cloud Project Number for Looker Studio Pro.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("linkedLspProjectNumber")]
        public virtual System.Nullable<long> LinkedLspProjectNumber { get; set; }

        /// <summary>Output only. Looker instance URI which can be used to access the Looker Instance UI.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lookerUri")]
        public virtual string LookerUri { get; set; }

        /// <summary>Output only. The Looker version that the instance is using.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lookerVersion")]
        public virtual string LookerVersion { get; set; }

        /// <summary>Maintenance schedule for this instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("maintenanceSchedule")]
        public virtual MaintenanceSchedule MaintenanceSchedule { get; set; }

        /// <summary>Maintenance window for this instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("maintenanceWindow")]
        public virtual MaintenanceWindow MaintenanceWindow { get; set; }

        /// <summary>Output only. Format: `projects/{project}/locations/{location}/instances/{instance}`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }

        /// <summary>Looker instance OAuth login settings.</summary>
        ...
        /// <summary>Whether private IP is enabled on the Looker instance.</summary>
        ...
        /// <summary>Output only. The time when the Looker instance was last updated.</summary>
    ...
    /// <summary>Published upcoming future maintenance schedule.</summary>
    ...
    /// <summary>Specifies the recurring maintenance window.</summary>
    public class MaintenanceWindow : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Required. Day of the week for this MaintenanceWindow (in UTC).</summary>
    ...
    {
        /// <summary>
        /// Input only. Client ID from an external OAuth application. This is an input-only field, and thus will not be
        /// set in any responses.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clientId")]
        public virtual string ClientId { get; set; }

        /// <summary>
        /// Input only. Client secret from an external OAuth application. This is an input-only field, and thus will not
        /// be set in any responses.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clientSecret")]
        public virtual string ClientSecret { get; set; }

        /// <summary>
        /// Optional. Whether to use the shared OAuth client. Instances specifying this field do not need to provide
        /// client_id and client_secret.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("sharedOauthClientEnabled")]
        public virtual System.Nullable<bool> SharedOauthClientEnabled { get; set; }
    ...
    /// <summary>Metadata about users for a Looker instance.</summary>
    public class UserMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. The number of additional developer users the instance owner has purchased.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("additionalDeveloperUserCount")]
        public virtual System.Nullable<int> AdditionalDeveloperUserCount { get; set; }

        /// <summary>Optional. The number of additional standard users the instance owner has purchased.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("additionalStandardUserCount")]
        public virtual System.Nullable<int> AdditionalStandardUserCount { get; set; }

        /// <summary>Optional. The number of additional viewer users the instance owner has purchased.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("additionalViewerUserCount")]
        public virtual System.Nullable<int> AdditionalViewerUserCount { get; set; }
