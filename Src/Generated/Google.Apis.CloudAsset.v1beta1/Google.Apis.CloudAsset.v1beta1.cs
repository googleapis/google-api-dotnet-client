...
namespace Google.Apis.CloudAsset.v1beta1
{
    ...
    public class FoldersResource
    {
        ...
        /// <summary>
        /// Exports assets with time and resource types to a given Cloud Storage location. The output format is
        /// newline-delimited JSON. This API implements the google.longrunning.Operation API allowing you to keep track
        /// of the export. We recommend intervals of at least 2 seconds with exponential retry to poll the export
        ...
        public class ExportAssetsRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1beta1.Data.Operation>
        {
            ...
            public ExportAssetsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudAsset.v1beta1.Data.ExportAssetsRequest body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1beta1/{+parent}:exportAssets";
    ...
    public class OrganizationsResource
    {
        ...
        public class BatchGetAssetsHistoryRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1beta1.Data.BatchGetAssetsHistoryResponse>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1beta1/{+parent}:batchGetAssetsHistory";
...
namespace Google.Apis.CloudAsset.v1beta1.Data
{
    ...
    {
        /// <summary>
        /// A list of asset types of which to take a snapshot for. For example: "google.compute.Disk". If specified,
        /// only matching assets will be returned. See [Introduction to Cloud Asset
        ...
        /// <summary>
        /// Required. Output configuration indicating where the results will be output to. All results will be in
        ...
        /// <summary>
        /// Timestamp to take an asset snapshot. This can only be set to a timestamp between 2018-10-02 UTC (inclusive)
        /// and the current time. If not specified, the current time will be used. Due to delays in resource data
        /// collection and indexing, there is a volatile window during which running the same query may get different
        /// results.
        /// </summary>
    ...
    public class GcsDestination : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The uri prefix of all generated Cloud Storage objects. For example: "gs://bucket_name/object_name_prefix".
        /// Each object uri is in format: "gs://bucket_name/object_name_prefix// and only contains assets for that type.
        /// starts from 0. For example: "gs://bucket_name/object_name_prefix/google.compute.disk/0" is the first shard
        /// of output objects containing all google.compute.disk assets. An INVALID_ARGUMENT error will be returned if
        /// file with the same name "gs://bucket_name/object_name_prefix" already exists.
        /// </summary>
