...
{    
    ...
    public class ExportAssetsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Timestamp to take an asset snapshot. This can only be set to a timestamp in the past or of the
        /// current time. If not specified, the current time will be used. Due to delays in resource data collection and
        /// indexing, there is a volatile window during which running the same query may get different
        /// results.</summary>
