    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta2.Data.Operation>
                {
            ...
            public class QueuesResource
            {
                ...
                public class TasksResource
                {
                    ...
                    /// </param>
                    public virtual BatchCreateRequest BatchCreate(Google.Apis.CloudTasks.v2beta2.Data.BatchCreateTasksRequest body, string parent)
                    {
                    ...
                    /// for the same queue. A maximum of 100 tasks can be created in a single batch.
                    /// </summary>
                    public class BatchCreateRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta2.Data.Operation>
                    {
                        /// <summary>Constructs a new BatchCreate request.</summary>
                        public BatchCreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta2.Data.BatchCreateTasksRequest body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudTasks.v2beta2.Data.BatchCreateTasksRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v2beta2/{+parent}/tasks:batchCreate";
                    ...
                    /// </param>
                    public virtual BatchDeleteRequest BatchDelete(Google.Apis.CloudTasks.v2beta2.Data.BatchDeleteTasksRequest body, string parent)
                    {
                    ...
                    /// details of failed deletions. A maximum of 1000 tasks can be deleted in a batch.
                    /// </summary>
                    public class BatchDeleteRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta2.Data.Operation>
                    {
                        /// <summary>Constructs a new BatchDelete request.</summary>
                        public BatchDeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta2.Data.BatchDeleteTasksRequest body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudTasks.v2beta2.Data.BatchDeleteTasksRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v2beta2/{+parent}/tasks:batchDelete";
...
namespace Google.Apis.CloudTasks.v2beta2.Data
{
    ...
    public class Queue : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// dispatch is from a first attempt or a retry). * retry_config controls what happens to a particular task
