...
namespace Google.Apis.HangoutsChat.v1.Data
{
    ...
    /// <summary>Widgets for chatbots to specify.</summary>
    public class CardWithId : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Card proto that allows chatbots to specify UI elements and editable widgets.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("card")]
        public virtual GoogleAppsCardV1Card Card { get; set; }

        /// <summary>Chatbot-specified identifier for this widget. Scoped within a message.</summary>
    ...
    public class Message : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Rich, formatted and interactive cards that can be used to display UI elements and editable widgets, such as:
        /// formatted text, buttons, clickable images, checkboxes, radio buttons. Cards are normally displayed below the
        /// plain-text body of the message. This v2 allows input widgets. The string key is a unique identifier among
