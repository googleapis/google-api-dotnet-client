...
namespace Google.Apis.HangoutsChat.v1
{
    ...
    public abstract class HangoutsChatBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected HangoutsChatBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
    ...
    public class SpacesResource
    {
        ...
        public class MessagesResource
        {
            ...
            public class CreateRequest : HangoutsChatBaseServiceRequest<Google.Apis.HangoutsChat.v1.Data.Message>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.HangoutsChat.v1.Data.Message body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add(
                        "threadKey", new Google.Apis.Discovery.Parameter
                        {
                            Name = "threadKey",
                            IsRequired = false,
                            ParameterType = "query",
            ...
            public class UpdateRequest : HangoutsChatBaseServiceRequest<Google.Apis.HangoutsChat.v1.Data.Message>
            {
                ...
                public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.HangoutsChat.v1.Data.Message body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
...
{    
    ...
    /// <summary>Hangouts Chat events.</summary>
    public class DeprecatedEvent : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// guide](/hangouts/chat/how-tos/auth-3p) for more information.</summary>
        ...
        /// generated by Google, remains static, and can be obtained from the Hangouts Chat API configuration page in
        /// the Cloud Console. Developers can revoke/regenerate it if needed from the same page.</summary>
