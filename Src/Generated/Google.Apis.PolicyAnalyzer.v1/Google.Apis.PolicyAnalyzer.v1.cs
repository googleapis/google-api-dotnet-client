...
namespace Google.Apis.PolicyAnalyzer.v1
{
    ...
    public class PolicyAnalyzerService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://policyanalyzer.googleapis.com/";

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "";

        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://policyanalyzer.googleapis.com/batch";
