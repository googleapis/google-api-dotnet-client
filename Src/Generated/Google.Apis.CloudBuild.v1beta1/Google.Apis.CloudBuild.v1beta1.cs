    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.CloudBuild.v1beta1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1beta1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.CloudBuild.v1beta1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.Operation>
                {
            ...
            public class WorkerPoolsResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.CloudBuild.v1beta1.Data.WorkerPool body, string parent)
                {
                ...
                /// method returns an `Operation` that is always complete.
                /// </summary>
                public class CreateRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1beta1.Data.WorkerPool body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudBuild.v1beta1.Data.WorkerPool Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+parent}/workerPools";
                ...
                /// Deletes a `WorkerPool`. NOTE: As of now, this method returns an `Operation` that is always complete.
                /// </summary>
                public class DeleteRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.Operation>
                {
                ...
                /// <summary>Returns details of a `WorkerPool`.</summary>
                public class GetRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.WorkerPool>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists `WorkerPool`s in the given project.</summary>
                /// <param name="parent">
                ...
                /// <summary>Lists `WorkerPool`s in the given project.</summary>
                public class ListRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.ListWorkerPoolsResponse>
                {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.CloudBuild.v1beta1.Data.WorkerPool body, string name)
                {
                ...
                /// Updates a `WorkerPool`. NOTE: As of now, this method returns an `Operation` that is always complete.
                /// </summary>
                public class PatchRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1beta1.Data.WorkerPool body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>A mask specifying which fields in `WorkerPool` to update.</summary>
...
namespace Google.Apis.CloudBuild.v1beta1.Data
{
    ...
    public class WorkerConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("noExternalIp")]
        public virtual System.Nullable<bool> NoExternalIp { get; set; }
    ...
    /// `WorkerPool` to run your builds. Custom `WorkerPool`s give your builds access to any single VPC network that you
