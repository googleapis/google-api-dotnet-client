...
namespace Google.Apis.Datastream.v1alpha1
{
    ...
    public class DatastreamService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://datastream.googleapis.com/";
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class ConnectionProfilesResource
            {
                ...
                public virtual CreateRequest Create(Google.Apis.Datastream.v1alpha1.Data.ConnectionProfile body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Use this method to create a connection profile in a project and location.</summary>
                public class CreateRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.ConnectionProfile body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Datastream.v1alpha1.Data.ConnectionProfile Body { get; set; }
                    ...
                    public override string RestPath => "v1alpha1/{+parent}/connectionProfiles";
                ...
                /// <summary>Use this method to delete a connection profile..</summary>
                public class DeleteRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Operation>
                {
                ...
                /// `projects/*/locations/*`.
                /// </param>
                public virtual DiscoverRequest Discover(Google.Apis.Datastream.v1alpha1.Data.DiscoverConnectionProfileRequest body, string parent)
                {
                ...
                /// data object that's optionally supplied in the request.
                /// </summary>
                public class DiscoverRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.DiscoverConnectionProfileResponse>
                {
                    /// <summary>Constructs a new Discover request.</summary>
                    public DiscoverRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.DiscoverConnectionProfileRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Datastream.v1alpha1.Data.DiscoverConnectionProfileRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha1/{+parent}/connectionProfiles:discover";
                ...
                /// <summary>Use this method to get details about a connection profile.</summary>
                public class GetRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ConnectionProfile>
                {
                ...
                /// <summary>Use this method to list connection profiles created in a project and location.</summary>
                public class ListRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ListConnectionProfilesResponse>
                {
                ...
                public virtual PatchRequest Patch(Google.Apis.Datastream.v1alpha1.Data.ConnectionProfile body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Use this method to update the parameters of a connection profile.</summary>
                public class PatchRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.ConnectionProfile body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.Datastream.v1alpha1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Datastream.v1alpha1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            public class PrivateConnectionsResource
            {
                ...
                public class RoutesResource
                {
                    ...
                    public virtual CreateRequest Create(Google.Apis.Datastream.v1alpha1.Data.Route body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.Route body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Datastream.v1alpha1.Data.Route Body { get; set; }
                    ...
                    /// <summary>Use this method to get details about a route.</summary>
                    public class GetRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Route>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// Use this method to list routes created for a private connectivity in a project and location.
                    /// </summary>
                    public class ListRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ListRoutesResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                ...
                public virtual CreateRequest Create(Google.Apis.Datastream.v1alpha1.Data.PrivateConnection body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.PrivateConnection body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Datastream.v1alpha1.Data.PrivateConnection Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha1/{+parent}/privateConnections";
                ...
                /// <summary>Use this method to get details about a private connectivity configuration.</summary>
                public class GetRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.PrivateConnection>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// Use this method to list private connectivity configurations in a project and location.
                /// </summary>
                public class ListRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ListPrivateConnectionsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
            ...
            public class StreamsResource
            {
                ...
                public class ObjectsResource
                {
                    ...
                    {
                        return new StartBackfillJobRequest(this.service, datastreamObject);
                    }
                    ...
                    {
                        return new StopBackfillJobRequest(this.service, datastreamObject);
                    }
                ...
                public virtual CreateRequest Create(Google.Apis.Datastream.v1alpha1.Data.Stream body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.Stream body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Datastream.v1alpha1.Data.Stream Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha1/{+parent}/streams";
                ...
                /// <summary>Use this method to fetch any errors associated with a stream.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="stream">Name of the Stream resource for which to fetch any errors.</param>
                public virtual FetchErrorsRequest FetchErrors(Google.Apis.Datastream.v1alpha1.Data.FetchErrorsRequest body, string stream)
                {
                    return new FetchErrorsRequest(this.service, body, stream);
                }

                /// <summary>Use this method to fetch any errors associated with a stream.</summary>
                public class FetchErrorsRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Operation>
                {
                    /// <summary>Constructs a new FetchErrors request.</summary>
                    public FetchErrorsRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.FetchErrorsRequest body, string stream) : base(service)
                    {
                        Stream = stream;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Name of the Stream resource for which to fetch any errors.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("stream", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Stream { get; private set; }

                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Datastream.v1alpha1.Data.FetchErrorsRequest Body { get; set; }

                    /// <summary>Returns the body of the request.</summary>
                    protected override object GetBody() => Body;

                    /// <summary>Gets the method name.</summary>
                    public override string MethodName => "fetchErrors";

                    /// <summary>Gets the HTTP method.</summary>
                    public override string HttpMethod => "POST";

                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha1/{+stream}:fetchErrors";

                    /// <summary>Initializes FetchErrors parameter list.</summary>
                    protected override void InitParameters()
                    {
                        base.InitParameters();
                        RequestParameters.Add("stream", new Google.Apis.Discovery.Parameter
                        {
                            Name = "stream",
                            IsRequired = true,
                            ParameterType = "path",
                ...
                /// <summary>Use this method to get details about a stream.</summary>
                public class GetRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Stream>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Use this method to list streams in a project and location.</summary>
                public class ListRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ListStreamsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                public virtual PatchRequest Patch(Google.Apis.Datastream.v1alpha1.Data.Stream body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Datastream.v1alpha1.Data.Stream body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class FetchStaticIpsRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.FetchStaticIpsResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1alpha1/{+name}:fetchStaticIps";
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : DatastreamBaseServiceRequest<Google.Apis.Datastream.v1alpha1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
namespace Google.Apis.Datastream.v1alpha1.Data
{
    ...
    public class ConnectionProfile : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>No connectivity option chosen.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("noConnectivity")]
        public virtual NoConnectivitySettings NoConnectivity { get; set; }
    ...
    {
        /// <summary>Required. Destination connection profile identifier.</summary>
    ...
    {
        /// <summary>An ad-hoc ConnectionProfile configuration.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("connectionProfile")]
        public virtual ConnectionProfile ConnectionProfile { get; set; }

        /// <summary>A reference to an existing ConnectionProfile.</summary>
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("recursionDepth")]
        public virtual System.Nullable<int> RecursionDepth { get; set; }

        /// <summary>
        /// Whether to retrieve the full hierarchy of data objects (TRUE) or only the current level (FALSE).
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("recursive")]
    ...
    /// <summary>Request message for 'FetchErrors' request.</summary>
    public class FetchErrorsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }

    /// <summary>Response message for a 'FetchErrors' response.</summary>
    public class FetchErrorsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The list of errors on the Stream.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("errors")]
        public virtual System.Collections.Generic.IList<Error> Errors { get; set; }
    ...
    public class GcsDestinationConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("gcsFileFormat")]
    ...
    {
        /// <summary>Required. The full project and resource path for Cloud Storage bucket including the name.</summary>
    ...
    public class MysqlSourceConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual MysqlRdbms Allowlist { get; set; }

        /// <summary>MySQL objects to exclude from the stream.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("rejectlist")]
        public virtual MysqlRdbms Rejectlist { get; set; }
    ...
    /// <summary>No connectivity settings.</summary>
    public class NoConnectivitySettings : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }
    ...
    {
        [Newtonsoft.Json.JsonPropertyAttribute("privateConnectionName")]
        public virtual string PrivateConnectionName { get; set; }
    ...
    /// <summary>
    /// The Route resource is the child of the PrivateConnection resource. It used to define a route for a
    ...
    public class SourceConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. Source connection profile identifier.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("sourceConnectionProfileName")]
    ...
    public class VpcPeeringConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. fully qualified name of the VPC Datastream will peer to.</summary>
