        ...
        public class LocationsResource
        {
            ...
            public class EnvironmentsResource
            {
                ...
                public class PatchRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.Operation>
                {
                    ...
                    /// "botocore":"==1.7.14" } } } } **Note:** Only the following fields can be updated: *Mask*
                    /// *Purpose* config.softwareConfig.pypiPackages Replace all custom custom PyPI packages. If a
                    /// replacement package map is not included in `environment`, all custom PyPI packages are cleared.
                    /// It is an error to provide both this mask and a mask specifying an individual package.
...
{    
    ...
    /// <summary>Configuration for controlling how IPs are allocated in the GKE cluster running the Apache Airflow
    /// software.</summary>
    public class IPAllocationPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. The IP address range used to allocate IP addresses to pods in the GKE cluster. This field
        /// is applicable only when `use_ip_aliases` is true. Set to blank to have GKE choose a range with the default
        ...
        /// <summary>Optional. The name of the GKE cluster's secondary range used to allocate IP addresses to pods. This
        /// field is applicable only when `use_ip_aliases` is true.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clusterSecondaryRangeName")]
        public virtual string ClusterSecondaryRangeName { get; set; }

        /// <summary>Optional. The IP address range of the services IP addresses in this GKE cluster. This field is
        ...
        /// <summary>Optional. The name of the services' secondary range used to allocate IP addresses to the GKE
        /// cluster. This field is applicable only when `use_ip_aliases` is true.</summary>
    ...
    public class NodeConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// provided, `nodeConfig.subnetwork` must also be provided.</summary>
    ...
    public class PrivateClusterConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// for assigning internal IP addresses to the GKE cluster master or set of masters and to the internal load
