    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class EnvironmentsResource
            {
                ...
                /// "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
                /// </param>
                public virtual CheckUpgradeRequest CheckUpgrade(Google.Apis.CloudComposer.v1.Data.CheckUpgradeRequest body, string environment)
                {
                ...
                /// be found in the returned Operation.
                /// </summary>
                public class CheckUpgradeRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.Operation>
                {
                    /// <summary>Constructs a new CheckUpgrade request.</summary>
                    public CheckUpgradeRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.CheckUpgradeRequest body, string environment) : base(service)
                    {
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudComposer.v1.Data.CheckUpgradeRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+environment}:checkUpgrade";
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.Environment body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                ...
                /// <summary>Triggers database failover (only for highly resilient environments).</summary>
                public class DatabaseFailoverRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.Operation>
                {
                    /// <summary>Constructs a new DatabaseFailover request.</summary>
                    public DatabaseFailoverRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.DatabaseFailoverRequest body, string environment) : base(service)
                    {
                        Environment = environment;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudComposer.v1.Data.DatabaseFailoverRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+environment}:databaseFailover";
                ...
                /// <summary>Executes Airflow CLI command.</summary>
                public class ExecuteAirflowCommandRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.ExecuteAirflowCommandResponse>
                {
                    /// <summary>Constructs a new ExecuteAirflowCommand request.</summary>
                    public ExecuteAirflowCommandRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.ExecuteAirflowCommandRequest body, string environment) : base(service)
                    {
                        Environment = environment;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudComposer.v1.Data.ExecuteAirflowCommandRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+environment}:executeAirflowCommand";
                ...
                /// <summary>Fetches database properties.</summary>
                public class FetchDatabasePropertiesRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.FetchDatabasePropertiesResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+environment}:fetchDatabaseProperties";
                ...
                public class PatchRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.Environment body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// remove an existing installation of numpy, the `updateMask` parameter would include the following
                    /// two `paths` values: "config.softwareConfig.pypiPackages.scikit-learn" and
                    ...
                    /// other than scikit-learn and numpy will be unaffected. Only one update type may be included in a
                    /// single request's `updateMask`. For example, one cannot update both the PyPI packages and labels
                    /// in the same request. However, it is possible to update multiple members of a map field
                    ...
                    /// cleared. * `config.softwareConfig.schedulerCount` * Horizontally scale the number of schedulers
                ...
                /// <summary>Polls Airflow CLI command execution and fetches logs.</summary>
                public class PollAirflowCommandRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.PollAirflowCommandResponse>
                {
                    /// <summary>Constructs a new PollAirflowCommand request.</summary>
                    public PollAirflowCommandRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.PollAirflowCommandRequest body, string environment) : base(service)
                    {
                        Environment = environment;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudComposer.v1.Data.PollAirflowCommandRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+environment}:pollAirflowCommand";
                ...
                /// <summary>Stops Airflow CLI command execution.</summary>
                public class StopAirflowCommandRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.StopAirflowCommandResponse>
                {
                    /// <summary>Constructs a new StopAirflowCommand request.</summary>
                    public StopAirflowCommandRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1.Data.StopAirflowCommandRequest body, string environment) : base(service)
                    {
                        Environment = environment;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudComposer.v1.Data.StopAirflowCommandRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+environment}:stopAirflowCommand";
            ...
            public class ImageVersionsResource
            {
                ...
                public class ListRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1.Data.ListImageVersionsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/imageVersions";
...
namespace Google.Apis.CloudComposer.v1.Data
{
    ...
    {
        /// <summary>
        /// Optional. The IP address range used to allocate IP addresses to pods in the GKE cluster. For Cloud Composer
        ...
        /// <summary>
        /// Optional. The name of the GKE cluster's secondary range used to allocate IP addresses to pods. For Cloud
        /// Composer environments in versions composer-1.*.*-airflow-*.*.*, this field is applicable only when
        ...
        /// <summary>
        /// Optional. The IP address range of the services IP addresses in this GKE cluster. For Cloud Composer
        /// environments in versions composer-1.*.*-airflow-*.*.*, this field is applicable only when `use_ip_aliases`
        /// is true. Set to blank to have GKE choose a range with the default size. Set to /netmask (e.g. `/14`) to have
        /// GKE choose a range with a specific netmask. Set to a
        /// [CIDR](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) notation (e.g. `10.96.0.0/14`) from the
        ...
        /// <summary>
        /// Optional. The name of the services' secondary range used to allocate IP addresses to the GKE cluster. For
        /// Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*, this field is applicable only when
        /// `use_ip_aliases` is true.
        /// </summary>
    ...
    public class PrivateClusterConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// assigning internal IP addresses to the GKE cluster master or set of masters and to the internal load
        /// balancer virtual IP. This range must not overlap with any other ranges in use within the cluster's network.
        /// </summary>
    ...
    public class PrivateEnvironmentConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// composer-1.*.*-airflow-*.*.*. This field is going to be deprecated. Use `networking_type` instead.
        /// </summary>
