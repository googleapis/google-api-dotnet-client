...
{    
    ...
    {
        /// <summary>Optional. The IP address range used to allocate IP addresses to pods in the GKE cluster.
        ///
        ...
        /// <summary>Optional. The name of the GKE cluster's secondary range used to allocate IP addresses to pods.
        ///
        ...
        /// <summary>Optional. The IP address range of the services IP addresses in this GKE cluster.
        ///
        /// This field is applicable only when `use_ip_aliases` is true.
        ///
        /// Set to blank to have GKE choose a range with the default size.
