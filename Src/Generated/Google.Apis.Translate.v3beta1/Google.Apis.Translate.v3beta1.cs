...
namespace Google.Apis.Translate.v3beta1
{
    ...
    public class TranslateService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://translation.googleapis.com/";
...
namespace Google.Apis.Translate.v3beta1.Data
{
    ...
    public class BatchTranslateTextRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// letter. See https://cloud.google.com/translate/docs/labels for more information.
        /// </summary>
    ...
    {
        /// <summary>
        /// A list of detected languages sorted by detection confidence in descending order. The most probable language
        /// first.
        /// </summary>
    ...
    {
        /// <summary>
        /// Required. There must be no files under 'output_uri_prefix'. 'output_uri_prefix' must end with "/" and start
