        ...
        public class LocationsResource
        {
            ...
            public class GlossariesResource
            {
                ...
                public class CreateRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.Glossary body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.CancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class WaitRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
                {
                    ...
                    public WaitRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.WaitOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
            ...
            public class BatchTranslateTextRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
            {
                ...
                public BatchTranslateTextRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.BatchTranslateTextRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            public class DetectLanguageRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.DetectLanguageResponse>
            {
                ...
                public DetectLanguageRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.DetectLanguageRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            public class GetSupportedLanguagesRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.SupportedLanguages>
            {
                ...
                public GetSupportedLanguagesRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
                {
                    Parent = parent;
                    InitParameters();
            ...
            public class TranslateTextRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.TranslateTextResponse>
            {
                ...
                public TranslateTextRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.TranslateTextRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
