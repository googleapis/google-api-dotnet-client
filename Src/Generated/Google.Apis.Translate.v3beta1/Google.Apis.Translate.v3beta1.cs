    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class GlossariesResource
            {
                ...
                /// <summary>Creates a glossary and returns the long-running operation. Returns NOT_FOUND, if the
                /// project doesn't exist.</summary>
                ...
                /// <summary>Creates a glossary and returns the long-running operation. Returns NOT_FOUND, if the
                /// project doesn't exist.</summary>
                public class CreateRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.Glossary body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Translate.v3beta1.Data.Glossary Body { get; set; }
                    ...
                    public override string RestPath => "v3beta1/{+parent}/glossaries";
                ...
                /// <summary>Deletes a glossary, or cancels glossary construction if the glossary isn't created yet.
                /// Returns NOT_FOUND, if the glossary doesn't exist.</summary>
                ...
                /// <summary>Deletes a glossary, or cancels glossary construction if the glossary isn't created yet.
                /// Returns NOT_FOUND, if the glossary doesn't exist.</summary>
                public class DeleteRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
                {
                ...
                /// <summary>Gets a glossary. Returns NOT_FOUND, if the glossary doesn't exist.</summary>
                public class GetRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Glossary>
                {
                ...
                /// <summary>Lists glossaries in a project. Returns NOT_FOUND, if the project doesn't exist.</summary>
                public class ListRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.ListGlossariesResponse>
                {
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Translate.v3beta1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// interested in the operation result. It does not cancel the operation. If the server doesn't support
                /// this method, it returns `google.rpc.Code.UNIMPLEMENTED`.</summary>
                public class DeleteRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
                /// operation result at intervals as recommended by the API service.</summary>
                public class GetRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// latest state before the specified timeout (including immediately), meaning even an immediate
                /// response is no guarantee that the operation is done.</summary>
                public class WaitRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Wait request.</summary>
                    public WaitRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.WaitOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Translate.v3beta1.Data.WaitOperationRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v3beta1/{+name}:wait";
            ...
            /// file, it's all or nothing) may still be available on the specified output location. This call returns
            /// immediately and you can use google.longrunning.Operation.name to poll the status of the call.</summary>
            public class BatchTranslateTextRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.Operation>
            {
                /// <summary>Constructs a new BatchTranslateText request.</summary>
                public BatchTranslateTextRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.BatchTranslateTextRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Translate.v3beta1.Data.BatchTranslateTextRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3beta1/{+parent}:batchTranslateText";
            ...
            /// <summary>Detects the language of text within a request.</summary>
            public class DetectLanguageRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.DetectLanguageResponse>
            {
                /// <summary>Constructs a new DetectLanguage request.</summary>
                public DetectLanguageRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.DetectLanguageRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Translate.v3beta1.Data.DetectLanguageRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3beta1/{+parent}:detectLanguage";
            ...
            /// <summary>Returns a list of supported languages for translation.</summary>
            public class GetSupportedLanguagesRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.SupportedLanguages>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3beta1/{+parent}/supportedLanguages";
            ...
            /// <summary>Translates input text and returns translated text.</summary>
            public class TranslateTextRequest : TranslateBaseServiceRequest<Google.Apis.Translate.v3beta1.Data.TranslateTextResponse>
            {
                /// <summary>Constructs a new TranslateText request.</summary>
                public TranslateTextRequest(Google.Apis.Services.IClientService service, Google.Apis.Translate.v3beta1.Data.TranslateTextRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Translate.v3beta1.Data.TranslateTextRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3beta1/{+parent}:translateText";
...
{    
    ...
    public class BatchTranslateTextRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// start with a letter. See https://cloud.google.com/translate/docs/labels for more information.</summary>
    ...
    public class GlossaryInputConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// multiple languages. The format is defined for Google Translation Toolkit and documented in [Use a
    ...
    {
        /// <summary>Required. Google Cloud Storage location for the source input. This can be a single file (for
        /// example, `gs://translation-test/input.tsv`) or a wildcard (for example, `gs://translation-test`). If a file
    ...
    public class OutputConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// bucket that may avoid file updating. (https://cloud.google.com/storage/docs/bucket-lock?hl=en#retention-
    ...
    /// <summary>A single supported language response corresponds to information related to one supported
    /// language.</summary>
    ...
    /// <summary>Configures which glossary should be used for a specific target language, and defines options for
    ...
    public class TranslateTextRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// 30k codepoints. The max length of this field is 1024. Use BatchTranslateText for larger text.</summary>
    ...
    {
        /// <summary>The BCP-47 language code of source text in the initial request, detected automatically, if no
    ...
    {
        /// <summary>The maximum duration to wait before timing out. If left blank, the wait will be at most the time
