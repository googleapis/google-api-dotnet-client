...
namespace Google.Apis.Appengine.v1
{
    ...
    public class AppsResource
    {
        ...
        public class ServicesResource
        {
            ...
            public class VersionsResource
            {
                ...
                public class InstancesResource
                {
                    ...
                    /// <param name="appsId">Part of `parent`. Name of the parent Version resource to list instances for. For example:
                    ...
                    public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.ListInstancesResponse>
                    {
                        ...
                        /// <summary>Part of `parent`. Name of the parent Version resource to list instances for. For
                        /// example: "apps/myapp/services/default/versions/v1".</summary>
                        [Google.Apis.Util.RequestParameterAttribute("appsId", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string AppsId { get; private set; }
                ...
                /// <param name="appsId">Part of `parent`. Name of the parent resource to create this version under. For example:
                ...
                public class CreateRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.Operation>
                {
                    ...
                    /// <summary>Part of `parent`. Name of the parent resource to create this version under. For
                    /// example: "apps/myapp/services/default".</summary>
                    [Google.Apis.Util.RequestParameterAttribute("appsId", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string AppsId { get; private set; }
                ...
                /// <summary>Gets the specified Version resource. By default, only a BASIC_VIEW will be returned. Please
                ...
                /// <param name="appsId">Part of `parent`. Name of the parent resource to list versions on. For example:
                /// "apps/myapp/services/default".</param>
                /// <param name="servicesId">Part of `parent`. See documentation of
                /// `appsId`.</param>
                ...
                public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.ListVersionsResponse>
                {
                    ...
                    /// <summary>Part of `parent`. Name of the parent resource to list versions on. For example:
            ...
            /// <param name="appsId">Part of `parent`. Name of the parent Application resource. For example:
            /// "apps/myapp".</param>
            public virtual ListRequest List(string appsId)
            {
                return new ListRequest(service, appsId);
            ...
            public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.ListServicesResponse>
            {
                ...
                /// <summary>Part of `parent`. Name of the parent Application resource. For example:
                /// "apps/myapp".</summary>
                [Google.Apis.Util.RequestParameterAttribute("appsId", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string AppsId { get; private set; }
            ...
            public class PatchRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.Operation>
            {
                ...
                /// from a single version to another single version. More information is available in the documentation
                /// for traffic migration: https://cloud.google.com/appengine/docs/python/migrating-traffic</summary>
        ...
        /// <param name="appsId">Part of `name`. The name of the Application resource to get. For example:
        /// "apps/myapp".</param>
        ...
        public class GetRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.Application>
        {
            ...
            /// <summary>Part of `name`. The name of the Application resource to get. For example:
            /// "apps/myapp".</summary>
            [Google.Apis.Util.RequestParameterAttribute("appsId", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string AppsId { get; private set; }
        ...
        /// <summary>Ensures that all special features required for App Engine, such as the appspot bucket and appengine
        /// robot, exist for this project.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="appsId">Part of `name`. Name of the application to repair. For example: "apps/myapp".</param>
        ...
        public class RepairRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1.Data.Operation>
        {
            ...
            /// <summary>Part of `name`. Name of the application to repair. For example: "apps/myapp".</summary>
            [Google.Apis.Util.RequestParameterAttribute("appsId", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string AppsId { get; private set; }
...
{    
    ...
    /// <summary>Google Cloud Endpoints configuration for API handlers. Used to tune behavior of optional Cloud
    /// Endpoints integration.</summary>
    ...
    public class Application : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The relative name of the application. Example: "myapp".</summary>
    ...
    public class Instance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The relative name of the instance within the version. Example: "instance-1" @OutputOnly</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
        ...
        /// <summary>The resource name of an Instance. Example:
    ...
    {
        /// <summary>The relative name of the service within the application. Example: "default" @OutputOnly</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
    ...
    public class Version : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The App Engine execution environment to use for this version. Default: "standard"</summary>
        ...
        /// <summary>The relative name of the Version within the service. Example: "v1". Version specifiers can contain
        /// lowercase letters, digits, and hyphens. It cannot begin with the prefix `ah-` and the names `default` and
        /// `latest` are reserved and cannot be used.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
        ...
        /// <summary>The version's URL, which is of the form: https://service_version_id-dot-service_id-dot-
        /// app_id.appspot.com @OutputOnly</summary>
