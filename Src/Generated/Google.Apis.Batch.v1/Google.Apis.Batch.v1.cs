...
namespace Google.Apis.Batch.v1.Data
{
    ...
    /// <summary>CloudLoggingOption contains additional settings for cloud logging generated by Batch job.</summary>
    ...
    {
        /// <summary>
        /// Optional. Additional settings for Cloud Logging. It will only take effect when the destination of LogsPolicy
