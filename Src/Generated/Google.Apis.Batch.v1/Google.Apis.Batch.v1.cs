...
namespace Google.Apis.Batch.v1.Data
{
    ...
    public class LogsPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `LogsPolicy` is set to `CLOUD_LOGGING`.
        /// </summary>
    ...
    public class TaskGroup : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. If not set or set to false, Batch will use root user to execute runnables. If set to true, Batch
        /// will make sure to run the runnables using non-root user. Currently, the non-root user Batch used is
        /// generated by OS login. Reference: https://cloud.google.com/compute/docs/oslogin
        /// </summary>
