...
namespace Google.Apis.Batch.v1.Data
{
    ...
    public class Container : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. If set to true, container will run with Image streaming. The container runtime will be changed to
        /// containerd instead of docker. Currently, only imageUri, commands, entrypoint and volumes are supported and
        /// any other fields will be ignored. Please refer
        /// [here](https://github.com/GoogleCloudPlatform/batch-samples/tree/main/api-samples/image-streaming) for the
