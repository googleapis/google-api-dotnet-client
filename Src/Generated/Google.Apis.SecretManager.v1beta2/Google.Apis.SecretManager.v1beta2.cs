    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Empty>
                {
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Empty>
                {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Operation>
                {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.ListOperationsResponse>
                {
            ...
            public class SecretsResource
            {
                ...
                public class VersionsResource
                {
                    ...
                    /// `projects/*/secrets/*/versions/latest` is an alias to the most recently created SecretVersion.
                    /// </summary>
                    public class AccessRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.AccessSecretVersionResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta2/{+name}:access";
                    ...
                    /// `projects/*/secrets/*/versions/*` or `projects/*/locations/*/secrets/*/versions/*`.
                    /// </param>
                    public virtual DestroyRequest Destroy(Google.Apis.SecretManager.v1beta2.Data.DestroySecretVersionRequest body, string name)
                    {
                    ...
                    /// destroys the secret data.
                    /// </summary>
                    public class DestroyRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.SecretVersion>
                    {
                        /// <summary>Constructs a new Destroy request.</summary>
                        public DestroyRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.DestroySecretVersionRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        Google.Apis.SecretManager.v1beta2.Data.DestroySecretVersionRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta2/{+name}:destroy";
                    ...
                    /// `projects/*/secrets/*/versions/*` or `projects/*/locations/*/secrets/*/versions/*`.
                    /// </param>
                    public virtual DisableRequest Disable(Google.Apis.SecretManager.v1beta2.Data.DisableSecretVersionRequest body, string name)
                    {
                        return new DisableRequest(this.service, body, name);
                    }

                    /// <summary>Disables a SecretVersion. Sets the state of the SecretVersion to DISABLED.</summary>
                    public class DisableRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.SecretVersion>
                    {
                        /// <summary>Constructs a new Disable request.</summary>
                        public DisableRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.DisableSecretVersionRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.SecretManager.v1beta2.Data.DisableSecretVersionRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta2/{+name}:disable";
                    ...
                    /// `projects/*/secrets/*/versions/*` or `projects/*/locations/*/secrets/*/versions/*`.
                    /// </param>
                    public virtual EnableRequest Enable(Google.Apis.SecretManager.v1beta2.Data.EnableSecretVersionRequest body, string name)
                    {
                        return new EnableRequest(this.service, body, name);
                    }

                    /// <summary>Enables a SecretVersion. Sets the state of the SecretVersion to ENABLED.</summary>
                    public class EnableRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.SecretVersion>
                    {
                        /// <summary>Constructs a new Enable request.</summary>
                        public EnableRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.EnableSecretVersionRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.SecretManager.v1beta2.Data.EnableSecretVersionRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta2/{+name}:enable";
                    ...
                    /// most recently created SecretVersion.
                    /// </summary>
                    public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.SecretVersion>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists SecretVersions. This call does not return secret data.</summary>
                    public class ListRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.ListSecretVersionsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                ...
                /// </param>
                public virtual AddVersionRequest AddVersion(Google.Apis.SecretManager.v1beta2.Data.AddSecretVersionRequest body, string parent)
                {
                ...
                /// Creates a new SecretVersion containing secret data and attaches it to an existing Secret.
                /// </summary>
                public class AddVersionRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.SecretVersion>
                {
                    /// <summary>Constructs a new AddVersion request.</summary>
                    public AddVersionRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.AddSecretVersionRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecretManager.v1beta2.Data.AddSecretVersionRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta2/{+parent}:addVersion";
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.SecretManager.v1beta2.Data.Secret body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a new Secret containing no SecretVersions.</summary>
                public class CreateRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Secret>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.Secret body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecretManager.v1beta2.Data.Secret Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta2/{+parent}/secrets";
                ...
                /// <summary>Gets metadata for a given Secret.</summary>
                public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Secret>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Policy>
                {
                ...
                /// <summary>Lists Secrets.</summary>
                public class ListRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.ListSecretsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.SecretManager.v1beta2.Data.Secret body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates metadata of an existing Secret.</summary>
                public class PatchRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Secret>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.Secret body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.SecretManager.v1beta2.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// SecretVersions are enforced according to the policy set on the associated Secret.
                /// </summary>
                public class SetIamPolicyRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecretManager.v1beta2.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.SecretManager.v1beta2.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// This operation may "fail open" without warning.
                /// </summary>
                public class TestIamPermissionsRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.SecretManager.v1beta2.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.SecretManager.v1beta2.Data.TestIamPermissionsRequest Body { get; set; }
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// private or other locations specifically visible to the project.
            /// </summary>
            public class ListRequest : SecretManagerBaseServiceRequest<Google.Apis.SecretManager.v1beta2.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
namespace Google.Apis.SecretManager.v1beta2.Data
{
    ...
    public class Secret : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// and modifiable via UpdateSecret. Access by alias is only supported for GetSecretVersion and
        /// AccessSecretVersion.
        /// </summary>
