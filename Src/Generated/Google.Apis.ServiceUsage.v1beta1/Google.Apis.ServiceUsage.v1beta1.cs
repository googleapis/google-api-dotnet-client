...
namespace Google.Apis.ServiceUsage.v1beta1
{
    ...
    public class ServicesResource
    {
        ...
        public class ConsumerQuotaMetricsResource
        {
            ...
            public class LimitsResource
            {
                ...
                public class AdminOverridesResource
                {
                    ...
                    /// GetConsumerQuotaMetric call. An example name would be: `projects/123/services/compute.googleapis.com/consumerQuotaMe
                    ...
                    public class CreateRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
                    {
                        ...
                        /// or GetConsumerQuotaMetric call. An example name would be: `projects/123/services/compute.goo
                        /// gleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</
                        /// summary>
                    ...
                    /// <param name="name">The resource name of the override to delete. An example name would be: `projects/123/services/com
                    /// pute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminOverrides/4a3
                    /// f2c1d`</param>
                    ...
                    public class DeleteRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
                    {
                        ...
                        /// <summary>The resource name of the override to delete. An example name would be: `projects/12
                        /// 3/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/
                        /// %2Fproject%2Fregion/adminOverrides/4a3f2c1d`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">The resource name of the override to update. An example name would be: `projects/123/services/com
                    /// pute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminOverrides/4a3
                    /// f2c1d`</param>
                    ...
                    public class PatchRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
                    {
                        ...
                        /// <summary>The resource name of the override to update. An example name would be: `projects/12
                        /// 3/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/
                        /// %2Fproject%2Fregion/adminOverrides/4a3f2c1d`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                ...
                public class ConsumerOverridesResource
                {
                    ...
                    /// <param name="name">The resource name of the override to delete. An example name would be: `projects/123/services/com
                    /// pute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/consumerOverrides/
                    /// 4a3f2c1d`</param>
                    public virtual DeleteRequest Delete(string name)
                    {
                        return new DeleteRequest(service, name);
                    ...
                    public class DeleteRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
                    {
                        ...
                        /// <summary>The resource name of the override to delete. An example name would be: `projects/12
                        /// 3/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/
                        /// %2Fproject%2Fregion/consumerOverrides/4a3f2c1d`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                ...
                /// <param name="name">The resource name of the quota limit. Use the quota limit resource name returned by previous
                /// ListConsumerQuotaMetrics and GetConsumerQuotaMetric API calls.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                }
                ...
                public class GetRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.ConsumerQuotaLimit>
                {
                    ...
                    /// <summary>The resource name of the quota limit. Use the quota limit resource name returned by
                    /// previous ListConsumerQuotaMetrics and GetConsumerQuotaMetric API calls.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            /// <param name="name">The resource name of the quota limit. An example name would be: projects/123/services/serviceusag
            /// e.googleapis.com/quotas/metrics/serviceusage.googleapis.com%2Fmutate_requests</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            }
            ...
            public class GetRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.ConsumerQuotaMetric>
            {
                ...
                /// <summary>The resource name of the quota limit. An example name would be: projects/123/services/servi
                /// ceusage.googleapis.com/quotas/metrics/serviceusage.googleapis.com%2Fmutate_requests</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="parent">Parent of the quotas resource. Some example names would be:
            ...
            public class ListRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.ListConsumerQuotaMetricsResponse>
            {
                ...
                /// <summary>Parent of the quotas resource. Some example names would be:
                /// projects/123/services/serviceconsumermanagement.googleapis.com
                /// folders/345/services/serviceconsumermanagement.googleapis.com
        ...
        /// the entire batch fails, and no state changes occur. Operation</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="parent">Parent to enable services on. An example name would be: `projects/123` where `123` is the
        /// project number (not project ID). The `BatchEnableServices` method currently only supports projects.</param>
        ...
        public class BatchEnableRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
        {
            ...
            /// <summary>Parent to enable services on. An example name would be: `projects/123` where `123` is the
        ...
        /// that may cause unexpected billing charges or security leaks. It is not valid to call the disable method on a
        /// service that is not currently enabled. Callers will receive a `FAILED_PRECONDITION` status if the target
        /// service is not currently enabled. Operation</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="name">Name of the consumer and service to disable the service on. The enable and disable methods
        /// currently only support projects. An example name would be: `projects/123/services/serviceusage.googleapis.com` where
        /// `123` is the project number (not project ID).</param>
        ...
        public class DisableRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
        {
            ...
            /// <summary>Name of the consumer and service to disable the service on. The enable and disable methods
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="name">Name of the consumer and service to enable the service on. The `EnableService` and
        /// `DisableService` methods currently only support projects. Enabling a service requires that the service is public or
        /// is shared with the user enabling the service. An example name would be:
        /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project ID).</param>
        ...
        public class EnableRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
        {
            ...
            /// <summary>Name of the consumer and service to enable the service on. The `EnableService` and
            /// `DisableService` methods currently only support projects. Enabling a service requires that the service
            /// is public or is shared with the user enabling the service. An example name would be:
            /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project
            /// ID).</summary>
            [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Name { get; private set; }
        ...
        /// <param name="parent">Name of the consumer and service to generate an identity for. The `GenerateServiceIdentity`
        /// methods currently only support projects. An example name would be: `projects/123/services/example.googleapis.com`
        /// where `123` is the project number.</param>
        ...
        public class GenerateServiceIdentityRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
        {
            ...
            public GenerateServiceIdentityRequest(Google.Apis.Services.IClientService service, string parent)
                : base(service)
            {
                Parent = parent;
                InitParameters();
            ...
            /// <summary>Name of the consumer and service to generate an identity for. The `GenerateServiceIdentity`
            /// methods currently only support projects. An example name would be:
            /// `projects/123/services/example.googleapis.com` where `123` is the project number.</summary>
            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Parent { get; private set; }
        ...
        /// <param name="name">Name of the consumer and service to get the `ConsumerState` for. An example name would be:
        /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project ID).</param>
        public virtual GetRequest Get(string name)
        {
            return new GetRequest(service, name);
        ...
        public class GetRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Service>
        {
            ...
            /// <summary>Name of the consumer and service to get the `ConsumerState` for. An example name would be:
            /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project
            /// ID).</summary>
            [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Name { get; private set; }
        ...
        /// project number (not project ID).</param>
        public virtual ListRequest List(string parent)
        {
            return new ListRequest(service, parent);
        }
        ...
        public class ListRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.ListServicesResponse>
        {
            ...
            /// <summary>Parent to search for services on. An example name would be: `projects/123` where `123` is the
            /// project number (not project ID).</summary>
            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Parent { get; private set; }
...
{    
    ...
    public class AdminQuotaPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the policy. This name is generated by the server when the policy is created.
        /// Example names would be: `organizations/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.goog
        /// leapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminQuotaPolicies/4a3f2c1d`</summary>
    ...
    {
        /// <summary>The identifiers of the services to enable on the project. A valid identifier would be:
        ...
        /// 20 services are specified, the request will fail, and no state changes will occur.</summary>
    ...
    public class ConsumerQuotaLimit : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the quota limit. An example name would be: `projects/123/services/compute.goog
        /// leapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion` The resource name
    ...
    public class GoogleApiServiceusageV1Service : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The resource name of the consumer and service. A valid name would be: -
        /// projects/123/services/serviceusage.googleapis.com</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
    ...
    public class QuotaOverride : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// created. Example names would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.
        /// googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminOverrides/4a3f2c1d` `projects/123/services/compute.goo
        /// gleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/consumerOverrides/
        /// 4a3f2c1d` The resource name is intended to be opaque and should not be parsed for its component strings,
        /// since its representation could change in the future.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
