...
namespace Google.Apis.ServiceUsage.v1beta1
{
    ...
    public class ServicesResource
    {
        ...
        /// <param name="parent">Name of the consumer and service to generate an identity for.
        ///
        ...
        public class GenerateServiceIdentityRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1beta1.Data.Operation>
        {
            ...
            /// <summary>Name of the consumer and service to generate an identity for.
            ///
            /// The `GenerateServiceIdentity` methods currently only support projects.
            ///
            /// An example name would be: `projects/123/services/example.googleapis.com` where `123` is the project
...
{    
    ...
    public class AdminQuotaPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// *   If "region" appears as a key, its value must be a valid Cloud region. *   If "zone" appears as a key,
        /// its value must be a valid Cloud zone. *   Keys other than "region" or "zone" are not valid.</summary>
