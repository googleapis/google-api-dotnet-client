        ...
        public class LocationsResource
        {
            ...
            public class ServicesResource
            {
                ...
                public class ConnectorsResource
                {
                    ...
                    /// ```
                    /// </param>
                    public virtual ImpersonateMutationRequest ImpersonateMutation(Google.Apis.FirebaseDataConnect.v1beta.Data.ImpersonateRequest body, string name)
                    {
                    ...
                    /// particular Firebase Auth user, or skip @auth completely.
                    /// </summary>
                    public class ImpersonateMutationRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1beta.Data.GraphqlResponse>
                    {
                        /// <summary>Constructs a new ImpersonateMutation request.</summary>
                        public ImpersonateMutationRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1beta.Data.ImpersonateRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.FirebaseDataConnect.v1beta.Data.ImpersonateRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+name}:impersonateMutation";
                    ...
                    /// ```
                    /// </param>
                    public virtual ImpersonateQueryRequest ImpersonateQuery(Google.Apis.FirebaseDataConnect.v1beta.Data.ImpersonateRequest body, string name)
                    {
                    ...
                    /// Firebase Auth user, or skip @auth completely.
                    /// </summary>
                    public class ImpersonateQueryRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1beta.Data.GraphqlResponse>
                    {
                        /// <summary>Constructs a new ImpersonateQuery request.</summary>
                        public ImpersonateQueryRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1beta.Data.ImpersonateRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+name}:impersonateQuery";
                ...
                /// projects/{project}/locations/{location}/services/{service}
                /// </param>
                public virtual GenerateQueryRequest GenerateQuery(Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateQueryRequest body, string name)
                {
                ...
                /// Streams results with real-time status and output chunks.
                /// </summary>
                public class GenerateQueryRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateQueryResponse>
                {
                    /// <summary>Constructs a new GenerateQuery request.</summary>
                    public GenerateQueryRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateQueryRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateQueryRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:generateQuery";
                ...
                /// projects/{project}/locations/{location}/services/{service}
                /// </param>
                public virtual GenerateSchemaRequest GenerateSchema(Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateSchemaRequest body, string name)
                {
                ...
                /// to scaffold new types and tables quickly. Streams results with real-time status and output chunks.
                /// </summary>
                public class GenerateSchemaRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateSchemaResponse>
                {
                    /// <summary>Constructs a new GenerateSchema request.</summary>
                    public GenerateSchemaRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateSchemaRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.FirebaseDataConnect.v1beta.Data.GenerateSchemaRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:generateSchema";
                ...
                /// ```
                /// </param>
                public virtual IntrospectGraphqlRequest IntrospectGraphql(Google.Apis.FirebaseDataConnect.v1beta.Data.GraphqlRequest body, string name)
                {
                ...
                /// rows from Cloud SQL instance, which can be done via ExecuteGraphqlRead.
                /// </summary>
                public class IntrospectGraphqlRequest : FirebaseDataConnectBaseServiceRequest<Google.Apis.FirebaseDataConnect.v1beta.Data.GraphqlResponse>
                {
                    /// <summary>Constructs a new IntrospectGraphql request.</summary>
                    public IntrospectGraphqlRequest(Google.Apis.Services.IClientService service, Google.Apis.FirebaseDataConnect.v1beta.Data.GraphqlRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:introspectGraphql";
