...
namespace Google.Apis.ServiceUsage.v1
{
    ...
    public class ServicesResource
    {
        ...
        /// project number. The `BatchEnableServices` method currently only supports projects.</param>
        ...
        public class BatchEnableRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1.Data.Operation>
        {
            ...
            /// project number. The `BatchEnableServices` method currently only supports projects.</summary>
        ...
        /// <param name="parent">Parent to retrieve services from. If this is set, the parent of all of the services specified
        /// in `names` must match this field. An example name would be: `projects/123` where `123` is the project number. The
        /// `BatchGetServices` method currently only supports projects.</param>
        ...
        public class BatchGetRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1.Data.BatchGetServicesResponse>
        {
            ...
            public BatchGetRequest(Google.Apis.Services.IClientService service, string parent)
                : base(service)
            {
                Parent = parent;
                InitParameters();
            ...
            /// <summary>Parent to retrieve services from. If this is set, the parent of all of the services specified
            /// in `names` must match this field. An example name would be: `projects/123` where `123` is the project
            /// number. The `BatchGetServices` method currently only supports projects.</summary>
            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Parent { get; private set; }

            /// <summary>Names of the services to retrieve. An example name would be:
            /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number. A single request
            /// can get a maximum of 30 services at a time.</summary>
        ...
        /// service is not currently enabled.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        /// `123` is the project number.</param>
        ...
        public class DisableRequest : ServiceUsageBaseServiceRequest<Google.Apis.ServiceUsage.v1.Data.Operation>
        {
            ...
            /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number.</summary>
            [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Name { get; private set; }
        ...
        /// `projects/123/services/serviceusage.googleapis.com` where `123` is the project number.</param>
...
{    
    ...
    public class BatchEnableServicesRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// services are specified, the request will fail, and no state changes will occur.</summary>
