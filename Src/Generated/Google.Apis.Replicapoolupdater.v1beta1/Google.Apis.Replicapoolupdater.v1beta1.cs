...
namespace Google.Apis.Replicapoolupdater.v1beta1
{
    ...
    public class ReplicapoolupdaterService : Google.Apis.Services.BaseClientService
    {
            ...
            : base(initializer)
        {
            ...
            rollout = new RolloutResource(this);
        ...
        private readonly RolloutResource rollout;

        /// <summary>Gets the Rollout resource.</summary>
        public virtual RolloutResource Rollout
        {
            get { return rollout; }
        }
    ...
    /// <summary>The "rollout" collection of methods.</summary>
    public class RolloutResource
    {
        private const string Resource = "rollout";

        /// <summary>The service which this resource belongs to.</summary>
        private readonly Google.Apis.Services.IClientService service;

        /// <summary>Constructs a new resource.</summary>
        public RolloutResource(Google.Apis.Services.IClientService service)
        {
            this.service = service;
        ...
        /// <summary>Abandon a rollout, leaving the IGM in the state it is already configured. This allows you to apply
        /// a new rollout to the IGM.</summary>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual AbandonRequest Abandon(string project, string zone, string rollout)
        {
            return new AbandonRequest(service, project, zone, rollout);
        }

        /// <summary>Abandon a rollout, leaving the IGM in the state it is already configured. This allows you to apply
        /// a new rollout to the IGM.</summary>
        public class AbandonRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Abandon request.</summary>
            public AbandonRequest(Google.Apis.Services.IClientService service, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            /// <summary>The ID of the update.</summary>
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}/abandon"; }
            }
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add(
                    "rollout", new Google.Apis.Discovery.Parameter
                    {
                        Name = "rollout",
                        IsRequired = true,
                        ParameterType = "path",
        ...
        /// <summary>Commits a rollout, so that it is final and can not be rolled back</summary>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual CommitRequest Commit(string project, string zone, string rollout)
        {
            return new CommitRequest(service, project, zone, rollout);
        }

        /// <summary>Commits a rollout, so that it is final and can not be rolled back</summary>
        public class CommitRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Commit request.</summary>
            public CommitRequest(Google.Apis.Services.IClientService service, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}/commit"; }
            }
        ...
        /// <summary>Get the details of a rollout</summary>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual GetRequest Get(string project, string zone, string rollout)
        {
            return new GetRequest(service, project, zone, rollout);
        }

        /// <summary>Get the details of a rollout</summary>
        public class GetRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}"; }
            }
        ...
        /// <summary>Inserts and starts a new rollout</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        public virtual InsertRequest Insert(Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout body, string project, string zone)
        {
            return new InsertRequest(service, body, project, zone);
        }

        /// <summary>Inserts and starts a new rollout</summary>
        public class InsertRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout body, string project, string zone)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            /// <summary>How the update policy should be initialised.</summary>
            [Google.Apis.Util.RequestParameterAttribute("updatePolicyInitialisationMethod", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<UpdatePolicyInitialisationMethodEnum> UpdatePolicyInitialisationMethod { get; set; }

            /// <summary>How the update policy should be initialised.</summary>
            public enum UpdatePolicyInitialisationMethodEnum
            {
                [Google.Apis.Util.StringValueAttribute("FROM_IGM")]
                FROMIGM,
                [Google.Apis.Util.StringValueAttribute("FROM_PARENT")]
                FROMPARENT,
            }


            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts"; }
            }
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add(
                    "updatePolicyInitialisationMethod", new Google.Apis.Discovery.Parameter
                    {
                        Name = "updatePolicyInitialisationMethod",
                        IsRequired = false,
                        ParameterType = "query",
                        DefaultValue = null,
                        Pattern = null,
        ...
        /// <summary>Resume a rollout. This lets the rollout continue updating instances after a pause.</summary>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        public virtual ListRequest List(string project, string zone)
        ...
        /// <summary>Resume a rollout. This lets the rollout continue updating instances after a pause.</summary>
        public class ListRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.ListRolloutResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project, string zone)
                : base(service)
        ...
        /// <summary>Pause the application of a rollout. This stops the update, and the instances managed by the
        /// instance group manager do not change their instance templates.</summary>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual PauseRequest Pause(string project, string zone, string rollout)
        {
            return new PauseRequest(service, project, zone, rollout);
        }

        /// <summary>Pause the application of a rollout. This stops the update, and the instances managed by the
        /// instance group manager do not change their instance templates.</summary>
        public class PauseRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Pause request.</summary>
            public PauseRequest(Google.Apis.Services.IClientService service, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}/pause"; }
            }
        ...
        /// <summary>Change the amount of instances within an IGM that should be updated to the new instance
        /// template</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual RampupRequest Rampup(Google.Apis.Replicapoolupdater.v1beta1.Data.RampUpRolloutRequest body, string project, string zone, string rollout)
        {
            return new RampupRequest(service, body, project, zone, rollout);
        }

        /// <summary>Change the amount of instances within an IGM that should be updated to the new instance
        /// template</summary>
        public class RampupRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Rampup request.</summary>
            public RampupRequest(Google.Apis.Services.IClientService service, Google.Apis.Replicapoolupdater.v1beta1.Data.RampUpRolloutRequest body, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Replicapoolupdater.v1beta1.Data.RampUpRolloutRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}/rampup"; }
            }

            /// <summary>Initializes Rampup parameter list.</summary>
            protected override void InitParameters()
            {
                base.InitParameters();
        ...
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual ResumeRequest Resume(string project, string zone, string rollout)
        {
            return new ResumeRequest(service, project, zone, rollout);
        }

        /// <summary>Resume a rollout. This lets the rollout continue updating instances after a pause.</summary>
        public class ResumeRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Resume request.</summary>
            public ResumeRequest(Google.Apis.Services.IClientService service, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}/resume"; }
            }
        ...
        /// <summary>Rollback a rollout, cancelling the update and changing all instances with the updated version to
        /// have the instanceTemplateToRollback template.</summary>
        /// <param name="project">The Google Developers Console project name.</param>
        /// <param name="zone">The name of the
        /// zone in which the update's target resides.</param>
        /// <param name="rollout">The ID of the update.</param>
        public virtual RollbackRequest Rollback(string project, string zone, string rollout)
        {
            return new RollbackRequest(service, project, zone, rollout);
        }

        /// <summary>Rollback a rollout, cancelling the update and changing all instances with the updated version to
        /// have the instanceTemplateToRollback template.</summary>
        public class RollbackRequest : ReplicapoolupdaterBaseServiceRequest<Google.Apis.Replicapoolupdater.v1beta1.Data.Rollout>
        {
            /// <summary>Constructs a new Rollback request.</summary>
            public RollbackRequest(Google.Apis.Services.IClientService service, string project, string zone, string rollout)
                : base(service)
            {
                Project = project;
                Zone = zone;
            ...
            public override string RestPath
            {
                get { return "{project}/zones/{zone}/rollouts/{rollout}/rollback"; }
            }
...
{    
    ...
    /// <summary>Used to specify an amount of instances within an instance group. Only one of fixed and percentage can
    /// be specified.</summary>
    public class FixedOrPercent : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Specify a fixed amount of instances</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("fixed")]
        public virtual System.Nullable<int> Fixed__ { get; set; } 

        /// <summary>Specify a percentage of the total amount of instances within an instance group manager</summary>
    ...
    public class ListRolloutResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resources")]
        public virtual System.Collections.Generic.IList<Rollout> Resources { get; set; } 
    ...
    public class RampUpRolloutRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The new amount of instances in the IGM to update instances to.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("canarySize")]
        public virtual FixedOrPercent CanarySize { get; set; } 
    ...
    {
        /// <summary>The amount of instances within the instance group manager to be updated to the new instance
        /// template.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("canarySize")]
        public virtual FixedOrPercent CanarySize { get; set; } 

        /// <summary>A list of the amount of instances within the instance group manager to be updated to the new
        /// instance template. Each target size is updated sequentially, in the order supplied.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("canarySizeStages")]
        public virtual System.Collections.Generic.IList<FixedOrPercent> CanarySizeStages { get; set; } 

        /// <summary>[Output Only] Creation timestamp in RFC3339 text format.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("creationTimestamp")]
        public virtual string CreationTimestamp { get; set; } 

        /// <summary>How long to wait for the health checks to return positive before assuming the update has failed or
        /// succeeded.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("healthCheckDeadlineSec")]
        public virtual System.Nullable<long> HealthCheckDeadlineSec { get; set; } 

        /// <summary>[Output Only] Unique identifier for the resource; defined by the server.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 

        /// <summary>Fully-qualified URL of an instance group manager being updated.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("instanceGroupManager")]
        public virtual string InstanceGroupManager { get; set; } 
        ...
        /// <summary>Fully-qualified URL of the instance template to rollback to if the rollout is cancelled.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("instanceTemplateToRollback")]
        public virtual string InstanceTemplateToRollback { get; set; } 

        /// <summary>[Output Only] Type of the resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; } 

        /// <summary>The parent rollout to inherit unspecified fields from.</summary>
        ...
        /// <summary>[Output Only] The current state of the rollout.</summary>
