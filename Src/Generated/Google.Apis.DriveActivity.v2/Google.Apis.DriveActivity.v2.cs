...
namespace Google.Apis.DriveActivity.v2
{
    ...
    public class DriveActivityService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://driveactivity.googleapis.com/";
...
namespace Google.Apis.DriveActivity.v2.Data
{
    ...
    public class Date : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        {
            get => Google.Apis.Util.Utilities.GetDateTimeOffsetFromString(ValueRaw);
            set => ValueRaw = Google.Apis.Util.Utilities.GetStringFromDateTimeOffset(value);
        }
