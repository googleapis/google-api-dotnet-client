    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                /// `us-west1-b`.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Parallelstore.v1beta.Data.Instance body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a Parallelstore instance in a given project and location.</summary>
                public class CreateRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Parallelstore.v1beta.Data.Instance body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Parallelstore.v1beta.Data.Instance Body { get; set; }
                ...
                /// <summary>Deletes a single instance.</summary>
                public class DeleteRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Operation>
                {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. Name of the resource.</param>
                public virtual ExportDataRequest ExportData(Google.Apis.Parallelstore.v1beta.Data.ExportDataRequest body, string name)
                {
                    return new ExportDataRequest(this.service, body, name);
                }

                /// <summary>Copies data from Parallelstore to Cloud Storage.</summary>
                public class ExportDataRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new ExportData request.</summary>
                    public ExportDataRequest(Google.Apis.Services.IClientService service, Google.Apis.Parallelstore.v1beta.Data.ExportDataRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Parallelstore.v1beta.Data.ExportDataRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:exportData";
                ...
                /// <summary>Gets details of a single instance.</summary>
                public class GetRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Instance>
                {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. Name of the resource.</param>
                public virtual ImportDataRequest ImportData(Google.Apis.Parallelstore.v1beta.Data.ImportDataRequest body, string name)
                {
                    return new ImportDataRequest(this.service, body, name);
                }

                /// <summary>Copies data from Cloud Storage to Parallelstore.</summary>
                public class ImportDataRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new ImportData request.</summary>
                    public ImportDataRequest(Google.Apis.Services.IClientService service, Google.Apis.Parallelstore.v1beta.Data.ImportDataRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Parallelstore.v1beta.Data.ImportDataRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:importData";
                ...
                /// <summary>Lists all instances in a given project and location.</summary>
                public class ListRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.ListInstancesResponse>
                {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Parallelstore.v1beta.Data.Instance body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates the parameters of a single instance.</summary>
                public class PatchRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Parallelstore.v1beta.Data.Instance body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class OperationsResource
            {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.GoogleProtobufEmpty>
                {
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.GoogleProtobufEmpty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : ParallelstoreBaseServiceRequest<Google.Apis.Parallelstore.v1beta.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
