...
namespace Google.Apis.CloudRun.v1.Data
{
    ...
    public class ObjectMeta : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `run.googleapis.com/build-service-account`: Service. * `run.googleapis.com/build-worker-pool`: Service. *
        ...
        /// `run.googleapis.com/execution-environment`: Revision, Execution. * `run.googleapis.com/function-target`:
        /// Service. * `run.googleapis.com/gc-traffic-tags`: Service. * `run.googleapis.com/ingress`: Service. *
        ...
        /// Revision. * `run.googleapis.com/source-location`: Service. * `run.googleapis.com/startup-cpu-boost`:
