...
namespace Google.Apis.CloudRun.v1.Data
{
    ...
    public class ObjectMeta : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Revision. * `autoscaling.knative.dev/minScale`: Revision. * `run.googleapis.com/base-images`: Revision,
        /// Service. * `run.googleapis.com/binary-authorization-breakglass`: Service, Job, *
        /// `run.googleapis.com/binary-authorization`: Service, Job, Execution. *
        /// `run.googleapis.com/build-environment-variables`: Service. * `run.googleapis.com/build-id`: Service. *
        /// `run.googleapis.com/build-name`: Service. * `run.googleapis.com/build-service-account`: Service. *
        /// `run.googleapis.com/build-worker-pool`: Service. * `run.googleapis.com/client-name`: All resources. *
        ...
        /// Service. * `run.googleapis.com/default-url-disabled`: Service. * `run.googleapis.com/description`: Service.
        ...
        /// `run.googleapis.com/post-key-revocation-action-type`: Revision. * `run.googleapis.com/runtime`: Service. *
        /// `run.googleapis.com/secrets`: Revision, Execution. * `run.googleapis.com/secure-session-agent`: Revision. *
        /// `run.googleapis.com/sessionAffinity`: Revision. * `run.googleapis.com/source-location`: Service. *
