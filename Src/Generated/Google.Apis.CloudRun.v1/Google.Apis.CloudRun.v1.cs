            ...
            public class NamespacesResource
            {
                ...
                public class SecretsResource
                {
                    ...
                    public class CreateRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v1.Data.Secret>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v1.Data.Secret body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        public override string RestPath => "api/v1/{+parent}/secrets";
                    ...
                    public class GetRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v1.Data.Secret>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "api/v1/{+name}";
                    ...
                    public class ReplaceSecretRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v1.Data.Secret>
                    {
                        ...
                        public ReplaceSecretRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v1.Data.Secret body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets the method name.</summary>
                        public override string MethodName => "replaceSecret";
                ...
                public class PatchRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v1.Data.Namespace>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v1.Data.Namespace body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
...
{    
    ...
    public class ConfigurationSpec : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// instances" annotation key. To set a Serverless VPC Access connector for the revision, use the
        /// "run.googleapis.com/vpc-access-connector" annotation key. Values should be comma separated.</summary>
    ...
    public class ResourceRequirements : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// values for CPU are '1' and '2'. Cloud Run for Anthos: supported Limits describes the maximum amount of
        /// compute resources allowed. The values of the map is string form of the 'quantity' k8s type: https://github.c
        /// om/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go</summary>
        ...
        /// <summary>(Optional) Cloud Run fully managed: Only memory and CPU are supported. Note: The only supported
        /// values for CPU are '1' and '2'. Cloud Run for Anthos: supported Requests describes the minimum amount of
        /// compute resources required. If Requests is omitted for a container, it defaults to Limits if that is
        /// explicitly specified, otherwise to an implementation-defined value. The values of the map is string form of
