...
namespace Google.Apis.CloudIdentity.v1
{
    ...
    public class AllowlistedDomainsResource
    {
        ...
        public virtual CreateRequest Create(Google.Apis.CloudIdentity.v1.Data.AllowlistedDomain body)
        {
        ...
        public class CreateRequest : CloudIdentityBaseServiceRequest<Google.Apis.CloudIdentity.v1.Data.Operation>
        {
            ...
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIdentity.v1.Data.AllowlistedDomain body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            Google.Apis.CloudIdentity.v1.Data.AllowlistedDomain Body { get; set; }
            ...
            public override string RestPath => "v1/allowlistedDomains";
        ...
        /// <summary>Retrieves a specific domain from the allowlist.</summary>
        public class GetRequest : CloudIdentityBaseServiceRequest<Google.Apis.CloudIdentity.v1.Data.AllowlistedDomain>
        {
        ...
        /// <summary>Lists the domains in the allowlist.</summary>
        public class ListRequest : CloudIdentityBaseServiceRequest<Google.Apis.CloudIdentity.v1.Data.ListAllowlistedDomainsResponse>
        {
    ...
    public class GroupsResource
    {
        ...
        public class SearchRequest : CloudIdentityBaseServiceRequest<Google.Apis.CloudIdentity.v1.Data.SearchGroupsResponse>
        {
            ...
            /// examples. * Must contain equality operators on the parent, e.g. `parent == 'customers/{customer_id}'`.
            /// The `customer_id` must begin with "C" (for example, 'C046psxkn'). [Find your customer ID.]
            /// (https://support.google.com/cloudidentity/answer/10070793) * Can contain optional inclusion operators on
            /// `labels` such as `'cloudidentity.googleapis.com/groups.discussion_forum' in labels`). * Can contain an
            /// optional equality operator on `domain_name`. e.g. `domain_name == 'examplepetstore.com'` * Can contain
            /// optional `startsWith/contains/equality` operators on `group_key`, e.g. `group_key.startsWith('dev')`,
            /// `group_key.contains('dev'), group_key == 'dev@examplepetstore.com'` * Can contain optional
            /// `startsWith/contains/equality` operators on `display_name`, such as `display_name.startsWith('dev')` ,
            /// `display_name.contains('dev')`, `display_name == 'dev'` Examples: * Search for all discussion forums
            /// under a customer: `parent == 'customers/C046psxkn' &amp;amp;&amp;amp;
            /// 'cloudidentity.googleapis.com/groups.discussion_forum' in labels` * Search for groups with key starting
            /// with 'sales': `parent == 'customers/C046psxkn' &amp;amp;&amp;amp; group_key.startsWith('sales')` *
            /// Search for groups with display name containing 'test': `parent == 'customers/C046psxkn'
    ...
    public class PoliciesResource
    {
        ...
        /// <param name="body">The body of the request.</param>
        public virtual CreateRequest Create(Google.Apis.CloudIdentity.v1.Data.Policy body)
        {
            return new CreateRequest(this.service, body);
        }
        ...
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIdentity.v1.Data.Policy body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudIdentity.v1.Data.Policy Body { get; set; }
        ...
        /// <param name="name">Required. The name of the policy to delete. Format: `policies/{policy}`.</param>
        public virtual DeleteRequest Delete(string name)
        {
            return new DeleteRequest(this.service, name);
        }
        ...
        public class DeleteRequest : CloudIdentityBaseServiceRequest<Google.Apis.CloudIdentity.v1.Data.Operation>
        {
            ...
            /// <summary>Required. The name of the policy to delete. Format: `policies/{policy}`.</summary>
            [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Name { get; private set; }
        ...
        /// </param>
        public virtual PatchRequest Patch(Google.Apis.CloudIdentity.v1.Data.Policy body, string name)
        {
            return new PatchRequest(this.service, body, name);
        }
        ...
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudIdentity.v1.Data.Policy body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
