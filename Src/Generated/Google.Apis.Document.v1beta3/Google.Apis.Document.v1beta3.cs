        ...
        public class LocationsResource
        {
            ...
            public class ProcessorsResource
            {
                ...
                public class HumanReviewConfigResource
                {
                    ...
                    /// <summary>Send a document for Human Review. The input document should be processed by the
                    /// specified processor.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="humanReviewConfig">Required. The resource name of the HumanReviewConfig that the document will be
                    /// reviewed with.</param>
                    ...
                    public class ReviewDocumentRequest : DocumentBaseServiceRequest<Google.Apis.Document.v1beta3.Data.GoogleLongrunningOperation>
                    {
                        ...
                        /// <summary>Required. The resource name of the HumanReviewConfig that the document will be
                        /// reviewed with.</summary>
                ...
                public class ProcessorVersionsResource
                {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The resource name of Processor or ProcessorVersion. Format:
                    /// projects/{project}/locations/{location}/processors/{processor}, or
                    /// projects/{project}/locations/{location}/processors/{processor}/processorVerions/{processorVersion}</param>
                    ...
                    public class BatchProcessRequest : DocumentBaseServiceRequest<Google.Apis.Document.v1beta3.Data.GoogleLongrunningOperation>
                    {
                        ...
                        /// <summary>Required. The resource name of Processor or ProcessorVersion. Format:
                        /// projects/{project}/locations/{location}/processors/{processor}, or projects/{project}/locati
                        /// ons/{location}/processors/{processor}/processorVerions/{processorVersion}</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The resource name of the Processor or ProcessorVersion to use for processing. If a
                    ...
                    public class ProcessRequest : DocumentBaseServiceRequest<Google.Apis.Document.v1beta3.Data.GoogleCloudDocumentaiV1beta3ProcessResponse>
                    {
                        ...
                        /// <summary>Required. The resource name of the Processor or ProcessorVersion to use for
                        /// processing. If a Processor is specified, the server will use its default version. Format:
                        /// projects/{project}/locations/{location}/processors/{processor}, or projects/{project}/locati
                        /// ons/{location}/processors/{processor}/processorVerions/{processorVersion}</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                ...
                public class BatchProcessRequest : DocumentBaseServiceRequest<Google.Apis.Document.v1beta3.Data.GoogleLongrunningOperation>
                {
                    ...
                    /// {location}/processors/{processor}/processorVerions/{processorVersion}</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                public class ProcessRequest : DocumentBaseServiceRequest<Google.Apis.Document.v1beta3.Data.GoogleCloudDocumentaiV1beta3ProcessResponse>
                {
                    ...
                    /// <summary>Required. The resource name of the Processor or ProcessorVersion to use for processing.
...
{    
    ...
    public class GoogleCloudDocumentaiUiv1beta3CreateProcessorVersionMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The basic metadata of the long running operation.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("commonMetadata")]
        public virtual GoogleCloudDocumentaiUiv1beta3CommonOperationMetadata CommonMetadata { get; set; }
    ...
    /// <summary>Response message for the disable processor method. Intentionally empty proto for adding fields in
    /// future.</summary>
    ...
    /// <summary>Response message for the enable processor method. Intentionally empty proto for adding fields in
    /// future.</summary>
    ...
    {
        /// <summary>Postal address. See also:
        /// https://github.com/googleapis/googleapis/blob/master/google/type/postal_address.proto</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("addressValue")]
        public virtual GoogleTypePostalAddress AddressValue { get; set; }

        /// <summary>Date value. Includes year, month, day. See also:
        /// https://github.com/googleapis/googleapis/blob/master/google/type/date.proto</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("dateValue")]
        public virtual GoogleTypeDate DateValue { get; set; }

        /// <summary>DateTime value. Includes date, time, and timezone. See also:
        /// https://github.com/googleapis/googleapis/blob/master/google/type/datetime.proto</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("datetimeValue")]
        public virtual GoogleTypeDateTime DatetimeValue { get; set; }

        /// <summary>Money value. See also:
        /// https://github.com/googleapis/googleapis/blob/master/google/type/money.proto</summary>
    ...
    public class GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRef : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. Index into the Document.pages element, for example using Document.pages to locate the
        /// related page element.</summary>
    ...
    public class GoogleCloudDocumentaiV1beta1OutputConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// 100 pages, 100 parsed pages will be produced. If `pages_per_shard` = 20, then 5 Document shard JSON files
        /// each containing 20 parsed pages will be written under the prefix OutputConfig.gcs_destination.uri and suffix
    ...
    public class GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Mimetype of the input. If the input is a raw document, the supported mimetypes are application/pdf,
        /// image/tiff, and image/gif. If the input is a [Document] proto, the type should be
    ...
    /// <summary>The message for output config in batch process.</summary>
    ...
    /// <summary>Response message for the process document method.</summary>
