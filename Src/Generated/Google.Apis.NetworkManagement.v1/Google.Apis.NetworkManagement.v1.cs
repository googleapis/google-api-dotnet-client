            ...
            public class GlobalResource
            {
                ...
                public class ConnectivityTestsResource
                {
                    ...
                    public class CreateRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1.Data.Operation>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1.Data.ConnectivityTest body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    public class PatchRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1.Data.Operation>
                    {
                        ...
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1.Data.ConnectivityTest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    public class RerunRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1.Data.Operation>
                    {
                        ...
                        public RerunRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1.Data.RerunConnectivityTestRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    public class SetIamPolicyRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1.Data.Policy>
                    {
                        ...
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1.Data.SetIamPolicyRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                    ...
                    public class TestIamPermissionsRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1.Data.TestIamPermissionsResponse>
                    {
                        ...
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1.Data.TestIamPermissionsRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                ...
                public class OperationsResource
                {
                    ...
                    public class CancelRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1.Data.Empty>
                    {
                        ...
                        public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1.Data.CancelOperationRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
