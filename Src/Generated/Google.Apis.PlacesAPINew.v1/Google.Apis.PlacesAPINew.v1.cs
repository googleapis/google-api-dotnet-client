...
namespace Google.Apis.PlacesAPINew.v1
{
    /// <summary>The PlacesAPINew Service.</summary>
    public class PlacesAPINewService : Google.Apis.Services.BaseClientService
    {
        ...
        public PlacesAPINewService() : this(new Google.Apis.Services.BaseClientService.Initializer())
        {
        }

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public PlacesAPINewService(Google.Apis.Services.BaseClientService.Initializer initializer) : base(initializer)
        {
    ...
    /// <summary>A base abstract class for PlacesAPINew requests.</summary>
    public abstract class PlacesAPINewBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        /// <summary>Constructs a new PlacesAPINewBaseServiceRequest instance.</summary>
        protected PlacesAPINewBaseServiceRequest(Google.Apis.Services.IClientService service) : base(service)
        {
        }
        ...
        /// <summary>Initializes PlacesAPINew parameter list.</summary>
    ...
    public class TextResource
    {
        ...
        public virtual SearchRequest Search(Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextRequest body)
        {
            return new SearchRequest(service, body);
        }

        /// <summary>Text query based place search.</summary>
        public class SearchRequest : PlacesAPINewBaseServiceRequest<Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextResponse>
        {
            /// <summary>Constructs a new Search request.</summary>
            public SearchRequest(Google.Apis.Services.IClientService service, Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextRequest Body { get; set; }
    ...
    public class PlacesResource
    {
        ...
        /// <summary>Text query based place search.</summary>
        /// <param name="body">The body of the request.</param>
        public virtual SearchTextRequest SearchText(Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextRequest body)
        {
            return new SearchTextRequest(service, body);
        }

        /// <summary>Text query based place search.</summary>
        public class SearchTextRequest : PlacesAPINewBaseServiceRequest<Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextResponse>
        {
            /// <summary>Constructs a new SearchText request.</summary>
            public SearchTextRequest(Google.Apis.Services.IClientService service, Google.Apis.PlacesAPINew.v1.Data.GoogleMapsPlacesV1SearchTextRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
...
namespace Google.Apis.PlacesAPINew.v1.Data
{
    /// <summary>
