...
/**
 * \brief
 *   Cloud Security Command Center API Version v1
 *
    ...
    public class OrganizationsResource
    {
        ...
        public class AssetsResource
        {
            ...
            public class GroupRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1.Data.GroupAssetsResponse>
            {
                ...
                {
                    get { return "v1/{+parent}/assets:group"; }
                }
            ...
            public class RunDiscoveryRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1.Data.Operation>
            {
                ...
                public override string RestPath
                {
                    get { return "v1/{+parent}/assets:runDiscovery"; }
                }
        ...
        public class SourcesResource
        {
            ...
            public class FindingsResource
            {
                ...
                /// /v1/organizations/123/sources/-/findings</summary>
                /// <param name="body">The body of the request.</param>
                ...
                public class GroupRequest : SecurityCommandCenterBaseServiceRequest<Google.Apis.SecurityCommandCenter.v1.Data.GroupFindingsResponse>
                {
                    ...
                    public override string RestPath
                    {
                        get { return "v1/{+parent}/findings:group"; }
                    }
...
{    
    ...
    public class Finding : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// would capture the time the open firewall was detected.</summary>
    ...
    public class GroupAssetsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// '=' create_time | '>', '<', '>=', '<=', '=' iam_policy.policy_blob | '=', ':' resource_properties | '=',
        /// ':', '>', '<', '>=', '<=' security_marks | '=', ':' security_center_properties.resource_name | '=', ':'
        /// security_center_properties.resource_type | '=', ':' security_center_properties.resource_parent | '=', ':'
    ...
    public class GroupFindingsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Expression that defines what assets fields to use for grouping (including `state_change`). The
    ...
    public class Source : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// example, two sources with the same parent can't share the same display name. The display name must start and
        /// end with a letter or digit, may contain letters, digits, spaces, hyphens, and underscores, and can be no
        /// longer than 32 characters. This is captured by the regular expression: [\p{L}\p{N}]({\p{L}\p{N}_-
        /// ]{0,30}[\p{L}\p{N}])?.</summary>
