    ...
    public class ProjectsResource
    {
        ...
        public class ClientEventsResource
        {
            ...
            public class CreateRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3p1beta1.Data.ClientEvent>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.CreateClientEventRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
        ...
        public class CompaniesResource
        {
            ...
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.CreateCompanyRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            public class PatchRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3p1beta1.Data.Company>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.UpdateCompanyRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
        ...
        public class JobsResource
        {
            ...
            public class BatchDeleteRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3p1beta1.Data.Empty>
            {
                ...
                public BatchDeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.BatchDeleteJobsRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.CreateJobRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.UpdateJobRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
            ...
            public class SearchRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3p1beta1.Data.SearchJobsResponse>
            {
                ...
                public SearchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.SearchJobsRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
            ...
            public class SearchForAlertRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3p1beta1.Data.SearchJobsResponse>
            {
                ...
                public SearchForAlertRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3p1beta1.Data.SearchJobsRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
