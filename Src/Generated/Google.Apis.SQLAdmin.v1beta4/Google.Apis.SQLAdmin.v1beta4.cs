...
namespace Google.Apis.SQLAdmin.v1beta4
{
    ...
    public class InstancesResource
    {
        ...
        public virtual ExecuteSqlRequest ExecuteSql(Google.Apis.SQLAdmin.v1beta4.Data.ExecuteSqlPayload body, string project, string instance)
        {
            return new ExecuteSqlRequest(this.service, body, project, instance);
        }

        /// <summary>Execute SQL statements.</summary>
        public class ExecuteSqlRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.SqlInstancesExecuteSqlResponse>
        {
            /// <summary>Constructs a new ExecuteSql request.</summary>
            public ExecuteSqlRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1beta4.Data.ExecuteSqlPayload body, string project, string instance) : base(service)
            {
                Project = project;
                Instance = instance;
                Body = body;
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "sql/v1beta4/projects/{project}/instances/{instance}/executeSql";
...
namespace Google.Apis.SQLAdmin.v1beta4.Data
{
    ...
    public class ExecuteSqlPayload : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `projects/{project}/locations/{location}/secrets/{secret}/versions/{secret_version}`. This field is used
