...
/**
 * \brief
 *   Cloud SQL Admin API Version v1beta4
 *
...
namespace Google.Apis.SQLAdmin.v1beta4
{
    ...
    public class BackupRunsResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the backupRun to delete. Format:
    ...
    public class DatabasesResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the database to delete. Format:
        ...
        /// This method supports patch semantics. Caution: This is not a partial update, so you must include values for
        /// all the settings that you want to retain. For partial updates, use update.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param
        /// name="instance">Database instance ID. This does not include the project ID.</param>
        ...
        public class PatchRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the database for Cloud SQL to update. Format:
            /// projects/{project}/locations/{location}/instances/{instance}/databases/{database}</summary>
            [Google.Apis.Util.RequestParameterAttribute("resourceName", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string ResourceName { get; set; }
    ...
    public class InstancesResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of database instance to delete. Format:
            /// projects/{project}/locations/{location}/instances/{instance}</summary>
            [Google.Apis.Util.RequestParameterAttribute("resourceName", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string ResourceName { get; set; }
        ...
        public class ListRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.InstancesListResponse>
        {
            ...
            /// per their JSON representation, such as 'settings.userLabels.auto_start:true'.
            ///
            /// Multiple filter queries are space-separated. For example. 'state:RUNNABLE
            /// instanceType:CLOUD_SQL_INSTANCE'. By default, each expression is an AND expression. However, you can
            /// include AND and OR expressions explicitly.</summary>
            ...
            /// <summary>The parent, which owns this collection of database instances. Format:
            /// projects/{project}/locations/{location}</summary>
            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string Parent { get; set; }
        ...
        public class PatchRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the database instance for Cloud SQL to update. Format:
            /// projects/{project}/locations/{location}/instances/{instance}</summary>
            [Google.Apis.Util.RequestParameterAttribute("resourceName", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string ResourceName { get; set; }
        ...
        /// <summary>Updates settings of a Cloud SQL instance.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param
        /// name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
    ...
    public class OperationsResource
    {
        ...
        public class GetRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the operation for Cloud SQL to get. Format:
            /// projects/{project}/locations/{location}/operations/{operation}</summary>
            [Google.Apis.Util.RequestParameterAttribute("resourceName", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string ResourceName { get; set; }
    ...
    public class ProjectsResource
    {
        ...
        public class InstancesResource
        {
            ...
            public class RescheduleMaintenanceRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
            {
                ...
                /// <summary>The parent resource where Cloud SQL reshedule this database instance's maintenance. Format:
                /// projects/{project}/locations/{location}/instances/{instance}</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string Parent { get; set; }
                ...
                public override string MethodName
                {
                    get { return "rescheduleMaintenance"; }
                }
                ...
                public override string RestPath
                {
                    get { return "sql/v1beta4/projects/{project}/instances/{instance}/rescheduleMaintenance"; }
                }
        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                /// <summary>Reschedules the maintenance on the given instance.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">The parent resource where Cloud SQL reshedule this database instance's maintenance. Format:
                /// projects/{project}/locations/{location}/instances/{instance}</param>
                public virtual RescheduleMaintenanceRequest RescheduleMaintenance(Google.Apis.SQLAdmin.v1beta4.Data.SqlInstancesRescheduleMaintenanceRequestBody body, string parent)
                {
                    return new RescheduleMaintenanceRequest(service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new RescheduleMaintenance request.</summary>
                    public RescheduleMaintenanceRequest(Google.Apis.Services.IClientService service, Google.Apis.SQLAdmin.v1beta4.Data.SqlInstancesRescheduleMaintenanceRequestBody body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// <summary>The parent resource where Cloud SQL reshedule this database instance's maintenance.
                    /// Format: projects/{project}/locations/{location}/instances/{instance}</summary>
                    ...
                    public override string RestPath
                    {
                        get { return "sql/v1beta4/{+parent}/rescheduleMaintenance"; }
                    }
    ...
    public class SslCertsResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of SSL certificate to delete. Format:
    ...
    public class UsersResource
    {
        ...
        public class DeleteRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the user to delete. Format:
        ...
        public class UpdateRequest : SQLAdminBaseServiceRequest<Google.Apis.SQLAdmin.v1beta4.Data.Operation>
        {
            ...
            /// <summary>The name of the user for Cloud SQL to update. Format:
            /// projects/{project}/locations/{location}/instances/{instance}/users</summary>
            [Google.Apis.Util.RequestParameterAttribute("resourceName", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string ResourceName { get; set; }
...
{    
    ...
    public class DatabaseInstance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// PostgreSQL instance. EXTERNAL: A database server that is not managed by Google. This property is read-only;
        /// use the tier property in the settings object to determine the database type and Second or First
        /// Generation.</summary>
    ...
    public class ImportContext : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The target database for the import. If fileType is SQL, this field is required only if the import
        /// file does not specify a database, and is overridden by any database specification in the import file. If
        /// fileType is CSV, one database must be specified.</summary>
    ...
    public class Settings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// instance state is RUNNABLE. Valid values: ALWAYS: The instance is on, and remains so even in the absence of
        /// connection requests. NEVER: The instance is off; it is not activated, even if a connection request arrives.
        /// ON_DEMAND: First Generation instances only. The instance responds to incoming requests, and turns itself off
        /// when not in use. Instances with PER_USE pricing turn off after 15 minutes of inactivity. Instances with
        /// PER_PACKAGE pricing turn off after 12 hours of inactivity.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("activationPolicy")]
        public virtual string ActivationPolicy { get; set; } 

        /// <summary>The App Engine app IDs that can access this instance. First Generation instances only.</summary>
        ...
        /// <summary>Availability type (PostgreSQL instances only). Potential values: ZONAL: The instance serves data
        /// from only one zone. Outages in that zone affect data accessibility. REGIONAL: The instance can serve data
        /// from more than one zone in a region (it is highly available). For more information, see Overview of the High
        /// Availability Configuration.</summary>
        ...
        /// <summary>The size of data disk, in GB. The data disk size minimum is 10GB. Not used for First Generation
        /// instances.</summary>
        ...
        /// either an App Engine app or Compute Engine zone for better performance. App Engine co-location is only
        ...
        /// maintenance purposes. Not used for First Generation instances.</summary>
        ...
        /// <summary>Configuration to increase storage size automatically. The default value is true. Not used for First
        /// Generation instances.</summary>
        ...
        /// which specifies that there is no limit. Not used for First Generation instances.</summary>
        ...
        /// <summary>The tier (or machine type) for this instance, for example db-n1-standard-1 (MySQL instances) or db-
        /// custom-1-3840 (PostgreSQL instances). For MySQL instances, this property determines whether the instance is
        /// First or Second Generation. For more information, see Instance Settings.</summary>
