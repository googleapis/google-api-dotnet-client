...
{    
    ...
    public class Settings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Availability type (PostgreSQL and MySQL instances only). Potential values: ZONAL: The instance
        /// serves data from only one zone. Outages in that zone affect data accessibility. REGIONAL: The instance can
        /// serve data from more than one zone in a region (it is highly available). For more information, see Overview
        /// of the High Availability Configuration.</summary>
