    ...
    public class AppsResource
    {
        ...
        public class OperationsResource
        {
            ...
            public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1beta.Data.ListOperationsResponse>
            {
                ...
                /// field is not supported by default and will result in an UNIMPLEMENTED error if set unless explicitly
        ...
        public class LocationsResource
        {
            ...
            public class ApplicationsResource
            {
                ...
                public class DomainMappingsResource
                {
                    ...
                    public virtual DeleteRequest Delete(string projectsId, string locationsId, string applicationsId, string domainMappingsId)
                    {
                        return new DeleteRequest(this.service, projectsId, locationsId, applicationsId, domainMappingsId);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Delete request.</summary>
                        public DeleteRequest(Google.Apis.Services.IClientService service, string projectsId, string locationsId, string applicationsId, string domainMappingsId) : base(service)
                        {
                            ProjectsId = projectsId;
                            LocationsId = locationsId;
                            ApplicationsId = applicationsId;
                    ...
                    /// <param name="applicationsId">Part of `name`. See documentation of `projectsId`.</param>
                    /// <param name="domainMappingsId">Part of `name`. See documentation of `projectsId`.</param>
                    public virtual PatchRequest Patch(Google.Apis.Appengine.v1beta.Data.DomainMapping body, string projectsId, string locationsId, string applicationsId, string domainMappingsId)
                    {
                        return new PatchRequest(this.service, body, projectsId, locationsId, applicationsId, domainMappingsId);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1beta.Data.DomainMapping body, string projectsId, string locationsId, string applicationsId, string domainMappingsId) : base(service)
                        {
                            ProjectsId = projectsId;
                            LocationsId = locationsId;
                            ApplicationsId = applicationsId;
...
namespace Google.Apis.Appengine.v1beta.Data
{
    ...
    public class SslSettings : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. ID of the managed AuthorizedCertificate resource currently being provisioned, if applicable.
        /// Until the new managed certificate has been successfully provisioned, the previous SSL state will be
        /// preserved. Once the provisioning process completes, the certificate_id field will reflect the new managed
        /// certificate and this field will be left empty. To remove SSL support while there is still a pending managed
        /// certificate, clear the certificate_id field with an UpdateDomainMappingRequest.@OutputOnly
        /// </summary>
