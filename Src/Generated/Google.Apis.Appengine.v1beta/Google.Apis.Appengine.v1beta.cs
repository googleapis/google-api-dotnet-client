...
{    
    ...
    public class IdentityAwareProxy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>InputOnly OAuth client info required to generate client id to be used for IAP.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("oauth2ClientInfo")]
        public virtual OAuth2ClientInfo Oauth2ClientInfo { get; set; } 
    ...
    public class OAuth2ClientInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Nameof the client to be generated. Optional - If not provided, the name will be autogenerated by
        /// the backend.</summary>
    ...
    /// that service. Next tag: 6</summary>
