...
namespace Google.Apis.Appengine.v1beta
{
    ...
    public class AppsResource
    {
        ...
        public class FirewallResource
        {
            ...
            public class IngressRulesResource
            {
                ...
                public class BatchUpdateRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1beta.Data.BatchUpdateIngressRulesResponse>
                {
                    ...
                    public BatchUpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1beta.Data.BatchUpdateIngressRulesRequest body, string appsId)
                        : base(service)
                    {
                        AppsId = appsId;
                        Body = body;
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1beta.Data.FirewallRule body, string appsId)
                        : base(service)
                    {
                        AppsId = appsId;
                        Body = body;
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1beta.Data.FirewallRule body, string appsId, string ingressRulesId)
                        : base(service)
                    {
                        AppsId = appsId;
                        IngressRulesId = ingressRulesId;
        ...
        public class ServicesResource
        {
            ...
            public class VersionsResource
            {
                ...
                public class InstancesResource
                {
                    ...
                    /// <summary>Stops a running instance.The instance might be automatically recreated based on the
                    /// scaling settings of the version. For more information, see "How Instances are Managed" (standard
                    ...
                    /// are-managed)).To ensure that instances are not re-created and avoid getting billed, you can stop
                    /// all instances within the target version by changing the serving status of the version to STOPPED
                    /// with the apps.services.versions.patch (https://cloud.google.com/appengine/docs/admin-
                    /// api/reference/rest/v1/apps.services.versions/patch) method.</summary>
                    /// <param name="appsId">Part of `name`. Name of the resource requested. Example:
                    /// apps/myapp/services/default/versions/v1/instances/instance-1.</param>
                    /// <param name="servicesId">Part of
                    /// `name`. See documentation of `appsId`.</param>
                ...
                public class GetRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1beta.Data.Version>
                {
                    ...
                    public enum ViewEnum
                    {
                        /// <summary>Basic version information including scaling and inbound services, but not detailed
                        /// deployment information.</summary>
                        [Google.Apis.Util.StringValueAttribute("BASIC")]
                        BASIC,
                        /// <summary>The information from BASIC, plus detailed information about the deployment. This
                        /// format is required when creating resources, but is not returned in Get or List by
                        /// default.</summary>
                ...
                /// api/reference/rest/v1beta/apps.services.versions#manualscaling)Flexible environment serving_status
                /// (https://cloud.google.com/appengine/docs/admin-
                ...
                /// api/reference/rest/v1beta/apps.services.versions#Version.FIELDS.automatic_scaling)manual scaling in
                /// the flexible environment: manual_scaling.instances (https://cloud.google.com/appengine/docs/admin-
                /// api/reference/rest/v1beta/apps.services.versions#manualscaling)</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="appsId">Part of `name`. Name of the resource to update. Example:
        ...
        /// undelete API if possible at https://cloud.google.com/iam/reference/rest/v1/projects.serviceAccounts/undelete
        /// ?apix_params=%7B"name"%3A"projects%2F-%2FserviceAccounts%2Funique_id"%2C"resource"%3A%7B%7D%7D . If the
        /// deletion was recent, the numeric ID can be found in the Cloud Console Activity Log.</summary>
        /// <param name="body">The body of the request.</param>
...
{    
    ...
    {
        /// <summary>The time period that the Autoscaler (https://cloud.google.com/compute/docs/autoscaler/) should wait
        ...
        /// <summary>Target scaling by user-provided metrics. Only applicable in the App Engine flexible
        /// environment.</summary>
    ...
    public class CustomMetric : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>May be used instead of target_utilization when an instance can handle a specific amount of
        /// work/resources and the metric value is equal to the current amount of work remaining. The autoscaler will
        /// try to keep the number of instances equal to the metric value divided by
        /// single_instance_assignment.</summary>
        ...
        /// <summary>The type of the metric. Must be a string representing a Stackdriver metric type e.g. GAGUE,
        /// DELTA_PER_SECOND, etc.</summary>
    ...
    {
        /// <summary>Google Cloud Build build information. Only applicable for instances running in the App Engine
        /// flexible environment.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("build")]
        public virtual BuildInfo Build { get; set; } 

        /// <summary>Options for any Google Cloud Build builds created as a part of this deployment.These options will
