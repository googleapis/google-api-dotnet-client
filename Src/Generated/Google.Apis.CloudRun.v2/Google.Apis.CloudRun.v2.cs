        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                public class CreateRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v2.Data.GoogleLongrunningOperation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2Instance body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2Instance Body { get; set; }
                ...
                /// <summary>Lists Instances. Results are sorted by creation time, descending.</summary>
                public class ListRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2ListInstancesResponse>
                {
                    ...
                    /// <summary>Optional. Maximum number of Instances to return in this call.</summary>
                ...
                public class PatchRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v2.Data.GoogleLongrunningOperation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2Instance body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// <summary>Starts an Instance.</summary>
                public class StartRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v2.Data.GoogleLongrunningOperation>
                {
                    /// <summary>Constructs a new Start request.</summary>
                    public StartRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2StartInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2StartInstanceRequest Body { get; set; }
                ...
                /// <summary>Stops an Instance.</summary>
                public class StopRequest : CloudRunBaseServiceRequest<Google.Apis.CloudRun.v2.Data.GoogleLongrunningOperation>
                {
                    /// <summary>Constructs a new Stop request.</summary>
                    public StopRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2StopInstanceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudRun.v2.Data.GoogleCloudRunV2StopInstanceRequest Body { get; set; }
...
namespace Google.Apis.CloudRun.v2.Data
{
    ...
    public class GoogleCloudRunV2Container : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual GoogleCloudRunV2Probe ReadinessProbe { get; set; }
    ...
    public class GoogleCloudRunV2ContainerStatus : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// This field holds the digest value regardless of whether a tag or digest was originally specified in the
        /// Container object.
        /// </summary>
    ...
    public class GoogleCloudRunV2Instance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. True if GPU zonal redundancy is disabled on this instance.</summary>
        ...
        /// <summary>Optional. IAP settings on the Instance.</summary>
        ...
        /// <summary>Output only. The Google Console URI to obtain logs for the Instance.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("logUri")]
        public virtual string LogUri { get; set; }
        ...
        /// <summary>Optional. The node selector for the instance.</summary>
    ...
    /// <summary>Response message containing a list of Instances.</summary>
    public class GoogleCloudRunV2ListInstancesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The resulting list of Instances.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("instances")]
        public virtual System.Collections.Generic.IList<GoogleCloudRunV2Instance> Instances { get; set; }

        /// <summary>
        /// A token indicating there are more items than page_size. Use it in the next ListInstances request to
        /// continue.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    public class GoogleCloudRunV2Service : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Identifier. The fully qualified name of this Service. In CreateServiceRequest, this field is ignored, and
    ...
    {
        /// <summary>
        /// Required. Input only. Represents the exact, literal, and complete source code of the file. Placeholders like
        /// `...` or comments such as `# [rest of code]` should NEVER be used as omission. Every character in this field
        /// will be built into the final container. Any omission will result in a broken application.
        /// </summary>
    ...
    /// <summary>Request message for starting an Instance.</summary>
    public class GoogleCloudRunV2StartInstanceRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. A system-generated fingerprint for this version of the resource. This may be used to detect
        /// modification conflict during updates.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("etag")]
        public virtual string ETag { get; set; }
    ...
    /// <summary>Request message for deleting an Instance.</summary>
    public class GoogleCloudRunV2StopInstanceRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. A system-generated fingerprint for this version of the resource. This may be used to detect
        /// modification conflict during updates.
    ...
    public class GoogleCloudRunV2SubmitBuildRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. The client that initiated the build request.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("client")]
        public virtual string Client { get; set; }
        ...
        /// <summary>
        /// Optional. The machine type from default pool to use for the build. If left blank, cloudbuild will use a
        /// sensible default. Currently only E2_HIGHCPU_8 is supported. If worker_pool is set, this field will be
        /// ignored.
        /// </summary>
    ...
    public class GoogleCloudRunV2WorkerPool : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Deprecated: Not supported, and ignored by Cloud Run.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("customAudiences")]
        public virtual System.Collections.Generic.IList<string> CustomAudiences { get; set; }
        ...
        /// <summary>
        /// Output only. Name of the latest revision that is serving workloads. See comments in `reconciling` for
        /// additional information on reconciliation process in Cloud Run.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("latestReadyRevision")]
        public virtual string LatestReadyRevision { get; set; }
        ...
        /// <summary>
        /// Output only. The generation of this WorkerPool currently serving workloads. See comments in `reconciling`
        /// for additional information on reconciliation process in Cloud Run. Please note that unlike v1, this is an
        ...
        /// `latest_ready_revison`, `instance_split_statuses`, and `uri` will have transient values that might mismatch
        /// the intended state: Once reconciliation is over (and this field is false), there are two possible outcomes:
        ...
        /// the following fields will match: `instance_splits` and `instance_split_statuses`, `observed_generation` and
        /// `generation`, `latest_ready_revision` and `latest_created_revision`. If reconciliation failed,
        /// `instance_split_statuses`, `observed_generation`, and `latest_ready_revision` will have the state of the
        /// last serving revision, or empty for newly created WorkerPools. Additional information on the failure can be
    ...
    public class GoogleDevtoolsCloudbuildV1Artifacts : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<GoogleDevtoolsCloudbuildV1GenericArtifact> GenericArtifacts { get; set; }
    ...
    public class GoogleDevtoolsCloudbuildV1Dependency : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual GoogleDevtoolsCloudbuildV1GenericArtifactDependency GenericArtifact { get; set; }
    ...
    /// </summary>
    public class GoogleDevtoolsCloudbuildV1GenericArtifact : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    /// <summary>Represents a generic artifact as a build dependency.</summary>
    public class GoogleDevtoolsCloudbuildV1GenericArtifactDependency : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleDevtoolsCloudbuildV1UploadedGenericArtifact : Google.Apis.Requests.IDirectResponseSchema
    {
