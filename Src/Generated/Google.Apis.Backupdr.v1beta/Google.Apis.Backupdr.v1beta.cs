...
namespace Google.Apis.Backupdr.v1beta
{
    ...
    public class FoldersResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class ResourceBackupConfigsResource
            {
                ...
                /// <summary>Fetches ResourceBackupConfigs.</summary>
                /// <param name="parent">
                ...
                /// <summary>Fetches ResourceBackupConfigs.</summary>
                public class FetchRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchResourceBackupConfigsResponse>
                {
                    ...
                    public override string RestPath => "v1beta/{+parent}/resourceBackupConfigs:fetch";
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            {
                this.service = service;
                AppliedAutoProtectionPolicies = new AppliedAutoProtectionPoliciesResource(service);
                AutoProtectionPolicies = new AutoProtectionPoliciesResource(service);
                ...
                Trial = new TrialResource(service);
            }

            /// <summary>Gets the AppliedAutoProtectionPolicies resource.</summary>
            public virtual AppliedAutoProtectionPoliciesResource AppliedAutoProtectionPolicies { get; }

            /// <summary>The "appliedAutoProtectionPolicies" collection of methods.</summary>
            public class AppliedAutoProtectionPoliciesResource
            {
                private const string Resource = "appliedAutoProtectionPolicies";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public AppliedAutoProtectionPoliciesResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }

                /// <summary>Lists AppliedAutoProtectionPolicies in a given project and location.</summary>
                /// <param name="parent">
                /// Required. The project and location for which to retrieve the list of applied policies. Format:
                ...
                /// <summary>Lists AppliedAutoProtectionPolicies in a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListAppliedAutoProtectionPoliciesResponse>
                {
                    ...
                    /// <summary>Optional. A filter expression that filters resources listed in the response.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("filter", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string Filter { get; set; }

                    /// <summary>Optional. An expression that sorts the results in the response.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("orderBy", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string OrderBy { get; set; }

                    /// <summary>Optional. The maximum number of applied policies to return in a single page.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/appliedAutoProtectionPolicies";
            ...
            /// <summary>Gets the AutoProtectionPolicies resource.</summary>
            public virtual AutoProtectionPoliciesResource AutoProtectionPolicies { get; }

            /// <summary>The "autoProtectionPolicies" collection of methods.</summary>
            public class AutoProtectionPoliciesResource
            {
                private const string Resource = "autoProtectionPolicies";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public AutoProtectionPoliciesResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                ...
                public class BindingsResource
                {
                    ...
                    {
                        this.service = service;
                        MatchingResources = new MatchingResourcesResource(service);
                    }

                    /// <summary>Gets the MatchingResources resource.</summary>
                    public virtual MatchingResourcesResource MatchingResources { get; }

                    /// <summary>The "matchingResources" collection of methods.</summary>
                    public class MatchingResourcesResource
                    {
                        private const string Resource = "matchingResources";

                        /// <summary>The service which this resource belongs to.</summary>
                        private readonly Google.Apis.Services.IClientService service;

                        /// <summary>Constructs a new resource.</summary>
                        public MatchingResourcesResource(Google.Apis.Services.IClientService service)
                        {
                            this.service = service;
                        }

                        /// <summary>Gets details of a single Binding Matching Resource.</summary>
                        /// <param name="name">
                        /// Required. The name of the matching resource to retrieve. Format:
                        ...
                        /// <summary>Gets details of a single Binding Matching Resource.</summary>
                        public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.BindingMatchingResource>
                        {
                        ...
                        /// <summary>Lists Binding Matching Resources for a given AutoProtectionPolicyBinding.</summary>
                        /// <param name="parent">
                        /// Required. The project, location, auto protection policy and binding for which to retrieve
                        ...
                        /// <summary>Lists Binding Matching Resources for a given AutoProtectionPolicyBinding.</summary>
                        public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListBindingMatchingResourcesResponse>
                        {
                            /// <summary>Constructs a new List request.</summary>
                            public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                            {
                            ...
                            /// <summary>
                            /// Required. The project, location, auto protection policy and binding for which to
                            ...
                            /// <summary>
                            /// Optional. The maximum number of `BindingMatchingResources` to return in a single
                            /// response. The default page size is 100 and maximum page size is 200. Note that the
                            /// response may include a partial list and a caller should only rely on the response's
                            ...
                            /// `ListBindingMatchingResources` call. Provide this to retrieve the subsequent page in a
                            /// multi-page list of results. When paginating, all other parameters provided to
                            /// `ListBindingMatchingResources` must match the call that provided the page token.
                            /// </summary>
                            [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                            public virtual string PageToken { get; set; }
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta/{+parent}/matchingResources";
                    ...
                    /// <summary>Creates a new AutoProtectionPolicyBinding in a given project and location.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">
                    /// Required. The parent resource where this binding will be created. Format:
                    /// projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}
                    /// </param>
                    public virtual CreateRequest Create(Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicyBinding body, string parent)
                    {
                        return new CreateRequest(this.service, body, parent);
                    }

                    /// <summary>Creates a new AutoProtectionPolicyBinding in a given project and location.</summary>
                    public class CreateRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicyBinding body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>
                        /// Required. The ID to use for the binding. This will become the final component of the
                        /// binding's resource name.
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("autoProtectionPolicyBindingId", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual string AutoProtectionPolicyBindingId { get; set; }

                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicyBinding Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+parent}/bindings";
                        ...
                        protected override void InitParameters()
                        {
                            ...
                            RequestParameters.Add("autoProtectionPolicyBindingId", new Google.Apis.Discovery.Parameter
                            {
                                Name = "autoProtectionPolicyBindingId",
                                IsRequired = false,
                                ParameterType = "query",
                                DefaultValue = null,
                                Pattern = null,
                    ...
                    /// <summary>Returns the auto protection policy binding read from the CCFE tables.</summary>
                    /// <param name="name">
                    ...
                    /// <summary>Returns the auto protection policy binding read from the CCFE tables.</summary>
                    public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicyBinding>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}/bindings/{binding}
                    /// </param>
                    public virtual InitiateDeleteRequest InitiateDelete(Google.Apis.Backupdr.v1beta.Data.InitiateDeleteAutoProtectionPolicyBindingRequest body, string name)
                    {
                        return new InitiateDeleteRequest(this.service, body, name);
                    }

                    /// <summary>
                    /// InitiateDeleteAutoProtectionPolicyBinding initiates delete for AutoProtectionPolicy Binding
                    /// </summary>
                    public class InitiateDeleteRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                    {
                        /// <summary>Constructs a new InitiateDelete request.</summary>
                        public InitiateDeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.InitiateDeleteAutoProtectionPolicyBindingRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.InitiateDeleteAutoProtectionPolicyBindingRequest Body { get; set; }

                        /// <summary>Returns the body of the request.</summary>
                        protected override object GetBody() => Body;

                        /// <summary>Gets the method name.</summary>
                        public override string MethodName => "initiateDelete";

                        /// <summary>Gets the HTTP method.</summary>
                        public override string HttpMethod => "POST";

                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+name}:initiateDelete";

                        /// <summary>Initializes InitiateDelete parameter list.</summary>
                        protected override void InitParameters()
                        {
                            base.InitParameters();
                            RequestParameters.Add("name", new Google.Apis.Discovery.Parameter
                    ...
                    /// <summary>Returns the auto protection policy bindings read from the CCFE tables.</summary>
                    /// <param name="parent">
                    /// Required. The project and location for which to retrieve the list of policies. Format:
                    /// projects/{project}/locations/{location}
                    /// </param>
                    public virtual ListRequest List(string parent)
                    {
                    ...
                    /// <summary>Returns the auto protection policy bindings read from the CCFE tables.</summary>
                    public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListAutoProtectionPolicyBindingsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// <summary>
                        /// Optional. An expression that sorts the results in the response. The following fields are
                        /// sortable:
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("orderBy", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual string OrderBy { get; set; }
                        ...
                        /// <summary>
                        /// Optional. The maximum number of policies to return in a single page. If unspecified, a
                        ...
                        /// <summary>
                        /// Optional. A page token, received from a previous `ListAutoProtectionPolicies` call. Provide
                ...
                /// <summary>Creates a new AutoProtectionPolicy in a given project and location.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">
                /// Required. The parent resource where this policy will be created. Format:
                /// projects/{project}/locations/{location}
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicy body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicy body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. The ID to use for the policy. This will become the final component of the policy's
                    /// resource name.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("autoProtectionPolicyId", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string AutoProtectionPolicyId { get; set; }

                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicy Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/autoProtectionPolicies";
                    ...
                    protected override void InitParameters()
                    {
                        ...
                        RequestParameters.Add("autoProtectionPolicyId", new Google.Apis.Discovery.Parameter
                        {
                            Name = "autoProtectionPolicyId",
                            IsRequired = false,
                            ParameterType = "query",
                            DefaultValue = null,
                            Pattern = null,
                ...
                /// <summary>Deletes a single AutoProtectionPolicy.</summary>
                /// <param name="name">
                ...
                /// <summary>Deletes a single AutoProtectionPolicy.</summary>
                public class DeleteRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                {
                    ...
                    /// <summary>
                    /// The current etag of the AutoProtectionPolicy. If an etag is provided and does not match the
                    /// current etag of the connection, the request will be rejected with an ABORTED error.
                    /// </summary>
                ...
                /// <summary>Gets details of a single AutoProtectionPolicy.</summary>
                /// <param name="name">
                ...
                /// <summary>Gets details of a single AutoProtectionPolicy.</summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicy>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists AutoProtectionPolicies for a given project and location.</summary>
                /// <param name="parent">
                /// Required. The project and location for which to retrieve the list of policies. Format:
                /// projects/{project}/locations/{location}
                /// </param>
                ...
                /// <summary>Lists AutoProtectionPolicies for a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListAutoProtectionPoliciesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>
                    /// Optional. A page token, received from a previous `ListAutoProtectionPolicies` call. Provide this
                ...
                /// <summary>Updates the parameters of a single AutoProtectionPolicy.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// Identifier. The resource name of the AutoprotectionPolicy. Format:
                /// `projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}`
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicy body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates the parameters of a single AutoProtectionPolicy.</summary>
                public class PatchRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.AutoProtectionPolicy body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. Field mask is used to specify the fields to be overwritten in the AutoProtectionPolicy
            ...
            public class BackupPlanAssociationsResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Backupdr.v1beta.Data.BackupPlanAssociation body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.BackupPlanAssociation body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.BackupPlanAssociation Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/backupPlanAssociations";
                ...
                public class DeleteRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                {
                    ...
                    /// <summary>
                    /// Optional. This field is exclusively used by Backup and DR's auto-protection feature. The
                    /// resource name of the `AutoProtectionPolicyBinding` that triggered the deletion of this
                    /// association. Format:
                    /// `projects/{project}/locations/{location}/autoProtectionPolicies/{policy}/bindings/{binding}`.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("autoProtectionPolicyBinding", Google.Apis.Util.RequestParameterType.Query)]
                    ...
                    protected override void InitParameters()
                    {
                        ...
                        RequestParameters.Add("autoProtectionPolicyBinding", new Google.Apis.Discovery.Parameter
                        {
                            Name = "autoProtectionPolicyBinding",
                            IsRequired = false,
                            ParameterType = "query",
                            DefaultValue = null,
                            Pattern = null,
                ...
                /// <summary>List BackupPlanAssociations for a given resource type.</summary>
                public class FetchForResourceTypeRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchBackupPlanAssociationsForResourceTypeResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/backupPlanAssociations:fetchForResourceType";
                ...
                /// <summary>Gets details of a single BackupPlanAssociation.</summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.BackupPlanAssociation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists BackupPlanAssociations in a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListBackupPlanAssociationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// projects/{project}/locations/{location}/backupPlanAssociations/{backupPlanAssociationId}
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Backupdr.v1beta.Data.BackupPlanAssociation body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.BackupPlanAssociation body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// `projects/{project}/locations/{location}/backupPlanAssociations/{backupPlanAssociationId}`
                /// </param>
                public virtual TriggerBackupRequest TriggerBackup(Google.Apis.Backupdr.v1beta.Data.TriggerBackupRequest body, string name)
                {
                    return new TriggerBackupRequest(this.service, body, name);
                }

                /// <summary>Triggers a new Backup.</summary>
                public class TriggerBackupRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new TriggerBackup request.</summary>
                    public TriggerBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.TriggerBackupRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.TriggerBackupRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:triggerBackup";
            ...
            public class BackupPlansResource
            {
                ...
                public class RevisionsResource
                {
                    ...
                    /// <summary>Gets details of a single BackupPlanRevision.</summary>
                    /// <param name="name">
                    ...
                    /// <summary>Gets details of a single BackupPlanRevision.</summary>
                    public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.BackupPlanRevision>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// Backup and DR, locations map to Google Cloud regions, for e.g. **us-central1**.
                    /// </param>
                    public virtual ListRequest List(string parent)
                    {
                        return new ListRequest(this.service, parent);
                    ...
                    /// <summary>Lists BackupPlanRevisions in a given project and location.</summary>
                    public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListBackupPlanRevisionsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// specified, a default value will be chosen by the service. Note that the response may include
                        /// a partial list and a caller should only rely on the response's next_page_token to determine
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Backupdr.v1beta.Data.BackupPlan body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.BackupPlan body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.BackupPlan Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/backupPlans";
                ...
                /// <summary>Gets details of a single BackupPlan.</summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.BackupPlan>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// `projects/{project}/locations/{location}`. In Google Cloud Backup and DR, locations map to Google
                /// Cloud regions, for e.g. **us-central1**. To retrieve backup plans for all locations, use "-" for the
                /// `{location}` value.
                /// </param>
                public virtual ListRequest List(string parent)
                {
                ...
                /// <summary>Lists BackupPlans in a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListBackupPlansResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// Google Cloud regions, for e.g. **us-central1**. To retrieve backup plans for all locations, use
                ...
                /// `projects/{project}/locations/{location}/backupPlans/{backup_plan}`
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Backupdr.v1beta.Data.BackupPlan body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.BackupPlan body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. The list of fields to update. Field mask is used to specify the fields to be
                    /// overwritten in the BackupPlan resource by the update. The fields specified in the update_mask
                    /// are relative to the resource, not the full request. A field will be overwritten if it is in the
                    /// mask. If the user does not provide a mask then the request will fail. Currently, these fields
                    /// are supported in update: description, schedules, retention period, adding and removing Backup
                    /// Rules.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual object UpdateMask { get; set; }
            ...
            public class BackupVaultsResource
            {
                ...
                public class DataSourcesResource
                {
                    ...
                    public class BackupsResource
                    {
                        ...
                        /// <summary>Fetch Backups for a given resource type.</summary>
                        public class FetchForResourceTypeRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchBackupsForResourceTypeResponse>
                        {
                            /// <summary>Constructs a new FetchForResourceType request.</summary>
                            public FetchForResourceTypeRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                            {
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta/{+parent}/backups:fetchForResourceType";
                        ...
                        /// <summary>Gets details of a Backup.</summary>
                        public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Backup>
                        {
                            /// <summary>Constructs a new Get request.</summary>
                            public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                            {
                        ...
                        /// <summary>Lists Backups in a given project and location.</summary>
                        public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListBackupsResponse>
                        {
                            /// <summary>Constructs a new List request.</summary>
                            public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                            {
                        ...
                        /// </param>
                        public virtual PatchRequest Patch(Google.Apis.Backupdr.v1beta.Data.Backup body, string name)
                        {
                            return new PatchRequest(this.service, body, name);
                        }
                        ...
                        {
                            /// <summary>Constructs a new Patch request.</summary>
                            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.Backup body, string name) : base(service)
                            {
                                Name = name;
                                Body = body;
                                InitParameters();
                            ...
                            /// <summary>Gets or sets the body of this request.</summary>
                            Google.Apis.Backupdr.v1beta.Data.Backup Body { get; set; }
                        ...
                        /// </param>
                        public virtual RestoreRequest Restore(Google.Apis.Backupdr.v1beta.Data.RestoreBackupRequest body, string name)
                        {
                            return new RestoreRequest(this.service, body, name);
                        }

                        /// <summary>Restore from a Backup</summary>
                        public class RestoreRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                        {
                            /// <summary>Constructs a new Restore request.</summary>
                            public RestoreRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.RestoreBackupRequest body, string name) : base(service)
                            {
                                Name = name;
                                Body = body;
                                InitParameters();
                            ...
                            /// <summary>Gets or sets the body of this request.</summary>
                            Google.Apis.Backupdr.v1beta.Data.RestoreBackupRequest Body { get; set; }
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta/{+name}:restore";
                    ...
                    /// </param>
                    public virtual AbandonBackupRequest AbandonBackup(Google.Apis.Backupdr.v1beta.Data.AbandonBackupRequest body, string dataSource)
                    {
                        return new AbandonBackupRequest(this.service, body, dataSource);
                    }

                    /// <summary>Internal only. Abandons a backup.</summary>
                    public class AbandonBackupRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                    {
                        /// <summary>Constructs a new AbandonBackup request.</summary>
                        public AbandonBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.AbandonBackupRequest body, string dataSource) : base(service)
                        {
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.AbandonBackupRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+dataSource}:abandonBackup";
                    ...
                    /// </param>
                    public virtual FetchAccessTokenRequest FetchAccessToken(Google.Apis.Backupdr.v1beta.Data.FetchAccessTokenRequest body, string name)
                    {
                        return new FetchAccessTokenRequest(this.service, body, name);
                    }

                    /// <summary>Internal only. Fetch access token for a given data source.</summary>
                    public class FetchAccessTokenRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchAccessTokenResponse>
                    {
                        /// <summary>Constructs a new FetchAccessToken request.</summary>
                        public FetchAccessTokenRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.FetchAccessTokenRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.FetchAccessTokenRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+name}:fetchAccessToken";
                    ...
                    /// 'projects/*/locations/*/backupVaults/*/dataSources/'.
                    /// </param>
                    public virtual FinalizeBackupRequest FinalizeBackup(Google.Apis.Backupdr.v1beta.Data.FinalizeBackupRequest body, string dataSource)
                    {
                    ...
                    /// Internal only. Finalize a backup that was started by a call to InitiateBackup.
                    /// </summary>
                    public class FinalizeBackupRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                    {
                        /// <summary>Constructs a new FinalizeBackup request.</summary>
                        public FinalizeBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.FinalizeBackupRequest body, string dataSource) : base(service)
                        {
                            DataSource = dataSource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.FinalizeBackupRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+dataSource}:finalizeBackup";
                    ...
                    /// <summary>Gets details of a DataSource.</summary>
                    public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.DataSource>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// 'projects/*/locations/*/backupVaults/*/dataSources/'.
                    /// </param>
                    public virtual InitiateBackupRequest InitiateBackup(Google.Apis.Backupdr.v1beta.Data.InitiateBackupRequest body, string dataSource)
                    {
                        return new InitiateBackupRequest(this.service, body, dataSource);
                    }

                    /// <summary>Internal only. Initiates a backup.</summary>
                    public class InitiateBackupRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.InitiateBackupResponse>
                    {
                        /// <summary>Constructs a new InitiateBackup request.</summary>
                        public InitiateBackupRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.InitiateBackupRequest body, string dataSource) : base(service)
                        {
                            DataSource = dataSource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.InitiateBackupRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+dataSource}:initiateBackup";
                    ...
                    /// Google Cloud regions, for example **us-central1**. To retrieve data sources for all locations,
                    /// use "-" for the '{location}' value.
                    /// </param>
                    public virtual ListRequest List(string parent)
                    {
                    ...
                    /// <summary>Lists DataSources in a given project and location.</summary>
                    public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListDataSourcesResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// format 'projects/{project_id}/locations/{location}'. In Google Cloud Backup and DR,
                        /// locations map to Google Cloud regions, for example **us-central1**. To retrieve data sources
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+parent}/dataSources";
                    ...
                    /// </param>
                    public virtual PatchRequest Patch(Google.Apis.Backupdr.v1beta.Data.DataSource body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.DataSource body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.DataSource Body { get; set; }
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. Name of the resource.</param>
                    public virtual RemoveRequest Remove(Google.Apis.Backupdr.v1beta.Data.RemoveDataSourceRequest body, string name)
                    {
                    ...
                    /// external clients will not delete DataSources except for BackupDR backup appliances.
                    /// </summary>
                    public class RemoveRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                    {
                        /// <summary>Constructs a new Remove request.</summary>
                        public RemoveRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.RemoveDataSourceRequest body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.RemoveDataSourceRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+name}:remove";
                    ...
                    /// 'projects/*/locations/*/backupVaults/*/dataSources/'.
                    /// </param>
                    public virtual SetInternalStatusRequest SetInternalStatus(Google.Apis.Backupdr.v1beta.Data.SetInternalStatusRequest body, string dataSource)
                    {
                        return new SetInternalStatusRequest(this.service, body, dataSource);
                    }

                    /// <summary>Sets the internal status of a DataSource.</summary>
                    public class SetInternalStatusRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                    {
                        /// <summary>Constructs a new SetInternalStatus request.</summary>
                        public SetInternalStatusRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.SetInternalStatusRequest body, string dataSource) : base(service)
                        {
                            DataSource = dataSource;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.Backupdr.v1beta.Data.SetInternalStatusRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta/{+dataSource}:setInternalStatus";
                ...
                public virtual CreateRequest Create(Google.Apis.Backupdr.v1beta.Data.BackupVault body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.BackupVault body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.BackupVault Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/backupVaults";
                ...
                /// Google Cloud regions, for example **us-central1**. To retrieve backupvault stores for all locations,
                /// use "-" for the '{location}' value.
                /// </param>
                ...
                /// BackupVault are the ones that user has backupdr.backupVaults.get permission.
                /// </summary>
                public class FetchUsableRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchUsableBackupVaultsResponse>
                {
                    ...
                    /// map to Google Cloud regions, for example **us-central1**. To retrieve backupvault stores for all
                    /// locations, use "-" for the '{location}' value.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/backupVaults:fetchUsable";
                ...
                /// <summary>Gets details of a BackupVault.</summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.BackupVault>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists BackupVaults in a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListBackupVaultsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Backupdr.v1beta.Data.BackupVault body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.BackupVault body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.Backupdr.v1beta.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// IAM permission to make this request.
                /// </summary>
                public class TestIamPermissionsRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.TestIamPermissionsRequest Body { get; set; }
            ...
            public class DataSourceReferencesResource
            {
                ...
                /// <summary>Fetch DataSourceReferences for a given project, location and resource type.</summary>
                public class FetchForResourceTypeRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchDataSourceReferencesForResourceTypeResponse>
                {
                    /// <summary>Constructs a new FetchForResourceType request.</summary>
                    public FetchForResourceTypeRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/dataSourceReferences:fetchForResourceType";
                ...
                /// <summary>Gets details of a single DataSourceReference.</summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.DataSourceReference>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Lists DataSourceReferences for a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListDataSourceReferencesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/dataSourceReferences";
            ...
            public class ManagementServersResource
            {
                ...
                /// Cloud regions, for example **us-central1**.
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Backupdr.v1beta.Data.ManagementServer body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.ManagementServer body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.ManagementServer Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/managementServers";
                ...
                /// <summary>Gets details of a single ManagementServer.</summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ManagementServer>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// does not have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Policy>
                {
                ...
                /// <summary>Lists ManagementServers in a given project and location.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListManagementServersResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// </param>
                public virtual MsComplianceMetadataRequest MsComplianceMetadata(Google.Apis.Backupdr.v1beta.Data.FetchMsComplianceMetadataRequest body, string parent)
                {
                    return new MsComplianceMetadataRequest(this.service, body, parent);
                }

                /// <summary>Returns the Assured Workloads compliance metadata for a given project.</summary>
                public class MsComplianceMetadataRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.FetchMsComplianceMetadataResponse>
                {
                    /// <summary>Constructs a new MsComplianceMetadata request.</summary>
                    public MsComplianceMetadataRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.FetchMsComplianceMetadataRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.FetchMsComplianceMetadataRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}:msComplianceMetadata";
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.Backupdr.v1beta.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
                /// </summary>
                public class SetIamPolicyRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.SetIamPolicyRequest Body { get; set; }
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.Backupdr.v1beta.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            public class ResourceBackupConfigsResource
            {
                ...
                /// <summary>Lists ResourceBackupConfigs.</summary>
                public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListResourceBackupConfigsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/resourceBackupConfigs";
            ...
            public class ServiceConfigResource
            {
                ...
                /// </param>
                public virtual InitializeRequest Initialize(Google.Apis.Backupdr.v1beta.Data.InitializeServiceRequest body, string name)
                {
                    return new InitializeRequest(this.service, body, name);
                }

                /// <summary>Initializes the service related config for a project.</summary>
                public class InitializeRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Operation>
                {
                    /// <summary>Constructs a new Initialize request.</summary>
                    public InitializeRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.InitializeServiceRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.InitializeServiceRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+name}:initialize";
            ...
            /// <summary>Gets the Trial resource.</summary>
            public virtual TrialResource Trial { get; }

            /// <summary>The "trial" collection of methods.</summary>
            public class TrialResource
            {
                private const string Resource = "trial";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public TrialResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }
                ...
                /// projects/{project}/locations/{location}
                /// </param>
                public virtual EndRequest End(Google.Apis.Backupdr.v1beta.Data.EndTrialRequest body, string parent)
                {
                    return new EndRequest(this.service, body, parent);
                }

                /// <summary>Ends the trial for a project</summary>
                public class EndRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Trial>
                {
                    /// <summary>Constructs a new End request.</summary>
                    public EndRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.EndTrialRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.EndTrialRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/trial:end";
                ...
                /// </param>
                public virtual SubscribeRequest Subscribe(Google.Apis.Backupdr.v1beta.Data.SubscribeTrialRequest body, string parent)
                {
                    return new SubscribeRequest(this.service, body, parent);
                }

                /// <summary>Subscribes to a trial for a project</summary>
                public class SubscribeRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Trial>
                {
                    /// <summary>Constructs a new Subscribe request.</summary>
                    public SubscribeRequest(Google.Apis.Services.IClientService service, Google.Apis.Backupdr.v1beta.Data.SubscribeTrialRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Backupdr.v1beta.Data.SubscribeTrialRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/trial:subscribe";
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Gets the Trial state for a given project</summary>
            public class GetTrialRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.Trial>
            {
                /// <summary>Constructs a new GetTrial request.</summary>
                public GetTrialRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
                    Name = name;
                    InitParameters();
                }
                ...
                /// <summary>Gets the method name.</summary>
                public override string MethodName => "getTrial";
                ...
                /// <summary>Initializes GetTrial parameter list.</summary>
                protected override void InitParameters()
                {
                    base.InitParameters();
                    RequestParameters.Add("name", new Google.Apis.Discovery.Parameter
            ...
            /// specific service implementation and version.
            /// </summary>
            public class ListRequest : BackupdrBaseServiceRequest<Google.Apis.Backupdr.v1beta.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
namespace Google.Apis.Backupdr.v1beta.Data
{
    ...
    /// <summary>
    /// AppliedAutoProtectionPolicy is a read-only view of AutoProtectionPolicy and AutoProtectionPolicyBinding
    /// resources that apply to a given workload project.
    /// </summary>
    public class AppliedAutoProtectionPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. The set of backup plan configurations, mirroring the backup_plan_details from the source
        /// AutoProtectionPolicy. Each element specifies a backup plan for a given resource type.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanDetails")]
        public virtual System.Collections.Generic.IList<BackupPlanDetail> BackupPlanDetails { get; set; }

        /// <summary>Output only. The summary of the last policy application when the job has run.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bindingEvaluationSummary")]
        public virtual BindingEvaluationSummary BindingEvaluationSummary { get; set; }

        private string _createTimeRaw;

        private object _createTime;

        /// <summary>Output only. Timestamp indicating when the binding was last created.</summary>
        ...
        /// <summary>
        /// Identifier. Canonical resource name. Format:
        ...
        /// <summary>
        /// Output only. The full resource name of the AutoProtectionPolicyBinding that applies the source policy to a
        /// scope including this workload project. e.g.,
        /// projects/{admin-project}/locations/{location}/autoProtectionPolicies/{policy_id}/autoProtectionPolicyBindings/{binding_id}.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("sourceBinding")]
        public virtual string SourceBinding { get; set; }

        /// <summary>Output only. The status of the applied auto protection policy.</summary>
        ...
        /// <summary>Output only. Timestamp indicating when the binding was last modified.</summary>
    ...
    /// </summary>
    public class AutoProtectionDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        /// <summary>Output only. Error during last sync for protection/unprotection, if any.</summary>
    ...
    /// <summary>
    /// An AutoprotectionPolicy is a policy resource designed to automate backup management, moving from manual
    /// per-resource protection to a bulk approach. The policy dynamically discovers and applies a specified backup plan
    /// to all eligible resources that match its defined scope and criteria.
    /// </summary>
    public class AutoProtectionPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Required. The backup plan details for matching resources.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanDetails")]
        public virtual System.Collections.Generic.IList<BackupPlanDetail> BackupPlanDetails { get; set; }

        /// <summary>Output only. Summary of total count of different containers covered through this policy.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bindingSummary")]
        public virtual BindingSummary BindingSummary { get; set; }

        private string _createTimeRaw;

        private object _createTime;

        /// <summary>Output only. The timestamp when the policy was created.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("createTime")]
        public virtual string CreateTimeRaw
        {
            get => _createTimeRaw;
        ...
        /// <summary>Required. The criteria for matching resources.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("criteria")]
        public virtual Criteria Criteria { get; set; }
        ...
        /// <summary>
        /// Output only. The etag for the policy. If this is provided on update, it must match the server's etag,
        /// otherwise the request will be rejected with an ABORTED error.
        /// </summary>
        ...
        /// <summary>Output only. Summary of last policy application when job was run per workload type.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("policyEvaluationSummary")]
        public virtual PolicyEvaluationSummary PolicyEvaluationSummary { get; set; }

        /// <summary>Output only. The current state of the AutoprotectionPolicy.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }
        ...
        /// <summary>Output only. The timestamp when the policy was last updated.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("updateTime")]
        public virtual string UpdateTimeRaw
        {
            get => _updateTimeRaw;
    ...
    /// <summary>
    /// An AutoprotectionPolicyBinding (APPA) acts as the bridge between an AutoprotectionPolicy and the scope (Project,
    /// Folder, or Organization) where the policy should be applied.
    /// </summary>
    public class AutoProtectionPolicyBinding : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. Summaries of the last policy application when the job has run, with one entry per resource type
        ...
        /// <summary>Output only. The timestamp when the binding was created.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("createTime")]
        public virtual string CreateTimeRaw
        {
            get => _createTimeRaw;
        ...
        /// <summary>Optional. A description of the binding.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }

        /// <summary>
        /// Optional. Output only. The etag for the binding. If this is provided on update, it must match the server's
        /// etag.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("etag")]
        public virtual string ETag { get; set; }
        ...
        /// <summary>Output only. The current state of the AutoProtectionPolicyBinding.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }
        ...
        /// <summary>Output only. The timestamp when the binding was last updated.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("updateTime")]
        public virtual string UpdateTimeRaw
        {
            get => _updateTimeRaw;
    ...
    public class BackupPlan : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Compute Engine Instances. This includes settings like whether to perform a guest flush.
        /// </summary>
    ...
    public class BackupPlanAssociation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. The resource name of the `AutoProtectionPolicyBinding` that manages this association, if any.
        /// Format: `projects/{project}/locations/{location}/autoProtectionPolicies/{policy}/bindings/{binding}`.
        /// </summary>
        ...
        /// Output only. The user friendly revision ID of the `BackupPlanRevision`. Example: v0, v1, v2, etc.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanRevisionId")]
    ...
    /// <summary>BackupPlanDetail defines configuration of protection.</summary>
    public class BackupPlanDetail : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. The resource name of the BackupPlan to apply to resources that match the policy's criteria. This
        /// backup plan must be in the same location as AutoProtectionPolicy. Format:
        /// projects/{project}/locations/{location}/backupPlans/{backupPlanId}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlan")]
        public virtual string BackupPlan { get; set; }
    ...
    /// <summary>`BackupPlanRevision` represents a snapshot of a `BackupPlan` at a point in time.</summary>
    public class BackupPlanRevision : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The Backup Plan being encompassed by this revision.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanSnapshot")]
        public virtual BackupPlan BackupPlanSnapshot { get; set; }
        ...
        /// <summary>Output only. Resource State</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }
    ...
    {
        /// <summary>
        /// Optional. Restricts access to certain sources and destinations for data being sent into, or restored from,
        /// the backup vault. Defaults to WITHIN_ORGANIZATION if not provided during creation.
        /// </summary>
    ...
    /// <summary>
    /// BindingEvaluationSummary contains the summary of the last run of job that applies policy to matching resources
    /// for a given binding.
    /// </summary>
    public class BindingEvaluationSummary : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. The number of matching resources whose protection failed during job run.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failedResourceCount")]
        public virtual System.Nullable<long> FailedResourceCount { get; set; }

        /// <summary>Output only. The number of resources that currently match the policy's criteria.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("matchingResourceCount")]
        public virtual System.Nullable<long> MatchingResourceCount { get; set; }

        /// <summary>Output only. The number of matching resources that are successfully protected.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("protectedResourceCount")]
        public virtual System.Nullable<long> ProtectedResourceCount { get; set; }
    ...
    /// </summary>
    public class BindingMatchingResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. The auto protection details of the resource from the current binding's perspective.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoProtectionDetails")]
        public virtual AutoProtectionDetails AutoProtectionDetails { get; set; }

        private string _lastEvaluationTimeRaw;

        private object _lastEvaluationTime;

        /// <summary>Output only. The timestamp when the resource was last evaluated for protection.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("lastEvaluationTime")]
        public virtual string LastEvaluationTimeRaw
        {
            get => _lastEvaluationTimeRaw;
            set
            {
                _lastEvaluationTime = Google.Apis.Util.Utilities.DeserializeForGoogleFormat(value);
                _lastEvaluationTimeRaw = value;
            }
        }

        /// <summary><seealso cref="object"/> representation of <see cref="LastEvaluationTimeRaw"/>.</summary>
        [Newtonsoft.Json.JsonIgnoreAttribute]
        [System.ObsoleteAttribute("This property is obsolete and may behave unexpectedly; please use LastEvaluationTimeDateTimeOffset instead.")]
        public virtual object LastEvaluationTime
        {
            get => _lastEvaluationTime;
            set
            {
                _lastEvaluationTimeRaw = Google.Apis.Util.Utilities.SerializeForGoogleFormat(value);
                _lastEvaluationTime = value;
            }
        }

        /// <summary>
        /// <seealso cref="System.DateTimeOffset"/> representation of <see cref="LastEvaluationTimeRaw"/>.
        /// </summary>
        [Newtonsoft.Json.JsonIgnoreAttribute]
        public virtual System.DateTimeOffset? LastEvaluationTimeDateTimeOffset
        {
            get => Google.Apis.Util.DiscoveryFormat.ParseGoogleDateTimeToDateTimeOffset(LastEvaluationTimeRaw);
            set => LastEvaluationTimeRaw = Google.Apis.Util.DiscoveryFormat.FormatDateTimeOffsetToGoogleDateTime(value);
        }

        /// <summary>
        /// Identifier. The resource name of the `BindingMatchingResource`. Format:
        /// `projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}/bindings/{binding}/matchingResources/{matching_resource}`
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
        ...
        /// <summary>
        /// Required. Immutable. Resource name of the workload that matches the criteria of the binding. The format can
        /// be either a relative resource name (e.g., `projects/my-project/zones/us-central1-a/instances/my-instance`)
    ...
    /// <summary>BindingSummary contains count of different containers covered through this policy.</summary>
    public class BindingSummary : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. Total count of Projects protected with this policy.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("projectCount")]
        public virtual System.Nullable<long> ProjectCount { get; set; }
    ...
    /// <summary>Criteria specifies a set of criteria for matching resources.</summary>
    public class Criteria : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("matchingConditions")]
        public virtual System.Collections.Generic.IList<MatchingCondition> MatchingConditions { get; set; }
    ...
    /// <summary>Response for FetchResourceBackupConfigs.</summary>
    public class FetchResourceBackupConfigsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GCPBackupPlanInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The user friendly id of the backup plan revision which triggered this backup in case of scheduled backup or
        /// used for on demand backup.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanRevisionId")]
        public virtual string BackupPlanRevisionId { get; set; }

        /// <summary>
        /// Resource name of the backup plan revision which triggered this backup in case of scheduled backup or used
        /// for on demand backup. Format:
    ...
    {
        /// <summary>
        /// Output only. The resource name of the `AutoProtectionPolicyBinding` that manages this datasource, if any.
        /// Format: `projects/{project}/locations/{location}/autoProtectionPolicies/{policy}/bindings/{binding}`.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoProtectionPolicyBinding")]
        public virtual string AutoProtectionPolicyBinding { get; set; }
        ...
        /// <summary>The user friendly id of the backup plan revision. E.g. v0, v1 etc.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanRevisionId")]
        public virtual string BackupPlanRevisionId { get; set; }

        /// <summary>The name of the backup plan revision.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanRevisionName")]
        public virtual string BackupPlanRevisionName { get; set; }
    ...
    public class GoogleCloudBackupdrV1betaOperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    /// <summary>Request message for initiating delete of an AutoProtectionPolicyBinding.</summary>
    public class InitiateDeleteAutoProtectionPolicyBindingRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }
    ...
    /// <summary>KeyValuePair defines a key-value pair for matching resource labels.</summary>
    public class KeyValuePair : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. The key of the label to match. This must be in the format `{label_key}`. The key must match the
        /// regex Format:`\p{Ll}\p{Lo}{0,62}`.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("key")]
        public virtual string Key { get; set; }

        /// <summary>
        /// Required. The values of the label to match. There will be explicit “OR” between values of array. Each value
        /// must be in the format `{label_value}`. The value must match the regex Format:
    ...
    /// <summary>Response message for ListAppliedAutoProtectionPolicies.</summary>
    public class ListAppliedAutoProtectionPoliciesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A list of the AppliedAutoProtectionPolicy resources found.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("appliedAutoProtectionPolicies")]
        public virtual System.Collections.Generic.IList<AppliedAutoProtectionPolicy> AppliedAutoProtectionPolicies { get; set; }
    ...
    /// <summary>Response message for ListAutoProtectionPolicies.</summary>
    public class ListAutoProtectionPoliciesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A list of the AutoProtectionPolicy resources found.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoProtectionPolicies")]
        public virtual System.Collections.Generic.IList<AutoProtectionPolicy> AutoProtectionPolicies { get; set; }
    ...
    /// <summary>Response message for ListAutoProtectionPolicyBindings.</summary>
    public class ListAutoProtectionPolicyBindingsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A list of the AutoProtectionPolicyBindings resources found.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoProtectionPolicyBindings")]
        public virtual System.Collections.Generic.IList<AutoProtectionPolicyBinding> AutoProtectionPolicyBindings { get; set; }
    ...
    /// <summary>The response message for getting a list of `BackupPlanRevision`.</summary>
    public class ListBackupPlanRevisionsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        /// will be populated with a list of unreachable locations.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("backupPlanRevisions")]
        public virtual System.Collections.Generic.IList<BackupPlanRevision> BackupPlanRevisions { get; set; }
    ...
    /// <summary>The response message for getting a list of `BindingMatchingResources`.</summary>
    public class ListBindingMatchingResourcesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The list of `BindingMatchingResources` in the project,location for the specified binding.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("matchingResources")]
        public virtual System.Collections.Generic.IList<BindingMatchingResource> MatchingResources { get; set; }

        /// <summary>
        /// A token which may be sent as page_token in a subsequent `ListBindingMatchingResources` call to retrieve the
        /// next page of results. If this field is omitted or empty, then there are no more results to return.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    /// <summary>MatchingCondition specifies a set of conditions for matching resources.</summary>
    public class MatchingCondition : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. A condition that matches resources based on their labels. For MVP, this is limited to a single
        /// label match.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labelCondition")]
        public virtual KeyValuePair LabelCondition { get; set; }
    ...
    /// </summary>
    public class PolicyEvaluationSummary : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. The number of matching resources whose protection failed during job run.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failedResourceCount")]
        public virtual System.Nullable<long> FailedResourceCount { get; set; }
    ...
    {
        /// <summary>
        /// Set to true to restore the boot disk from the instance backup. This field should only be set to true if
        /// selected.
        /// </summary>
    ...
    /// <summary>Request message for subscribing to a trial.</summary>
    public class SubscribeTrialRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }
    ...
    public class Trial : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The time when the trial will expire.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endTime")]
        public virtual string EndTimeRaw
        {
            get => _endTimeRaw;
        ...
        /// <summary>Output only. The time when the trial was subscribed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("startTime")]
        public virtual string StartTimeRaw
        {
            get => _startTimeRaw;
        ...
        /// <summary>Output only. The state of the trial.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }
