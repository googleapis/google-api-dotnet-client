...
{    
    ...
    public class Condition : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The signed-in user originating the request must be a part of one of the provided members. Syntax:
        /// `user:{emailid}` `group:{emailid}` `serviceAccount:{emailid}` If not specified, a request may come from any
        /// user (logged in/not logged in, not present in any groups, etc.).</summary>
