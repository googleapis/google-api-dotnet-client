...
namespace Google.Apis.CloudVideoIntelligence.v1beta2
{
    ...
    public class CloudVideoIntelligenceService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri =>
            ...
            BaseUriOverride ?? "https://videointelligence.googleapis.com/";
        #else
    ...
    public class VideosResource
    {
        ...
        public virtual AnnotateRequest Annotate(Google.Apis.CloudVideoIntelligence.v1beta2.Data.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest body)
        {
        ...
        /// `google.longrunning.Operations` interface. `Operation.metadata` contains `AnnotateVideoProgress` (progress).
        /// `Operation.response` contains `AnnotateVideoResponse` (results).</summary>
        public class AnnotateRequest : CloudVideoIntelligenceBaseServiceRequest<Google.Apis.CloudVideoIntelligence.v1beta2.Data.GoogleLongrunningOperation>
        {
            /// <summary>Constructs a new Annotate request.</summary>
            public AnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudVideoIntelligence.v1beta2.Data.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            Google.Apis.CloudVideoIntelligence.v1beta2.Data.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest Body { get; set; }
            ...
            public override string RestPath => "v1beta2/videos:annotate";
...
{    
    ...
    public class GoogleCloudVideointelligenceV1DetectedAttribute : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The name of the attribute, for example, glasses, dark_glasses, mouth_open. A full list of supported
    ...
    {
        /// <summary>Common categories for the detected entity. For example, when the label is `Terrier`, the category
        /// is likely `dog`. And in some cases there might be more than one categories e.g., `Terrier` could also be a
        /// `pet`.</summary>
    ...
    public class GoogleCloudVideointelligenceV1SpeechRecognitionAlternative : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `enable_speaker_diarization` is set to true, you will see all the words from the beginning of the
        /// audio.</summary>
    ...
    public class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The video data bytes. If unset, the input video(s) should be specified via the `input_uri`. If set,
        /// `input_uri` must be unset.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("inputContent")]
        public virtual string InputContent { get; set; }

        /// <summary>Input video location. Currently, only [Cloud Storage](https://cloud.google.com/storage/) URIs are
        /// supported. URIs must be specified in the following format: `gs://bucket-id/object-id` (other URI formats
        /// return google.rpc.Code.INVALID_ARGUMENT). For more information, see [Request
        ...
        /// `input_content` must be unset.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("inputUri")]
        public virtual string InputUri { get; set; }

        /// <summary>Optional. Cloud region where annotation should take place. Supported cloud regions are: `us-east1`,
        ...
        /// <summary>Optional. Location where the output (in JSON format) should be stored. Currently, only [Cloud
        ...
        /// information, see [Request URIs](https://cloud.google.com/storage/docs/request-endpoints).</summary>
    ...
    public class GoogleCloudVideointelligenceV1beta2ExplicitContentDetectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVideointelligenceV1beta2FaceDetectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Whether to enable face attributes detection, such as glasses, dark_glasses, mouth_open etc. Ignored
        /// if 'include_bounding_boxes' is set to false.</summary>
    ...
    public class GoogleCloudVideointelligenceV1beta2LabelDetectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// range will be clipped. Note: For best results, follow the default threshold. We will update the default
        /// threshold everytime when we release a new model.</summary>
        ...
        /// <summary>Whether the video has been shot from a stationary (i.e., non-moving) camera. When set to true,
        ...
        /// detections. If not set, it's set to 0.3 by default. The valid range for this threshold is [0.1, 0.9]. Any
        /// value set outside of this range will be clipped. Note: For best results, follow the default threshold. We
        /// will update the default threshold everytime when we release a new model.</summary>
    ...
    public class GoogleCloudVideointelligenceV1beta2ObjectTrackingConfig : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVideointelligenceV1beta2PersonDetectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Whether to enable person attributes detection, such as cloth color (black, blue, etc), type (coat,
        /// dress, etc), pattern (plain, floral, etc), hair, etc. Ignored if 'include_bounding_boxes' is set to
        /// false.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("includeAttributes")]
        public virtual System.Nullable<bool> IncludeAttributes { get; set; }
        ...
        /// <summary>Whether to enable pose landmarks detection. Ignored if 'include_bounding_boxes' is set to
        /// false.</summary>
    ...
    public class GoogleCloudVideointelligenceV1beta2ShotChangeDetectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVideointelligenceV1beta2SpeechContext : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// the words from the beginning of the audio for the top alternative in every consecutive response. This is
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudVideointelligenceV1beta2SpeechContext> SpeechContexts { get; set; }
    ...
    public class GoogleCloudVideointelligenceV1beta2TextDetectionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVideointelligenceV1beta2VideoContext : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Config for EXPLICIT_CONTENT_DETECTION.</summary>
