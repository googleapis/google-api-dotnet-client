...
/**
 * \brief
 *   Cloud Memorystore for Redis API Version v1beta1
 *
 * \section ApiInfo API Version Information
 *    <table>
 *      <tr><th>API
 *          <td><a href='https://cloud.google.com/memorystore/docs/redis/'>Cloud Memorystore for Redis API</a>
 ...
 *
 * The complete API documentation for using Cloud Memorystore for Redis API can be found at
...
namespace Google.Apis.CloudRedis.v1beta1
{
    ...
    public class CloudRedisService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scopes for use with the Cloud Memorystore for Redis API.</summary>
        public class Scope
        {
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                ///
                /// By default, the instance is peered to the project's [default network](/compute/docs/networks-and-
                /// firewalls#networks).
                ///
                ...
                /// however, users get to choose which specific zone (or collection of zones for cross-zone instances) an instance
                /// should be provisioned in. Refer to [location_id] and [alternative_location_id] fields for more details.</param>
                ...
                public class PatchRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.Operation>
                {
                    ...
                    /// a GCP region; however, users get to choose which specific zone (or collection of zones for
                    /// cross-zone instances) an instance should be provisioned in. Refer to [location_id] and
                    ...
                    /// `display_name` * `labels` * `redis_config` * `redis_version`</summary>
...
{    
    ...
    public class Instance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The current zone where the Redis endpoint is placed. In single zone deployments, this
        /// will always be the same as [location_id] provided by the user at creation time. In cross-zone instances
        /// (only applicable in STANDARD_HA tier), this can be either [location_id] or [alternative_location_id] and can
        /// change on a failover event.</summary>
        ...
        /// <summary>Required. Redis memory size in GB, up to 200GB.</summary>
        ...
        /// region; however, users get to choose which specific zone (or collection of zones for cross-zone instances)
        /// an instance should be provisioned in. Refer to [location_id] and [alternative_location_id] fields for more
        /// details.</summary>
        ...
        /// the only supported parameters are: * maxmemory-policy * notify-keyspace-events</summary>
        ...
        /// must be unique and non-overlapping with existing subnets in a network.</summary>
    ...
    /// <summary>This operation metadata represents the state of operations that may have happened or are happening on
    /// the instance. All fields are output only. It is returned as content of the
    /// `google.longrunning.Operation.metadata` field. The `google.longrunning.Operation.name` field will be of the form
    /// `projects/{project_id}/locations/{location_id}/operations/{operation_id}` and the name for a `ListOperations`
    /// request will be of the form `projects/{project_id}/locations/{location_id}`
    ///
    /// On a ListOperations request where {location_id} is "-", all regions available to the {project_id} are queried
    /// and the results aggregated. If a location is not available, a dummy `google.longrunning.Operation` entry will be
    /// included in the `operations` field of the response, with the `name` field set to a value of the form
    /// `projects/{project_id}/locations/{location_id}/operations/-` and the `done` field will be set and the
    /// `result.error` field set with the `code` field set to `google.rpc.Code.DEADLINE_EXCEEDED` and the `message`
    /// field set to `location unavailable for ListOperations`. The Operation metadata` field will not be set for such a
    /// dummy operation.</summary>
    public class OperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The time the operation was completed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endTime")]
        public virtual object EndTime { get; set; } 
        ...
        /// <summary>Output only. The time the operation was started.</summary>
