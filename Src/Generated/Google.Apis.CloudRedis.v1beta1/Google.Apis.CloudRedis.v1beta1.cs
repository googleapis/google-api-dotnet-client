        ...
        public class LocationsResource
        {
            ...
            public class AclPoliciesResource
            {
                ...
                public class RevisionsResource
                {
                    ...
                    /// <summary>Gets details of a specific ACL policy revision.</summary>
                    public class GetRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.AclPolicyRevision>
                    {
                    ...
                    /// <summary>Lists all ACL policy revisions in a given ACL policy.</summary>
                    public class ListRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.ListAclPolicyRevisionsResponse>
                    {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta1/{+parent}/revisions";
            ...
            public class ClustersResource
            {
                ...
                public class TokenAuthUsersResource
                {
                    ...
                    public class AuthTokensResource
                    {
                        ...
                        /// <summary>Gets a specific auth token for a specific token auth user.</summary>
                        public class GetRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.AuthToken>
                        {
                            /// <summary>Constructs a new Get request.</summary>
                            public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                            {
                        ...
                        /// <summary>Lists all the auth tokens for a specific token auth user.</summary>
                        public class ListRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.ListAuthTokensResponse>
                        {
                            /// <summary>Constructs a new List request.</summary>
                            public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                            {
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta1/{+parent}/authTokens";
                    ...
                    /// projects/{project}/locations/{location}/clusters/{cluster}/tokenAuthUsers/{token_auth_user}
                    /// </param>
                    public virtual AddAuthTokenRequest AddAuthToken(Google.Apis.CloudRedis.v1beta1.Data.AddAuthTokenRequest body, string tokenAuthUser)
                    {
                        return new AddAuthTokenRequest(this.service, body, tokenAuthUser);
                    }

                    /// <summary>Adds a auth token for a user of a token based auth enabled cluster.</summary>
                    public class AddAuthTokenRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.Operation>
                    {
                        /// <summary>Constructs a new AddAuthToken request.</summary>
                        public AddAuthTokenRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRedis.v1beta1.Data.AddAuthTokenRequest body, string tokenAuthUser) : base(service)
                        {
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudRedis.v1beta1.Data.AddAuthTokenRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta1/{+tokenAuthUser}:addAuthToken";
                    ...
                    /// <summary>Gets a specific token auth user for a basic auth enabled cluster.</summary>
                    public class GetRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.TokenAuthUser>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists all the token auth users for a token based auth enabled cluster.</summary>
                    public class ListRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.ListTokenAuthUsersResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta1/{+parent}/tokenAuthUsers";
                ...
                /// projects/{project}/locations/{location}/clusters/{cluster}
                /// </param>
                public virtual AddTokenAuthUserRequest AddTokenAuthUser(Google.Apis.CloudRedis.v1beta1.Data.AddTokenAuthUserRequest body, string cluster)
                {
                    return new AddTokenAuthUserRequest(this.service, body, cluster);
                }

                /// <summary>Adds a token auth user for a token based auth enabled cluster.</summary>
                public class AddTokenAuthUserRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new AddTokenAuthUser request.</summary>
                    public AddTokenAuthUserRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRedis.v1beta1.Data.AddTokenAuthUserRequest body, string cluster) : base(service)
                    {
                        Cluster = cluster;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudRedis.v1beta1.Data.AddTokenAuthUserRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+cluster}:addTokenAuthUser";
            ...
            /// <summary>Gets the details of regional certificate authority information for Redis cluster.</summary>
            public class GetSharedRegionalCertificateAuthorityRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.SharedRegionalCertificateAuthority>
            {
...
namespace Google.Apis.CloudRedis.v1beta1.Data
{
    ...
    /// </summary>
    public class BackupDRMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
