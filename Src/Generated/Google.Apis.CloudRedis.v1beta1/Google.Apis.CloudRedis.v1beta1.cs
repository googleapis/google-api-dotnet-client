        ...
        public class LocationsResource
        {
            ...
            public class InstancesResource
            {
                ...
                public class ExportRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.Operation>
                {
                    ...
                    public ExportRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRedis.v1beta1.Data.ExportInstanceRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                public class ImportRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1beta1.Data.Operation>
                {
                    ...
                    public ImportRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRedis.v1beta1.Data.ImportInstanceRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
