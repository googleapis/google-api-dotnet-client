...
{    
    ...
    public class Instance : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. IAM identity used by import / export operations to transfer data to/from GCS.  Format
        /// is "serviceAccount:".  The value may change over time for a given instance so should be checked before each
        /// import/export operation.</summary>
