...
{    
    ...
    /// <summary>`Any` contains an arbitrary serialized message along with a URL that describes the type of the
    /// serialized message.
    ///
    ...
    {
        /// <summary>A URL/resource name whose content describes the type of the serialized message.
        ///
        /// For URLs which use the schema `http`, `https`, or no schema, the following restrictions and interpretations
        /// apply:
        ///
        ...
        /// <summary>Must be valid serialized data of the above specified type.</summary>
