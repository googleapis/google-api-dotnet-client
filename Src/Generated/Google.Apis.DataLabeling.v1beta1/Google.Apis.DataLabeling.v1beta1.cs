    ...
    public class ProjectsResource
    {
        ...
        public class DatasetsResource
        {
            ...
            public class AnnotatedDatasetsResource
            {
                ...
                public class DataItemsResource
                {
                    ...
                    public class ListRequest : DataLabelingBaseServiceRequest<Google.Apis.DataLabeling.v1beta1.Data.GoogleCloudDatalabelingV1beta1ListDataItemsResponse>
                    {
                        ...
                        /// <summary>
                        /// Optional. Requested page size. Server may return fewer results than requested. Default value
                        /// is 100.
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual System.Nullable<int> PageSize { get; set; }
                        ...
                        /// by ListDataItemsResponse.next_page_token of the previous [DataLabelingService.ListDataItems]
                ...
                public class ExamplesResource
                {
                    ...
                    public class ListRequest : DataLabelingBaseServiceRequest<Google.Apis.DataLabeling.v1beta1.Data.GoogleCloudDatalabelingV1beta1ListExamplesResponse>
                    {
                        ...
                        /// <summary>
                        /// Optional. An expression for filtering Examples. For annotated datasets that have annotation
                        /// spec set, filter by annotation_spec.display_name is supported. Format
                        ...
                        /// <summary>
                        /// Optional. A token identifying a page of results for the server to return. Typically obtained
                        /// by ListExamplesResponse.next_page_token of the previous [DataLabelingService.ListExamples]
                        /// call. Return first page if empty.
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual string PageToken { get; set; }
                ...
                public class FeedbackThreadsResource
                {
                    ...
                    public class ListRequest : DataLabelingBaseServiceRequest<Google.Apis.DataLabeling.v1beta1.Data.GoogleCloudDatalabelingV1beta1ListFeedbackThreadsResponse>
                    {
                        ...
                        /// <summary>
                        /// Optional. A token identifying a page of results for the server to return. Typically obtained
                        /// by ListFeedbackThreads.next_page_token of the previous
            ...
            public class DataItemsResource
            {
                ...
                /// <summary>
                /// Gets a data item in a dataset by resource name. This API can be called after data are imported into
                /// dataset.
                /// </summary>
                /// <param name="name">
                /// Required. The name of the data item to get, format:
            ...
            /// <summary>
            /// Imports data into dataset based on source locations defined in request. It can be called multiple times
            /// for the same dataset. Each dataset can only have one long running operation running on it. For example,
            /// no labeling task (also long running operation) can be started while importing is still ongoing. Vice
            /// versa.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">
        ...
        public class EvaluationJobsResource
        {
            ...
            public class ListRequest : DataLabelingBaseServiceRequest<Google.Apis.DataLabeling.v1beta1.Data.GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse>
            {
                ...
                /// nextPageToken in the response to the previous request. The request returns the first page if this is
                /// empty.
                /// </summary>
                [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string PageToken { get; set; }
            ...
            /// change any other aspect of the evaluation job, you must delete the job and create a new one.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">
        ...
        public class EvaluationsResource
        {
            ...
            public class SearchRequest : DataLabelingBaseServiceRequest<Google.Apis.DataLabeling.v1beta1.Data.GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse>
            {
                ...
                /// the `AND` operator or the `OR` operator. The following examples shows a string that filters by
                ...
                /// <summary>
                /// Optional. A token identifying a page of results for the server to return. Typically obtained by the
                /// nextPageToken of the response to a previous search request. If you don't specify this field, the API
...
namespace Google.Apis.DataLabeling.v1beta1.Data
{
    ...
    public class GoogleCloudDatalabelingV1alpha1CreateInstructionMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Partial failures encountered. E.g. single files that couldn't be read. Status details field will contain
    ...
    public class GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output only. Partial failures encountered. E.g. single files that couldn't be read. Status details field
    ...
    {
        /// <summary>
        /// Optional. A human-readable description for AnnotatedDataset. The description can be up to 10000 characters
        /// long.
        /// </summary>
        ...
        /// <summary>
        /// Optional. If you want your own labeling contributors to manage and work on this labeling request, you can
        /// set these contributors here. We will give them access to the question types in crowdcompute. Note that these
        ...
        /// <summary>
        /// Optional. The Language of this question, as a [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt).
        /// Default value is en-US. Only need to set this when task is language related. For example, French text
        /// classification.
        /// </summary>
        ...
        /// <summary>
        /// Optional. Maximum duration for contributors to answer a question. Maximum is 3600 seconds. Default is 3600
        /// seconds.
        /// </summary>
        ...
        /// <summary>
        /// Optional. Replication of questions. Each question will be sent to up to this number of contributors to
        /// label. Aggregated answers will be returned. Default is set to 1. For image related labeling, valid values
        /// are 1, 3, 5.
        /// </summary>
        ...
        /// <summary>
        /// Email of the user who started the labeling task and should be notified by email. If empty no notification
        /// will be sent.
        /// </summary>
    ...
    {
        /// <summary>
        /// Map of each annotation spec's example count. Key is the annotation spec name and value is the number of
        /// examples for that annotation spec. If the annotated dataset does not have annotation spec, the map will
        /// return a pair where the key is empty string and value is the total number of annotations.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1alpha1OutputConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Output to a folder in Cloud Storage. Should be used for image segmentation or document de-identification
        /// labeling outputs.
        /// </summary>
    ...
    /// <summary>
    /// AnnotatedDataset is a set holding annotations for data in a Dataset. Each labeling task will generate an
    /// AnnotatedDataset under the Dataset that the task is requested for.
    /// </summary>
    public class GoogleCloudDatalabelingV1beta1AnnotatedDataset : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// starts a labeling task. Maximum of 10000 characters.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }

        /// <summary>
        /// Output only. The display name of the AnnotatedDataset. It is specified in HumanAnnotationConfig when user
        /// starts a labeling task. Maximum of 64 characters.
        /// </summary>
    ...
    /// <summary>
    /// Annotation for Example. Each example may have one or more annotations. For example in image classification
    /// problem, each image might have one or more labels. We call labels binded with this image an Annotation.
    /// </summary>
    ...
    /// image classification task where images are labeled as `dog` or `cat` must reference an AnnotationSpec for `dog`
    ...
    {
        /// <summary>
        /// Optional. User-provided description of the annotation specification. The description can be up to 10,000
        /// characters long.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }
        ...
        /// sequential starting from 0. For example, an AnnotationSpecSet with classes `dog` and `cat`, might contain
        /// one AnnotationSpec with `{ display_name: "dog", index: 0 }` and one AnnotationSpec with `{ display_name:
        /// "cat", index: 1 }`. This is especially useful for model training as it encodes the string labels into
        /// numeric values.
        /// </summary>
    ...
    /// <summary>
    /// An AnnotationSpecSet is a collection of label definitions. For example, in image classification tasks, you
    /// define a set of possible labels for images as an AnnotationSpecSet. An AnnotationSpecSet is immutable upon
    /// creation.
    /// </summary>
    public class GoogleCloudDatalabelingV1beta1AnnotationSpecSet : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. The array of AnnotationSpecs that you define when you create the AnnotationSpecSet. These are the
        /// possible labels for the labeling task.
        /// </summary>
        ...
        /// <summary>
        /// Optional. User-provided description of the annotation specification set. The description can be up to 10,000
        /// characters long.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }
        ...
        /// <summary>
        /// Required. The display name for AnnotationSpecSet that you define when you create it. Maximum of 64
        /// characters.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayName")]
        public virtual string DisplayName { get; set; }
    ...
    {
        /// <summary>
        /// Optional. If allow_multi_label is true, contributors are able to choose multiple labels from one annotation
        /// spec set.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1beta1AnnotationValue : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Annotation value for image polyline cases. Polyline here is different from BoundingPoly. It is formed by
        /// line segments connected to each other but not closed form(Bounding Poly). The line segments can cross each
        /// other.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1beta1Attempt : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        {
            get => Google.Apis.Util.Utilities.GetDateTimeOffsetFromString(AttemptTimeRaw);
            set => AttemptTimeRaw = Google.Apis.Util.Utilities.GetStringFromDateTimeOffset(value);
        }
    ...
    /// <summary>
    /// The BigQuery location for input data. If used in an EvaluationJob, this is where the service saves the
    ...
    {
        /// <summary>
        /// Required. BigQuery URI to a table, up to 2,000 characters long. If you specify the URI of a table that does
        /// not exist, Data Labeling Service creates a table at the URI with the correct schema when you create your
        /// EvaluationJob. If you specify the URI of a table that already exists, it must have the [correct
        /// schema](/ml-engine/docs/continuous-evaluation/create-job#table-schema). Provide the table URI in the
        /// following format: "bq://{your_project_id}/ {your_dataset_name}/{your_table_name}" [Learn
    ...
    public class GoogleCloudDatalabelingV1beta1BoundingBoxEvaluationOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// (IOU)](/vision/automl/object-detection/docs/evaluate#intersection-over-union) required for 2 bounding boxes
        /// to be considered a match. This must be a number between 0 and 1.
        /// </summary>
    ...
    {
        /// <summary>
        /// Threshold used for this entry. For classification tasks, this is a classification threshold: a predicted
        /// label is categorized as positive or negative (in the context of this point on the PR curve) based on whether
        /// the label's score meets this threshold. For image object detection (bounding box) tasks, this is the
        /// [intersection-over-union (IOU)](/vision/automl/object-detection/docs/evaluate#intersection-over-union)
    ...
    /// <summary>
    /// Confusion matrix of the model running the classification. Only applicable when the metrics entry aggregates
    /// multiple labels. Not applicable when the entry is for a single label.
    /// </summary>
    ...
    {
        /// <summary>
        /// Required. Annotation spec set to create. Annotation specs must be included. Only one annotation spec will be
    ...
    /// <summary>
    /// Dataset is the resource to hold your data. You can request multiple labeling tasks for a dataset while each one
    ...
    public class GoogleCloudDatalabelingV1beta1Dataset : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. User-provided description of the annotation specification set. The description can be up to 10000
        /// characters long.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }
        ...
        /// <summary>
        /// Output only. This is populated with the original input configs where ImportData is called. It is available
        /// only after the clients import data to this dataset.
        /// </summary>
    ...
    /// <summary>
    /// Describes an evaluation between a machine learning model's predictions and ground truth labels. Created when an
    /// EvaluationJob runs successfully.
    /// </summary>
    public class GoogleCloudDatalabelingV1beta1Evaluation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// populated when the evaulation is for certain AnnotationTypes.
        /// </summary>
        ...
        {
            get => Google.Apis.Util.Utilities.GetDateTimeOffsetFromString(EvaluationJobRunTimeRaw);
            set => EvaluationJobRunTimeRaw = Google.Apis.Util.Utilities.GetStringFromDateTimeOffset(value);
        }
    ...
    /// job](/ml-engine/docs/continuous-evaluation/create-job) is the starting point for using continuous evaluation.
    /// </summary>
    public class GoogleCloudDatalabelingV1beta1EvaluationJob : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// You must create this resource before you create an evaluation job and provide its name in the following
        ...
        /// <summary>
        /// Output only. Every time the evaluation job runs and an error occurs, the failed attempt is appended to this
        /// array.
        /// </summary>
        ...
        /// want the service to assign human labelers to annotate your data, set this to `true`. If you want to provide
        ...
        /// Prediction input and output is sampled from this model version. When creating an evaluation job, specify the
        /// model version in the following format: "projects/{project_id}/models/{model_name}/versions/{version_name}"
        ...
        /// <summary>
        /// Required. Describes the interval at which the job runs. This interval must be at least 1 day, and it is
        /// rounded to the nearest day. For example, if you specify a 50-hour interval, the job runs every 2 days. You
        /// can provide the schedule in [crontab format](/scheduler/docs/configuring/cron-job-schedules) or in an
    ...
    public class GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Required. A number between 0 and 1 that describes a minimum mean average precision threshold. When the
        /// evaluation job runs, if it calculates that your model version's predictions from the recent interval have
        /// meanAveragePrecision below this threshold, then it sends an alert to your specified email.
        /// </summary>
    ...
    /// <summary>
    /// Configures specific details of how a continuous evaluation job works. Provide this configuration when you create
    /// an EvaluationJob.
    /// </summary>
    public class GoogleCloudDatalabelingV1beta1EvaluationJobConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. Prediction keys that tell Data Labeling Service where to find the data for evaluation in your
        /// BigQuery table. When the service samples prediction input and output from your model version and saves it to
        /// BigQuery, the data gets stored as JSON strings in the BigQuery table. These keys tell Data Labeling Service
        /// how to parse the JSON. You can provide the following entries in this field: * `data_json_key`: the data key
        /// for prediction input. You must provide either this key or `reference_json_key`. * `reference_json_key`: the
        /// data reference key for prediction input. You must provide either this key or `data_json_key`. *
        /// `label_json_key`: the label key for prediction output. Required. * `label_score_json_key`: the score key for
        /// prediction output. Required. * `bounding_box_json_key`: the bounding box key for prediction output. Required
        /// if your model version perform image object detection. Learn [how to configure prediction
        ...
        /// <summary>
        /// Required. Details for calculating evaluation metrics and creating Evaulations. If your model version
        /// performs image object detection, you must specify the `boundingBoxEvaluationOptions` field within this
        ...
        /// <summary>
        /// Optional. Configuration details for evaluation job alerts. Specify this field if you want to receive email
        /// alerts if the evaluation job finds that your predictions have low mean average precision during a run.
        /// </summary>
        ...
        /// This limit overrides `example_sample_percentage`: even if the service has not sampled enough predictions to
        /// fulfill `example_sample_perecentage` during an interval, it stops sampling predictions when it meets this
        /// limit.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("exampleCount")]
        ...
        /// <summary>
        /// Required. Fraction of predictions to sample and save to BigQuery during each evaluation interval. For
        /// example, 0.1 means 10% of predictions served by your model version get saved to BigQuery.
        /// </summary>
        ...
        /// <summary>
        /// Optional. Details for human annotation of your data. If you set labelMissingGroundTruth to `true` for this
        /// evaluation job, then you must specify this field. If you plan to provide your own ground truth labels, then
        /// omit this field. Note that you must create an Instruction resource before you can specify this field.
        /// Provide the name of the instruction resource in the `instruction` field within this configuration.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("humanAnnotationConfig")]
        public virtual GoogleCloudDatalabelingV1beta1HumanAnnotationConfig HumanAnnotationConfig { get; set; }
        ...
        /// <summary>
        /// Rquired. Details for the sampled prediction input. Within this configuration, there are requirements for
        /// several fields: * `dataType` must be one of `IMAGE`, `TEXT`, or `GENERAL_DATA`. * `annotationType` must be
        ...
        /// <summary>
        /// Specify this field if your model version performs text classification. `annotationSpecSet` in this
    ...
    {
        /// <summary>
        /// Required. The list of annotation spec set resource name. Similar to video classification, we support
        /// selecting event from multiple AnnotationSpecSet at the same time.
        /// </summary>
        ...
        /// <summary>
        /// Videos will be cut to smaller clips to make it easier for labelers to work on. Users can configure is field
        /// in seconds, if not set, default value is 60s.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clipLength")]
        public virtual System.Nullable<int> ClipLength { get; set; }

        /// <summary>
        /// The overlap length between different video clips. Users can configure is field in seconds, if not set,
        /// default value is 1s.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1beta1Example : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// projects/{project_id}/datasets/{dataset_id}/annotatedDatasets/ {annotated_dataset_id}/examples/{example_id}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    {
        /// <summary>
        /// Required. Annotated dataset resource name. DataItem in Dataset and their annotations in specified annotated
        /// dataset will be exported. It's in format of projects/{project_id}/datasets/{dataset_id}/annotatedDatasets/
        ...
        /// <summary>
        /// Email of the user who started the export task and should be notified by email. If empty no notification will
        /// be sent.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("userEmailAddress")]
        public virtual string UserEmailAddress { get; set; }
    ...
    {
        /// <summary>
        /// The mapping between rgb color and annotation spec. The key is the rgb color represented in format of rgb(0,
        /// 0, 0). The value is the AnnotationSpec.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1beta1ImportDataRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Email of the user who started the import task and should be notified by email. If empty no notification will
        /// be sent.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("userEmailAddress")]
        public virtual string UserEmailAddress { get; set; }
    ...
    {
        /// <summary>
        /// Optional. The type of annotation to be performed on this data. You must specify this field if you are using
        ...
        /// <summary>
        /// Optional. Metadata about annotations for the input. You must specify this field if you are using this
        /// InputConfig in an EvaluationJob for a model version that performs classification.
        /// </summary>
    ...
    /// <summary>
    /// Instruction of how to perform the labeling task for human operators. Currently only PDF instruction is
    /// supported.
    /// </summary>
    public class GoogleCloudDatalabelingV1beta1Instruction : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// classification task. The CSV file should have exact two columns, in the following format: * The first column
        /// is labeled data, such as an image reference, text. * The second column is comma separated labels associated
        /// with data.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1beta1LabelImageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Configuration for image classification task. One of image_classification_config, bounding_poly_config,
        ...
        /// <summary>
        /// Configuration for polyline task. One of image_classification_config, bounding_poly_config, polyline_config
    ...
    public class GoogleCloudDatalabelingV1beta1LabelVideoRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Configuration for video event task. One of video_classification_config, object_detection_config,
        ...
        /// <summary>
        /// Configuration for video object detection task. One of video_classification_config, object_detection_config,
        /// object_tracking_config and event_config is required.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("objectDetectionConfig")]
        public virtual GoogleCloudDatalabelingV1beta1ObjectDetectionConfig ObjectDetectionConfig { get; set; }
        ...
        /// <summary>
        /// Configuration for video object tracking task. One of video_classification_config, object_detection_config,
        /// object_tracking_config and event_config is required.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("objectTrackingConfig")]
        public virtual GoogleCloudDatalabelingV1beta1ObjectTrackingConfig ObjectTrackingConfig { get; set; }
        ...
        /// <summary>
        /// Configuration for video classification task. One of video_classification_config, object_detection_config,
        /// object_tracking_config and event_config is required.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("videoClassificationConfig")]
        public virtual GoogleCloudDatalabelingV1beta1VideoClassificationConfig VideoClassificationConfig { get; set; }
    ...
    /// <summary>
    /// Config for video object detection human labeling task. Object detection will be conducted on the images
    ...
    public class GoogleCloudDatalabelingV1beta1ObjectTrackingConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Videos will be cut to smaller clips to make it easier for labelers to work on. Users can configure is field
        /// in seconds, if not set, default value is 20s.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clipLength")]
        public virtual System.Nullable<int> ClipLength { get; set; }
    ...
    public class GoogleCloudDatalabelingV1beta1OperatorMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Confidence score corresponding to a label. For examle, if 3 contributors have answered the question and 2 of
        /// them agree on the final label, the confidence score will be 0.67 (2/3).
        /// </summary>
    ...
    {
        /// <summary>
        /// The annotation spec of the label for which the precision-recall curve calculated. If this field is empty,
        /// that means the precision-recall curve is an aggregate curve for all labels.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("annotationSpec")]
        public virtual GoogleCloudDatalabelingV1beta1AnnotationSpec AnnotationSpec { get; set; }
    ...
    {
        /// <summary>
        /// If set to true, contributors will have the option to select sentiment of the label they selected, to mark it
    ...
    {
        /// <summary>
        /// Optional. If allow_multi_label is true, contributors are able to choose multiple labels for one text
        /// segment.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("allowMultiLabel")]
        public virtual System.Nullable<bool> AllowMultiLabel { get; set; }
        ...
        /// <summary>
        /// Optional. Configs for sentiment selection. We deprecate sentiment analysis in data labeling side as it is
    ...
    {
        /// <summary>
        /// The language of this text, as a [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt). Default value is
        /// en-US.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("languageCode")]
        public virtual string LanguageCode { get; set; }
    ...
    /// 1. Assign labels on the entire video. 2. Split the video into multiple video clips based on camera shot, and
    ...
    {
        /// <summary>
        /// Required. The list of annotation spec set configs. Since watching a video clip takes much longer time than
        /// an image, we support label with multiple AnnotationSpecSet at the same time. Labels in each
        /// AnnotationSpecSet will be shown in a group to contributors. Contributors can select one or more (depending
        /// on whether to allow multi label) from each group.
        /// </summary>
    ...
    public class GoogleCloudDatalabelingV1beta1VideoThumbnail : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Time offset relative to the beginning of the video, corresponding to the video frame where the thumbnail has
        /// been extracted from.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("timeOffset")]
        public virtual object TimeOffset { get; set; }
