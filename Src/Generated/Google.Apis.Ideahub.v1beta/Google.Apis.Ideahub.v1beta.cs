    ...
    public class PlatformsResource
    {
        ...
        public class PropertiesResource
        {
            ...
            public class IdeaActivitiesResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaActivity body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }

                /// <summary>Creates an idea activity entry.</summary>
                public class CreateRequest : IdeahubBaseServiceRequest<Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaActivity>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaActivity body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaActivity Body { get; set; }
                    ...
                    public override string RestPath => "v1beta/{+parent}/ideaActivities";
            ...
            public class IdeaStatesResource
            {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaState body, string name)
                {
                    return new PatchRequest(service, body, name);
                }

                /// <summary>Update an idea state resource.</summary>
                public class PatchRequest : IdeahubBaseServiceRequest<Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaState>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaState body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaIdeaState Body { get; set; }
            ...
            public class IdeasResource
            {
                ...
                /// <summary>List ideas for a given Creator and filter and sort options.</summary>
                public class ListRequest : IdeahubBaseServiceRequest<Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaListIdeasResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/ideas";
            ...
            public class LocalesResource
            {
                ...
                /// <summary>Returns which locales ideas are available in for a given Creator.</summary>
                public class ListRequest : IdeahubBaseServiceRequest<Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaListAvailableLocalesResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta/{+parent}/locales";
            ...
            public class TopicStatesResource
            {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaTopicState body, string name)
                {
                    return new PatchRequest(service, body, name);
                }

                /// <summary>Update a topic state resource.</summary>
                public class PatchRequest : IdeahubBaseServiceRequest<Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaTopicState>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaTopicState body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Ideahub.v1beta.Data.GoogleSearchIdeahubV1betaTopicState Body { get; set; }
...
namespace Google.Apis.Ideahub.v1beta.Data
{
    ...
    public class GoogleSearchIdeahubV1betaAvailableLocale : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleSearchIdeahubV1betaIdea : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<GoogleSearchIdeahubV1betaTopic> Topics { get; set; }
    ...
    public class GoogleSearchIdeahubV1betaIdeaActivity : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleSearchIdeahubV1betaIdeaState : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    /// user.
    /// </summary>
    public class GoogleSearchIdeahubV1betaListAvailableLocalesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<GoogleSearchIdeahubV1betaAvailableLocale> AvailableLocales { get; set; }
    ...
    public class GoogleSearchIdeahubV1betaListIdeasResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Results for the ListIdeasRequest.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ideas")]
        public virtual System.Collections.Generic.IList<GoogleSearchIdeahubV1betaIdea> Ideas { get; set; }
    ...
    public class GoogleSearchIdeahubV1betaTopic : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleSearchIdeahubV1betaTopicState : Google.Apis.Requests.IDirectResponseSchema
    {
