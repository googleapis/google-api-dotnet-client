...
namespace Google.Apis.CloudMachineLearningEngine.v1
{
    ...
    public class CloudMachineLearningEngineService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scope constants for use with the Cloud Machine Learning Engine.</summary>
...
{    
    ...
    public class GoogleCloudMlV1HyperparameterSpec : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. How many failed trials that need to be seen before failing the hyperparameter tuning job.
        /// User can specify this field to override the default failing criteria for CloudML Engine hyperparameter
        /// tuning jobs.
        ///
        /// Defaults to zero, which means to let the service decide when a hyperparameter job should fail.</summary>
