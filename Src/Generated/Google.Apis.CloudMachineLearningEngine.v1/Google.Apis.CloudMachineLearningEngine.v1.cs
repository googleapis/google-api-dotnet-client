...
/**
 * \brief
 *   Cloud Machine Learning Engine Version v1
 *
 ...
 *
 * The complete API documentation for using Cloud Machine Learning Engine can be found at
...
namespace Google.Apis.CloudMachineLearningEngine.v1
{
    ...
    public class CloudMachineLearningEngineService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scopes for use with the Cloud Machine Learning Engine.</summary>
        public class Scope
        {
...
{    
    ...
    /// <summary>Represents a hardware accelerator request config.</summary>
    ...
    {
        /// <summary>Optional. The type and number of accelerators to be attached to each machine running the
        /// job.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("accelerator")]
        public virtual GoogleCloudMlV1AcceleratorConfig Accelerator { get; set; } 
    ...
    public class GoogleCloudMlV1TrainingInput : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// will choose a stable version, which is defined in the documentation of runtime version list.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("runtimeVersion")]
        public virtual string RuntimeVersion { get; set; } 
    ...
    public class GoogleCloudMlV1Version : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Valid values are `TENSORFLOW`, `SCIKIT_LEARN`, and `XGBOOST`. If you do not specify a framework, Cloud ML
        /// Engine uses TensorFlow. If you choose `SCIKIT_LEARN` or `XGBOOST`, you must also set the runtime version of
        /// the model to 1.4 or greater.</summary>
