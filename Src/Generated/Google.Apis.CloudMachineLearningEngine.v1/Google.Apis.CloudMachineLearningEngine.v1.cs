...
/**
 * \brief
 *   AI Platform Training & Prediction API Version v1
 *
 ...
 *
 * The complete API documentation for using AI Platform Training & Prediction API can be found at
...
namespace Google.Apis.CloudMachineLearningEngine.v1
{
    ...
    public class CloudMachineLearningEngineService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://ml.googleapis.com/"; }
        #else
    ...
    public class ProjectsResource
    {
        ...
        public class ModelsResource
        {
            ...
            public class VersionsResource
            {
                ...
                ///
                /// Currently the only update-able fields are `description` and `autoScaling.minNodes`.</summary>
                /// <param name="body">The body of the request.</param>
        ...
        /// top of an HTTP POST method. For details of the request and response format, see the **guide to the [explain
        /// request format](/ml-engine/docs/v1/explain-request)**.</summary>
        /// <param name="body">The body of the request.</param>
...
{    
    ...
    /// <summary>Message holding configuration options for explaining model predictions. Currently, the only supported
    /// mechanism to explain a model's prediction is through attributing its output back to its inputs which is
    /// essentially a credit assignment task. We support multiple attribution methods, some specific to particular
    /// frameworks like Tensorflow and XGBoost. Next idx: 7.</summary>
    ...
    public class GoogleCloudMlV1Version : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Configures the request-response pair logging on predictions from this Version.</summary>
