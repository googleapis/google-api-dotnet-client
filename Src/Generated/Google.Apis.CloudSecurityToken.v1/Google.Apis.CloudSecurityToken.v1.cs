...
namespace Google.Apis.CloudSecurityToken.v1.Data
{
    ...
    public class GoogleIdentityStsV1ExchangeTokenRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// signing key securing the JWT. - `alg`: The cryptographic algorithm securing the JWT. Must be `RS256` or
        /// `ES256`. The following payload fields are required. For more information, see [RFC 7523, Section
