            ...
            public class DatasetsResource
            {
                ...
                public class AnnotationStoresResource
                {
                    ...
                    public class AnnotationsResource
                    {
                        ...
                        /// <summary>
                        /// Creates a new Annotation record. It is valid to create Annotation objects for the same
                        /// source more than once since a unique ID is assigned to each record by this service.
                        /// </summary>
                        ...
                        public class ListRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.ListAnnotationsResponse>
                        {
                            ...
                            /// <summary>
                            /// Limit on the number of Annotations to return in a single response. If not specified, 100
                    ...
                    public class ListRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.ListAnnotationStoresResponse>
                    {
                        ...
                        /// <summary>
                        /// Limit on the number of Annotation stores to return in a single response. If not specified,
                ...
                public class FhirStoresResource
                {
                    ...
                    public class FhirResource
                    {
                        ...
                        public class ConceptMapSearchTranslateRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.HttpBody>
                        {
                            ...
                            /// <summary>
                            /// The source value set of the concept map to be used. If unset, target is used to search
                            /// for concept maps.
                            /// </summary>
                            ...
                            /// <summary>
                            /// The target value set of the concept map to be used. If unset, source is used to search
                            /// for concept maps.
                            /// </summary>
                            ...
                            /// <summary>
                            /// The canonical url of the concept map to use. If unset, the source and target is used to
                        ...
                        /// containing the results of the operation. Errors generated by the FHIR store contain a
                        ...
                        /// mapped to a valid API method on a FHIR store, a generic GCP error might be returned instead.
                        /// </summary>
                        public class ResourceValidateRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.HttpBody>
                        {
                            /// <summary>Constructs a new ResourceValidate request.</summary>
                            public ResourceValidateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudHealthcare.v1beta1.Data.HttpBody body, string parent, string type) : base(service)
                            {
                                Parent = parent;
                                Type = type;
                                Body = body;
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta1/{+parent}/fhir/{+type}/$validate";
                        ...
                        /// resource path recorded in Cloud audit logs and Cloud Pub/Sub notifications. Those IDs can
                        /// also be contained in reference fields within other resources. If the search criteria
                        /// identify zero matches, and the supplied resource body does not contain an `id`, the resource
                        /// is created with a server-assigned ID as per the create method. The request body must contain
                        ...
                        /// a generic GCP error might be returned instead. This method requires permission for executing
                        /// the requests in the bundle. The `executeBundle` permission grants permission to execute the
                        ...
                        /// [R4](https://hl7.org/implement/standards/fhir/R4/search.html)). Supports four methods of
                        ...
                        public class SearchTypeRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.HttpBody>
                        {
                            ...
                            public SearchTypeRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudHealthcare.v1beta1.Data.SearchResourcesRequest body, string parent, string resourceType) : base(service)
                            {
                                Parent = parent;
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta1/{+parent}/fhir/{resourceType}/_search";
                    ...
                    /// The location and format of the input data are specified by the parameters in
                ...
                public class Hl7V2StoresResource
                {
                    ...
                    public class MessagesResource
                    {
                        ...
                        /// <summary>Gets multiple messages in the given HL7v2 store.</summary>
                        public class BatchGetRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.BatchGetMessagesResponse>
                        {
                            ...
                            /// <summary>
                            /// The resource id of the HL7v2 messages to retrieve in the format: `{message_id}`, where
                            /// the full resource name is `{parent}/messages/{message_id}` A maximum of 100 messages can
                            ...
                            {
                                /// <summary>
                                /// Not specified, equivalent to FULL for getMessage, equivalent to BASIC for
                                /// listMessages.
                                /// </summary>
                            ...
                            /// <summary>Gets the REST path.</summary>
                            public override string RestPath => "v1beta1/{+parent}/messages:batchGet";
                        ...
                        public class ListRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.ListMessagesResponse>
                        {
                            ...
                            /// `send_facility = "ABC"`. * `PatientId(value, type)`, which matches if the message lists
                            /// a patient having an ID of the given value and type in the PID-2, PID-3, or PID-4
                            /// segments. For example, `PatientId("123456", "MRN")`. * `labels.x`, a string value of the
                        ...
                        /// contents such as Message.create_time can't be altered. Only the Message.labels field is
                    ...
                    /// the error field, errors are also logged to Cloud Logging (see [Viewing
                ...
                /// is OperationMetadata. If the request is successful, the response field type is DeidentifySummary.
                /// The LRO result may still be successful if de-identification fails for some resources. The new
                /// de-identified dataset will not contain these failed resources. The number of resources processed are
                /// tracked in Operation.metadata. Error details are logged to Cloud Logging. For more information, see
...
namespace Google.Apis.CloudHealthcare.v1beta1.Data
{
    ...
    public class Annotation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Additional information for this annotation record, such as annotator and verifier information or study
        /// campaign.
        /// </summary>
    ...
    {
        /// <summary>
        /// Optional. User-supplied key-value pairs used to organize Annotation stores. Label keys must be between 1 and
        /// 63 characters long, have a UTF-8 encoding of maximum 128 bytes, and must conform to the following PCRE
        /// regular expression: \p{Ll}\p{Lo}{0,62} Label values must be between 1 and 63 characters long, have a UTF-8
    ...
    public class Attribute : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The value of the attribute. Must be an acceptable value as defined in the consent store. For example, if the
        /// consent store defines "data type" with acceptable values "questionnaire" and "step-count", when the
        /// attribute name is data type, this field must contain one of those values.
        /// </summary>
    ...
    /// <summary>Gets multiple messages in a specified HL7v2 store.</summary>
    public class BatchGetMessagesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The returned Messages. See `MessageView` for populated fields.</summary>
    ...
    {
        /// <summary>
        /// Configures how annotations, meaning that the location and infoType of sensitive information findings, are
        /// created during de-identification. If unspecified, no annotations are created.
        /// </summary>
    ...
    public class DicomStore : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A list of streaming configs used to configure the destination of streaming exports for every DICOM instance
        /// insertion in this DICOM store. After a new config is added to `stream_configs`, DICOM instance insertions
        /// are streamed to the new destination. When a config is removed from `stream_configs`, the server stops
        /// streaming to that destination. Each config must contain a unique destination.
        /// </summary>
    ...
    /// <summary>
    /// Response for successful Annotation store evaluation operations. This structure is included in the response upon
    ...
    /// <summary>
    /// Request to export Annotations. The export operation is not atomic. If a failure occurs, any annotations already
    ...
    /// <summary>
    /// Response for successful annotation export operations. This structure is included in response upon operation
    /// completion.
    /// </summary>
    ...
    public class FhirConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// passed through to the output dataset unmodified. All extensions are removed in the output. If a field can be
        /// matched by more than one FieldMetadata, the first FieldMetadata.Action is applied.
        /// </summary>
    ...
    public class FieldMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// supports partial matching. For example, "Patient.Address.city" can be matched by "Address.city" (Patient
        ...
        /// types are: AdministrativeGenderCode, Code, Date, DateTime, Decimal, HumanName, Id, LanguageCode, Markdown,
        /// Oid, String, Uri, Uuid, Xhtml. The sub-type for HumanName, such as HumanName.given or HumanName.family, can
        /// be omitted.
        /// </summary>
    ...
    public class Finding : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The snippet of the sensitive text. This field is only populated during deidentification if `store_quote` is
    ...
    {
        /// <summary>
        /// The Cloud Storage destination to export to. URI for a Cloud Storage directory where the server writes result
        /// files, in the format `gs://{bucket-id}/{path/to/destination/dir}`. If there is no trailing slash, the
        /// service appends one when composing the object path. The user is responsible for creating the Cloud Storage
    ...
    public class GoogleCloudHealthcareV1beta1AnnotationGcsSource : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// the specified directory and its sub-directories. For example, `gs://my-bucket/my-directory/**.json` imports
        /// all files with .json extensions in `my-directory/` and its sub-directories. '?' to match 1 character All
    ...
    public class GoogleCloudHealthcareV1beta1DicomStreamConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Cloud Logging (see [Viewing logs](/healthcare/docs/how- [Viewing logs](/healthcare/docs/how-tos/logging)).
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bigqueryDestination")]
        public virtual GoogleCloudHealthcareV1beta1DicomBigQueryDestination BigqueryDestination { get; set; }
    ...
    public class Hl7V2NotificationConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// segment. For example, `send_time &amp;lt; "2017-01-02T00:00:00-05:00"`. * `send_facility`, the care center
        /// that the message came from, from the MSH-4 segment. For example, `send_facility = "ABC"`. *
    ...
    public class Hl7V2Store : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The notification destination all messages (both Ingest &amp;amp; Create) are published on. Only the message
    ...
    /// <summary>
    /// Request to import Annotations. The Annotations to be imported must have client-supplied resource names which
    /// indicate the annotation resource. The import operation is not atomic. If a failure occurs, any annotations
    ...
    /// <summary>
    /// Final response of importing Annotations in successful case. This structure is included in the response. It is
    ...
    public class ImportResourcesRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Cloud Storage source data location and import configuration. The Cloud Healthcare Service Agent requires the
        /// `roles/storage.objectViewer` Cloud IAM roles on the Cloud Storage location. The Healthcare Service Agent
    ...
    public class InfoTypeConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// If `TRUE`, infoTypes described by `filter` are used for evaluation. Otherwise, infoTypes are not considered
        /// for evaluation. For example: * Annotated text: "Toronto is a location" * Finding 1: `{"infoType": "PERSON",
        /// "quote": "Toronto", "start": 0, "end": 7}` * Finding 2: `{"infoType": "CITY", "quote": "Toronto", "start":
        /// 0, "end": 7}` * Finding 3: `{}` * Ground truth: `{"infoType": "LOCATION", "quote": "Toronto", "start": 0,
        /// "end": 7}` When `strict_matching` is `TRUE`: * Finding 1: 1 false positive * Finding 2: 1 false positive *
        /// Finding 3: 1 false negative When `strict_matching` is `FALSE`: * Finding 1: 1 true positive * Finding 2: 1
    ...
    {
        /// <summary>
        /// Maps from a resource slice. For example, FHIR resource field path to a set of sensitive text findings. For
        /// example, Appointment.Narrative text1 --&amp;gt; {findings_1, findings_2, findings_3}
        /// </summary>
    ...
    public class StreamConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// given resource type, the server attempts to create one. When a table schema doesn't align with the schema
        /// config, either because of existing incompatible schema or out of band incompatible modification, the server
        /// does not stream in new data. One resolution in this case is to delete the incompatible table and let the
        /// server recreate one, though the newly created table only contains data after the table recreation. BigQuery
        /// imposes a 1 MB limit on streaming insert row size, therefore any resource mutation that generates more than
        /// 1 MB of BigQuery data will not be streamed. Results are appended to the corresponding BigQuery tables.
        ...
        /// duplicates. If a resource mutation cannot be streamed to BigQuery, errors will be logged to Cloud Logging
