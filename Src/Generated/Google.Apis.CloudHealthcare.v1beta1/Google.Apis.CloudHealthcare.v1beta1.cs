...
namespace Google.Apis.CloudHealthcare.v1beta1.Data
{
    ...
    public class Hl7V2NotificationConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// segment. For example, `send_time &amp;lt; "2017-01-02T00:00:00-05:00"`. * `create_time`, the timestamp when
        /// the message was created in the HL7v2 store. Use the RFC3339 time format for comparisons. For example,
        /// `create_time &amp;lt; "2017-01-02T00:00:00-05:00"`. * `send_facility`, the care center that the message came
        /// from, from the MSH-4 segment. For example, `send_facility = "ABC"`. * `PatientId(value, type)`, which
