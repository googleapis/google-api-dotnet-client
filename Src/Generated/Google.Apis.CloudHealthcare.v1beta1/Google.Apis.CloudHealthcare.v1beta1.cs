        ...
        public class LocationsResource
        {
            ...
            public class DatasetsResource
            {
                ...
                public class DicomStoresResource
                {
                    ...
                    /// <summary>Exports data to the specified destination by copying it from the DICOM store. The
                ...
                public class Hl7V2StoresResource
                {
                    ...
                    public class MessagesResource
                    {
                        ...
                        public class ListRequest : CloudHealthcareBaseServiceRequest<Google.Apis.CloudHealthcare.v1beta1.Data.ListMessagesResponse>
                        {
                            ...
                            /// "MRN") AND PatientId("456789", "MRN")`. *  Conjunction of multiple labels fields is also
                            /// not supported, for example this query is invalid: `labels."tag1":* AND
                            /// labels."tag2"="val2"`. *  Conjunction of one patient ID function, one labels field and
                            /// conditions on other fields is supported. For example, this query is valid:
                            /// `PatientId("123456", "MRN") AND labels."tag1":* AND message_type = "ADT"`.</summary>
                            [Google.Apis.Util.RequestParameterAttribute("filter", Google.Apis.Util.RequestParameterType.Query)]
                            public virtual string Filter { get; set; }
                ...
                /// DeidentifySummary. If errors occur, error details field type is DeidentifyErrorDetails. Errors are
                /// also logged to Stackdriver Logging. For more information, see [Viewing logs](/healthcare/docs/how-
                /// tos/stackdriver-logging).</summary>
                /// <param name="body">The body of the request.</param>
