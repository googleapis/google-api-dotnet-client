...
namespace Google.Apis.Apigateway.v1beta.Data
{
    ...
    public class ApigatewayBackendConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// This may either be the Service Account's email (i.e. "{ACCOUNT_ID}@{PROJECT}.iam.gserviceaccount.com") or
        /// its full resource name (i.e. "projects/{PROJECT}/accounts/{UNIQUE_ID}"). This is most often used when the
        /// backend is a GCP resource such as a Cloud Run Service or an IAP-secured service. Note that this token is
        /// always sent as an authorization header bearer token. The audience of the OIDC token is configured in the
