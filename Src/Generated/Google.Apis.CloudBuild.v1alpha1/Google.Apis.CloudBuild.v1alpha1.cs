    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.CloudBuild.v1alpha1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1alpha1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.CloudBuild.v1alpha1.Data.CancelOperationRequest Body { get; set; }
        ...
        public class WorkerPoolsResource
        {
            ...
            public class CreateRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha1.Data.WorkerPool>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1alpha1.Data.WorkerPool body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v1alpha1/{+parent}/workerPools";
            ...
            public class PatchRequest : CloudBuildBaseServiceRequest<Google.Apis.CloudBuild.v1alpha1.Data.WorkerPool>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudBuild.v1alpha1.Data.WorkerPool body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
...
namespace Google.Apis.CloudBuild.v1alpha1.Data
{
    ...
    public class Network : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Project id containing the defined network and subnetwork. For a peered VPC, this will be the same as the
        /// project_id in which the workers are created. For a shared VPC, this will be the project sharing the network
        /// with the project_id project in which workers will be created. For custom workers with no VPC, this will be
        /// the same as project_id.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("projectId")]
        public virtual string ProjectId { get; set; }
    ...
    public class WorkerConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// specified, Cloud Build will use a standard disk size. `disk_size` is overridden if you specify a different
        /// disk size in `build_options`. In this case, a VM with a disk size specified in the `build_options` will be
        ...
        /// is overridden if you specify a different machine type in `build_options`. In this case, the VM specified in
        /// the `build_options` will be created on demand at build time. For more information see
        ...
        /// <summary>
        /// The network definition used to create the worker. If this section is left empty, the workers will be created
        /// in WorkerPool.project_id on the default network.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("network")]
    ...
    public class WorkerPool : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// List of regions to create the `WorkerPool`. Regions can't be empty. If Cloud Build adds a new GCP region in
        /// the future, the existing `WorkerPool` will not be enabled in the new region automatically; you must add the
        /// new region to the `regions` field to enable the `WorkerPool` in that region.
        /// </summary>
