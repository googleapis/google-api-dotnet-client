...
/**
 * \brief
 *   Service Management API Version v1
 *
 ...
 *
 * The complete API documentation for using Service Management API can be found at
...
namespace Google.Apis.ServiceManagement.v1
{
    ...
    public class ServiceManagementService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://servicemanagement.googleapis.com/"; }
        #else
    ...
    public class ServicesResource
    {
        ...
        public class RolloutsResource
        {
            ...
            public class CreateRequest : ServiceManagementBaseServiceRequest<Google.Apis.ServiceManagement.v1.Data.Operation>
            {
                ...
                /// <summary>Unimplemented. Do not use this feature until this comment is removed.
                ///
                ...
                /// when server receives the request, request will be rejected for safety.</summary>
                [Google.Apis.Util.RequestParameterAttribute("baseRolloutId", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string BaseRolloutId { get; set; }
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add(
                        "baseRolloutId", new Google.Apis.Discovery.Parameter
                        {
                            Name = "baseRolloutId",
                            IsRequired = false,
                            ParameterType = "query",
