...
namespace Google.Apis.Cloudbilling.v1
{
    ...
    public class BillingAccountsResource
    {
        ...
        public class GetIamPolicyRequest : CloudbillingBaseServiceRequest<Google.Apis.Cloudbilling.v1.Data.Policy>
        {
            ...
            /// invalid value will be rejected. Requests for policies with any conditional bindings must specify version
            /// 3. Policies without any conditional bindings may specify any valid value or leave the field unset. To
