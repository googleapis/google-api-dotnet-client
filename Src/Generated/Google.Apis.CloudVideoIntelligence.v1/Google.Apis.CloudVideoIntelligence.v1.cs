...
namespace Google.Apis.CloudVideoIntelligence.v1
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            {
                this.service = service;
                Corpora = new CorporaResource(service);
                Corpura = new CorpuraResource(service);
                Operations = new OperationsResource(service);

            }

            /// <summary>Gets the Corpora resource.</summary>
            public virtual CorporaResource Corpora { get; }

            /// <summary>The "corpora" collection of methods.</summary>
            public class CorporaResource
            {
                private const string Resource = "corpora";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public CorporaResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                    Operations = new OperationsResource(service);
            ...
            public virtual CorpuraResource Corpura { get; }
            ...
            public class OperationsResource
            {
                ...
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudVideoIntelligence.v1.Data.GoogleLongrunningCancelOperationRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
    ...
    public class VideosResource
    {
        ...
        public class AnnotateRequest : CloudVideoIntelligenceBaseServiceRequest<Google.Apis.CloudVideoIntelligence.v1.Data.GoogleLongrunningOperation>
        {
            ...
            public AnnotateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudVideoIntelligence.v1.Data.GoogleCloudVideointelligenceV1AnnotateVideoRequest body)
                : base(service)
            {
                Body = body;
                InitParameters();
