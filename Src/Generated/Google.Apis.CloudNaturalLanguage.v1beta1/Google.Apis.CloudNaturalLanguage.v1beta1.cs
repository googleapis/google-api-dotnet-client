...
namespace Google.Apis.CloudNaturalLanguage.v1beta1
{
    ...
    public class DocumentsResource
    {
        ...
        public class AnalyzeEntitiesRequest : CloudNaturalLanguageBaseServiceRequest<Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnalyzeEntitiesResponse>
        {
            ...
            public AnalyzeEntitiesRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnalyzeEntitiesRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            public override string RestPath => "v1beta1/documents:analyzeEntities";
        ...
        public class AnalyzeSentimentRequest : CloudNaturalLanguageBaseServiceRequest<Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnalyzeSentimentResponse>
        {
            ...
            public AnalyzeSentimentRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnalyzeSentimentRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1beta1/documents:analyzeSentiment";
        ...
        public class AnalyzeSyntaxRequest : CloudNaturalLanguageBaseServiceRequest<Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnalyzeSyntaxResponse>
        {
            ...
            public AnalyzeSyntaxRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnalyzeSyntaxRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1beta1/documents:analyzeSyntax";
        ...
        public class AnnotateTextRequest : CloudNaturalLanguageBaseServiceRequest<Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnnotateTextResponse>
        {
            ...
            public AnnotateTextRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudNaturalLanguage.v1beta1.Data.AnnotateTextRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1beta1/documents:annotateText";
...
namespace Google.Apis.CloudNaturalLanguage.v1beta1.Data
{
    ...
    public class Entity : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Metadata associated with the entity. Currently, Wikipedia URLs and Knowledge Graph MIDs are provided, if
    ...
    public class Sentiment : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// DEPRECATED FIELD - This field is being deprecated in favor of score. Please refer to our documentation at
