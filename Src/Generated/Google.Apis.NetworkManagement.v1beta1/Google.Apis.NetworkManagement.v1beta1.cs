    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class VpcFlowLogsConfigsResource
            {
                ...
                /// <summary>
                /// Creates a new VPC Flow Logs configuration. If a configuration with the exact same settings already
                ...
                /// <summary>Deletes a specific VpcFlowLog configuration.</summary>
                /// <param name="name">
                /// Required. VpcFlowLogsConfig name using the form:
                ...
                /// <summary>Gets the details of a specific VPC Flow Log configuration.</summary>
                /// <param name="name">
                /// Required. `VpcFlowLog` resource name using the form:
                /// `projects/{project_id}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_config}`
                /// </param>
                public virtual GetRequest Get(string name)
                {
                ...
                /// <summary>Lists all VPC Flow Logs configurations in a given project.</summary>
                /// <param name="parent">
                ...
                public class ListRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.ListVpcFlowLogsConfigsResponse>
                {
                    ...
                    /// <summary>
                    /// Optional. Lists the `VpcFlowLogsConfig`s that match the filter expression. A filter expression
                    /// filters the resources listed in the response. The expression must be of the form ` ` where
                    /// operators: `&amp;lt;`, `&amp;gt;`, `&amp;lt;=`, `&amp;gt;=`, `!=`, `=`, `:` are supported (colon
                    /// `:` represents a HAS operator which is roughly synonymous with equality). can refer to a proto
                    /// or JSON field, or a synthetic field. Field names can be camelCase or snake_case. Examples: -
                    /// Filter by name: name = "projects/proj-1/locations/global/vpcFlowLogsConfigs/config-1 - Filter by
                    /// target resource: - Configurations at the VPC network level target_resource.network:* -
                    /// Configurations for a VPC network called `vpc-1` target_resource.network = vpc-1
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("filter", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string Filter { get; set; }
                    ...
                    /// <summary>Optional. Number of `VpcFlowLogsConfig`s to return.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }
...
namespace Google.Apis.NetworkManagement.v1beta1.Data
{
    ...
    public class VpcFlowLogsConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. The value of the field must be in [0, 1]. The sampling rate of VPC flow logs within the subnetwork
        /// where 1.0 means all collected logs are reported and 0.0 means no logs are reported. Default value is 1.0.
        /// </summary>
        ...
        /// <summary>Optional. The state of the VPC Flow Log. Default value is ENABLED.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; }
