...
namespace Google.Apis.NetworkManagement.v1beta1
{
    ...
    public class NetworkManagementService : Google.Apis.Services.BaseClientService
    {
        ...
        public NetworkManagementService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class NetworkManagementBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected NetworkManagementBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
        ...
        public class LocationsResource
        {
            ...
            public class GlobalResource
            {
                ...
                public class ConnectivityTestsResource
                {
                    ...
                    /// <param name="parent">Required. The parent resource of the Connectivity Test to create:
                    ...
                    public class CreateRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.Operation>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1beta1.Data.ConnectivityTest body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                        ...
                        /// <summary>Required. The parent resource of the Connectivity Test to create:
                        ...
                        protected override void InitParameters()
                        {
                            ...
                            RequestParameters.Add(
                                "testId", new Google.Apis.Discovery.Parameter
                                {
                                    Name = "testId",
                                    IsRequired = false,
                                    ParameterType = "query",
                    ...
                    /// <param name="name">Required. `ConnectivityTest` resource name using the form:
                    /// `projects/{project_id}/locations/global/connectivityTests/{test_id}`</param>
                    ...
                    public class GetRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.ConnectivityTest>
                    {
                        ...
                        /// <summary>Required. `ConnectivityTest` resource name using the form:
                        /// `projects/{project_id}/locations/global/connectivityTests/{test_id}`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    /// <param name="parent">Required. The parent resource of the Connectivity Tests:
                    /// `projects/{project_id}/locations/global`</param>
                    ...
                    public class ListRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.ListConnectivityTestsResponse>
                    {
                        ...
                        /// <summary>Required. The parent resource of the Connectivity Tests:
                        /// `projects/{project_id}/locations/global`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }
                    ...
                    public class PatchRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.Operation>
                    {
                        ...
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1beta1.Data.ConnectivityTest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    public class RerunRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.Operation>
                    {
                        ...
                        public RerunRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1beta1.Data.RerunConnectivityTestRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    public class SetIamPolicyRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.Policy>
                    {
                        ...
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1beta1.Data.SetIamPolicyRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                    ...
                    public class TestIamPermissionsRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.TestIamPermissionsResponse>
                    {
                        ...
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                ...
                public class OperationsResource
                {
                    ...
                    public class CancelRequest : NetworkManagementBaseServiceRequest<Google.Apis.NetworkManagement.v1beta1.Data.Empty>
                    {
                        ...
                        public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.NetworkManagement.v1beta1.Data.CancelOperationRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
...
{    
    ...
    public class Endpoint : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// IP address is specified, and the IP address is within a GCP project. 2. When you are using Shared VPC and
    ...
    /// <summary>For display only. The specification of the endpoints for the test. EndpointInfo is derived from source
    /// and destination Endpoint and validated by the backend data plane model.</summary>
    ...
    /// <summary>A simulated forwarding path is composed of multiple steps. Each step has a well-defined state and an
    /// associated configuration.</summary>
