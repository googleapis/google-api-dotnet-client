...
namespace Google.Apis.ToolResults.v1beta3
{
    ...
    public class ToolResultsService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://toolresults.googleapis.com/";
    ...
    public class ProjectsResource
    {
        ...
        public class HistoriesResource
        {
            ...
            public class ExecutionsResource
            {
                ...
                public class EnvironmentsResource
                {
                    ...
                    public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListEnvironmentsResponse>
                    {
                        ...
                        /// <summary>
                        /// The maximum number of Environments to fetch. Default value: 25. The server will use this
                ...
                public class StepsResource
                {
                    ...
                    public class PerfMetricsSummaryResource
                    {
                        ...
                        /// <summary>
                        /// Creates a PerfMetricsSummary resource. Returns the existing one if it has already been
                        /// created. May return any of the following error code(s): - NOT_FOUND - The containing Step
                        /// does not exist
                        /// </summary>
                    ...
                    public class PerfSampleSeriesResource
                    {
                        ...
                        public class SamplesResource
                        {
                            ...
                            /// <summary>
                            /// Creates a batch of PerfSamples - a client can submit multiple batches of Perf Samples
                            /// through repeated calls to this method in order to split up a large request payload -
                            /// duplicates and existing timestamp entries will be ignored. - the batch operation may
                            /// partially succeed - the set of elements successfully inserted is returned in the
                            /// response (omits items which already existed in the database). May return any of the
                            /// following canonical error codes: - NOT_FOUND - The containing PerfSampleSeries does not
                            /// exist
                            /// </summary>
                            /// <param name="body">The body of the request.</param>
                            /// <param name="projectId">The cloud project</param>
                            ...
                            /// timestamps ascending - The default page size is 500 samples; and maximum size allowed
                            /// 5000 - The response token indicates the last returned PerfSample timestamp - When the
                            /// results size exceeds the page size, submit a subsequent request including the page token
                            /// to return the rest of the samples up to the page limit May return any of the following
                            /// canonical error codes: - OUT_OF_RANGE - The specified request page_token is out of valid
                            /// range - NOT_FOUND - The containing PerfSampleSeries does not exist
                            /// </summary>
                            /// <param name="projectId">The cloud project</param>
                            /// <param name="historyId">A tool results history ID.</param>
                            /// <param name="executionId">A tool results execution ID.</param>
                            ...
                            public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListPerfSamplesResponse>
                            {
                                ...
                                /// <summary>
                                /// The default page size is 500 samples, and the maximum size is 5000. If the page_size
                        ...
                        /// - PerfMetricSummary already exists for the given Step - NOT_FOUND - The containing Step does
                        /// not exist
                        /// </summary>
                        /// <param name="body">The body of the request.</param>
                        /// <param name="projectId">The cloud project</param>
                        ...
                        /// resulting PerfSampleSeries are sorted by ids. May return any of the following canonical
                    ...
                    public class TestCasesResource
                    {
                        ...
                        /// <summary>
                        /// Lists Test Cases attached to a Step. Experimental test cases API. Still in active
                        /// development. May return any of the following canonical error codes: - PERMISSION_DENIED - if
                        /// the user is not authorized to write to project - INVALID_ARGUMENT - if the request is
                        ...
                        public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListTestCasesResponse>
                        {
                            ...
                            /// <summary>
                            /// The maximum number of TestCases to fetch. Default value: 100. The server will use this
                    ...
                    public class ThumbnailsResource
                    {
                        ...
                        /// <summary>
                        /// Lists thumbnails of images attached to a step. May return any of the following canonical
                        /// error codes: - PERMISSION_DENIED - if the user is not authorized to read from the project,
                        /// or from any of the images - INVALID_ARGUMENT - if the request is malformed - NOT_FOUND - if
                        /// the step does not exist, or if any of the images do not exist
                        /// </summary>
                        /// <param name="projectId">A Project id. Required.</param>
                        /// <param name="historyId">A History id. Required.</param>
                        /// <param name="executionId">An Execution id. Required.</param>
                        ...
                        public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListStepThumbnailsResponse>
                        {
                            ...
                            /// <summary>
                            /// The maximum number of thumbnails to fetch. Default value: 50. The server will use this
                            /// default if the field is not set or has a value of 0. Optional.
                            /// </summary>
                            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                            public virtual System.Nullable<int> PageSize { get; set; }
                    ...
                    public class AccessibilityClustersRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListStepAccessibilityClustersResponse>
                    {
                        ...
                        /// <summary>
                        /// The accepted format is the canonical Unicode format with hyphen as a delimiter. Language
                        /// must be lowercase, Language Script - Capitalized, Region - UPPERCASE. See
                    ...
                    public class CreateRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.Step>
                    {
                        ...
                        /// <summary>
                        /// A unique request ID for server to detect duplicated requests. For example, a UUID. Optional,
                    ...
                    /// the following canonical error codes: - PERMISSION_DENIED - if the user is not authorized to read
                    ...
                    public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListStepsResponse>
                    {
                        ...
                        /// <summary>
                        /// The maximum number of Steps to fetch. Default value: 25. The server will use this default if
                ...
                /// <summary>
                /// Creates an Execution. The returned Execution will have the id set. May return any of the following
                /// canonical error codes: - PERMISSION_DENIED - if the user is not authorized to write to project -
                /// INVALID_ARGUMENT - if the request is malformed - NOT_FOUND - if the containing History does not
                /// exist
                /// </summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="projectId">A Project id. Required.</param>
                ...
                /// <summary>
                /// Gets an Execution. May return any of the following canonical error codes: - PERMISSION_DENIED - if
                ...
                public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListExecutionsResponse>
                {
                    ...
                    /// <summary>
                    /// The maximum number of Executions to fetch. Default value: 25. The server will use this default
                    /// if the field is not set or has a value of 0. Optional.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }
            ...
            /// <summary>
            /// Creates a History. The returned History will have the id set. May return any of the following canonical
            ...
            /// <summary>
            /// Gets a History. May return any of the following canonical error codes: - PERMISSION_DENIED - if the user
            /// is not authorized to read project - INVALID_ARGUMENT - if the request is malformed - NOT_FOUND - if the
            ...
            /// <summary>
            /// Lists Histories for a given Project. The histories are sorted by modification time in descending order.
            /// The history_id key will be used to order the history with the same modification time. May return any of
            /// the following canonical error codes: - PERMISSION_DENIED - if the user is not authorized to read project
            ...
            public class ListRequest : ToolResultsBaseServiceRequest<Google.Apis.ToolResults.v1beta3.Data.ListHistoriesResponse>
            {
                ...
                /// <summary>
                /// The maximum number of Histories to fetch. Default value: 20. The server will use this default if the
                /// field is not set or has a value of 0. Any value greater than 100 will be treated as 100. Optional.
                /// </summary>
                [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                public virtual System.Nullable<int> PageSize { get; set; }
        ...
        /// <summary>
        /// Creates resources for settings which have not yet been set. Currently, this creates a single resource: a
        /// Google Cloud Storage bucket, to be used as the default bucket for this project. The bucket is created in an
        /// FTL-own storage project. Except for in rare cases, calling this method in parallel from multiple clients
        /// will only create a single bucket. In order to avoid unnecessary storage charges, the bucket is configured to
        /// automatically delete objects older than 90 days. The bucket is created with the following permissions: -
        /// Owner access for owners of central storage project (FTL-owned) - Writer access for owners/editors of
        /// customer project - Reader access for viewers of customer project The default ACL on objects created in the
        /// bucket is: - Owner access for owners of central storage project - Reader access for owners/editors/viewers
        /// of customer project See Google Cloud Storage documentation for more details. If there is already a default
        /// bucket set and the project can access the bucket, this call does nothing. However, if the project doesn't
        /// have the permission to access the bucket or the bucket is deleted, a new bucket will be created. May return
        /// any canonical error codes, including the following: - PERMISSION_DENIED - if the user is not authorized to
...
namespace Google.Apis.ToolResults.v1beta3.Data
{
    ...
    /// with an additional field `@type` which contains the type URL. Example: package google.profile; message Person {
    ...
    /// that representation will be embedded adding a field `value` which holds the custom JSON in addition to the
    /// `@type` field. Example (for message google.protobuf.Duration): { "@type":
    ...
    public class Any : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// qualified name of the type (as in `path/google.protobuf.Duration`). The name should be in a canonical form
        /// (e.g., leading "." is not accepted). In practice, teams usually precompile into the binary all types that
        /// they expect it to use in the context of Any. However, for URLs which use the scheme `http`, `https`, or no
        /// scheme, one can optionally set up a type server that maps type URLs to message definitions as follows: * If
        /// no scheme is provided, `https` is assumed. * An HTTP GET on the URL must yield a google.protobuf.Type value
    ...
    {
        /// <summary>
        /// Optional. The time from app start to reaching the developer-reported "fully drawn" time. This is only stored
        /// if the app includes a call to Activity.reportFullyDrawn(). See
    ...
    /// <summary>
    /// The request must provide up to a maximum of 5000 samples to be created; a larger sample size will cause an
    ...
    /// seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". It is
    /// related to Timestamp in that the difference between two Timestamp values is a Duration and it can be added or
    ...
    public class Duration : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Signed seconds of the span of time. Must be from -315,576,000,000 to +315,576,000,000 inclusive. Note: these
        /// bounds are computed from: 60 sec/min * 60 min/hr * 24 hr/day * 365.25 days/year * 10000 years
        /// </summary>
    ...
    /// <summary>
    /// An Environment represents the set of test runs (Steps) from the parent Execution that are configured with the
    /// same set of dimensions (Model, Version, Locale, and Orientation). Multiple such runs occur particularly because
    /// of features like sharding (splitting up a test suite to run in parallel across devices) and reruns (running a
    /// test multiple times to check for different outcomes).
    /// </summary>
    public class Environment : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Output only. The time when the Environment status was set to complete. This value will be set automatically
        ...
        /// <summary>
        /// Dimension values describing the environment. Dimension values always consist of "Model", "Version",
        ...
        /// <summary>
        /// Output only. Summaries of shards. Only one shard will present unless sharding feature is enabled in
    ...
    /// becomes immutable. Next tag: 16
    /// </summary>
    public class Execution : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// The time when the Execution status transitioned to COMPLETE. This value will be set automatically when state
        ...
        /// <summary>
        /// The time when the Execution was created. This value will be set automatically when CreateExecution is
        /// called. - In response: always set - In create/update request: never set
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("creationTime")]
        public virtual Timestamp CreationTime { get; set; }

        /// <summary>
        /// The dimensions along which different steps in this execution may vary. This must remain fixed over the life
        /// of the execution. Returns INVALID_ARGUMENT if this field is set in an update request. Returns
        ...
        /// <summary>
        /// A unique identifier within a History for this Execution. Returns INVALID_ARGUMENT if this field is set or
        /// overwritten by the caller. - In response always set - In create/update request: never set
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("executionId")]
        public virtual string ExecutionId { get; set; }

        /// <summary>
        /// Classify the result, for example into SUCCESS or FAILURE - In response: present if set by create/update
        ...
        /// <summary>
        /// Lightweight information about execution request. - In response: present if set by create - In create:
        /// optional - In update: optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("specification")]
        public virtual Specification Specification { get; set; }

        /// <summary>
        /// The initial state is IN_PROGRESS. The only legal state transitions is from IN_PROGRESS to COMPLETE. A
        /// PRECONDITION_FAILED will be returned if an invalid transition is requested. The state can only be set to
        ...
        /// <summary>
        /// TestExecution Matrix ID that the TestExecutionService uses. - In response: present if set by create - In
    ...
    public class FailureDetail : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// If the Roboscript failed to complete successfully, e.g., because a Roboscript action or assertion failed or
        /// a Roboscript action could not be matched during the entire crawl.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failedRoboscript")]
        public virtual System.Nullable<bool> FailedRoboscript { get; set; }

        /// <summary>
        /// If an app is not installed and thus no test can be run with the app. This might be caused by trying to run a
        /// test on an unsupported platform.
        /// </summary>
    ...
    /// <summary>
    /// Graphics statistics for the App. The information is collected from 'adb shell dumpsys graphicsstats'. For more
    /// info see: https://developer.android.com/training/testing/performance.html Statistics will only be present for
    /// API 23+.
    /// </summary>
    ...
    /// <summary>
    /// A History represents a sorted list of Executions ordered by the start_timestamp_millis field (descending). It
    /// can be used to group all the Executions of a continuous build. Note that the ordering only operates on
    /// one-dimension. If a repository has multiple branches, it means that multiple histories will need to be used in
    /// order to order Executions per branch.
    /// </summary>
    public class History : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// A short human-readable (plain text) name to display in the UI. Maximum of 100 characters. - In response:
        /// present if set during create. - In create request: optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayName")]
        public virtual string DisplayName { get; set; }

        /// <summary>
        /// A unique identifier within a project for this History. Returns INVALID_ARGUMENT if this field is set or
        /// overwritten by the caller. - In response always set - In create request: never set
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("historyId")]
        public virtual string HistoryId { get; set; }
        ...
        /// <summary>
        /// The platform of the test history. - In response: always set. Returns the platform of the last execution if
        /// unknown.
        /// </summary>
    ...
    public class Image : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A reference to the full-size, original image. This is the same as the tool_outputs entry for the image under
        /// its Step. Always set.
        /// </summary>
    ...
    {
        /// <summary>
        /// If the end user aborted the test execution before a pass or fail could be determined. For example, the user
        /// pressed ctrl-c which sent a kill signal to the test runner while the test was running.
        /// </summary>
        ...
        /// <summary>
        /// If the test runner could not determine success or failure because the test depends on a component other than
        /// the system under test which failed. For example, a mobile test requires provisioning a device where the test
    ...
    public class ListExecutionsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A continuation token to resume the query at the next item. Will only be set if there are more Executions to
        /// fetch.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    public class ListHistoriesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A continuation token to resume the query at the next item. Will only be set if there are more histories to
        /// fetch. Tokens are valid for up to one hour from the time of the first list request. For instance, if you
        /// make a list request at 1PM and use the token from this first request 10 minutes later, the token from this
    ...
    {
        /// <summary>
        /// Optional, returned if result size exceeds the page size specified in the request (or the default page size,
        /// 500, if unspecified). It indicates the last sample timestamp to be used as page_token in subsequent request
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    {
        /// <summary>
        /// A sequence of accessibility suggestions, grouped into clusters. Within the sequence, clusters that belong to
        /// the same SuggestionCategory should be adjacent. Within each category, clusters should be ordered by their
        /// SuggestionPriority (ERRORs first). The categories should be ordered by their highest priority cluster.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("clusters")]
    ...
    {
        /// <summary>
        /// A continuation token to resume the query at the next item. If set, indicates that there are more thumbnails
        /// to read, by calling list again with this value in the page_token field.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }

        /// <summary>
        /// A list of image data. Images are returned in a deterministic order; they are ordered by these factors, in
        /// order of importance: * First, by their associated test case. Images without a test case are considered
        /// greater than images with one. * Second, by their creation time. Images without a creation time are greater
        /// than images with one. * Third, by the order in which they were added to the step (by calls to CreateStep or
        /// UpdateStep).
        /// </summary>
    ...
    {
        /// <summary>
        /// A continuation token to resume the query at the next item. If set, indicates that there are more steps to
        /// read, by calling list again with this value in the page_token field.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    /// <summary>
    /// Merged test result for environment. If the environment has only one step (no reruns or shards), then the merged
    /// result is the same as the step result. If the environment has multiple shards and/or reruns, then the results of
    /// shards and reruns that belong to the same environment are merged into one environment result.
    /// </summary>
    public class MergedResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The combined and rolled-up result of each test suite that was run as part of this environment. Combining:
        /// When the test cases from a suite are run in different steps (sharding), the results are added back together
        /// in one overview. (e.g., if shard1 has 2 failures and shard2 has 1 failure than the overview failure_count =
        /// 3). Rollup: When test cases from the same suite are run multiple times (flaky), the results are combined
        /// (e.g., if testcase1.run1 fails, testcase1.run2 passes, and both testcase2.run1 and testcase2.run2 fail then
        /// the overview flaky_count = 1 and failure_count = 1).
        /// </summary>
    ...
    public class NonSdkApiInsight : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A unique ID, to be used for determining the effectiveness of this particular insight in the context of a
        /// matcher. (required)
        /// </summary>
        ...
        /// <summary>
        /// An insight indicating that the hidden API usage originates from the use of a library that needs to be
        /// upgraded.
        /// </summary>
    ...
    {
        /// <summary>
        /// More information about a FAILURE outcome. Returns INVALID_ARGUMENT if this field is set but the summary is
        /// not FAILURE. Optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failureDetail")]
        public virtual FailureDetail FailureDetail { get; set; }

        /// <summary>
        /// More information about an INCONCLUSIVE outcome. Returns INVALID_ARGUMENT if this field is set but the
        /// summary is not INCONCLUSIVE. Optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("inconclusiveDetail")]
        public virtual InconclusiveDetail InconclusiveDetail { get; set; }

        /// <summary>
        /// More information about a SKIPPED outcome. Returns INVALID_ARGUMENT if this field is set but the summary is
        /// not SKIPPED. Optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("skippedDetail")]
        public virtual SkippedDetail SkippedDetail { get; set; }

        /// <summary>
        /// More information about a SUCCESS outcome. Returns INVALID_ARGUMENT if this field is set but the summary is
        /// not SUCCESS. Optional
        /// </summary>
    ...
    /// <summary>
    /// A warning that Robo encountered a screen that has overlapping clickable elements; this may indicate a potential
    /// UI issue.
    /// </summary>
    ...
    /// <summary>
    /// This insight indicates that the hidden API usage originates from a Google-provided library. Users need not take
    /// any action.
    /// </summary>
    ...
    public class PerfMetricsSummary : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Graphics statistics for the entire run. Statistics are reset at the beginning of the run and collected at
        /// the end of the run.
        /// </summary>
    ...
    {
        /// <summary>
        /// The name of the Google Cloud Storage bucket to which results are written. By default, this is unset. In
        /// update request: optional In response: optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("defaultBucket")]
        public virtual string DefaultBucket { get; set; }

        /// <summary>
        /// The name of the project's settings. Always of the form: projects/{project-id}/settings In update request:
    ...
    {
        /// <summary>
        /// URI of the Xunit XML files to publish. The maximum size of the file this reference is pointing to is 50MB.
        /// Required.
        /// </summary>
    ...
    public class ScreenshotCluster : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A singular screen that represents the cluster as a whole. This screen will act as the "cover" of the entire
        /// cluster. When users look at the clusters, only the key screen from each cluster will be shown. Which screen
    ...
    {
        /// <summary>
        /// Summaries of the steps belonging to the shard. With flaky_test_attempts enabled from TestExecutionService,
        /// more than one run (Step) can present. And the runs will be sorted by multistep_number.
        /// </summary>
    ...
    /// <summary>
    /// A Step represents a single operation performed as part of Execution. A step can be used to represent the
    /// execution of a tool ( for example a test runner execution or an execution of a compiler). Steps can overlap (for
    /// instance two steps might have the same start time if some operations are done in parallel). Here is an example,
    /// let's consider that we have a continuous build is executing a test runner for each iteration. The workflow would
    /// look like: - user creates a Execution with id 1 - user creates an TestExecutionStep with id 100 for Execution 1
    ...
    {
        /// <summary>
        /// The time when the step status was set to complete. This value will be set automatically when state
        /// transitions to COMPLETE. - In response: set if the execution state is COMPLETE. - In create/update request:
        /// never set
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("completionTime")]
        ...
        /// <summary>
        /// A description of this tool For example: mvn clean package -D skipTests=true - In response: present if set by
        ...
        /// <summary>
        /// How much the device resource is used to perform the test. This is the device usage used for billing purpose,
        /// which is different from the run_duration, for example, infrastructure failure won't be charged for device
        /// usage. PRECONDITION_FAILED will be returned if one attempts to set a device_usage on a step which already
        /// has this field set. - In response: present if previously set. - In create request: optional - In update
        /// request: optional
        /// </summary>
        ...
        /// values for those dimensions, eg. `dimension_value = ['attempt': '1', 'device': 'Nexus 6']` If a step does
        ...
        /// <summary>
        /// Whether any of the outputs of this step are images whose thumbnails can be fetched with ListThumbnails. - In
        ...
        /// <summary>
        /// Arbitrary user-supplied key/value pairs that are associated with the step. Users are responsible for
        /// managing the key namespace such that keys don't accidentally collide. An INVALID_ARGUMENT will be returned
        /// if the number of labels exceeds 100 or if the length of any of the keys or values exceeds 100 characters. -
        /// In response: always set - In create request: optional - In update request: optional; any new key/value pair
        /// will be added to the map, and any new value for an existing key will update that key's value
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IList<StepLabelsEntry> Labels { get; set; }

        /// <summary>
        /// Details when multiple steps are run with the same configuration as a group. These details can be used
        /// identify which group this step is part of. It also identifies the groups 'primary step' which indexes all
        /// the group members. - In response: present if previously set. - In create request: optional, set iff this
        /// step was performed more than once. - In update request: optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("multiStep")]
        public virtual MultiStep MultiStep { get; set; }

        /// <summary>
        /// A short human-readable name to display in the UI. Maximum of 100 characters. For example: Clean build A
        /// PRECONDITION_FAILED will be returned upon creating a new step if it shares its name and dimension_value with
        /// an existing step. If two steps represent a similar action, but have different dimension values, they should
        /// share the same name. For instance, if the same set of tests is run on two different platforms, the two steps
        /// should have the same name. - In response: always set - In create request: always set - In update request:
        /// never set
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
        ...
        /// <summary>
        /// Classification of the result, for example into SUCCESS or FAILURE - In response: present if set by
        /// create/update request - In create/update request: optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("outcome")]
        public virtual Outcome Outcome { get; set; }
        ...
        /// <summary>
        /// How long it took for this step to run. If unset, this is set to the difference between creation_time and
        /// completion_time when the step is set to the COMPLETE state. In some cases, it is appropriate to set this
        /// value separately: For instance, if a step is created, but the operation it represents is queued for a few
        /// minutes before it executes, it would be appropriate not to include the time spent queued in its
        /// run_duration. PRECONDITION_FAILED will be returned if one attempts to set a run_duration on a step which
        /// already has this field set. - In response: present if previously set; always present on COMPLETE step - In
        ...
        /// <summary>
        /// The initial state is IN_PROGRESS. The only legal state transitions are * IN_PROGRESS -&amp;gt; COMPLETE A
        ...
        /// <summary>
        /// A unique identifier within a Execution for this Step. Returns INVALID_ARGUMENT if this field is set or
        /// overwritten by the caller. - In response: always set - In create/update request: never set
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("stepId")]
        public virtual string StepId { get; set; }
    ...
    /// <summary>
    /// A set of similar suggestions that we suspect are closely related. This proto and most of the nested protos are
    /// branched from foxandcrown.prelaunchreport.service.SuggestionClusterProto, replacing PLR's dependencies with
    /// FTL's.
    /// </summary>
    public class SuggestionClusterProto : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A sequence of suggestions. All of the suggestions within a cluster must have the same SuggestionPriority and
        /// belong to the same SuggestionCategory. Suggestions with the same screenshot URL should be adjacent.
        /// </summary>
    ...
    public class SuggestionProto : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A somewhat human readable identifier of the source view, if it does not have a resource_name. This is a path
        /// within the accessibility hierarchy, an element with resource name; similar to an XPath.
        /// </summary>
        ...
        /// <summary>
        /// ID of the screen for the suggestion. It is used for getting the corresponding screenshot path. For example,
        ...
        /// <summary>
        /// Relative importance of a suggestion as compared with other suggestions that have the same priority and
        /// category. This is a meaningless value that can be used to order suggestions that are in the same category
        /// and have the same priority. The larger values have higher priority (i.e., are more important). Optional.
        /// </summary>
    ...
    public class TestCase : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The stack trace details if the test case failed or encountered an error. The maximum size of the stack
        /// traces is 100KiB, beyond which the stack track will be truncated. Zero if the test case passed.
        /// </summary>
    ...
    /// <summary>
    /// A reference to a test case. Test case references are canonically ordered lexicographically by these three
    /// factors: * First, by test_suite_name. * Second, by class_name. * Third, by name.
    /// </summary>
    ...
    /// <summary>
    /// A step that represents running tests. It accepts ant-junit xml files which will be parsed into structured test
    /// results by the service. Xml file paths are updated in order to append more files, however they can't be deleted.
    ...
    {
        /// <summary>
        /// Issues observed during the test execution. For example, if the mobile app under test crashed during the
        /// test, the error message and the stack trace content can be recorded here to assist debugging. - In response:
        ...
        /// <summary>
        /// List of test suite overview contents. This could be parsed from xUnit XML log by server, or uploaded
        /// directly by user. This references should only be called when test suites are fully parsed or uploaded. The
        /// maximum allowed number of test suite overviews per step is 1000. - In response: always set - In create
        /// request: optional - In update request: never (use publishXunitXmlFiles custom method instead)
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("testSuiteOverviews")]
        public virtual System.Collections.Generic.IList<TestSuiteOverview> TestSuiteOverviews { get; set; }

        /// <summary>
        /// The timing break down of the test execution. - In response: present if set by create or update - In
        /// create/update request: optional
        /// </summary>
        ...
        /// <summary>
        /// Represents the execution of the test runner. The exit code of this tool will be used to determine if the
        /// test passed. - In response: always set - In create/update request: optional
        /// </summary>
    ...
    /// <summary>
    /// A summary of a test suite result either parsed from XML or uploaded directly by a user. Note: the API related
    /// comments are for StepService only. This message is also being used in ExecutionService in a read only mode for
    ...
    public class TestSuiteOverview : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Number of test cases in error, typically set by the service by parsing the xml_source. - In create/response:
        ...
        /// <summary>
        /// Number of failed test cases, typically set by the service by parsing the xml_source. May also be set by the
        /// user. - In create/response: always set - In update request: never
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failureCount")]
        public virtual System.Nullable<int> FailureCount { get; set; }

        /// <summary>
        /// Number of flaky test cases, set by the service by rolling up flaky test attempts. Present only for rollup
        /// test suite overview at environment level. A step cannot have flaky test cases.
        /// </summary>
        ...
        /// <summary>
        /// Number of test cases not run, typically set by the service by parsing the xml_source. - In create/response:
        /// always set - In update request: never
        /// </summary>
        ...
        /// <summary>
        /// Number of test cases, typically set by the service by parsing the xml_source. - In create/response: always
        ...
        /// <summary>
        /// If this test suite was parsed from XML, this is the URI where the original XML file is stored. Note:
        /// Multiple test suites can share the same xml_source Returns INVALID_ARGUMENT if the uri format is not
    ...
    {
        /// <summary>
        /// How long it took to run the test process. - In response: present if previously set. - In create/update
        /// request: optional
        /// </summary>
    ...
    public class Thumbnail : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The thumbnail file itself. That is, the bytes here are precisely the bytes that make up the thumbnail file;
        /// they can be served as an image as-is (with the appropriate content type.) Always set.
        /// </summary>
    ...
    /// convert to and from [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) date strings.
    /// </summary>
    ...
    {
        /// <summary>
        /// The full tokenized command line including the program name (equivalent to argv in a C program). - In
        /// response: present if set by create request - In create request: optional - In update request: never set
        /// </summary>
        ...
        /// create/update request - In create request: optional - In update request: optional, a FAILED_PRECONDITION
        ...
        /// <summary>
        /// References to any plain text logs output the tool execution. This field can be set before the tool has
        /// exited in order to be able to have access to a live view of the logs while the tool is running. The maximum
        /// allowed number of tool logs per step is 1000. - In response: present if set by create/update request - In
        /// create request: optional - In update request: optional, any value provided will be appended to the existing
        /// list
        /// </summary>
        ...
        /// <summary>
        /// References to opaque files of any format output by the tool execution. The maximum allowed number of tool
        /// outputs per step is 1000. - In response: present if set by create/update request - In create request:
        /// optional - In update request: optional, any value provided will be appended to the existing list
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("toolOutputs")]
        public virtual System.Collections.Generic.IList<ToolOutputReference> ToolOutputs { get; set; }
    ...
    /// <summary>
    /// Generic tool step to be used for binaries we do not explicitly support. For example: running cp to copy
    /// artifacts from one location to another.
    /// </summary>
    public class ToolExecutionStep : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// A Tool execution. - In response: present if set by create/update request - In create/update request:
        /// optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("toolExecution")]
        public virtual ToolExecution ToolExecution { get; set; }
    ...
    {
        /// <summary>
        /// Tool execution exit code. A value of 0 means that the execution was successful. - In response: always set -
    ...
    {
        /// <summary>
        /// The creation time of the file. - In response: present if set by create/update request - In create/update
        /// request: optional
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("creationTime")]
        public virtual Timestamp CreationTime { get; set; }
        ...
        /// <summary>
        /// The test case to which this output file belongs. - In response: present if set by create/update request - In
        /// create/update request: optional
        /// </summary>
    ...
    /// <summary>
    /// This insight is a recommendation to upgrade a given library to the specified version, in order to avoid
    /// dependencies on non-SDK APIs.
    /// </summary>
    ...
    /// <summary>
    /// Additional details of a used Robo directive with an ignore action. Note: This is a different scenario than
    /// unused directive.
    /// </summary>
