...
namespace Google.Apis.YouTube.v3
{
    ...
    public class LiveBroadcastsResource
    {
        ...
        public class ControlRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.LiveBroadcast>
        {
            ...
            public ControlRequest(Google.Apis.Services.IClientService service, string id, Google.Apis.Util.Repeatable<string> part) : base(service)
            {
                Id = id;
                Part = part;
                InitParameters();
            ...
            /// <summary>Whether display or hide slate.</summary>
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "youtube/v3/liveBroadcasts/control";
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add("displaySlate", new Google.Apis.Discovery.Parameter
                {
                    Name = "displaySlate",
                    IsRequired = false,
                    ParameterType = "query",
                ...
                RequestParameters.Add("offsetTimeMs", new Google.Apis.Discovery.Parameter
                {
                    Name = "offsetTimeMs",
                    IsRequired = false,
                    ParameterType = "query",
                ...
                RequestParameters.Add("walltime", new Google.Apis.Discovery.Parameter
                {
                    Name = "walltime",
                    IsRequired = false,
                    ParameterType = "query",
