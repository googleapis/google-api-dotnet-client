...
/**
 * \brief
 *   YouTube Data API v3 Version v3
 *
 ...
 *
 * The complete API documentation for using YouTube Data API v3 can be found at
...
namespace Google.Apis.YouTube.v3
{
    ...
    public class YouTubeService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            get { return "https://www.googleapis.com/batch/youtube"; }
        }

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath
        {
            get { return "batch/youtube"; }
        }
        #endif
    ...
    public class ActivitiesResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.ActivityListResponse>
        {
            ...
            public ListRequest(Google.Apis.Services.IClientService service, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                InitParameters();
            ...
            /// properties, the child properties will be included in the response. For example, in an activity resource,
            /// the snippet property contains other properties that identify the type of activity, a display title for
            /// the activity, and so forth. If you set part=snippet, the API response will also contain all of those
            ...
            {
                get { return "youtube/v3/activities"; }
            }
    ...
    public class CaptionsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/captions"; }
            }
        ...
        public class DownloadRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/captions/{id}"; }
            }
        ...
        public class InsertRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.Caption>
        {
            ...
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Caption body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string videoId, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                VideoId = videoId;
                Part = part;
        ...
        public class UpdateRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.Caption>
        {
            ...
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Caption body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class ChannelBannersResource
    {
        ...
        public class InsertRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.ChannelBannerResource>
        {
            ...
            /// intended exclusively for YouTube content partners.The onBehalfOfContentOwnerChannel parameter specifies
            /// the YouTube channel ID of the channel to which a video is being added. This parameter is required when a
            ...
            /// provide authentication credentials for each separate channel.</summary>
            ...
            public override string RestPath
            {
                get { return "youtube/v3/channelBanners/insert"; }
            }
    ...
    public class ChannelSectionsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/channelSections"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.ChannelSection body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            /// write operation will set as well as the properties that the API response will include.The part names
            /// that you can include in the parameter value are snippet and contentDetails.</summary>
            [Google.Apis.Util.RequestParameterAttribute("part", Google.Apis.Util.RequestParameterType.Query)]
            public virtual Google.Apis.Util.Repeatable<string> Part { get; private set; }
        ...
        /// contains other properties, such as a display title for the channelSection. If you set part=snippet, the API response
        /// will also contain all of those nested properties.</param>
        public virtual ListRequest List(Google.Apis.Util.Repeatable<string> part)
        {
            return new ListRequest(service, part);
        }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.ChannelSection body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class ChannelsResource
    {
        ...
        /// contains other properties, such as the uploads properties. As such, if you set part=contentDetails, the API response
        /// will also contain all of those nested properties.</param>
        public virtual ListRequest List(Google.Apis.Util.Repeatable<string> part)
        {
            return new ListRequest(service, part);
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.ChannelListResponse>
        {
            ...
            /// that the API response will include.If the parameter identifies a property that contains child
            /// properties, the child properties will be included in the response. For example, in a channel resource,
            /// the contentDetails property contains other properties, such as the uploads properties. As such, if you
            /// set part=contentDetails, the API response will also contain all of those nested properties.</summary>
            [Google.Apis.Util.RequestParameterAttribute("part", Google.Apis.Util.RequestParameterType.Query)]
            public virtual Google.Apis.Util.Repeatable<string> Part { get; private set; }
            ...
            public override string RestPath
            {
                get { return "youtube/v3/channels"; }
            }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Channel body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            /// <summary>The part parameter serves two purposes in this operation. It identifies the properties that the
            /// write operation will set as well as the properties that the API response will include.The API currently
            /// only allows the parameter value to be set to either brandingSettings or invideoPromotion. (You cannot
            /// update both of those parts with a single request.)Note that this method overrides the existing values
    ...
    public class CommentThreadsResource
    {
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.CommentThread body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            public override string RestPath
            {
                get { return "youtube/v3/commentThreads"; }
            }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.CommentThread body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class CommentsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/comments"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Comment body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        public class MarkAsSpamRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public MarkAsSpamRequest(Google.Apis.Services.IClientService service, Google.Apis.Util.Repeatable<string> id)
                : base(service)
            {
                Id = id;
                InitParameters();
            ...
            public override string RestPath
            {
                get { return "youtube/v3/comments/markAsSpam"; }
            }
        ...
        public class SetModerationStatusRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public SetModerationStatusRequest(Google.Apis.Services.IClientService service, Google.Apis.Util.Repeatable<string> id, SetModerationStatusRequest.ModerationStatusEnum moderationStatus)
                : base(service)
            {
                Id = id;
            ...
            public override string RestPath
            {
                get { return "youtube/v3/comments/setModerationStatus"; }
            }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Comment body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class GuideCategoriesResource
    {
        ...
        /// <summary>Retrieves a list of guide categories.</summary>
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.GuideCategoryListResponse>
        {
            ...
            /// <summary>Return the guide categories with the given IDs.</summary>
            [Google.Apis.Util.RequestParameterAttribute("id", Google.Apis.Util.RequestParameterType.Query)]
            public virtual Google.Apis.Util.Repeatable<string> Id { get; set; }

            /// <summary>Return all categories in the given region code.</summary>
            [Google.Apis.Util.RequestParameterAttribute("regionCode", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string RegionCode { get; set; }
            ...
            public override string RestPath
            {
                get { return "youtube/v3/guideCategories"; }
            }
    ...
    public class I18nLanguagesResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.I18nLanguageListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/i18nLanguages"; }
            }
    ...
    public class I18nRegionsResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.I18nRegionListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/i18nRegions"; }
            }
    ...
    public class LiveBroadcastsResource
    {
        ...
        public class BindRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.LiveBroadcast>
        {
            ...
            public BindRequest(Google.Apis.Services.IClientService service, string id, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Id = id;
                Part = part;
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveBroadcasts/bind"; }
            }
        ...
        public class ControlRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.LiveBroadcast>
        {
            ...
            public ControlRequest(Google.Apis.Services.IClientService service, string id, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Id = id;
                Part = part;
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveBroadcasts/control"; }
            }
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveBroadcasts"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveBroadcast body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        public class TransitionRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.LiveBroadcast>
        {
            ...
            public TransitionRequest(Google.Apis.Services.IClientService service, string id, TransitionRequest.BroadcastStatusEnum broadcastStatus, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Id = id;
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveBroadcasts/transition"; }
            }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveBroadcast body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class LiveChatBansResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveChat/bans"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveChatBan body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class LiveChatMessagesResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveChat/messages"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveChatMessage body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string liveChatId, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
    ...
    public class LiveChatModeratorsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveChat/moderators"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveChatModerator body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class LiveStreamsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/liveStreams"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveStream body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        /// <param name="part">The part parameter serves two purposes in this operation. It identifies the properties that the
        /// write operation will set as well as the properties that the API response will include.The part properties that you
        /// can include in the parameter value are id, snippet, cdn, and status.Note that this method will override the existing
        /// values for all of the mutable properties that are contained in any parts that the parameter value specifies. If the
        /// request body does not specify a value for a mutable property, the existing value for that property will be
        /// removed.</param>
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.LiveStream body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
    ...
    public class MembershipsLevelsResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.MembershipsLevelListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/membershipsLevels"; }
            }
    ...
    public class PlaylistItemsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/playlistItems"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.PlaylistItem body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        /// properties that the API response will include.If the parameter identifies a property that contains child properties,
        /// the child properties will be included in the response. For example, in a playlistItem resource, the snippet property
        /// contains numerous fields, including the title, description, position, and resourceId properties. As such, if you set
        /// part=snippet, the API response will contain all of those properties.</param>
        public virtual ListRequest List(Google.Apis.Util.Repeatable<string> part)
        {
            return new ListRequest(service, part);
        }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.PlaylistItem body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            /// <summary>The part parameter serves two purposes in this operation. It identifies the properties that the
            /// write operation will set as well as the properties that the API response will include.Note that this
            /// method will override the existing values for all of the mutable properties that are contained in any
            /// parts that the parameter value specifies. For example, a playlist item can specify a start time and end
            /// time, which identify the times portion of the video that should play when users watch the video in the
            /// playlist. If your request is updating a playlist item that sets these values, and the request's part
    ...
    public class PlaylistsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/playlists"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Playlist body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.PlaylistListResponse>
        {
            ...
            /// that the API response will include.If the parameter identifies a property that contains child
            /// properties, the child properties will be included in the response. For example, in a playlist resource,
            /// the snippet property contains properties like author, title, description, tags, and timeCreated. As
            /// such, if you set part=snippet, the API response will contain all of those properties.</summary>
            [Google.Apis.Util.RequestParameterAttribute("part", Google.Apis.Util.RequestParameterType.Query)]
            public virtual Google.Apis.Util.Repeatable<string> Part { get; private set; }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Playlist body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            /// <summary>The part parameter serves two purposes in this operation. It identifies the properties that the
            /// write operation will set as well as the properties that the API response will include.Note that this
            /// method will override the existing values for mutable properties that are contained in any parts that the
    ...
    public class SponsorsResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.SponsorListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/sponsors"; }
            }
    ...
    public class SubscriptionsResource
    {
        ...
        public class DeleteRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/subscriptions"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Subscription body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
        ...
        /// properties that the API response will include.If the parameter identifies a property that contains child properties,
        /// the child properties will be included in the response. For example, in a subscription resource, the snippet property
        /// contains other properties, such as a display title for the subscription. If you set part=snippet, the API response
        /// will also contain all of those nested properties.</param>
        public virtual ListRequest List(Google.Apis.Util.Repeatable<string> part)
        {
            return new ListRequest(service, part);
    ...
    public class SuperChatEventsResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.SuperChatEventListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/superChatEvents"; }
            }
    ...
    public class ThumbnailsResource
    {
        ...
        public class SetRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.ThumbnailSetResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/thumbnails/set"; }
            }
    ...
    public class VideoAbuseReportReasonsResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.VideoAbuseReportReasonListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/videoAbuseReportReasons"; }
            }
    ...
    public class VideoCategoriesResource
    {
        ...
        public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.VideoCategoryListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/videoCategories"; }
            }
    ...
    public class VideosResource
    {
        ...
        public class GetRatingRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.VideoRatingListResponse>
        {
            ...
            public GetRatingRequest(Google.Apis.Services.IClientService service, Google.Apis.Util.Repeatable<string> id)
                : base(service)
            {
                Id = id;
                InitParameters();
            ...
            public override string RestPath
            {
                get { return "youtube/v3/videos/getRating"; }
            }
        ...
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Video body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            /// <summary>The part parameter serves two purposes in this operation. It identifies the properties that the
            /// write operation will set as well as the properties that the API response will include.Note that not all
            /// parts contain properties that can be set when inserting or updating a video. For example, the statistics
            ...
            /// part will still be included in the API response.</summary>
            [Google.Apis.Util.RequestParameterAttribute("part", Google.Apis.Util.RequestParameterType.Query)]
            public virtual Google.Apis.Util.Repeatable<string> Part { get; private set; }
        ...
        /// the API response will include.If the parameter identifies a property that contains child properties, the child
        ...
        public class RateRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/videos/rate"; }
            }
        ...
        public class ReportAbuseRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/videos/reportAbuse"; }
            }
        ...
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.Video body, Google.Apis.Util.Repeatable<string> part)
                : base(service)
            {
                Part = part;
                Body = body;
            ...
            /// write operation will set as well as the properties that the API response will include.Note that this
            /// method will override the existing values for all of the mutable properties that are contained in any
            /// parts that the parameter value specifies. For example, a video's privacy setting is contained in the
    ...
    public class WatermarksResource
    {
        ...
        public class SetRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/watermarks/set"; }
            }
        ...
        public class UnsetRequest : YouTubeBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "youtube/v3/watermarks/unset"; }
            }
...
{    
    ...
    public class ChannelContentDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public class RelatedPlaylistsData
        {
            ...
            /// <summary>The ID of the playlist that contains the channel"s liked videos. Use the
            ///
            /// playlistItems.insert and  playlistItems.delete to add or remove items from that list.</summary>
    ...
    public class ContentRating : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The video's rating from the Austrian Board of Media Classification (Bundesministerium fr
        ...
        /// <summary>The video's rating from France's Conseil suprieur de l’audiovisuel, which rates broadcast
        /// content.</summary>
        ...
        /// <summary>The video's Departamento de Justia, Classificao, Qualificao e Ttulos (DJCQT - Brazil)
        /// rating.</summary>
        ...
        /// <summary>The video's Instituto de la Cinematografa y de las Artes Audiovisuales (ICAA - Spain)
        /// rating.</summary>
        ...
        /// <summary>The video's Korea Media Rating Board () rating. The KMRB rates videos in South Korea.</summary>
        ...
        /// <summary>The video's rating from the Ministero dei Beni e delle Attivit Culturali e del Turismo
        /// (Italy).</summary>
    ...
    public class IngestionInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// the stream URL and stream name separately or you may need to concatenate them in the following
        /// format:STREAM_URL/STREAM_NAME</summary>
    ...
    public class LiveStreamContentDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// resource for a non-reusable stream is to use the id parameter to identify the stream. </summary>
    ...
    ///
    /// uploaded videos favorite videos positively rated (liked) videos watch history watch later
    ///
    /// To be more specific, these lists are associated with a channel, which is a collection of a person, group, or
    /// company's videos, playlists, and other YouTube information.  You can retrieve the playlist IDs for each of these
    /// lists from the  channel resource for a given channel. You can then use the playlistItems.list method to retrieve
    /// any of those lists. You can also add or remove items from those lists by calling the playlistItems.insert and
    /// playlistItems.delete methods.</summary>
    ...
    /// to how that resource is used in that playlist. YouTube uses playlists to identify special collections of videos
    /// for a channel, such as:
    ///
    /// uploaded videos favorite videos positively rated (liked) videos watch history watch later
    ///
    ...
    ///
    /// You can retrieve the playlist IDs for each of these lists from the channel resource for a given channel. You can
    /// then use the playlistItems.list method to retrieve any of those lists. You can also add or remove items from
    /// those lists by calling the playlistItems.insert and playlistItems.delete methods. For example, if a user gives a
    /// positive rating to a video, you would insert that video into the liked videos playlist for that user's
    /// channel.</summary>
    ...
    /// <summary>Basic details about a video category, such as its localized title. Next Id: 16</summary>
