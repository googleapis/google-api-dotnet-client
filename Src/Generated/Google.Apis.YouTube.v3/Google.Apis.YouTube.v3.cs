...
namespace Google.Apis.YouTube.v3
{
    ...
    public class MediaResource
    {
        ...
        /// <summary>Inserts a new AudioTrack for a video.</summary>
        /// <param name="body">The body of the request.</param>
        public virtual UploadRequest Upload(Google.Apis.YouTube.v3.Data.AudioTrack body)
        {
            return new UploadRequest(this.service, body);
        }

        /// <summary>Inserts a new AudioTrack for a video.</summary>
        public class UploadRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.AudioTrack>
        {
            /// <summary>Constructs a new Upload request.</summary>
            public UploadRequest(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.AudioTrack body) : base(service)
            {
                Body = body;
                InitParameters();
            }

            /// <summary>Required. The BCP-47 language code of the AudioTrack (e.g., "es-ES").</summary>
            ...
            /// <summary>Required. The external YouTube video ID.</summary>
            [Google.Apis.Util.RequestParameterAttribute("videoId", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string VideoId { get; set; }

            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.YouTube.v3.Data.AudioTrack Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "youtube/v3/audiotracks";
        ...
        /// <param name="stream">The stream to upload. See remarks for further information.</param>
        /// <param name="contentType">The content type of the stream to upload.</param>
        public virtual UploadMediaUpload Upload(Google.Apis.YouTube.v3.Data.AudioTrack body, System.IO.Stream stream, string contentType)
        {
            return new UploadMediaUpload(service, body, stream, contentType);
        }

        /// <summary>Upload media upload which supports resumable upload.</summary>
        public class UploadMediaUpload : Google.Apis.Upload.ResumableUpload<Google.Apis.YouTube.v3.Data.AudioTrack, Google.Apis.YouTube.v3.Data.AudioTrack>
        {
            /// <summary>V1 error format.</summary>
            [Google.Apis.Util.RequestParameterAttribute("$.xgafv", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<XgafvEnum> Xgafv { get; set; }
            ...
            /// </list>
            /// </remarks>
            public UploadMediaUpload(Google.Apis.Services.IClientService service, Google.Apis.YouTube.v3.Data.AudioTrack body, System.IO.Stream stream, string contentType)
                : base(service, string.Format("/{0}/{1}{2}", "upload", service.BasePath, "youtube/v3/audiotracks"), "POST", stream, contentType)
            {
                Body = body;
            }
        }
    ...
    public class YoutubeResource
    {
        ...
        public class V3Resource
        {
            ...
            {
                this.service = service;
                Audiotracks = new AudiotracksResource(service);
                LiveChat = new LiveChatResource(service);
            }

            /// <summary>Gets the Audiotracks resource.</summary>
            public virtual AudiotracksResource Audiotracks { get; }

            /// <summary>The "audiotracks" collection of methods.</summary>
            public class AudiotracksResource
            {
                private const string Resource = "audiotracks";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public AudiotracksResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }

                /// <summary>Retrieves a list of AudioTracks for a video.</summary>
                public virtual ListRequest List()
                {
                    return new ListRequest(this.service);
                }
                ...
                /// <summary>Retrieves a list of AudioTracks for a video.</summary>
                public class ListRequest : YouTubeBaseServiceRequest<Google.Apis.YouTube.v3.Data.ListAudioTracksResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service) : base(service)
                    {
                    ...
                    /// <summary>Required. Filter by specific BCP-47 language codes.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("language", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual Google.Apis.Util.Repeatable<string> Language { get; set; }
            ...
            /// <summary>Deletes one or more AudioTracks from a video.</summary>
            public virtual DeleteAudiotracksRequest DeleteAudiotracks()
            {
                return new DeleteAudiotracksRequest(this.service);
            }

            /// <summary>Deletes one or more AudioTracks from a video.</summary>
            public class DeleteAudiotracksRequest : YouTubeBaseServiceRequest<string>
            {
                /// <summary>Constructs a new DeleteAudiotracks request.</summary>
                public DeleteAudiotracksRequest(Google.Apis.Services.IClientService service) : base(service)
                {
                    InitParameters();
                }
                ...
                /// </summary>
                [Google.Apis.Util.RequestParameterAttribute("audioTrackId", Google.Apis.Util.RequestParameterType.Query)]
                ...
                /// <summary>Gets the method name.</summary>
                public override string MethodName => "deleteAudiotracks";
                ...
                /// <summary>Initializes DeleteAudiotracks parameter list.</summary>
                protected override void InitParameters()
                {
                    base.InitParameters();
                    RequestParameters.Add("audioTrackId", new Google.Apis.Discovery.Parameter
                    {
                        Name = "audioTrackId",
                        IsRequired = false,
                        ParameterType = "query",
...
namespace Google.Apis.YouTube.v3.Data
{
    ...
    /// <summary>Represents an AudioTrack for a YouTube video.</summary>
    public class AudioTrack : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Etag of this resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("etag")]
        public virtual string ETag { get; set; }
        ...
        /// <summary>Identifies what kind of resource this is. Value: the fixed string youtube#audiotrack.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }

        /// <summary>The `snippet` object contains basic details about the AudioTrack.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("snippet")]
        public virtual AudioTrackSnippet Snippet { get; set; }
    }

    /// <summary>Basic details about an AudioTrack, such as its video, language, and status.</summary>
    public class AudioTrackSnippet : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The content type of the audio (e.g., "dubbed", "descriptive").</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("contentType")]
        public virtual string ContentType { get; set; }

        /// <summary>If the status is "FAILED", this provides a reason for the failure.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("failureReason")]
        public virtual string FailureReason { get; set; }

        /// <summary>The BCP-47 language code of this AudioTrack.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("language")]
        public virtual string Language { get; set; }

        /// <summary>The current status of this AudioTrack.</summary>
        ...
        /// <summary>Output only. Timestamp of the last update.</summary>
        ...
        /// <summary>The external YouTube video ID this AudioTrack belongs to.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("videoId")]
        public virtual string VideoId { get; set; }
    ...
    /// <summary>Response for listing AudioTracks.</summary>
    public class ListAudioTracksResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. A list of AudioTracks that match the request criteria.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("audioTracks")]
        public virtual System.Collections.Generic.IList<AudioTrack> AudioTracks { get; set; }

        /// <summary>Output only. Etag of this response.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("etag")]
        public virtual string ETag { get; set; }
