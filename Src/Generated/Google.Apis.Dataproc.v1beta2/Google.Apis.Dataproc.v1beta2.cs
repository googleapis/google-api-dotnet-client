        ...
        public class RegionsResource
        {
            ...
            public class JobsResource
            {
                ...
                public class ListRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1beta2.Data.ListJobsResponse>
                {
                    ...
                    /// either ACTIVE or INACTIVE. Only the logical AND operator is supported; space-separated items are
                    /// treated as having an implicit AND operator.Example filter:status.state = ACTIVE AND labels.env =
                    /// staging AND labels.starred = *</summary>
                    [Google.Apis.Util.RequestParameterAttribute("filter", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string Filter { get; set; }
