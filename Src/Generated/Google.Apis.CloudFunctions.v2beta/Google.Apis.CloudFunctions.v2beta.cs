    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class FunctionsResource
            {
                ...
                /// </param>
                public virtual CommitFunctionUpgradeAsGen2Request CommitFunctionUpgradeAsGen2(Google.Apis.CloudFunctions.v2beta.Data.CommitFunctionUpgradeAsGen2Request body, string name)
                {
                ...
                /// the Gen2 function active and manageable by the GCFv2 API.
                /// </summary>
                public class CommitFunctionUpgradeAsGen2Request : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2beta.Data.Operation>
                {
                    /// <summary>Constructs a new CommitFunctionUpgradeAsGen2 request.</summary>
                    public CommitFunctionUpgradeAsGen2Request(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v2beta.Data.CommitFunctionUpgradeAsGen2Request body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFunctions.v2beta.Data.CommitFunctionUpgradeAsGen2Request Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v2beta/{+name}:commitFunctionUpgradeAsGen2";
