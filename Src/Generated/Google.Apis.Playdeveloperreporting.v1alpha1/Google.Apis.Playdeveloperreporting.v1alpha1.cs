...
namespace Google.Apis.Playdeveloperreporting.v1alpha1
{
    ...
    public class VitalsResource
    {
        ...
        public class LmkrateResource
        {
            ...
            /// <summary>Describes the properties of the metric set.</summary>
            public class GetRequest : PlaydeveloperreportingBaseServiceRequest<Google.Apis.Playdeveloperreporting.v1alpha1.Data.GooglePlayDeveloperReportingV1alpha1LmkRateMetricSet>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Required. The resource name. Format: apps/{app}/lmkRateMetricSet</param>
            public virtual QueryRequest Query(Google.Apis.Playdeveloperreporting.v1alpha1.Data.GooglePlayDeveloperReportingV1alpha1QueryLmkRateMetricSetRequest body, string name)
            {
                return new QueryRequest(this.service, body, name);
            }

            /// <summary>Queries the metrics in the metric set.</summary>
            public class QueryRequest : PlaydeveloperreportingBaseServiceRequest<Google.Apis.Playdeveloperreporting.v1alpha1.Data.GooglePlayDeveloperReportingV1alpha1QueryLmkRateMetricSetResponse>
            {
                /// <summary>Constructs a new Query request.</summary>
                public QueryRequest(Google.Apis.Services.IClientService service, Google.Apis.Playdeveloperreporting.v1alpha1.Data.GooglePlayDeveloperReportingV1alpha1QueryLmkRateMetricSetRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Playdeveloperreporting.v1alpha1.Data.GooglePlayDeveloperReportingV1alpha1QueryLmkRateMetricSetRequest Body { get; set; }
...
namespace Google.Apis.Playdeveloperreporting.v1alpha1.Data
{
    ...
    /// </summary>
    public class GooglePlayDeveloperReportingV1alpha1LmkRateMetricSet : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Summary about data freshness in this resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("freshnessInfo")]
        public virtual GooglePlayDeveloperReportingV1alpha1FreshnessInfo FreshnessInfo { get; set; }
    ...
    public class GooglePlayDeveloperReportingV1alpha1QueryLmkRateMetricSetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GooglePlayDeveloperReportingV1alpha1QueryLmkRateMetricSetResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Continuation token to fetch the next page of data.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
