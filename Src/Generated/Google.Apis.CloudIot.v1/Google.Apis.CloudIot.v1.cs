        ...
        public class LocationsResource
        {
            ...
            public class RegistriesResource
            {
                ...
                public class ListRequest : CloudIotBaseServiceRequest<Google.Apis.CloudIot.v1.Data.ListDeviceRegistriesResponse>
                {
                    ...
                    /// `next_page_token` in the response indicates that more data is available.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }
...
{    
    ...
    public class Device : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// regular expression a-zA-Z+ and be less than 128 bytes in length. Values are free-form strings. Each value
    ...
    public class DeviceRegistry : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// added credentials of an updated device should be signed with one of these registry credentials. Note,
        /// however, that existing devices will never be affected by modifications to this list of credentials: after a
        ...
        /// be delivered to Cloud Pub/Sub. If multiple configurations match a message, only the first matching
        /// configuration is used. If you try to publish a device telemetry event using MQTT without specifying a Cloud
