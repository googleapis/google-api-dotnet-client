        ...
        public class LocationsResource
        {
            ...
            public class GlobalResource
            {
                ...
                public class PolicyOrchestratorsResource
                {
                    ...
                    /// omitted (in which case, the created resource will be in `ACTIVE` state anyway).
                    /// </summary>
                    public class CreateRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.Operation>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.OSConfig.v2beta.Data.GoogleCloudOsconfigV2betaPolicyOrchestrator body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
                        ...
                        Google.Apis.OSConfig.v2beta.Data.GoogleCloudOsconfigV2betaPolicyOrchestrator Body { get; set; }
                        ...
                        public override string RestPath => "v2beta/{+parent}/policyOrchestrators";
                    ...
                    /// <summary>Deletes an existing policy orchestrator resource, parented by a folder.</summary>
                    public class DeleteRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.Operation>
                    {
                    ...
                    /// <summary>Retrieves an existing policy orchestrator, parented by a folder.</summary>
                    public class GetRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.GoogleCloudOsconfigV2betaPolicyOrchestrator>
                    {
                    ...
                    /// <summary>Lists the policy orchestrators under the given parent folder resource.</summary>
                    public class ListRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.GoogleCloudOsconfigV2betaListPolicyOrchestratorsResponse>
                    {
                    ...
                    /// </param>
                    public virtual PatchRequest Patch(Google.Apis.OSConfig.v2beta.Data.GoogleCloudOsconfigV2betaPolicyOrchestrator body, string name)
                    {
                        return new PatchRequest(this.service, body, name);
                    }

                    /// <summary>Updates an existing policy orchestrator, parented by a folder.</summary>
                    public class PatchRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.Operation>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.OSConfig.v2beta.Data.GoogleCloudOsconfigV2betaPolicyOrchestrator body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.OSConfig.v2beta.Data.CancelOperationRequest body, string name)
                {
                ...
                /// Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.OSConfig.v2beta.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.OSConfig.v2beta.Data.CancelOperationRequest Body { get; set; }
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.Empty>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : OSConfigBaseServiceRequest<Google.Apis.OSConfig.v2beta.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
...
namespace Google.Apis.OSConfig.v2beta.Data
{
    ...
    public class GoogleCloudOsconfigV2betaListPolicyOrchestratorsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudOsconfigV2betaPolicyOrchestrator> PolicyOrchestrators { get; set; }
    ...
    public class GoogleCloudOsconfigV2betaOrchestratedResource : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
    ...
    public class GoogleCloudOsconfigV2betaOrchestrationScope : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual System.Collections.Generic.IList<GoogleCloudOsconfigV2betaOrchestrationScopeSelector> Selectors { get; set; }
    ...
    public class GoogleCloudOsconfigV2betaOrchestrationScopeLocationSelector : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudOsconfigV2betaOrchestrationScopeResourceHierarchySelector : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudOsconfigV2betaOrchestrationScopeSelector : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudOsconfigV2betaPolicyOrchestrator : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual GoogleCloudOsconfigV2betaOrchestratedResource OrchestratedResource { get; set; }
        ...
        public virtual GoogleCloudOsconfigV2betaOrchestrationScope OrchestrationScope { get; set; }

        /// <summary>Output only. State of the orchestration.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("orchestrationState")]
        public virtual GoogleCloudOsconfigV2betaPolicyOrchestratorOrchestrationState OrchestrationState { get; set; }
    ...
    public class GoogleCloudOsconfigV2betaPolicyOrchestratorIterationState : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudOsconfigV2betaPolicyOrchestratorOrchestrationState : Google.Apis.Requests.IDirectResponseSchema
    {
