...
namespace Google.Apis.Spanner.v1.Data
{
    ...
    /// <summary>
    /// In addition, if TransactionOptions.read_only.return_read_timestamp is set to true, a special value of 2^63 - 2
    /// will be returned in the Transaction message that describes the transaction, instead of a valid read timestamp.
    /// This special value should be discarded and not used for any subsequent queries. Please see
