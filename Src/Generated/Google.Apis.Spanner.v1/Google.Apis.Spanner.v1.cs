...
namespace Google.Apis.Spanner.v1.Data
{
    ...
    /// distributed, stale read-only transactions can execute more quickly than strong or read-write transactions,
    ...
    /// as long as one week, which allows Cloud Spanner to perform reads up to one week in the past. Partitioned DML
