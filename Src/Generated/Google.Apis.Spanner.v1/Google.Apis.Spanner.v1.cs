    ...
    public class ProjectsResource
    {
        ...
        public class InstancesResource
        {
            ...
            public class GetRequest : SpannerBaseServiceRequest<Google.Apis.Spanner.v1.Data.Instance>
            {
                ...
                /// <summary>If field_mask is present, specifies the subset of Instance fields that should be returned.
                /// If absent, all Instance fields are returned.</summary>
...
{    
    ...
    {
        /// <summary>Required. A mask specifying which fields in Instance should be updated. The field mask must always
