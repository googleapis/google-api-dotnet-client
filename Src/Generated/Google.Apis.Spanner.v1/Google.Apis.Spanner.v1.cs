...
namespace Google.Apis.Spanner.v1.Data
{
    ...
    public class QueryOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// supported query optimizer version. If not specified, Cloud Spanner uses optimizer version set at the
        ...
        /// will fail with a syntax error (`INVALID_ARGUMENT`) status. See
