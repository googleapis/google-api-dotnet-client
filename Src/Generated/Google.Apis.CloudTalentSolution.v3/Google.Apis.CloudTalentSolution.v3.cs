...
namespace Google.Apis.CloudTalentSolution.v3.Data
{
    ...
    public class JobQuery : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// name must match the value exactly. Alternatively, if the value being searched for is wrapped in
        /// SUBSTRING_MATCH([value]), the company name must contain a case insensitive substring match of the value.
        /// Using this function may increase latency. Sample Value: SUBSTRING_MATCH(google) If a value isn't specified,
        /// jobs within the search results are associated with any company. If multiple values are specified, jobs
        /// within the search results may be associated with any of the specified companies. At most 20 company display
