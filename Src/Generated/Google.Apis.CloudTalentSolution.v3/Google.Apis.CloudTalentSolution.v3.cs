...
namespace Google.Apis.CloudTalentSolution.v3
{
    ...
    public class ProjectsResource
    {
        ...
        public class ClientEventsResource
        {
            ...
            /// /talent-solution/overview). [Learn more](https://cloud.google.com/talent-solution/docs/management-tools)
            /// about self service tools.</summary>
            ...
            public class CreateRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.ClientEvent>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.CreateClientEventRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                public override string RestPath => "v3/{+parent}/clientEvents";
        ...
        public class CompaniesResource
        {
            ...
            /// <summary>Creates a new company entity.</summary>
            public class CreateRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Company>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.CreateCompanyRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTalentSolution.v3.Data.CreateCompanyRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3/{+parent}/companies";
            ...
            /// <summary>Retrieves specified company.</summary>
            public class GetRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Company>
            {
            ...
            /// <summary>Lists all companies associated with the service account.</summary>
            public class ListRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.ListCompaniesResponse>
            {
                ...
                /// <summary>Optional. The maximum number of companies to be returned, at most 100. Default is 100 if a
                /// non-positive number is provided.</summary>
            ...
            /// <summary>Updates specified company. Company names can't be updated. To update a company name, delete the
            /// company and all jobs associated with it, and only then re-create them.</summary>
            public class PatchRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Company>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.UpdateCompanyRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTalentSolution.v3.Data.UpdateCompanyRequest Body { get; set; }
        ...
        public class JobsResource
        {
            ...
            /// <summary>Deletes a list of Jobs by filter.</summary>
            public class BatchDeleteRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Empty>
            {
                /// <summary>Constructs a new BatchDelete request.</summary>
                public BatchDeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.BatchDeleteJobsRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTalentSolution.v3.Data.BatchDeleteJobsRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3/{+parent}/jobs:batchDelete";
            ...
            /// <summary>Creates a new job. Typically, the job becomes searchable within 10 seconds, but it may take up
            /// to 5 minutes.</summary>
            public class CreateRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Job>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.CreateJobRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTalentSolution.v3.Data.CreateJobRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3/{+parent}/jobs";
            ...
            /// <summary>Retrieves the specified job, whose status is OPEN or recently EXPIRED within the last 90
            /// days.</summary>
            public class GetRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Job>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists jobs by filter.</summary>
            public class ListRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.ListJobsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
            ...
            /// <summary>Updates specified job. Typically, updated contents become visible in search results within 10
            /// seconds, but it may take up to 5 minutes.</summary>
            public class PatchRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.Job>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.UpdateJobRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTalentSolution.v3.Data.UpdateJobRequest Body { get; set; }
            ...
            /// jobs present in the database, and only returns jobs that the caller has permission to search
            /// against.</summary>
            public class SearchRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.SearchJobsResponse>
            {
                /// <summary>Constructs a new Search request.</summary>
                public SearchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.SearchJobsRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTalentSolution.v3.Data.SearchJobsRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3/{+parent}/jobs:search";
            ...
            /// to passive job seekers. This call constrains the visibility of jobs present in the database, and only
            /// returns jobs the caller has permission to search against.</summary>
            public class SearchForAlertRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.SearchJobsResponse>
            {
                /// <summary>Constructs a new SearchForAlert request.</summary>
                public SearchForAlertRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTalentSolution.v3.Data.SearchJobsRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v3/{+parent}/jobs:searchForAlert";
        ...
        /// <summary>Completes the specified prefix with keyword suggestions. Intended for use by a job search auto-
        /// complete search box.</summary>
        public class CompleteRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v3.Data.CompleteQueryResponse>
        {
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v3/{+name}:complete";
...
{    
    ...
    public class ClientEvent : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. A unique identifier, generated by the client application. This `event_id` is used to
        /// establish the relationship between different events (see parent_event_id).</summary>
        ...
        /// <summary>Optional. The event_id of an event that resulted in the current event. For example, a Job view
        /// event usually follows a parent impression event: A job seeker first does a search where a list of jobs
        /// appears (impression). The job seeker then selects a result and views the description of a particular job
        /// (Job view).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("parentEventId")]
        public virtual string ParentEventId { get; set; } 

        /// <summary>Required. A unique ID generated in the API responses. It can be found in
        /// ResponseMetadata.request_id.</summary>
    ...
    {
        /// <summary>Optional. The URI to employer's career site or careers page on the employer's web site, for
        /// example, "https://careers.google.com".</summary>
        ...
        /// won't be properly searchable, and those keyword queries need to be surrounded by quotes.</summary>
    ...
    {
        /// <summary>A structured headquarters location of the company, resolved from Company.hq_location if
        /// provided.</summary>
    ...
    {
        /// <summary>Required. Events issued when end user interacts with customer's application that uses Cloud Talent
        /// Solution.</summary>
    ...
    /// <summary>Custom attributes histogram request. An error is thrown if neither string_value_histogram or
    ...
    public class CustomAttributeHistogramRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. If set to true, the response includes the histogram value for each key as a
        /// string.</summary>
    ...
    public class HistogramResults : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Specifies histogram results for custom attributes that match
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The resource name of the company listing the job, such as "projects/api-test-
        /// project/companies/foo".</summary>
        ...
        /// <summary>Optional. The end timestamp of the job. Typically this field is used for contracting engagements.
        /// Invalid timestamps are ignored.</summary>
        ...
        /// <summary>Optional. The start timestamp of the job in UTC time zone. Typically this field is used for
        /// contracting engagements. Invalid timestamps are ignored.</summary>
        ...
        /// <summary>Optional. The timestamp this job posting was most recently published. The default value is the time
        /// the request arrives at the server. Invalid timestamps are ignored.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("postingPublishTime")]
        public virtual object PostingPublishTime { get; set; } 

        /// <summary>Optional. The job PostingRegion (for example, state, country) throughout which the job is
        /// available. If this field is set, a LocationFilter in a search query within the job region finds this job
        /// posting if an exact location match isn't specified. If this field is set to PostingRegion.NATION or
    ...
    public class JobEvent : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// field contains the identifier of the viewed job.</summary>
    ...
    public class Location : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// a circle with the specified radius centered from LatLng covers the area associated with the job location.
        /// For example, currently, "Mountain View, CA, USA" has a radius of 6.17 miles.</summary>
    ...
    public class LocationFilter : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. The latitude and longitude of the geographic center from which to search. This field's
        /// ignored if `address` is provided.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("latLng")]
        public virtual LatLng LatLng { get; set; } 
    ...
    public class NumericBucketingResult : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Stores the maximum value of the numeric field. Is populated only if
    ...
    {
        /// <summary>Optional. Controls whether to disable exact keyword match on Job.job_title, Job.description,
