...
namespace Google.Apis.CloudTalentSolution.v3.Data
{
    ...
    public class LocationFilter : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. CLDR region code of the country/region of the address. This is used to address ambiguity of the
        /// user-input location, for example, "Liverpool" against "Liverpool, NY, US" or "Liverpool, UK". Set this field
        /// if all the jobs to search against are from a same region, or jobs are world-wide, but the job seeker is from
        /// a specific region. See http://cldr.unicode.org/ and
