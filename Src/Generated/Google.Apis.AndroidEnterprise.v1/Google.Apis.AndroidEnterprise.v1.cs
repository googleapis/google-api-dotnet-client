...
{    
    ...
    public class ProductSet : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Other products that are part of the set, in addition to those specified in the productId array. The
        /// only difference between this field and the productId array is that it's possible to specify additional
        /// information about this product visibility, see ProductVisibility and its fields for more information.
        /// Specifying the same product ID both here and in the productId array is not allowed and it will result in an
        /// error.</summary>
    ...
    {
        /// <summary>The product ID that should be made visible to the user. This is required.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("productId")]
        public virtual string ProductId { get; set; } 

        /// <summary>This allows to only grant visibility to the specified tracks of the app. For example, if an app has
        /// a prod version, a beta version and an alpha version and the enterprise has been granted visibility to both
        /// the alpha and beta tracks, if tracks is {"beta", "production"} the user will be able to install the app and
        /// they will get the beta version of the app. If there are no app versions in the specified track or if the
        /// enterprise wasn't granted visibility for the track, adding the "alpha" and "beta" values to the list of
        /// tracks will have no effect for now; however they will take effect once both conditions are met. Note that
        /// the enterprise itself needs to be granted access to the alpha and/or beta tracks, regardless of whether
