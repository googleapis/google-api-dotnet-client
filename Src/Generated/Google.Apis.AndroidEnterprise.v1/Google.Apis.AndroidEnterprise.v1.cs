...
namespace Google.Apis.AndroidEnterprise.v1
{
    ...
    public class DevicesResource
    {
        ...
        /// <summary>
        /// Checks if a device can access Google apps and services for a user. Returns whether access is "enabled" or
        /// "disabled". A "disabled" state prevents the user's Managed Google Account on the device from successfully
        /// authenticating with Google. This blocks access to most Google applications and services, including Google
        /// Play, as the device cannot prove its entitlement to access them. New devices default to "disabled".
        /// Important: Enforcement of this state depends on the following conditions: * The user must be a managed
        /// google account. * The enterprise must be a managed google domain. * Third-party Android mobile management
        /// must be active in the Google Admin Console for the user's Organizational Unit. If these conditions aren't
        ...
        /// <summary>
        /// Sets whether a device's access to Google services (including Google Play) is enabled or disabled for the
        /// specified user. Setting the state to "enabled" allows the Google Account to access Google services, while
        /// "disabled" blocks access by preventing OAuth token issuance. Preconditions for Enforcement: 1. This setting
        /// is only effective for Google-managed users. 2. The enterprise must be linked to a Google Managed Domain. 3.
        /// Enforcement requires third-party Android mobile management to be enabled within the Google Admin Console for
        /// the user's Organizational Unit. If these preconditions are not met, changes to this state may be ignored.
        /// </summary>
    ...
    public class EnterprisesResource
    {
        ...
        /// managed Google domain. See the guide to upgrading an enterprise for more details.
        /// </summary>
        /// <param name="enterpriseId">Required. The ID of the enterprise.</param>
...
namespace Google.Apis.AndroidEnterprise.v1.Data
{
    ...
    public class EnrollmentToken : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Optional] Provides options related to Google authentication during the enrollment.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("googleAuthenticationOptions")]
        public virtual EnrollmentTokenGoogleAuthenticationOptions GoogleAuthenticationOptions { get; set; }
    ...
    /// <summary>Options for Google authentication during the enrollment.</summary>
    public class EnrollmentTokenGoogleAuthenticationOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
