    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class AutoscalingPoliciesResource
            {
                ...
                /// projects.locations.autoscalingPolicies.create, the resource name of the location has the following format:
                ...
                public class CreateRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1.Data.AutoscalingPolicy>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1.Data.AutoscalingPolicy body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// following format: projects/{project_id}/locations/{location}</summary>
                ...
                public class UpdateRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1.Data.AutoscalingPolicy>
                {
                    ...
                    public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1.Data.AutoscalingPolicy body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
        ...
        public class RegionsResource
        {
            ...
            public class JobsResource
            {
                ...
                public class SubmitAsOperationRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1.Data.Operation>
                {
                    ...
                    public SubmitAsOperationRequest(Google.Apis.Services.IClientService service, Google.Apis.Dataproc.v1.Data.SubmitJobRequest body, string projectId, string region)
                        : base(service)
                    {
                        ProjectId = projectId;
                        Region = region;
...
{    
    ...
    /// <summary>Specifies the type and number of accelerator cards attached to the instances of an instance. See GPUs
    /// on Compute Engine (https://cloud.google.com/compute/docs/gpus/).</summary>
    public class AcceleratorConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// tesla-k80 projects/[project_id]/zones/us-east1-a/acceleratorTypes/nvidia-tesla-k80 nvidia-tesla-k80Auto Zone
    ...
    public class BasicYarnAutoscalingConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// more information.Bounds: 0.0, 1.0.</summary>
        ...
        /// of scaling up (less aggressive scaling). See How autoscaling works
        /// (https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/autoscaling#how_autoscaling_works) for
        /// more information.Bounds: 0.0, 1.0.</summary>
    ...
    {
        /// <summary>Required. Maximum number of instances for this group. Required for primary workers. Note that by
        /// default, clusters will not use secondary workers. Required for secondary workers if the minimum secondary
        /// instances is set.Primary workers - Bounds: [min_instances, ). Secondary workers - Bounds: [min_instances, ).
        /// Default: 0.</summary>
    ...
    public class InstanceGroupConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. Specifies the minimum cpu platform for the Instance Group. See Dataproc -> Minimum CPU
        /// Platform (https://cloud.google.com/dataproc/docs/concepts/compute/dataproc-min-cpu).</summary>
    ...
    {
        /// <summary>Optional. Output only. Job state details, such as an error description if the state is
        /// ERROR.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("details")]
        public virtual string Details { get; set; } 
