        ...
        public class RegionsResource
        {
            ...
            public class ClustersResource
            {
                ...
                public class PatchRequest : DataprocBaseServiceRequest<Google.Apis.Dataproc.v1.Data.Operation>
                {
                    ...
                    /// new value, as follows: { "config":{ "workerConfig":{ "numInstances":"5" } } } Note: Currently,
                    /// config.worker_config.num_instances is the only field that can be updated.</summary>
...
{    
    ...
    public class ClusterConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Optional] The shared Google Compute Engine config settings for all instances in a
        /// cluster.</summary>
