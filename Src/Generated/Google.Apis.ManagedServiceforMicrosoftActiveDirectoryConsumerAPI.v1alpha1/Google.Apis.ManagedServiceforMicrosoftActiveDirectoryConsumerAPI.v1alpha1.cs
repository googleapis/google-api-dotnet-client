            ...
            public class GlobalResource
            {
                ...
                public class DomainsResource
                {
                    ...
                    public class SqlIntegrationsResource
                    {
                        ...
                        /// <param name="name">Required. MangedOU resource name using the form:
                        /// `projects/{project_id}/locations/global/domains/sqlIntegrations/{name}`</param>
                        ...
                        public class GetRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.SQLIntegration>
                        {
                            ...
                            /// <summary>Required. MangedOU resource name using the form:
                            /// `projects/{project_id}/locations/global/domains/sqlIntegrations/{name}`</summary>
                        ...
                        /// <param name="parent">Required. The resource name of the SqlIntegrations using the form:
                        /// `projects/{project_id}/locations/global/domains`</param>
                        ...
                        public class ListRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.ListSQLIntegrationsResponse>
                        {
                            ...
                            /// <summary>Required. The resource name of the SqlIntegrations using the form:
                            /// `projects/{project_id}/locations/global/domains`</summary>
                            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                            public virtual string Parent { get; private set; }

                            /// <summary>Optional. Filter specifying constraints of a list operation. For example,
                            /// `SqlIntegration.name="sql"`.</summary>
                            ...
                            /// <summary>Optional. The maximum number of items to return. If not specified, a default
                            /// value of 1000 will be used by the service. Regardless of the page_size value, the
                            /// response may include a partial list and a caller should only rely on response'ANIZATIONs
                            /// next_page_token to determine if there are more instances left to be queried.</summary>
                    ...
                    /// <param name="name">The resource domain name, project name and location using the form:
                    ...
                    public class AttachTrustRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.Operation>
                    {
                        ...
                        /// <summary>The resource domain name, project name and location using the form:
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">Resource project name and location using the form:
                    ...
                    public class CreateRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.Operation>
                    {
                        ...
                        /// <summary>Resource project name and location using the form:
                        /// `projects/{project_id}/locations/global`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Parent { get; private set; }

                        /// <summary>The fully qualified domain name. e.g. mydomain.myorganization.com, with the
                        ...
                        /// or a letter. * Must not start with period. * Must be unique within the project. * First
                        /// segement length (mydomain form example above) shouldn't exceed 15 chars. * The last segment
                        /// cannot be fully numeric.</summary>
                    ...
                    /// <param name="name">Domain resource name using the form:
                    /// `projects/{project_id}/locations/global/domains/{domain_name}`</param>
                    ...
                    public class DeleteRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.Operation>
                    {
                        ...
                        /// <summary>Domain resource name using the form:
                        /// `projects/{project_id}/locations/global/domains/{domain_name}`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    public class ListRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.ListDomainsResponse>
                    {
                        ...
                        /// <summary>If not specified, a default value of 1000 will be used by the service. Regardless
                        /// of the page_size value, the response may include a partial list and a caller should only
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Output only. Unique name of the domain in this scope including projects and location using the
                    /// form: `projects/{project_id}/locations/global/domains/{domain_name}`.</param>
                    ...
                    public class PatchRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.Operation>
                    {
                        ...
                        /// <summary>Output only. Unique name of the domain in this scope including projects and
                        ...
                        /// elements of the repeated paths field may only include these fields from Domain: * `labels` *
                        /// `locations` * `authorized_networks` * `audit_logs_enabled`</summary>
                    ...
                    /// <summary>Resets managed identities admin password identified by
                    /// managed_identities_admin_name</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">The domain resource name using the form:
                    /// `projects/{project_id}/locations/global/domains/{domain_name}`</param>
                    ...
                    public class ResetAdminPasswordRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1alpha1.Data.ResetAdminPasswordResponse>
                    {
                        ...
                        /// <summary>The domain resource name using the form:
                        /// `projects/{project_id}/locations/global/domains/{domain_name}`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
...
{    
    ...
    public class SQLIntegration : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The unique name of the sql integration in the form of
        /// `projects/{project_id}/locations/global/domains/{domain_name}/sqlIntegrations/{sql_integration}`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
