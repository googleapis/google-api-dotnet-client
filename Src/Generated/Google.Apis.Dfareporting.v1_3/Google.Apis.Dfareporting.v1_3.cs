...
/**
 * \brief
 *   DFA Reporting API Version v1.3
 *
...
namespace Google.Apis.Dfareporting.v1_3
{
    ...
    public class DfareportingService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            get { return "https://www.googleapis.com/dfareporting/v1.3/"; }
        }

        /// <summary>Gets the service base path.</summary>
        public override string BasePath
        {
            get { return "dfareporting/v1.3/"; }
        }
    ...
    public class DimensionValuesResource
    {
        ...
        public virtual QueryRequest Query(Google.Apis.Dfareporting.v1_3.Data.DimensionValueRequest body, long profileId)
        {
            return new QueryRequest(service, body, profileId);
        }

        /// <summary>Retrieves list of report dimension values for a list of filters.</summary>
        public class QueryRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.DimensionValueList>
        {
            /// <summary>Constructs a new Query request.</summary>
            public QueryRequest(Google.Apis.Services.IClientService service, Google.Apis.Dfareporting.v1_3.Data.DimensionValueRequest body, long profileId)
                : base(service)
            {
                ProfileId = profileId;
                Body = body;
            ...
            Google.Apis.Dfareporting.v1_3.Data.DimensionValueRequest Body { get; set; }
    ...
    public class FilesResource
    {
        ...
        /// <summary>Retrieves a report file by its report ID and file ID.</summary>
        public class GetRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.File>
        {
        ...
        /// <summary>Lists files for a user profile.</summary>
        public class ListRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.FileList>
        {
    ...
    public class ReportsResource
    {
        ...
        public class CompatibleFieldsResource
        {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="profileId">The DFA user profile ID.</param>
            public virtual QueryRequest Query(Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId)
            {
                return new QueryRequest(service, body, profileId);
            }
            ...
            /// <summary>Returns the fields that are compatible to be selected in the respective sections of a report
            /// criteria, given the fields already selected in the input report and user permissions.</summary>
            public class QueryRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.CompatibleFields>
            {
                /// <summary>Constructs a new Query request.</summary>
                public QueryRequest(Google.Apis.Services.IClientService service, Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId)
                    : base(service)
                {
                    ProfileId = profileId;
                    Body = body;
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Dfareporting.v1_3.Data.Report Body { get; set; }
        ...
        /// <summary>Retrieves a report by its ID.</summary>
        public class GetRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.Report>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="profileId">The DFA user profile ID.</param>
        public virtual InsertRequest Insert(Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId)
        {
            return new InsertRequest(service, body, profileId);
        }

        /// <summary>Creates a report.</summary>
        public class InsertRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.Report>
        {
            /// <summary>Constructs a new Insert request.</summary>
            public InsertRequest(Google.Apis.Services.IClientService service, Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId)
                : base(service)
            {
                ProfileId = profileId;
                Body = body;
        ...
        /// <summary>Retrieves list of reports.</summary>
        public class ListRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.ReportList>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, long profileId)
                : base(service)
        ...
        /// <param name="reportId">The ID of the
        /// report.</param>
        public virtual PatchRequest Patch(Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId, long reportId)
        {
            return new PatchRequest(service, body, profileId, reportId);
        }

        /// <summary>Updates a report. This method supports patch semantics.</summary>
        public class PatchRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.Report>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId, long reportId)
                : base(service)
            {
                ProfileId = profileId;
                ReportId = reportId;
        ...
        /// <summary>Runs a report.</summary>
        public class RunRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.File>
        {
        ...
        /// <param name="reportId">The ID of the
        /// report.</param>
        public virtual UpdateRequest Update(Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId, long reportId)
        {
            return new UpdateRequest(service, body, profileId, reportId);
        }

        /// <summary>Updates a report.</summary>
        public class UpdateRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.Report>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dfareporting.v1_3.Data.Report body, long profileId, long reportId)
                : base(service)
            {
                ProfileId = profileId;
                ReportId = reportId;
    ...
    public class UserProfilesResource
    {
        ...
        /// <summary>Gets one user profile by ID.</summary>
        public class GetRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.UserProfile>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Retrieves list of user profiles for a user.</summary>
        public class ListRequest : DfareportingBaseServiceRequest<Google.Apis.Dfareporting.v1_3.Data.UserProfileList>
        {
            /// <summary>Constructs a new List request.</summary>
...
namespace Google.Apis.Dfareporting.v1_3.Data
{    
