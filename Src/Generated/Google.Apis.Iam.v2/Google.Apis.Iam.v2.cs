...
namespace Google.Apis.Iam.v2
{
    ...
    public class PoliciesResource
    {
        ...
        public class OperationsResource
        {
            ...
            /// result at intervals as recommended by the API service.
            /// </summary>
            public class GetRequest : IamBaseServiceRequest<Google.Apis.Iam.v2.Data.GoogleLongrunningOperation>
            {
        ...
        /// numeric ID.
        /// </param>
        public virtual CreatePolicyRequest CreatePolicy(Google.Apis.Iam.v2.Data.GoogleIamV2Policy body, string parent)
        {
            return new CreatePolicyRequest(this.service, body, parent);
        }

        /// <summary>Creates a policy.</summary>
        public class CreatePolicyRequest : IamBaseServiceRequest<Google.Apis.Iam.v2.Data.GoogleLongrunningOperation>
        {
            /// <summary>Constructs a new CreatePolicy request.</summary>
            public CreatePolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Iam.v2.Data.GoogleIamV2Policy body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
            ...
            Google.Apis.Iam.v2.Data.GoogleIamV2Policy Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v2/{+parent}";
        ...
        /// <summary>Deletes a policy. This action is permanent.</summary>
        public class DeleteRequest : IamBaseServiceRequest<Google.Apis.Iam.v2.Data.GoogleLongrunningOperation>
        {
        ...
        /// <summary>Gets a policy.</summary>
        public class GetRequest : IamBaseServiceRequest<Google.Apis.Iam.v2.Data.GoogleIamV2Policy>
        {
            /// <summary>Constructs a new Get request.</summary>
            public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
            {
        ...
        /// metadata. In particular, policy rules are omitted.
        /// </summary>
        public class ListPoliciesRequest : IamBaseServiceRequest<Google.Apis.Iam.v2.Data.GoogleIamV2ListPoliciesResponse>
        {
        ...
        /// </param>
        public virtual UpdateRequest Update(Google.Apis.Iam.v2.Data.GoogleIamV2Policy body, string name)
        {
        ...
        /// prevent conflicts between concurrent updates.
        /// </summary>
        public class UpdateRequest : IamBaseServiceRequest<Google.Apis.Iam.v2.Data.GoogleLongrunningOperation>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Iam.v2.Data.GoogleIamV2Policy body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
...
namespace Google.Apis.Iam.v2.Data
{
    ...
    public class GoogleIamV2ListPoliciesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        ...
        public virtual System.Collections.Generic.IList<GoogleIamV2Policy> Policies { get; set; }
    ...
    public class GoogleIamV2PolicyOperationMetadata : Google.Apis.Requests.IDirectResponseSchema
    {
        private string _createTimeRaw;
