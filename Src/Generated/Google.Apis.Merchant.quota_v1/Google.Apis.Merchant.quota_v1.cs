...
namespace Google.Apis.Merchant.quota_v1
{
    ...
    public class AccountsResource
    {
        ...
        public class LimitsResource
        {
            ...
            /// <summary>Retrieves an account limit.</summary>
            public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.quota_v1.Data.AccountLimit>
            {
                ...
                public override string RestPath => "quota/v1/{+name}";
            ...
            /// <summary>Lists the limits of an account.</summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.quota_v1.Data.ListAccountLimitsResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "quota/v1/{+parent}/limits";
        ...
        public class QuotasResource
        {
            ...
            /// <summary>Lists the daily call quota and usage per group for your Merchant Center account.</summary>
            /// <param name="parent">
            ...
            /// <summary>Lists the daily call quota and usage per group for your Merchant Center account.</summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.quota_v1.Data.ListQuotaGroupsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "quota/v1/{+parent}/quotas";
...
namespace Google.Apis.Merchant.quota_v1.Data
{
    ...
    /// <summary>The method details per method in the Merchant API.</summary>
    public class MethodDetails : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. The name of the method for example `products.list`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("method")]
        public virtual string Method { get; set; }

        /// <summary>Output only. The path for the method such as `products/v1/productInputs.insert`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("path")]
        public virtual string Path { get; set; }

        /// <summary>Output only. The sub-API that the method belongs to.</summary>
    ...
    /// <summary>
    /// The group information for methods in the Merchant API. The quota is shared between all methods in the group.
    /// Even if none of the methods within the group have usage the information for the group is returned.
    /// </summary>
    public class QuotaGroup : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Identifier. The resource name of the quota group. Format: accounts/{account}/quotas/{group} Note: There is
        /// no guarantee on the format of {group}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
