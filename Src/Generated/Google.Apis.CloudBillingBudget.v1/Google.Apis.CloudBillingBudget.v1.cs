...
namespace Google.Apis.CloudBillingBudget.v1
{
    ...
    public class BillingAccountsResource
    {
        ...
        public class BudgetsResource
        {
            ...
            /// <summary>Creates a new budget. See [Quotas and limits](https://cloud.google.com/billing/quotas) for more
            /// information on the limits of the number of budgets you can create.</summary>
            ...
            public class PatchRequest : CloudBillingBudgetBaseServiceRequest<Google.Apis.CloudBillingBudget.v1.Data.GoogleCloudBillingBudgetsV1Budget>
            {
                ...
                /// <summary>Optional. Indicates which fields in the provided budget to update. Read-only fields (such
                /// as `name`) cannot be changed. If this is not provided, then only fields with non-default values from
                /// the request are updated. See https://developers.google.com/protocol-buffers/docs/proto3#default for
                /// more details about default values.</summary>
...
{    
    ...
    public class GoogleCloudBillingBudgetsV1Filter : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// the parent account, usage from the parent account will be included. If the field is omitted, the report will
        /// include usage from the parent account and all subaccounts, if they exist.</summary>
