...
namespace Google.Apis.Cloudchannel.v1
{
    ...
    public class AccountsResource
    {
        ...
        public class ChannelPartnerLinksResource
        {
            ...
            /// reseller channel. To accept the invite, the invited partner should follow the invite_link_uri provided
            /// in the response. If the link creation is accepted, a valid link is set up between the two involved
            /// parties. To call this method, you must be a distributor. Possible Error Codes: * PERMISSION_DENIED: If
            /// the reseller account making the request and the reseller account being queried for are different. *
            /// INVALID_ARGUMENT: Missing or invalid required parameters in the request. * ALREADY_EXISTS: If the
            /// ChannelPartnerLink sent in the request already exists. * NOT_FOUND: If no Cloud Identity customer exists
            /// for domain provided. * INTERNAL: Any non-user error related to a technical issue in the backend. In this
            /// case, contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the
            /// backend. In this case, contact Cloud Channel support. Return Value: Newly created ChannelPartnerLink
            /// resource if successful, otherwise error is returned.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">
            /// Required. The resource name of reseller's account for which to create a channel partner link. The parent
            ...
            /// Possible Error Codes: * PERMISSION_DENIED: If the reseller account making the request and the reseller
            /// account being queried for are different. * INVALID_ARGUMENT: Missing or invalid required parameters in
            /// the request. * NOT_FOUND: ChannelPartnerLink resource not found. Results due invalid channel partner
            /// link name. Return Value: ChannelPartnerLink resource if found, otherwise returns an error.
            /// </summary>
            /// <param name="name">
            ...
            /// Possible Error Codes: * PERMISSION_DENIED: If the reseller account making the request and the reseller
            /// account being queried for are different. * INVALID_ARGUMENT: Missing or invalid required parameters in
            /// the request. Return Value: If successful, returns the list of ChannelPartnerLink resources for the
            /// distributor account, otherwise returns an error.
            /// </summary>
            /// <param name="parent">
            /// Required. The resource name of the reseller account for listing channel partner links. The parent takes
            ...
            public class ListRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleCloudChannelV1ListChannelPartnerLinksResponse>
            {
                ...
                /// <summary>
                /// Optional. A token identifying a page of results, if other than the first one. Typically obtained via
            ...
            /// <summary>
            /// Updates a channel partner link. A distributor calls this method to change a link's status. For example,
            /// suspend a partner link. To call this method, you must be a distributor. Possible Error Codes: *
            /// PERMISSION_DENIED: If the reseller account making the request and the reseller account being queried for
            /// are different. * INVALID_ARGUMENT: It can happen in following scenarios - * Missing or invalid required
            /// parameters in the request. * Updating link state from invited to active or suspended. * Sending
            /// reseller_cloud_identity_id, invite_url or name in update mask. * NOT_FOUND: ChannelPartnerLink resource
            /// not found. * INTERNAL: Any non-user error related to a technical issue in the backend. In this case,
            /// contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the
            /// backend. In this case, contact Cloud Channel support. Return Value: If successful, the updated
        ...
        public class CustomersResource
        {
            ...
            public class EntitlementsResource
            {
                ...
                /// <summary>
                /// Activates a previously suspended entitlement. The entitlement must be in a suspended state for it to
                /// be activated. Entitlements suspended for pending ToS acceptance can't be activated using this
                /// method. An entitlement activation is a long-running operation and can result in updates to the state
                /// of the customer entitlement. Possible Error Codes: * PERMISSION_DENIED: If the customer doesn't
                /// belong to the reseller or if the reseller account making the request and reseller account being
                /// queried for are different. * INVALID_ARGUMENT: Missing or invalid required parameters in the
                /// request. * NOT_FOUND: Entitlement resource not found. * SUSPENSION_NOT_RESELLER_INITIATED: Can't
                /// activate an entitlement that is pending TOS acceptance. Only reseller initiated suspensions can be
                /// activated. * NOT_SUSPENDED: Can't activate entitlements that are already in ACTIVE state. Can only
                /// activate suspended entitlements. * INTERNAL: Any non-user error related to a technical issue in the
                ...
                /// Possible Error Codes: * PERMISSION_DENIED: If the customer doesn't belong to the reseller or if the
                /// reseller account making the request and reseller account being queried for are different. *
                /// FAILED_PRECONDITION: If there are any Google Cloud projects linked to the Google Cloud entitlement's
                /// Cloud Billing subaccount. * INVALID_ARGUMENT: Missing or invalid required parameters in the request.
                /// * NOT_FOUND: Entitlement resource not found. * DELETION_TYPE_NOT_ALLOWED: Cancel is only allowed for
                /// Google Workspace add-ons or entitlements for Google Cloud's development platform. * INTERNAL: Any
                /// non-user error related to a technical issue in the backend. In this case, contact Cloud Channel
                /// support. * UNKNOWN: Any non-user error related to a technical issue in the backend. In this case,
                /// contact Cloud Channel support. Return Value: Long Running Operation ID. To get the results of the
                /// operation, call the GetOperation method of CloudChannelOperationsService. The response will contain
                ...
                /// not found. * INTERNAL: Any non-user error related to a technical issue in the backend. In this case,
                /// contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the
                /// backend. In this case, contact Cloud Channel support. Return Value: Long Running Operation ID. To
                ...
                /// invalid required parameters in the request. For example, if the number of seats being changed to is
                /// greater than the allowed number of max seats for the resource. Or decreasing seats for a commitment
                /// based plan. * NOT_FOUND: Entitlement resource not found. * INTERNAL: Any non-user error related to a
                /// technical issue in the backend. In this case, contact Cloud Channel support. * UNKNOWN: Any non-user
                /// error related to a technical issue in the backend. In this case, contact Cloud Channel support.
                /// Return Value: Long Running Operation ID. To get the results of the operation, call the GetOperation
                ...
                /// related to a technical issue in the backend. In this case, contact Cloud Channel support. * UNKNOWN:
                /// Any non user error related to a technical issue in the backend. In this case, contact Cloud Channel
                /// support. Return Value: Long Running Operation ID. To get the results of the operation, call the
                ...
                /// doesn't belong to the reseller. * INVALID_ARGUMENT: It can happen in below scenarios - * Missing or
                /// invalid required parameters in the request. * Cannot purchase an entitlement if there is already an
                /// entitlement for customer, for a SKU from the same product family. * INVALID_VALUE: Offer passed in
                /// isn't valid. Make sure OfferId is valid. If it is valid, then contact Google Channel support for
                /// further troubleshooting. * NOT_FOUND: If the customer or offer resource is not found for the
                /// reseller. * ALREADY_EXISTS: This failure can happen in the following cases: * If the SKU has been
                /// already purchased for the customer. * If the customer's primary email already exists. In this case
                /// retry after changing the customer's primary contact email. * CONDITION_NOT_MET or
                /// FAILED_PRECONDITION: This failure can happen in the following cases: * Purchasing a SKU that
                /// requires domain verification and the domain has not been verified. * Purchasing an Add-On SKU like
                /// Vault or Drive without purchasing the pre-requisite SKU, such as Google Workspace Business Starter.
                /// * Applicable only for developer accounts: reseller and resold domain. Must meet the following domain
                /// naming requirements: * Domain names must start with goog-test. * Resold domain names must include
                ...
                /// issue in the backend. Contact Cloud Channel Support in this case. Return Value: Long Running
                ...
                public class CreateRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleLongrunningOperation>
                {
                    ...
                    /// <summary>
                    /// Required. The resource name of reseller's customer account in which to create the entitlement.
                ...
                /// <summary>
                /// Returns a requested Entitlement resource. Possible Error Codes: * PERMISSION_DENIED: If the customer
                /// doesn't belong to the reseller. * INVALID_ARGUMENT: Missing or invalid required parameters in the
                /// request. * NOT_FOUND: If the entitlement is not found for the customer. Return Value: If found, the
                ...
                /// customer doesn't belong to the reseller. * INVALID_ARGUMENT: Missing or invalid required parameters
                /// in the request. Return Value: List of Entitlements belonging to the customer, or empty list if there
                /// are none.
                /// </summary>
                /// <param name="parent">
                ...
                public class ListRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleCloudChannelV1ListEntitlementsResponse>
                {
                    ...
                    /// <summary>
                    /// Required. The resource name of the reseller's customer account for which to list entitlements.
                    /// The parent takes the format: accounts/{account_id}/customers/{customer_id}
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                    ...
                    /// <summary>
                    /// Optional. Requested page size. Server might return fewer results than requested. If unspecified,
                    /// at most 50 entitlements will be returned. The maximum value is 100; values above 100 will be
                    /// coerced to 100.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }
                    ...
                    /// via ListEntitlementsResponse.next_page_token of the previous
                ...
                /// customer doesn't belong to the reseller. * INVALID_ARGUMENT: Missing or invalid required parameters
                /// in the request. * NOT_FOUND: Entitlement resource not found. * FAILED_PRECONDITION/NOT_IN_TRIAL:
                /// This method only works for entitlement on trial plans. * INTERNAL: Any non-user error related to a
                /// technical issue in the backend. In this case, contact Cloud Channel support. * UNKNOWN: Any non-user
                /// error related to a technical issue in the backend. In this case, contact Cloud Channel support.
                /// Return Value: Long Running Operation ID. To get the results of the operation, call the GetOperation
                /// method of CloudChannelOperationsService. The Operation metadata will contain an instance of
                ...
                public class StartPaidServiceRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleLongrunningOperation>
                {
                    ...
                    /// <summary>
                    /// Required. The name of the entitlement for which paid service is being started. The name takes
                ...
                /// to a technical issue in the backend. In this case, contact Cloud Channel support. * UNKNOWN: Any
                /// non-user error related to a technical issue in the backend. In this case, contact Cloud Channel
                /// support. Return Value: Long Running Operation ID. To get the results of the operation, call the
                /// GetOperation method of CloudChannelOperationsService. The Operation metadata will contain an
                /// instance of OperationMetadata.
            ...
            /// PERMISSION_DENIED: If the reseller account making the request and the reseller account being queried for
            /// are different. * INVALID_ARGUMENT: It can happen in following scenarios - * Missing or invalid required
            /// parameters in the request. * Domain field value doesn't match the domain specified in primary email.
            /// Return Value: If successful, the newly created Customer resource, otherwise returns an error.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">
            /// Required. The resource name of reseller account in which to create the customer. The parent takes the
            ...
            /// <summary>
            /// Deletes the given Customer permanently and irreversibly. Possible Error Codes: * PERMISSION_DENIED: If
            /// the account making the request does not own this customer. * INVALID_ARGUMENT: Missing or invalid
            /// required parameters in the request. * FAILED_PRECONDITION: If the customer has existing entitlements. *
            ...
            /// account making the request and the reseller account being queried for are different. * INVALID_ARGUMENT:
            /// Missing or invalid required parameters in the request. * NOT_FOUND: If the customer resource doesn't
            /// exist. Usually the result of an invalid name parameter. Return Value: Customer resource if found, error
            /// otherwise.
            /// </summary>
            /// <param name="name">
            ...
            /// <summary>
            /// List downstream Customers. Possible Error Codes: * PERMISSION_DENIED: If the reseller account making the
            /// request and the reseller account being queried for are different. * INVALID_ARGUMENT: Missing or invalid
            /// required parameters in the request. Return Value: List of Customers pertaining to the reseller or empty
            /// list if there are none.
            /// </summary>
            /// <param name="parent">
            /// Required. The resource name of the reseller account from which to list customers. The parent takes the
            /// format: accounts/{account_id}.
            /// </param>
            public virtual ListRequest List(string parent)
            {
            ...
            public class ListRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleCloudChannelV1ListCustomersResponse>
            {
                ...
                /// If unspecified, at most 10 customers will be returned. The maximum value is 50; values about 50 will
                /// be coerced to 50.
                /// </summary>
                [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                public virtual System.Nullable<int> PageSize { get; set; }
            ...
            /// customer * Offers that can be changed to, for an entitlement. Possible Error Codes: * PERMISSION_DENIED:
            /// If the customer doesn't belong to the reseller * INVALID_ARGUMENT: Missing or invalid required
            ...
            public class ListPurchasableOffersRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleCloudChannelV1ListPurchasableOffersResponse>
            {
                ...
                /// <summary>
                /// Optional. The BCP-47 language code, such as "en-US". If specified, the response will be localized to
                /// the corresponding language code. Default is "en-US".
                /// </summary>
                ...
                /// <summary>Optional. A token identifying a page of results, if other than the first one.</summary>
                [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string PageToken { get; set; }
            ...
            /// <summary>
            /// Lists the Purchasable SKUs for following cases: * SKUs that can be newly purchased for a customer * SKUs
            /// that can be upgraded/downgraded to, for an entitlement. Possible Error Codes: * PERMISSION_DENIED: If
            /// the customer doesn't belong to the reseller * INVALID_ARGUMENT: Missing or invalid required parameters
            /// in the request.
            /// </summary>
            /// <param name="customer">
            ...
            /// <summary>
            /// Updates an existing Customer resource belonging to the reseller or distributor. Possible Error Codes: *
            /// PERMISSION_DENIED: If the reseller account making the request and the reseller account being queried for
            /// are different. * INVALID_ARGUMENT: Missing or invalid required parameters in the request. * NOT_FOUND:
            /// No Customer resource found for the name specified in the request. Return Value: If successful, the
            /// updated Customer resource, otherwise returns an error.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">
            ...
            /// provided here, if present. Possible Error Codes: * PERMISSION_DENIED: If the customer doesn't belong to
            /// the reseller. * INVALID_ARGUMENT: Missing or invalid required parameters in the request. * NOT_FOUND: If
            /// the customer is not found for the reseller. * ALREADY_EXISTS: If the customer's primary email already
            /// exists. In this case, retry after changing the customer's primary contact email. * INTERNAL: Any
            /// non-user error related to a technical issue in the backend. Contact Cloud Channel support in this case.
            /// * UNKNOWN: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support
            /// in this case. Return Value: Long Running Operation ID. To get the results of the operation, call the
            /// GetOperation method of CloudChannelOperationsService. The Operation metadata will contain an instance of
            /// OperationMetadata.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="customer">
            ...
            /// <summary>
            /// Transfers customer entitlements to new reseller. Possible Error Codes: * PERMISSION_DENIED: If the
            /// customer doesn't belong to the reseller. * INVALID_ARGUMENT: Missing or invalid required parameters in
            /// the request. * NOT_FOUND: If the customer or offer resource is not found for the reseller. *
            /// ALREADY_EXISTS: If the SKU has been already transferred for the customer. * CONDITION_NOT_MET or
            /// FAILED_PRECONDITION: This failure can happen in the following cases: * Transferring a SKU that requires
            /// domain verification and the domain has not been verified. * Transferring an Add-On SKU like Vault or
            /// Drive without transferring the pre-requisite SKU, such as G Suite Basic. * Applicable only for developer
            /// accounts: reseller and resold domain must follow the domain naming convention as follows: * Domain names
            /// must start with goog-test. * Resold domain names must include the reseller domain. * All transferring
            /// entitlements must be specified. * INTERNAL: Any non-user error related to a technical issue in the
            /// backend. Please contact Cloud Channel Support in this case. * UNKNOWN: Any non-user error related to a
            /// technical issue in the backend. Please contact Cloud Channel Support in this case. Return Value: Long
            /// Running Operation ID. To get the results of the operation, call the GetOperation method of
            /// CloudChannelOperationsService. The Operation metadata will contain an instance of OperationMetadata.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            ...
            /// PERMISSION_DENIED: If the customer doesn't belong to the reseller. * INVALID_ARGUMENT: Missing or
            /// invalid required parameters in the request. * NOT_FOUND: If the customer or offer resource is not found
            /// for the reseller. * ALREADY_EXISTS: If the SKU has been already transferred for the customer. *
            /// CONDITION_NOT_MET or FAILED_PRECONDITION: This failure can happen in the following cases: * Transferring
            /// a SKU that requires domain verification and the domain has not been verified. * Transferring an Add-On
            /// SKU like Vault or Drive without purchasing the pre-requisite SKU, such as G Suite Basic. * Applicable
            /// only for developer accounts: reseller and resold domain must follow the domain naming convention as
            /// follows: * Domain names must start with goog-test. * Resold domain names must include the reseller
            /// domain. * INTERNAL: Any non-user error related to a technical issue in the backend. Please contact Cloud
            /// Channel Support in this case. * UNKNOWN: Any non-user error related to a technical issue in the backend.
            /// Please contact Cloud Channel Support in this case. Return Value: Long Running Operation ID. To get the
            /// results of the operation, call the GetOperation method of CloudChannelOperationsService. The response
            /// will contain google.protobuf.Empty on success. The Operation metadata will contain an instance of
            /// OperationMetadata.
            /// </summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">
            /// Required. The resource name of reseller's customer account where the entitlements transfer from. The
            /// parent takes the format: accounts/{account_id}/customers/{customer_id}
            /// </param>
        ...
        /// <summary>
        /// Confirms the existence of Cloud Identity accounts, based on the domain and whether the Cloud Identity
        /// accounts are owned by the reseller. Possible Error Codes: * PERMISSION_DENIED: If the reseller account
        /// making the request and the reseller account being queried for are different. * INVALID_ARGUMENT: Missing or
        /// invalid required parameters in the request. * INVALID_VALUE: Invalid domain value in the request. Return
        /// Value: List of CloudIdentityCustomerAccount resources for the domain. List may be empty. Note: in the
        /// v1alpha1 version of the API, a NOT_FOUND error is returned if no CloudIdentityCustomerAccount resources
        /// match the domain.
        /// </summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="parent">
        ...
        /// Services account. Possible Error Codes: * PERMISSION_DENIED: If the reseller account making the request and
        /// the reseller account being provided are different, or if the account is not a super admin. *
        /// INVALID_ARGUMENT: Missing or invalid required parameters in the request. * NOT_FOUND: If the topic resource
        /// doesn't exist. * INTERNAL: Any non-user error related to a technical issue in the backend. In this case,
        /// contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the backend. In
        /// this case, contact Cloud Channel support. Return Value: List of service email addresses if successful,
        ...
        public class ListSubscribersRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleCloudChannelV1ListSubscribersResponse>
        {
            ...
            /// value. If unspecified, at most 100 service accounts will be returned. The maximum value is 1000; values
        ...
        /// <summary>
        /// List TransferableOffers of a customer based on Cloud Identity ID or Customer Name in the request. This
        /// method is used when a reseller gets the entitlement information of a customer that is not owned. The
        /// reseller should provide the customer's Cloud Identity ID or Customer Name. Possible Error Codes: *
        /// PERMISSION_DENIED: Appears because of one of the following: * If the customer doesn't belong to the reseller
        /// and no auth token or invalid auth token is supplied. * If the reseller account making the request and the
        /// reseller account being queried for are different. * INVALID_ARGUMENT: Missing or invalid required parameters
        /// in the request. Return Value: List of TransferableOffer for the given customer and SKU.
        /// </summary>
        /// <param name="body">The body of the request.</param>
        ...
        /// <summary>
        /// List TransferableSkus of a customer based on Cloud Identity ID or Customer Name in the request. This method
        /// is used when a reseller lists the entitlements information of a customer that is not owned. The reseller
        /// should provide the customer's Cloud Identity ID or Customer Name. Possible Error Codes: * PERMISSION_DENIED:
        /// Appears because of one of the following - * The customer doesn't belong to the reseller and no auth token. *
        /// The supplied auth token is invalid. * The reseller account making the request and the queries reseller
        /// account are different. * INVALID_ARGUMENT: Missing or invalid required parameters in the request. Return
        ...
        /// <summary>
        /// Registers a service account with subscriber privileges on the Cloud Pub/Sub topic created for this Channel
        /// Services account. Once you create a subscriber, you will get the events as per SubscriberEvent Possible
        /// Error Codes: * PERMISSION_DENIED: If the reseller account making the request and the reseller account being
        /// provided are different, or if the impersonated user is not a super admin. * INVALID_ARGUMENT: Missing or
        /// invalid required parameters in the request. * INTERNAL: Any non-user error related to a technical issue in
        /// the backend. In this case, contact Cloud Channel support. * UNKNOWN: Any non-user error related to a
        /// technical issue in the backend. In this case, contact Cloud Channel support. Return Value: Topic name with
        ...
        /// Services account. If there are no more service account left with sunbscriber privileges, the topic will be
        /// deleted. You can check this by calling ListSubscribers api. Possible Error Codes: * PERMISSION_DENIED: If
        /// the reseller account making the request and the reseller account being provided are different, or if the
        /// impersonated user is not a super admin. * INVALID_ARGUMENT: Missing or invalid required parameters in the
        /// request. * NOT_FOUND: If the topic resource doesn't exist. * INTERNAL: Any non-user error related to a
        /// technical issue in the backend. In this case, contact Cloud Channel support. * UNKNOWN: Any non-user error
        /// related to a technical issue in the backend. In this case, contact Cloud Channel support. Return Value:
        /// Topic name from which service email address has been unregistered if successful, otherwise error is
        /// returned. If the service email was already not associated with the topic, the success response will be
        /// returned.
        /// </summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="account">Required. Resource name of the account.</param>
    ...
    public class ProductsResource
    {
        ...
        /// <summary>
        /// Lists the Products the reseller is authorized to sell. Possible Error Codes: * INVALID_ARGUMENT: Missing or
        ...
        public class ListRequest : CloudchannelBaseServiceRequest<Google.Apis.Cloudchannel.v1.Data.GoogleCloudChannelV1ListProductsResponse>
        {
            ...
            /// <summary>
            /// Optional. The BCP-47 language code, such as "en-US". If specified, the response will be localized to the
            ...
            /// <summary>
            /// Optional. Requested page size. Server might return fewer results than requested. If unspecified, at most
            /// 100 Products will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
            /// </summary>
            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<int> PageSize { get; set; }
...
namespace Google.Apis.Cloudchannel.v1.Data
{
    ...
    public class GoogleCloudChannelV1ActivateEntitlementRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// your request, the server will know to ignore the request if it has already been completed. For example,
    ...
    public class GoogleCloudChannelV1ChangeRenewalSettingsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// request, the server will know to ignore the request if it has already been completed. For example, consider
        /// a situation where you make an initial request and the request times out. If you make the request again with
        /// the same request ID, the server can check if the original operation with the same request ID was received,
        /// and if so, will ignore the second request. The request ID must be a valid
        /// [UUID](https://tools.ietf.org/html/rfc4122) with the exception that zero UUID is not supported
        /// (`00000000-0000-0000-0000-000000000000`).
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("requestId")]
    ...
    {
        /// <summary>Required. Domain for which the Cloud Identity account customer is fetched.</summary>
    ...
    /// <summary>
    /// Entity representing a Cloud Identity account which may or may not be associated with a Channel Services API
    /// partner.
    /// </summary>
    public class GoogleCloudChannelV1CloudIdentityCustomerAccount : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Cloud Identity ID of the customer. This field is populated ONLY if existing = true.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("customerCloudIdentityId")]
        public virtual string CustomerCloudIdentityId { get; set; }

        /// <summary>
        /// Name of the customer that owns the Cloud Identity account. This field is populated ONLY if owned = true. The
        /// customer_name takes the format: accounts/{account_id}/customers/{customer_id}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("customerName")]
        public virtual string CustomerName { get; set; }

        /// <summary>True if a Cloud Identity account exists for a specific domain.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("existing")]
        public virtual System.Nullable<bool> Existing { get; set; }

        /// <summary>
        /// True if the Cloud Identity account is associated with a customer belonging to the Channel Services partner
        /// making the API call.
        /// </summary>
    ...
    {
        /// <summary>The customers belonging to the reseller or distributor.</summary>
    ...
    {
        /// <summary>The entitlements belonging to the reseller's customer.</summary>
    ...
    public class GoogleCloudChannelV1ListTransferableOffersRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The BCP-47 language code, such as "en-US". If specified, the response will be localized to the corresponding
        ...
        /// <summary>
        /// Requested page size. Server might return fewer results than requested. If unspecified, at most 100 Offers
        ...
        /// <summary>Required. SKU for which the Offers are being looked up.</summary>
    ...
    {
        /// <summary>
        /// This token is generated by the Super Admin of the resold customer to authorize a reseller to access their
        /// Cloud Identity and purchase entitlements on their behalf. This token can be omitted once the authorization
        /// is generated. See https://support.google.com/a/answer/7643790 for more details.
        /// </summary>
        ...
        /// <summary>
        /// A reseller is required to create a customer and use the resource name of the created customer here. The
        /// customer_name takes the format: accounts/{account_id}/customers/{customer_id}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("customerName")]
        public virtual string CustomerName { get; set; }
        ...
        /// <summary>
        /// Requested page size. Server might return fewer results than requested. If unspecified, at most 100 SKUs will
        /// be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. Optional.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pageSize")]
        public virtual System.Nullable<int> PageSize { get; set; }
    ...
    public class GoogleCloudChannelV1ListTransferableSkusResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Information about existing SKUs for a customer that would need to be transferred.</summary>
    ...
    public class GoogleCloudChannelV1ProvisionCloudIdentityRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>If set, validate the request and preview the review, but do not actually post it.</summary>
    ...
    /// <summary>Offer that can be puchased for a customer. This is used in ListPurchasableOffer API response.</summary>
    ...
    /// <summary>SKU that can be used for a puchase. This is used in ListPurchasableSku API response.</summary>
    ...
    {
        /// <summary>Required. Service account which will provide subscriber access to the registered topic.</summary>
    ...
    {
        /// <summary>Name of the topic to which the subscriber will listen to.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("topic")]
        public virtual string Topic { get; set; }
    ...
    public class GoogleCloudChannelV1TransferEntitlementsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The new entitlements to be created or transferred.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("entitlements")]
        public virtual System.Collections.Generic.IList<GoogleCloudChannelV1Entitlement> Entitlements { get; set; }
    ...
    /// <summary>
    /// Response message for CloudChannelService.TransferEntitlements. This will be put into the response field of
    /// google.longrunning.Operation.
    /// </summary>
    public class GoogleCloudChannelV1TransferEntitlementsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The entitlements that have been transferred.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("entitlements")]
        public virtual System.Collections.Generic.IList<GoogleCloudChannelV1Entitlement> Entitlements { get; set; }
    ...
    {
        /// <summary>Required. The entitlements to be transferred to Google.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("entitlements")]
        public virtual System.Collections.Generic.IList<GoogleCloudChannelV1Entitlement> Entitlements { get; set; }
    ...
    {
        /// <summary>Name of the topic from which the service account subscriber access has been removed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("topic")]
        public virtual string Topic { get; set; }
    ...
    {
        /// <summary>
        /// Required. The channel partner link to update. Only field channel_partner_link.link_state is allowed to be
        /// updated.
        /// </summary>
        ...
        /// <summary>
        /// Required. The update mask that applies to the resource. The only allowable value for update mask is
