        ...
        public class LocationsResource
        {
            ...
            public class AuthProvidersResource
            {
                ...
                public class CredentialsResource
                {
                    ...
                    /// <summary>Finalizes the credentials after a successful consent flow.</summary>
                    public class FinalizeRequest : AgentIdentityCredentialsBaseServiceRequest<Google.Apis.AgentIdentityCredentials.v1alpha.Data.GoogleCloudAgentidentitycredentialsV1alphaFinalizeCredentialsResponse>
                    {
                        /// <summary>Constructs a new Finalize request.</summary>
                        public FinalizeRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentityCredentials.v1alpha.Data.GoogleCloudAgentidentitycredentialsV1alphaFinalizeCredentialsRequest body, string authProvider) : base(service)
                        {
                        ...
                        Google.Apis.AgentIdentityCredentials.v1alpha.Data.GoogleCloudAgentidentitycredentialsV1alphaFinalizeCredentialsRequest Body { get; set; }
                        ...
                        public override string RestPath => "v1alpha/{+authProvider}/credentials:finalize";
                    ...
                    /// comments on `RetrieveCredentialsResponse` for more information.
                    /// </summary>
                    public class RetrieveRequest : AgentIdentityCredentialsBaseServiceRequest<Google.Apis.AgentIdentityCredentials.v1alpha.Data.GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsResponse>
                    {
                        /// <summary>Constructs a new Retrieve request.</summary>
                        public RetrieveRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentityCredentials.v1alpha.Data.GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest body, string authProvider) : base(service)
                        {
                            AuthProvider = authProvider;
                            Body = body;
                            InitParameters();
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.AgentIdentityCredentials.v1alpha.Data.GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1alpha/{+authProvider}/credentials:retrieve";
...
namespace Google.Apis.AgentIdentityCredentials.v1alpha.Data
{
    ...
    public class GoogleCloudAgentidentitycredentialsV1alphaSuccess : Google.Apis.Requests.IDirectResponseSchema
    {
