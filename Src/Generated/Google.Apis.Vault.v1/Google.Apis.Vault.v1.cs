 ...
 * <a href='https://apps.google.com/products/vault/'>https://apps.google.com/products/vault/</a>.
 *
...
namespace Google.Apis.Vault.v1
{
    ...
    public class MattersResource
    {
        ...
        /// <summary>Creates a new matter. Returns created matter with default view.</summary>
        /// <param name="body">The body of the request.</param>
