...
namespace Google.Apis.CloudSourceRepositories.v1
{
    ...
    public class ProjectsResource
    {
        ...
        public class ReposResource
        {
            ...
            /// <summary>Creates a repo in the given project with the given name. If the named repository already
            /// exists, `CreateRepo` returns `ALREADY_EXISTS`.</summary>
            ...
            /// <summary>Synchronize a connected repo. The response contains SyncRepoMetadata in the metadata
            /// field.</summary>
            /// <param name="body">The body of the request.</param>
...
{    
    ...
    public class Repo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Resource name of the repository, of the form `projects//repos/`. The repo name may contain slashes.
        /// eg, `projects/myproject/repos/name/with/slash`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
