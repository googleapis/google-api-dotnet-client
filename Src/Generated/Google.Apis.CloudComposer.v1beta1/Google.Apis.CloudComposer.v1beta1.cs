        ...
        public class LocationsResource
        {
            ...
            public class EnvironmentsResource
            {
                ...
                public class CreateRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1beta1.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1beta1.Data.Environment body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                ...
                public class PatchRequest : CloudComposerBaseServiceRequest<Google.Apis.CloudComposer.v1beta1.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudComposer.v1beta1.Data.Environment body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
