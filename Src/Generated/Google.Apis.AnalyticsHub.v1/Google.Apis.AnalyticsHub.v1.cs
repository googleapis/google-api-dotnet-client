...
namespace Google.Apis.AnalyticsHub.v1.Data
{
    ...
    {
        /// <summary>
        /// Optional. The app profile to use for the Bigtable writes. If not specified, the "default" application
        /// profile will be used. The app profile must use single-cluster routing.
        /// </summary>
        ...
        /// <summary>
        /// Optional. When true, write the subscription name, message_id, publish_time, attributes, and ordering_key to
        /// additional columns in the table under the pubsub_metadata column family. The subscription name, message_id,
        /// and publish_time fields are put in their own columns while all other message properties (other than data)
    ...
    public class GooglePubsubV1Subscription : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bigtableConfig")]
        public virtual BigtableConfig BigtableConfig { get; set; }
