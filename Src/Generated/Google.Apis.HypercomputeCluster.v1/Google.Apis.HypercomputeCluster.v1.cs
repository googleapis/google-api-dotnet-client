...
namespace Google.Apis.HypercomputeCluster.v1.Data
{
    ...
    public class NewLustreConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. Immutable. Throughput of the instance in MB/s/TiB. Valid values are 125, 250, 500, 1000. See
        /// [Performance tiers and maximum storage
        /// capacities](https://cloud.google.com/managed-lustre/docs/create-instance#performance-tiers) for more
        /// information.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("perUnitStorageThroughput")]
        public virtual System.Nullable<long> PerUnitStorageThroughput { get; set; }
