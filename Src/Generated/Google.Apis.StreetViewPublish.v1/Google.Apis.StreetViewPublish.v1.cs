...
namespace Google.Apis.StreetViewPublish.v1
{
    ...
    public class PhotoResource
    {
        ...
        /// <summary>After the client finishes uploading the photo with the returned `UploadRef`, `photo.create`
        /// publishes the uploaded photo to Street View on Google Maps.
        ///
        /// This method returns the following error codes:
        ///
        /// * `INVALID_ARGUMENT` if the request is malformed. * `NOT_FOUND` if the upload reference does not
        /// exist.</summary>
        ...
        /// This method returns the following error codes:
        ///
        /// * `PERMISSION_DENIED` if the requesting user did not create the requested photo. * `NOT_FOUND` if the photo
        /// ID does not exist.</summary>
        ...
        /// This method returns the following error codes:
        ///
        /// * `PERMISSION_DENIED` if the requesting user did not create the requested photo. * `NOT_FOUND` if the
        /// requested photo does not exist.</summary>
        /// <param name="photoId">Required. ID of the photo.</param>
        ...
        /// <summary>Creates an upload session to start uploading photo data. The upload URL of the returned `UploadRef`
        /// is used to upload the data for the photo.
        ///
        ...
        /// horizontally.
        ///
        /// After the upload is complete, the `UploadRef` is used with `StreetViewPublishService:CreatePhoto()` to
        /// create the `Photo` object entry.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        /// <summary>Updates the metadata of a photo, such as pose, place association, etc. Changing the pixels of a
        /// photo is not supported.
        ///
        /// This method returns the following error codes:
        ///
        /// * `PERMISSION_DENIED` if the requesting user did not create the requested photo. * `INVALID_ARGUMENT` if the
        /// request is malformed. * `NOT_FOUND` if the photo ID does not exist.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        public class UpdateRequest : StreetViewPublishBaseServiceRequest<Google.Apis.StreetViewPublish.v1.Data.Photo>
        {
            ...
            /// `connections` * `places`
            ///
            /// Note: Repeated fields in `update_mask` mean the entire set of repeated values will be replaced with the
            /// new contents. For example, if `UpdatePhotoRequest.photo.update_mask` contains `connections` and
            /// `UpdatePhotoRequest.photo.connections` is empty, all connections will be removed.</summary>
    ...
    public class PhotosResource
    {
        ...
        ///
        /// Note that if `photos.batchDelete` fails, either critical fields are missing or there was an authentication
        /// error. Even if `photos.batchDelete` succeeds, there may have been failures for single photos in the batch.
        /// These failures will be specified in `BatchDeletePhotosResponse.status`. See `photo.update` for specific
        ...
        ///
        /// Note that if `photos.batchGet` fails, either critical fields are missing or there was an authentication
        /// error. Even if `photos.batchGet` succeeds, there may have been failures for single photos in the batch.
        /// These failures will be specified in `BatchGetPhotosResponse.results.status`. See `photo.get` for specific
        /// failures that can occur per photo.</summary>
        ...
        /// <summary>Updates the metadata of photos, such as pose, place association, etc. Changing the pixels of a
        /// photo is not supported.
        ///
        /// Note that if `photos.batchUpdate` fails, either critical fields are missing or there was an authentication
        /// error. Even if `photos.batchUpdate` succeeds, there may have been failures for single photos in the batch.
        /// These failures will be specified in `BatchUpdatePhotosResponse.results.status`. See `UpdatePhoto` for
        ...
        public class ListRequest : StreetViewPublishBaseServiceRequest<Google.Apis.StreetViewPublish.v1.Data.ListPhotosResponse>
        {
            ...
            /// <summary>The maximum number of photos to return. `page_size` must be non-negative. If `page_size` is
            /// zero or is not provided, the default page size of 100 will be used. The number of photos returned in the
            /// response may be less than `page_size` if the number of photos that belong to the user is less than
            /// `page_size`.</summary>
            ...
            /// <summary>The filter expression. Example: `placeId=ChIJj61dQgK6j4AR4GeTYWZsKWw`</summary>
...
{    
    ...
    {
        /// <summary>Required. List of delete photo requests. For HTTP GET requests, the URL query parameter should be
        /// `photoIds==&...`.</summary>
    ...
    {
        /// <summary>List of results for each individual photo requested, in the same order as the request.</summary>
    ...
    {
        /// <summary>Required. List of update photo requests.</summary>
    ...
    public class ListPhotosResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>List of photos. The maximum number of items returned is based on the `page_size` field in the
        /// request.</summary>
    ...
    public class Photo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The download URL for the photo bytes. This field is set only when the `view` parameter
        /// in a `GetPhotoRequest` is set to `INCLUDE_DOWNLOAD_URL`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("downloadUrl")]
        public virtual string DownloadUrl { get; set; } 

        /// <summary>Output only. Identifier for the photo, which is unique among all photos in Google.</summary>
    ...
    /// <summary>Response payload for a single `Photo` in batch operations including `BatchGetPhotosRequest` and
    /// `BatchUpdatePhotosRequest`.</summary>
    ...
    {
        /// <summary>Required. Place identifier, as described in https://developers.google.com/places/place-
        /// id.</summary>
    ...
    {
        /// <summary>Altitude of the pose in meters above ground level (as defined by WGS84). NaN indicates an
        /// unmeasured quantity.</summary>
    ...
    {
        /// <summary>Required. Photo object containing the new metadata. Only the fields specified in `update_mask` are
        /// used. If `update_mask` is not present, the update applies to all fields. Note: To update `pose.altitude`,
        ...
        /// `connections` * `places`
        ///
        /// Note: Repeated fields in `update_mask` mean the entire set of repeated values will be replaced with the new
        /// contents. For example, if `UpdatePhotoRequest.photo.update_mask` contains `connections` and
        /// `UpdatePhotoRequest.photo.connections` is empty, all connections will be removed.</summary>
