    ...
    public class UsersResource
    {
        ...
        public class SshPublicKeysResource
        {
            ...
            public class PatchRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1beta.Data.SshPublicKey>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1beta.Data.SshPublicKey body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
        ...
        public class ImportSshPublicKeyRequest : CloudOSLoginBaseServiceRequest<Google.Apis.CloudOSLogin.v1beta.Data.ImportSshPublicKeyResponse>
        {
            ...
            public ImportSshPublicKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudOSLogin.v1beta.Data.SshPublicKey body, string parent)
                : base(service)
            {
                Parent = parent;
                Body = body;
