    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.Empty>
                {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.Operation>
                {
                ...
                /// collection id.
                /// </summary>
                public class ListRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.ListOperationsResponse>
                {
            ...
            public class WorkflowsResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.Workflows.v1.Data.Workflow body, string parent)
                {
                ...
                public class CreateRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Workflows.v1.Data.Workflow body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Workflows.v1.Data.Workflow Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/workflows";
                ...
                /// executions of the workflow.
                /// </summary>
                public class DeleteRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.Operation>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                public class PatchRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Workflows.v1.Data.Workflow body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : WorkflowsBaseServiceRequest<Google.Apis.Workflows.v1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
