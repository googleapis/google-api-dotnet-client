...
namespace Google.Apis.WorkspaceEvents.v1
{
    ...
    public class SubscriptionsResource
    {
        ...
        /// approval](https://developers.google.com/workspace/chat/authenticate-authorize-chat-app). - [Developer
        /// Preview](https://developers.google.com/workspace/preview): A Chat app subscribing to all events in a Google
        ...
        /// organization
        /// ](https://developers.google.com/workspace/events/guides/create-subscription#customer-subscription). - A user
        ...
        public class ListRequest : WorkspaceEventsBaseServiceRequest<Google.Apis.WorkspaceEvents.v1.Data.ListSubscriptionsResponse>
        {
            ...
            /// target_resource="//chat.googleapis.com/spaces/{space}"
            /// ```
            /// The following query is available in
            /// [Developer Preview](https://developers.google.com/workspace/preview):
            /// ```
            /// event_types:"google.workspace.chat.message.v1.created" AND
            /// target_resource="//admin.googleapis.com/customers/my_customer"
            /// ```
            /// The server rejects invalid queries
...
namespace Google.Apis.WorkspaceEvents.v1.Data
{
    ...
    public class DriveOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// that are children of the target folder or shared drive. This field must be `true` for subscriptions on
        /// shared drives. * If `false`, the subscription only receives events about changes to the folder or shared
        /// drive that's specified as the `targetResource`. * If `true`, the `mimeType` field of the `file` resource
        /// must be set to `application/vnd.google-apps.folder`. For details, see [Google Drive event
    ...
    public class Subscription : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// account must be owned by the same Google Cloud project where you created this subscription. Format:
