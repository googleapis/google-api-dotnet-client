...
namespace Google.Apis.Merchant.conversions_v1
{
    ...
    public class AccountsResource
    {
        ...
        public class ConversionSourcesResource
        {
            ...
            /// </param>
            public virtual CreateRequest Create(Google.Apis.Merchant.conversions_v1.Data.ConversionSource body, string parent)
            {
                return new CreateRequest(this.service, body, parent);
            }

            /// <summary>Creates a new conversion source.</summary>
            public class CreateRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.conversions_v1.Data.ConversionSource>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.conversions_v1.Data.ConversionSource body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.Merchant.conversions_v1.Data.ConversionSource Body { get; set; }
                ...
                public override string RestPath => "conversions/v1/{+parent}/conversionSources";
            ...
            /// immediately and can be restored by creating a new one.
            /// </summary>
            public class DeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.conversions_v1.Data.Empty>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "conversions/v1/{+name}";
            ...
            /// <summary>Fetches a conversion source.</summary>
            public class GetRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.conversions_v1.Data.ConversionSource>
            {
            ...
            /// <summary>Retrieves the list of conversion sources the caller has access to.</summary>
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.conversions_v1.Data.ListConversionSourcesResponse>
            {
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.Merchant.conversions_v1.Data.ConversionSource body, string name)
            {
            ...
            /// conversion sources.
            /// </summary>
            public class PatchRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.conversions_v1.Data.ConversionSource>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.conversions_v1.Data.ConversionSource body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
            ...
            /// `accounts/{account}/conversionSources/{conversion_source}`
            /// </param>
            public virtual UndeleteRequest Undelete(Google.Apis.Merchant.conversions_v1.Data.UndeleteConversionSourceRequest body, string name)
            {
            ...
            /// sources.
            /// </summary>
            public class UndeleteRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.conversions_v1.Data.ConversionSource>
            {
                /// <summary>Constructs a new Undelete request.</summary>
                public UndeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.conversions_v1.Data.UndeleteConversionSourceRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Merchant.conversions_v1.Data.UndeleteConversionSourceRequest Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "conversions/v1/{+name}:undelete";
...
namespace Google.Apis.Merchant.conversions_v1.Data
{
