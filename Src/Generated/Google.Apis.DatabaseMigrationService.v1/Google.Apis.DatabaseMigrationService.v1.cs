...
namespace Google.Apis.DatabaseMigrationService.v1.Data
{
    ...
    /// </summary>
    public class BadRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Describes all violations in a client request.</summary>
    ...
    /// <summary>A message type used to describe a single bad request field.</summary>
    public class FieldViolation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A description of why the request element is bad.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }
    ...
    public class PostgreSqlConnectionProfile : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. If true, Database Migration Service will use IAM database authentication to connect to the
        /// database.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("enableIamAuthentication")]
        public virtual System.Nullable<bool> EnableIamAuthentication { get; set; }
    ...
    /// <summary>
    /// Describes what preconditions have failed. For example, if an RPC failed because it required the Terms of Service
    /// to be acknowledged, it could list the terms of service violation in the PreconditionFailure message.
    /// </summary>
    public class PreconditionFailure : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Describes all precondition violations.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("violations")]
        public virtual System.Collections.Generic.IList<PreconditionFailureViolation> Violations { get; set; }

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }

    /// <summary>A message type used to describe a single precondition failure.</summary>
    public class PreconditionFailureViolation : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// A description of how the precondition failed. Developers can use this description to understand how to fix
        /// the failure. For example: "Terms of service not accepted".
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }

        /// <summary>
        /// The subject, relative to the type, that failed. For example, "google.com/cloud" relative to the "TOS" type
        /// would indicate which terms of service is being referenced.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("subject")]
        public virtual string Subject { get; set; }

        /// <summary>
        /// The type of PreconditionFailure. We recommend using a service-specific enum type to define the supported
    ...
    /// <summary>
    /// Describes how a quota check failed. For example if a daily limit was exceeded for the calling project, a service
    /// could respond with a QuotaFailure detail containing the project id and the description of the quota limit that
    /// was exceeded. If the calling project hasn't enabled the service in the developer console, then a service could
    /// respond with the project id and set `service_disabled` to true. Also see RetryInfo and Help types for other
    /// details about handling a quota failure.
    /// </summary>
    public class QuotaFailure : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Describes all quota violations.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("violations")]
        public virtual System.Collections.Generic.IList<QuotaFailureViolation> Violations { get; set; }
    ...
    /// <summary>
    /// A message type used to describe a single quota violation. For example, a daily quota or a custom quota that was
    /// exceeded.
    /// </summary>
    public class QuotaFailureViolation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("apiService")]
        public virtual string ApiService { get; set; }

        /// <summary>
        /// A description of how the quota check failed. Clients can use this description to find more about the quota
        /// configuration in the service's public documentation, or find the relevant quota limit to adjust through
        /// developer console. For example: "Service disabled" or "Daily Limit for read operations exceeded".
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("description")]
        public virtual string Description { get; set; }

        /// <summary>
        /// The new quota value being rolled out at the time of the violation. At the completion of the rollout, this
        /// value will be enforced in place of quota_value. If no rollout is in progress at the time of the violation,
        /// this field is not set. For example, if at the time of the violation a rollout is in progress changing the
        /// number of CPUs quota from 10 to 20, 20 would be the value of this field.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("futureQuotaValue")]
        public virtual System.Nullable<long> FutureQuotaValue { get; set; }

        /// <summary>
        /// The dimensions of the violated quota. Every non-global quota is enforced on a set of dimensions. While quota
        /// metric defines what to count, the dimensions specify for what aspects the counter should be increased. For
        /// example, the quota "CPUs per region per VM family" enforces a limit on the metric
        /// "compute.googleapis.com/cpus_per_vm_family" on dimensions "region" and "vm_family". And if the violation
        /// occurred in region "us-central1" and for VM family "n1", the quota_dimensions would be, { "region":
        /// "us-central1", "vm_family": "n1", } When a quota is enforced globally, the quota_dimensions would always be
        /// empty.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("quotaDimensions")]
        public virtual System.Collections.Generic.IDictionary<string, string> QuotaDimensions { get; set; }

        /// <summary>
        /// The id of the violated quota. Also know as "limit name", this is the unique identifier of a quota in the
        /// context of an API service. For example, "CPUS-PER-VM-FAMILY-per-project-region".
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("quotaId")]
        public virtual string QuotaId { get; set; }

        /// <summary>
        /// The metric of the violated quota. A quota metric is a named counter to measure usage, such as API requests
        /// or CPUs. When an activity occurs in a service, such as Virtual Machine allocation, one or more quota metrics
        /// may be affected. For example, "compute.googleapis.com/cpus_per_vm_family",
        /// "storage.googleapis.com/internet_egress_bandwidth".
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("quotaMetric")]
        ...
        /// quantity.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("quotaValue")]
        public virtual System.Nullable<long> QuotaValue { get; set; }

        /// <summary>The subject on which the quota check failed. For example, "clientip:" or "project:".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("subject")]
        public virtual string Subject { get; set; }
    ...
    /// <summary>
    /// Contains metadata about the request that clients can attach when filing a bug or providing other forms of
    /// feedback.
    /// </summary>
    public class RequestInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// An opaque string that should only be interpreted by the service generating it. For example, it can be used
        /// to identify requests in the service's logs.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("requestId")]
        public virtual string RequestId { get; set; }

        /// <summary>
        /// Any data that was used to serve this request. For example, an encrypted stack trace that can be sent back to
        /// the service provider for debugging.
        /// </summary>
    ...
    /// <summary>Describes the resource that is being accessed.</summary>
    public class ResourceInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The owner of the resource (optional). For example, "user:" or "project:".</summary>
        ...
        /// <summary>
        /// A name for the type of resource being accessed, e.g. "sql table", "cloud storage bucket", "file", "Google
        /// calendar"; or the type URL of the resource: e.g. "type.googleapis.com/google.pubsub.v1.Topic".
        /// </summary>
    ...
    /// <summary>
    /// Describes when the clients can retry a failed request. Clients could ignore the recommendation here or retry
    /// when this information is missing from error responses. It's always recommended that clients should use
    /// exponential backoff when retrying. Clients should wait until `retry_delay` amount of time has passed since
    /// receiving the error response before retrying. If retrying requests also fail, clients should use an exponential
    /// backoff scheme to gradually increase the delay between retries based on `retry_delay`, until either a maximum
    /// number of retries have been reached or a maximum retry delay cap has been reached.
    /// </summary>
    public class RetryInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Clients should wait at least this long between retrying the same request.</summary>
