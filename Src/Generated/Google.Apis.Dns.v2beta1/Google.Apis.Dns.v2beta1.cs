...
namespace Google.Apis.Dns.v2beta1
{
    ...
    public class ChangesResource
    {
        ...
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.Change>
        {
            ...
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/changes"; }
            }
        ...
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.Change>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/changes/{changeId}"; }
            }
    ...
    public class DnsKeysResource
    {
        ...
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.DnsKey>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}"; }
            }
        ...
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.DnsKeysListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/dnsKeys"; }
            }
    ...
    public class ManagedZoneOperationsResource
    {
        ...
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.Operation>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/operations/{operation}"; }
            }
        ...
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.ManagedZoneOperationsListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/operations"; }
            }
    ...
    public class ManagedZonesResource
    {
        ...
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.ManagedZone>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones"; }
            }
        ...
        public class DeleteRequest : DnsBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}"; }
            }
    ...
    public class PoliciesResource
    {
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="project">Identifies the project addressed by this request.</param>
        public virtual CreateRequest Create(Google.Apis.Dns.v2beta1.Data.Policy body, string project)
        {
            return new CreateRequest(service, body, project);
        }

        /// <summary>Create a new Policy</summary>
        public class CreateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.Policy>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2beta1.Data.Policy body, string project)
                : base(service)
            {
                Project = project;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Dns.v2beta1.Data.Policy Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/policies"; }
            }
        ...
        public class DeleteRequest : DnsBaseServiceRequest<string>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/policies/{policy}"; }
            }
        ...
        /// <summary>Fetch the representation of an existing Policy.</summary>
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.Policy>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Enumerate all Policies associated with a project.</summary>
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.PoliciesListResponse>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string project)
                : base(service)
        ...
        /// <param name="policy">User
        /// given friendly name of the policy addressed by this request.</param>
        public virtual PatchRequest Patch(Google.Apis.Dns.v2beta1.Data.Policy body, string project, string policy)
        {
            return new PatchRequest(service, body, project, policy);
        }

        /// <summary>Apply a partial update to an existing Policy.</summary>
        public class PatchRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.PoliciesPatchResponse>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2beta1.Data.Policy body, string project, string policy)
                : base(service)
            {
                Project = project;
                Policy = policy;
        ...
        /// <param name="policy">User
        /// given friendly name of the policy addressed by this request.</param>
        public virtual UpdateRequest Update(Google.Apis.Dns.v2beta1.Data.Policy body, string project, string policy)
        {
            return new UpdateRequest(service, body, project, policy);
        }

        /// <summary>Update an existing Policy.</summary>
        public class UpdateRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.PoliciesUpdateResponse>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Dns.v2beta1.Data.Policy body, string project, string policy)
                : base(service)
            {
                Project = project;
                Policy = policy;
    ...
    public class ProjectsResource
    {
        ...
        public class GetRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.Project>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}"; }
            }
    ...
    public class ResourceRecordSetsResource
    {
        ...
        public class ListRequest : DnsBaseServiceRequest<Google.Apis.Dns.v2beta1.Data.ResourceRecordSetsListResponse>
        {
            ...
            public override string RestPath
            {
                get { return "dns/v2beta1/projects/{project}/managedZones/{managedZone}/rrsets"; }
            }
