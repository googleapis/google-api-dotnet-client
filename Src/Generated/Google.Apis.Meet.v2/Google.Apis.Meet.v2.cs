...
namespace Google.Apis.Meet.v2
{
    ...
    public class ConferenceRecordsResource
    {
        ...
        public ConferenceRecordsResource(Google.Apis.Services.IClientService service)
        {
            ...
            SmartNotes = new SmartNotesResource(service);
        ...
        /// <summary>Gets the SmartNotes resource.</summary>
        public virtual SmartNotesResource SmartNotes { get; }

        /// <summary>The "smartNotes" collection of methods.</summary>
        public class SmartNotesResource
        {
            private const string Resource = "smartNotes";

            /// <summary>The service which this resource belongs to.</summary>
            private readonly Google.Apis.Services.IClientService service;

            /// <summary>Constructs a new resource.</summary>
            public SmartNotesResource(Google.Apis.Services.IClientService service)
            {
                this.service = service;
            }
            ...
            public class ListRequest : MeetBaseServiceRequest<Google.Apis.Meet.v2.Data.ListSmartNotesResponse>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v2/{+parent}/smartNotes";
...
namespace Google.Apis.Meet.v2.Data
{
    ...
    /// <summary>Configuration related to meeting artifacts potentially generated by this meeting space.</summary>
    public class ArtifactConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Configuration for recording.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("recordingConfig")]
        public virtual RecordingConfig RecordingConfig { get; set; }

        /// <summary>Configuration for auto-smart-notes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("smartNotesConfig")]
        public virtual SmartNotesConfig SmartNotesConfig { get; set; }

        /// <summary>Configuration for auto-transcript.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("transcriptionConfig")]
    ...
    /// <summary>Response for ListSmartNotes method.</summary>
    public class ListSmartNotesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Token to be circulated back for further List call if current List doesn't include all the smart notes. Unset
        /// if all smart notes are returned.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }

        /// <summary>List of smart notes in one page.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("smartNotes")]
        public virtual System.Collections.Generic.IList<SmartNote> SmartNotes { get; set; }
    ...
    /// <summary>Defines restrictions for features when the meeting is moderated.</summary>
    public class ModerationRestrictions : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Defines who has permission to send chat messages in the meeting space.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("chatRestriction")]
        public virtual string ChatRestriction { get; set; }

        /// <summary>Defines whether to restrict the default role assigned to users as viewer.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("defaultJoinAsViewerType")]
        public virtual string DefaultJoinAsViewerType { get; set; }

        /// <summary>Defines who has permission to share their screen in the meeting space.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("presentRestriction")]
        public virtual string PresentRestriction { get; set; }

        /// <summary>Defines who has permission to send reactions in the meeting space.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("reactionRestriction")]
    ...
    /// <summary>Configuration related to recording in a meeting space.</summary>
    public class RecordingConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Defines whether a meeting space is automatically recorded when someone with the privilege to record joins
        /// the meeting.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoRecordingGeneration")]
        public virtual string AutoRecordingGeneration { get; set; }
    ...
    /// <summary>
    /// Metadata for a smart note generated from a conference. It refers to the notes generated from Take Notes with
    /// Gemini during the conference.
    /// </summary>
    public class SmartNote : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. The Google Doc destination where the smart notes are saved.</summary>
        ...
        /// <summary>Output only. Timestamp when the smart notes stopped.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endTime")]
        public virtual string EndTimeRaw
        {
            get => _endTimeRaw;
        ...
        /// `conferenceRecords/{conference_record}/smartNotes/{smart_note}`, where `{smart_note}` is a 1:1 mapping to
        /// each unique smart notes session of the conference.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
        ...
        /// <summary>Output only. Timestamp when the smart notes started.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("startTime")]
        public virtual string StartTimeRaw
        {
            get => _startTimeRaw;
    ...
    {
        /// <summary>
        /// Defines whether to automatically generate a summary and recap of the meeting for all invitees in the
        /// organization when someone with the privilege to enable smart notes joins the meeting.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("autoSmartNotesGeneration")]
        public virtual string AutoSmartNotesGeneration { get; set; }
    ...
    /// <summary>Configuration related to transcription in a meeting space.</summary>
    public class TranscriptionConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Defines whether the content of a meeting is automatically transcribed when someone with the privilege to
        /// transcribe joins the meeting.
        /// </summary>
