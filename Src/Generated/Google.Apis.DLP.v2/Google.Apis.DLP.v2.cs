...
{    
    ...
    /// [`CryptoReplaceFfxFpeConfig`](/dlp/docs/reference/rest/v2/content/deidentify#CryptoReplaceFfxFpeConfig). These
    /// types of transformations are those that perform pseudonymization, thereby producing a "surrogate" as output.
    /// This should be used in conjunction with a field on the transformation such as `surrogate_info_type`. This custom
    /// info type does not support the use of `detection_rules`.</summary>
