    ...
    public class ProjectsResource
    {
        ...
        public class JobTriggersResource
        {
            ...
            public class ListRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2ListJobTriggersResponse>
            {
                ...
                /// time the JobTrigger was last updated. - `name`: corresponds to JobTrigger's name. - `display_name`:
                /// corresponds to JobTrigger's display name. - `status`: corresponds to JobTrigger's status.</summary>
                [Google.Apis.Util.RequestParameterAttribute("orderBy", Google.Apis.Util.RequestParameterType.Query)]
                public virtual string OrderBy { get; set; }
...
{    
    ...
    /// L7k0BHmF1ha5U3NfGykjro4xWi1MPVQPjhMAZbSV9mM=). Currently, only string and integer values can be
    /// hashed.</summary>
