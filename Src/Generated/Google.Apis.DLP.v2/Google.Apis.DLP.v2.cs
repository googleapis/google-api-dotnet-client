...
namespace Google.Apis.DLP.v2
{
    ...
    public class InfoTypesResource
    {
        ...
        /// <summary>Returns a list of the sensitive information types that the DLP API supports. For more information,
        /// see [Listing supported predefined infoTypes](/dlp/docs/listing-infotypes).</summary>
    ...
    public class ProjectsResource
    {
        ...
        public class ContentResource
        {
            ...
            /// <summary>Re-identifies content that has been de-identified.</summary>
            /// <param name="body">The body of the request.</param>
...
{    
    ...
    /// <summary>Message representing a path in Cloud Storage.</summary>
    ...
    public class GooglePrivacyDlpV2TimespanConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Specification of the field containing the timestamp of scanned items. Required for data sources
        /// like Datastore or BigQuery. The valid data types of the timestamp field are: for BigQuery - timestamp, date,
        /// datetime; for Datastore - timestamp. Datastore entity will be scanned if the timestamp property does not
        /// exist or its value is empty or invalid.</summary>
