...
namespace Google.Apis.DLP.v2
{
    ...
    public class DLPService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scope constants for use with the Cloud Data Loss Prevention (DLP) API.</summary>
    ...
    public class InfoTypesResource
    {
        ...
        public class ListRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2ListInfoTypesResponse>
        {
            ...
            /// <summary>The parent resource name. The format of this value is as follows: locations/
            /// LOCATION_ID</summary>
    ...
    public class LocationsResource
    {
        ...
        public class InfoTypesResource
        {
            ...
            /// <summary>Returns a list of the sensitive information types that the DLP API supports. See
            /// https://cloud.google.com/dlp/docs/infotypes-reference to learn more.</summary>
            /// <param name="parent">The parent resource name. The format of this value is as follows: locations/
            /// LOCATION_ID</param>
    ...
    public class OrganizationsResource
    {
        ...
        public class DeidentifyTemplatesResource
        {
            ...
            /// <param name="parent">Required. Parent resource name. The format of this value varies depending on the scope of the
            /// request (project or organization) and whether you have [specified a processing location](/dlp/docs/specifying-
            /// location): + Projects scope, location specified: `projects/`PROJECT_ID`/locations/`LOCATION_ID + Projects scope, no
            /// location specified (defaults to global): `projects/`PROJECT_ID + Organizations scope, location specified:
            /// `organizations/`ORG_ID`/locations/`LOCATION_ID + Organizations scope, no location specified (defaults to global):
            /// `organizations/`ORG_ID The following example `parent` string specifies a parent project with the identifier
            ...
            public class CreateRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyTemplate>
            {
                ...
                /// <summary>Required. Parent resource name. The format of this value varies depending on the scope of
                ...
                /// processing data: parent=projects/example-project/locations/europe-west3</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            /// <summary>Deletes a DeidentifyTemplate. See https://cloud.google.com/dlp/docs/creating-templates-deid to
            /// learn more.</summary>
            /// <param name="name">Required. Resource name of the organization and deidentify template to be deleted, for example
            ...
            public class DeleteRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GoogleProtobufEmpty>
            {
                ...
                /// <summary>Required. Resource name of the organization and deidentify template to be deleted, for
            ...
            /// <summary>Gets a DeidentifyTemplate. See https://cloud.google.com/dlp/docs/creating-templates-deid to
            /// learn more.</summary>
            /// <param name="name">Required. Resource name of the organization and deidentify template to be read, for example
            /// `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
            /// id/deidentifyTemplates/432452342.</param>
            ...
            public class GetRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyTemplate>
            {
                ...
                /// <summary>Required. Resource name of the organization and deidentify template to be read, for example
                /// `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
                /// id/deidentifyTemplates/432452342.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <summary>Updates the DeidentifyTemplate. See https://cloud.google.com/dlp/docs/creating-templates-deid
            /// to learn more.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Required. Resource name of organization and deidentify template to be updated, for example
            /// `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
            /// id/deidentifyTemplates/432452342.</param>
            ...
            public class PatchRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyTemplate>
            {
                ...
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>Required. Resource name of organization and deidentify template to be updated, for example
                /// `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
                /// id/deidentifyTemplates/432452342.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
        ...
        public class InspectTemplatesResource
        {
            ...
            /// <summary>Deletes an InspectTemplate. See https://cloud.google.com/dlp/docs/creating-templates to learn
            /// more.</summary>
            /// <param name="name">Required. Resource name of the organization and inspectTemplate to be deleted, for example
            ...
            public class DeleteRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GoogleProtobufEmpty>
            {
                ...
                /// <summary>Required. Resource name of the organization and inspectTemplate to be deleted, for example
            ...
            /// <summary>Gets an InspectTemplate. See https://cloud.google.com/dlp/docs/creating-templates to learn
            /// more.</summary>
            /// <param name="name">Required. Resource name of the organization and inspectTemplate to be read, for example
            /// `organizations/433245324/inspectTemplates/432452342` or projects/project-id/inspectTemplates/432452342.</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            ...
            public class GetRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2InspectTemplate>
            {
                ...
                /// <summary>Required. Resource name of the organization and inspectTemplate to be read, for example
                /// `organizations/433245324/inspectTemplates/432452342` or projects/project-
                /// id/inspectTemplates/432452342.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <summary>Updates the InspectTemplate. See https://cloud.google.com/dlp/docs/creating-templates to learn
            /// more.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Required. Resource name of organization and inspectTemplate to be updated, for example
            /// `organizations/433245324/inspectTemplates/432452342` or projects/project-id/inspectTemplates/432452342.</param>
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2UpdateInspectTemplateRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                /// <summary>Required. Resource name of organization and inspectTemplate to be updated, for example
                /// `organizations/433245324/inspectTemplates/432452342` or projects/project-
                /// id/inspectTemplates/432452342.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
        ...
        public class LocationsResource
        {
            ...
            public class DeidentifyTemplatesResource
            {
                ...
                public class CreateRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyTemplate>
                {
                    ...
                    /// <summary>Required. Parent resource name. The format of this value varies depending on the scope
                    ...
                    /// to global): `projects/`PROJECT_ID + Organizations scope, location specified:
                    /// `organizations/`ORG_ID`/locations/`LOCATION_ID + Organizations scope, no location specified
                    /// (defaults to global): `organizations/`ORG_ID The following example `parent` string specifies a
                    /// parent project with the identifier `example-project`, and specifies the `europe-west3` location
                    /// for processing data: parent=projects/example-project/locations/europe-west3</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <summary>Deletes a DeidentifyTemplate. See https://cloud.google.com/dlp/docs/creating-templates-deid
                /// to learn more.</summary>
                /// <param name="name">Required. Resource name of the organization and deidentify template to be deleted, for example
                /// `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
                /// id/deidentifyTemplates/432452342.</param>
                ...
                public class GetRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyTemplate>
                {
                    ...
                    /// <summary>Required. Resource name of the organization and deidentify template to be read, for
                    /// example `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
                    /// id/deidentifyTemplates/432452342.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <summary>Updates the DeidentifyTemplate. See https://cloud.google.com/dlp/docs/creating-templates-
                /// deid to learn more.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. Resource name of organization and deidentify template to be updated, for example
                /// `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
                /// id/deidentifyTemplates/432452342.</param>
                ...
                public class PatchRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyTemplate>
                {
                    ...
                    /// <summary>Required. Resource name of organization and deidentify template to be updated, for
                    /// example `organizations/433245324/deidentifyTemplates/432452342` or projects/project-
                    /// id/deidentifyTemplates/432452342.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            public class InspectTemplatesResource
            {
                ...
                /// <summary>Deletes an InspectTemplate. See https://cloud.google.com/dlp/docs/creating-templates to
                /// learn more.</summary>
                /// <param name="name">Required. Resource name of the organization and inspectTemplate to be deleted, for example
                /// `organizations/433245324/inspectTemplates/432452342` or projects/project-id/inspectTemplates/432452342.</param>
                public virtual DeleteRequest Delete(string name)
                ...
                public class DeleteRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GoogleProtobufEmpty>
                {
                    ...
                    /// <summary>Required. Resource name of the organization and inspectTemplate to be deleted, for
                ...
                /// <summary>Updates the InspectTemplate. See https://cloud.google.com/dlp/docs/creating-templates to
                /// learn more.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. Resource name of organization and inspectTemplate to be updated, for example
                /// `organizations/433245324/inspectTemplates/432452342` or projects/project-id/inspectTemplates/432452342.</param>
            ...
            public class StoredInfoTypesResource
            {
                ...
                /// <summary>Deletes a stored infoType. See https://cloud.google.com/dlp/docs/creating-stored-infotypes
                /// to learn more.</summary>
                /// <param name="name">Required. Resource name of the organization and storedInfoType to be deleted, for example
                ...
                public class DeleteRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GoogleProtobufEmpty>
                {
                    ...
                    /// <summary>Required. Resource name of the organization and storedInfoType to be deleted, for
                ...
                /// learn more.</summary>
                /// <param name="name">Required. Resource name of the organization and storedInfoType to be read, for example
                /// `organizations/433245324/storedInfoTypes/432452342` or projects/project-id/storedInfoTypes/432452342.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                public class GetRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2StoredInfoType>
                {
                    ...
                    /// <summary>Required. Resource name of the organization and storedInfoType to be read, for example
                ...
                /// <summary>Updates the stored infoType by creating a new version. The existing version will continue
                /// to be used until the new version is ready. See https://cloud.google.com/dlp/docs/creating-stored-
                /// infotypes to learn more.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. Resource name of organization and storedInfoType to be updated, for example
                /// `organizations/433245324/storedInfoTypes/432452342` or projects/project-id/storedInfoTypes/432452342.</param>
                ...
                public class PatchRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2StoredInfoType>
                {
                    ...
                    /// <summary>Required. Resource name of organization and storedInfoType to be updated, for example
                    /// `organizations/433245324/storedInfoTypes/432452342` or projects/project-
                    /// id/storedInfoTypes/432452342.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
        ...
        public class StoredInfoTypesResource
        {
            ...
            public class DeleteRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GoogleProtobufEmpty>
            {
                ...
                /// <summary>Required. Resource name of the organization and storedInfoType to be deleted, for example
                /// `organizations/433245324/storedInfoTypes/432452342` or projects/project-
                /// id/storedInfoTypes/432452342.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
    ...
    public class ProjectsResource
    {
        ...
        public class ContentResource
        {
            ...
            /// updated.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Parent resource name. The format of this value varies depending on whether you have [specified
            /// a processing location](/dlp/docs/specifying-location): + Projects scope, location specified:
            /// `projects/`PROJECT_ID`/locations/`LOCATION_ID + Projects scope, no location specified (defaults to global):
            /// `projects/`PROJECT_ID The following example `parent` string specifies a parent project with the identifier `example-
            /// project`, and specifies the `europe-west3` location for processing data: parent=projects/example-project/locations
            /// /europe-west3</param>
            ...
            public class DeidentifyRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyContentResponse>
            {
                ...
                /// <summary>Parent resource name. The format of this value varies depending on whether you have
            ...
            /// [specified a processing location](/dlp/docs/specifying-location): + Projects scope, location specified:
            /// `projects/`PROJECT_ID`/locations/`LOCATION_ID + Projects scope, no location specified (defaults to global):
            /// `projects/`PROJECT_ID The following example `parent` string specifies a parent project with the identifier `example-
            /// project`, and specifies the `europe-west3` location for processing data: parent=projects/example-project/locations
            /// /europe-west3</param>
            ...
            public class ReidentifyRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2ReidentifyContentResponse>
            {
                ...
                /// <summary>Required. Parent resource name. The format of this value varies depending on whether you
                /// have [specified a processing location](/dlp/docs/specifying-location): + Projects scope, location
                /// specified: `projects/`PROJECT_ID`/locations/`LOCATION_ID + Projects scope, no location specified
                /// (defaults to global): `projects/`PROJECT_ID The following example `parent` string specifies a parent
                /// project with the identifier `example-project`, and specifies the `europe-west3` location for
                /// processing data: parent=projects/example-project/locations/europe-west3</summary>
        ...
        public class DlpJobsResource
        {
            ...
            /// cancel the DlpJob, but success is not guaranteed. See https://cloud.google.com/dlp/docs/inspecting-
            /// storage and https://cloud.google.com/dlp/docs/compute-risk-analysis to learn more.</summary>
            /// <param name="body">The body of the request.</param>
            ...
            public class CancelRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GoogleProtobufEmpty>
            {
                ...
                public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2CancelDlpJobRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
            ...
            /// /inspecting-storage and https://cloud.google.com/dlp/docs/compute-risk-analysis to learn more.</summary>
        ...
        public class JobTriggersResource
        {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Required. Resource name of the trigger to activate, for example `projects/dlp-test-
            ...
            public class ActivateRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DlpJob>
            {
                ...
                /// <summary>Required. Resource name of the trigger to activate, for example `projects/dlp-test-
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2UpdateJobTriggerRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
        ...
        public class LocationsResource
        {
            ...
            public class ContentResource
            {
                ...
                public class ReidentifyRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2ReidentifyContentResponse>
                {
                    ...
                    /// you have [specified a processing location](/dlp/docs/specifying-location): + Projects scope,
                    ...
                    /// specifies a parent project with the identifier `example-project`, and specifies the `europe-
                    /// west3` location for processing data: parent=projects/example-project/locations/europe-
                    /// west3</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
            ...
            public class DlpJobsResource
            {
                ...
                /// <summary>Starts asynchronous cancellation on a long-running DlpJob. The server makes a best effort
                /// to cancel the DlpJob, but success is not guaranteed. See https://cloud.google.com/dlp/docs
                ...
                /// <summary>Deletes a long-running DlpJob. This method indicates that the client is no longer
                /// interested in the DlpJob result. The job will be cancelled if possible. See
                /// https://cloud.google.com/dlp/docs/inspecting-storage and https://cloud.google.com/dlp/docs/compute-
...
{    
    ...
    /// <summary>A task to execute on the completion of a job. See https://cloud.google.com/dlp/docs/concepts-actions to
    /// learn more.</summary>
    ...
    /// type of the bound before comparing. See https://cloud.google.com/dlp/docs/concepts-bucketing to learn
    /// more.</summary>
    ...
    /// <summary>Request message for CreateDlpJobRequest. Used to initiate long running jobs such as calculating risk
    ...
    /// <summary>Pseudonymization method that generates deterministic encryption for the given input. Outputs a base64
    /// encoded representation of the encrypted output. Uses AES-SIV based on the RFC
    ...
    /// must be either 32 or 64 bytes. Outputs a base64 encoded representation of the hashed output (for example,
    /// L7k0BHmF1ha5U3NfGykjro4xWi1MPVQPjhMAZbSV9mM=). Currently, only string and integer values can be hashed. See
    /// https://cloud.google.com/dlp/docs/pseudonymization to learn more.</summary>
    ...
    /// <summary>Replaces an identifier with a surrogate using Format Preserving Encryption (FPE) with the FFX mode of
    /// operation; however when used in the `ReidentifyContent` API method, it serves the opposite function by reversing
    ...
    /// <summary>Shifts dates by random number of days, with option to be consistent for the same context. See
    /// https://cloud.google.com/dlp/docs/concepts-date-shifting to learn more.</summary>
    ...
    /// <summary>DeidentifyTemplates contains instructions on how to de-identify content. See
    ...
    /// <summary>Deprecated; use `InspectionRuleSet` instead. Rule for modifying a `CustomInfoType` to alter behavior
    /// under certain circumstances, depending on the specific details of the rule. Not supported for the
    /// `surrogate_type` custom infoType.</summary>
    ...
    {
        /// <summary>InfoType list in ExclusionRule rule drops a finding when it overlaps or contained within with a
        /// finding of an infoType from this list. For example, for `InspectionRuleSet.info_types` containing
        /// "PHONE_NUMBER"` and `exclusion_rule` containing `exclude_info_types.info_types` with "EMAIL_ADDRESS" the
    ...
    /// <summary>The rule that specifies conditions when findings of infoTypes specified in `InspectionRuleSet` are
    /// removed from results.</summary>
    ...
    /// anywhere you otherwise would normally specify InspectConfig. See https://cloud.google.com/dlp/docs/concepts-
    ...
    /// <summary>Rule set for modifying a set of infoTypes to alter behavior under certain circumstances, depending on
    /// the specific details of the rules within the set.</summary>
    ...
    /// <summary>Contains a configuration to make dlp api calls on a repeating basis. See
    ...
    /// <summary>Include to use an existing data crypto key wrapped by KMS. The wrapped key must be a 128/192/256 bit
    /// key. Authorization requires the following IAM permissions when sending a request to perform a crypto
    ...
    /// <summary>Skips the data without modifying it if the requested transformation would cause an error. For example,
    /// if a `DateShift` transformation were applied an an IP address, this mode would leave the IP address unchanged in
    ...
    /// <summary>Publish the result summary of a DlpJob to the Cloud Security Command Center (CSCC Alpha). This action
    /// is only available for projects which are parts of an organization and whitelisted for the alpha Cloud Security
    /// Command Center. The action will publish count of finding instances and their info types. The summary of findings
    /// will be persisted in CSCC and are governed by CSCC service-specific policy, see https://cloud.google.com/terms
    /// /service-terms Only a single instance of this action can be specified. Compatible with: Inspect</summary>
    ...
    /// <summary>Enable Stackdriver metric dlp.googleapis.com/finding_count. This will publish a metric to stack driver
    /// on each infotype requested and how many findings were found for it. CustomDetectors will be bucketed as 'Custom'
    /// under the Stackdriver label 'info_type'.</summary>
    ...
    /// <summary>Request to search for potentially sensitive info in an image and redact it by covering it with a
    /// colored rectangle.</summary>
    ...
    /// <summary>Configuration for a risk analysis job. See https://cloud.google.com/dlp/docs/concepts-risk-analysis to
    /// learn more.</summary>
    ...
    /// <summary>Configuration for stored infoTypes. All fields and subfield are provided by the user. For more
    /// information, see https://cloud.google.com/dlp/docs/creating-custom-infotypes.</summary>
    ...
    /// <summary>Structured content to inspect. Up to 50,000 `Value`s per request allowed. See
    ...
    /// <summary>How to handle transformation errors during de-identification. A transformation error occurs when the
    /// requested transformation is incompatible with the data. For example, trying to de-identify an IP address using a
    ...
    /// <summary>Summary of a single transformation. Only one of 'transformation', 'field_transformation', or
