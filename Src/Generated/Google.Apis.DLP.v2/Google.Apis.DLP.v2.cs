...
namespace Google.Apis.DLP.v2
{
    ...
    public class OrganizationsResource
    {
        ...
        public class DeidentifyTemplatesResource
        {
            ...
            /// `projects/`PROJECT_ID + Organizations scope, location specified: `organizations/`ORG_ID`/locations/`LOCATION_ID +
            /// Organizations scope, no location specified (defaults to global): `organizations/`ORG_ID The following example
            /// `parent` string specifies a parent project with the identifier `example-project`, and specifies the `europe-west3`
            /// location for processing data: parent=projects/example-project/locations/europe-west3</param>
    ...
    public class ProjectsResource
    {
        ...
        public class ContentResource
        {
            ...
            /// a processing location](https://cloud.google.com/dlp/docs/specifying-location): + Projects scope, location specified:
            /// `projects/`PROJECT_ID`/locations/`LOCATION_ID + Projects scope, no location specified (defaults to global):
            ...
            public class DeidentifyRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyContentResponse>
            {
                ...
                /// location for processing data: parent=projects/example-project/locations/europe-west3</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            public class ReidentifyRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2ReidentifyContentResponse>
            {
                ...
                /// have [specified a processing location](https://cloud.google.com/dlp/docs/specifying-location): +
        ...
        public class LocationsResource
        {
            ...
            public class ContentResource
            {
                ...
                public class DeidentifyRequest : DLPBaseServiceRequest<Google.Apis.DLP.v2.Data.GooglePrivacyDlpV2DeidentifyContentResponse>
                {
                    ...
                    /// the `europe-west3` location for processing data: parent=projects/example-project/locations
                    /// /europe-west3</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
...
{    
    ...
    public class GooglePrivacyDlpV2TimespanConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Exclude files, tables, or rows newer than this value. If not set, no upper time limit is
        /// applied.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("endTime")]
        public virtual object EndTime { get; set; }

        /// <summary>Exclude files, tables, or rows older than this value. If not set, no lower time limit is
        /// applied.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("startTime")]
        public virtual object StartTime { get; set; }

        /// <summary>Specification of the field containing the timestamp of scanned items. Used for data sources like
        /// Datastore and BigQuery. For BigQuery: If this value is not specified and the table was modified between the
        /// given start and end times, the entire table will be scanned. If this value is specified, then rows are
        /// filtered based on the given start and end times. Rows with a `NULL` value in the provided BigQuery column
        /// are skipped. Valid data types of the provided BigQuery column are: `INTEGER`, `DATE`, `TIMESTAMP`, and
        ...
        /// values, then it is included. Valid data types of the provided timestamp property are: `TIMESTAMP`.</summary>
