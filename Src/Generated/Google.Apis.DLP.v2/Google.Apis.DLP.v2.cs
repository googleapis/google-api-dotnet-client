...
{    
    ...
    /// <summary>Note: We recommend using  CryptoDeterministicConfig for all use cases which do not require preserving
    /// the input alphabet space and size, plus warrant referential integrity.</summary>
