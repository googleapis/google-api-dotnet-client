...
namespace Google.Apis.MyBusinessVerifications.v1
{
    ...
    public class VerificationTokensResource
    {
        ...
        /// <summary>Generate a token for the provided location data to verify the location.</summary>
        /// <param name="body">The body of the request.</param>
        public virtual GenerateRequest Generate(Google.Apis.MyBusinessVerifications.v1.Data.GenerateInstantVerificationTokenRequest body)
        {
            return new GenerateRequest(this.service, body);
        }

        /// <summary>Generate a token for the provided location data to verify the location.</summary>
        public class GenerateRequest : MyBusinessVerificationsBaseServiceRequest<Google.Apis.MyBusinessVerifications.v1.Data.GenerateInstantVerificationTokenResponse>
        {
            /// <summary>Constructs a new Generate request.</summary>
            public GenerateRequest(Google.Apis.Services.IClientService service, Google.Apis.MyBusinessVerifications.v1.Data.GenerateInstantVerificationTokenRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.MyBusinessVerifications.v1.Data.GenerateInstantVerificationTokenRequest Body { get; set; }
...
namespace Google.Apis.MyBusinessVerifications.v1.Data
{
    ...
    /// <summary>Request message for Verifications.GenerateInstantVerificationToken.</summary>
    public class GenerateInstantVerificationTokenRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// The location identifier associated with an unverified listing. This is the location id generated at the time
        /// that the listing was originally created. It is the final portion of a location resource name as generated by
        /// the Google My Business API. Note: the caller must be an owner or manager of this listing in order to
        /// generate a verification token. See the [location
        /// resource](/my-business/reference/rest/v4/accounts.locations) documentation for more information.
        /// </summary>
    ...
    /// <summary>Response message for Verifications.GenerateInstantVerificationToken.</summary>
    public class GenerateInstantVerificationTokenResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The generated instant verification token.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("instantVerificationToken")]
        public virtual string InstantVerificationToken { get; set; }

        /// <summary>Output only. The result of the instant verification token generation.</summary>
    ...
    /// <summary>The address and other details of the location to generate an instant verification token for.</summary>
