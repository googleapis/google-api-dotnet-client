...
namespace Google.Apis.Admin.Reports.reports_v1
{
    ...
    public class ActivitiesResource
    {
        ...
        public class ListRequest : ReportsBaseServiceRequest<Google.Apis.Admin.Reports.reports_v1.Data.Activities>
        {
            ...
            public enum ApplicationNameEnum
            {
                ...
                /// <summary>
                /// The Gemini for Workspace activity reports return information about various types of Gemini activity
                /// events performed by users within a Workspace application.
                /// </summary>
    ...
    public class CustomerUsageReportsResource
    {
        ...
        public class GetRequest : ReportsBaseServiceRequest<Google.Apis.Admin.Reports.reports_v1.Data.UsageReports>
        {
            ...
            /// Customers usage report include `accounts`, `app_maker`, `apps_scripts`, `calendar`, `chat`, `classroom`,
    ...
    public class UserUsageReportResource
    {
        ...
        public class GetRequest : ReportsBaseServiceRequest<Google.Apis.Admin.Reports.reports_v1.Data.UsageReports>
        {
            ...
            /// Report include `accounts`, `chat`, `docs`, and `gmail`. Filters are in the form `[application
            /// name]:parameter name[parameter value],...`. In this example, the `&amp;lt;&amp;gt;` 'not equal to'
