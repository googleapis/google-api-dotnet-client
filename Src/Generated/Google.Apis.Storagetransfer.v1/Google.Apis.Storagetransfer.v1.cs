...
namespace Google.Apis.Storagetransfer.v1.Data
{
    ...
    /// our data retention policy for user credentials, see [User credentials](data-retention#user-credentials).
    /// </summary>
    ...
    public class AwsS3Data : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// for user credentials, see [User credentials](data-retention#user-credentials).
        /// </summary>
    ...
    public class AzureBlobStorageData : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// retention policy for user credentials, see [User credentials](data-retention#user-credentials).
        /// </summary>
    ...
    public class ObjectConditions : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// If `include_prefixes` is specified, objects that satisfy the object conditions must have names that start
        /// with one of the `include_prefixes` and that do not start with any of the exclude_prefixes. If
        /// `include_prefixes` is not specified, all objects except those that have names starting with one of the
        /// `exclude_prefixes` must satisfy the object conditions. Requirements: * Each include-prefix and
        ...
        /// expression matching are not supported. * Each include-prefix and exclude-prefix must omit the leading slash.
        /// For example, to include the `requests.gz` object in a transfer from
        /// `s3://my-aws-bucket/logs/y=2015/requests.gz`, specify the include prefix as `logs/y=2015/requests.gz`. *
        /// None of the include-prefix or the exclude-prefix values can be empty, if specified. * Each include-prefix
        /// must include a distinct portion of the object namespace. No include-prefix may be a prefix of another
        /// include-prefix. * Each exclude-prefix must exclude a distinct portion of the object namespace. No
        /// exclude-prefix may be a prefix of another exclude-prefix. * If `include_prefixes` is specified, then each
        /// exclude-prefix must start with the value of a path explicitly included by `include_prefixes`. The max size
        /// of `include_prefixes` is 1000.
        /// </summary>
    ...
    public class TransferJob : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// or a number, and should be no more than 128 characters. Example:
        /// `"transferJobs/[A-Za-z0-9-._~]*[A-Za-z0-9]$"` Invalid job names will fail with an INVALID_ARGUMENT error.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
