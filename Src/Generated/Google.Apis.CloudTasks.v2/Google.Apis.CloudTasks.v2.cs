...
{    
    ...
    {
        /// <summary>Task-level setting for App Engine routing. * If app_engine_routing_override is set on the queue,
        /// this value is used for all tasks in the queue, no matter what the setting is for the task-level
    ...
    /// routed). Using AppEngineRouting requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs
    ...
    public class Queue : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// queue. Http tasks are not affected. If set, `app_engine_routing_override` is used for all App Engine tasks
        /// in the queue, no matter what the setting is for the task-level app_engine_routing.</summary>
    ...
    public class RateLimits : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// `max_burst_size` based on the value of max_dispatches_per_second. For queues that were created or updated
        ...
        /// created, Cloud Tasks will pick the default. * The maximum allowed value is 500. This field has the same
        /// meaning as [rate in
    ...
    public class Task : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The time when the task is scheduled to be attempted or retried. `schedule_time` will be truncated
        /// to the nearest microsecond.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("scheduleTime")]
        public virtual object ScheduleTime { get; set; }
