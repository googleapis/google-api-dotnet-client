    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2.Data.Operation>
                {
            ...
            public class QueuesResource
            {
                ...
                public class TasksResource
                {
                    ...
                    /// </param>
                    /// <param name="taskId">
                    /// Optional. Task ID for the task being created. If not provided, Cloud Tasks generates an ID for
                    /// the task.
                    /// </param>
                    public virtual BufferRequest Buffer(Google.Apis.CloudTasks.v2.Data.BufferTaskRequest body, string queue, string taskId)
                    {
                    ...
                    /// projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks:buffer.
                    /// </summary>
                    public class BufferRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2.Data.BufferTaskResponse>
                    {
                        /// <summary>Constructs a new Buffer request.</summary>
                        public BufferRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2.Data.BufferTaskRequest body, string queue, string taskId) : base(service)
                        {
                            Queue = queue;
                            TaskId = taskId;
                            Body = body;
                        ...
                        /// <summary>
                        /// Optional. Task ID for the task being created. If not provided, Cloud Tasks generates an ID
                        /// for the task.
                        /// </summary>
                        ...
                        Google.Apis.CloudTasks.v2.Data.BufferTaskRequest Body { get; set; }
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v2/{+queue}/tasks/{taskId}:buffer";
            ...
            /// By default there is no kms_key configured.
            /// </summary>
            public class GetCmekConfigRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2.Data.CmekConfig>
            {
            ...
            /// </param>
            public virtual UpdateCmekConfigRequest UpdateCmekConfig(Google.Apis.CloudTasks.v2.Data.CmekConfig body, string name)
            {
            ...
            /// be encrypted at-rest with the KMS-key provided in the config.
            /// </summary>
            public class UpdateCmekConfigRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2.Data.CmekConfig>
            {
                /// <summary>Constructs a new UpdateCmekConfig request.</summary>
                public UpdateCmekConfigRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2.Data.CmekConfig body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.CloudTasks.v2.Data.CmekConfig Body { get; set; }
