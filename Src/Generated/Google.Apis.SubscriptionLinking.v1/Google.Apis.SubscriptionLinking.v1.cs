...
namespace Google.Apis.SubscriptionLinking.v1
{
    ...
    public class SubscriptionLinkingService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri => BaseUriOverride ?? "https://readerrevenuesubscriptionlinking.googleapis.com/";

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "";

        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://readerrevenuesubscriptionlinking.googleapis.com/batch";
