    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class FunctionsResource
            {
                ...
                /// </param>
                public virtual CommitFunctionUpgradeAsGen2Request CommitFunctionUpgradeAsGen2(Google.Apis.CloudFunctions.v2.Data.CommitFunctionUpgradeAsGen2Request body, string name)
                {
                ...
                /// the Gen2 function active and manageable by the GCFv2 API.
                /// </summary>
                public class CommitFunctionUpgradeAsGen2Request : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.Operation>
                {
                    /// <summary>Constructs a new CommitFunctionUpgradeAsGen2 request.</summary>
                    public CommitFunctionUpgradeAsGen2Request(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v2.Data.CommitFunctionUpgradeAsGen2Request body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFunctions.v2.Data.CommitFunctionUpgradeAsGen2Request Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v2/{+name}:commitFunctionUpgradeAsGen2";
                ...
                public virtual DetachFunctionRequest DetachFunction(Google.Apis.CloudFunctions.v2.Data.DetachFunctionRequest body, string name)
                {
                    return new DetachFunctionRequest(this.service, body, name);
                }

                /// <summary>Detaches 2nd Gen function to Cloud Run function.</summary>
                public class DetachFunctionRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.Operation>
                {
                    /// <summary>Constructs a new DetachFunction request.</summary>
                    public DetachFunctionRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v2.Data.DetachFunctionRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFunctions.v2.Data.DetachFunctionRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v2/{+name}:detachFunction";
                ...
                /// does not have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.Policy>
                {
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.CloudFunctions.v2.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
                /// </summary>
                public class SetIamPolicyRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v2.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFunctions.v2.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.CloudFunctions.v2.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// checking. This operation may "fail open" without warning.
                /// </summary>
                public class TestIamPermissionsRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudFunctions.v2.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudFunctions.v2.Data.TestIamPermissionsRequest Body { get; set; }
            ...
            public class OperationsResource
            {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.Operation>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// method, it returns `UNIMPLEMENTED`.
                /// </summary>
                public class ListRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.ListOperationsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : CloudFunctionsBaseServiceRequest<Google.Apis.CloudFunctions.v2.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
