    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                public virtual CancelRequest Cancel(Google.Apis.Eventarc.v1beta1.Data.CancelOperationRequest body, string name)
                {
                ...
                /// operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to
                /// `Code.CANCELLED`.</summary>
                public class CancelRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Empty>
                {
                    /// <summary>Constructs a new Cancel request.</summary>
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Eventarc.v1beta1.Data.CancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.Eventarc.v1beta1.Data.CancelOperationRequest Body { get; set; }
                ...
                /// interested in the operation result. It does not cancel the operation. If the server doesn't support
                /// this method, it returns `google.rpc.Code.UNIMPLEMENTED`.</summary>
                public class DeleteRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Empty>
                {
                ...
                /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
                /// operation result at intervals as recommended by the API service.</summary>
                public class GetRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Operation>
                {
                ...
                /// however overriding users must ensure the name binding is the parent resource, without the operations
                /// collection id.</summary>
                public class ListRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.ListOperationsResponse>
                {
            ...
            public class TriggersResource
            {
                ...
                public virtual CreateRequest Create(Google.Apis.Eventarc.v1beta1.Data.Trigger body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }

                /// <summary>Create a new trigger in a particular project and location.</summary>
                public class CreateRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Eventarc.v1beta1.Data.Trigger body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1beta1/{+parent}/triggers";
                ...
                /// <summary>Delete a single trigger.</summary>
                public class DeleteRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Delete request.</summary>
                    public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Get a single trigger.</summary>
                public class GetRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Trigger>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// <summary>Gets the access control policy for a resource. Returns an empty policy if the resource
                /// exists and does not have a policy set.</summary>
                public class GetIamPolicyRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Policy>
                {
                ...
                /// <summary>List triggers.</summary>
                public class ListRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.ListTriggersResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    ...
                    /// <summary>The sorting order of the resources returned. Value should be a comma separated list of
                    /// fields. The default sorting oder is ascending. To specify descending order for a field, append a
                    /// ` desc` suffix; for example: `name desc, trigger_id`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("orderBy", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string OrderBy { get; set; }

                    /// <summary>The maximum number of triggers to return on each page. Note: The service may send
                    /// fewer.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }

                    /// <summary>The page token; provide the value from the `next_page_token` field in a previous
                    /// `ListTriggers` call to retrieve the subsequent page. When paginating, all other parameters
                    /// provided to `ListTriggers` must match the call that provided the page token.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string PageToken { get; set; }
                ...
                /// <summary>Update a single trigger.</summary>
                public class PatchRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Operation>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Eventarc.v1beta1.Data.Trigger body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// documentation for the appropriate value for this field.</param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.Eventarc.v1beta1.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// <summary>Sets the access control policy on the specified resource. Replaces any existing policy. Can
                /// return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.</summary>
                public class SetIamPolicyRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.Eventarc.v1beta1.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Eventarc.v1beta1.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// documentation for the appropriate value for this field.</param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.Eventarc.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// is designed to be used for building permission-aware UIs and command-line tools, not for
                /// authorization checking. This operation may "fail open" without warning.</summary>
                public class TestIamPermissionsRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.Eventarc.v1beta1.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Eventarc.v1beta1.Data.TestIamPermissionsRequest Body { get; set; }
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : EventarcBaseServiceRequest<Google.Apis.Eventarc.v1beta1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
...
{    
    ...
    /// <summary>Represents a Cloud Run service destination.</summary>
    public class CloudRunService : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional. The relative path on the Cloud Run service the events should be sent to. The value must
        /// conform to the definition of URI path segment (section 3.3 of RFC2396). Examples: "/route", "route",
        /// "route/subroute".</summary>
        ...
        /// <summary>Required. The name of the Cloud run service being addressed (see
        /// https://cloud.google.com/run/docs/reference/rest/v1/namespaces.services). Only services located in the same
        /// project of the trigger object can be addressed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("service")]
        public virtual string Service { get; set; }
    ...
    {
        /// <summary>A page token that can be sent to ListTriggers to request the next page. If this is empty, then
        /// there are no more pages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    {
        /// <summary>The Pub/Sub topic and subscription that maybe created by Eventarc as delivery
    ...
    public class Trigger : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. This checksum is computed by the server based on the value of other fields, and may be
        /// sent only on create requests to ensure the client has an up-to-date value before proceeding.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("etag")]
        public virtual string ETag { get; set; }
        ...
        /// <summary>Optional. The IAM service account email associated with the trigger. The service account represents
        /// the identity of the trigger. The principal who calls this API must have `iam.serviceAccounts.actAs`
        /// permission in the service account. See https://cloud.google.com/iam/docs/understanding-service-
        /// accounts?hl=en#sa_common for more information. For Cloud Run destinations, this service account is used to
        /// generate identity tokens when invoking the service. See https://cloud.google.com/run/docs/triggering/pubsub-
        /// push#create-service-account for information on how to invoke authenticated Cloud Run services. In order to
        /// create Audit Log triggers, the service account should also have 'eventarc.events.receiveAuditLogV1Written'
        /// permission.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("serviceAccount")]
        public virtual string ServiceAccount { get; set; }

        /// <summary>Output only. In order to deliver messages, Eventarc may configure other GCP products as transport
