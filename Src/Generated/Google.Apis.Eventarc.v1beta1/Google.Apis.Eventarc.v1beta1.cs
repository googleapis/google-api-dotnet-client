...
namespace Google.Apis.Eventarc.v1beta1.Data
{
    ...
    {
        /// <summary>
        /// Required. The name of a CloudEvents attribute. Currently, only a subset of attributes can be specified. All
        /// triggers MUST provide a matching criteria for the 'type' attribute.
        /// </summary>
