...
{    
    ...
    public class Conversion : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The revenue amount of this TRANSACTION conversion, in micros (value multiplied by 1000, no
        /// decimal). For example, to specify a revenue value of "10" enter "10000" in your request.</summary>
