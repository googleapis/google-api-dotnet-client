    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class OperationsResource
            {
                ...
                /// Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.
                /// </summary>
                public class CancelRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.Empty>
                {
                ...
                /// it returns `google.rpc.Code.UNIMPLEMENTED`.
                /// </summary>
                public class DeleteRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.Empty>
                {
                ...
                /// result at intervals as recommended by the API service.
                /// </summary>
                public class GetRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.Operation>
                {
                ...
                /// collection id.
                /// </summary>
                public class ListRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.ListOperationsResponse>
                {
                ...
                /// response is no guarantee that the operation is done.
                /// </summary>
                public class WaitRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.Operation>
                {
            ...
            public class ScansResource
            {
                ...
                public class VulnerabilitiesResource
                {
                    ...
                    /// <summary>Lists vulnerabilities resulting from a successfully completed scan.</summary>
                    public class ListRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.ListVulnerabilitiesResponseV1>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        ...
                        /// <summary>Gets the REST path.</summary>
                        public override string RestPath => "v1/{+parent}/vulnerabilities";
                ...
                /// </param>
                public virtual AnalyzePackagesRequest AnalyzePackages(Google.Apis.OnDemandScanning.v1.Data.AnalyzePackagesRequestV1 body, string parent)
                {
                    return new AnalyzePackagesRequest(service, body, parent);
                }

                /// <summary>Initiates an analysis of the provided packages.</summary>
                public class AnalyzePackagesRequest : OnDemandScanningBaseServiceRequest<Google.Apis.OnDemandScanning.v1.Data.Operation>
                {
                    /// <summary>Constructs a new AnalyzePackages request.</summary>
                    public AnalyzePackagesRequest(Google.Apis.Services.IClientService service, Google.Apis.OnDemandScanning.v1.Data.AnalyzePackagesRequestV1 body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.OnDemandScanning.v1.Data.AnalyzePackagesRequestV1 Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1/{+parent}/scans:analyzePackages";
...
namespace Google.Apis.OnDemandScanning.v1.Data
{
    ...
    {
        /// <summary>
        /// [DEPRECATED] Whether to include OSV data in the scan. For backwards compatibility reasons, this field can be
    ...
    public class ListVulnerabilitiesResponseV1 : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
