...
{    
    ...
    public class Clustering : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// simple-type fields are supported. The order of the fields will determine how clusters will be generated, so
        /// it is important.</summary>
    ...
    {
        /// <summary>[Experimental] [Optional] Range of a sheet to query from. Only used when non-empty. Typical format:
        /// !:</summary>
    ...
    public class JobConfigurationLoad : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Experimental] Clustering specification for the destination table. Must be specified with time-
        /// based partitioning, data in the table will be first partitioned and subsequently clustered.</summary>
    ...
    {
        /// <summary>[Experimental] [Output-only] Job progress (0.0 -> 1.0) for LOAD and EXTRACT jobs.</summary>
    ...
    public class JobStatistics2 : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>[Output-only] [Experimental] Describes a timeline of job execution.</summary>
    ...
    {
        /// <summary>[Experimental] Clustering specification for the table. Must be specified with time-based
    ...
    public class TableList : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        {
            /// <summary>[Experimental] Clustering specification for this table, if configured.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("clustering")]
            public virtual Clustering Clustering { get; set; } 
