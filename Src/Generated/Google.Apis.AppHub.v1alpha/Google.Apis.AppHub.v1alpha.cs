...
namespace Google.Apis.AppHub.v1alpha
{
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            /// <summary>Gets a Boundary.</summary>
            public class GetBoundaryRequest : AppHubBaseServiceRequest<Google.Apis.AppHub.v1alpha.Data.Boundary>
            {
            ...
            /// "projects/{project}/locations/{location}/boundary"
            /// </param>
            public virtual UpdateBoundaryRequest UpdateBoundary(Google.Apis.AppHub.v1alpha.Data.Boundary body, string name)
            {
                return new UpdateBoundaryRequest(this.service, body, name);
            }

            /// <summary>Updates a Boundary.</summary>
            public class UpdateBoundaryRequest : AppHubBaseServiceRequest<Google.Apis.AppHub.v1alpha.Data.Operation>
            {
                /// <summary>Constructs a new UpdateBoundary request.</summary>
                public UpdateBoundaryRequest(Google.Apis.Services.IClientService service, Google.Apis.AppHub.v1alpha.Data.Boundary body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.AppHub.v1alpha.Data.Boundary Body { get; set; }
