            ...
            public class GlobalResource
            {
                ...
                public class DomainsResource
                {
                    ...
                    public class CreateRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1.Data.Operation>
                    {
                        ...
                        /// <summary>Required. The fully qualified domain name. e.g. mydomain.myorganization.com, with
                        /// the following restrictions: * Must contain only lowercase letters, numbers, periods and
                        /// hyphens. * Must start with a letter. * Must contain between 2-64 characters. * Must end with
                        /// a number or a letter. * Must not start with period. * First segement length (mydomain form
                        /// example above) shouldn't exceed 15 chars. * The last segment cannot be fully numeric. * Must
                        /// be unique within the customer project.</summary>
                    ...
                    public class ListRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1.Data.ListDomainsResponse>
                    {
                        ...
                        /// <summary>Optional. The `next_page_token` value returned from a previous ListDomainsRequest
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The unique name of the domain using the form:
                    /// `projects/{project_id}/locations/global/domains/{domain_name}`.</param>
                    ...
                    public class PatchRequest : ManagedServiceforMicrosoftActiveDirectoryConsumerAPIBaseServiceRequest<Google.Apis.ManagedServiceforMicrosoftActiveDirectoryConsumerAPI.v1.Data.Operation>
                    {
                        ...
                        /// <summary>Required. The unique name of the domain using the form:
                        /// `projects/{project_id}/locations/global/domains/{domain_name}`.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
...
{    
    ...
    /// <summary>Represents a managed Microsoft Active Directory domain. If the domain is being changed, it will be
    /// placed into the UPDATING state, which indicates that the resource is being reconciled. At this point, Get will
    /// reflect an intermediate state.</summary>
    ...
    /// user in another domain. If the trust is being changed, it will be placed into the UPDATING state, which
    /// indicates that the resource is being reconciled. At this point, Get will reflect an intermediate
    /// state.</summary>
    public class Trust : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Optional. The trust authentication type, which decides whether the trusted side has forest/domain
        /// wide access or selective access to an approved set of resources.</summary>
        ...
        /// <summary>Required. The target DNS server IP addresses which can resolve the remote domain involved in the
        /// trust.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("targetDnsIpAddresses")]
        public virtual System.Collections.Generic.IList<string> TargetDnsIpAddresses { get; set; }

        /// <summary>Required. The fully qualified target domain name which will be in trust with the current
        /// domain.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("targetDomainName")]
        public virtual string TargetDomainName { get; set; }

        /// <summary>Required. The trust direction, which decides if the current domain is trusted, trusting, or
        /// both.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("trustDirection")]
        public virtual string TrustDirection { get; set; }

        /// <summary>Required. The trust secret used for the handshake with the target domain. This will not be
        /// stored.</summary>
