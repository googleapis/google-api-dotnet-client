        ...
        public class TenantsResource
        {
            ...
            public class JobsResource
            {
                ...
                public class ListRequest : CloudTalentSolutionBaseServiceRequest<Google.Apis.CloudTalentSolution.v4.Data.ListJobsResponse>
                {
                    ...
                    /// fields eligible for filtering are: * `companyName` * `requisitionId` * `status` Available
                    /// values: OPEN, EXPIRED, ALL. Defaults to OPEN if no value is specified. At least one of
                    /// `companyName` and `requisitionId` must present or an INVALID_ARGUMENT error is thrown. Sample
                    ...
                    /// "projects/foo/tenants/bar/companies/baz" AND status = "EXPIRED" * requisitionId = "req-1" *
            ...
            {
                return new CompleteQueryRequest(this.service, tenant);
            }
...
namespace Google.Apis.CloudTalentSolution.v4.Data
{
    ...
    public class Job : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// other objects, such as ApplicationInfo, to refer a job that didn't exist in the system prior to becoming
    ...
    public class JobQuery : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// This filter specifies the company Company.display_name of the jobs to search against. The company name must
        /// match the value exactly. Alternatively, the value being searched for can be wrapped in different match
        /// operators. `SUBSTRING_MATCH([value])` The company name must contain a case insensitive substring match of
        /// the value. Using this function may increase latency. Sample Value: `SUBSTRING_MATCH(google)`
    ...
    public class LocationFilter : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// filters using address or lat_lng. This filter can be used by itself to search exclusively for telecommuting
        ...
        /// telecommuting jobs can be treated as less relevant than other jobs in the search response. This field is
    ...
    public class SearchJobsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// A maximum of 200 histogram buckets are supported. Data types: * Histogram facet: facet names with format
        /// `a-zA-Z+`. * String: string like "any string with backslash escape for quote(\")." * Number: whole number
        /// and floating point number like 10, -1 and -0.01. * List: list of elements with comma(,) separator surrounded
        /// by square brackets, for example, [1, 2, 3] and ["one", "two", "three"]. Built-in constants: * MIN (minimum
        ...
        /// buckets in spec. * degree_types: histogram by the Job.degree_types, for example, "Bachelors", "Masters". *
        ...
        /// <summary>
        /// Optional. The relevance threshold of the search results. Default to Google defined threshold, leveraging a
