...
namespace Google.Apis.Merchant.issueresolution_v1
{
    ...
    public class MerchantService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "issueresolution_v1";
    ...
    public class AccountsResource
    {
        ...
        public class AggregateProductStatusesResource
        {
            ...
            public class ListRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.issueresolution_v1.Data.ListAggregateProductStatusesResponse>
            {
                ...
                public override string RestPath => "issueresolution/v1/{+parent}/aggregateProductStatuses";
    ...
    public class IssueresolutionResource
    {
        ...
        public virtual RenderaccountissuesRequest Renderaccountissues(Google.Apis.Merchant.issueresolution_v1.Data.RenderIssuesRequestPayload body, string name)
        {
        ...
        /// content and actions are meant to be rendered and shown in third-party applications.
        /// </summary>
        public class RenderaccountissuesRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.issueresolution_v1.Data.RenderAccountIssuesResponse>
        {
            /// <summary>Constructs a new Renderaccountissues request.</summary>
            public RenderaccountissuesRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.issueresolution_v1.Data.RenderIssuesRequestPayload body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
            ...
            Google.Apis.Merchant.issueresolution_v1.Data.RenderIssuesRequestPayload Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "issueresolution/v1/{+name}:renderaccountissues";
        ...
        /// </param>
        public virtual RenderproductissuesRequest Renderproductissues(Google.Apis.Merchant.issueresolution_v1.Data.RenderIssuesRequestPayload body, string name)
        {
        ...
        /// content and actions are meant to be rendered and shown in third-party applications.
        /// </summary>
        public class RenderproductissuesRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.issueresolution_v1.Data.RenderProductIssuesResponse>
        {
            /// <summary>Constructs a new Renderproductissues request.</summary>
            public RenderproductissuesRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.issueresolution_v1.Data.RenderIssuesRequestPayload body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "issueresolution/v1/{+name}:renderproductissues";
        ...
        /// </param>
        public virtual TriggeractionRequest Triggeraction(Google.Apis.Merchant.issueresolution_v1.Data.TriggerActionPayload body, string name)
        {
        ...
        /// that can be shown to the user.
        /// </summary>
        public class TriggeractionRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.issueresolution_v1.Data.TriggerActionResponse>
        {
            /// <summary>Constructs a new Triggeraction request.</summary>
            public TriggeractionRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.issueresolution_v1.Data.TriggerActionPayload body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Merchant.issueresolution_v1.Data.TriggerActionPayload Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "issueresolution/v1/{+name}:triggeraction";
