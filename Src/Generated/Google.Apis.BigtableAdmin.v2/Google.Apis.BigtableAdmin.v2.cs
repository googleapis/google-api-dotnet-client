    ...
    public class ProjectsResource
    {
        ...
        public class InstancesResource
        {
            ...
            public class AppProfilesResource
            {
                ...
                /// <param name="parent">Required. The unique name of the instance in which to create the new app profile. Values are of
                /// the form `projects/{project}/instances/{instance}`.</param>
                ...
                public class CreateRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.AppProfile>
                {
                    ...
                    /// <summary>Required. The unique name of the instance in which to create the new app profile.
                    /// Values are of the form `projects/{project}/instances/{instance}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Required. The ID to be used when referring to the new app profile within its instance,
                ...
                /// <param name="name">Required. The unique name of the app profile to be deleted. Values are of the form
                /// `projects/{project}/instances/{instance}/appProfiles/{app_profile}`.</param>
                public virtual DeleteRequest Delete(string name)
                {
                    return new DeleteRequest(service, name);
                }
                ...
                public class DeleteRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Empty>
                {
                    ...
                    /// <summary>Required. The unique name of the app profile to be deleted. Values are of the form
                    /// `projects/{project}/instances/{instance}/appProfiles/{app_profile}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="name">Required. The unique name of the requested app profile. Values are of the form
                /// `projects/{project}/instances/{instance}/appProfiles/{app_profile}`.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                public class GetRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.AppProfile>
                {
                    ...
                    /// <summary>Required. The unique name of the requested app profile. Values are of the form
                    /// `projects/{project}/instances/{instance}/appProfiles/{app_profile}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="parent">Required. The unique name of the instance for which a list of app profiles is requested. Values
                /// are of the form `projects/{project}/instances/{instance}`. Use `{instance} = '-'` to list AppProfiles for all
                /// Instances in a project, e.g., `projects/myproject/instances/-`.</param>
                ...
                public class ListRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.ListAppProfilesResponse>
                {
                    ...
                    /// <summary>Required. The unique name of the instance for which a list of app profiles is
                    /// requested. Values are of the form `projects/{project}/instances/{instance}`. Use `{instance} =
                    /// '-'` to list AppProfiles for all Instances in a project, e.g.,
                    /// `projects/myproject/instances/-`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The unique name of the app profile. Values are of the form
                /// `projects/{project}/instances/{instance}/appProfiles/_a-zA-Z0-9*`.</param>
                ...
                public class PatchRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Operation>
                {
                    ...
                    /// <summary>Required. The subset of app profile fields which should be replaced. If unset, all
                    /// fields will be replaced.</summary>
            ...
            public class ClustersResource
            {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Required. The unique name of the instance in which to create the new cluster. Values are of the
                /// form `projects/{project}/instances/{instance}`.</param>
                ...
                public class CreateRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Operation>
                {
                    ...
                    /// <summary>Required. The unique name of the instance in which to create the new cluster. Values
                    /// are of the form `projects/{project}/instances/{instance}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Required. The ID to be used when referring to the new cluster within its instance,
                    /// e.g., just `mycluster` rather than
                    /// `projects/myproject/instances/myinstance/clusters/mycluster`.</summary>
                ...
                /// <param name="name">Required. The unique name of the cluster to be deleted. Values are of the form
                /// `projects/{project}/instances/{instance}/clusters/{cluster}`.</param>
                public virtual DeleteRequest Delete(string name)
                {
                    return new DeleteRequest(service, name);
                ...
                public class DeleteRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Empty>
                {
                    ...
                    /// <summary>Required. The unique name of the cluster to be deleted. Values are of the form
                    /// `projects/{project}/instances/{instance}/clusters/{cluster}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="name">Required. The unique name of the requested cluster. Values are of the form
                /// `projects/{project}/instances/{instance}/clusters/{cluster}`.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                public class GetRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Cluster>
                {
                    ...
                    /// <summary>Required. The unique name of the requested cluster. Values are of the form
                    /// `projects/{project}/instances/{instance}/clusters/{cluster}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="parent">Required. The unique name of the instance for which a list of clusters is requested. Values are
                /// of the form `projects/{project}/instances/{instance}`. Use `{instance} = '-'` to list Clusters for all Instances in
                /// a project, e.g., `projects/myproject/instances/-`.</param>
                public virtual ListRequest List(string parent)
                {
                    return new ListRequest(service, parent);
                }
                ...
                public class ListRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.ListClustersResponse>
                {
                    ...
                    /// <summary>Required. The unique name of the instance for which a list of clusters is requested.
                    /// Values are of the form `projects/{project}/instances/{instance}`. Use `{instance} = '-'` to list
                    /// Clusters for all Instances in a project, e.g., `projects/myproject/instances/-`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">The unique name of the cluster. Values are of the form
                /// `projects/{project}/instances/{instance}/clusters/a-z*`.</param>
            ...
            public class TablesResource
            {
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The unique name of the Table for which to check replication consistency. Values are of
                /// the form `projects/{project}/instances/{instance}/tables/{table}`.</param>
                ...
                public class CheckConsistencyRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.CheckConsistencyResponse>
                {
                    ...
                    /// <summary>Required. The unique name of the Table for which to check replication consistency.
                    /// Values are of the form `projects/{project}/instances/{instance}/tables/{table}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Required. The unique name of the instance in which to create the table. Values are of the form
                /// `projects/{project}/instances/{instance}`.</param>
                ...
                public class CreateRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Table>
                {
                    ...
                    /// <summary>Required. The unique name of the instance in which to create the table. Values are of
                    /// the form `projects/{project}/instances/{instance}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <param name="name">Required. The unique name of the table to be deleted. Values are of the form
                /// `projects/{project}/instances/{instance}/tables/{table}`.</param>
                public virtual DeleteRequest Delete(string name)
                {
                    return new DeleteRequest(service, name);
                }
                ...
                public class DeleteRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Empty>
                {
                    ...
                    /// <summary>Required. The unique name of the table to be deleted. Values are of the form
                    /// `projects/{project}/instances/{instance}/tables/{table}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The unique name of the table on which to drop a range of rows. Values are of the form
                /// `projects/{project}/instances/{instance}/tables/{table}`.</param>
                ...
                public class DropRowRangeRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Empty>
                {
                    ...
                    /// <summary>Required. The unique name of the table on which to drop a range of rows. Values are of
                    /// the form `projects/{project}/instances/{instance}/tables/{table}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The unique name of the Table for which to create a consistency token. Values are of the
                /// form `projects/{project}/instances/{instance}/tables/{table}`.</param>
                ...
                public class GenerateConsistencyTokenRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.GenerateConsistencyTokenResponse>
                {
                    ...
                    /// <summary>Required. The unique name of the Table for which to create a consistency token. Values
                    /// are of the form `projects/{project}/instances/{instance}/tables/{table}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="name">Required. The unique name of the requested table. Values are of the form
                /// `projects/{project}/instances/{instance}/tables/{table}`.</param>
                public virtual GetRequest Get(string name)
                {
                    return new GetRequest(service, name);
                ...
                public class GetRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Table>
                {
                    ...
                    /// <summary>Required. The unique name of the requested table. Values are of the form
                    /// `projects/{project}/instances/{instance}/tables/{table}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                ...
                /// <param name="parent">Required. The unique name of the instance for which tables should be listed. Values are of the
                /// form `projects/{project}/instances/{instance}`.</param>
                public virtual ListRequest List(string parent)
                {
                    return new ListRequest(service, parent);
                ...
                public class ListRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.ListTablesResponse>
                {
                    ...
                    /// <summary>Required. The unique name of the instance for which tables should be listed. Values are
                    /// of the form `projects/{project}/instances/{instance}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The unique name of the table whose families should be modified. Values are of the form
                /// `projects/{project}/instances/{instance}/tables/{table}`.</param>
                ...
                public class ModifyColumnFamiliesRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Table>
                {
                    ...
                    /// <summary>Required. The unique name of the table whose families should be modified. Values are of
                    /// the form `projects/{project}/instances/{instance}/tables/{table}`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Required. The unique name of the project in which to create the new instance. Values are of the
            /// form `projects/{project}`.</param>
            ...
            public class CreateRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Operation>
            {
                ...
                /// <summary>Required. The unique name of the project in which to create the new instance. Values are of
                /// the form `projects/{project}`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            /// <param name="name">Required. The unique name of the instance to be deleted. Values are of the form
            /// `projects/{project}/instances/{instance}`.</param>
            public virtual DeleteRequest Delete(string name)
            {
                return new DeleteRequest(service, name);
            ...
            public class DeleteRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Empty>
            {
                ...
                /// <summary>Required. The unique name of the instance to be deleted. Values are of the form
                /// `projects/{project}/instances/{instance}`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="name">Required. The unique name of the requested instance. Values are of the form
            /// `projects/{project}/instances/{instance}`.</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            ...
            public class GetRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Instance>
            {
                ...
                /// <summary>Required. The unique name of the requested instance. Values are of the form
                /// `projects/{project}/instances/{instance}`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="parent">Required. The unique name of the project for which a list of instances is requested. Values are
            /// of the form `projects/{project}`.</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            }
            ...
            public class ListRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.ListInstancesResponse>
            {
                ...
                /// <summary>Required. The unique name of the project for which a list of instances is requested. Values
                /// are of the form `projects/{project}`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">The unique name of the instance. Values are of the form
            /// `projects/{project}/instances/a-z+[a-z0-9]`.</param>
            ...
            public class PartialUpdateInstanceRequest : BigtableAdminBaseServiceRequest<Google.Apis.BigtableAdmin.v2.Data.Operation>
            {
                ...
                /// <summary>Required. The subset of Instance fields which should be replaced. Must be explicitly
                /// set.</summary>
                [Google.Apis.Util.RequestParameterAttribute("updateMask", Google.Apis.Util.RequestParameterType.Query)]
                public virtual object UpdateMask { get; set; }
...
{    
    ...
    {
        /// <summary>Required. Modifications to be atomically applied to the specified table's families. Entries are
