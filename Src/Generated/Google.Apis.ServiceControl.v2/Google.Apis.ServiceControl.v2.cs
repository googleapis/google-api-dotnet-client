...
namespace Google.Apis.ServiceControl.v2
{
    ...
    public class ServicesResource
    {
        ...
        public class CheckRequest : ServiceControlBaseServiceRequest<Google.Apis.ServiceControl.v2.Data.CheckResponse>
        {
            ...
            public CheckRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceControl.v2.Data.CheckRequest body, string serviceName)
                : base(service)
            {
        ...
        public class ReportRequest : ServiceControlBaseServiceRequest<Google.Apis.ServiceControl.v2.Data.ReportResponse>
        {
            ...
            public ReportRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceControl.v2.Data.ReportRequest body, string serviceName)
                : base(service)
            {
                ServiceName = serviceName;
                Body = body;
...
{    
    ...
    /// <summary>This message defines attributes associated with API operations, such as a network API request. The
    /// terminology is based on the conventions used by Google APIs, Istio, and OpenAPI.</summary>
    public class Api : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The API operation name. For gRPC requests, it is the fully qualified API method name, such as
    ...
    /// <summary>Response message for the Report method. If the request contains any invalid data, the server returns an
    /// RPC error.</summary>
    ...
    /// <summary>This message defines attributes for a typical network response. It generally models semantics of an
