 ...
 *      <tr><th>API Rev<td>20190407 (1557)
 *      <tr><th>API Docs
...
namespace Google.Apis.AndroidPublisher.v2
{
    ...
    public class EditsResource
    {
        ...
        private readonly BundlesResource bundles;

        /// <summary>Gets the Bundles resource.</summary>
        public virtual BundlesResource Bundles
        {
            get { return bundles; }
        }
        ...
        public class BundlesResource
        {
            ...
            public class ListRequest : AndroidPublisherBaseServiceRequest<Google.Apis.AndroidPublisher.v2.Data.BundlesListResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string packageName, string editId)
                    : base(service)
            ...
            /// minutes is recommended). See: https://developers.google.com/api-client-library/java/google-api-java-
            /// client/errors for an example in java.</summary>
            public class UploadRequest : AndroidPublisherBaseServiceRequest<Google.Apis.AndroidPublisher.v2.Data.Bundle>
            {
                /// <summary>Constructs a new Upload request.</summary>
                public UploadRequest(Google.Apis.Services.IClientService service, string packageName, string editId)
                    : base(service)
            ...
            /// <summary>Upload media upload which supports resumable upload.</summary>
            public class UploadMediaUpload : Google.Apis.Upload.ResumableUpload<string, Google.Apis.AndroidPublisher.v2.Data.Bundle>
            {
...
{    
    ...
    /// <summary>Contains the price change information for a subscription that can be used to control the user journey
    /// for the price change in the app. This can be in the form of seeking confirmation from the user or tailoring the
    /// experience for a successful conversion.</summary>
    ...
    public class Track : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Version codes to make active on this track. Note that this list should contain all versions you
        /// wish to be active, including those you wish to retain from previous releases.</summary>
