...
namespace Google.Apis.Texttospeech.v1
{
    ...
    public class VoicesResource
    {
        ...
        /// </summary>
        /// <param name="body">The body of the request.</param>
        public virtual GenerateVoiceCloningKeyRequest GenerateVoiceCloningKey(Google.Apis.Texttospeech.v1.Data.GenerateVoiceCloningKeyRequest body)
        {
        ...
        /// of checks against the voice talent statement to verify the voice clone is safe to generate.
        /// </summary>
        public class GenerateVoiceCloningKeyRequest : TexttospeechBaseServiceRequest<Google.Apis.Texttospeech.v1.Data.GenerateVoiceCloningKeyResponse>
        {
            /// <summary>Constructs a new GenerateVoiceCloningKey request.</summary>
            public GenerateVoiceCloningKeyRequest(Google.Apis.Services.IClientService service, Google.Apis.Texttospeech.v1.Data.GenerateVoiceCloningKeyRequest body) : base(service)
            {
                Body = body;
                InitParameters();
            }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Texttospeech.v1.Data.GenerateVoiceCloningKeyRequest Body { get; set; }
            ...
            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1/voices:generateVoiceCloningKey";
