...
namespace Google.Apis.GoogleHealthAPI.v4beta
{
    ...
    public class GoogleHealthAPIService : Google.Apis.Services.BaseClientService
    {
        ...
        public const string Version = "v4beta";
    ...
    public class ProjectsResource
    {
        ...
        public class SubscribersResource
        {
            ...
            public class SubscriptionsResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.GoogleHealthAPI.v4beta.Data.CreateSubscriptionPayload body, string parent)
                {
                ...
                /// subscriber to have a `SubscriptionCreatePolicy` set to `MANUAL` for the given data types.
                /// </summary>
                public class CreateRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Subscription>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.CreateSubscriptionPayload body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.GoogleHealthAPI.v4beta.Data.CreateSubscriptionPayload Body { get; set; }
                    ...
                    public override string RestPath => "v4beta/{+parent}/subscriptions";
                ...
                /// Deletes a specific user subscription, stopping notifications for this user to this subscriber.
                /// </summary>
                public class DeleteRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Empty>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+name}";
                ...
                /// data type.
                /// </summary>
                public class ListRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.ListSubscriptionsResponse>
                {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.GoogleHealthAPI.v4beta.Data.Subscription body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates the data types for an existing user subscription.</summary>
                public class PatchRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Subscription>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.Subscription body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GoogleHealthAPI.v4beta.Data.Subscription Body { get; set; }
            ...
            /// </param>
            public virtual CreateRequest Create(Google.Apis.GoogleHealthAPI.v4beta.Data.CreateSubscriberPayload body, string parent)
            {
                return new CreateRequest(this.service, body, parent);
            }
            ...
            /// the `Authorization` header.
            /// </summary>
            public class CreateRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Operation>
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.CreateSubscriberPayload body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.GoogleHealthAPI.v4beta.Data.CreateSubscriberPayload Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v4beta/{+parent}/subscribers";
            ...
            /// Deletes a subscriber registration. This will stop all notifications to the subscriber's endpoint.
            /// </summary>
            public class DeleteRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Operation>
            {
                /// <summary>Constructs a new Delete request.</summary>
                public DeleteRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists all subscribers registered within the owned Google Cloud Project.</summary>
            public class ListRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.ListSubscribersResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.GoogleHealthAPI.v4beta.Data.Subscriber body, string name)
            {
                return new PatchRequest(this.service, body, name);
            }
            ...
            /// an error will be returned.
            /// </summary>
            public class PatchRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Operation>
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.Subscriber body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.GoogleHealthAPI.v4beta.Data.Subscriber Body { get; set; }
    ...
    public class ShlResource
    {
        ...
        public class MResource
        {
            ...
            /// </param>
            public virtual GetShlManifestRequest GetShlManifest(Google.Apis.GoogleHealthAPI.v4beta.Data.ManifestParams body, string externalShlId)
            {
                return new GetShlManifestRequest(this.service, body, externalShlId);
            }

            /// <summary>Forward a manifest request for a given SHL</summary>
            public class GetShlManifestRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.HttpBody>
            {
                /// <summary>Constructs a new GetShlManifest request.</summary>
                public GetShlManifestRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.ManifestParams body, string externalShlId) : base(service)
                {
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.GoogleHealthAPI.v4beta.Data.ManifestParams Body { get; set; }
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v4beta/shl/m/{externalShlId}";
        ...
        public class RResource
        {
            ...
            /// <summary>Forward a resource request for a given SHL</summary>
            public class GetRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.HttpBody>
            {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v4beta/shl/r/{externalShlId}/{resourceToken}";
    ...
    public class UsersResource
    {
        ...
        public class DataTypesResource
        {
            ...
            public class DataPointsResource
            {
                ...
                /// </param>
                public virtual BatchDeleteRequest BatchDelete(Google.Apis.GoogleHealthAPI.v4beta.Data.BatchDeleteDataPointsRequest body, string parent)
                {
                    return new BatchDeleteRequest(this.service, body, parent);
                }

                /// <summary>Delete a batch of identifyable data points.</summary>
                public class BatchDeleteRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Operation>
                {
                    /// <summary>Constructs a new BatchDelete request.</summary>
                    public BatchDeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.BatchDeleteDataPointsRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GoogleHealthAPI.v4beta.Data.BatchDeleteDataPointsRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+parent}/dataPoints:batchDelete";
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.GoogleHealthAPI.v4beta.Data.DataPoint body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.DataPoint body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GoogleHealthAPI.v4beta.Data.DataPoint Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+parent}/dataPoints";
                ...
                /// value union field.
                /// </param>
                public virtual DailyRollUpRequest DailyRollUp(Google.Apis.GoogleHealthAPI.v4beta.Data.DailyRollUpDataPointsRequest body, string parent)
                {
                    return new DailyRollUpRequest(this.service, body, parent);
                }

                /// <summary>Roll up data points over civil time intervals for supported data types.</summary>
                public class DailyRollUpRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.DailyRollUpDataPointsResponse>
                {
                    /// <summary>Constructs a new DailyRollUp request.</summary>
                    public DailyRollUpRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.DailyRollUpDataPointsRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GoogleHealthAPI.v4beta.Data.DailyRollUpDataPointsRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+parent}/dataPoints:dailyRollUp";
                ...
                /// (`normal` or `readonly`) in their access token to succeed.
                /// </summary>
                public class ExportExerciseTcxRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.ExportExerciseTcxResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+name}:exportExerciseTcx";
                ...
                /// <summary>Get a single identifyable data point.</summary>
                public class GetRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.DataPoint>
                {
                    /// <summary>Constructs a new Get request.</summary>
                ...
                /// <summary>Query user health and fitness data points.</summary>
                public class ListRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.ListDataPointsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.GoogleHealthAPI.v4beta.Data.DataPoint body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.DataPoint body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// <summary>Reconcile data points from multiple data sources into a single data stream.</summary>
                public class ReconcileRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.ReconcileDataPointsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+parent}/dataPoints:reconcile";
                ...
                /// union field.
                /// </param>
                public virtual RollUpRequest RollUp(Google.Apis.GoogleHealthAPI.v4beta.Data.RollUpDataPointsRequest body, string parent)
                {
                    return new RollUpRequest(this.service, body, parent);
                }

                /// <summary>Roll up data points over physical time intervals for supported data types.</summary>
                public class RollUpRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.RollUpDataPointsResponse>
                {
                    /// <summary>Constructs a new RollUp request.</summary>
                    public RollUpRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.RollUpDataPointsRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.GoogleHealthAPI.v4beta.Data.RollUpDataPointsRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v4beta/{+parent}/dataPoints:rollUp";
        ...
        public class PairedDevicesResource
        {
            ...
            /// <summary>Returns user's Device.</summary>
            public class GetRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.PairedDevice>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Returns the user's list of paired 1P trackers and smartwatches.</summary>
            public class ListRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.ListPairedDevicesResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
                ...
                /// <summary>Gets the REST path.</summary>
                public override string RestPath => "v4beta/{+parent}/pairedDevices";
        ...
        /// migrating clients to map identifiers between the two systems.
        /// </summary>
        public class GetIdentityRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Identity>
        {
        ...
        /// <summary>Returns user's IRN Profile details.</summary>
        public class GetIrnProfileRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.IrnProfile>
        {
        ...
        /// <summary>Returns user Profile details.</summary>
        public class GetProfileRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Profile>
        {
        ...
        /// <summary>Returns user settings details.</summary>
        public class GetSettingsRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Settings>
        {
        ...
        /// </param>
        public virtual UpdateProfileRequest UpdateProfile(Google.Apis.GoogleHealthAPI.v4beta.Data.Profile body, string name)
        {
            return new UpdateProfileRequest(this.service, body, name);
        }

        /// <summary>Updates the user's profile details.</summary>
        public class UpdateProfileRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Profile>
        {
            /// <summary>Constructs a new UpdateProfile request.</summary>
            public UpdateProfileRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.Profile body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.GoogleHealthAPI.v4beta.Data.Profile Body { get; set; }
        ...
        /// The literal `me` can also be used to refer to the authenticated user.
        /// </param>
        public virtual UpdateSettingsRequest UpdateSettings(Google.Apis.GoogleHealthAPI.v4beta.Data.Settings body, string name)
        {
            return new UpdateSettingsRequest(this.service, body, name);
        }

        /// <summary>Updates the user's settings details.</summary>
        public class UpdateSettingsRequest : GoogleHealthAPIBaseServiceRequest<Google.Apis.GoogleHealthAPI.v4beta.Data.Settings>
        {
            /// <summary>Constructs a new UpdateSettings request.</summary>
            public UpdateSettingsRequest(Google.Apis.Services.IClientService service, Google.Apis.GoogleHealthAPI.v4beta.Data.Settings body, string name) : base(service)
            {
                Name = name;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.GoogleHealthAPI.v4beta.Data.Settings Body { get; set; }
