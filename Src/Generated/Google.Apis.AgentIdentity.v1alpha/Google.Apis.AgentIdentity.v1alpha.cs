    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class AccessSummariesResource
            {
                ...
                /// <summary>Gets details of a single AccessSummary.</summary>
                public class GetRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AccessSummary>
                {
                ...
                /// the SPIFFE ID of the agent. Example: `workload_id="spiffe://example.com/ns/default/sa/my-agent"`
                /// </summary>
                public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.ListAccessSummariesResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+parent}/accessSummaries";
            ...
            public class AuthProvidersResource
            {
                ...
                public class AuthorizationsResource
                {
                    ...
                    /// <summary>Deletes a single Authorization.</summary>
                    public class DeleteRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.Empty>
                    {
                    ...
                    /// <summary>Gets details of a single Authorization.</summary>
                    public class GetRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.Authorization>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                        {
                    ...
                    /// <summary>Lists Authorizations in a given project and location.</summary>
                    public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.ListAuthorizationsResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                        {
                ...
                /// projects/{project}/locations/{location}
                /// </param>
                public virtual CreateRequest Create(Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider body, string parent)
                {
                    return new CreateRequest(this.service, body, parent);
                }

                /// <summary>Creates a new AuthProvider in a given project and location.</summary>
                public class CreateRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+parent}/authProviders";
                ...
                /// projects/{project}/locations/{location}/authProviders/{auth_provider}
                /// </param>
                public virtual DisableRequest Disable(Google.Apis.AgentIdentity.v1alpha.Data.DisableAuthProviderRequest body, string name)
                {
                    return new DisableRequest(this.service, body, name);
                }

                /// <summary>Disables a single AuthProvider.</summary>
                public class DisableRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider>
                {
                    /// <summary>Constructs a new Disable request.</summary>
                    public DisableRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.DisableAuthProviderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1alpha.Data.DisableAuthProviderRequest Body { get; set; }
                ...
                /// projects/{project}/locations/{location}/authProviders/{auth_provider}
                /// </param>
                public virtual EnableRequest Enable(Google.Apis.AgentIdentity.v1alpha.Data.EnableAuthProviderRequest body, string name)
                {
                    return new EnableRequest(this.service, body, name);
                }

                /// <summary>Enables a single AuthProvider.</summary>
                public class EnableRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider>
                {
                    /// <summary>Constructs a new Enable request.</summary>
                    public EnableRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.EnableAuthProviderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1alpha.Data.EnableAuthProviderRequest Body { get; set; }
                ...
                /// <summary>Gets details of a single AuthProvider.</summary>
                public class GetRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                    {
                ...
                /// does not have a policy set.
                /// </summary>
                public class GetIamPolicyRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.Policy>
                {
                ...
                /// <summary>Lists AuthProviders in a given project and location.</summary>
                public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.ListAuthProvidersResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                ...
                /// projects/{project}/locations/{location}/authProviders/{auth_provider}
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider body, string name)
                {
                    return new PatchRequest(this.service, body, name);
                }

                /// <summary>Updates the parameters of a single AuthProvider.</summary>
                public class PatchRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                /// <summary>Queries what all auth_providers are used by a given workload_id.</summary>
                public class QueryRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.QueryAuthProvidersResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+parent}/authProviders:query";
                ...
                /// <summary>Queries what all workloads are using a given auth_provider.</summary>
                public class QueryWorkloadsRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.QueryWorkloadsResponse>
                {
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+name}:queryWorkloads";
                ...
                /// projects/{project}/locations/{location}/authProviders/{auth_provider}
                /// </param>
                public virtual RevokeAuthorizationRequest RevokeAuthorization(Google.Apis.AgentIdentity.v1alpha.Data.RevokeAuthorizationRequest body, string name)
                {
                ...
                /// records associated with the user and AuthProvider, effectively revoking access across all agents.
                /// </summary>
                public class RevokeAuthorizationRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.RevokeAuthorizationResponse>
                {
                    /// <summary>Constructs a new RevokeAuthorization request.</summary>
                    public RevokeAuthorizationRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.RevokeAuthorizationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1alpha.Data.RevokeAuthorizationRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+name}:revokeAuthorization";
                ...
                /// field.
                /// </param>
                public virtual SetIamPolicyRequest SetIamPolicy(Google.Apis.AgentIdentity.v1alpha.Data.SetIamPolicyRequest body, string resource)
                {
                ...
                /// `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
                /// </summary>
                public class SetIamPolicyRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.Policy>
                {
                    /// <summary>Constructs a new SetIamPolicy request.</summary>
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.SetIamPolicyRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1alpha.Data.SetIamPolicyRequest Body { get; set; }
                ...
                /// field.
                /// </param>
                public virtual TestIamPermissionsRequest TestIamPermissions(Google.Apis.AgentIdentity.v1alpha.Data.TestIamPermissionsRequest body, string resource)
                {
                ...
                /// checking. This operation may "fail open" without warning.
                /// </summary>
                public class TestIamPermissionsRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.TestIamPermissionsResponse>
                {
                    /// <summary>Constructs a new TestIamPermissions request.</summary>
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.TestIamPermissionsRequest body, string resource) : base(service)
                    {
                        Resource = resource;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1alpha.Data.TestIamPermissionsRequest Body { get; set; }
                ...
                /// projects/{project}/locations/{location}/authProviders/{auth_provider}
                /// </param>
                public virtual UndeleteRequest Undelete(Google.Apis.AgentIdentity.v1alpha.Data.UndeleteAuthProviderRequest body, string name)
                {
                    return new UndeleteRequest(this.service, body, name);
                }

                /// <summary>Undeletes a single AuthProvider.</summary>
                public class UndeleteRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.AuthProvider>
                {
                    /// <summary>Constructs a new Undelete request.</summary>
                    public UndeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.AgentIdentity.v1alpha.Data.UndeleteAuthProviderRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.AgentIdentity.v1alpha.Data.UndeleteAuthProviderRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1alpha/{+name}:undelete";
            ...
            /// <summary>Gets information about a location.</summary>
            public class GetRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// specific service implementation and version.
            /// </summary>
            public class ListRequest : AgentIdentityBaseServiceRequest<Google.Apis.AgentIdentity.v1alpha.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
