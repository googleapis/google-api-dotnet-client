...
namespace Google.Apis.CloudResourceManager.v2
{
    ...
    public class FoldersResource
    {
        ...
        public class CreateRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.Operation>
        {
            ...
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.Folder body)
                : base(service)
            {
                Body = body;
                InitParameters();
        ...
        public class GetIamPolicyRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.Policy>
        {
            ...
            public GetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.GetIamPolicyRequest body, string resource)
                : base(service)
            {
                Resource = resource;
                Body = body;
        ...
        public class MoveRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.Operation>
        {
            ...
            public MoveRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.MoveFolderRequest body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
        ...
        public class PatchRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.Folder>
        {
            ...
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.Folder body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
        ...
        public class SearchRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.SearchFoldersResponse>
        {
            ...
            public SearchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.SearchFoldersRequest body)
                : base(service)
            {
                Body = body;
                InitParameters();
        ...
        public class SetIamPolicyRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.Policy>
        {
            ...
            public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.SetIamPolicyRequest body, string resource)
                : base(service)
            {
                Resource = resource;
                Body = body;
        ...
        public class TestIamPermissionsRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.TestIamPermissionsResponse>
        {
            ...
            public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.TestIamPermissionsRequest body, string resource)
                : base(service)
            {
                Resource = resource;
                Body = body;
        ...
        public class UndeleteRequest : CloudResourceManagerBaseServiceRequest<Google.Apis.CloudResourceManager.v2.Data.Folder>
        {
            ...
            public UndeleteRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudResourceManager.v2.Data.UndeleteFolderRequest body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
