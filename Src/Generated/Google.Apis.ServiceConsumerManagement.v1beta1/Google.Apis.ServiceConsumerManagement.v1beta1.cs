        ...
        public class ConsumerQuotaMetricsResource
        {
            ...
            public class LimitsResource
            {
                ...
                public class ProducerOverridesResource
                {
                    ...
                    ///
                    /// An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%
                    ...
                    public class CreateRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
                    {
                        ...
                        ///
                        /// An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics
                    ...
                    ///
                    /// An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%
                    /// 2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/4a3f2c1d`</param>
                    ...
                    public class DeleteRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
                    {
                        ...
                        ///
                        /// An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics
                        /// /compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/4a3f2c1d`</summa
                        /// ry>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                ...
                public class GetRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ConsumerQuotaLimit>
                {
                    ...
                    /// GetConsumerQuotaMetric call.
                    ///
                    /// An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/com
                    /// pute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
            ...
            /// <param name="name">The resource name of the quota metric, returned by a ListConsumerQuotaMetrics call.
            ///
            ...
            public class GetRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ConsumerQuotaMetric>
            {
                ...
                /// <summary>The resource name of the quota metric, returned by a ListConsumerQuotaMetrics call.
                ///
                /// An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute
                /// .googleapis.com%2Fcpus`</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            ///
            /// An example name would be: `services/compute.googleapis.com/projects/123`</param>
            ...
            public class ImportProducerOverridesRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
            {
                ...
                ///
                /// An example name would be: `services/compute.googleapis.com/projects/123`</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            ///
            /// An example parent would be: `services/serviceconsumermanagement.googleapis.com/projects/123`</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            }
...
{    
    ...
    public class V1Beta1ConsumerQuotaLimit : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// An example name would be: `services/compute.googleapis.com/projects/123/quotas/metrics/compute.googleapis.co
        /// m%2Fcpus/limits/%2Fproject%2Fregion`
        ///
    ...
    /// <summary>Response message for the `GenerateServiceIdentity` method.
    ///
    ...
    public class V1Beta1QuotaOverride : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The name of the metric to which this override applies.
        ///
        /// An example name would be: `compute.googleapis.com/cpus`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("metric")]
        public virtual string Metric { get; set; } 
        ...
        /// <summary>The limit unit of the limit to which this override applies.
        ///
        /// An example unit would be: `1/{project}/{region}` Note that `{project}` and `{region}` are not placeholders
        /// in this example; the literal characters `{` and `}` occur in the string.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("unit")]
    ...
    public class V1Beta1ServiceIdentity : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>P4 service identity resource name.
        ///
        /// An example name would be:
    ...
    /// <summary>Response message for the `GenerateServiceAccount` method.
    ///
    /// This response message is assigned to the `response` field of the returned Operation when that operation is
    /// done.</summary>
