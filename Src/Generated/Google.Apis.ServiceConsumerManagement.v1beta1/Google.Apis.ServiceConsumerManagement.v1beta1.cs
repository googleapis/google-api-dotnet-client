...
namespace Google.Apis.ServiceConsumerManagement.v1beta1
{
    ...
    public class ServiceConsumerManagementService : Google.Apis.Services.BaseClientService
    {
        ...
        public ServiceConsumerManagementService() :
            this(new Google.Apis.Services.BaseClientService.Initializer()) {}

        /// <summary>Constructs a new service.</summary>
        /// <param name="initializer">The service initializer.</param>
        public ServiceConsumerManagementService(Google.Apis.Services.BaseClientService.Initializer initializer)
            : base(initializer)
        {
    ...
    public abstract class ServiceConsumerManagementBaseServiceRequest<TResponse> : Google.Apis.Requests.ClientServiceRequest<TResponse>
    {
        ...
        protected ServiceConsumerManagementBaseServiceRequest(Google.Apis.Services.IClientService service)
            : base(service)
        {
        }
    ...
    public class OperationsResource
    {
        ...
        /// <summary>Gets the latest state of a long-running operation. Clients can use this method to poll the
        /// operation result at intervals as recommended by the API service.</summary>
        public class GetRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
        {
    ...
    public class ServicesResource
    {
        ...
        public class ConsumerQuotaMetricsResource
        {
            ...
            public class LimitsResource
            {
                ...
                public virtual ProducerOverridesResource ProducerOverrides { get; }
                ...
                public class ProducerOverridesResource
                {
                    ...
                    /// <summary>Creates a producer override. A producer override is applied by the owner or
                    /// administrator of a service to increase or decrease the amount of quota a consumer of the service
                    /// is allowed to use. To create multiple overrides at once, use ImportProducerOverrides instead. If
                    /// an override with the specified dimensions already exists, this call will fail. To overwrite an
                    /// existing override if one is already present ("upsert" semantics), use ImportProducerOverrides
                    /// instead.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">The resource name of the parent quota limit, returned by a ListConsumerQuotaMetrics or
                    /// GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMe
                    /// trics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</param>
                    ...
                    public class CreateRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1QuotaOverride body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                        ...
                        /// or GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/p
                        /// rojects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</
                        /// summary>
                        ...
                        Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1QuotaOverride Body { get; set; }
                        ...
                        ///<summary>Gets the REST path.</summary>
                        public override string RestPath => "v1beta1/{+parent}/producerOverrides";
                    ...
                    /// <param name="name">The resource name of the override to delete. An example name would be: `services/compute.googleap
                    /// is.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/
                    /// 4a3f2c1d`</param>
                    ...
                    public class DeleteRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
                    {
                        ...
                        /// <summary>The resource name of the override to delete. An example name would be: `services/co
                        /// mpute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/
                        /// %2Fproject%2Fregion/producerOverrides/4a3f2c1d`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                    ...
                    /// <summary>Lists all producer overrides on this limit.</summary>
                    public class ListRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ListProducerOverridesResponse>
                    {
                    ...
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">The resource name of the override to update. An example name would be: `services/compute.googleap
                    /// is.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/
                    /// 4a3f2c1d`</param>
                    ...
                    public class PatchRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
                    {
                        ...
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1QuotaOverride body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// <summary>The resource name of the override to update. An example name would be: `services/co
                        /// mpute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/
                        /// %2Fproject%2Fregion/producerOverrides/4a3f2c1d`</summary>
                        [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string Name { get; private set; }
                        ...
                        /// <summary>Update only the specified fields. If unset, all modifiable fields will be
                        /// updated.</summary>
                ...
                /// <param name="name">The resource name of the quota limit, returned by a ListConsumerQuotaMetrics or
                /// GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMe
                /// trics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</param>
                public virtual GetRequest Get(string name)
                {
                ...
                /// <summary>Retrieves a summary of quota information for a specific quota limit.</summary>
                public class GetRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ConsumerQuotaLimit>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name)
                        : base(service)
                    ...
                    /// <summary>The resource name of the quota limit, returned by a ListConsumerQuotaMetrics or
                    /// GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/projects
                    /// /123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }
                    ...
                    {
                        /// <summary>No quota view specified. Requests that do not specify a quota view will typically
                        /// default to the BASIC view.</summary>
                        ...
                        BASIC,
                        /// <summary>Include per-location buckets even if they do not have overrides. When the view is
                        /// FULL, and a limit has regional or zonal quota, the limit will include buckets for all
                        /// regions or zones that could support overrides, even if none are currently present. In some
                        /// cases this will cause the response to become very large; callers that do not need this extra
                        /// information should use the BASIC view instead.</summary>
            ...
            /// <param name="name">The resource name of the quota metric, returned by a ListConsumerQuotaMetrics call. An example
            /// name would be:
            /// `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus`</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            }
            ...
            /// <summary>Retrieves a summary of quota information for a specific quota metric.</summary>
            public class GetRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ConsumerQuotaMetric>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
                ...
                /// <summary>The resource name of the quota metric, returned by a ListConsumerQuotaMetrics call. An
                /// example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.go
                /// ogleapis.com%2Fcpus`</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
                ...
                public enum ViewEnum
                {
                    ...
                    [Google.Apis.Util.StringValueAttribute("BASIC")]
                    BASIC,
                    /// <summary>Include per-location buckets even if they do not have overrides. When the view is FULL,
                    /// and a limit has regional or zonal quota, the limit will include buckets for all regions or zones
                    /// that could support overrides, even if none are currently present. In some cases this will cause
                    /// the response to become very large; callers that do not need this extra information should use
                    /// the BASIC view instead.</summary>
                    [Google.Apis.Util.StringValueAttribute("FULL")]
                    FULL,
                }
            ...
            /// <summary>Create or update multiple producer overrides atomically, all on the same consumer, but on many
            ...
            /// `services/compute.googleapis.com/projects/123`</param>
            ...
            /// <summary>Create or update multiple producer overrides atomically, all on the same consumer, but on many
            /// different metrics or limits. The name field in the quota override message should not be set.</summary>
            public class ImportProducerOverridesRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.Operation>
            {
                /// <summary>Constructs a new ImportProducerOverrides request.</summary>
                public ImportProducerOverridesRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ImportProducerOverridesRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// `services/compute.googleapis.com/projects/123`</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }


                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ImportProducerOverridesRequest Body { get; set; }

                ///<summary>Returns the body of the request.</summary>
                protected override object GetBody() => Body;

                ///<summary>Gets the method name.</summary>
                public override string MethodName => "importProducerOverrides";
            ...
            /// <summary>Retrieves a summary of all quota information about this consumer that is visible to the service
            ...
            /// value), the current effective limit value, and all of the overrides applied to the limit.</summary>
            /// <param name="parent">Parent of the quotas resource. An example parent would be:
            /// `services/serviceconsumermanagement.googleapis.com/projects/123`</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            }
            ...
            /// its defined limits. Each limit includes the limit configuration (quota unit, preciseness, default
            /// value), the current effective limit value, and all of the overrides applied to the limit.</summary>
            public class ListRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1beta1.Data.V1Beta1ListConsumerQuotaMetricsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent)
                    : base(service)
                ...
                /// <summary>Parent of the quotas resource. An example parent would be:
                /// `services/serviceconsumermanagement.googleapis.com/projects/123`</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
...
{    
    ...
    public class V1Beta1ConsumerQuotaLimit : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The name of the parent metric of this limit. An example name would be:
        /// `compute.googleapis.com/cpus`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("metric")]
        public virtual string Metric { get; set; } 

        /// <summary>The resource name of the quota limit. An example name would be: `services/compute.googleapis.com/pr
        /// ojects/123/quotas/metrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion` The resource name is
        /// intended to be opaque and should not be parsed for its component strings, since its representation could
        ...
        /// <summary>The limit unit. An example unit would be: `1/{project}/{region}` Note that `{project}` and
        /// `{region}` are not placeholders in this example; the literal characters `{` and `}` occur in the
        /// string.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("unit")]
        public virtual string Unit { get; set; } 
    ...
    public class V1Beta1ConsumerQuotaMetric : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<V1Beta1ConsumerQuotaLimit> ConsumerQuotaLimits { get; set; } 
        ...
        /// <summary>The resource name of the quota settings on this metric for this consumer. An example name would be:
    ...
    /// <summary>Response message for the `EnableConsumer` method. This response message is assigned to the `response`
    /// field of the returned Operation when that operation is done.</summary>
    ...
    /// <summary>Response message for the `GenerateServiceIdentity` method. This response message is assigned to the
    ...
    /// <summary>Request message for ImportProducerOverrides</summary>
    public class V1Beta1ImportProducerOverridesRequest : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class V1Beta1ListConsumerQuotaMetricsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("metrics")]
        public virtual System.Collections.Generic.IList<V1Beta1ConsumerQuotaMetric> Metrics { get; set; } 
    ...
    public class V1Beta1ListProducerOverridesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Token identifying which result to start with; returned by a previous list call.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; } 
    ...
    public class V1Beta1ProducerQuotaPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// in the limit unit. For example, an policy on a limit with the unit 1/{project}/{region} could contain an
        /// entry with the key "region" and the value "us-east-1"; the policy is only applied to quota consumed in that
        ...
        /// a valid key; the API does not support quota polcies that apply only to a specific user. * If "region"
        ...
        /// other than "region" or "zone" must also appear in the map.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("dimensions")]
        public virtual System.Collections.Generic.IDictionary<string,string> Dimensions { get; set; } 

        /// <summary>The name of the metric to which this policy applies. An example name would be:
        /// `compute.googleapis.com/cpus`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("metric")]
        public virtual string Metric { get; set; } 
        ...
        /// <summary>The limit unit of the limit to which this policy applies. An example unit would be:
        /// `1/{project}/{region}` Note that `{project}` and `{region}` are not placeholders in this example; the
        /// literal characters `{` and `}` occur in the string.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("unit")]
        public virtual string Unit { get; set; } 
    ...
    public class V1Beta1QuotaBucket : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The dimensions of this quota bucket. If this map is empty, this is the global bucket, which is the
        /// default quota value applied to all requests that do not have a more specific override. If this map is
        /// nonempty, the default limit, effective limit, and quota overrides apply only to requests that have the
        /// dimensions given in the map. For example, if the map has key "region" and value "us-east-1", then the
        /// specified effective limit is only effective in that region, and the specified overrides apply only in that
        /// region.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("dimensions")]
        public virtual System.Collections.Generic.IDictionary<string,string> Dimensions { get; set; } 
    ...
    public class V1Beta1QuotaOverride : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// in the limit unit. For example, an override on a limit with the unit 1/{project}/{region} could contain an
        /// entry with the key "region" and the value "us-east-1"; the override is only applied to quota consumed in
        /// that region. This map has the following restrictions: * Keys that are not defined in the limit's unit are
        /// not valid keys. Any string appearing in {brackets} in the unit (besides {project} or {user}) is a defined
        ...
        /// valid keys other than "region" or "zone" must also appear in the map.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("dimensions")]
        public virtual System.Collections.Generic.IDictionary<string,string> Dimensions { get; set; } 

        /// <summary>The name of the metric to which this override applies. An example name would be:
        /// `compute.googleapis.com/cpus`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("metric")]
        public virtual string Metric { get; set; } 

        /// <summary>The resource name of the producer override. An example name would be: `services/compute.googleapis.
        /// com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverr
        /// ides/4a3f2c1d`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
        ...
        /// <summary>The limit unit of the limit to which this override applies. An example unit would be:
        /// `1/{project}/{region}` Note that `{project}` and `{region}` are not placeholders in this example; the
        /// literal characters `{` and `}` occur in the string.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("unit")]
        public virtual string Unit { get; set; } 
    ...
    /// <summary>Response message for the `RefreshConsumer` method. This response message is assigned to the `response`
    /// field of the returned Operation when that operation is done.</summary>
    ...
    public class V1Beta1ServiceIdentity : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>P4 service identity resource name. An example name would be:
        /// `services/serviceconsumermanagement.googleapis.com/projects/123/serviceIdentities/default`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 

        /// <summary>The P4 service identity configuration tag. This must be defined in activation_grants. If not
        /// specified when creating the account, the tag is set to "default".</summary>
    ...
    /// <summary>Response message for the `AddVisibilityLabels` method. This response message is assigned to the
    /// `response` field of the returned Operation when that operation is done.</summary>
    public class V1beta1AddVisibilityLabelsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class V1beta1DefaultIdentity : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Default identity resource name. An example name would be:
    ...
    /// <summary>Response message for the `GenerateDefaultIdentity` method. This response message is assigned to the
    /// `response` field of the returned Operation when that operation is done.</summary>
    public class V1beta1GenerateDefaultIdentityResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("identity")]
        public virtual V1beta1DefaultIdentity Identity { get; set; } 
    ...
    /// <summary>Response message for the `GenerateServiceAccount` method. This response message is assigned to the
    /// `response` field of the returned Operation when that operation is done.</summary>
    public class V1beta1GenerateServiceAccountResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>ServiceAccount that was created or retrieved.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("account")]
        public virtual V1beta1ServiceAccount Account { get; set; } 
    ...
    /// <summary>Response message for the `RemoveVisibilityLabels` method. This response message is assigned to the
    /// `response` field of the returned Operation when that operation is done.</summary>
    public class V1beta1RemoveVisibilityLabelsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The updated set of visibility labels for this consumer on this service.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IList<string> Labels { get; set; } 
    ...
    public class V1beta1ServiceAccount : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>P4 SA resource name. An example name would be:
        /// `services/serviceconsumermanagement.googleapis.com/projects/123/serviceAccounts/default`</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 

        /// <summary>The P4 SA configuration tag. This must be defined in activation_grants. If not specified when
        /// creating the account, the tag is set to "default".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("tag")]
        public virtual string Tag { get; set; } 
