...
namespace Google.Apis.RemoteBuildExecution.v1alpha
{
    ...
    public class RemoteBuildExecutionService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri =>
            ...
            BaseUriOverride ?? "https://admin-remotebuildexecution.googleapis.com/";
        #else
        ...
        public override string BatchUri => "https://admin-remotebuildexecution.googleapis.com/batch";
    ...
    public class ProjectsResource
    {
        ...
        public class InstancesResource
        {
            ...
            public class WorkerpoolsResource
            {
                ...
                /// <summary>Creates a new worker pool with a specified size and configuration. Returns a long running
                /// operation which contains a worker pool on completion. While the long running operation is in
                /// progress, any call to `GetWorkerPool` returns a worker pool in state `CREATING`.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="parent">Resource name of the instance in which to create the new worker pool. Format:
                /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.</param>
                public virtual CreateRequest Create(Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest body, string parent)
                {
                ...
                /// operation which contains a worker pool on completion. While the long running operation is in
                /// progress, any call to `GetWorkerPool` returns a worker pool in state `CREATING`.</summary>
                public class CreateRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleLongrunningOperation>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest Body { get; set; }
                    ...
                    public override string RestPath => "v1alpha/{+parent}/workerpools";
                ...
                /// <summary>Deletes the specified worker pool. Returns a long running operation, which contains a
                /// `google.protobuf.Empty` response on completion. While the long running operation is in progress, any
                /// call to `GetWorkerPool` returns a worker pool in state `DELETING`.</summary>
                /// <param name="name">Name of the worker pool to delete. Format:
                /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]/workerpools/[POOL_ID]`.</param>
                ...
                /// `google.protobuf.Empty` response on completion. While the long running operation is in progress, any
                /// call to `GetWorkerPool` returns a worker pool in state `DELETING`.</summary>
                public class DeleteRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleLongrunningOperation>
                {
                ...
                /// <summary>Returns the specified worker pool.</summary>
                /// <param name="name">Name of the worker pool to retrieve. Format:
                /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]/workerpools/[POOL_ID]`.</param>
                ...
                /// <summary>Returns the specified worker pool.</summary>
                public class GetRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool>
                {
                ...
                /// <summary>Lists worker pools in an instance.</summary>
                /// <param name="parent">Resource name of the instance. Format:
                /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.</param>
                ...
                /// <summary>Lists worker pools in an instance.</summary>
                public class ListRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse>
                {
                    ...
                    /// <summary>Resource name of the instance. Format:
                    /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }

                    /// <summary>Optional. A filter expression that filters resources listed in the response. The
                ...
                /// <summary>Updates an existing worker pool with a specified size and/or configuration. Returns a long
                /// running operation, which contains a worker pool on completion. While the long running operation is
                /// in progress, any call to `GetWorkerPool` returns a worker pool in state `UPDATING`.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">WorkerPool resource name formatted as:
                /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]/workerpools/[POOL_ID]`. name should not be populated when creating a
                /// worker pool since it is provided in the `poolId` field.</param>
                public virtual PatchRequest Patch(Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest body, string name)
                {
                ...
                public class PatchRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleLongrunningOperation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// populated when creating a worker pool since it is provided in the `poolId` field.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }


                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest Body { get; set; }
            ...
            /// <summary>Creates a new instance in the specified region. Returns a long running operation which contains
            /// an instance on completion. While the long running operation is in progress, any call to `GetInstance`
            /// returns an instance in state `CREATING`.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">Resource name of the project containing the instance. Format:
            /// `projects/[PROJECT_ID]`.</param>
            public virtual CreateRequest Create(Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest body, string parent)
            {
                return new CreateRequest(service, body, parent);
            }
            ...
            {
                /// <summary>Constructs a new Create request.</summary>
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Resource name of the project containing the instance. Format:
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest Body { get; set; }
            ...
            /// <summary>Deletes the specified instance. Returns a long running operation which contains a
            /// `google.protobuf.Empty` response on completion. Deleting an instance with worker pools in it will delete
            /// these worker pools.</summary>
            /// <param name="name">Name of the instance to delete. Format:
            /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.</param>
            public virtual DeleteRequest Delete(string name)
            {
                return new DeleteRequest(service, name);
            ...
            public class DeleteRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleLongrunningOperation>
            {
                ...
                /// <summary>Name of the instance to delete. Format:
                /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <summary>Returns the specified instance.</summary>
            /// <param name="name">Name of the instance to retrieve. Format:
            /// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            ...
            /// <summary>Returns the specified instance.</summary>
            public class GetRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            /// <summary>Lists instances in a project.</summary>
            /// <param name="parent">Resource name of the project. Format: `projects/[PROJECT_ID]`.</param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            }
            ...
            /// <summary>Lists instances in a project.</summary>
            public class ListRequest : RemoteBuildExecutionBaseServiceRequest<Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.RemoteBuildExecution.v1alpha.Data.GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add("loggingEnabled", new Google.Apis.Discovery.Parameter
                    {
                        Name = "loggingEnabled",
                        IsRequired = false,
                        ParameterType = "query",
                    ...
                    RequestParameters.Add("name1", new Google.Apis.Discovery.Parameter
                    {
                        Name = "name1",
                        IsRequired = false,
                        ParameterType = "query",
...
namespace Google.Apis.RemoteBuildExecution.v1alpha.Data
{    
