...
namespace Google.Apis.CloudAsset.v1p4beta1
{
    ...
    public class V1p4beta1Resource
    {
        ...
        /// <param name="parent">
        /// Required. The relative name of the root asset. Only resources and IAM policies within the parent will be
        ...
        public class AnalyzeIamPolicyRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p4beta1.Data.AnalyzeIamPolicyResponse>
        {
            ...
            /// IAM policy binding. If identity_selector is specified, the identity in the result will be determined by
            ...
            /// <summary>
            /// Optional. If true, the resource section of the result will expand any resource attached to an IAM policy
            /// to include resources lower in the resource hierarchy. For example, if the request analyzes for which
            /// resources user A has permission P, and the results include an IAM policy with P on a GCP folder, the
            /// results will also include resources in that folder with permission P. If resource_selector is specified,
            /// the resource section of the result will be determined by the selector, and this flag will have no
            ...
            /// to include their permissions. If access_selector is specified, the access section of the result will be
        ...
        /// destination. The output format is the JSON format that represents a AnalyzeIamPolicyResponse in the JSON
        /// format. This method implements the google.longrunning.Operation, which allows you to keep track of the
        /// export. We recommend intervals of at least 2 seconds with exponential retry to poll the export operation
        /// result. The metadata contains the request to help callers to map responses to requests.
        /// </summary>
...
namespace Google.Apis.CloudAsset.v1p4beta1.Data
{
    ...
    /// any of them. The total number of roles and permissions should be equal or less than 10.
    /// </summary>
    ...
    public class AnalyzeIamPolicyResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// A list of non-critical errors happened during the request handling to explain why `fully_explored` is false,
        /// or empty if no error happened.
        /// </summary>
    ...
    public class Options : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Optional. If true, the response will include access analysis from identities to resources via service
        /// account impersonation. This is a very expensive operation, because many derived queries will be executed.
        ...
        /// policy binding. If identity_selector is specified, the identity in the result will be determined by the
        ...
        /// <summary>
        /// Optional. If true, the resource section of the result will expand any resource attached to an IAM policy to
        /// include resources lower in the resource hierarchy. For example, if the request analyzes for which resources
        /// user A has permission P, and the results include an IAM policy with P on a GCP folder, the results will also
        /// include resources in that folder with permission P. If resource_selector is specified, the resource section
        /// of the result will be determined by the selector, and this flag will have no effect. Default is false.
        /// </summary>
        ...
        /// include their permissions. If access_selector is specified, the access section of the result will be
        /// determined by the selector, and this flag will have no effect. Default is false.
        /// </summary>
