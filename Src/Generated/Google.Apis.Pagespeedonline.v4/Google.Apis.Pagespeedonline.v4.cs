...
/**
 * \brief
 *   PageSpeed Insights API Version v4
 *
...
namespace Google.Apis.Pagespeedonline.v4
{
    ...
    public class PagespeedonlineService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri
        {
            ...
            get { return BaseUriOverride ?? "https://www.googleapis.com/pagespeedonline/v4/"; }
        #else
            get { return "https://www.googleapis.com/pagespeedonline/v4/"; }
        #endif
        }
        ...
        {
            get { return "https://www.googleapis.com/batch/pagespeedonline/v4"; }
        }

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath
        {
            get { return "batch/pagespeedonline/v4"; }
        }
        #endif
    ...
    public class PagespeedapiResource
    {
        ...
        /// <summary>Runs PageSpeed analysis on the page at the specified URL, and returns PageSpeed scores, a list of
        /// suggestions to make that page faster, and other information.</summary>
        public class RunpagespeedRequest : PagespeedonlineBaseServiceRequest<Google.Apis.Pagespeedonline.v4.Data.PagespeedApiPagespeedResponseV4>
        {
            ...
            /// <summary>Indicates if binary data containing snapshot images should be included</summary>
            /// [default: false]
            [Google.Apis.Util.RequestParameterAttribute("snapshots", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<bool> Snapshots { get; set; }
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add(
                    "snapshots", new Google.Apis.Discovery.Parameter
                    {
                        Name = "snapshots",
                        IsRequired = false,
                        ParameterType = "query",
...
{    
    ...
    public class PagespeedApiFormatStringV4 : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>List of arguments for the format string.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("args")]
        public virtual System.Collections.Generic.IList<PagespeedApiFormatStringV4.ArgsData> Args { get; set; } 
    ...
    public class PagespeedApiImageV4 : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class PagespeedApiPagespeedResponseV4 : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IDictionary<string,PagespeedApiPagespeedResponseV4.RuleGroupsDataElement> RuleGroups { get; set; } 
        ...
        /// <summary>Additional base64-encoded screenshots of the page, in various partial render states.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("snapshots")]
        public virtual System.Collections.Generic.IList<PagespeedApiImageV4> Snapshots { get; set; } 
        ...
        public class FormattedResultsData
        {
            ...
            {
                /// <summary>Whether this rule is in 'beta'. Rules in beta are new rules that are being tested, which do
                /// not impact the overall score.</summary>
                [Newtonsoft.Json.JsonPropertyAttribute("beta")]
                public virtual System.Nullable<bool> Beta { get; set; } 

                /// <summary>List of rule groups that this rule belongs to. Each entry in the list is one of "SPEED",
                /// "USABILITY", or "SECURITY".</summary>
                ...
                public class UrlBlocksData
                {
                    ...
                    public class UrlsData
                    {
                        ...
                        public virtual System.Collections.Generic.IList<PagespeedApiFormatStringV4> Details { get; set; } 
        ...
        public class LoadingExperienceData
        {
            ...
            public virtual System.Collections.Generic.IDictionary<string,LoadingExperienceData.MetricsDataElement> Metrics { get; set; } 
        ...
        {
            /// <summary>Content management system (CMS) used for the page.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("cms")]
            ...
            /// <summary>The needed round trips to load render blocking resources</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("numRenderBlockingRoundTrips")]
            public virtual System.Nullable<int> NumRenderBlockingRoundTrips { get; set; } 

            /// <summary>The needed round trips to load the full page</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("numTotalRoundTrips")]
            public virtual System.Nullable<int> NumTotalRoundTrips { get; set; } 
            ...
            /// <summary>Number of roboted resources.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("numberRobotedResources")]
            public virtual System.Nullable<int> NumberRobotedResources { get; set; } 
            ...
            /// <summary>Number of transient-failed resources.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("numberTransientFetchFailureResources")]
            public virtual System.Nullable<int> NumberTransientFetchFailureResources { get; set; } 
            ...
            /// <summary>Number of over-the-wire bytes, uses the default gzip compression strategy as an
            /// estimation.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("overTheWireResponseBytes")]
            public virtual System.Nullable<long> OverTheWireResponseBytes { get; set; } 

            /// <summary>List of roboted urls.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("robotedUrls")]
            public virtual System.Collections.Generic.IList<string> RobotedUrls { get; set; } 
            ...
            /// <summary>List of transient fetch failure urls.</summary>
            [Newtonsoft.Json.JsonPropertyAttribute("transientFetchFailureUrls")]
            public virtual System.Collections.Generic.IList<string> TransientFetchFailureUrls { get; set; } 

        }    

        /// <summary>The name of this rule group: one of "SPEED", "USABILITY", or "SECURITY".</summary>
        public class RuleGroupsDataElement
        {
            [Newtonsoft.Json.JsonPropertyAttribute("pass")]
            public virtual System.Nullable<bool> Pass { get; set; } 
