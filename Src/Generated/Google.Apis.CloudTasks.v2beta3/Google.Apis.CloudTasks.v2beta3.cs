        ...
        public class LocationsResource
        {
            ...
            public class QueuesResource
            {
                ...
                public class TasksResource
                {
                    ...
                    /// <summary>Creates a task and adds it to a queue. Tasks cannot be updated after creation; there is
                    /// no UpdateTask command. * The maximum task size is 100KB.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="parent">Required. The queue name. For example:
                    /// `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` The queue must already exist.</param>
                    ...
                    public class CreateRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Task>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.CreateTaskRequest body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                    ...
                    /// <summary>Deletes a task. A task can be deleted if it is scheduled or dispatched. A task cannot
                    /// be deleted if it has executed successfully or permanently failed.</summary>
                    ...
                    public class GetRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Task>
                    {
                        ...
                        /// <summary>The response_view specifies which subset of the Task will be returned. By default
                        ...
                        public enum ResponseViewEnum
                        {
                            ...
                            VIEWUNSPECIFIED,
                            /// <summary>The basic view omits fields which can be large or can contain sensitive data.
                            /// This view does not include the body in AppEngineHttpRequest. Bodies are desirable to
                            /// return only when needed, because they can be large and because of the sensitivity of the
                            /// data that you choose to store in it.</summary>
                            [Google.Apis.Util.StringValueAttribute("BASIC")]
                            BASIC,
                            /// <summary>All information is returned. Authorization for FULL requires
                            /// `cloudtasks.tasks.fullView` [Google IAM](https://cloud.google.com/iam/) permission on
                            /// the Queue resource.</summary>
                    ...
                    /// <summary>Lists the tasks in a queue. By default, only the BASIC view is retrieved due to
                    /// performance considerations; response_view controls the subset of information which is returned.
                    ...
                    public class ListRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.ListTasksResponse>
                    {
                        ...
                        /// <summary>Maximum page size. Fewer tasks than requested might be returned, even if more tasks
                        /// exist; use next_page_token in the response to determine if more tasks exist. The maximum
                        /// page size is 1000. If unspecified, the page size will be the maximum.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual System.Nullable<int> PageSize { get; set; }

                        /// <summary>A token identifying the page of results to return. To request the first page
                        /// results, page_token must be empty. To request the next page of results, page_token must be
                        /// the value of next_page_token returned from the previous call to ListTasks method. The page
                        /// token is valid for only 2 hours.</summary>
                    ...
                    /// <summary>Forces a task to run now. When this method is called, Cloud Tasks will dispatch the
                    /// task, even if the task is already running, the queue has reached its RateLimits or is PAUSED.
                    /// This command is meant to be used for manual debugging. For example, RunTask can be used to retry
                    /// a failed task after a fix has been made or to manually force a task to be dispatched now. The
                    /// dispatched task is returned. That is, the task that is returned contains the status after the
                    /// task is dispatched but before the task is received by its target. If Cloud Tasks receives a
                    /// successful response from the task's target, then the task will be deleted; otherwise the task's
                    ...
                    /// already succeeded or permanently failed.</summary>
                    /// <param name="body">The body of the request.</param>
                    /// <param name="name">Required. The task name. For example:
                    /// `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
                    ...
                    public class RunRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Task>
                    {
                        ...
                        public RunRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.RunTaskRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                ...
                /// <summary>Creates a queue. Queues created with this method allow tasks to live for a maximum of 31
                /// days. After a task is 31 days old, the task will be deleted regardless of whether it was dispatched
                /// or not. WARNING: Using this method may have unintended side effects if you are using an App Engine
                ...
                /// `projects/PROJECT_ID/locations/LOCATION_ID` The list of allowed locations can be obtained by calling Cloud Tasks'
                /// implementation of ListLocations.</param>
                ...
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.Queue body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// calling Cloud Tasks' implementation of ListLocations.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Parent { get; private set; }
                ...
                /// <summary>Deletes a queue. This command will delete the queue even if it has tasks in it. Note: If
                /// you delete a queue, a queue with the same name can't be created for 7 days. WARNING: Using this
                /// method may have unintended side effects if you are using an App Engine `queue.yaml` or `queue.xml`
                ...
                /// and does not have a policy set. Authorization requires the following [Google
                ...
                public class GetIamPolicyRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Policy>
                {
                    ...
                    public GetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.GetIamPolicyRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                ...
                public class ListRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.ListQueuesResponse>
                {
                    ...
                    /// <summary>Requested page size. The maximum page size is 9800. If unspecified, the page size will
                    /// be the maximum. Fewer queues than requested might be returned, even if more queues exist; use
                    /// the next_page_token in the response to determine if more queues exist.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }

                    /// <summary>A token identifying the page of results to return. To request the first page results,
                    ...
                    /// the value of the filter while iterating through pages.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageToken", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual string PageToken { get; set; }
                ...
                /// <summary>Updates a queue. This method creates the queue if it does not exist and updates the queue
                /// if it does exist. Queues created with this method allow tasks to live for a maximum of 31 days.
                ...
                /// queue.yaml](https://cloud.google.com/tasks/docs/queue-yaml) before using this method.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Caller-specified and required in CreateQueue, after which it becomes output only. The queue name.
                /// The queue name must have the following format: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` *
                /// `PROJECT_ID` can contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more
                /// information, see [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-managing-
                /// projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the queue's location. The list of available
                /// locations can be obtained by calling ListLocations. For more information, see
                /// https://cloud.google.com/about/locations/. * `QUEUE_ID` can contain letters ([A-Za-z]), numbers ([0-9]), or hyphens
                /// (-). The maximum length is 100 characters.</param>
                ...
                public class PatchRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Queue>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.Queue body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                    ...
                    /// <summary>Caller-specified and required in CreateQueue, after which it becomes output only. The
                    ...
                    /// ([0-9]), or hyphens (-). The maximum length is 100 characters.</summary>
                    [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                    public virtual string Name { get; private set; }

                    /// <summary>A mask used to specify which fields of the queue are being updated. If empty, then all
                ...
                /// <summary>Pauses the queue. If a queue is paused then the system will stop dispatching tasks until
                /// the queue is resumed via ResumeQueue. Tasks can still be added when the queue is paused. A queue is
                /// paused if its state is PAUSED.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The queue name. For example:
                ...
                public class PauseRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Queue>
                {
                    ...
                    public PauseRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.PauseQueueRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// <summary>Purges a queue by deleting all of its tasks. All tasks created before this method is called
                /// are permanently deleted. Purge operations can take up to one minute to take effect. Tasks might be
                /// dispatched before the purge takes effect. A purge is irreversible.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">Required. The queue name. For example:
                /// `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`</param>
                ...
                public class PurgeRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Queue>
                {
                    ...
                    public PurgeRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.PurgeQueueRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// <summary>Resume a queue. This method resumes a queue after it has been PAUSED or DISABLED. The state
                /// of a queue is stored in the queue's state; after calling this method it will be set to RUNNING.
                ...
                public class ResumeRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Queue>
                {
                    ...
                    public ResumeRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.ResumeQueueRequest body, string name)
                        : base(service)
                    {
                        Name = name;
                        Body = body;
                ...
                /// <summary>Sets the access control policy for a Queue. Replaces any existing policy. Note: The Cloud
                /// Console does not check queue-level IAM permissions yet. Project-level permissions are required to
                ...
                public class SetIamPolicyRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.Policy>
                {
                    ...
                    public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.SetIamPolicyRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
                ...
                public class TestIamPermissionsRequest : CloudTasksBaseServiceRequest<Google.Apis.CloudTasks.v2beta3.Data.TestIamPermissionsResponse>
                {
                    ...
                    public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudTasks.v2beta3.Data.TestIamPermissionsRequest body, string resource)
                        : base(service)
                    {
                        Resource = resource;
                        Body = body;
...
{    
    ...
    /// <summary>App Engine HTTP queue. The task will be delivered to the App Engine application hostname specified by
    /// its AppEngineHttpQueue and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the
    /// task's host URL is constructed. Using AppEngineHttpQueue requires
    /// [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM
    /// permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform`</summary>
    ...
    /// <summary>App Engine HTTP request. The message defines the HTTP request that is sent to an App Engine app when
    ...
    /// traffic congestion control to throttle the queue.</summary>
    public class AppEngineHttpRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>HTTP request body. A request body is allowed only if the HTTP method is POST or PUT. It is an error
        /// to set a body on a task with an incompatible HttpMethod.</summary>
        ...
        /// sets some headers to default values: * `User-Agent`: By default, this header is `"AppEngine-Google;
        /// (+http://code.google.com/appengine)"`. This header can be modified, but Cloud Tasks will append `"AppEngine-
        /// Google; (+http://code.google.com/appengine)"` to the modified `User-Agent`. If the task has a body, Cloud
        /// Tasks sets the following headers: * `Content-Type`: By default, the `Content-Type` header is set to
        /// `"application/octet-stream"`. The default can be overridden by explicitly setting `Content-Type` to a
        ...
        /// information about the task; see [request headers](https://cloud.google.com/tasks/docs/creating-appengine-
        /// handlers#reading_request_headers). These headers are set only when the task is dispatched, so they are not
        /// visible when the task is returned in a Cloud Tasks response. Although there is no specific limit for the
        ...
        /// fails with error code 405 (Method Not Allowed). See [Writing a push task request
        ...
        /// <summary>The relative URI. The relative URI must begin with "/" and must be a valid HTTP relative URI. It
        /// can contain a path and query string arguments. If the relative URI is empty, then the root path "/" will be
    ...
    /// <summary>App Engine Routing. Defines routing characteristics specific to App Engine - service, version, and
    /// instance. For more information about services, versions, and instances see [An Overview of App
    ...
    {
        /// <summary>Output only. The host that the task is sent to. The host is constructed from the domain name of the
        /// app associated with the queue's project ID (for example .appspot.com), and the service, version, and
        /// instance. Tasks which were created using the App Engine SDK might have a custom domain name. For more
        /// information, see [How Requests are Routed](https://cloud.google.com/appengine/docs/standard/python/how-
        /// requests-are-routed).</summary>
    ...
    public class Attempt : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The response from the worker for this attempt. If `response_time` is unset, then the
        /// task has not been attempted or is currently running and the `response_status` field is
        /// meaningless.</summary>
    ...
    public class CreateTaskRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// to return only when needed because of its large size or because of the sensitivity of data that it contains.
        ...
        /// will set it to the current time. Task De-duplication: Explicitly specifying a task ID enables task de-
        /// duplication. If a task's ID is identical to that of an existing task or a task that was deleted or executed
        /// recently then the call will fail with ALREADY_EXISTS. If the task's queue was created using Cloud Tasks,
        /// then another task with the same name can't be created for ~1hour after the original task was deleted or
        /// executed. If the task's queue was created using queue.yaml or queue.xml, then another task with the same
    ...
    /// <summary>HTTP request. The task will be pushed to the worker as an HTTP request. If the worker or the redirected
    /// worker acknowledges the task by returning a successful HTTP response code ([`200` - `299`]), the task will be
    /// removed from the queue. If any other HTTP response code is returned or no response is received, the task will be
    /// retried according to the following: * User-specified throttling: retry configuration, rate limits, and the
    /// queue's state. * System throttling: To prevent the worker from overloading, Cloud Tasks may temporarily reduce
    /// the queue's effective rate. User-specified settings will not be changed. System throttling happens because: *
    ...
    /// considered. * To prevent traffic spikes and to smooth sudden increases in traffic, dispatches ramp up slowly
    /// when the queue is newly created or idle and if large numbers of tasks suddenly become available to dispatch (due
    /// to spikes in create task rates, the queue being unpaused, or many tasks that are scheduled at the same
    /// time).</summary>
    public class HttpRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// an error to set body on a task with an incompatible HttpMethod.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("body")]
        public virtual string Body { get; set; } 

        /// <summary>HTTP request headers. This map contains the header field names and values. Headers can be set when
        /// the task is created. These headers represent a subset of the headers that will accompany the task's HTTP
        /// request. Some HTTP request headers will be ignored or replaced. A partial list of headers that will be
        /// ignored or replaced is: * Host: This will be computed by Cloud Tasks and derived from HttpRequest.url. *
        /// Content-Length: This will be computed by Cloud Tasks. * User-Agent: This will be set to `"Google-Cloud-
        /// Tasks"`. * X-Google-*: Google use only. * X-AppEngine-*: Google use only. `Content-Type` won't be set by
        /// Cloud Tasks. You can explicitly set `Content-Type` to a media type when the task is created. For example,
        /// `Content-Type` can be set to `"application/octet-stream"` or `"application/json"`. Headers which can have
        /// multiple values (according to RFC2616) can be specified using comma-separated values. The size of the
        ...
        /// <summary>Required. The full url path that the request will be sent to. This string must begin with either
        /// "http://" or "https://". Some examples are: `http://acme.com` and `https://acme.com/sales:8080`. Cloud Tasks
        /// will encode some characters for safety and compatibility. The maximum allowed URL length is 2083 characters
        /// after encoding. The `Location` header response from a redirect response [`300` - `399`] may be followed. The
        /// redirect is not counted as a separate attempt.</summary>
    ...
    {
        /// <summary>A token to retrieve next page of results. To return the next page of results, call ListQueues with
    ...
    public class Queue : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// task attempts. However they control task attempts in different ways: * rate_limits controls the total rate
        /// of dispatches from a queue (i.e. all traffic dispatched from the queue, regardless of whether the dispatch
        /// is from a first attempt or a retry). * retry_config controls what happens to particular a task after its
        /// first attempt fails. That is, retry_config controls task retries (the second attempt, third attempt, etc).
        /// The queue's actual dispatch rate is the result of: * Number of tasks in the queue * User-specified
        /// throttling: rate_limits, retry_config, and the queue's state. * System throttling due to `429` (Too Many
        /// Requests) or `503` (Service Unavailable) responses from the worker, high error rates, or to smooth sudden
        /// large traffic spikes.</summary>
        ...
        /// set on individual tasks. * For tasks created using the App Engine SDK: the queue-level retry settings apply
        /// to all tasks in the queue which do not have retry settings explicitly set on the task and were created by
        /// the App Engine SDK. See [App Engine
    ...
    /// <summary>Rate limits. This message determines the maximum rate that tasks can be dispatched by a queue,
    /// regardless of whether the dispatch is a first task attempt or a retry. Note: The debugging command, RunTask,
    /// will run a task even if the queue has reached its RateLimits.</summary>
    public class RateLimits : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. The max burst size. Max burst size limits how fast tasks in queue are processed when
        /// many tasks are in the queue and the rate is high. This field allows the queue to have a high rate so
        /// processing starts shortly after a task is enqueued, but still limits resource usage when many tasks are
        /// enqueued in a short period of time. The [token bucket](https://wikipedia.org/wiki/Token_Bucket) algorithm is
        /// used to control the rate of task dispatches. Each queue has a token bucket that holds tokens, up to the
        /// maximum specified by `max_burst_size`. Each time a task is dispatched, a token is removed from the bucket.
        /// Tasks will be dispatched until the queue's bucket runs out of tokens. The bucket will be continuously
        /// refilled with new tokens based on max_dispatches_per_second. Cloud Tasks will pick the value of
        /// `max_burst_size` based on the value of max_dispatches_per_second. For App Engine queues that were created or
        ...
        /// requests decreases. If unspecified when the queue is created, Cloud Tasks will pick the default. The maximum
        /// allowed value is 5,000. This field has the same meaning as [max_concurrent_requests in queue.yaml/xml](https
        /// ://cloud.google.com/appengine/docs/standard/python/config/queueref#max_concurrent_requests).</summary>
        ...
        /// created, Cloud Tasks will pick the default. * For App Engine queues, the maximum allowed value is 500. This
    ...
    {
        /// <summary>Number of attempts per task. Cloud Tasks will attempt the task `max_attempts` times (that is, if
        /// the first attempt fails, then there will be `max_attempts - 1` retries). Must be >= -1. If unspecified when
        /// the queue is created, Cloud Tasks will pick the default. -1 indicates unlimited attempts. This field has the
        /// same meaning as [task_retry_limit in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python
        /// /config/queueref#retry_parameters).</summary>
        ...
        /// same meaning as [max_backoff_seconds in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/pyt
        /// hon/config/queueref#retry_parameters).</summary>
        ...
        /// of max_backoff up to max_attempts times. For example, if min_backoff is 10s, max_backoff is 300s, and
        /// `max_doublings` is 3, then the a task will first be retried in 10s. The retry interval will double three
        /// times, and then increase linearly by 2^3 * 10s. Finally, the task will retry at intervals of max_backoff
        /// until the task has been attempted max_attempts times. Thus, the requests will retry at 10s, 20s, 40s, 80s,
        /// 160s, 240s, 300s, 300s, .... If unspecified when the queue is created, Cloud Tasks will pick the default.
        ...
        /// attempted max_attempts times, no further attempts will be made and the task will be deleted. If zero, then
        /// the task age is unlimited. If unspecified when the queue is created, Cloud Tasks will pick the default.
        /// `max_retry_duration` will be truncated to the nearest second. This field has the same meaning as
        /// [task_age_limit in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#r
        /// etry_parameters).</summary>
        ...
        /// same meaning as [min_backoff_seconds in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/pyt
        /// hon/config/queueref#retry_parameters).</summary>
    ...
    {
        /// <summary>HTTP request that is sent to the App Engine app handler. An App Engine task is a task that has
        /// AppEngineHttpRequest set.</summary>
        ...
        /// the task according to the RetryConfig. Note that when the request is cancelled, Cloud Tasks will stop
        /// listening for the response, but whether the worker stops processing depends on the worker. For example, if
        /// the worker is stuck, it may not react to cancelled requests. The default and maximum values depend on the
        /// type of request: * For HTTP tasks, the default is 10 minutes. The deadline must be in the interval [15
        /// seconds, 30 minutes]. * For App Engine tasks, 0 indicates that the request has the default deadline. The
        /// default deadline depends on the [scaling type](https://cloud.google.com/appengine/docs/standard/go/how-
        /// instances-are-managed#instance_scaling) of the service: 10 minutes for standard apps with automatic scaling,
        /// 24 hours for standard apps with manual and basic scaling, and 60 minutes for flex apps. If the request
        /// deadline is set, it must be in the interval [15 seconds, 24 hours 15 seconds]. Regardless of the task's
        /// `dispatch_deadline`, the app handler will not run for longer than than the service's timeout. We recommend
        /// setting the `dispatch_deadline` to at most a few seconds more than the app handler's timeout. For more
        /// information see [Timeouts](https://cloud.google.com/tasks/docs/creating-appengine-handlers#timeouts).
        ...
        /// Attempt information is not retained by Cloud Tasks.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("firstAttempt")]
        public virtual Attempt FirstAttempt { get; set; } 

        /// <summary>HTTP request that is sent to the task's target. An HTTP task is a task that has HttpRequest
        /// set.</summary>
        ...
        /// letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see
        /// [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-managing-
        ...
        /// will be attempted or retried. `schedule_time` will be truncated to the nearest microsecond.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("scheduleTime")]
        public virtual object ScheduleTime { get; set; } 
