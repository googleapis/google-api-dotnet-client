...
namespace Google.Apis.Admin.Directory.directory_v1.Data
{
    ...
    public class DirectoryChromeosdevicesIssueCommandRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// "user_session_delay_seconds": 300 }. The delay has to be in the range [0, 300]. * `FETCH_SUPPORT_PACKET`:
        /// Payload is optionally a stringified JSON object in the form: {"supportPacketDetails":{ "issueCaseId":
        /// optional_support_case_id_string, "issueDescription": optional_issue_description_string,
        /// "requestedDataCollectors": []}} The list of available `data_collector_enums` are as following: Chrome System
        /// Information (1), Crash IDs (2), Memory Details (3), UI Hierarchy (4), Additional ChromeOS Platform Logs (5),
        /// Device Event (6), Intel WiFi NICs Debug Dump (7), Touch Events (8), Lacros (9), Lacros System Information
        /// (10), ChromeOS Flex Logs (11), DBus Details (12), ChromeOS Network Routes (13), ChromeOS Shill (Connection
        /// Manager) Logs (14), Policies (15), ChromeOS System State and Logs (16), ChromeOS System Logs (17), ChromeOS
        /// Chrome User Logs (18), ChromeOS Bluetooth (19), ChromeOS Connected Input Devices (20), ChromeOS Traffic
        /// Counters (21), ChromeOS Virtual Keyboard (22), ChromeOS Network Health (23). See more details in [help
    ...
    public class OrgUnit : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// organizational unit. This field is deprecated. Setting it to `true` is no longer supported and can have
        /// _unintended consequences_. For more information about inheritance and users in an organization structure,
        /// see the [administration help center](https://support.google.com/a/answer/4352075).
        /// </summary>
