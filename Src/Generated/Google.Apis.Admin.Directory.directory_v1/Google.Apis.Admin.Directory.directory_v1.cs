...
namespace Google.Apis.Admin.Directory.directory_v1
{
    ...
    public class ChromeosdevicesResource
    {
        ...
        /// <summary>Takes an action that affects a Chrome OS Device. This includes deprovisioning, disabling, and re-
        /// enabling devices. *Warning:* * Deprovisioning a device will stop device policy syncing and remove device-
        /// level printers. After a device is deprovisioned, it must be wiped before it can be re-enrolled. * Lost or
        /// stolen devices should use the disable action. * Re-enabling a disabled device will consume a device license.
        /// If you do not have sufficient licenses available when completing the re-enable action, you will receive an
        /// error. For more information about deprovisioning and disabling devices, visit the [help
        /// center](https://support.google.com/chrome/a/answer/3523633).</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="customerId">The unique ID for the customer's G Suite account. As an account administrator, you can also
        /// use the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as part of
        /// the [Users resource](/admin-sdk/directory/v1/reference/users).</param>
        /// <param name="resourceId">The unique
        /// ID of the device. The `resourceId`s are returned in the response from the [chromeosdevices.list](/admin-
        /// sdk/directory/v1/reference/chromeosdevices/list) method.</param>
        ...
        public class ActionRequest : DirectoryBaseServiceRequest<string>
        {
            ...
            /// <summary>The unique ID for the customer's G Suite account. As an account administrator, you can also use
            /// the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as
            /// part of the [Users resource](/admin-sdk/directory/v1/reference/users).</summary>
            ...
            /// <summary>The unique ID of the device. The `resourceId`s are returned in the response from the
            /// [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list) method.</summary>
        ...
        /// use the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as part of
        /// the [Users resource](/admin-sdk/directory/v1/reference/users).</param>
        /// <param name="deviceId">The unique ID
        /// of the device. The `deviceId`s are returned in the response from the [chromeosdevices.list](/admin-
        /// sdk/directory/v1/reference/chromeosdevices/list) method.</param>
        ...
        public class GetRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.ChromeOsDevice>
        {
            ...
            /// <summary>The unique ID of the device. The `deviceId`s are returned in the response from the
            /// [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list) method.</summary>
            ...
            /// <summary>Determines whether the response contains the full list of properties or only a
            /// subset.</summary>
        ...
        public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.ChromeOsDevices>
        {
            ...
            public enum OrderByEnum
            {
                ...
                AnnotatedUser,
                /// <summary>The date and time the Chrome device was last synchronized with the policy settings in the
                ...
                SerialNumber,
                /// <summary>Chrome device status. For more information, see the </summary>
                [Google.Apis.Util.StringValueAttribute("status")]
                Status,
                /// <summary>Chrome device support end date. This is applicable only for devices purchased directly from
                /// Google.</summary>
            ...
            /// <summary>The `pageToken` query parameter is used to request the next page of query results. The follow-
            /// on request's `pageToken` query parameter is the `nextPageToken` from your previous response.</summary>
            ...
            /// <summary>Whether to return results in ascending or descending order. Must be used with the `orderBy`
            /// parameter.</summary>
        ...
        /// <summary>Move or insert multiple Chrome OS devices to an organizational unit. You can move up to 50 devices
        /// at once.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        /// <summary>Updates a device's updatable properties, such as `annotatedUser`, `annotatedLocation`, `notes`,
        /// `orgUnitPath`, or `annotatedAssetId`. This method supports [patch semantics](/admin-
        /// sdk/directory/v1/guides/performance#patch).</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="customerId">The unique ID for the customer's G Suite account. As an account administrator, you can also
        /// use the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as part of
        /// the [Users resource](/admin-sdk/directory/v1/reference/users).</param>
        /// <param name="deviceId">The unique ID
        /// of the device. The `deviceId`s are returned in the response from the [chromeosdevices.list](/admin-
        /// sdk/v1/reference/chromeosdevices/list) method.</param>
        ...
        public class PatchRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.ChromeOsDevice>
        {
            ...
            /// <summary>The unique ID of the device. The `deviceId`s are returned in the response from the
            /// [chromeosdevices.list](/admin-sdk/v1/reference/chromeosdevices/list) method.</summary>
            [Google.Apis.Util.RequestParameterAttribute("deviceId", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string DeviceId { get; private set; }
        ...
        /// <summary>Updates a device's updatable properties, such as `annotatedUser`, `annotatedLocation`, `notes`,
        /// `orgUnitPath`, or `annotatedAssetId`.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="customerId">The unique ID for the customer's G Suite account. As an account administrator, you can also
        /// use the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as part of
        /// the [Users resource](/admin-sdk/directory/v1/reference/users).</param>
        ...
        public class DevicesResource
        {
            ...
            public class ChromeosResource
            {
                ...
                public class CommandsResource
                {
                    ...
                    /// <param name="customerId">Immutable. Immutable ID of the G Suite account.</param>
                    /// <param
                    /// name="deviceId">Immutable. Immutable ID of Chrome OS Device.</param>
                    /// <param name="commandId">Immutable.
                    /// Immutable ID of Chrome OS Device Command.</param>
                    ...
                    public class GetRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.DirectoryChromeosdevicesCommand>
                    {
                        ...
                        /// <summary>Immutable. Immutable ID of the G Suite account.</summary>
                        [Google.Apis.Util.RequestParameterAttribute("customerId", Google.Apis.Util.RequestParameterType.Path)]
                        public virtual string CustomerId { get; private set; }
    ...
    public class GroupsResource
    {
        ...
        public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.Groups>
        {
            ...
            /// <summary>The unique ID for the customer's G Suite account. In case of a multi-domain account, to fetch
            ...
            /// as part of the [Users](/admin-sdk/directory/v1/reference/users)</summary>
            [Google.Apis.Util.RequestParameterAttribute("customer", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string Customer { get; set; }

            /// <summary>The domain name. Use this field to get fields from only one domain. To return all domains for a
            /// customer account, use the `customer` query parameter instead.</summary>
        ...
        /// <summary>Updates a group's properties. This method supports [patch semantics](/admin-
        /// sdk/directory/v1/guides/performance#patch).</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="groupKey">Identifies the group in the API request. The value can be the group's email address, group
        /// alias, or the unique group ID.</param>
    ...
    public class MembersResource
    {
        ...
        /// <param name="groupKey">Identifies the group in the API request. The value can be the group's email address, group
        /// alias, or the unique group ID.</param>
        /// <param name="memberKey">Identifies the group member in the API
        /// request. A group member can be a user or another group. The value can be the member's (group or user) primary email
        /// address, alias, or unique ID.</param>
        ...
        public class DeleteRequest : DirectoryBaseServiceRequest<string>
        {
            ...
            /// <summary>Identifies the group member in the API request. A group member can be a user or another group.
            /// The value can be the member's (group or user) primary email address, alias, or unique ID.</summary>
        ...
        public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.Members>
        {
            ...
            /// <summary>The `roles` query parameter allows you to retrieve group members by role. Allowed values are
            /// `OWNER`, `MANAGER`, and `MEMBER`.</summary>
        ...
        /// <summary>Updates the membership properties of a user in the specified group. This method supports [patch
        /// semantics](/admin-sdk/directory/v1/guides/performance#patch).</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="groupKey">Identifies the group in the API request. The value can be the group's email address, group
        /// alias, or the unique group ID.</param>
        /// <param name="memberKey">Identifies the group member in the API
    ...
    public class MobiledevicesResource
    {
        ...
        /// the [Users resource](/admin-sdk/directory/v1/reference/users).</param>
        /// <param name="resourceId">The unique
        /// ID the API service uses to identify the mobile device.</param>
        ...
        public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.MobileDevices>
        {
            ...
            public enum OrderByEnum
            {
                [Google.Apis.Util.StringValueAttribute("orderByUndefined")]
                OrderByUndefined,
                /// <summary>The serial number for a Google Sync mobile device. For Android devices, this is a software
                /// generated unique identifier.</summary>
    ...
    public class OrgunitsResource
    {
        ...
        /// use the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as part of
        /// the [Users resource](/admin-sdk/directory/v1/reference/users).</param>
        /// <param name="orgUnitPath">The full
        /// path of the organizational unit or its unique ID.</param>
        ...
        public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.OrgUnits>
        {
            ...
            /// <summary>The full path to the organizational unit or its unique ID. Returns the children of the
            /// specified organizational unit.</summary>
            [Google.Apis.Util.RequestParameterAttribute("orgUnitPath", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string OrgUnitPath { get; set; }
        ...
        /// <summary>Updates an organizational unit. This method supports [patch semantics](/admin-
        /// sdk/directory/v1/guides/performance#patch)</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="customerId">The unique ID for the customer's G Suite account. As an account administrator, you can also
        /// use the `my_customer` alias to represent your account's `customerId`. The `customerId` is also returned as part of
    ...
    public class ResourcesResource
    {
        ...
        public class BuildingsResource
        {
            ...
            public class InsertRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.Building>
            {
                ...
                public enum CoordinatesSourceEnum
                {
                    ...
                    RESOLVEDFROMADDRESS,
                    /// <summary>Defaults to `RESOLVED_FROM_ADDRESS` if postal address is provided. Otherwise, defaults
                    /// to `CLIENT_SPECIFIED` if coordinates are provided.</summary>
        ...
        public class CalendarsResource
        {
            ...
            public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.CalendarResources>
            {
                ...
                /// specified, defaults to ascending. Should be of the form "field [asc|desc], field [asc|desc], ...".
                /// For example `buildingId, capacity desc` would return results sorted first by `buildingId` in
                /// ascending order then by `capacity` in descending order.</summary>
                [Google.Apis.Util.RequestParameterAttribute("orderBy", Google.Apis.Util.RequestParameterType.Query)]
                ...
                /// `name`, `buildingId`, `floor_name`, `capacity`, `featureInstances.feature.name`, `resourceEmail`,
        ...
        public class FeaturesResource
        {
            ...
            /// <param name="customer">The unique ID for the customer's G Suite account. As an account administrator, you can also
            /// use the `my_customer` alias to represent your account's customer ID.</param>
            /// <param name="oldName">The
            /// unique ID of the feature to rename.</param>
    ...
    public class UsersResource
    {
        ...
        public class PhotosResource
        {
            ...
            /// <summary>Adds a photo for the user. This method supports [patch semantics](/admin-
            /// sdk/directory/v1/guides/performance#patch).</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="userKey">Identifies the user in the API request. The value can be the user's primary email address,
            /// alias email address, or unique user ID.</param>
        ...
        public class GetRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.User>
        {
            ...
            /// <summary>A comma-separated list of schema names. All fields from these schemas are fetched. This should
            ...
            /// <summary>Whether to fetch the administrator-only or domain-wide public view of the user. For more
            /// information, see [Retrieve a user as a non-administrator](/admin-sdk/directory/v1/guides/manage-
            /// users#retrieve_users_non_admin).</summary>
            ...
            public enum ViewTypeEnum
            {
                ...
                AdminView,
                /// <summary>Results only include fields for the user that are publicly visible to other users in the
                /// domain.</summary>
        ...
        public class ListRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.Users>
        {
            ...
            /// parameter must be provided.</summary>
            [Google.Apis.Util.RequestParameterAttribute("domain", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string Domain { get; set; }
            ...
            /// <summary>Query string for searching user fields. For more information on constructing user queries, see
            /// [Search for Users](/admin-sdk/directory/v1/guides/search-users).</summary>
            [Google.Apis.Util.RequestParameterAttribute("query", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string Query { get; set; }
        ...
        /// <summary>Updates a user using patch semantics. The update method should be used instead, since it also
        /// supports patch semantics and has better performance. This method is unable to clear fields that contain
        /// repeated objects (`addresses`, `phones`, etc). Use the update method instead.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="userKey">Identifies the user in the API request. The value can be the user's primary email address,
        /// alias email address, or unique user ID.</param>
        ...
        /// <summary>Sign a user out of all web and device sessions and reset their sign-in cookies. User will have to
        /// sign in by authenticating again.</summary>
        /// <param name="userKey">Identifies the target user in the API request. The value can be the user's primary email
        /// address, alias email address, or unique user ID.</param>
        ...
        public class SignOutRequest : DirectoryBaseServiceRequest<string>
        {
            ...
            /// <summary>Identifies the target user in the API request. The value can be the user's primary email
            /// address, alias email address, or unique user ID.</summary>
            [Google.Apis.Util.RequestParameterAttribute("userKey", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string UserKey { get; private set; }
        ...
        /// <summary>Updates a user. This method supports patch semantics, meaning you only need to include the fields
        ...
        public class WatchRequest : DirectoryBaseServiceRequest<Google.Apis.Admin.Directory.directory_v1.Data.Channel>
        {
            ...
            public enum OrderByEnum
            {
                [Google.Apis.Util.StringValueAttribute("orderByUnspecified")]
                OrderByUnspecified,
                /// <summary>Primary email of the user.</summary>
                [Google.Apis.Util.StringValueAttribute("email")]
                Email,
            ...
            public enum ProjectionEnum
            {
                [Google.Apis.Util.StringValueAttribute("projectionUnspecified")]
            ...
            public enum SortOrderEnum
            {
                [Google.Apis.Util.StringValueAttribute("sortOrderUnspecified")]
...
{    
    ...
    /// <summary>An application-specific password (ASP) is used with applications that do not accept a verification code
    /// when logging into the application on certain devices. The ASP access code is used instead of the login and
    /// password you commonly use when accessing an application through a browser. For more information about ASPs and
    /// how to create one, see the [help
    /// center](//http://support.google.com/a/bin/answer.py?amp;answer=1032419).</summary>
    public class Asp : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The time when the ASP was created. Expressed in [Unix
        /// time](http://en.wikipedia.org/wiki/Epoch_time) format.</summary>
        ...
        /// <summary>The time when the ASP was last used. Expressed in [Unix
        /// time](http://en.wikipedia.org/wiki/Epoch_time) format.</summary>
    ...
    {
        /// <summary>The postal address of the building. See [`PostalAddress`](/my-
        /// business/reference/rest/v4/PostalAddress) for details. Note that only a single address line and region code
    ...
    /// <summary>Google Chrome devices run on the [Chrome OS](http://support.google.com/chromeos). For more information
    /// about common API tasks, see the [Developer's Guide](/admin-sdk/directory/v1/guides/manage-chrome-
    /// devices).</summary>
    public class ChromeOsDevice : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The address or location of the device as noted by the administrator. Maximum length is `200`
        /// characters. Empty values are allowed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("annotatedLocation")]
        public virtual string AnnotatedLocation { get; set; }

        /// <summary>The user of the device as noted by the administrator. Maximum length is 100 characters. Empty
        /// values are allowed.</summary>
        ...
        /// <summary>The boot mode for the device. The possible values are: * `Verified`: The device is running a valid
        ...
        /// series-5-chromebook#TOC-Developer-switch).</summary>
        ...
        /// <summary>The type of resource. For the Chromeosdevices resource, the value is
        /// `admin#directory#chromeosdevice`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }
        ...
        /// <summary>The device's wireless MAC address. If the device does not have this information, it is not included
        ...
        /// <summary>The Mobile Equipment Identifier (MEID) or the International Mobile Equipment Identity (IMEI) for
        /// the 3G mobile card in a mobile device. A MEID/IMEI is typically used when adding a device to a wireless
        /// carrier's post-pay service plan. If the device does not have this information, this property is not included
        /// in the response. For more information on how to export a MEID/IMEI list, see the [Developer's Guide](/admin-
        /// sdk/directory/v1/guides/manage-chrome-devices.html#export_meid).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("meid")]
        public virtual string Meid { get; set; }

        /// <summary>The device's model information. If the device does not have this information, this property is not
        /// included in the response.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("model")]
        public virtual string Model { get; set; }

        /// <summary>Notes about this device added by the administrator. This property can be
        /// [searched](http://support.google.com/chromeos/a/bin/answer.py?answer=1698333) with the [list](/admin-
        /// sdk/directory/v1/reference/chromeosdevices/list) method's `query` parameter. Maximum length is 500
        /// characters. Empty values are allowed.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("notes")]
        public virtual string Notes { get; set; }

        /// <summary>The device's order number. Only devices directly purchased from Google have an order
        /// number.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("orderNumber")]
        public virtual string OrderNumber { get; set; }

        /// <summary>The full parent path with the organizational unit's name associated with the device. Path names are
        ...
        /// center](http://support.google.com/a/bin/answer.py?answer=182433).</summary>
        ...
        public virtual System.Collections.Generic.IList<RecentUsers> RecentUsers { get; set; }

        /// <summary>The Chrome device serial number entered when the device was enabled. This value is the same as the
        /// Admin console's *Serial Number* in the *Chrome OS Devices* tab.</summary>
        ...
        /// <summary>Determines if the device will auto renew its support after the support end date. This is a read-
        /// only property.</summary>
        ...
        {
            /// <summary>TPM family. We use the TPM 2.0 style encoding, e.g.: TPM 1.2: "1.2" -> 312e3200 TPM 2.0: "2.0"
            /// -> 322e3000</summary>
            ...
            /// <summary>TPM specification level. See Library Specification for TPM 2.0 and Main Specification for TPM
            /// 1.2.</summary>
    ...
    public class ChromeOsDeviceAction : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Only used when the action is `deprovision`. With the `deprovision` action, this field is required.
        /// *Note*: The deprovision reason is audited because it might have implications on licenses for perpetual
        /// subscription customers.</summary>
    ...
    public class ChromeOsDevices : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Token used to access the next page of this result. To access the next page, use this token's value
        /// in the `pageToken` query string of this request.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nextPageToken")]
        public virtual string NextPageToken { get; set; }
    ...
    public class Customer : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The customer's ISO 639-2 language code. See the [Language Codes](/admin-sdk/directory/v1/languages)
        /// page for the list of supported codes. Valid language codes outside the supported set will be accepted by the
        /// API but may lead to unexpected behavior. The default value is `en`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("language")]
        public virtual string Language { get; set; }

        /// <summary>The customer's contact phone number in [E.164](http://en.wikipedia.org/wiki/E.164)
        /// format.</summary>
    ...
    public class CustomerPostalAddress : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// elements](http://www.iso.org/iso/country_codes.htm).</summary>
    ...
    {
        /// <summary>The time at which the command will expire. If the device doesn't execute the command within this
        /// time the command will become expired.</summary>
    ...
    {
        /// <summary>The error message with a short explanation as to why the command failed. Only present if the
    ...
    public class DirectoryChromeosdevicesIssueCommandRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The payload for the command, provide it only if command supports it. The following commands support
        /// adding payload: - SET_VOLUME: Payload is a stringified JSON object in the form: { "volume": 50 }. The volume
        /// has to be an integer in the range [0,100].</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("payload")]
        public virtual string Payload { get; set; }
    ...
    {
        /// <summary>Creation time of the domain. Expressed in [Unix time](http://en.wikipedia.org/wiki/Epoch_time)
    ...
    /// <summary>Google Groups provide your users the ability to send messages to groups of people using the group's
    /// email address. For more information about common tasks, see the [Developer's Guide](/admin-
    /// sdk/directory/v1/guides/manage-groups).</summary>
    public class Group : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The number of users that are direct members of the group. If a group is a member (child) of this
        ...
        /// <summary>The group's email address. If your account has multiple domains, select the appropriate domain for
        ...
        /// center](http://support.google.com/a/bin/answer.py?answer=33386) for the details.</summary>
        ...
        /// <summary>List of the group's non-editable alias email addresses that are outside of the account's primary
        /// domain or subdomains. These are functioning email addresses used by the group. This is a read-only property
        /// returned in the API's response for a group. If edited in a group's POST or PUT request, the edit is ignored
        /// by the API service.</summary>
    ...
    /// <summary>A Google Groups member can be a user or another group. This member can be inside or outside of your
    /// account's domains. For more information about common group member tasks, see the [Developer's Guide](/admin-
    /// sdk/directory/v1/guides/manage-group-members).</summary>
    public class Member : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The member's email address. A member can be a user or another group. This property is required when
        /// adding a member to a group. The `email` must be unique and cannot be an alias of another group. If the email
        /// address is changed, the API automatically reflects the email address changes.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("email")]
        public virtual string Email { get; set; }
        ...
        /// <summary>The unique ID of the group member. A member `id` can be used as a member request URI's
        /// `memberKey`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; }

        /// <summary>The type of the API resource. For Members resources, the value is
        /// `admin#directory#member`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }

        /// <summary>The member's role in a group. The API returns an error for cycles in group memberships. For
        /// example, if `group1` is a member of `group2`, `group2` cannot be a member of `group1`. For more information
        /// about a member's role, see the [administration help
        /// center](http://support.google.com/a/bin/answer.py?answer=167094).</summary>
    ...
    /// <summary>G Suite Mobile Management includes Android, [Google
    /// Sync](http://support.google.com/a/bin/answer.py?answer=135937), and iOS devices. For more information about
    /// common group mobile device API tasks, see the [Developer's Guide](/admin-sdk/directory/v1/guides/manage-mobile-
    /// devices.html).</summary>
    public class MobileDevice : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The list of applications installed on an Android mobile device. It is not applicable to Google Sync
        /// and iOS devices. The list includes any Android applications that access G Suite data. When updating an
        ...
        /// <summary>The serial number for a Google Sync mobile device. For Android and iOS devices, this is a software
        /// generated unique identifier.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("deviceId")]
        public virtual string DeviceId { get; set; }
        ...
        /// <summary>List of owner's email addresses. If your application needs the current list of user emails, use the
        /// [get](/admin-sdk/directory/v1/reference/mobiledevices/get.html) method. For additional information, see the
        /// [retrieve a user](/admin-sdk/directory/v1/guides/manage-users#get_user) method.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("email")]
        ...
        /// <summary>The IMEI/MEID unique identifier for Android hardware. It is not applicable to Google Sync devices.
        /// When adding an Android mobile device, this is an optional property. When updating one of these devices, this
        /// is a read-only property.</summary>
        ...
        /// <summary>The type of the API resource. For Mobiledevices resources, the value is
        /// `admin#directory#mobiledevice`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }
        ...
        /// <summary>The mobile device's model name, for example Nexus S. This property can be [updated](/admin-
        /// sdk/directory/v1/reference/mobiledevices/update.html). For more information, see the [Developer's Guide
        /// ](/admin-sdk/directory/v1/guides/manage-mobile=devices#update_mobile_device).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("model")]
        public virtual string Model { get; set; }

        /// <summary>List of the owner's user names. If your application needs the current list of device owner names,
        /// use the [get](/admin-sdk/directory/v1/reference/mobiledevices/get.html) method. For more information about
        /// retrieving mobile device user information, see the [Developer's Guide](/admin-sdk/directory/v1/guides
        /// /manage-users#get_user).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        ...
        /// <summary>The mobile device's operating system, for example IOS 4.3 or Android 2.3.5. This property can be
        /// [updated](/admin-sdk/directory/v1/reference/mobiledevices/update.html). For more information, see the
        /// [Developer's Guide](/admin-sdk/directory/v1/guides/manage-mobile-devices#update_mobile_device).</summary>
        ...
        /// <summary>Gives information about the device such as `os` version. This property can be [updated](/admin-
        /// sdk/directory/v1/reference/mobiledevices/update.html). For more information, see the [Developer's Guide
        /// ](/admin-sdk/directory/v1/guides/manage-mobile-devices#update_mobile_device).</summary>
        ...
        public class ApplicationsData
        {
            ...
            /// <summary>The list of permissions of this application. These can be either a standard Android permission
            /// or one defined by the application, and are found in an application's [Android
            /// manifest](http://developer.android.com/guide/topics/manifest/uses-permission-element.html). Examples of
            /// a Calendar application's permissions are `READ_CALENDAR`, or `MANAGE_ACCOUNTS`.</summary>
    ...
    /// <summary>Managing your account's organizational units allows you to configure your users' access to services and
    /// custom settings. For more information about common organizational unit tasks, see the [Developer's Guide
    /// ](/admin-sdk/directory/v1/guides/manage-org-units.html).</summary>
    public class OrgUnit : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Determines if a sub-organizational unit can inherit the settings of the parent organization. The
        ...
        /// [administration help
        /// center](http://support.google.com/a/bin/answer.py?answer=182442=1227584=topic).</summary>
        ...
        /// <summary>The type of the API resource. For Orgunits resources, the value is
        /// `admin#directory#orgUnit`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }

        /// <summary>The organizational unit's path name. For example, an organizational unit's name within the
        /// /corp/support/sales_support parent path is sales_support. Required.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
        ...
        /// <summary>The full path to the organizational unit. The `orgUnitPath` is a derived property. When listed, it
        ...
        /// [administration help center](http://support.google.com/a/bin/answer.py?answer=182433=1227584=topic). For
        /// more information about moving a user to a different organization, see [Update a user](/admin-
        /// sdk/directory/v1/guides/manage-users.html#update_user).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("orgUnitPath")]
        public virtual string OrgUnitPath { get; set; }

        /// <summary>The unique ID of the parent organizational unit. Required, unless `parentOrgUnitPath` is
        /// set.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("parentOrgUnitId")]
        public virtual string ParentOrgUnitId { get; set; }

        /// <summary>The organizational unit's parent path. For example, /corp/sales is the parent path for
        /// /corp/sales/sales_support organizational unit. Required, unless `parentOrgUnitId` is set.</summary>
    ...
    public class OrgUnits : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The type of the API resource. For Org Unit resources, the type is
        /// `admin#directory#orgUnits`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }
    ...
    public class Privilege : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// [`Privileges.list()`](/admin-sdk/directory/v1/reference/privileges/list).</summary>
    ...
    /// <summary>List of recent device users, in descending order, by last login time.</summary>
    public class RecentUsers : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The user's email address. This is only present if the user type is `USER_TYPE_MANAGED`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("email")]
        public virtual string Email { get; set; }
    ...
    /// <summary>You can use schemas to add custom fields to user profiles. You can use these fields to store
    /// information such as the projects your users work on, their physical locations, their hire dates, or whatever
    /// else fits your business needs. For more information, see [Custom User Fields](/admin-sdk/directory/v1/guides
    /// /manage-schemas).</summary>
    public class SchemaFieldSpec : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The kind of resource this is. For schema fields this is always
        /// `admin#directory#schema#fieldspec`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }
        ...
        /// <summary>Specifies who can view values of this field. See [Retrieve users as a non-administrator](/admin-
        /// sdk/directory/v1/guides/manage-users#retrieve_users_non_admin) for more information. Note: It may take up to
        /// 24 hours for changes to this field to be reflected.</summary>
    ...
    /// <summary>The Directory API allows you to create and manage your account's users, user aliases, and user Gmail
    /// chat profile photos. For more information about common tasks, see the [User Accounts Developer's Guide](/admin-
    /// sdk/directory/v1/guides/manage-users.html) and the [User Aliases Developer's Guide](/admin-
    /// sdk/directory/v1/guides/manage-user-aliases.html).</summary>
    public class User : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. This property is `true` if the user has completed an initial login and accepted the
        /// Terms of Service agreement.</summary>
        ...
        /// <summary>Indicates if the user is forced to change their password at next login. This setting doesn't apply
        /// when [the user signs in via a third-party identity
        /// provider](https://support.google.com/a/answer/60224).</summary>
        ...
        /// <summary>Output only. The customer ID to [retrieve all account users](/admin-sdk/directory/v1/guides/manage-
        ...
        /// sdk/directory/v1/reference/users/list) request.</summary>
        ...
        /// <summary>A list of the user's email addresses. The maximum allowed data size for this field is
        /// 10Kb.</summary>
        ...
        /// <summary>A list of external IDs for the user, such as an employee or network ID. The maximum allowed data
        /// size for this field is 2Kb.</summary>
        ...
        /// <summary>Stores the hash format of the password property. We recommend sending the `password` property value
        /// as a base 16 bit hexadecimal-encoded hash value. Set the `hashFunction` values as either the
        /// [SHA-1](http://wikipedia.org/wiki/SHA-1), [MD5](http://wikipedia.org/wiki/MD5), or
        /// [crypt](https://en.wikipedia.org/wiki/Crypt_(C)) hash format.</summary>
        ...
        /// <summary>The user's Instant Messenger (IM) accounts. A user account can have multiple ims properties. But,
        /// only one of these ims properties can be the primary IM contact. The maximum allowed data size for this field
        /// is 2Kb.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ims")]
        public virtual object Ims { get; set; }

        /// <summary>Indicates if the user's profile is visible in the G Suite global address list when the contact
        /// sharing feature is enabled for the domain. For more information about excluding user profiles, see the
        /// [administration help center](http://support.google.com/a/bin/answer.py?answer=1285988).</summary>
        ...
        /// <summary>If `true`, the user's IP address is [white
        /// listed](http://support.google.com/a/bin/answer.py?answer=60752).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ipWhitelisted")]
        public virtual System.Nullable<bool> IpWhitelisted { get; set; }

        /// <summary>Output only. Indicates a user with super admininistrator privileges. The `isAdmin` property can
        /// only be edited in the [Make a user an administrator](/admin-sdk/directory/v1/guides/manage-
        /// users.html#make_admin) operation ( [makeAdmin](/admin-sdk/directory/v1/reference/users/makeAdmin.html)
        /// method). If edited in the user [insert](/admin-sdk/directory/v1/reference/users/insert.html) or [update
        /// ](/admin-sdk/directory/v1/reference/users/update.html) methods, the edit is ignored by the API
        /// service.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("isAdmin")]
        public virtual System.Nullable<bool> IsAdmin { get; set; }

        /// <summary>Output only. Indicates if the user is a delegated administrator. Delegated administrators are
        /// supported by the API but cannot create or undelete users, or make users administrators. These requests are
        /// ignored by the API service. Roles and privileges for administrators are assigned using the [Admin
        /// console](http://support.google.com/a/bin/answer.py?answer=33325).</summary>
        ...
        /// <summary>Output only. Indicates if the user's Google mailbox is created. This property is only applicable if
        /// the user has been assigned a Gmail license.</summary>
        ...
        /// <summary>Output only. The type of the API resource. For Users resources, the value is
        /// `admin#directory#user`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; }
        ...
        /// <summary>Holds the given and family names of the user, and the read-only `fullName` value. The maximum
        ...
        /// center](http://support.google.com/a/bin/answer.py?answer=33386). Maximum allowed data size for this field is
        /// 1Kb.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual UserName Name { get; set; }

        /// <summary>Output only. List of the user's non-editable alias email addresses. These are typically outside the
        /// account's primary domain or sub-domain.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("nonEditableAliases")]
        public virtual System.Collections.Generic.IList<string> NonEditableAliases { get; set; }
        ...
        /// <summary>The full path of the parent organization associated with the user. If the parent organization is
        /// the top-level, it is represented as a forward slash (`/`).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("orgUnitPath")]
        public virtual string OrgUnitPath { get; set; }

        /// <summary>A list of organizations the user belongs to. The maximum allowed data size for this field is
        /// 10Kb.</summary>
        ...
        /// <summary>A list of [POSIX](http://www.opengroup.org/austin/papers/posix_faq.html) account information for
        /// the user.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("posixAccounts")]
        public virtual object PosixAccounts { get; set; }

        /// <summary>The user's primary email address. This property is required in a request to create a user account.
        /// The `primaryEmail` must be unique and cannot be an alias of another user.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("primaryEmail")]
        public virtual string PrimaryEmail { get; set; }
        ...
        /// <summary>A list of the user's relationships to other users. The maximum allowed data size for this field is
        /// 2Kb.</summary>
        ...
        /// <summary>Output only. Has the reason a user account is suspended either by the administrator or by Google at
        /// the time of suspension. The property is returned only if the `suspended` property is `true`.</summary>
    ...
    public class UserPhoto : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The MIME type of the photo. Allowed values are `JPEG`, `PNG`, `GIF`, `BMP`, `TIFF`, and web-safe
        /// base64 encoding.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("mimeType")]
        public virtual string MimeType { get; set; }

        /// <summary>The user photo's upload data in [web-safe
        /// Base64](https://code.google.com/p/stringencoders/wiki/WebSafeBase64) format in bytes. This means: * The
        /// slash (/) character is replaced with the underscore (_) character. * The plus sign (+) character is replaced
        /// with the hyphen (-) character. * The equals sign (=) character is replaced with the asterisk (*). * For
        /// padding, the period (.) character is used instead of the RFC-4648 baseURL definition which uses the equals
        /// sign (=) for padding. This is done to simplify URL-parsing. * Whatever the size of the photo being uploaded,
        /// the API downsizes it to 96x96 pixels.</summary>
    ...
    /// <summary>The Directory API allows you to view, generate, and invalidate backup verification codes for a
    /// user.</summary>
