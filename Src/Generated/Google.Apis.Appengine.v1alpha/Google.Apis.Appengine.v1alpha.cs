...
namespace Google.Apis.Appengine.v1alpha
{
    ...
    public class AppsResource
    {
        ...
        public class ServicesResource
        {
            ...
            public class VersionsResource
            {
                ...
                public class InstancesResource
                {
                    ...
                    public virtual DebugRequest Debug(Google.Apis.Appengine.v1alpha.Data.DebugInstanceRequest body, string appsId, string servicesId, string versionsId, string instancesId)
                    {
                    ...
                    /// the system to take over and determine if another instance should be started.Only applicable for
                    /// instances in App Engine flexible environment.</summary>
                    public class DebugRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
                    {
                        /// <summary>Constructs a new Debug request.</summary>
                        public DebugRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.DebugInstanceRequest body, string appsId, string servicesId, string versionsId, string instancesId)
                            : base(service)
                        {
                            AppsId = appsId;
                        ...
                        Google.Apis.Appengine.v1alpha.Data.DebugInstanceRequest Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug"; }
                        }
                    ...
                    public class DeleteRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
                    {
                        ...
                        public override string RestPath
                        {
                            get { return "v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}"; }
                        }
                    ...
                    /// <summary>Gets instance information.</summary>
                    public class GetRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Instance>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                    ...
                    /// <summary>Lists the instances of a version.</summary>
                    public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.ListInstancesResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        ...
                        public override string RestPath
                        {
                            get { return "v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances"; }
                        }
                ...
                /// `appsId`.</param>
                public virtual CreateRequest Create(Google.Apis.Appengine.v1alpha.Data.Version body, string appsId, string servicesId)
                {
                ...
                public class CreateRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.Version body, string appsId, string servicesId)
                        : base(service)
                    {
                        AppsId = appsId;
                        ServicesId = servicesId;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Appengine.v1alpha.Data.Version Body { get; set; }
                    ...
                    public override string RestPath
                    {
                        get { return "v1alpha/apps/{appsId}/services/{servicesId}/versions"; }
                    }
                ...
                public class DeleteRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
                {
                    ...
                    public override string RestPath
                    {
                        get { return "v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}"; }
                    }
                ...
                /// <summary>Gets the specified Version resource. By default, only a BASIC_VIEW will be returned.
                /// Specify the FULL_VIEW parameter to get the full resource.</summary>
                public class GetRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Version>
                {
                    /// <summary>Constructs a new Get request.</summary>
                ...
                /// <summary>Lists the versions of a service.</summary>
                public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.ListVersionsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                ...
                /// api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.serving_status):  For Version
                ...
                /// api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.instance_class):  For Version
                /// resources that run in the App Engine standard environment. automatic_scaling.min_idle_instances
                /// (https://cloud.google.com/appengine/docs/admin-
                /// api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version
                ...
                /// of `appsId`.</param>
                /// <param name="versionsId">Part of `name`. See documentation of `appsId`.</param>
                public virtual PatchRequest Patch(Google.Apis.Appengine.v1alpha.Data.Version body, string appsId, string servicesId, string versionsId)
                {
                ...
                public class PatchRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.Version body, string appsId, string servicesId, string versionsId)
                        : base(service)
                    {
                        AppsId = appsId;
                        ServicesId = servicesId;
            ...
            public class DeleteRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
            {
                ...
                public override string RestPath
                {
                    get { return "v1alpha/apps/{appsId}/services/{servicesId}"; }
                }
            ...
            /// <summary>Gets the current configuration of the specified service.</summary>
            public class GetRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Service>
            {
                /// <summary>Constructs a new Get request.</summary>
            ...
            /// <summary>Lists all the services in the application.</summary>
            public class ListRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.ListServicesResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string appsId)
                    : base(service)
                ...
                public override string RestPath
                {
                    get { return "v1alpha/apps/{appsId}/services"; }
                }
            ...
            /// <param name="servicesId">Part of `name`. See documentation of
            /// `appsId`.</param>
            public virtual PatchRequest Patch(Google.Apis.Appengine.v1alpha.Data.Service body, string appsId, string servicesId)
            {
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.Service body, string appsId, string servicesId)
                    : base(service)
                {
                    AppsId = appsId;
                    ServicesId = servicesId;
                ...
                /// (https://cloud.google.com/appengine/docs/admin-
                /// api/reference/rest/v1alpha/apps.services.versions#inboundservicetype) and automatic scaling
                /// (https://cloud.google.com/appengine/docs/admin-
                /// api/reference/rest/v1alpha/apps.services.versions#automaticscaling). You must specify the shardBy
                /// (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services#shardby)
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Appengine.v1alpha.Data.Service Body { get; set; }
        ...
        /// <param name="body">The body of the request.</param>
        public virtual CreateRequest Create(Google.Apis.Appengine.v1alpha.Data.Application body)
        {
        ...
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.Application body)
                : base(service)
            {
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Appengine.v1alpha.Data.Application Body { get; set; }
        ...
        /// <summary>Gets information about an application.</summary>
        public class GetRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Application>
        {
            /// <summary>Constructs a new Get request.</summary>
            ...
            public override string RestPath
            {
                get { return "v1alpha/apps/{appsId}"; }
            }
        ...
        public virtual PatchRequest Patch(Google.Apis.Appengine.v1alpha.Data.Application body, string appsId)
        {
        ...
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.Application body, string appsId)
                : base(service)
            {
                AppsId = appsId;
                Body = body;
        ...
        public virtual RepairRequest Repair(Google.Apis.Appengine.v1alpha.Data.RepairApplicationRequest body, string appsId)
        {
        ...
        /// Cloud Storage bucket or App Engine service account. Use this method if you receive an error message about a
        /// missing feature, for example, Error retrieving the App Engine service account.</summary>
        public class RepairRequest : AppengineBaseServiceRequest<Google.Apis.Appengine.v1alpha.Data.Operation>
        {
            /// <summary>Constructs a new Repair request.</summary>
            public RepairRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.RepairApplicationRequest body, string appsId)
                : base(service)
            {
                AppsId = appsId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Appengine.v1alpha.Data.RepairApplicationRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "v1alpha/apps/{appsId}:repair"; }
            }
...
{    
    ...
    public class Version : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// api/reference/rest/v1alpha/apps.services.versions#staticfileshandler) does not specify its own expiration
