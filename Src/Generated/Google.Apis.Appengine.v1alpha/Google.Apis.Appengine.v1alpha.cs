        ...
        public class LocationsResource
        {
            ...
            public class ApplicationsResource
            {
                ...
                public class DomainMappingsResource
                {
                    ...
                    /// <param name="applicationsId">Part of `name`. See documentation of `projectsId`.</param>
                    /// <param name="domainMappingsId">Part of `name`. See documentation of `projectsId`.</param>
                    public virtual PatchRequest Patch(Google.Apis.Appengine.v1alpha.Data.DomainMapping body, string projectsId, string locationsId, string applicationsId, string domainMappingsId)
                    {
                    ...
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Appengine.v1alpha.Data.DomainMapping body, string projectsId, string locationsId, string applicationsId, string domainMappingsId) : base(service)
                        {
                            ProjectsId = projectsId;
                            LocationsId = locationsId;
                            ApplicationsId = applicationsId;
                        ...
                        /// false, a managed certificate will be provisioned and a certificate ID will be automatically
                        /// populated. Only applicable if ssl_settings.certificate_id is specified in the update mask.
                        /// </summary>
                        [Google.Apis.Util.RequestParameterAttribute("noManagedCertificate", Google.Apis.Util.RequestParameterType.Query)]
                        public virtual System.Nullable<bool> NoManagedCertificate { get; set; }
