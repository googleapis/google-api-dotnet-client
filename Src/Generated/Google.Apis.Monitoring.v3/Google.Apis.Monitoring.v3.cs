    ...
    public class ProjectsResource
    {
        ...
        public class TimeSeriesResource
        {
            ...
            public class ListRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.ListTimeSeriesResponse>
            {
                ...
                /// <summary>If outputPeriod is specified, the data in the response will have the given period. Must be
                /// equal to or longer than alignmentPeriod. Must not be used when view is HEADERS. Only used when
                /// interval describes an interval longer than a single point.</summary>
                [Google.Apis.Util.RequestParameterAttribute("outputPeriod", Google.Apis.Util.RequestParameterType.Query)]
                ...
                public enum AggregationCrossSeriesReducerEnum
                {
                    ...
                    REDUCEPERCENTILE05,
                    [Google.Apis.Util.StringValueAttribute("REDUCE_FRACTION_LESS_THAN")]
                    REDUCEFRACTIONLESSTHAN,
                }
                ...
                public enum AggregationPerSeriesAlignerEnum
                {
                    ...
                    ALIGNPERCENTILE05,
                    [Google.Apis.Util.StringValueAttribute("ALIGN_MAKE_DISTRIBUTION")]
                    ALIGNMAKEDISTRIBUTION,
                }
                ...
                /// <summary>The threshold used by the REDUCE_FRACTION_LESS_THAN cross-series reducer.</summary>
                [Google.Apis.Util.RequestParameterAttribute("aggregation.reduceFractionLessThanParams.threshold", Google.Apis.Util.RequestParameterType.Query)]
                public virtual System.Nullable<double> AggregationReduceFractionLessThanParamsThreshold { get; set; }
                ...
                protected override void InitParameters()
                {
                    ...
                    RequestParameters.Add(
                        "outputPeriod", new Google.Apis.Discovery.Parameter
                        {
                            Name = "outputPeriod",
                            IsRequired = false,
                            ParameterType = "query",
                    ...
                    RequestParameters.Add(
                        "aggregation.reduceFractionLessThanParams.threshold", new Google.Apis.Discovery.Parameter
                        {
                            Name = "aggregation.reduceFractionLessThanParams.threshold",
                            IsRequired = false,
                            ParameterType = "query",
                            DefaultValue = null,
                            Pattern = null,
