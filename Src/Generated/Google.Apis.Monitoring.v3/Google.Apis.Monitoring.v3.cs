...
namespace Google.Apis.Monitoring.v3
{
    ...
    public class ProjectsResource
    {
        ...
        public class UptimeCheckConfigsResource
        {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="parent">The project in which to create the uptime check. The formatis
            ...
            public class CreateRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.UptimeCheckConfig>
            {
                ...
                /// <summary>The project in which to create the uptime check. The formatis
            ...
            /// <param name="name">The uptime check configuration to delete. The formatis
            ...
            public class DeleteRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.Empty>
            {
                ...
                /// <summary>The uptime check configuration to delete. The formatis
            ...
            /// <param name="name">The uptime check configuration to retrieve. The formatis
            /// projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID].</param>
            public virtual GetRequest Get(string name)
            {
                return new GetRequest(service, name);
            ...
            public class GetRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.UptimeCheckConfig>
            {
                ...
                /// <summary>The uptime check configuration to retrieve. The formatis
                /// projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID].</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
            ...
            /// <param name="parent">The project whose uptime check configurations are listed. The formatis
            /// projects/[PROJECT_ID].</param>
            ...
            public class ListRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.ListUptimeCheckConfigsResponse>
            {
                ...
                /// <summary>The project whose uptime check configurations are listed. The formatis
                /// projects/[PROJECT_ID].</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
