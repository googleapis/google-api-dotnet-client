...
namespace Google.Apis.Monitoring.v3
{
    ...
    public class ProjectsResource
    {
        ...
        public class MetricDescriptorsResource
        {
            ...
            /// <summary>Lists metric descriptors that match a filter. This method does not require a
            /// Workspace.</summary>
            /// <param name="name">Required. The project on which to execute the request. The format is:
            /// projects/[PROJECT_ID_OR_NUMBER] </param>
            public virtual ListRequest List(string name)
        ...
        public class MonitoredResourceDescriptorsResource
        {
            ...
            /// <summary>Gets a single monitored resource descriptor. This method does not require a
            /// Workspace.</summary>
        ...
        public class NotificationChannelsResource
        {
            ...
            /// <param name="body">The body of the request.</param>
            /// <param name="name">Required. The notification channel for which a verification code is to be generated and
            /// retrieved. This must name a channel that is already verified; if the specified channel is not verified, the request
            /// will fail.</param>
            ...
            public class GetVerificationCodeRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.GetNotificationChannelVerificationCodeResponse>
            {
                ...
                /// <summary>Required. The notification channel for which a verification code is to be generated and
                /// retrieved. This must name a channel that is already verified; if the specified channel is not
                /// verified, the request will fail.</summary>
                [Google.Apis.Util.RequestParameterAttribute("name", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Name { get; private set; }
    ...
    public class ServicesResource
    {
        ...
        public class ServiceLevelObjectivesResource
        {
            ...
            /// <param name="parent">Required. Resource name of the parent containing the listed SLOs, either a project or a
            /// Monitoring Workspace. The formats are: projects/[PROJECT_ID_OR_NUMBER]/services/[SERVICE_ID]
            /// workspaces/[HOST_PROJECT_ID_OR_NUMBER]/services/- </param>
            public virtual ListRequest List(string parent)
            {
                return new ListRequest(service, parent);
            }
            ...
            public class ListRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.ListServiceLevelObjectivesResponse>
            {
                ...
                /// <summary>Required. Resource name of the parent containing the listed SLOs, either a project or a
                /// Monitoring Workspace. The formats are: projects/[PROJECT_ID_OR_NUMBER]/services/[SERVICE_ID]
                /// workspaces/[HOST_PROJECT_ID_OR_NUMBER]/services/- </summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
        ...
        /// <param name="parent">Required. Resource name of the parent containing the listed services, either a project or a
        ...
        public class ListRequest : MonitoringBaseServiceRequest<Google.Apis.Monitoring.v3.Data.ListServicesResponse>
        {
            ...
            /// <summary>Required. Resource name of the parent containing the listed services, either a project or a
            /// Monitoring Workspace. The formats are: projects/[PROJECT_ID_OR_NUMBER]
            /// workspaces/[HOST_PROJECT_ID_OR_NUMBER] </summary>
            [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string Parent { get; private set; }
...
{    
    ...
    public class Aggregation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// aligner ALIGN_NONE is specified, then this field is ignored.The maximum value of the alignment_period is 104
        /// weeks (2 years) for charts, and 90,000 seconds (25 hours) for alerting policies.</summary>
    ...
    /// to Alerting (https://cloud.google.com/monitoring/alerts/).</summary>
    ...
    {
        /// <summary>Required. The new data to be added to a list of time series. Adds at most one data point to each of
        /// several time series. The new data point must be more recent than any other point in its time series. Each
    ...
    {
        /// <summary>Required in the Cloud Monitoring API v3. The values for each bucket specified in bucket_options.
        /// The sum of the values in bucketCounts must equal the value in the count field of the Distribution object.
        /// The order of the bucket counts follows the numbering schemes described for the three bucket types. The
        /// underflow bucket has number 0; the finite buckets, if any, have numbers 1 through N-2; and the overflow
    ...
    public class MetricAbsence : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// field must not exceed 2048 Unicode characters in length.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("filter")]
        public virtual string Filter { get; set; }
    ...
    public class MetricDescriptor : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// may scale the values to be more easily displayed (so a value of 0.02KBy might be displayed as 20By, and a
        /// value of 3523KBy might be displayed as 3.5MBy). However, if the unit is KBy, then the value of the metric is
        /// always in thousands of bytes, no matter how it may be displayed..If you want a custom metric to record the
    ...
    /// <summary>A point's value columns and time interval. Each point has one or more point values corresponding to the
    /// entries in point_descriptors field in the TimeSeriesDescriptor associated with this object.</summary>
    ...
    public class QueryTimeSeriesRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. The query in the Monitoring Query Language
        /// (https://cloud.google.com/monitoring/mql/reference) format. The default time zone is in UTC.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("query")]
        public virtual string Query { get; set; }
    ...
    /// concern (Wikipedia (https://en.wikipedia.org/wiki/Service-orientation)). In Cloud Monitoring, a Service acts as
    /// the root resource under which operational aspects of the service are accessible.</summary>
    ...
    /// endTime]. Valid time intervals depend on the MetricKind of the metric value. The end time must not be earlier
    /// than the start time. When writing data points, the start time must not be more than 25 hours in the past and the
    /// end time must not be more than five minutes in the future. For GAUGE metrics, the startTime value is technically
    ...
    /// time of the previous interval. For CUMULATIVE metrics, the start time and end time must specify a a non-zero
    ...
    /// could overwrite data written at the previous end time.</summary>
    ...
    {
        /// <summary>The values of the labels in the time series identifier, given in the same order as the
    ...
    {
        /// <summary>Required. The verification code that was delivered to the channel as a result of invoking the
