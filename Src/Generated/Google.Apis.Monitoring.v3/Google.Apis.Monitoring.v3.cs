...
namespace Google.Apis.Monitoring.v3.Data
{
    ...
    public class AlertPolicy : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>
        /// Optional. The severity of an alert policy indicates how important alerts generated by that policy are. The
        /// severity level, if specified, will be displayed on the Incident detail page and in notifications.
        /// </summary>
