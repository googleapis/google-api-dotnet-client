...
{    
    ...
    /// <summary>Nimbus InternalCheckers. The API currently only allows reading of internal checkers, creation of
    /// internal checkers is a manual process.</summary>
    public class InternalChecker : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// is:projects/[PROJECT_ID]/internalCheckers/[CHECKER_ID].PROJECT_ID is the GCP project ID where the internal
        /// resource lives. Not necessarily the same as the project_id for the config.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
