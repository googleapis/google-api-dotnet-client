...
namespace Google.Apis.CloudAsset.v1p7beta1
{
    ...
    public class CloudAssetService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            AssetUpdates = new AssetUpdatesResource(this);
        ...
        /// <summary>Gets the AssetUpdates resource.</summary>
        public virtual AssetUpdatesResource AssetUpdates { get; }
    ...
    /// <summary>The "assetUpdates" collection of methods.</summary>
    public class AssetUpdatesResource
    {
        private const string Resource = "assetUpdates";

        /// <summary>The service which this resource belongs to.</summary>
        private readonly Google.Apis.Services.IClientService service;

        /// <summary>Constructs a new resource.</summary>
        public AssetUpdatesResource(Google.Apis.Services.IClientService service)
        {
            this.service = service;
        }

        /// <summary>Lists asset updates within a time window and returns paged results in response.</summary>
        /// <param name="parent">
        ...
        /// <summary>Lists asset updates within a time window and returns paged results in response.</summary>
        public class ListRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.ListAssetUpdatesResponse>
        {
            ...
            /// `//compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1`. If specified, only
            /// assets in the list will be returned. At most one of asset_types and asset_names should be specified. If
            ...
            /// If specified, only matching assets will be returned. At most one of asset_types and asset_names should
            /// be specified. If neither is specified, all assets under the parent will be returned.
            /// </summary>
            ...
            /// </summary>
            [Google.Apis.Util.RequestParameterAttribute("updateTimeWindow.timeWindow.endTime", Google.Apis.Util.RequestParameterType.Query)]
            public virtual object UpdateTimeWindowTimeWindowEndTime { get; set; }

            /// <summary>Start time of the time window (exclusive).</summary>
            [Google.Apis.Util.RequestParameterAttribute("updateTimeWindow.timeWindow.startTime", Google.Apis.Util.RequestParameterType.Query)]
            public virtual object UpdateTimeWindowTimeWindowStartTime { get; set; }

            /// <summary>The type of the time in time_window.</summary>
            [Google.Apis.Util.RequestParameterAttribute("updateTimeWindow.type", Google.Apis.Util.RequestParameterType.Query)]
            public virtual System.Nullable<UpdateTimeWindowTypeEnum> UpdateTimeWindowType { get; set; }

            /// <summary>The type of the time in time_window.</summary>
            public enum UpdateTimeWindowTypeEnum
            {
                /// <summary>If not specified, UPDATE_TIME is used.</summary>
                [Google.Apis.Util.StringValueAttribute("TIME_TYPE_UNSPECIFIED")]
                TIMETYPEUNSPECIFIED,

                /// <summary>Update time of the Asset. Assets updated in the window will be returned.</summary>
                [Google.Apis.Util.StringValueAttribute("UPDATE_TIME")]
                UPDATETIME,

                /// <summary>
                /// Capture time of the Asset update in Asset Inventory. Assets updates captured by Asset Inventory in
                /// the window will be returned. This definition should be used when full-fidelity data is required in
                /// requests with consecutive time windows.
                /// </summary>
                [Google.Apis.Util.StringValueAttribute("CAPTURE_TIME")]
                CAPTURETIME,
            }
            ...
            public override string RestPath => "v1p7beta1/{+parent}/assetUpdates";
            ...
            protected override void InitParameters()
            {
                ...
                RequestParameters.Add("updateTimeWindow.timeWindow.endTime", new Google.Apis.Discovery.Parameter
                {
                    Name = "updateTimeWindow.timeWindow.endTime",
                    IsRequired = false,
                    ParameterType = "query",
                    DefaultValue = null,
                    Pattern = null,
                });
                RequestParameters.Add("updateTimeWindow.timeWindow.startTime", new Google.Apis.Discovery.Parameter
                {
                    Name = "updateTimeWindow.timeWindow.startTime",
                    IsRequired = false,
                    ParameterType = "query",
                    DefaultValue = null,
                    Pattern = null,
                });
                RequestParameters.Add("updateTimeWindow.type", new Google.Apis.Discovery.Parameter
                {
                    Name = "updateTimeWindow.type",
                    IsRequired = false,
                    ParameterType = "query",
                    DefaultValue = null,
                    Pattern = null,
    ...
    public class FoldersResource
    {
        ...
        {
            this.service = service;
            InventorySettings = new InventorySettingsResource(service);
        }

        /// <summary>Gets the InventorySettings resource.</summary>
        public virtual InventorySettingsResource InventorySettings { get; }

        /// <summary>The "inventorySettings" collection of methods.</summary>
        public class InventorySettingsResource
        {
            private const string Resource = "inventorySettings";

            /// <summary>The service which this resource belongs to.</summary>
            private readonly Google.Apis.Services.IClientService service;

            /// <summary>Constructs a new resource.</summary>
            public InventorySettingsResource(Google.Apis.Services.IClientService service)
            {
                this.service = service;
                ExportSettings = new ExportSettingsResource(service);
            }

            /// <summary>Gets the ExportSettings resource.</summary>
            public virtual ExportSettingsResource ExportSettings { get; }

            /// <summary>The "exportSettings" collection of methods.</summary>
            public class ExportSettingsResource
            {
                private const string Resource = "exportSettings";

                /// <summary>The service which this resource belongs to.</summary>
                private readonly Google.Apis.Services.IClientService service;

                /// <summary>Constructs a new resource.</summary>
                public ExportSettingsResource(Google.Apis.Services.IClientService service)
                {
                    this.service = service;
                }

                /// <summary>Creates an export setting.</summary>
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.CloudAsset.v1p7beta1.Data.CreateExportSettingRequest body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }

                /// <summary>Creates an export setting.</summary>
                public class CreateRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.ExportSetting>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudAsset.v1p7beta1.Data.CreateExportSettingRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. Name of the inventory settings where this export setting should be created in. The
                    /// format will be: projects/{PROJECT_NUMBER}/inventorySettings
                    /// folders/{FOLDER_NUMBER}/inventorySettings organizations/{ORGANIZATION_NUMBER}/inventorySettings
                    ...
                    Google.Apis.CloudAsset.v1p7beta1.Data.CreateExportSettingRequest Body { get; set; }
                    ...
                    /// <summary>Gets the REST path.</summary>
                    public override string RestPath => "v1p7beta1/{+parent}/exportSettings";
                ...
                /// <summary>Deletes an export setting.</summary>
                /// <param name="name">
                ...
                /// <summary>Deletes an export setting.</summary>
                public class DeleteRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.Empty>
                {
                ...
                /// <summary>Gets details about an export setting.</summary>
                /// <param name="name">
                ...
                /// <summary>Gets details about an export setting.</summary>
                public class GetRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.ExportSetting>
                {
                ...
                /// <summary>Lists all export settings under a [InventorySettings].</summary>
                /// <param name="parent">
                ...
                /// <summary>Lists all export settings under a [InventorySettings].</summary>
                public class ListRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.ListExportSettingsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                    {
                    ...
                    /// If unspecified, at most 100 export settings will be returned. The maximum value is 100, as
                    /// currently only a maximum of 100 export settings can be created under each parent.
                    /// </summary>
                    [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
                    public virtual System.Nullable<int> PageSize { get; set; }
                    ...
                    /// subsequent page. When paginating, all other parameters provided to `ListExportSettings` must
                ...
                /// <summary>Updates an export setting.</summary>
                /// <param name="body">The body of the request.</param>
                /// <param name="name">
                /// The format will be:
                ...
                /// </param>
                public virtual PatchRequest Patch(Google.Apis.CloudAsset.v1p7beta1.Data.ExportSetting body, string name)
                {
                    return new PatchRequest(service, body, name);
                }

                /// <summary>Updates an export setting.</summary>
                public class PatchRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.ExportSetting>
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudAsset.v1p7beta1.Data.ExportSetting body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>
                    /// Required. Only updates the `export_setting` fields indicated by this mask. The field mask must
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudAsset.v1p7beta1.Data.ExportSetting Body { get; set; }
        ...
        /// <summary>Gets details about an inventory setting.</summary>
        /// <param name="name">
        ...
        /// </param>
        public virtual GetInventorySettingsRequest GetInventorySettings(string name)
        {
            return new GetInventorySettingsRequest(service, name);
        }

        /// <summary>Gets details about an inventory setting.</summary>
        public class GetInventorySettingsRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.InventorySettings>
        {
            /// <summary>Constructs a new GetInventorySettings request.</summary>
            public GetInventorySettingsRequest(Google.Apis.Services.IClientService service, string name) : base(service)
            {
                Name = name;
                InitParameters();
            }
            ...
            /// <summary>Gets the method name.</summary>
            public override string MethodName => "getInventorySettings";
            ...
            /// <summary>Initializes GetInventorySettings parameter list.</summary>
            protected override void InitParameters()
            {
                base.InitParameters();
                RequestParameters.Add("name", new Google.Apis.Discovery.Parameter
    ...
    public class V1p7beta1Resource
    {
        ...
        /// <summary>
        /// Exports asset updates within a time window to a given Cloud Storage location/BigQuery table. For Cloud
        ...
        /// </param>
        public virtual ExportAssetUpdatesRequest ExportAssetUpdates(Google.Apis.CloudAsset.v1p7beta1.Data.ExportAssetUpdatesRequest body, string parent)
        {
            return new ExportAssetUpdatesRequest(service, body, parent);
        }
        ...
        /// finishes within 5 minutes.
        /// </summary>
        public class ExportAssetUpdatesRequest : CloudAssetBaseServiceRequest<Google.Apis.CloudAsset.v1p7beta1.Data.Operation>
        {
            /// <summary>Constructs a new ExportAssetUpdates request.</summary>
            public ExportAssetUpdatesRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudAsset.v1p7beta1.Data.ExportAssetUpdatesRequest body, string parent) : base(service)
            {
                Parent = parent;
                Body = body;
                InitParameters();
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.CloudAsset.v1p7beta1.Data.ExportAssetUpdatesRequest Body { get; set; }

            /// <summary>Returns the body of the request.</summary>
            protected override object GetBody() => Body;

            /// <summary>Gets the method name.</summary>
            public override string MethodName => "exportAssetUpdates";

            /// <summary>Gets the HTTP method.</summary>
            public override string HttpMethod => "POST";

            /// <summary>Gets the REST path.</summary>
            public override string RestPath => "v1p7beta1/{+parent}:exportAssetUpdates";

            /// <summary>Initializes ExportAssetUpdates parameter list.</summary>
            protected override void InitParameters()
            {
                base.InitParameters();
                RequestParameters.Add("parent", new Google.Apis.Discovery.Parameter
...
namespace Google.Apis.CloudAsset.v1p7beta1.Data
{
    ...
    public class BigQueryDestination : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// new table with the given name will be created. In the case of scheduled export, the real destination is
        /// [table] appended with a suffix indicating the point-in-time of the snapshot. For example, suppose field
        /// [table] is "mytable". When [separate_tables_per_asset_type] and is `FALSE`, the destination will be
        /// "mytable_snapshot_20201122060000", and when [separate_tables_per_asset_type] and is `TRUE` and the
        /// [asset_types] contains "storage.googleapis.com/Bucket", the destination will be
    ...
    /// <summary>Setting for scheduled export to BigQuery.</summary>
    public class BigQuerySetting : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. Destination on BigQuery. The output table stores the fields in asset proto as columns in BigQuery.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("destination")]
        public virtual BigQueryDestination Destination { get; set; }

        /// <summary>Schedule for scheduled export of asset snapshot.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("snapshotSchedule")]
        public virtual ScheduleConfig SnapshotSchedule { get; set; }
    ...
    public class CreateExportSettingRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Required. The export setting details. The field `name` must be empty and it will be generated in the format
        /// of: projects/{PROJECT_NUMBER}/inventorySettings/exportSettings/{EXPORT_SETTING_ID}
        /// folders/{FOLDER_NUMBER}/inventorySettings/exportSettings/{EXPORT_SETTING_ID}
        /// organizations/{ORGANIZATION_NUMBER}/inventorySettings/exportSettings/{EXPORT_SETTING_ID}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("exportSetting")]
        public virtual ExportSetting ExportSetting { get; set; }

        /// <summary>
        /// Required. This is the client-assigned export setting identifier encoded in UTF-8 and it needs to be unique
        /// under a specific [InventorySettings].
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("exportSettingId")]
        public virtual string ExportSettingId { get; set; }
    ...
    /// <summary>Export asset updates request.</summary>
    public class ExportAssetUpdatesRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// A list of the full names of the assets to export the updates for. See:
        /// https://cloud.google.com/asset-inventory/docs/resource-name-format Example:
        /// `//compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1`. If specified, only
        /// assets in the list will be returned. At most one of asset_types and asset_names should be specified. If
        /// neither is specified, all assets under the parent will be returned.
        ...
        /// <summary>
        /// A list of asset types to export the updates for. For example: "compute.googleapis.com/Disk". Regular
        ...
        /// Inventory](https://cloud.google.com/asset-inventory/docs/overview) for all supported asset types. At most
        /// one of asset_types and asset_names should be specified. If neither is specified, all assets under the parent
        /// will be returned.
        /// </summary>
        ...
        /// <summary>
        /// The time window configuration for the asset updates. Both start_time and end_time must be within 35 days
        /// from now. end_time is optional and not set, it is default to current timestamp. The returned results contain
        /// all assets created, updated or deleted within update_time_window.time_window.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("updateTimeWindow")]
        public virtual UpdateTimeWindow UpdateTimeWindow { get; set; }
    ...
    /// <summary>
    /// Settings that configure CAI to export assets on given schedules. An [InventorySettings] might have multiple
    /// [ExportSetting], each with a unique identifier.
    /// </summary>
    public class ExportSetting : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>
        /// Asset types of resources that will be exported on schedule. For example: "compute.googleapis.com/Disk".
        /// Regular expressions are also supported. For example: * "compute.googleapis.com.*" snapshots resources whose
        /// asset type starts with "compute.googleapis.com". * ".*Instance" snapshots resources whose asset type ends
        /// with "Instance". * ".*Instance.*" snapshots resources whose asset type contains "Instance". See
        /// [RE2](https://github.com/google/re2/wiki/Syntax) for all supported regular expression syntax. If the regular
        /// expression does not match any supported asset type, an INVALID_ARGUMENT error will be returned. If
        /// specified, only matching assets will be returned. See [Introduction to Cloud Asset
        ...
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("bigquerySetting")]
        public virtual BigQuerySetting BigquerySetting { get; set; }

        /// <summary>
        /// Required. Asset content type. Currently only `RESOURCE`, `IAM_POLICY`, `ORG_POLICY`, `ACCESS_POLICY` are
        /// supported.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("contentType")]
        public virtual string ContentType { get; set; }
        ...
        /// <summary>
        /// Setting to configure scheduled export output to GCS. At least one of [gcs_setting] and [bigquery_setting]
        /// should be set.
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("gcsSetting")]
        public virtual GcsSetting GcsSetting { get; set; }

        /// <summary>
        /// The format will be: organizations/{ORGANIZATION_NUMBER}/inventorySettings/exportSettings/{exportSetting} or
        /// folders/{FOLDER_NUMBER}/inventorySettings/exportSettings/{exportSetting} or
        /// projects/{PROJECT_NUMBER}/inventorySettings/exportSettings/{exportSetting}
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
    ...
    public class GcsDestination : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Metadata](https://cloud.google.com/storage/docs/viewing-editing-metadata) for more information. In the case
        /// of scheduled export, a path indiciating when the export happens will be added in between the bucket_name and
        /// object_name. For example: the real destination for an scheduled snapshot is:
        /// gs://bucket_name/{YYYY}/{MM}/{DD}/snapshot/{HHMMSS}/file
        /// </summary>
        ...
        /// the same name "gs://bucket_name/object_name_prefix" already exists. In the case of scheduled export, a path
        /// indiciating when the export happens will be appended. For example: the real destination for an scheduled
        /// snapshot is:
        /// gs://bucket_name/object_name_prefix/{YYYY}/{MM}/{DD}/snapshot/{HHMMSS}/{ASSET_TYPE}/{SHARD_NUMBER}
        /// </summary>
    ...
    /// <summary>Setting for scheduled export to GCS.</summary>
    public class GcsSetting : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Required. Destination on Cloud Storage.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("destination")]
        public virtual GcsDestination Destination { get; set; }
    ...
    /// <summary>
    /// Inventory Settings. There is only one inventory settings for a given organization, folder or project. Users can
    /// update inventory settings using specific API, but cannot create or delete.
    /// </summary>
    public class InventorySettings : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Output only. A list of export settings.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("exportSettings")]
        public virtual System.Collections.Generic.IList<string> ExportSettings { get; set; }

        /// <summary>
        /// Required. The format will be projects/{PROJECT_NUMBER}/inventorySettings or
        /// folders/{FOLDER_NUMBER}/inventorySettings or organizations/{ORGANIZATION_NUMBER}/inventorySettings
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; }
    ...
    public class ListAssetUpdatesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Asset updates in the time window.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("assetUpdates")]
        public virtual System.Collections.Generic.IList<Asset> AssetUpdates { get; set; }
        ...
        /// <summary>Time window configuration of the list request.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("updateTimeWindow")]
        public virtual UpdateTimeWindow UpdateTimeWindow { get; set; }
    ...
    public class ListExportSettingsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A list of export settings.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("exportSettings")]
        public virtual System.Collections.Generic.IList<ExportSetting> ExportSettings { get; set; }
    ...
    {
        /// <summary>
        /// Required. Cron-tab formatted schedule by which the job will execute Format: minute, hour, day of month,
        /// month, day of week e.g. 0 0 * * WED = every Wednesday More examples: https://crontab.guru/examples.html
        /// </summary>
        [Newtonsoft.Json.JsonPropertyAttribute("crontab")]
        public virtual string Crontab { get; set; }

        /// <summary>
        /// Specifies the time zone to be used in interpreting [crontab]. The value of this field must be a time zone
        /// name from the [tz database](https://en.wikipedia.org/wiki/Tz_database). Note that some time zones include a
    ...
    /// <summary>Time window configuration for asset updates requests.</summary>
    public class UpdateTimeWindow : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The time window.</summary>
