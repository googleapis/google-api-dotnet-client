...
namespace Google.Apis.CloudResourceManager.v1.Data
{
    ...
    public class SearchOrganizationsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// Organization resources with `owner.directory_customer_id` equal to `123456789`. * Filter `domain:google.com`
        /// returns Organization resources corresponding to the domain `google.com`. This field is optional.
        /// </summary>
