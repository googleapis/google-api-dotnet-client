    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class AclPoliciesResource
            {
                ...
                /// </param>
                public virtual CreateRequest Create(Google.Apis.CloudRedis.v1.Data.AclPolicy body, string parent)
                {
                ...
                public class CreateRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1.Data.AclPolicy>
                {
                    ...
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRedis.v1.Data.AclPolicy body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    Google.Apis.CloudRedis.v1.Data.AclPolicy Body { get; set; }
                    ...
                    public override string RestPath => "v1/{+parent}/aclPolicies";
                ...
                /// then all regions available to the project are queried, and the results are aggregated.
                /// </summary>
                public class ListRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1.Data.ListAclPoliciesResponse>
                {
                ...
                public virtual PatchRequest Patch(Google.Apis.CloudRedis.v1.Data.AclPolicy body, string name)
                {
                ...
                public class PatchRequest : CloudRedisBaseServiceRequest<Google.Apis.CloudRedis.v1.Data.Operation>
                {
                    ...
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudRedis.v1.Data.AclPolicy body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
