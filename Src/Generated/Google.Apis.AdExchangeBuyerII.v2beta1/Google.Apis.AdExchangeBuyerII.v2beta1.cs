...
{    
    ...
    public class Creative : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Output only. The filtering stats for this creative. Deprecated; please use
    ...
    /// <summary>Output only. Filtering reasons for this creative during a period of a single day (from midnight to
