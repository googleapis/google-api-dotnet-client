...
namespace Google.Apis.DoubleClickBidManager.v1
{
    ...
    public class DoubleClickBidManagerService : Google.Apis.Services.BaseClientService
    {
        ...
        public override string BaseUri =>
            ...
            BaseUriOverride ?? "https://www.googleapis.com/doubleclickbidmanager/v1/";
        #else
            "https://www.googleapis.com/doubleclickbidmanager/v1/";
        #endif

        /// <summary>Gets the service base path.</summary>
        public override string BasePath => "doubleclickbidmanager/v1/";

        #if !NET40
        /// <summary>Gets the batch base URI; <c>null</c> if unspecified.</summary>
        public override string BatchUri => "https://www.googleapis.com/batch/doubleclickbidmanager";

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath => "batch/doubleclickbidmanager";
        #endif
