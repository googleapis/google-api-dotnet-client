...
{    
    ...
    public class GoogleCloudRecommenderV1beta1Operation : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// "/versions/targetSize/percent": 20 } * Example: { "/bindings/role": "roles/owner" "/bindings/condition" :
        /// null } * Example: { "/bindings/role": "roles/owner" "/bindings/members" : ["x@example.com", "y@example.com"]
