...
namespace Google.Apis.Genomics.v1
{
    ...
    public class DatasetsResource
    {
        ...
        /// <summary>Deletes a dataset. For the definitions of datasets and other genomics resources, see [Fundamentals
    ...
    public class VariantsResource
    {
        ...
        /// information from the new variant is added to the existing variant, and other fields (such as key/value
        /// pairs) are discarded. In particular, this means for merged VCF variants that have conflicting INFO fields,
        /// some data will be arbitrarily discarded. As a special case, for single-sample VCF files, QUAL and FILTER
        /// fields will be moved to the call level; these are sometimes interpreted in a call-specific context. Imported
        /// VCF headers are appended to the metadata already in a variant set.</summary>
        /// <param name="body">The body of the request.</param>
