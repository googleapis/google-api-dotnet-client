...
namespace Google.Apis.Merchant.reports_v1
{
    ...
    public class AccountsResource
    {
        ...
        public class ReportsResource
        {
            ...
            /// `page_size`. Rely on `next_page_token` to determine if there are more rows to be requested.
            /// </summary>
            public class SearchRequest : MerchantBaseServiceRequest<Google.Apis.Merchant.reports_v1.Data.SearchResponse>
            {
                /// <summary>Constructs a new Search request.</summary>
                public SearchRequest(Google.Apis.Services.IClientService service, Google.Apis.Merchant.reports_v1.Data.SearchRequest body, string parent) : base(service)
                {
                    Parent = parent;
                    Body = body;
                    InitParameters();
                ...
                Google.Apis.Merchant.reports_v1.Data.SearchRequest Body { get; set; }
                ...
                public override string RestPath => "reports/v1/{+parent}/reports:search";
