...
namespace Google.Apis.Prediction.v1_5
{
    ...
    public class PredictionService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            get { return "https://www.googleapis.com/prediction/v1.5/"; }
        }

        /// <summary>Gets the service base path.</summary>
        public override string BasePath
        {
            get { return "prediction/v1.5/"; }
        }
        ...
        {
            get { return "https://www.googleapis.com/batch/prediction/v1.5"; }
        }

        /// <summary>Gets the batch base path; <c>null</c> if unspecified.</summary>
        public override string BatchPath
        {
            get { return "batch/prediction/v1.5"; }
        }
        #endif
    ...
    public class HostedmodelsResource
    {
        ...
        /// <summary>Submit input and request an output against a hosted model.</summary>
        public class PredictRequest : PredictionBaseServiceRequest<Google.Apis.Prediction.v1_5.Data.Output>
        {
            ...
            Google.Apis.Prediction.v1_5.Data.Input Body { get; set; }
    ...
    public class TrainedmodelsResource
    {
        ...
        /// <summary>Get analysis of the model and the data the model was trained on.</summary>
        public class AnalyzeRequest : PredictionBaseServiceRequest<Google.Apis.Prediction.v1_5.Data.Analyze>
        {
            ...
            public override string RestPath
            {
                get { return "trainedmodels/{id}/analyze"; }
            }
        ...
        /// <summary>Check training status of your model.</summary>
        public class GetRequest : PredictionBaseServiceRequest<Google.Apis.Prediction.v1_5.Data.Training>
        {
        ...
        /// <summary>Begin training your model.</summary>
        public class InsertRequest : PredictionBaseServiceRequest<Google.Apis.Prediction.v1_5.Data.Training>
        {
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Prediction.v1_5.Data.Training Body { get; set; }
        ...
        /// <summary>List available models.</summary>
        public class ListRequest : PredictionBaseServiceRequest<Google.Apis.Prediction.v1_5.Data.List>
        {
        ...
        /// <summary>Add new data to a trained model.</summary>
        public class UpdateRequest : PredictionBaseServiceRequest<Google.Apis.Prediction.v1_5.Data.Training>
        {
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Prediction.v1_5.Data.Update Body { get; set; }
...
{    
    ...
    public class Analyze : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public class ModelDescriptionData
        {
            ...
            public virtual Training Modelinfo { get; set; } 
    ...
    public class List : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<Training> Items { get; set; } 
    ...
    public class Training : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual System.Collections.Generic.IList<Training.TrainingInstancesData> TrainingInstances { get; set; } 
