...
namespace Google.Apis.Auth.OAuth2
{
    ...
    public sealed class ClientCredentialParameters
    {
        ...
        /// <summary>Private Key associated with ServiceAccountCredential obtained from https://console.developers.google.com.</summary>
        [Newtonsoft.Json.JsonProperty("private_key")]
        private string PrivateKey { get; set; }

        /// <summary>Client Email assocaited with ServiceAccountCredential obtained from https://console.developers.google.com</summary>
        [Newtonsoft.Json.JsonProperty("client_email")]
        public string ClientEmail { get; set; }

        /// <summary>Cliend Id associated with UserCredential created by gcloud sdk.</summary>
        [Newtonsoft.Json.JsonProperty("client_id")]
        private string ClientId { get; set; }

        /// <summary>Client Secret associated with UserCredential created by gcloud sdk.</summary>
        [Newtonsoft.Json.JsonProperty("client_secret")]
        private string ClientSecret { get; set; }

        /// <summary>Refresh Token associated with UserCredential created by gcloud sdk.</summary>
