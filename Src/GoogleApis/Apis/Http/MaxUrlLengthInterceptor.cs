...
namespace Google.Apis.Http
{
    ...
    /// <item>Any query parameters from the URI will be moved into the body of the request.
    ...
    internal class MaxUrlLengthInterceptor : IHttpExecuteInterceptor
    {
        ...
        public Task InterceptAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (!String.IsNullOrEmpty(query))
            {
                ...
                request.RequestUri = new Uri(requestString.Remove(requestString.IndexOf("?") - 1));
            }
