...
namespace Google.Apis.Tools.CodeGen {
	...
	public class TestResourceClassGenerator : ResourceBaseGenerator {
		...
		public TestResourceClassGenerator(Resource resource, String serviceClassName, int resourceNumber, 
		...
		public CodeTypeDeclaration CreateClass() {
			...
			foreach(IResourceDecorator decorator in this.decorators){
				ITestResourceDecorator testDecorator = decorator as ITestResourceDecorator;
				if ( decorator is ITestResourceDecorator == false){
