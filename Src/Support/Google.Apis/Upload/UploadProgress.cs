...
/// <summary>
/// Extension methods for <see cref="IUploadProgress"/>.
/// </summary>
public static class UploadProgress
{
    /// <summary>
    /// Throws the exception from <paramref name="progress"/> if it represents a failure with an exception.
    /// The thrown exception will contain a more useful stack trace than just <see cref="IUploadProgress.Exception"/>
    ...
    public static void ThrowOnFailure(this IUploadProgress progress)
    {
        ...
        if (progress is ResumableUpload.ResumableUploadProgress { ExceptionDispatchInfo: ExceptionDispatchInfo edi })
        {
            edi.Throw();
        }
        throw ex;
