...
namespace Google.Apis.Upload
{
    ...
    public class ResumableUpload<TRequest>
    {
        ...
        /// <summary>
        /// <para>Event called when an UploadUri is created.</para>
        /// <para>Not needed if the application program will not support resuming after a program restart.</para>
        /// <para>Within the event, persist the UploadUri to storage.</para>
        /// <para>It is strongly recommended that the full path filename (or other media identifier) is also stored so that it can be compared to the current open filename (media) upon restart.</para>
        /// </summary>
        ...
        {
            /// <summary>
            /// Create a ResumeableUploadSessionData instance.
            /// </summary>
        ...
        /// <summary>
        /// <para>Resumes the upload from the last point it was interrupted.</para>
        /// <para>Use when resuming and the program was not restarted.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Resumes the upload from the last point it was interrupted.</para>
        /// <para>Use when the program was restarted and you wish to resume the upload that was in progress when the program was halted.</para>
        /// <para>In your application's UploadSessionData Event Handler, store UploadUri.AbsoluteUri property value (resumable session URI string value)
        /// <para>to persistent storage for use with Resume() or ResumeAsync() upon a program restart.</para>
        /// <para>It is strongly recommended that the FullPathFilename of the media file that is being uploaded is saved also so that a subsequent execution of the</para>
        /// <para>program can compare the saved FullPathFilename value to the FullPathFilename of the media file that it has opened for uploading.</para>
        /// <para>You do not need to seek to restart point in the media file.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Asynchronously resumes the upload from the last point it was interrupted.</para> 
        /// <para>You do not need to seek to restart point in the media file.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Asynchronously resumes the upload from the last point it was interrupted.</para>
        /// <para>Use when resuming and the program was restarted.</para>
        /// <para>In your application's UploadSessionData Event Handler, store UploadUri.AbsoluteUri property value (resumable session URI string value)
        /// <para>to persistent storage for use with Resume() or ResumeAsync() upon a program restart.</para>
        /// <para>It is strongly recommended that the FullPathFilename of the media file that is being uploaded is saved also so that a subsequent execution of the</para>
        /// <para>program can compare the saved FullPathFilename value to the FullPathFilename of the media file that it has opened for uploading.</para>
